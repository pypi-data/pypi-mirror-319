...
use conspire::constitutive::{
    solid::{
        elastic::Elastic,
        hyperelastic::{Hyperelastic, SaintVenantKirchoff as SaintVenantKirchoffConspire},
    },
    Constitutive,
};
use ndarray::Array;
...
#[pyclass]
pub struct SaintVenantKirchoff {
    bulk_modulus: f64,
    shear_modulus: f64,
}

#[pymethods]
impl SaintVenantKirchoff {
    #[new]
    ...
    fn cauchy_stress<'py>(
        ...
        let cauchy_stress: Vec<Vec<f64>> =
            SaintVenantKirchoffConspire::new(&[self.bulk_modulus, self.shear_modulus])
