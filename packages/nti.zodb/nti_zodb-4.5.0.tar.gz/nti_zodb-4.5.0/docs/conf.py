# -*- coding: utf-8 -*-
#
# nti.zodb documentation build configuration file, created by
...
rqmt = pkg_resources.require('nti.zodb')[0]
...
latex_documents = [
    (master_doc, 'ntizodb.tex', u'nti.zodb Documentation',
...
man_pages = [
    (master_doc, 'ntizodb', u'nti.zodb Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'ntizodb', u'nti.zodb Documentation',
     author, 'ntizodb', 'One line description of project.',
     'Miscellaneous'),
]
...
extlinks = {'issue': ('https://github.com/NextThought/nti.zodb/issues/%s',
                      'issue #'),
            'pr': ('https://github.com/NextThought/nti.zodb/pull/%s',
                   'pull request #')}
