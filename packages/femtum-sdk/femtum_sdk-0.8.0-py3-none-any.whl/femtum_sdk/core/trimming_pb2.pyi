...
class SweepReferenceResultDto(_message.Message):
    ...
    Tags: _containers.RepeatedCompositeFieldContainer[_component_pb2.TagDto]
    def __init__(self, Id: _Optional[str] = ..., WavelengthsArray: _Optional[_Iterable[float]] = ..., PowersArray: _Optional[_Iterable[float]] = ..., Tags: _Optional[_Iterable[_Union[_component_pb2.TagDto, _Mapping]]] = ...) -> None: ...
