...
class OptionalSingleResultsDto(_message.Message):
    __slots__ = ("Result",)
    RESULT_FIELD_NUMBER: _ClassVar[int]
    Result: _component_pb2.ResultDto
    def __init__(self, Result: _Optional[_Union[_component_pb2.ResultDto, _Mapping]] = ...) -> None: ...
