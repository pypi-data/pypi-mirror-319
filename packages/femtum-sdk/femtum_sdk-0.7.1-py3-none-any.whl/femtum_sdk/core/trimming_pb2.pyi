...
class SweepReferenceInputDto(_message.Message):
    __slots__ = ("Sweep",)
    SWEEP_FIELD_NUMBER: _ClassVar[int]
    Sweep: SweepInputDto
    def __init__(self, Sweep: _Optional[_Union[SweepInputDto, _Mapping]] = ...) -> None: ...

class SweepAfterShotInputDto(_message.Message):
    __slots__ = ("Sweep",)
    SWEEP_FIELD_NUMBER: _ClassVar[int]
    Sweep: SweepInputDto
    def __init__(self, Sweep: _Optional[_Union[SweepInputDto, _Mapping]] = ...) -> None: ...

class SweepInputDto(_message.Message):
    __slots__ = ("WaferName", "ReticleName", "DieName", "CircuitName", "Tags", "OpticalSpectralAnalyserSweepInput")
    ...
    OPTICALSPECTRALANALYSERSWEEPINPUT_FIELD_NUMBER: _ClassVar[int]
    WaferName: str
    ReticleName: str
    DieName: str
    CircuitName: str
    Tags: _containers.RepeatedCompositeFieldContainer[_component_pb2.TagDto]
    OpticalSpectralAnalyserSweepInput: OpticalSpectralAnalyserSweepInputDto
    def __init__(self, WaferName: _Optional[str] = ..., ReticleName: _Optional[str] = ..., DieName: _Optional[str] = ..., CircuitName: _Optional[str] = ..., Tags: _Optional[_Iterable[_Union[_component_pb2.TagDto, _Mapping]]] = ..., OpticalSpectralAnalyserSweepInput: _Optional[_Union[OpticalSpectralAnalyserSweepInputDto, _Mapping]] = ...) -> None: ...

class SweepReferenceResultDto(_message.Message):
    __slots__ = ("ResultId", "WavelengthsArray", "PowersArray", "Tags")
    ...
    Tags: _containers.RepeatedCompositeFieldContainer[_component_pb2.TagDto]
    def __init__(self, ResultId: _Optional[str] = ..., WavelengthsArray: _Optional[_Iterable[float]] = ..., PowersArray: _Optional[_Iterable[float]] = ..., Tags: _Optional[_Iterable[_Union[_component_pb2.TagDto, _Mapping]]] = ...) -> None: ...

class SweepAfterShotResultDto(_message.Message):
    __slots__ = ("ResultId", "WavelengthsArray", "PowersArray", "Tags")
    RESULTID_FIELD_NUMBER: _ClassVar[int]
    WAVELENGTHSARRAY_FIELD_NUMBER: _ClassVar[int]
    POWERSARRAY_FIELD_NUMBER: _ClassVar[int]
...
class OpticalSpectralAnalyserSweepInputDto(_message.Message):
