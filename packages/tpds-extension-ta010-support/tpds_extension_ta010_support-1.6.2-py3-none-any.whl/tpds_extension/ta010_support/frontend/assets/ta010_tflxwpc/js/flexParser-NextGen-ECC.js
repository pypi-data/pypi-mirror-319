...
function gererateXML(xml_type) {
  ...
  let jsObj = { base_xml: "TA010_TFLXWPC" };
  ...
  partNumberString = document
    ...
    .value.toUpperCase();
  if (partNumberString == "") partNumberString = "TA010-WPCAA-T";
  ...
  if (
    ...
    if (xml_type === "proto_xml" || xml_type === "prod_xml") {
      ta010_tflxwpc_json(JSON.stringify(jsObj));
    } else {
      ta010_tflxwpc_proto_prov(JSON.stringify(jsObj));
    }
  }
}
