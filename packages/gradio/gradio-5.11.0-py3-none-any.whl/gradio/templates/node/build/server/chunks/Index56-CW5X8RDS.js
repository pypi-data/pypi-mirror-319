...
import { B as Block, S as Static, f as BlockLabel, C as Chat, i as IconButtonWrapper, j as IconButton, q as Community, r as Trash, t as MarkdownCode, M as Music, v as File$1, w as Copy, x as ScrollDownArrow, y as Check, z as Clear, R as Retry, A as Undo, G as Edit } from './2-D1IjqQPD.js';
...
const ButtonPanel = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  message_text = is_all_text(message) ? all_text(message) : "";
  show_copy = show_copy_button && message && is_all_text(message);
  return `${show_copy || show_retry || show_undo || show_edit || likeable ? `<div class="${"message-buttons-" + escape(position, true) + " " + escape(layout, true) + " message-buttons " + escape(avatar !== null && "with-avatar", true) + " svelte-5c5t6x"}">${validate_component(IconButtonWrapper, "IconButtonWrapper").$$render($$result, { top_panel: false }, {}, {
    default: () => {
...
const MessageContent = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${message.type === "text" ? `<div class="message-content svelte-43w8lk">${validate_component(MarkdownCode, "Markdown").$$render(
    $$result,
    {
      message: message.content,
      latex_delimiters,
    ...
    {},
    {}
  )}` : `${message.type === "component" && message.content.component === "file" ? `<div class="file-container svelte-43w8lk"><div class="file-icon svelte-43w8lk">${validate_component(File$1, "File").$$render($$result, {}, {}, {})}</div> <div class="file-info svelte-43w8lk"><a data-testid="chatbot-file" class="file-link svelte-43w8lk"${add_attribute("href", message.content.value.url, 0)} target="_blank"${add_attribute(
    "download",
    window.__is_colab__ ? null : message.content.value?.orig_name || message.content.value?.path.split("/").pop() || "file",
    0
  )}><span class="file-name svelte-43w8lk">${escape(message.content.value?.orig_name || message.content.value?.path.split("/").pop() || "file")}</span></a> <span class="file-type svelte-43w8lk">${escape((message.content.value?.orig_name || message.content.value?.path || "").split(".").pop().toUpperCase())}</span></div></div>` : ``}`}`}`;
});
const css$5 = {
  code: ".box.svelte-1adzknt{border-radius:4px;max-width:max-content;background:var(--color-accent-soft);border:1px solid var(--border-color-accent-subdued);font-size:0.8em}.title.svelte-1adzknt{display:flex;align-items:center;padding:3px 6px;color:var(--body-text-color);opacity:0.8;cursor:pointer}.content.svelte-1adzknt{padding:4px 8px}.content.svelte-1adzknt *{font-size:0.8em}.title-text.svelte-1adzknt{padding-right:var(--spacing-lg)}.arrow.svelte-1adzknt{margin-left:auto;opacity:0.8}",
  map: '{"version":3,"file":"MessageBox.svelte","sources":["MessageBox.svelte"],"sourcesContent":["<script lang=\\"ts\\">export let expanded = false;\\nexport let title;\\nexport let rtl = false;\\nfunction toggleExpanded() {\\n    expanded = !expanded;\\n}\\n<\/script>\\n\\n<div style:padding=\\"var(--spacing-sm) var(--spacing-xl)\\">\\n\\t<div class=\\"box\\" style:text-align={rtl ? \\"right\\" : \\"left\\"}>\\n\\t\\t<div\\n\\t\\t\\tclass=\\"title\\"\\n\\t\\t\\ton:click|stopPropagation={toggleExpanded}\\n\\t\\t\\trole=\\"button\\"\\n\\t\\t\\ttabindex=\\"0\\"\\n\\t\\t\\ton:keydown={(e) => e.key === \\"Enter\\" && toggleExpanded()}\\n\\t\\t>\\n\\t\\t\\t<span class=\\"title-text\\">{title}</span>\\n\\t\\t\\t<span\\n\\t\\t\\t\\tstyle:transform={expanded ? \\"rotate(0)\\" : \\"rotate(90deg)\\"}\\n\\t\\t\\t\\tclass=\\"arrow\\"\\n\\t\\t\\t>\\n\\t\\t\\t\\t▼\\n\\t\\t\\t</span>\\n\\t\\t</div>\\n\\t\\t{#if expanded}\\n\\t\\t\\t<div class=\\"content\\">\\n\\t\\t\\t\\t<slot></slot>\\n\\t\\t\\t</div>\\n\\t\\t{/if}\\n\\t</div>\\n</div>\\n\\n<style>\\n\\t.box {\\n\\t\\tborder-radius: 4px;\\n\\t\\tmax-width: max-content;\\n\\t\\tbackground: var(--color-accent-soft);\\n\\t\\tborder: 1px solid var(--border-color-accent-subdued);\\n\\t\\tfont-size: 0.8em;\\n\\t}\\n\\n\\t.title {\\n\\t\\tdisplay: flex;\\n\\t\\talign-items: center;\\n\\t\\tpadding: 3px 6px;\\n\\t\\tcolor: var(--body-text-color);\\n\\t\\topacity: 0.8;\\n\\t\\tcursor: pointer;\\n\\t}\\n\\n\\t.content {\\n\\t\\tpadding: 4px 8px;\\n\\t}\\n\\n\\t.content :global(*) {\\n\\t\\tfont-size: 0.8em;\\n\\t}\\n\\n\\t.title-text {\\n\\t\\tpadding-right: var(--spacing-lg);\\n\\t}\\n\\n\\t.arrow {\\n\\t\\tmargin-left: auto;\\n\\t\\topacity: 0.8;\\n\\t}</style>\\n"],"names":[],"mappings":"AAkCC,mBAAK,CACJ,aAAa,CAAE,GAAG,CAClB,SAAS,CAAE,WAAW,CACtB,UAAU,CAAE,IAAI,mBAAmB,CAAC,CACpC,MAAM,CAAE,GAAG,CAAC,KAAK,CAAC,IAAI,6BAA6B,CAAC,CACpD,SAAS,CAAE,KACZ,CAEA,qBAAO,CACN,OAAO,CAAE,IAAI,CACb,WAAW,CAAE,MAAM,CACnB,OAAO,CAAE,GAAG,CAAC,GAAG,CAChB,KAAK,CAAE,IAAI,iBAAiB,CAAC,CAC7B,OAAO,CAAE,GAAG,CACZ,MAAM,CAAE,OACT,CAEA,uBAAS,CACR,OAAO,CAAE,GAAG,CAAC,GACd,CAEA,uBAAQ,CAAS,CAAG,CACnB,SAAS,CAAE,KACZ,CAEA,0BAAY,CACX,aAAa,CAAE,IAAI,YAAY,CAChC,CAEA,qBAAO,CACN,WAAW,CAAE,IAAI,CACjB,OAAO,CAAE,GACV"}'
};
...
const Message = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="${[
    "message-row " + escape(layout, true) + " " + escape(role, true) + "-row svelte-1ipou5b",
    (avatar_img !== null ? "with_avatar" : "") + " " + (opposite_avatar_img !== null ? "with_opposite_avatar" : "")
  ].join(" ").trim()}">${avatar_img !== null ? `<div class="avatar-container svelte-1ipou5b">${validate_component(Image$1, "Image").$$render(
    $$result,
    {
      class: "avatar-image",
      src: avatar_img?.url,
    ...
    "flex-wrap svelte-1ipou5b",
    (role ? "role" : "") + " " + (messages[0].type === "component" ? "component-wrap" : "")
  ].join(" ").trim()}"><div class="${[
    escape(null_to_empty(display_consecutive_in_same_bubble ? role : ""), true) + " svelte-1ipou5b",
    display_consecutive_in_same_bubble ? "message" : ""
  ].join(" ").trim()}">${each(messages, (message, thought_index) => {
    return `<div class="${[
      "message " + escape(!display_consecutive_in_same_bubble ? role : "", true) + " svelte-1ipou5b",
    ...
    ].join(" ").trim()}">${in_edit_mode && thought_index === messages.length - 1 && message.type === "text" ? ` <textarea class="edit-textarea svelte-1ipou5b" autofocus${add_styles({
    ...
    })}${add_attribute("this", messageElements[thought_index], 0)}>${message?.metadata?.title ? `${validate_component(MessageBox, "MessageBox").$$render(
      $$result,
      {
        title: message.metadata.title,
        expanded: is_last_bot_message([message], value),
      ...
      {
        default: () => {
          return `${validate_component(MessageContent, "MessageContent").$$render(
            $$result,
            {
              message,
              sanitize_html,
...
const ChatBot = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    $$rendered = `${value !== null && value.length > 0 ? `${validate_component(IconButtonWrapper, "IconButtonWrapper").$$render($$result, {}, {}, {
    ...
    })}` : ``} <div class="${escape(null_to_empty(layout === "bubble" ? "bubble-wrap" : "panel-wrap"), true) + " svelte-pcaovb"}" role="log" aria-label="chatbot conversation" aria-live="polite"${add_attribute("this", div, 0)}>${value !== null && value.length > 0 && groupedMessages !== null ? `<div class="message-wrap svelte-pcaovb">${each(groupedMessages, (messages, i) => {
    ...
    })} ${pending_message ? `${validate_component(Pending, "Pending").$$render($$result, { layout, avatar_images }, {}, {})}` : `${options ? `<div class="options svelte-pcaovb">${each(options, (option, index) => {
      return `<button class="option svelte-pcaovb">${escape(option.label || option.value)} </button>`;
      ...
      {},
      {}
    )}`}</div> ${show_scroll_button ? `<div class="scroll-down-button-container svelte-pcaovb">${validate_component(IconButton, "IconButton").$$render(
      $$result,
      {
        Icon: ScrollDownArrow,
        label: "Scroll down",
...
//# sourceMappingURL=Index56-CW5X8RDS.js.map
