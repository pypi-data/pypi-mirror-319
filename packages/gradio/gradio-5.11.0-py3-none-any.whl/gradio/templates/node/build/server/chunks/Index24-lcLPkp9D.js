import { B as Block, S as Static, J as BlockTitle, h as Empty, as as LineChart, a7 as globals } from './2-D1IjqQPD.js';
...
const Index = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  async function load_chart() {
    ...
    if (!vegaEmbed) {
      vegaEmbed = (await import('./vega-embed.module-BfdOLxf9.js')).default;
    }
    vegaEmbed(chart_element, spec, { actions: false }).then(function(result) {
      view = result.view;
      resizeObserver.observe(chart_element);
...
//# sourceMappingURL=Index24-lcLPkp9D.js.map
