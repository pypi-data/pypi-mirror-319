...
print("Auto checking and installation dependencies for Anaplanet")
...
print(f"Anaplanet is ready to use with {err} errors")

__version__ = "2.5.9"
__update__ = "* Changes: https://github.com/HCB06/Anaplanet/blob/main/CHANGES\n* Anaplan document: https://github.com/HCB06/Anaplanet/blob/main/Anaplan/ANAPLAN_USER_MANUEL_AND_LEGAL_INFORMATION(EN).pdf.\n* YouTube tutorials: https://www.youtube.com/@HasanCanBeydili"

def print_version(__version__):
    print(f"Anaplanet Version {__version__}" + '\n')
