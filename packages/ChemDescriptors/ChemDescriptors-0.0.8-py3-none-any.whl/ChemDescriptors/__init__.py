...
print("""
**add_rdkit_descriptor**(input_file, output_file, smiles_column):
...
**add_morgan_fp**(input_file, output_file, smiles_column):
...
**add_mordred_descriptors**(input_file, output_file, smiles_column):
...
**add_molfeat_fps(filenmae, smiles_column,fp_type )
