...
def create_snapshot(
    ...
    **kwargs,
    ...
    resp = raise_for_status(ipf.post("snapshots", json=snapshot.params)).json()  # TODO: IPF-1515/IPF-810
    started = datetime.strptime(resp.headers["date"], DATE_FORMAT) - timedelta(seconds=5)
    return _parse_snapshot_creation(ipf, resp, snapshot, started)
