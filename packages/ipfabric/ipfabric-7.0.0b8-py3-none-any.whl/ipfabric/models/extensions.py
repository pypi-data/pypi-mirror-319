...
class Extensions(BaseModel):
    ...
    def extensions(self) -> List[Extension]:
        ...
        """
        response = ExtensionsResponse(extensions=self.client.get("extensions").json()["extensions"])
    ...
    def extension_by_id(self, extension_id: str) -> Extension:
        ...
        """
        return Extension(**self.client.get(f"extensions/{extension_id}").json())
    ...
    def logs_by_extension_id(self, extension_id: str) -> Dict:
        ...
        """
        return self.client.get(f"extensions/{extension_id}/logs").json()
    ...
    def register_docker_zip(
        ...
        response = self.client.post("extensions/docker-zip", files=files, data=data, timeout=300)
    ...
    def register_docker_image(
        ...
        response = self.client.post("extensions/docker-image", files=files, data=data, timeout=300)
        if response.status_code != 204:
            raise Exception(response.content)

    def start_extension(self, extension_id: str) -> None:
        """
        ...
        """
        response = self.client.post(f"extensions/{extension_id}/start")
        if response.status_code != 204:
            raise Exception(response.content)

    def stop_extension(self, extension_id: str) -> None:
        """
        ...
        """
        response = self.client.post(f"extensions/{extension_id}/stop")
        if response.status_code != 204:
            raise Exception(response.content)
    ...
    def unregister_extension(self, extension_id: str) -> None:
        ...
        """
        self.client.delete(f"extensions/{extension_id}")
