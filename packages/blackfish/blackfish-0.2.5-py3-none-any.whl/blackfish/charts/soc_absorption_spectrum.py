...
def soc_absorption_spectrum_chart(
    df: pl.DataFrame, fwhm: int = 2000, peaks: bool = True, peak_threshold: float = 0.3
) -> alt.LayerChart:
    bar = (
        alt.Chart(df)
    ...
    if peaks:
        ...
        peak_indices, _ = find_peaks(y, height=peak_threshold)
        ...
        peak_layer = (
            ...
            .encode(x="energy_cm:Q", y="rel_intensity:Q")
        )
        chart += peak_layer
