"""
Setup script for types-boto3-workspaces-web.
...
setup(
    ...
    description="Type annotations for boto3 WorkSpacesWeb 1.35.93 service generated with mypy-boto3-builder 8.8.0",
    classifiers=[
    ...
    package_data={"types_boto3_workspaces_web": ["py.typed", "*.pyi"]},
    python_requires=">=3.8",
    project_urls={
