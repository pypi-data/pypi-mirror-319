...
[![PyPI - types-boto3-workspaces-web](https://img.shields.io/pypi/v/types-boto3-workspaces-web.svg?color=blue)](https://pypi.org/project/types-boto3-workspaces-web/)
[![PyPI - Python Version](https://img.shields.io/pypi/pyversions/types-boto3-workspaces-web.svg?color=blue)](https://pypi.org/project/types-boto3-workspaces-web/)
[![Docs](https://img.shields.io/readthedocs/boto3-stubs.svg?color=blue)](https://youtype.github.io/types_boto3_docs/)
[![PyPI - Downloads](https://static.pepy.tech/badge/types-boto3-workspaces-web)](https://pypistats.org/packages/types-boto3-workspaces-web)
...
[types-boto3-workspaces-web docs](https://youtype.github.io/types_boto3_docs/types_boto3_workspaces_web/).
...
- Install `types-boto3[workspaces-web]` in your environment:
...
- Install `types-boto3[workspaces-web]` with services you use in your
  environment:
...
`types_boto3_workspaces_web.paginator` module contains type annotations for all
paginators.
...
`types_boto3_workspaces_web.literals` module contains literals extracted from
shapes that can be used in user code for type checking.

Full list of `WorkSpacesWeb` Literals can be found in
[docs](https://youtype.github.io/types_boto3_docs/types_boto3_workspaces_web/literals/).
...
`types_boto3_workspaces_web.type_defs` module contains structures and shapes
assembled to typed dictionaries and unions for additional type checking.

Full list of `WorkSpacesWeb` TypeDefs can be found in
[docs](https://youtype.github.io/types_boto3_docs/types_boto3_workspaces_web/type_defs/).
...
`types-boto3-workspaces-web` version is the same as related `boto3` version and
...
[boto3 docs](https://youtype.github.io/types_boto3_docs/types_boto3_workspaces_web/)
