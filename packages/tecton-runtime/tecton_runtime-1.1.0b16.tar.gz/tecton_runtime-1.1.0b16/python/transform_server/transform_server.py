...
def calculate_max_concurrent_rpcs(max_workers: int) -> int:
    """
    Calculate the maximum number of concurrent RPCs based on the number of workers.
    The current default is 4x the number of workers.
    """
...
def main():
    ...
    if transform_server_groups_enabled:
        ...
        max_concurrent_rpcs = calculate_max_concurrent_rpcs(max_workers)
        try:
