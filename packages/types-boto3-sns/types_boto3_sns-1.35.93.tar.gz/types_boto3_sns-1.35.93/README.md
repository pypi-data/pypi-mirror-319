<a id="types-boto3-sns"></a>

# types-boto3-sns

[![PyPI - types-boto3-sns](https://img.shields.io/pypi/v/types-boto3-sns.svg?color=blue)](https://pypi.org/project/types-boto3-sns/)
[![PyPI - Python Version](https://img.shields.io/pypi/pyversions/types-boto3-sns.svg?color=blue)](https://pypi.org/project/types-boto3-sns/)
[![Docs](https://img.shields.io/readthedocs/boto3-stubs.svg?color=blue)](https://youtype.github.io/types_boto3_docs/)
[![PyPI - Downloads](https://static.pepy.tech/badge/types-boto3-sns)](https://pypistats.org/packages/types-boto3-sns)

![boto3.typed](https://github.com/youtype/mypy_boto3_builder/raw/main/logo.png)

Type annotations for [boto3 SNS 1.35.93](https://pypi.org/project/boto3/)
...
[types-boto3-sns docs](https://youtype.github.io/types_boto3_docs/types_boto3_sns/).

See how it helps you find and fix potential bugs:

![types-boto3 demo](https://github.com/youtype/mypy_boto3_builder/raw/main/demo.gif)

- [types-boto3-sns](#types-boto3-sns)
...
- Install `types-boto3[sns]` in your environment:
...
- Install `types-boto3[sns]` with services you use in your environment:
...
`types-boto3-sns` dependency in production. However, there is an issue in
...
`types_boto3_sns.paginator` module contains type annotations for all
paginators.
...
`types_boto3_sns.service_resource` module contains type annotations for all
resources.
...
from types_boto3_sns import SNSServiceResource
from types_boto3_sns.service_resource import (
    PlatformApplication,
    PlatformEndpoint,
    Subscription,
    Topic,
...
`types_boto3_sns.literals` module contains literals extracted from shapes that
can be used in user code for type checking.

Full list of `SNS` Literals can be found in
[docs](https://youtype.github.io/types_boto3_docs/types_boto3_sns/literals/).
...
`types_boto3_sns.type_defs` module contains structures and shapes assembled to
typed dictionaries and unions for additional type checking.

Full list of `SNS` TypeDefs can be found in
[docs](https://youtype.github.io/types_boto3_docs/types_boto3_sns/type_defs/).
...
`types-boto3-sns` version is the same as related `boto3` version and follows
...
[boto3 docs](https://youtype.github.io/types_boto3_docs/types_boto3_sns/)
