...
class Gld:
    ...
    def plot_pdf(self,params_list, disp_data= True, ymin= 0.01, ymax= 0.99, n_points= 100 , bins= None, names= None, color_emp = 'lightgrey', colors = None):
    ...
    def plot_cdf(self,params_list, disp_data= True, ymin= 0.01, ymax= 0.99, n_points= 100, names= None, color_emp = 'lightgrey', colors = None):
