...
class Gld:
    ...
    def plot_pdf(self,sample_array):
        """ Plots Probability Distribution of sample data
        
        Args:
            sample_array (array-like) : Sample data generated from GLD
    ...
    def plot_pdf(self,params_list, ymin= 0.01, ymax= 0.99, n_points= 500, bins= None, names= None, color_emp = 'lightgrey', colors = None):
        """ Plot probability density functions of GLD.

        Args:
            data (_type_): _description_
            params_list (_type_): _description_
            ymin (float, optional): _description_. Defaults to 0.01.
            ymax (float, optional): _description_. Defaults to 0.99.
            ...
            color_emp (str, optional): _description_. Defaults to 'lightgrey'.
        ...
        for i in range(len(param_list)):
            param = param_list[i]
            plt.plot(self._Q(param, y ), gld.pdf_x(param, y), color = colors[i])
            pdf_max = np.max([pdf_max,np.max(self.pdf_x(param, y))])
