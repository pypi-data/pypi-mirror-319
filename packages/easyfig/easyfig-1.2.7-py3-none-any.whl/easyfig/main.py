# Author: Yu-Xin Tian, 2025-01-06 Version 1.2.7
...
def makefig():
    ...
    def open_formula_converter(parent):
        ...
        # 自定义标题栏
        title_bar = tk.Frame(converter_window, bg="#0c2f6b", relief="raised", bd=2)
        title_bar.pack(fill="x", side="top")

        title_label = tk.Label(title_bar, text="LaTeX 到 SymPy 的转换器", bg="#0c2f6b", fg="white", font=("Arial", 12, "bold"))
        title_label.pack(side="left", padx=10)
    ...
    # 初始化主窗口
    root = tk.Tk()
    root.title("EasyFig仿真绘图向导 V1.2.7 - 作者：东北大学 田雨鑫 - 让天下没有难用的工具！")
