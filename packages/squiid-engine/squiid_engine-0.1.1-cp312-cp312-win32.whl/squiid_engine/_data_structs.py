...
class ConstantTypes(IntEnum):
    """
    An enum defining types of constants stored in a Bucket if the BucketTypes value is CONSTANT.
...
class Bucket:
    ...
    Attributes:
        ...
        constant_type (ConstantTypes): If `bucket_type` is a constant, this contains the specific constant
    """
...
class EngineSignalSet:
    """
    Struct to identify which EngineSignals were triggered during the submission of multiple commands to the engine.
    """
    ...
    def from_ffi(cls, ffi_signal: EngineSignalSet_FFI) -> "EngineSignalSet":
        ...
        Args:
            ffi_message (EngineSignalSet_FFI): The EngineSignalSet_FFI object
    ...
    def should_quit(self) -> bool:
        ...
        This means that the user requested that the engine quit, and thus the frontend should also quit.
