    ...
    def __init__(self, api_client=None):
        ...
        def __chat_assistant(
            ...
            **kwargs
            ...
            [Chat with an assistant](https://docs.pinecone.io/guides/assistant/chat-with-assistant#chat-with-an-assistant) and get back citations in structured form.   This is the recommended way to chat with an assistant, as it offers more functionality and control over the assistant's responses and references than the [OpenAI-compatible chat interface](https://docs.pinecone.io/guides/assistant/chat-with-assistant#chat-through-an-openai-compatible-interface).  # noqa: E501
        ...
        def __chat_completion_assistant(
            ...
            **kwargs
            ...
            [Chat with an assistant](https://docs.pinecone.io/guides/assistant/chat-with-assistant#chat-through-an-openai-compatible-interface). This endpoint is based on the OpenAI Chat Completion API, a commonly used and adopted API.   It is useful if you need inline citations or OpenAI-compatible responses, but has limited functionality compared to the [standard chat interface](https://docs.pinecone.io/guides/assistant/chat-with-assistant#chat-with-an-assistant).  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True
        ...
        def __context_assistant(
            ...
            **kwargs
            ...
            [Retrieve context snippets](https://docs.pinecone.io/guides/assistant/retrieve-context-snippets) from an assistant to use as part of RAG or any agentic flow.  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True
        ...
        def __delete_file(
            ...
            **kwargs
            ...
            [Delete an uploaded file](https://docs.pinecone.io/guides/assistant/manage-files#delete-a-file) from an assistant.  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True
        ...
        def __describe_file(
            ...
            **kwargs
            ...
            [Get the status and metadata of a file](https://docs.pinecone.io/guides/assistant/manage-files#get-the-status-of-a-file) uploaded to an assistant.  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True
        ...
        def __list_files(
            ...
            **kwargs
            ...
            [List all files in an assistant](https://docs.pinecone.io/guides/assistant/manage-files#list-files-in-an-assistant), with an option to filter files with metadata.  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True
        ...
        def __upload_file(
            ...
            **kwargs
            ...
            [Upload a file](https://docs.pinecone.io/guides/assistant/manage-files#upload-a-local-file) to the specified assistant.  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True
