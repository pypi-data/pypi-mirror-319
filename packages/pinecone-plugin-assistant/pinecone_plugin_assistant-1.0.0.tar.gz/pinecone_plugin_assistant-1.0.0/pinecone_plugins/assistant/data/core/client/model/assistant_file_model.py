...
class AssistantFileModel(ModelNormal):
    ...
    def _from_openapi_data(cls, name, id, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            metadata ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}, none_type): The metadata associated with the file.. [optional]  # noqa: E501
            created_on (str): The date and time the file was uploaded.. [optional]  # noqa: E501
            updated_on (str): The date and time the file was last updated.. [optional]  # noqa: E501
            status (str): The status of the file.. [optional]  # noqa: E501
            percent_done (float, none_type): The percentage of the file that has been processed. [optional]  # noqa: E501
            signed_url (str, none_type): A signed url that gives you access to the underlying file. [optional]  # noqa: E501
