...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-textract)](https://pypistats.org/packages/mypy-boto3-textract)
...
`mypy-boto3-textract` dependency in production. However, there is an issue in
