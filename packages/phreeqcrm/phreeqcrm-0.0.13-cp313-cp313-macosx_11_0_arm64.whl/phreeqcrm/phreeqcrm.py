...
class PhreeqcRM(object):
    ...
    def __init__(self, nxyz, thread_count_or_communicator, io=None, delay_construct=False):
        ...
        """
        _phreeqcrm.PhreeqcRM_swiginit(self, _phreeqcrm.new_PhreeqcRM(nxyz, thread_count_or_communicator, io, delay_construct))
...
class BMIPhreeqcRM(PhreeqcRM):
    ...
    def __init__(self):
        ...
        _phreeqcrm.BMIPhreeqcRM_swiginit(self, _phreeqcrm.new_BMIPhreeqcRM())
