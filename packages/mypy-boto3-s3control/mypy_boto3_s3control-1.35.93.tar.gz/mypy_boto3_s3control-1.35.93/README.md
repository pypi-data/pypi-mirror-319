...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-s3control)](https://pypistats.org/packages/mypy-boto3-s3control)
...
`mypy-boto3-s3control` dependency in production. However, there is an issue in
