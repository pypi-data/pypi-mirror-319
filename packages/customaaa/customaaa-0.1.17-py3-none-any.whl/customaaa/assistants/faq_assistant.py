...
.DS_Store'''
  ...
  <head>
      ...
      <style>
          :root {{
              --primary-color: {self.config.get('PRIMARY_COLOR', '#6B46C1')};
              --secondary-color: {self.config.get('SECONDARY_COLOR', '#805AD5')};
              --accent-color: #48BB78;
              --text-color: #333;
              --light-gray: #f5f6fa;
          }}
          ...
          * {{
          ...
          .hero::before {{
              ...
              right: 0;
              bottom: 0;
              background: linear-gradient({self.config.get('PRIMARY_COLOR', 'rgba(43, 108, 176, 0.8)')}, {self.config.get('SECONDARY_COLOR', 'rgba(66, 153, 225, 0.8)')}),
  ...
  <body>
      ...
      <script>
          // Add your JavaScript for chat widget functionality
