...
.DS_Store'''
    ...
    def _create_demo_website_content(self, assistant_url: str) -> str:
      ...
      bg_image = self.config.get('BG_IMAGE', 'https://i.ibb.co/3RdSX01/Leonardo-Kino-XL-two-retired-couple-enjoying-time-together-1.jpg')
    ...
    <div id="chat-widget" class="chat-widget">
        ...
        <div id="chat-window" class="chat-window hidden">
            ...
            <div class="chat-content">
                <iframe src=f'https://{self.config['HF_USERNAME']}-{self.config['SPACE_NAME']}.hf.space/?embed=true'></iframe>
            </div>
        </div>
    </div>
