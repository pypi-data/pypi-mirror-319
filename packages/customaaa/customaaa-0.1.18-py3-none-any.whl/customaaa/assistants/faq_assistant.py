...
.DS_Store'''
  ...
  <head>
      ...
      <style>
          ...
          * {{
          ...
          /* Copy all CSS styles from the example... */
          /* Including all animations, chat widget styles, etc. */
  ...
  <body>
      ...
      <!-- Copy all JavaScript from example -->
      <script>
          ...
          // Rest of the JavaScript from example...
      </script>
  </body>
  </html>"""
