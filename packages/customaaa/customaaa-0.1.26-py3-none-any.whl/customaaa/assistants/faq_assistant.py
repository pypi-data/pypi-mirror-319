...
.DS_Store'''
    ...
    def _create_demo_website_content(self, assistant_url: str) -> str:
      ...
      bg_image = self.config.get('BG_IMAGE', 'https://i.ibb.co/3RdSX01/Leonardo-Kino-XL-two-retired-couple-enjoying-time-together-1.jpg')  # Default to an empty string if not provided
      ...
      <style>
          ...
          * {{
          ...
          .hero {{
              ...
              background: url('{self.config["BG_IMAGE"]}') center/cover no-repeat;
              display: flex;
              align-items: center;
  ...
  <body>
      ...
      <section class="hero">
    <div class="hero-overlay"></div> <!-- Overlay for transparency -->
      ...
      <div class="chat-widget">
          <div class="chat-window">
              ...
              <div class="chat-content">
                  <iframe src="https://australia2025-ww233weew.hf.space/?embed=true"></iframe>
              </div>
          </div>
      </div>
  </body>
