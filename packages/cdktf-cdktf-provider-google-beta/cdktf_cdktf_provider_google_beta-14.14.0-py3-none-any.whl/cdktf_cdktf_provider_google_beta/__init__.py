r'''
# CDKTF prebuilt bindings for hashicorp/google-beta provider version 6.15.0

This repo builds and publishes the [Terraform google-beta provider](https://registry.terraform.io/providers/hashicorp/google-beta/6.15.0/docs) bindings for [CDK for Terraform](https://cdk.tf).
...
* [Terraform google-beta provider](https://registry.terraform.io/providers/hashicorp/google-beta/6.15.0)
