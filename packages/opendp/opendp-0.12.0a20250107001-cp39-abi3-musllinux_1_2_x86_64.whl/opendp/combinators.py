...
def make_approximate(
    ...
    [`make_approximate` in Rust documentation.](https://docs.rs/opendp/0.12.0-nightly.20250107.1/opendp/combinators/fn.make_approximate.html)
...
def make_basic_composition(
    ...
    * compositor: all privacy parameters specified up-front (via the map)
    ...
    [`make_basic_composition` in Rust documentation.](https://docs.rs/opendp/0.12.0-nightly.20250107.1/opendp/combinators/fn.make_basic_composition.html)
...
def make_chain_mt(
    ...
    [`make_chain_mt` in Rust documentation.](https://docs.rs/opendp/0.12.0-nightly.20250107.1/opendp/combinators/fn.make_chain_mt.html)
...
def make_chain_pm(
    ...
    [`make_chain_pm` in Rust documentation.](https://docs.rs/opendp/0.12.0-nightly.20250107.1/opendp/combinators/fn.make_chain_pm.html)
...
def make_chain_tt(
    ...
    [`make_chain_tt` in Rust documentation.](https://docs.rs/opendp/0.12.0-nightly.20250107.1/opendp/combinators/fn.make_chain_tt.html)
...
def make_fix_delta(
    ...
    [`make_fix_delta` in Rust documentation.](https://docs.rs/opendp/0.12.0-nightly.20250107.1/opendp/combinators/fn.make_fix_delta.html)
...
def make_population_amplification(
    ...
    [`make_population_amplification` in Rust documentation.](https://docs.rs/opendp/0.12.0-nightly.20250107.1/opendp/combinators/fn.make_population_amplification.html)
...
def make_pureDP_to_zCDP(
    ...
    [`make_pureDP_to_zCDP` in Rust documentation.](https://docs.rs/opendp/0.12.0-nightly.20250107.1/opendp/combinators/fn.make_pureDP_to_zCDP.html)
...
def make_select_private_candidate(
    ...
    [`make_select_private_candidate` in Rust documentation.](https://docs.rs/opendp/0.12.0-nightly.20250107.1/opendp/combinators/fn.make_select_private_candidate.html)
...
def make_sequential_composition(
    ...
    * compositor: all privacy parameters specified up-front
    ...
    [`make_sequential_composition` in Rust documentation.](https://docs.rs/opendp/0.12.0-nightly.20250107.1/opendp/combinators/fn.make_sequential_composition.html)
...
def make_zCDP_to_approxDP(
    ...
    [`make_zCDP_to_approxDP` in Rust documentation.](https://docs.rs/opendp/0.12.0-nightly.20250107.1/opendp/combinators/fn.make_zCDP_to_approxDP.html)
