...
class Embedder:
    ...
    def get_model_func(ssl: str) -> Callable:
        model_dict_func = {
            ...
            "monet_concept": partial(
                Embedder.load_monet_concept,
                out_dim=48,
            ),
        }
    ...
    def load_panderm(
        ...
        **kwargs,
        ...
        from .helper_panderm import panderm_large_patch16_224
        ...
        if return_info:
            ...
            info = SimpleNamespace()
            info.model_type = "ViT"
            info.ssl_type = "PanDerm"
            info.out_dim = kwargs.get("out_dim", 1024)
            return model, info, {}
        return model
    ...
    def load_monet_concept(
        ...
        **kwargs,
        ...
        # load the huggingface model
        model = MONETConceptWrapper(concept_list=kwargs.get("concept_list", None))
        if return_info:
            # information about the model
            info = SimpleNamespace()
            info.model_type = "ViT"
            info.ssl_type = "ImageNet-ViT"
            info.out_dim = kwargs.get("out_dim", 48)
            return model, info, {}
        return model
