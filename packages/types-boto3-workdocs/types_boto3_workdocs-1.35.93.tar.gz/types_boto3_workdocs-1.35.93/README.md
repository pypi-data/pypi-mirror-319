<a id="types-boto3-workdocs"></a>

# types-boto3-workdocs

[![PyPI - types-boto3-workdocs](https://img.shields.io/pypi/v/types-boto3-workdocs.svg?color=blue)](https://pypi.org/project/types-boto3-workdocs/)
[![PyPI - Python Version](https://img.shields.io/pypi/pyversions/types-boto3-workdocs.svg?color=blue)](https://pypi.org/project/types-boto3-workdocs/)
[![Docs](https://img.shields.io/readthedocs/boto3-stubs.svg?color=blue)](https://youtype.github.io/types_boto3_docs/)
[![PyPI - Downloads](https://static.pepy.tech/badge/types-boto3-workdocs)](https://pypistats.org/packages/types-boto3-workdocs)

![boto3.typed](https://github.com/youtype/mypy_boto3_builder/raw/main/logo.png)

Type annotations for [boto3 WorkDocs 1.35.93](https://pypi.org/project/boto3/)
...
[types-boto3-workdocs docs](https://youtype.github.io/types_boto3_docs/types_boto3_workdocs/).

See how it helps you find and fix potential bugs:

![types-boto3 demo](https://github.com/youtype/mypy_boto3_builder/raw/main/demo.gif)

- [types-boto3-workdocs](#types-boto3-workdocs)
...
- Install `types-boto3[workdocs]` in your environment:
...
- Install `types-boto3[workdocs]` with services you use in your environment:
...
`types-boto3-workdocs` dependency in production. However, there is an issue in
...
from types_boto3_workdocs import WorkDocsClient
...
`types_boto3_workdocs.paginator` module contains type annotations for all
paginators.
...
`types_boto3_workdocs.literals` module contains literals extracted from shapes
that can be used in user code for type checking.

Full list of `WorkDocs` Literals can be found in
[docs](https://youtype.github.io/types_boto3_docs/types_boto3_workdocs/literals/).
...
`types_boto3_workdocs.type_defs` module contains structures and shapes
assembled to typed dictionaries and unions for additional type checking.

Full list of `WorkDocs` TypeDefs can be found in
[docs](https://youtype.github.io/types_boto3_docs/types_boto3_workdocs/type_defs/).
...
`types-boto3-workdocs` version is the same as related `boto3` version and
...
[boto3 docs](https://youtype.github.io/types_boto3_docs/types_boto3_workdocs/)
