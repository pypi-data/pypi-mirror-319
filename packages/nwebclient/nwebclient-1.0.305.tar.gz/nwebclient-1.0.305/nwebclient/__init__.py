...
class NWebGroup:
    ...
    def is_root(self):
        return self.__data.get('parent') == 0
...
class NWebDoc:
    ...
    def getMeta(self):
        return json.loads(self.__client.reqGet('w/api/doc/'+self.__data['document_id']+'/meta'))
...
class NWebClient:
    ...
    def groups(self):
        ...
        return map(lambda g: NWebGroup(self, g), items)
