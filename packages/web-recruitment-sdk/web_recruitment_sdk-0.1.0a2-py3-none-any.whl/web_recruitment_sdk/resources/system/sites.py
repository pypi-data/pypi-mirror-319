...
class SitesResource(SyncAPIResource):
    ...
    def retrieve(
        ...
        *,
        ...
        return self._get(
            f"/system/{tenant_id}/sites/{site_id}",
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=SiteRead,
    ...
    def update(
        ...
        *,
        ...
        return self._patch(
            f"/system/{tenant_id}/sites/{site_id}",
            body=maybe_transform({"name": name}, site_update_params.SiteUpdateParams),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=SiteRead,
    ...
    async def update(
        ...
        *,
        ...
        return await self._patch(
            f"/system/{tenant_id}/sites/{site_id}",
            body=await async_maybe_transform({"name": name}, site_update_params.SiteUpdateParams),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=SiteRead,
