...
class TestProtocolParsings:
    ...
    def test_method_error(self, client: WebRecruitmentSDK) -> None:
        protocol_parsing = client.protocol_parsings.error(
            tenant="tenant",
            job_id="job_id",
        )
    ...
    def test_raw_response_error(self, client: WebRecruitmentSDK) -> None:
        response = client.protocol_parsings.with_raw_response.error(
            tenant="tenant",
            job_id="job_id",
        )
    ...
    def test_streaming_response_error(self, client: WebRecruitmentSDK) -> None:
        with client.protocol_parsings.with_streaming_response.error(
            tenant="tenant",
            job_id="job_id",
        ) as response:
            assert not response.is_closed
    ...
    def test_path_params_error(self, client: WebRecruitmentSDK) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `job_id` but received ''"):
            client.protocol_parsings.with_raw_response.error(
                tenant="tenant",
                job_id="",
            )
    ...
    def test_method_success(self, client: WebRecruitmentSDK) -> None:
        protocol_parsing = client.protocol_parsings.success(
            tenant="tenant",
            job_id="job_id",
            criteria_create=[
                {
    ...
    def test_raw_response_success(self, client: WebRecruitmentSDK) -> None:
        response = client.protocol_parsings.with_raw_response.success(
            tenant="tenant",
            job_id="job_id",
            criteria_create=[
                {
    ...
    def test_streaming_response_success(self, client: WebRecruitmentSDK) -> None:
        with client.protocol_parsings.with_streaming_response.success(
            tenant="tenant",
            job_id="job_id",
            criteria_create=[
                {
    ...
    def test_path_params_success(self, client: WebRecruitmentSDK) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `job_id` but received ''"):
            client.protocol_parsings.with_raw_response.success(
                tenant="tenant",
                job_id="",
                criteria_create=[
                    {
...
class TestAsyncProtocolParsings:
    ...
    async def test_method_error(self, async_client: AsyncWebRecruitmentSDK) -> None:
        protocol_parsing = await async_client.protocol_parsings.error(
            tenant="tenant",
            job_id="job_id",
        )
        assert_matches_type(object, protocol_parsing, path=["response"])
    ...
    async def test_raw_response_error(self, async_client: AsyncWebRecruitmentSDK) -> None:
        response = await async_client.protocol_parsings.with_raw_response.error(
            tenant="tenant",
            job_id="job_id",
        )
    ...
    async def test_streaming_response_error(self, async_client: AsyncWebRecruitmentSDK) -> None:
        async with async_client.protocol_parsings.with_streaming_response.error(
            tenant="tenant",
            job_id="job_id",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_error(self, async_client: AsyncWebRecruitmentSDK) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `job_id` but received ''"):
            await async_client.protocol_parsings.with_raw_response.error(
                tenant="tenant",
                job_id="",
            )
    ...
    async def test_method_success(self, async_client: AsyncWebRecruitmentSDK) -> None:
        protocol_parsing = await async_client.protocol_parsings.success(
            tenant="tenant",
            job_id="job_id",
            criteria_create=[
                {
    ...
    async def test_raw_response_success(self, async_client: AsyncWebRecruitmentSDK) -> None:
        response = await async_client.protocol_parsings.with_raw_response.success(
            tenant="tenant",
            job_id="job_id",
            criteria_create=[
                {
    ...
    async def test_streaming_response_success(self, async_client: AsyncWebRecruitmentSDK) -> None:
        async with async_client.protocol_parsings.with_streaming_response.success(
            tenant="tenant",
            job_id="job_id",
            criteria_create=[
                {
    ...
    async def test_path_params_success(self, async_client: AsyncWebRecruitmentSDK) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `job_id` but received ''"):
            await async_client.protocol_parsings.with_raw_response.success(
                tenant="tenant",
                job_id="",
                criteria_create=[
                    {
