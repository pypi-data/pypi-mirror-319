...
setup(
    ...
    data_files=[
        ...
        ('audiocat', ['audiocat_clark/killaudiocat.sh', 'audiocat_clark/mmack.sh', 'audiocat_clark/mmdata.sh', 'audiocat_clark/mmrx.sh', 'audiocat_clark/mmrxnopwd.sh', 'audiocat_clark/mmshellout.sh', 'audiocat_clark/mmtx.sh', 'audiocat_clark/mmtxfile.sh', 'audiocat_clark/install_dependencies.sh', 'audiocat_clark/version']),
        ...
        ('audiocat/state', ['audiocat_clark/state/rx_receiving_file', 'audiocat_clark/state/seq_rx', 'audiocat_clark/state/seq_tx', 'audiocat_clark/state/seq_tx_acked', 'audiocat_clark/state/session_established', 'audiocat_clark/state/transmitter_started', 'audiocat_clark/state/tx_sending_file']),
