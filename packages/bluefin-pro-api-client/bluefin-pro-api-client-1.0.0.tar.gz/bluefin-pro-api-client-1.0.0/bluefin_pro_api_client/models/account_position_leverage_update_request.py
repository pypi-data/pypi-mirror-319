...
class AccountPositionLeverageUpdateRequest(BaseModel):
    """
    AccountPositionLeverageUpdateRequest
    """ # noqa: E501
    signed_fields: AccountPositionLeverageUpdateRequestSignedFields = Field(alias="signedFields")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "signedFields": AccountPositionLeverageUpdateRequestSignedFields.from_dict(obj["signedFields"]) if obj.get("signedFields") is not None else None,
