...
class TestTickerUpdate(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TickerUpdate:
        """Test TickerUpdate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TickerUpdate`
        """
        model = TickerUpdate()
        if include_optional:
            return TickerUpdate(
