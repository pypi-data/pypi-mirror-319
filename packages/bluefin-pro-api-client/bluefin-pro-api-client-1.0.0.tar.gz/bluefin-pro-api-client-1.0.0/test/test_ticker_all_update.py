...
class TestTickerAllUpdate(unittest.TestCase):
    """TickerAllUpdate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TickerAllUpdate:
        """Test TickerAllUpdate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TickerAllUpdate`
        """
        model = TickerAllUpdate()
        if include_optional:
