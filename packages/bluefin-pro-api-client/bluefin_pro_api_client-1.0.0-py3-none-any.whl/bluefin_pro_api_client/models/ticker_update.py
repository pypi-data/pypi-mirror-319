...
class TickerUpdate(BaseModel):
    ...
    market_price_e9: StrictStr = Field(description="Simple average of bestBid and bestAsk, or lastPrice if either is not present (e9 format).", alias="marketPriceE9")
    ...
    high_price24hr_e9: StrictStr = Field(description="Highest Price in the last 24 hours (e9 format).", alias="highPrice24hrE9")
    low_price24hr_e9: StrictStr = Field(description="Lowest Price in the last 24 hours (e9 format).", alias="lowPrice24hrE9")
    volume24hr_e9: StrictStr = Field(description="Total market volume in last 24 hours of asset (e9 format).", alias="volume24hrE9")
