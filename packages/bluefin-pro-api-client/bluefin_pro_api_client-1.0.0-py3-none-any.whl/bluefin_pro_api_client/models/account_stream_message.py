...
class AccountStreamMessage(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["event", "reason", "payload"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "payload": AccountStreamMessagePayload.from_dict(obj["payload"]) if obj.get("payload") is not None else None
        })
        return _obj
