...
class RecentTradeUpdates(BaseModel):
    """
    RecentTradeUpdates
    """ # noqa: E501
    recent_trades: List[RecentTradeUpdate] = Field(alias="recentTrades")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "recentTrades": [RecentTradeUpdate.from_dict(_item) for _item in obj["recentTrades"]] if obj.get("recentTrades") is not None else None
        })
        return _obj
