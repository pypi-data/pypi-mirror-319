...
class SubscriptionResponseMessage(BaseModel):
    """
    Response message indicating the success or failure of a subscription operation.
    """ # noqa: E501
    success: StrictBool = Field(description="Indicates if the subscription operation was successful.")
    message: StrictStr = Field(description="Additional information about the subscription operation.")
