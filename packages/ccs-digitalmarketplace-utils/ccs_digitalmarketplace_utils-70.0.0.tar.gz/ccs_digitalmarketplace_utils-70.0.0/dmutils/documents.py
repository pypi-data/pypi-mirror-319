...
def validate_documents(files):
    ...
    """
    ID_TO_VALIDATION = {
        'groupOrConsortiumDetailsAttachment6URL': file_is_spreadsheet_format,
        'groupOrConsortiumDetailsAttachment4aURL': file_is_zip,
        'keySubcontractorsDetailsAttachment7URL': file_is_spreadsheet_format,
        'keySubcontractorsDetailsAttachment4bURL': file_is_zip,
        'modernSlaveryStatementDocumentURL': file_is_open_document_format,
        'modernSlaveryStillRelevantStatementDocumentURL': file_is_open_document_format,
    }
...
def file_is_less_than_5mb(file_):
    return get_file_size(file_) < 5_400_000


def file_is_less_than_10mb(file_):
    return get_file_size(file_) < 10_800_000
...
def generate_file_name(framework_slug, upload_type, supplier_id, service_id, field, filename, suffix=None):
    ...
    ID_TO_FILE_NAME_SUFFIX = {
        ...
        'keySubcontractorsDetailsAttachment7URL': 'attachment-7-subcontractors-details',
        'keySubcontractorsDetailsAttachment4bURL': 'attachment-4b-subcontractors-declaration',
        'modernSlaveryStatementDocumentURL': 'modern-slavery-statement',
        'modernSlaveryStillRelevantStatementDocumentURL': 'modern-slavery-statement',
    }
