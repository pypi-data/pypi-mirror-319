...
class TranscribeConfig(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["enable_language_switching", b"enable_language_switching", "language", b"language"]) -> None: ...
...
class TranslateConfig(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["enable_language_switching", b"enable_language_switching", "source_language", b"source_language"]) -> None: ...
...
class OneBestSegment(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["detected_source_language", b"detected_source_language", "end_time", b"end_time", "language", b"language", "source_language", b"source_language", "start_time", b"start_time", "text", b"text"]) -> None: ...
