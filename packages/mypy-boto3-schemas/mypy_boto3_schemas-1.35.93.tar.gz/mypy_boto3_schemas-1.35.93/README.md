...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-schemas)](https://pypistats.org/packages/mypy-boto3-schemas)
...
`mypy-boto3-schemas` dependency in production. However, there is an issue in
