...
def player_group_stats_parser(csv,loc="",groupurl="",authkey=""):
    ...
    info = pd.DataFrame([id,link,platform,pid,players,car_id,car_name,team,opp],index=["group id","group link","platform","id","name","car_id","car_name","team","opponent"])
    info = info.transpose()
