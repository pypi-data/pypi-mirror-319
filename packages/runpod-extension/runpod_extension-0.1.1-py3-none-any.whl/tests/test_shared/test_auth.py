...
class TestAPIKey(unittest.TestCase):
    ...
    def test_use_file_credentials(self, mock_file):
        ...
        """
        import runpod_extension  # pylint: disable=import-outside-toplevel

        importlib.reload(runpod_extension)
        self.assertEqual(runpod_extension.api_key, "RUNPOD_API_KEY")
