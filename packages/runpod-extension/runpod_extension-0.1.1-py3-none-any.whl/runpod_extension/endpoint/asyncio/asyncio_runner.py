...
from runpod_extension.endpoint.helpers import FINAL_STATES, is_completed
from runpod_extension.http_client import ClientSession
...
class Job:
    ...
    def __init__(self, endpoint_id: str, job_id: str, session: ClientSession):
        from runpod_extension import (  # pylint: disable=import-outside-toplevel,cyclic-import
            api_key,
            endpoint_url_base,
        )
