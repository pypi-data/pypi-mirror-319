...
from runpod_extension import error
from runpod_extension.user_agent import USER_AGENT
...
def run_graphql_query(query: str) -> Dict[str, Any]:
    ...
    Run a GraphQL query
    """
    from runpod_extension import api_key  # pylint: disable=import-outside-toplevel, cyclic-import
