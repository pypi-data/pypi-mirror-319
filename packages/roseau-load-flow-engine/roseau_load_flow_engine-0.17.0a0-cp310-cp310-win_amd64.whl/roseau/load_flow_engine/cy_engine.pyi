...
class CyElement:
    ...
    def connect_ports(self, ports: np.ndarray, n: int) -> None: ...
...
class CyBranch(CyElement):
    def connect(self, element: CyElement, connections: list[tuple[int, int]], beginning: bool) -> None: ...
    def get_currents(
        self, n1: int, n2: int
...
class CyThreePhaseTransformer(CyTransformer):
    def __init__(
        self, n1: int, n2: int, prim: str, sec: str, z2: complex, ym: complex, k: float, orientation: float
    ) -> None: ...
...
class CyAbstractNewton(CyAbstractSolver):
    ...
    def current_jacobian(self) -> np.ndarray[tuple[int, int], np.dtype[np.float64]]: ...  # tuple[int, int] -> matrix
