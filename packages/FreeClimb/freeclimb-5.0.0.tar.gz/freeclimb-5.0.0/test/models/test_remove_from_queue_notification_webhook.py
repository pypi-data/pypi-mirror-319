...
class TestRemoveFromQueueNotificationWebhook(unittest.TestCase):
    """RemoveFromQueueNotificationWebhook unit test stubs"""

    def setUp(self):
        self.model = RemoveFromQueueNotificationWebhook()

    def test_request_type(self):
        """Test RemoveFromQueueNotificationWebhook.request_type"""
    ...
    def test_call_status(self):
        """Test RemoveFromQueueNotificationWebhook.call_status"""
    ...
    def test_direction(self):
        """Test RemoveFromQueueNotificationWebhook.direction"""
    ...
    def test_queue_result(self):
        """Test RemoveFromQueueNotificationWebhook.queue_result"""
        self.model.queue_result = QueueResultStatus.QUEUE_FULL
        assert self.model.queue_result == QueueResultStatus.QUEUE_FULL
        self.model.queue_result = QueueResultStatus.DEQUEUED
        assert self.model.queue_result == QueueResultStatus.DEQUEUED
        self.model.queue_result = QueueResultStatus.HANGUP
        assert self.model.queue_result == QueueResultStatus.HANGUP
        self.model.queue_result = QueueResultStatus.SYSTEM_ERROR
        assert self.model.queue_result == QueueResultStatus.SYSTEM_ERROR

    def test_queue_time(self):
        """Test RemoveFromQueueNotificationWebhook.queue_time"""
