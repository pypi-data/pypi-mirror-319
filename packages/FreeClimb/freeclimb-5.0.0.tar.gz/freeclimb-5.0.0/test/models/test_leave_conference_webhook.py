...
class TestLeaveConferenceWebhook(unittest.TestCase):
    """LeaveConferenceWebhook unit test stubs"""

    def setUp(self):
        self.model = LeaveConferenceWebhook()

    def test_request_type(self):
        """Test LeaveConferenceWebhook.request_type"""

    def test_call_id(self):
        """Test LeaveConferenceWebhook.call_id"""
        self.model.call_id = "TEST_STRING"
        assert self.model.call_id == "TEST_STRING"

    def test_account_id(self):
        """Test LeaveConferenceWebhook.account_id"""
        self.model.account_id = "TEST_STRING"
        assert self.model.account_id == "TEST_STRING"

    def test_var_from(self):
        """Test LeaveConferenceWebhook.var_from"""
        self.model.var_from = "TEST_STRING"
        assert self.model.var_from == "TEST_STRING"

    def test_to(self):
        """Test LeaveConferenceWebhook.to"""
        self.model.to = "TEST_STRING"
        assert self.model.to == "TEST_STRING"

    def test_call_status(self):
        """Test LeaveConferenceWebhook.call_status"""
    ...
    def test_direction(self):
        """Test LeaveConferenceWebhook.direction"""
    ...
    def test_deserialize(self):
        ...
        assert isinstance(
            LeaveConferenceWebhook.deserialize(payload), LeaveConferenceWebhook
        )
