"""https://www.zabbix.com/documentation/7.2/en/manual/api/reference/discoveryrule/object"""
from zabbix_enums import _ZabbixEnum


class LLDRuleType(_ZabbixEnum):
    """
    https://www.zabbix.com/documentation/7.2/en/manual/api/reference/discoveryrule/object#lld-rule
...
class LLDRuleEvalType(_ZabbixEnum):
    """
    https://www.zabbix.com/documentation/7.2/en/manual/api/reference/discoveryrule/object#lld-rule-filter
...
class LLDRuleFilterConditionOperator(_ZabbixEnum):
    """
    https://www.zabbix.com/documentation/7.2/en/manual/api/reference/discoveryrule/object#lld-rule-filter-condition
...
class LLDRulePreprocessing(_ZabbixEnum):
    """
    https://www.zabbix.com/documentation/7.2/en/manual/api/reference/discoveryrule/object#lld-rule-preprocessing
...
class LLDRuleOverridesStop(_ZabbixEnum):
    """
    https://www.zabbix.com/documentation/7.2/en/manual/api/reference/discoveryrule/object#lld-rule-overrides
...
class LLDRuleOverrideFilterEvalType(_ZabbixEnum):
    """
    https://www.zabbix.com/documentation/7.2/en/manual/api/reference/discoveryrule/object#lld-rule-override-filter
...
class LLDRuleOverrideFilterConditionOperator(_ZabbixEnum):
    """
    https://www.zabbix.com/documentation/7.2/en/manual/api/reference/discoveryrule/object#lld-rule-override-filter-condition
...
class LLDRuleOverrideOperationObject(_ZabbixEnum):
    """
    https://www.zabbix.com/documentation/7.2/en/manual/api/reference/discoveryrule/object#lld-rule-override-operation
...
class LLDRuleOverrideOperationStatus(_ZabbixEnum):
    """
    https://www.zabbix.com/documentation/7.2/en/manual/api/reference/discoveryrule/object#lld-rule-override-operation-status
...
class LLDRuleOverrideOperationDiscover(_ZabbixEnum):
    """
    https://www.zabbix.com/documentation/7.2/en/manual/api/reference/discoveryrule/object#lld-rule-override-operation-discover
...
class LLDRuleOverrideOperationSeverity(_ZabbixEnum):
    """
    https://www.zabbix.com/documentation/7.2/en/manual/api/reference/discoveryrule/object#lld-rule-override-operation-severity
...
class LLDRuleOverrideOperationInventory(_ZabbixEnum):
    """
    https://www.zabbix.com/documentation/7.2/en/manual/api/reference/discoveryrule/object#lld-rule-override-operation-inventory
