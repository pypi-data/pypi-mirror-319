...
from mag_db.model.engine_type import EngineType
...
class Create(BaseSql):
    def __init__(self, table: Table):
        ...
        # 添加列名清单
        self.append_whole_columns(table.__columns)
...
if __name__ == '__main__':
    ...
    _table = Table(name="example_table", columns=_columns, primary_keys="id", comment="示例表", auto_increment=1)
