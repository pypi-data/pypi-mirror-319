...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-opensearch)](https://pypistats.org/packages/mypy-boto3-opensearch)

![boto3.typed](https://github.com/youtype/mypy_boto3_builder/raw/main/logo.png)

Type annotations for
[boto3 OpenSearchService 1.35.93](https://pypi.org/project/boto3/) compatible
...
`mypy-boto3-opensearch` dependency in production. However, there is an issue in
...
`mypy_boto3_opensearch.paginator` module contains type annotations for all
paginators.
