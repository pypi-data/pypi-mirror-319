"""Helper functions to work with value collection
"""
def data_merge(a, b):
    """
    ...
    try:
        ...
        if a is None or isinstance(a, (str, int, float)):
            ...
            if isinstance(b, dict):
                ...
                raise Exception(f'Cannot merge non-dict "{b}" into dict "{a}"') # pylint:disable=broad-exception-raised

        else:
            raise Exception(f'NOT IMPLEMENTED "{b}" into "{a}"') # pylint:disable=broad-exception-raised
