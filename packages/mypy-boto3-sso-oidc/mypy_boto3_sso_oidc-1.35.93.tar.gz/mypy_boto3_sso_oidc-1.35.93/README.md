...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-sso-oidc)](https://pypistats.org/packages/mypy-boto3-sso-oidc)
...
`mypy-boto3-sso-oidc` dependency in production. However, there is an issue in
