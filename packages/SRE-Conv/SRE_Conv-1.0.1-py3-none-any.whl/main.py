...
def main_worker(args):
    ...
    train_dataset = DataClass(
        split="train", transform=transform, download=True, size=args.medmnist_size
    )
    test_dataset = DataClass(
        split="test", transform=test_transform, download=True, size=args.medmnist_size
    )
    ...
    if "3d" in args.med_mnist:
        ...
        model = getattr(sre_resnet_3d, args.model_type)(
        ...
        if args.sre_conv_size_list != None:
            ...
            sre_conv_size = args.sre_conv_size
        model = getattr(sre_resnet, args.model_type)(
            num_classes=n_classes,
