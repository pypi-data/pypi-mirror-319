...
print('Software de visualizacao de arquivos de STS Nanosurf e Omicron v5.0.1')
...
print('Aquivos Omicron tipo .txt, .asc ou .ibw (IGOR) para grid. NAO MUDAR O NOME DO ARQUIVO PADRAO')
