...
setup(
    name="advenced-logger",             # 包名
    version="0.1.1",                 # 版本号
    author="Zongwei Du",            # 作者
    author_email="pxwtp6519@gmail.com",  # 作者邮箱
    description="Advanced logging configuration with support for multi-threading and multi-processing.Provides structured logging, context management, and automatic rotation.",  # 包的描述
    ...
    py_modules=["advenced_logger"],      # 自动发现所有子包
