...
class Unifier:
    ...
    @classmethod
    def query(cls, name, user=None, token=None, key=None, keys=None, as_of=None, back_to=None, up_to=None, asof_date=None, limit=None):
    ...
    @classmethod
    def get_dataframe(cls, name, user=None, token=None, key=None, keys=None, as_of=None, back_to=None, up_to=None, asof_date=None, limit=None):
        """Get the query result as a pandas DataFrame."""
        
        json_result = cls.query(name, user, token, key, keys, as_of, back_to, up_to, asof_date, limit)
