...
module_dir = os.path.join(__location__, "../src/celldex")
try:
...
try:
    from celldex import __version__ as version
except ImportError:
    version = ""
...
latex_documents = [
    ("index", "user_guide.tex", "celldex Documentation", "Jayaram Kancherla", "manual")
]
