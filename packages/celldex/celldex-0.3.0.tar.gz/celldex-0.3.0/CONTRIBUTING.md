...
Welcome to `celldex` contributor's guide.
...
If you experience bugs or general issues with `celldex`, please have a look
...
You can help improve `celldex` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`celldex` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `celldex`'s files. While this mechanism can
...
```
conda create -n celldex python=3 six virtualenv pytest pytest-cov
conda activate celldex
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/celldex.git
   cd celldex
   ```
...
5. Install [pre-commit]:
   ...
   `celldex` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/celldex
[issue tracker]: https://github.com/<USERNAME>/celldex/issues
