...
conf = {
    bstack1l11_opy_ (u"࠭ࡡࡱࡲࡢࡥࡺࡺ࡯࡮ࡣࡷࡩࠬၼ"): False,
    bstack1l11_opy_ (u"ࠧࡣࡵࡷࡥࡨࡱ࡟ࡴࡧࡶࡷ࡮ࡵ࡮ࠨၽ"): True,
    bstack1l11_opy_ (u"ࠨࡵ࡮࡭ࡵࡥࡳࡦࡵࡶ࡭ࡴࡴ࡟ࡴࡶࡤࡸࡺࡹࠧၾ"): False
}
class Config(object):
    instance = None
    def __init__(self):
        self._1111l1l1l1_opy_ = conf
    @classmethod
    def bstack11ll111lll_opy_(cls):
        if cls.instance:
            return cls.instance
        return Config()
    def get_property(self, property_name):
        return self._1111l1l1l1_opy_.get(property_name, None)
    def bstack1l1l1l1ll_opy_(self, property_name, bstack1111l1l1ll_opy_):
        self._1111l1l1l1_opy_[property_name] = bstack1111l1l1ll_opy_
    def bstack1l1111l11_opy_(self, val):
        self._1111l1l1l1_opy_[bstack1l11_opy_ (u"ࠩࡶ࡯࡮ࡶ࡟ࡴࡧࡶࡷ࡮ࡵ࡮ࡠࡵࡷࡥࡹࡻࡳࠨၿ")] = bool(val)
    def bstack111ll11l1l_opy_(self):
        return self._1111l1l1l1_opy_.get(bstack1l11_opy_ (u"ࠪࡷࡰ࡯ࡰࡠࡵࡨࡷࡸ࡯࡯࡯ࡡࡶࡸࡦࡺࡵࡴࠩႀ"), False)