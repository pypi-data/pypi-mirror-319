...
class ServerApi:
    ...
    def get_openapi_specification(
        self,
        format: Annotated[
            Optional[StrictStr], Field(description="OpenAPI specification format")
        ] = None,
        ...
        """Retrieves OpenAPI specification


        :param format: OpenAPI specification format
        :type format: str
        ...
        _param = self._get_openapi_specification_serialize(
            format=format,
    ...
    @validate_call
    def get_openapi_specification_with_http_info(
        self,
        format: Annotated[
            Optional[StrictStr], Field(description="OpenAPI specification format")
        ] = None,
    ...
    @validate_call
    def get_openapi_specification_without_preload_content(
        self,
        format: Annotated[
            Optional[StrictStr], Field(description="OpenAPI specification format")
        ] = None,
    ...
    def _get_openapi_specification_serialize(
        self,
        format,
        _request_auth,
        _content_type,
