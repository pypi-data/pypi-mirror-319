...
class SessionApi:
    ...
    def get_webui_session_info(
        ...
        _param = self._get_webui_session_info_serialize(
    ...
    @validate_call
    def get_webui_session_info_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def get_webui_session_info_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_webui_session_info_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/session/webui/info",
