...
class PROStorageObjectMetadata(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["authorizations", "label", "path"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PROStorageObjectMetadata from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PROStorageObjectMetadata from a dict"""
        if obj is None:
            return None
