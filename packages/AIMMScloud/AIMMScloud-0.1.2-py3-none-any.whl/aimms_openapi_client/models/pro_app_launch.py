...
class PROAppLaunch(BaseModel):
    """
    Represents a PRO app launch body
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["appName", "appVersion", "deviceId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PROAppLaunch from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PROAppLaunch from a dict"""
        if obj is None:
            return None
