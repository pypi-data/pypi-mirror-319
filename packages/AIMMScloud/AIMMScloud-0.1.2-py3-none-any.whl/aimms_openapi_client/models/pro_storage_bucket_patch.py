...
class PROStorageBucketPatch(BaseModel):
    """
    PROStorageBucketPatch
    """  # noqa: E501

    authorizations: Optional[List[EntityAuthorization]] = None
    label: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["authorizations", "label"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PROStorageBucketPatch from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PROStorageBucketPatch from a dict"""
        if obj is None:
            return None
