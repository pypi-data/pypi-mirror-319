...
class PROAppCategoryList(BaseModel):
    """
    PROAppCategoryList
    """  # noqa: E501

    applications: Optional[List[PROAppCategory]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PROAppCategoryList from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PROAppCategoryList from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "applications": (
                    [PROAppCategory.from_dict(_item) for _item in obj["applications"]]
