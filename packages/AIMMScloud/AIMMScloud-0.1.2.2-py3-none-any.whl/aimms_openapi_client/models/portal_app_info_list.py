...
class PortalAppInfoList(BaseModel):
    """
    PortalAppInfoList
    """  # noqa: E501

    applications: Optional[List[PortalAppInfo]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PortalAppInfoList from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PortalAppInfoList from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "applications": (
                    [PortalAppInfo.from_dict(_item) for _item in obj["applications"]]
