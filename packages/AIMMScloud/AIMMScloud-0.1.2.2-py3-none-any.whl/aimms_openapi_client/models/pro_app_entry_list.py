...
class PROAppEntryList(BaseModel):
    """
    PROAppEntryList
    """  # noqa: E501

    applications: Optional[List[PROAppEntry]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PROAppEntryList from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PROAppEntryList from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "applications": (
                    [PROAppEntry.from_dict(_item) for _item in obj["applications"]]
