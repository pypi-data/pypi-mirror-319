...
class EnvironmentInfo(BaseModel):
    ...
    id: StrictInt = Field(description="Unique ID of the environment")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of EnvironmentInfo from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of EnvironmentInfo from a dict"""
        if obj is None:
            return None
