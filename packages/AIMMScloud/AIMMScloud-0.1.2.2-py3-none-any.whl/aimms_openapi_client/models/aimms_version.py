...
class AimmsVersion(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["authorizations", "id"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AimmsVersion from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AimmsVersion from a dict"""
        if obj is None:
            return None
