...
class Buffer(Resource):
    ...
    def from_numpy(self, data: ArrayLike) -> None: ...
...
class BufferCursor(Object):
    ...
    @overload
    def __init__(self, element_layout: TypeLayoutReflection, buffer_resource: Buffer) -> None:
        """N/A"""

    @overload
    def __init__(self, element_layout: TypeLayoutReflection, buffer_resource: Buffer, size: int, offset: int) -> None:
        """N/A"""
...
class ComputeKernel(Kernel):
    ...
    def dispatch(self, thread_count: uint3param, vars: dict = {}, command_buffer: Optional[CommandBuffer] = None, **kwargs) -> None: ...
...
class Device(Object):
    ...
    @overload
    def create_buffer(self, size: int = 0, element_count: int = 0, struct_size: int = 0, struct_type: Optional[object] = None, format: Format = Format.unknown, usage: ResourceUsage = ResourceUsage.none, memory_type: MemoryType = MemoryType.device_local, debug_name: str = '', data: Optional[ArrayLike] = None) -> Buffer:
        """
        Create a new buffer.
    ...
    @overload
    def create_framebuffer(self, render_targets: Sequence[ResourceView], depth_stencil: Optional[ResourceView] = None, layout: Optional[FramebufferLayout] = None) -> Framebuffer:
        """
    ...
    @overload
    def create_graphics_pipeline(self, program: ShaderProgram, input_layout: Optional[InputLayout], framebuffer_layout: FramebufferLayout, primitive_type: PrimitiveType = PrimitiveType.triangle, depth_stencil: Optional[DepthStencilDescParam] = None, rasterizer: Optional[RasterizerDescParam] = None, blend: Optional[BlendDescParam] = None) -> GraphicsPipeline: ...
...
class FramebufferLayoutDesc:
    ...
    @property
    def depth_stencil(self) -> Optional[FramebufferLayoutTargetDesc]: ...
...
class RayTracingCommandEncoder:
    ...
    def build_acceleration_structure(self, inputs: AccelerationStructureBuildInputsBase, dst: AccelerationStructure, scratch_data: int, src: Optional[AccelerationStructure] = None) -> None: ...
...
class RenderCommandEncoder:
    ...
    def draw_indirect(self, max_draw_count: int, arg_buffer: Buffer, arg_offset: int, count_buffer: Optional[Buffer] = None, count_offset: int = 0) -> None: ...

    def draw_indexed_indirect(self, max_draw_count: int, arg_buffer: Buffer, arg_offset: int, count_buffer: Optional[Buffer] = None, count_offset: int = 0) -> None: ...
...
SGL_GIT_VERSION: str = 'commit: 0f6839c / branch: main (local changes)'

SGL_VERSION: str = '0.4.0'

SGL_VERSION_MAJOR: int = 0

SGL_VERSION_MINOR: int = 4
...
class Texture(Resource):
    ...
    def from_numpy(self, data: ArrayLike, mip_level: int = 0, array_slice: int = 0) -> None: ...
