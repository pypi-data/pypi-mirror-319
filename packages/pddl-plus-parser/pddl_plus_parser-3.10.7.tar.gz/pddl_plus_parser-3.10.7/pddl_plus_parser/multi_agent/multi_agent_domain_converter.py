...
class MultiAgentDomainsConverter:
    ...
    def export_combined_domain(self, add_dummy_actions: bool = False, output_folder: Optional[Path] = None) -> None:
        ...
        DomainExporter().export_domain(combined_domain, output_folder_path / f"{combined_domain.name.lower()}_combined_domain.pddl")
