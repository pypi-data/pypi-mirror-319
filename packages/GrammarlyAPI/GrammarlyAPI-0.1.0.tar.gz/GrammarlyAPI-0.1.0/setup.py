...
setup(
    name="GrammarlyAPI",                  # Package name on PyPI
    ...
    url="https://github.com/projectest20/GrammarlyAPI",  # URL to your project (GitHub repo or website)
    ...
    package_data={  # Include specific files for each package
        'GrammarlyAPI': ['static/*', 'templates/*', 'uploads/*','index.html', 'style.css', 'script.js'],  # Add paths to your static files
    },
    ...
    entry_points={
        "console_scripts": [
            "run-GrammarlyAPI=GrammarlyAPI.app:main",  # Maps to your `main()` function
        ]
    },
)
