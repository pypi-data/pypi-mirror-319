...
TimeDistributed, NullTransform= base_blocks.TimeDistributed, base_blocks.NullTransform
...
class VariableSelectionNetwork(nn.Module):
    ...
    def forward(self, flattened_embedding, context=None):
        ...
        outputs = processed_inputs * sparse_weights
        # Dimensions:
