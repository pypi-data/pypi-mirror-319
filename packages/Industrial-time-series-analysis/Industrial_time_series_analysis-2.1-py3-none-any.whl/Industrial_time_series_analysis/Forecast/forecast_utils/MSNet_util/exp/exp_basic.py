...
from Industrial_time_series_analysis.Forecast.forecast_utils.MSNet_util.models import  MSNet9,stdnet1

from Industrial_time_series_analysis.Forecast.forecast_utils.MSNet_util.models.stdnet import stdnet
