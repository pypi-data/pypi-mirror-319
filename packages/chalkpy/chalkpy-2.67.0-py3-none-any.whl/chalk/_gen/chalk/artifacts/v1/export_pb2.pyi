...
class Export(_message.Message):
    ...
    lsp: _lsp_pb2.LSP
    conversion_errors: _containers.RepeatedCompositeFieldContainer[_chalk_error_pb2.ChalkException]
    def __init__(
        self,
        ...
        conversion_errors: _Optional[_Iterable[_Union[_chalk_error_pb2.ChalkException, _Mapping]]] = ...,
    ) -> None: ...
