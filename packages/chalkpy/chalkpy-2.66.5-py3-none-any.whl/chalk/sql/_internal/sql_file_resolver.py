...
def get_sql_file_resolver(
    ...
    with (
            ...
            try:
                ...
                error_builder.add_diagnostic_with_spellcheck(
                    ...
                    spellcheck_candidates=[
                        feature.fqn
                        for feature in FeatureSetBase.registry[build_namespaced_name(name=parsed.namespace)].features
                    ],
                    message=message,
                    code="152",
        ...
        finalizer = parsed.comment_dict.count
        ...
        def fn(
            *input_values: Any,
            ...
            elif finalizer in [1, "one"]:
                func = func.one()
            elif finalizer == "one_or_none":
