...
class ArtifactFileLocationOut(BaseModel):
    """
    ArtifactFileLocationOut
    """ # noqa: E501
    filename: StrictStr
    link: StrictStr
    __properties: ClassVar[List[str]] = ["filename", "link"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ArtifactFileLocationOut from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ArtifactFileLocationOut from a dict"""
        if obj is None:
            return None
