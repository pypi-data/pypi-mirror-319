...
class ProjectAccessUser(BaseModel):
    ...
    """ # noqa: E501
    id: StrictInt
    is_manager: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["id", "is_manager"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ProjectAccessUser from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.is_manager is None and "is_manager" in self.model_fields_set:
            _dict['is_manager'] = None

        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ProjectAccessUser from a dict"""
        if obj is None:
            return None
