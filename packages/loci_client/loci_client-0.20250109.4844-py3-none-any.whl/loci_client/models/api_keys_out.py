...
class ApiKeysOut(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ApiKeysOut from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ApiKeysOut from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "data": [ApiKeyOut.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
            "count": obj.get("count")
        })
        return _obj
