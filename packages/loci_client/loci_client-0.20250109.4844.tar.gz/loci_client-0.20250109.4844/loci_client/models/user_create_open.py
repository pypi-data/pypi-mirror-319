...
class UserCreateOpen(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["email", "password", "full_name"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UserCreateOpen from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UserCreateOpen from a dict"""
        if obj is None:
            return None
