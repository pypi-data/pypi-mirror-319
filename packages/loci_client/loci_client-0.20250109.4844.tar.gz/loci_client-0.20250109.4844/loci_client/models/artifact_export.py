...
class ArtifactExport(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["descriptor", "priority", "type", "created_at", "notes"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ArtifactExport from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ArtifactExport from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "notes": [ArtifactNoteExport.from_dict(_item) for _item in obj["notes"]] if obj.get("notes") is not None else None
        })
        return _obj
