...
class ArtifactNoteUpdateIn(BaseModel):
    """
    ArtifactNoteUpdateIn
    """ # noqa: E501
    contents: Optional[StrictStr] = None
    type: Optional[ArtifactNoteTypeEnum] = None
    submission_tool: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["contents", "type", "submission_tool"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ArtifactNoteUpdateIn from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ArtifactNoteUpdateIn from a dict"""
        if obj is None:
            return None
