...
class ArtifactNoteExport(BaseModel):
    """
    ArtifactNoteExport
    """ # noqa: E501
    ...
    created_at: datetime
    updated_at: datetime
    __properties: ClassVar[List[str]] = ["type", "submission_tool", "contents", "author_id", "created_at", "updated_at"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ArtifactNoteExport from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ArtifactNoteExport from a dict"""
        if obj is None:
            return None
