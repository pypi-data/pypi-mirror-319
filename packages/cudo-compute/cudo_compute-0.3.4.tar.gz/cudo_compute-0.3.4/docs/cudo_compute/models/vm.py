...
class VM(object):
    ...
    def commitment_end_time(self, commitment_end_time):
        ...
        :type: datetime
        """
        if self._configuration.client_side_validation and commitment_end_time is None:
            raise ValueError("Invalid value for `commitment_end_time`, must not be `None`")  # noqa: E501
