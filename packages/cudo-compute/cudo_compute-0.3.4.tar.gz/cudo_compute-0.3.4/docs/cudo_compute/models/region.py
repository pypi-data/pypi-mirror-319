...
class Region(object):
    ...
    swagger_types = {
        'id': 'str',
        'name': 'str',
        'data_centers': 'list[RegionDataCenter]'
    }
    ...
    def __init__(self, id=None, name=None, data_centers=None, _configuration=None):  # noqa: E501
    ...
    def data_centers(self):
        """Gets the data_centers of this Region.  # noqa: E501


        :return: The data_centers of this Region.  # noqa: E501
        :rtype: list[RegionDataCenter]
        """
        return self._data_centers

    @data_centers.setter
    def data_centers(self, data_centers):
        """Sets the data_centers of this Region.


        :param data_centers: The data_centers of this Region.  # noqa: E501
        :type: list[RegionDataCenter]
        """
