...
class SSHKeysApi(object):
    ...
    def delete_ssh_key(self, id, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.delete_ssh_key_with_http_info(id, **kwargs)  # noqa: E501
            return data
    ...
    def get_ssh_key(self, id, **kwargs):  # noqa: E501
        """Get  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_ssh_key(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_ssh_key_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_ssh_key_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def get_ssh_key_with_http_info(self, id, **kwargs):  # noqa: E501
        """Get  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_ssh_key_with_http_info(id, async_req=True)
        >>> result = thread.get()
    ...
    def list_ssh_keys(self, **kwargs):  # noqa: E501
        """List  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.list_ssh_keys_with_http_info(**kwargs)  # noqa: E501
            return data

    def list_ssh_keys_with_http_info(self, **kwargs):  # noqa: E501
        """List  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='ListSshKeysResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
