...
class BaseManimAnimationWrapper:
    ...
    def __init__(self, animation_generator_instance_or_class: Union[BaseManimAnimation, BaseThreeDManimAnimation], types: Union[list[ManimAnimationType], ManimAnimationType]):
        ...
        types = [
            ...
            for type in (types if PythonValidator.is_list(types) else [types])
        ]
