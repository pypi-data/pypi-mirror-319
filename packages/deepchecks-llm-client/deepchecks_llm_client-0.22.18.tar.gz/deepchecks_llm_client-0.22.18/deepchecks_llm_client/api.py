...
class API:
    ...
    def log_batch(
        ...
        interactions: t.List[t.Union[LogInteraction, LogInteractionType]],
    ):
        return maybe_raise(
            self.session.post(
                "interactions",
    ...
    def get_interaction_type_config(self, application_id: int, interaction_type: str, file_save_path: t.Union[str, None] = None) -> str:
