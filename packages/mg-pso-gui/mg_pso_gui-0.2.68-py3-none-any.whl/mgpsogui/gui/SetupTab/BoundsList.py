        ...
        def import_csv():
            ...
            if filename is not None and filename != "":
                ...
                for _, row in df.iterrows():
                    ...
                    self.option_manager.add_bound(self.step_index, name, type_, min_bound, max_bound, default_value, calibration_strategy)

            self.clear()
            self.render()

        CTkButton(self.containerFrame, text="Import CSV", command=import_csv).grid(row=row, column=1, padx=(5, 5), pady=(5, 5), sticky="new")
