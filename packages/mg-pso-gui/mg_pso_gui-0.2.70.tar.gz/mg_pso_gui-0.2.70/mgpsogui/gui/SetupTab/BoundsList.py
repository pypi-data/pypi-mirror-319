        ...
        def import_csv():
            ...
            if filename is not None and filename != "":
                ...
                for _, row in df.iterrows():
                    ...
                    self.option_manager.add_bound(step_index=self.step_index, name=name, min_bound=min_bound, max_bound=max_bound, type=type_, default_value=default_value, calibration_strategy=calibration_strategy)
