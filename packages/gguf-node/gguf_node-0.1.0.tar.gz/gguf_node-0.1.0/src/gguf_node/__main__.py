...
if __name__ == "__main__":
    ...
    if choice=="1":
        # method#1: download the full pack (everything inside; no installation needed)
        ...
        # method#2: clone the gguf repo to custom_nodes
        repo_url = "https://github.com/calcuis/gguf"
        clone_github_repo(repo_url)
    # elif choice=="3": # as for the latest update; this copy was included in gguf repo already
    #     # method#3: clone the deployment copy of connector
    #     repo_url = "https://github.com/calcuis/gguf_connector"
    #     clone_github_repo(repo_url)
    else:
