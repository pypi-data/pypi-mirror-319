...
from dogpile_breaker.middleware import StorageBackendMiddleware
...
async def main() -> None:
    ...
    await region.configure(
        backend=RedisStorageBackend, backend_arguments={}, middlewares=[LoggingProxy, LoggingProxy2, another_prxy]
    )
    for _ in range(10):
