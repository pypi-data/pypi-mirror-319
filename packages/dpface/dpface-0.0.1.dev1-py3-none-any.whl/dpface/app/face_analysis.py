import logging, os, sys; logger = logging.getLogger(os.path.splitext(os.path.basename(__file__))[0]); logger.debug(__file__)
...
class FaceAnalysis:
    def __init__(self, name=DEFAULT_MP_NAME, root='~/.dpface', allowed_modules=None, **kwargs):
        ...
        for onnx_file in onnx_files:
            ...
            if model is None:
                ...
                logger.debug(f'find model: {onnx_file}, {model.taskname}, {model.input_shape}, {model.input_mean}, {model.input_std}')
