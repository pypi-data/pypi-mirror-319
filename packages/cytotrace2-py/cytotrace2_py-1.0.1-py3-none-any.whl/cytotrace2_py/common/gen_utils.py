...
def check_and_download_models():
    """
    Ensures that the 'models/' directory contains all 19 .pt files.
    If any are missing, download them from Google Drive.
    """

    model_dir = pkg_resources.resource_filename("cytotrace2_py", "resources/models")
    os.makedirs(model_dir, exist_ok=True)

    model_urls = {
        "model1.pt":  "https://drive.google.com/uc?export=download&id=1p9IYPEikAJrVCchVhsPodZ1ADaqcteyy",
        "model2.pt":  "https://drive.google.com/uc?export=download&id=1NZDKW-K9iHAqu-ZOzBbB40Ann6kQkzJu",
        "model3.pt":  "https://drive.google.com/uc?export=download&id=12fLBt_rFqSHkCgFkX5WrvIwa8zePzIci",
        "model4.pt":  "https://drive.google.com/uc?export=download&id=1pJwwXmIJHs5uHMZxGuY3AoU4keK1mu8-",
        "model5.pt":  "https://drive.google.com/uc?export=download&id=1UTdt35q15FL4IHiohre32vPBqxXRJpSk",
        "model6.pt":  "https://drive.google.com/uc?export=download&id=1F5s6z4y0zKZIVVrlkPThcp6cHAM694NM",
        "model7.pt":  "https://drive.google.com/uc?export=download&id=1Dqc33jZZkwSkkXKLDtYkdSC4oB_jSFg3",
        "model8.pt":  "https://drive.google.com/uc?export=download&id=1gs9UDOpBNZvM0_p31-ozn4vrybcLUldu",
        "model9.pt":  "https://drive.google.com/uc?export=download&id=1ijq63IK8hmQqZk2j1EofuVDCJtYcka_6",
        "model10.pt": "https://drive.google.com/uc?export=download&id=133BqnJc-7-jxDzhoql45OHXRXAa8B8R8",
        "model11.pt": "https://drive.google.com/uc?export=download&id=1YarR0teunMd4CrtpSB8nv0g9uwOve5VD",
        "model12.pt": "https://drive.google.com/uc?export=download&id=1mmpilYiClb_rdf70WNmbJIKhYCiZStWZ",
        "model13.pt": "https://drive.google.com/uc?export=download&id=1ftMmon9nNT69fP30j7RhRPmU0U1A6jkE",
        "model14.pt": "https://drive.google.com/uc?export=download&id=1DjlcVG5iHoahqbAdC6XL7rswn-9L3j2v",
        "model15.pt": "https://drive.google.com/uc?export=download&id=1jPRWpTnF4j1uW2wPCSXn7UfvZUWV_VTO",
        "model16.pt": "https://drive.google.com/uc?export=download&id=1yJx7XZOVX_8oKwtVn21HG_bganqegPf3",
        "model17.pt": "https://drive.google.com/uc?export=download&id=1vC2MkSdBD6WcQcsMI9qHf9TtJR7ha7G5",
        "model18.pt": "https://drive.google.com/uc?export=download&id=118daDRp5VtBbS7pQ1B-503Ooof-WNs17",
        "model19.pt": "https://drive.google.com/uc?export=download&id=1Vu8jkYIUL30poIwYmbJ6WAD63Ee6--IE"
    }
    ...
    if len(pt_files) < 19:
        print("Warning: Not all models were downloaded successfully.")
    else:
