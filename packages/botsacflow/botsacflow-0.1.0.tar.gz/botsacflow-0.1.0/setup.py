...
setup(
    name="botsacflow",
    version="0.1.0",
    description='A class for interacting with the Sacflow API to send WhatsApp message for RPA',
    author='Ben-Hur P. B. Santos',
    author_email='botlorien@gmail.com',
    long_description=open("README.md", encoding='utf-8').read(),
    long_description_content_type="text/markdown",
    url="https://github.com/botlorien/botsacflow",  # Link para o repositório
