...
badd +3 pyproject.toml
badd +1 src/textual_spinbox/demo.py
badd +106 src/textual_spinbox/spinbox.py
badd +24 README.md
...
argglobal
balt src/textual_spinbox/spinbox.py
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
setlocal nowrap
setlocal wrapmargin=0
let s:l = 29 - ((12 * winheight(0) + 14) / 29)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 29
let s:c = 45 - ((22 * winwidth(0) + 31) / 63)
if s:c > 0
