...
logger = Loggers().waker
RESOURCE_FILE = get_absolute_path_based_on_reference_file(
    __file__,
...
class HotwordDetector(object):
    ...
    :param decoder_model: decoder model file path, a string or a list of strings  # noqa: E501
    ...
    def start(self, detected_callback=None,
        ...
        :param detected_callback: a function or list of functions. The number of  # noqa: E501
