...
def find_running_recorder(customer_auth, username):
    global recorder_handler
...
def get_user_insights(customer_auth,username, api_config = API_CONFIG):
    insight_handler = Insight_User_Handler(customer_auth, api_config)
    cam = Customer_Account_Manager(customer_auth, api_config)
    user_id = cam.get_user_id(username)
    insights = insight_handler.get_user_insights(user_id)
    return insights


def get_user_alltime_insights(customer_auth,username,start_date,end_date,insight_type="output$neurobrave_stress2",boundry="hour", api_config = API_CONFIG):
    insight_handler = Insight_User_Handler(customer_auth, api_config)
    cam = Customer_Account_Manager(customer_auth, api_config)
    user_id = cam.get_user_id(username)
    
    insights = insight_handler.get_user_alltime_insights(user_id,start_date,end_date,insight_type,boundry)
    return insights


def get_user_insights_stats(customer_auth,username,daily_date,insight_type="output$neurobrave_stress2",boundry="day", api_config = API_CONFIG):
    """
    ...
    cam = Customer_Account_Manager(customer_auth, api_config)
    user_id = cam.get_user_id(username)
    insights = insight_handler.get_user_insights_stats(user_id,daily_date,insight_type,boundry)
    
    return insights

def get_user_all_insights_stats(customer_auth,username,daily_date,insight_type="output$neurobrave_stress2",boundry="day", api_config = API_CONFIG):
    """
    ...
    insights = insight_handler.get_user_all_insights_stats(user_id,daily_date,insight_type, boundry)
    return insights

def get_user_stress_baseline(auth, username = None, api_config = API_CONFIG, insight_type="output$neurobrave_stress2"):
    """
...
def get_user_daily_stress(auth, daily_date, timezone = None, username = None, api_config = API_CONFIG):
    """
    The function will return the daily stress
    """
    insight_handler = Insight_User_Handler(auth, api_config)
...
def get_user_battery(auth, daily_date, timezone = None, username = None, api_config = API_CONFIG):
    """
    The function will return the daily stress
    """
    insight_handler = Insight_User_Handler(auth, api_config)
...
def get_user_hourly_insights(auth, daily_date,timezone = None, username = None, api_config = API_CONFIG):
    insight_handler = Insight_User_Handler(auth, api_config)
...
def get_user_history_hourly_insights(auth, timezone = None, username = None, api_config = API_CONFIG):
    insight_handler = Insight_User_Handler(auth, api_config)
...
def get_weekly_stress_average(auth, daily_date, timezone = None, username = None, api_config = API_CONFIG):
    """
...
def get_weekly_stress_change(auth, daily_date, timezone = None, username = None, api_config = API_CONFIG):
    """
...
def get_weekly_stress_index(auth, daily_date, timezone = None, username = None, api_config = API_CONFIG):
    """
...
def get_weekly_best_sleep(auth, daily_date, username = None, api_config = API_CONFIG):
    """
...
def get_weekly_worst_sleep(auth, daily_date, username = None, api_config = API_CONFIG):
    """
    The function will return the night and the value of the best sleep
    """
    insight_handler = Insight_User_Handler(auth, api_config)
...
def get_weekly_stressful_time(auth, daily_date, timezone = None, username = None, api_config = API_CONFIG):
    """
...
def get_weekly_quiet_time(auth, daily_date, timezone = None, username = None, api_config = API_CONFIG):
    """
    The function will return the most stressful time in the week
    """
    insight_handler = Insight_User_Handler(auth, api_config)
...
def delete_recording(recorder_id):
    recorder_handler.delete_recorder(recorder_id) 
...
def get_all_existing_users(customer_auth, page_number = 1, page_size = 50):
    '''
    ...
    customer_account = Customer_Account_Manager(customer_auth)
...
def init_HIA_client(config, hia_config, use_local_timestamp = False):
    '''
