...
class StationControlClient:
    ...
    def query_runs(self, **kwargs) -> ListWithMeta[RunLite]:
        ...
        return ListWithMeta(RunLiteList.model_validate(response_with_meta.items), meta=response_with_meta.meta)
    ...
    def create_observations(
        ...
        response_with_meta = ResponseWithMeta(**response.json())
        return ListWithMeta(ObservationDataList.model_validate(response_with_meta.items), meta=response_with_meta.meta)
    ...
    def query_observation_sets(self, **kwargs) -> ListWithMeta[ObservationSetData]:
        ...
        response_with_meta = ResponseWithMeta(**response.json())
        return ListWithMeta(
            ObservationSetDataList.model_validate(response_with_meta.items), meta=response_with_meta.meta
        )
    ...
    def query_sequence_metadatas(self, **kwargs) -> ListWithMeta[SequenceMetadataData]:
        ...
        response_with_meta = ResponseWithMeta(**response.json())
        return ListWithMeta(
            SequenceMetadataDataList.model_validate(response_with_meta.items), meta=response_with_meta.meta
        )
