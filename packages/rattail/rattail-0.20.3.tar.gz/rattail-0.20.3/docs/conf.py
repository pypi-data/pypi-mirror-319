...
# sphinx-quickstart on Thu Dec 19 23:18:17 2013.
#
...
# Must import this early to ensure things work good.
import rattail.db.model

exec(open(os.path.join(os.pardir, 'rattail', '_version.py')).read())
...
latex_documents = [
  ('index', 'rattail.tex', u'rattail Documentation',
   u'Lance Edgar \\textless{}lance@edbob.org\\textgreater{}', 'manual'),
]
...
man_pages = [
    ('index', 'rattail', u'rattail Documentation',
     [u'Lance Edgar <lance@edbob.org>'], 1)
]
...
texinfo_documents = [
  ('index', 'rattail', u'rattail Documentation',
   u'Lance Edgar <lance@edbob.org>', 'rattail', 'One line description of project.',
   'Miscellaneous'),
]
