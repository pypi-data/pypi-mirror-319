...
setup(
    name="SmartCVParserAPI",                  # Package name on PyPI
    ...
    url="https://github.com/projectest20/SmartCVParserAPI",  # URL to your project (GitHub repo or website)
    ...
    package_data={  # Include specific files for each package
        'SmartCVParserAPI': ['static/*', 'templates/*', 'uploads/*','index.html','interact.html','styles.css'],  # Add paths to your static files
    },
    ...
    entry_points={
        "console_scripts": [
            "run-SmartCVParserAPI=SmartCVParserAPI.app6:main",  # Maps to your `main()` function
        ]
    },
)
