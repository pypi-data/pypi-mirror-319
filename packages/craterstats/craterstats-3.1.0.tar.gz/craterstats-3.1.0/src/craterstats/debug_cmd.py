...
def main():
    ...
    #workdir = r"D:\mydocs\work\_gyig\zhang li\2024-05-31 ce6 region dating\2024-12-13 kaguya w5 measurement\li - original"
    os.chdir(workdir)
    ...
    cmd = r'-cs neukumivanov -title Example plot -p source=%sample%/Pickering.scc -p type=poisson,range=[b8,b-5]'
    cmd = r'--functions_user "D:\mydocs\code\pycharm\craterstats\src\craterstats\config\functions_user.txt"'
    cmd = r'-i "D:\mydocs\work\_gyig\zhang li\2024-05-31 ce6 region dating\2024-12-13 kaguya w5 measurement\gm\greg_w5l2.cs"'

    #cmd = r'-pr cumul -cs neukumivanov -pd 8x8'+dir
