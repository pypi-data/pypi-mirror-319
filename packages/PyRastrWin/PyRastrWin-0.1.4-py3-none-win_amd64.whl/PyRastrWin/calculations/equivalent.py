"""
Модуль предназначен для эквивалентирования
"""
...
def ekv(rastr_win: CDispatch, par: str = "") -> bool:
    """
    Эквивалентирование режима.
    ...
    :return None
    """
    logger.info("Эквивалентирование запущенно")
    params = {
        "": ["", "c параметрами по умолчанию"],
