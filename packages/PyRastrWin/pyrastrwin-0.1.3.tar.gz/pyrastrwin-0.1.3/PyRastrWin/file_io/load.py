...
def load(
    ...
    - если не задано название или путь шаблона: name_template, то загружается - без шаблона;
    ...
    :param kod_rg: Числовое значение, определяет режим загрузки при наличии таблицы в рабочей области.
    ...
    :param filename: абсолютный путь с именем файла (пример: Path("C:\\Folder\\ДРМ.rst").
    :param name_template: Шаблон RastrWin3 для загрузки пример:
