...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-stepfunctions)](https://pypistats.org/packages/mypy-boto3-stepfunctions)
...
`mypy-boto3-stepfunctions` dependency in production. However, there is an issue
