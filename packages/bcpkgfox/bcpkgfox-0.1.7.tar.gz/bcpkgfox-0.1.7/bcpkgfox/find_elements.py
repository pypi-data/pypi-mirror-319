...
def move_to_image(imagem, click_on_final=False, tolerancia=1, timeout=10):
    """Move o mouse até o centro de uma imagem na tela e clica, se necessário.

    Args: imagem (str): Caminho da imagem a ser localizada. click_on_final (bool): Se True, realiza um clique ao final.
    Exemplo: caminho_imagem = 'C:\\User\\Caminho\\exemplo.png' move_to_image(caminho_imagem, click_on_final=True, tolerancia=0.9)
    Nota: Recomenda-se colocar a imagem na mesma pasta do arquivo MAIN para evitar problemas ao gerar o executável com pyinstaller e rodar em outras máquinas.
    """
    attempts = 0
