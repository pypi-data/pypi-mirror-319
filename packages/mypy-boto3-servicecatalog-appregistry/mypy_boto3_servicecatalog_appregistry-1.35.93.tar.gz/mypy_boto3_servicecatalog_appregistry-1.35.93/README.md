...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-servicecatalog-appregistry)](https://pypistats.org/packages/mypy-boto3-servicecatalog-appregistry)
...
`mypy-boto3-servicecatalog-appregistry` dependency in production. However,
