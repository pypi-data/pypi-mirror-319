...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-redshift-serverless)](https://pypistats.org/packages/mypy-boto3-redshift-serverless)
...
`mypy-boto3-redshift-serverless` dependency in production. However, there is an
