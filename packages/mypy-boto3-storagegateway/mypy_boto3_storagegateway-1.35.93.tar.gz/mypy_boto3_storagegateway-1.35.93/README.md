...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-storagegateway)](https://pypistats.org/packages/mypy-boto3-storagegateway)
...
`mypy-boto3-storagegateway` dependency in production. However, there is an
