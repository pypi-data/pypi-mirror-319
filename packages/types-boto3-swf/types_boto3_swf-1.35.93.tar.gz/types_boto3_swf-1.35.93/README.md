<a id="types-boto3-swf"></a>

# types-boto3-swf

[![PyPI - types-boto3-swf](https://img.shields.io/pypi/v/types-boto3-swf.svg?color=blue)](https://pypi.org/project/types-boto3-swf/)
[![PyPI - Python Version](https://img.shields.io/pypi/pyversions/types-boto3-swf.svg?color=blue)](https://pypi.org/project/types-boto3-swf/)
[![Docs](https://img.shields.io/readthedocs/boto3-stubs.svg?color=blue)](https://youtype.github.io/types_boto3_docs/)
[![PyPI - Downloads](https://static.pepy.tech/badge/types-boto3-swf)](https://pypistats.org/packages/types-boto3-swf)

![boto3.typed](https://github.com/youtype/mypy_boto3_builder/raw/main/logo.png)

Type annotations for [boto3 SWF 1.35.93](https://pypi.org/project/boto3/)
...
[types-boto3-swf docs](https://youtype.github.io/types_boto3_docs/types_boto3_swf/).

See how it helps you find and fix potential bugs:

![types-boto3 demo](https://github.com/youtype/mypy_boto3_builder/raw/main/demo.gif)

- [types-boto3-swf](#types-boto3-swf)
...
- Install `types-boto3[swf]` in your environment:
...
- Install `types-boto3[swf]` with services you use in your environment:
...
`types-boto3-swf` dependency in production. However, there is an issue in
...
from types_boto3_swf import SWFClient
...
`types_boto3_swf.paginator` module contains type annotations for all
paginators.
...
`types_boto3_swf.literals` module contains literals extracted from shapes that
can be used in user code for type checking.

Full list of `SWF` Literals can be found in
[docs](https://youtype.github.io/types_boto3_docs/types_boto3_swf/literals/).
...
`types_boto3_swf.type_defs` module contains structures and shapes assembled to
typed dictionaries and unions for additional type checking.

Full list of `SWF` TypeDefs can be found in
[docs](https://youtype.github.io/types_boto3_docs/types_boto3_swf/type_defs/).
...
`types-boto3-swf` version is the same as related `boto3` version and follows
...
[boto3 docs](https://youtype.github.io/types_boto3_docs/types_boto3_swf/)
