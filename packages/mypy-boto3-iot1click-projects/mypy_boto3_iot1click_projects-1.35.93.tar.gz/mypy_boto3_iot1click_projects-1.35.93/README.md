...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-iot1click-projects)](https://pypistats.org/packages/mypy-boto3-iot1click-projects)
...
`mypy-boto3-iot1click-projects` dependency in production. However, there is an
