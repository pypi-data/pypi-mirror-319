...
class EryonMessages:
  ...
  ░██████████ ░████       ░████▓    ▓████████░  ▓███▒  ████  ████    ░████ ████    █████████████████░  
   ▒▒▒▒▒▒▒▒▒░  ░▒▒░        ████        ▓██▓      ▒▒░   ░▒▒░  ▒▒▒      ░▒▒▒ ░▒▒░     ░██████████████    
                        ...
                        ████░                                                                          
"""
    has_printed = False  # Flag to prevent repeating the print statements
    ...
    def show_welcome_message(cls):
        if not cls.has_printed:  # Only print once
            print(cls.ascii_art)
            cls.detect_hardware()
            cls.has_printed = True
...
# Show welcome message on module import
EryonMessages.show_welcome_message()
...
# Function to be called whenever the model is used
def show_messages():
    EryonMessages.show_welcome_message()

# Register the show_messages function to be called on exit
