...
@LastEditTime: 2024-12-18 14:59:48
        ...
        while True:
            try:
                ...
                try:
                    ...
                    stat_report_condition = "app_id=%s and act_id=%s and module_id=%s and create_day=%s and user_id=%s"
                    stat_report_param = [stat_queue_dict["app_id"], stat_queue_dict["act_id"], stat_queue_dict["module_id"], create_day_int, stat_queue_dict["user_id"]]
