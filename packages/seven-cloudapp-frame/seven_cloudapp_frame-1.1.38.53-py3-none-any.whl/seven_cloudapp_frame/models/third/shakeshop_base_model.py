...
@LastEditTime: 2025-01-07 17:26:45
...
class ShakeShopBaseModel():
    ...
    def m_get_member_info_by_open_id_list(self, app_id, open_id_list, extend_info_list, is_log=False):
        """
        ...
        invoke_result_data = InvokeResultData()
        try:
            params = {"app_id": app_id, "open_id_list": open_id_list, "extend_info_list": extend_info_list}
    ...
    def batch_get_open_id_list_by_union_id(self, union_id_list, is_log=False):
        """
        :description: 服务商可以根据品牌维度的用户唯一身份UnionId来查询品牌下每个店铺的用户OpenId
    ...
    def batch_get_history_member_union_id(self, app_id, open_id_list, is_log=False):
        """
        :description:【品牌会员店铺专用】根据店铺会员的openId获取品牌维度的用户身份标识unionId
