...
@LastEditTime: 2024-06-24 15:41:23
...
class TopBaseModel():
    ...
    def get_buy_order_list(self, open_id, access_token, app_key, app_secret, start_created="", end_created="", page_size=50, is_log=False, type="fixed,step",field="tid,status,payment,price,created,orders,num,pay_time,step_trade_status,step_paid_fee,type,outer_iid"):
        """
