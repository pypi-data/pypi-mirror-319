...
class Condition(_message.Message):
    __slots__ = ["last_transition_time", "deployment_status", "message", "revision"]
    ...
    message: str
    revision: int
    def __init__(self, last_transition_time: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., deployment_status: _Optional[_Union[Status.DeploymentStatus, str]] = ..., message: _Optional[str] = ..., revision: _Optional[int] = ...) -> None: ...

class Status(_message.Message):
    __slots__ = ["assigned_cluster", "current_replicas", "ingress", "created_at", "last_updated_at", "conditions"]
...
class Spec(_message.Message):
    __slots__ = ["container", "pod", "autoscaling", "ingress", "desired_state", "cluster_pool", "images", "security_context"]
