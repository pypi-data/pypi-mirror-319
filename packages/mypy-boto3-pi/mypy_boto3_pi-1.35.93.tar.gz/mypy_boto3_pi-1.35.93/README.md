...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-pi)](https://pypistats.org/packages/mypy-boto3-pi)

![boto3.typed](https://github.com/youtype/mypy_boto3_builder/raw/main/logo.png)

Type annotations for [boto3 PI 1.35.93](https://pypi.org/project/boto3/)
...
`mypy-boto3-pi` dependency in production. However, there is an issue in
