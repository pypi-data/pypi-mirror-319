...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-ram)](https://pypistats.org/packages/mypy-boto3-ram)

![boto3.typed](https://github.com/youtype/mypy_boto3_builder/raw/main/logo.png)

Type annotations for [boto3 RAM 1.35.93](https://pypi.org/project/boto3/)
...
`mypy-boto3-ram` dependency in production. However, there is an issue in
