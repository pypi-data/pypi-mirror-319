...
[aiobotocore 2.17.0](https://pypi.org/project/aiobotocore/) compatible with
...
- `types-aiobotocore-lite[full]` - Type annotations for all 405 services in one
  package (recommended).
- `types-aiobotocore-lite[all]` - Type annotations for all 405 services in
  separate packages.
