...
![masim stairs heatmap in ascii](https://raw.githubusercontent.com/damonitor/damo/v2.6.3/images/masim_stairs_heatmap_ascii.png)
...
For more detailed usage, please refer to [USAGE.md](https://github.com/damonitor/damo/blob/v2.6.3/USAGE.md) file.
...
In short, features that documented on [USAGE.md](https://github.com/damonitor/damo/blob/v2.6.3/USAGE.md) and not explicitly
