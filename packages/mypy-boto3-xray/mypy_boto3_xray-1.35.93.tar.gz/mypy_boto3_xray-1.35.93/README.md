...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-xray)](https://pypistats.org/packages/mypy-boto3-xray)
...
`mypy-boto3-xray` dependency in production. However, there is an issue in
