...
class BlurLoader(QuantityLoader):
    ...
    def behavior_attrs(self):
        '''list of attrs in self which affect behavior of self.
        Here, returns ['blur_dims', 'blur_sigma'] + any values from super().
        '''
        return ['blur_dims', 'blur_sigma'] + getattr(super(), 'behavior_attrs', [])
    ...
    blur_sigma = simple_property('_blur_sigma', default=None,
