...
class BasicArithmeticLoader(QuantityLoader):
    ...
    @known_var
    def get_0(self):
        '''0, as an xarray. Included for discoverability. Actual code will use self.get_int instead.'''
        return xr.DataArray(0)

    @known_var
    def get_1(self):
        '''1, as an xarray. Included for discoverability. Actual code will use self.get_int instead.'''
