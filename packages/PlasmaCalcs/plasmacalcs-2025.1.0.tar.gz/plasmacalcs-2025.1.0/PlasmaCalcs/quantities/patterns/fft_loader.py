...
from ...errors import DimensionError, DimensionKeyError, InputError
from ...tools import (
    simple_setdefault_property, simple_setdefaultvia_property, alias, alias_child,
    format_docstring,
    UNSET,
...
class FFTLoader(QuantityLoader):
    ...
    def behavior_attrs(self):
        ...
        The implementation here returns ['fft_dims', 'fft_slices', 'lowpass_keep'] + any values from super().
        '''
        return ['fft_dims', 'fft_slices', 'lowpass_keep'] + getattr(super(), 'behavior_attrs', [])
    ...
    fft_slices = simple_setdefaultvia_property('_fft_slices', '_new_fft_slices',
    ...
    lowpass_keep = simple_setdefault_property('_lowpass_keep', lambda: DEFAULTS.LOWPASS_KEEP,
