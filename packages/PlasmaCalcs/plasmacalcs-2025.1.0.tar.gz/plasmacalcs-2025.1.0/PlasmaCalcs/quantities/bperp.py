...
class BperpLoader(QuantityLoader):
    ...
    @known_pattern(r'Ta(joule)?perp', deps=[lambda ql, var, groups: f'Ta{groups[0] or ""}_perp_B'])
    ...
    @known_pattern(r'T(joule)?par', deps=[lambda ql, var, groups: f"Ta{groups[0] or ''}_par_B"])
