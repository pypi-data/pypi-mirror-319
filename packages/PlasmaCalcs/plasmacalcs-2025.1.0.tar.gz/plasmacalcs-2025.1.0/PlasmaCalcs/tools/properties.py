...
def simple_property(internal_name, *, doc=None, default=NO_VALUE, setable=True, delable=True,
                    valid=UNSET, validate_from=UNSET):
        ...
        if (valid is UNSET and validate_from is UNSET):
            ...
            def setter(self, value):
                ...
                if value not in allowed:
                    raise InputError(f'{internal_name}={value!r}. Expected one of: {allowed!r}')
                setattr(self, internal_name, value)
    else:
        setter = None
    if delable:
...
def simple_setdefault_property(internal_name, setdefault, *, doc=None, valid=UNSET, validate_from=UNSET):
    '''return a property with a setter and getter method for internal_name.
...
def simple_setdefaultvia_property(internal_name, setdefaultvia, *, doc=None, valid=UNSET, validate_from=UNSET):
    '''return a property with a setter and getter method for internal_name.
