...
def xarray_assign(array, coords=None, attrs=None, *, name=UNSET, overwrite=None):
...
@pcArrayAccessor.register('squeeze')
def xarray_squeeze(array):
    ...
    '''
    for d in array.dims:
        dropped = array.isel({d: 0}, drop=True)
