...
from ..errors import (
    ...
    InputMissingError, InputError,
)
from ..tools import (
    alias, simple_setdefault_property, simple_setdefaultvia_property,
...
class UnitsManager():
    ...
    alts = simple_setdefault_property('_alts', dict,
    ...
    # # # CGS UNITS # # #
    CGS_UNITS = simple_setdefaultvia_property('_CGS_UNITS', 'CGS_UNITS_DEFAULT',
