...
from ..errors import (
    FluidValueError, LoadingNotImplementedError,
    InputMissingError,
)
...
class MhdBasesLoader(AllBasesLoader, SimpleDerivedLoader):
    ...
    def assert_single_fluid_mode(self, varname='var', *, errmsg_verb='getting'):
        ...
        errmsg_verb: str, default 'getting'
            verb to include in error message if crashing. Error message starts like:
                "{type(self)} {errmsg_verb} {varname} requires self.in_single_fluid_mode..."
        ...
        if not self.in_single_fluid_mode:
            errmsg = (f'{type(self).__name__} {errmsg_verb} {varname!r} requires self.in_single_fluid_mode,\n'
    ...
    elements = simple_setdefaultvia_property('_elements', '_get_default_elements',
    ...
    def set_e(self, value, **kw):
        ...
        self.assert_single_fluid_mode('e', errmsg_verb='setting')
    ...
    def set_eperm(self, value, **kw):
        ...
        '''
        self.assert_single_fluid_mode('eperm', errmsg_verb='setting')
        e = value * self('r')
