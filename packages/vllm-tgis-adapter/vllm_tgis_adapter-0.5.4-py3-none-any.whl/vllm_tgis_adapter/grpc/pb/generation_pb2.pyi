...
class BatchedGenerationRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["_adapter_id", b"_adapter_id", "_prefix_id", b"_prefix_id", "adapter_id", b"adapter_id", "params", b"params", "prefix_id", b"prefix_id"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["_adapter_id", b"_adapter_id", "_prefix_id", b"_prefix_id", "adapter_id", b"adapter_id", "model_id", b"model_id", "params", b"params", "prefix_id", b"prefix_id", "requests", b"requests"]) -> None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_adapter_id", b"_adapter_id"]) -> typing_extensions.Literal["adapter_id"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_prefix_id", b"_prefix_id"]) -> typing_extensions.Literal["prefix_id"] | None: ...
...
class SingleGenerationRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["_adapter_id", b"_adapter_id", "_prefix_id", b"_prefix_id", "adapter_id", b"adapter_id", "params", b"params", "prefix_id", b"prefix_id", "request", b"request"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["_adapter_id", b"_adapter_id", "_prefix_id", b"_prefix_id", "adapter_id", b"adapter_id", "model_id", b"model_id", "params", b"params", "prefix_id", b"prefix_id", "request", b"request"]) -> None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_adapter_id", b"_adapter_id"]) -> typing_extensions.Literal["adapter_id"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_prefix_id", b"_prefix_id"]) -> typing_extensions.Literal["prefix_id"] | None: ...
...
class GenerationResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["generated_token_count", b"generated_token_count", "input_token_count", b"input_token_count", "input_tokens", b"input_tokens", "seed", b"seed", "stop_reason", b"stop_reason", "stop_sequence", b"stop_sequence", "text", b"text", "tokens", b"tokens"]) -> None: ...
...
class Parameters(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["decoding", b"decoding", "response", b"response", "sampling", b"sampling", "stopping", b"stopping"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["decoding", b"decoding", "method", b"method", "response", b"response", "sampling", b"sampling", "stopping", b"stopping", "truncate_input_tokens", b"truncate_input_tokens"]) -> None: ...
...
class DecodingParameters(google.protobuf.message.Message):
    ...
    class LengthPenalty(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing_extensions.Literal["decay_factor", b"decay_factor", "start_index", b"start_index"]) -> None: ...
    ...
    class StringChoices(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing_extensions.Literal["choices", b"choices"]) -> None: ...
    ...
    def HasField(self, field_name: typing_extensions.Literal["_length_penalty", b"_length_penalty", "choice", b"choice", "format", b"format", "grammar", b"grammar", "guided", b"guided", "json_schema", b"json_schema", "length_penalty", b"length_penalty", "regex", b"regex"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["_length_penalty", b"_length_penalty", "choice", b"choice", "format", b"format", "grammar", b"grammar", "guided", b"guided", "json_schema", b"json_schema", "length_penalty", b"length_penalty", "regex", b"regex", "repetition_penalty", b"repetition_penalty"]) -> None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_length_penalty", b"_length_penalty"]) -> typing_extensions.Literal["length_penalty"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["guided", b"guided"]) -> typing_extensions.Literal["format", "json_schema", "regex", "choice", "grammar"] | None: ...
...
class SamplingParameters(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["_seed", b"_seed", "_temperature", b"_temperature", "seed", b"seed", "temperature", b"temperature"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["_seed", b"_seed", "_temperature", b"_temperature", "seed", b"seed", "temperature", b"temperature", "top_k", b"top_k", "top_p", b"top_p", "typical_p", b"typical_p"]) -> None: ...
    @typing.overload
...
class StoppingCriteria(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["_include_stop_sequence", b"_include_stop_sequence", "include_stop_sequence", b"include_stop_sequence"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["_include_stop_sequence", b"_include_stop_sequence", "include_stop_sequence", b"include_stop_sequence", "max_new_tokens", b"max_new_tokens", "min_new_tokens", b"min_new_tokens", "stop_sequences", b"stop_sequences", "time_limit_millis", b"time_limit_millis"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_include_stop_sequence", b"_include_stop_sequence"]) -> typing_extensions.Literal["include_stop_sequence"] | None: ...
...
class ResponseOptions(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["generated_tokens", b"generated_tokens", "input_text", b"input_text", "input_tokens", b"input_tokens", "token_logprobs", b"token_logprobs", "token_ranks", b"token_ranks", "top_n_tokens", b"top_n_tokens"]) -> None: ...
...
class TokenInfo(google.protobuf.message.Message):
    ...
    class TopToken(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing_extensions.Literal["logprob", b"logprob", "text", b"text"]) -> None: ...
    ...
    def ClearField(self, field_name: typing_extensions.Literal["logprob", b"logprob", "rank", b"rank", "text", b"text", "top_tokens", b"top_tokens"]) -> None: ...
...
class BatchedTokenizeRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["_adapter_id", b"_adapter_id", "_prefix_id", b"_prefix_id", "adapter_id", b"adapter_id", "prefix_id", b"prefix_id"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["_adapter_id", b"_adapter_id", "_prefix_id", b"_prefix_id", "adapter_id", b"adapter_id", "model_id", b"model_id", "prefix_id", b"prefix_id", "requests", b"requests", "return_offsets", b"return_offsets", "return_tokens", b"return_tokens", "truncate_input_tokens", b"truncate_input_tokens"]) -> None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_adapter_id", b"_adapter_id"]) -> typing_extensions.Literal["adapter_id"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_prefix_id", b"_prefix_id"]) -> typing_extensions.Literal["prefix_id"] | None: ...
...
class TokenizeResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["offsets", b"offsets", "token_count", b"token_count", "tokens", b"tokens"]) -> None: ...
...
class ModelInfoResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["max_new_tokens", b"max_new_tokens", "max_sequence_length", b"max_sequence_length", "model_kind", b"model_kind"]) -> None: ...
