...
.. py:data:: mod_dotted_path
   :type: str
   :value: "drain_swamp_snippet.snip"
...
__package__ = "drain_swamp_snippet"
__all__ = (
    "ReplaceResult",
    "Snip",
)
...
def check_matching_tag_count(
    ...
    .. code-block:: python
        ...
        from drain_swamp_snippet.snip import check_matching_tag_count
...
def check_not_nested_or_out_of_order(
    ...
    Assumes :py:func:`drain_swamp_snippet.snip.check_matching_tag_count`
    already checked.
...
class Snip:
    ...
    def snippets(self):
        ...
        :rtype: list[tuple[str, str]] | drain_swamp_snippet.ReplaceResult
        """
        cls = type(self)
    ...
    def contents(self, id_=None):
        ...
        :rtype: tuple[str, str] | drain_swamp_snippet.ReplaceResult
