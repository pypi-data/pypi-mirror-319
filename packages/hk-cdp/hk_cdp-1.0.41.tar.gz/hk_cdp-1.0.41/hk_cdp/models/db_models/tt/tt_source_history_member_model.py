...
class SourceHistoryMemberModel(CacheModel):
    def __init__(self, db_connect_key='db_cloudapp', db_config_dict=None, sub_table=None, db_transaction=None, context=None):
        super(SourceHistoryMemberModel, self).__init__(SourceHistoryMember, sub_table)
...
class SourceHistoryMember:
    def __init__(self):
        super(SourceHistoryMember, self).__init__()
