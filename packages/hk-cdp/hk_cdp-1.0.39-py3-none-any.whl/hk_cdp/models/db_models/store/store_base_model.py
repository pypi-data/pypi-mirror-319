...
@LastEditTime: 2024-12-05 17:33:44
...
class StoreBase:
    ...
    def __init__(self):
        ...
        self.is_incr_process = 0  # 是否开启增量处理
    ...
    def get_field_list(self):
        return ['id', 'guid', 'business_id', 'scheme_id', 'platform_id', 'store_name', 'seller_nick', 'plat_store_id', 'init_integral_multiple', 'init_growth_config', 'is_incr_process', 'incr_process_start_date', 'is_omid_merge', 'create_date', 'modify_date']
