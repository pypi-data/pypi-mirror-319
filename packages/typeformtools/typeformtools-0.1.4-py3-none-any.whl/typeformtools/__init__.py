"""typeformtools - Tools for PEP 747 `TypeForm`s - Olaf, 16 Dec 2024-8 Jan 2025.
...
* `non_optional()` to remove optionality in a union (if applicable)
    ...
    A possible scenario, which triggered including this, is conversion between type definitions:
...
from typing import Annotated, _AnnotatedAlias, Never, Optional, TypeAliasType, Union, _UnionGenericAlias

import more_itertools
# noinspection PyUnresolvedReferences,PyProtectedMember
from typing_extensions import Doc, TypeForm

__all__ = ['unaliased', 'unannotated', 'undisguised', 'non_optional']
