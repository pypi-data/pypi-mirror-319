...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-ses)](https://pypistats.org/packages/mypy-boto3-ses)
...
`mypy-boto3-ses` dependency in production. However, there is an issue in
