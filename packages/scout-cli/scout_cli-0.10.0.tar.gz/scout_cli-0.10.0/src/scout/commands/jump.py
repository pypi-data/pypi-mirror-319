...
def jump_command(
    ...
    try:
        ...
        try:
            ...
            # Show the new location with verification
            if str(target) != new_dir:
                console.print(f"[yellow]Note:[/yellow] Actual location may differ from target")
                console.print(f"[green]Target was:[/green] {target}")
                console.print(f"[green]Actually at:[/green] {new_dir}")
            else:
                console.print(f"[green]Now in:[/green] {new_dir}")
            
            # Verify we actually moved
            if new_dir == old_dir:
                console.print(f"[yellow]Warning:[/yellow] Directory didn't change!")
