...
class WizVulnerabilityIntegration(ScannerIntegration):
    ...
    @classmethod
    def authenticate(cls, client_id: Optional[str] = None, client_secret: Optional[str] = None) -> None:
        """
        ...
        WizVariables.wizAccessToken = wiz_authenticate(client_id, client_secret)
    ...
    @classmethod
    def fetch_wiz_data_if_needed(cls, query: str, variables: Dict, topic_key: str, file_path: str) -> List[Dict]:
        """
