...
def get_tables(document: Any) -> list[Table]:
    """
...
def get_xpath_privacy_detailed(
    tables: List[Table], key: str, xpath: str, count_array: list[int] = [0, 2, 4, 6]
) -> dict:
    """
    Use Xpath to pull data from XML tables

    :param List[Table] tables: XML tables
...
def get_xpath_data_detailed(tables: List[Table], key: str, ident: str, xpath: str, count_array: list = None) -> dict:
    """
    Use Xpath to pull data from XML tables
...
def get_xpath_sysinfo_detailed(tables: List[Table], key: str, xpath: str, count_array: list = None) -> dict:
    """
    Use Xpath to pull data from XML tables
...
def get_xpath_prepdata_detailed(tables: List[Table], key: str, ident: str, xpath: str) -> dict:
    """
    Use Xpath to pull data from XML tables
...
def parse_ssp_docx_tables(tables: Any) -> Tuple[str, str, str, str, str, str, list]:
    ...
    :return Tuple[str, str, str, str, str, str, list]: System Status, System Type, Title, Cloud Model, Cloud Sevice, Version, Table Data
