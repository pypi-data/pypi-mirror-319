...
class Api:
    ...
    def get(
        ...
        headers = {
            ...
            **headers,  # Merge any provided headers, allowing them to override defaults
        }
        response = None
        try:
    ...
    def delete(self, url: str, headers: Optional[dict] = None, retry_login: bool = True) -> requests.models.Response:
        ...
        if headers is None:
            headers = {}
        headers = {"Authorization": self.config["token"], "accept": self.accept, **headers}
        response = None
        try:
    ...
    def put(
        ...
        if headers is None:
            headers = {}
        headers = {"Authorization": self.config["token"], **headers}
        response = None
        try:
