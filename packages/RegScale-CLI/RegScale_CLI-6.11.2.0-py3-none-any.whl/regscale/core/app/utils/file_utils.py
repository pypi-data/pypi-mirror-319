...
IMPORT_EXCLUDES = [".DS_Store", "~", ".zip", "mapping.json", ".md", ".burp", ".html"]
...
def get_files_by_folder(
    import_folder: Union[str, Path], exclude_non_scan_files: bool, file_excludes: Optional[list[str]] = None
) -> List[str]:
    """
