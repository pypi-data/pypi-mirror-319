...
class Client:
    ...
    def place_order(self, data: OrderDataInput, exchange_addr='', chain_id=8453, currency_addr=''):
        try:
            ...
            v2_add_order_req_body = dict(
                salt=signerOrder.order.salt,
                maker=signerOrder.order.maker,
                signer=signerOrder.order.signer,
                taker=signerOrder.order.taker,
                tokenId=signerOrder.order.tokenId,
                makerAmount=signerOrder.order.makerAmount,
                takerAmount=signerOrder.order.takerAmount,
                expiration='0',
                nonce='0',
                feeRateBps='0',
                side=signerOrder.order.side,
                signatureType=signerOrder.order.signatureType,
