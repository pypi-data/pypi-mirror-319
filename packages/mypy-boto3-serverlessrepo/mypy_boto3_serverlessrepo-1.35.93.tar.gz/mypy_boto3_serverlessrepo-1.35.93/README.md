...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-serverlessrepo)](https://pypistats.org/packages/mypy-boto3-serverlessrepo)
...
`mypy-boto3-serverlessrepo` dependency in production. However, there is an
