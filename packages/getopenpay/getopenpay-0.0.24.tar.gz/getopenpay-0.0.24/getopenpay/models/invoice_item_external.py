...
class InvoiceItemExternal(BaseModel):
  ...
  __properties: ClassVar[List[str]] = [
    'id', 'object', 'created_at', 'updated_at', 'is_deleted', 'invoice_id', 'account_id',
    'amount_atom', 'currency', 'customer_id', 'description', 'period_end', 'period_start',
    'price_id', 'price_type', 'product_id', 'proration', 'quantity', 'subscription_id',
    'subscription_item_id', 'subscription_cancelled_at', 'discounts', 'discount_amount_atoms',
    'amount_atom_considering_discount_applied', 'proration_details_debit_invoice_item'
  ]
