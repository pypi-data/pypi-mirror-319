...
def sfx(filename: str, times: int = 1, volume: float = default_volume) -> None:
    """
...
def play_music(filename: str, stop_other: bool = False, loop: bool = True, volume: float = default_volume) -> None:
    """
...
def find_audio_file(filename: str) -> str:
    ...
    wav_file: str = os.path.join(music_directory, f"{filename}.wav")
    mp3_file: str = os.path.join(music_directory, f"{filename}.mp3")
