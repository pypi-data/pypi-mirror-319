...
@splunk_appinspect.tags(Tags.SPLUNK_APPINSPECT, Tags.CLOUD, Tags.MANUAL, Tags.AST)
def check_built_in_import_function(app: "App", reporter: "Reporter") -> None:
    ...
    # Nice SO discussion on this here:
...
@splunk_appinspect.tags(Tags.SPLUNK_APPINSPECT, Tags.CLOUD, Tags.MANUAL, Tags.AST)
def check_for_file_and_directory_access(app: "App", reporter: "Reporter") -> None:
...
@splunk_appinspect.tags(Tags.SPLUNK_APPINSPECT, Tags.CLOUD, Tags.MANUAL, Tags.AST)
def check_for_unencrypted_network_communications(app: "App", reporter: "Reporter") -> None:
...
@splunk_appinspect.tags(Tags.SPLUNK_APPINSPECT, Tags.CLOUD, Tags.MANUAL, Tags.AST)
def check_for_builtin_functions(app: "App", reporter: "Reporter") -> None:
    ...
    def has_non_string_args(call_node: ast.Call, ast_info: "AstAnalyzer"):
        if call_node.args:
...
@splunk_appinspect.tags(Tags.SPLUNK_APPINSPECT, Tags.CLOUD, Tags.MANUAL, Tags.AST)
def check_python_untrusted_xml_functions(app: "App", reporter: "Reporter") -> None:
    ...
    message = (
        ...
        "Using various XML methods to parse untrusted XML data is known to be vulnerable to XML attacks. "
...
@splunk_appinspect.tags(Tags.SPLUNK_APPINSPECT, Tags.CLOUD, Tags.MANUAL, Tags.AST)
def check_for_data_persistence(app: "App", reporter: "Reporter") -> None:
...
@splunk_appinspect.tags(Tags.SPLUNK_APPINSPECT, Tags.CLOUD, Tags.MANUAL, Tags.AST)
def check_for_plain_text_credentials_in_python(app: "App", reporter: "Reporter") -> None:
    ...
    def check_variable_name(variable_name: str) -> bool:
        return any(
            map(
...
@splunk_appinspect.tags(Tags.SPLUNK_APPINSPECT, Tags.CLOUD, Tags.MANUAL, Tags.AST)
def check_for_interprocess_communication_and_networking(app: "App", reporter: "Reporter") -> None:
...
@splunk_appinspect.tags(Tags.SPLUNK_APPINSPECT, Tags.CLOUD, Tags.MANUAL, Tags.AST)
def check_for_generic_operating_system_services(app: "App", reporter: "Reporter") -> None:
...
@splunk_appinspect.tags(Tags.SPLUNK_APPINSPECT, Tags.CLOUD, Tags.MANUAL, Tags.AST)
def check_for_python_runtime_services(app: "App", reporter: "Reporter") -> None:
...
@splunk_appinspect.tags(Tags.SPLUNK_APPINSPECT, Tags.CLOUD, Tags.MANUAL, Tags.AST)
def check_for_data_compression_and_archiving(app: "App", reporter: "Reporter") -> None:
...
@splunk_appinspect.tags(Tags.SPLUNK_APPINSPECT, Tags.CLOUD, Tags.AST, Tags.MANUAL)
def check_for_internet_protocols_and_support(app: "App", reporter: "Reporter") -> None:
    """Check for the use of web server classes, they could be used to start an internal server in current app"""
...
@splunk_appinspect.tags(Tags.SPLUNK_APPINSPECT, Tags.CLOUD, Tags.AST, Tags.MANUAL)
def check_for_importing_modules(app: "App", reporter: "Reporter") -> None:
...
class CheckPythonSdkVersion(Check):
    ...
    NEW_MINIMUM_SDK_VERSION = semver.VersionInfo.parse("2.0.2")
    ...
    def check_python_sdk(
        ...
        elif self.MINIMUM_SDK_VERSION <= parsed_ver < self.NEW_MINIMUM_SDK_VERSION:
            yield WarningMessage(
                f"Detected an outdated version of the Splunk SDK for Python ({raw_version}).",
                file_name=path_in_app,
                line_number=line_number,
        ...
        elif self.NEW_MINIMUM_SDK_VERSION <= parsed_ver < self.LATEST_SDK_VERSION:
            yield WarningMessage(
                f"Detected an outdated version of the Splunk SDK for Python ({raw_version}).",
                file_name=path_in_app,
                line_number=line_number,
