...
def check_requires_adobe_flash(app: "App", reporter: "Reporter") -> None:
...
class CheckPackageCompression(Check):
    ...
    def check(self, app: "App") -> Generator[CheckMessage, Any, None]:
        ...
        # we allow to inspect zip packages / directories
        ...
        try:
            ...
            yield FailMessage(
                "The provided package archive is not compressed properly.",
                remediation="Please, submit properly compressed archive. See: https://dev.splunk.com/enterprise/docs/releaseapps/packageapps/#Third-party-utilities-and-CLI-commands for more info.",
            )
