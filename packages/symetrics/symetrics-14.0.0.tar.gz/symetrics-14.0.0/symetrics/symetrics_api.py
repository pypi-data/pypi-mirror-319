...
class Symetrics(ISymetrics):
    ...
    def execute_query(self, query: str, params: tuple, default_result: dict, columns: list):
        """
    ...
    def get_silva_score(self, variant: VariantObject):
        ...
        return self.execute_query(query, (variant._chr, variant._pos, variant._ref, variant._alt), default_values, columns)
    ...
    def get_gnomad_constraints(self, gene=''):
        ...
        return self.execute_query(query, (gene,), default_values, columns)
