...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-tnb)](https://pypistats.org/packages/mypy-boto3-tnb)
...
`mypy-boto3-tnb` dependency in production. However, there is an issue in
