...
GET_TEXT_SQL_FORMAT_WITHOUT_RELATION_KEY_FORMAT = "select {} from {} where nc_hedge = 0 and nc_data_status != 99 and nc_key in (select nc_key from nc_entity_data where dataset_id = '{}')"
