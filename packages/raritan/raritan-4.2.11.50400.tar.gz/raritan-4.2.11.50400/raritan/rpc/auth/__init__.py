...
class LdapManager(Interface):
    idlType = "auth.LdapManager:4.0.0"

    # enumeration
    class ServerType(Enumeration):
        idlType = "auth.LdapManager_4_0_0.ServerType:1.0.0"
    ...
    class SecurityProtocol(Enumeration):
        idlType = "auth.LdapManager_4_0_0.SecurityProtocol:1.0.0"
    ...
    class ServerSettings(Structure):
        idlType = "auth.LdapManager_4_0_0.ServerSettings:1.0.0"
        elements = ["id", "server", "adoptSettingsId", "type", "secProto", "port", "sslPort", "forceTrustedCert", "allowOffTimeRangeCerts", "certificate", "adsDomain", "useAnonymousBind", "bindDN", "bindPwd", "searchBaseDN", "loginNameAttr", "userEntryObjClass", "userSearchFilter", "groupInfoInUserEntry", "supportNestedGroups", "groupMemberAttr", "groupEntryObjClass", "groupSearchFilter"]

        def __init__(self, id="", server="", adoptSettingsId="", type=None, secProto=None, port=0, sslPort=0, forceTrustedCert=False, allowOffTimeRangeCerts=False, certificate="", adsDomain="", useAnonymousBind=False, bindDN="", bindPwd="", searchBaseDN="", loginNameAttr="", userEntryObjClass="", userSearchFilter="", groupInfoInUserEntry=False, supportNestedGroups=False, groupMemberAttr="", groupEntryObjClass="", groupSearchFilter=""):
            if type is None:
        ...
        def decode(cls, json, agent, useDefaults=False):
            obj = cls(
                ...
                adoptSettingsId = json['adoptSettingsId'] if 'adoptSettingsId' in json or not useDefaults else "",
...
class RadiusManager(Interface):
    ...
    class ServerSettings(Structure):
        ...
        def __init__(self, id="", server="", sharedSecret="", udpAuthPort=0, udpAccountPort=0, timeout=0, retries=0, authType=None, disableAccounting=False):
            if authType is None:
