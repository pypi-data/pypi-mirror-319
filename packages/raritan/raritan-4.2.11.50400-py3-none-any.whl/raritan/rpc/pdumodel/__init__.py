...
class Ade(Interface):
    ...
    class MetaData(Structure):
        ...
        def __init__(self, adeType="", channels=0, currentDivider=0.0, voltageDivider=0.0, energyDivider=0.0):
        ...
        def decode(cls, json, agent, useDefaults=False):
            obj = cls(
                adeType = json['adeType'] if 'adeType' in json or not useDefaults else "",
                channels = json['channels'] if 'channels' in json or not useDefaults else 0,
                currentDivider = json['currentDivider'] if 'currentDivider' in json or not useDefaults else 0.0,
                voltageDivider = json['voltageDivider'] if 'voltageDivider' in json or not useDefaults else 0.0,
                energyDivider = json['energyDivider'] if 'energyDivider' in json or not useDefaults else 0.0,
            )
            return obj
    ...
    class Sample(Structure):
        ...
        def __init__(self, vrms=0, irms=0, watt=0, va=0, wh=0, vah=0):
        ...
        def decode(cls, json, agent, useDefaults=False):
            obj = cls(
                vrms = int(json['vrms']) if 'vrms' in json or not useDefaults else 0,
                irms = int(json['irms']) if 'irms' in json or not useDefaults else 0,
                watt = int(json['watt']) if 'watt' in json or not useDefaults else 0,
                va = int(json['va']) if 'va' in json or not useDefaults else 0,
                wh = int(json['wh']) if 'wh' in json or not useDefaults else 0,
                vah = int(json['vah']) if 'vah' in json or not useDefaults else 0,
            )
            return obj
    ...
    class _getMetaData(Interface.Method):
        ...
        def decode(rsp, agent, useDefaults=False):
            _ret_ = raritan.rpc.pdumodel.Ade.MetaData.decode(rsp['_ret_'], agent, useDefaults=useDefaults)
    ...
    class _getLatestSample(Interface.Method):
        ...
        @staticmethod
        def decode(rsp, agent, useDefaults=False):
            _ret_ = [raritan.rpc.pdumodel.Ade.Sample.decode(x0, agent, useDefaults=useDefaults) for x0 in rsp['_ret_']]
            for x0 in _ret_:
...
class OutletGroup(Interface):
    idlType = "pdumodel.OutletGroup:1.1.9"

    ERR_INVALID_ARGUMENT = 1

    # structure
    class Sensors(Structure):
        idlType = "pdumodel.OutletGroup_1_1_9.Sensors:1.0.0"
    ...
    # structure
    class Settings(Structure):
        idlType = "pdumodel.OutletGroup_1_1_9.Settings:1.0.0"
    ...
    # structure
    class MetaData(Structure):
        idlType = "pdumodel.OutletGroup_1_1_9.MetaData:1.0.0"
    ...
    class SensorsChangedEvent(raritan.rpc.idl.Event):
        idlType = "pdumodel.OutletGroup_1_1_9.SensorsChangedEvent:1.0.0"
    ...
    # value object
    class SettingsChangedEvent(raritan.rpc.event.UserEvent):
        idlType = "pdumodel.OutletGroup_1_1_9.SettingsChangedEvent:1.0.0"
    ...
    # value object
    class PowerControlEvent(raritan.rpc.event.UserEvent):
        idlType = "pdumodel.OutletGroup_1_1_9.PowerControlEvent:1.0.0"
...
class OutletGroupManager(Interface):
    idlType = "pdumodel.OutletGroupManager:1.1.9"
    ...
    class GroupCreatedEvent(raritan.rpc.event.UserEvent):
        idlType = "pdumodel.OutletGroupManager_1_1_9.GroupCreatedEvent:1.0.0"
    ...
    class GroupDeletedEvent(raritan.rpc.event.UserEvent):
        idlType = "pdumodel.OutletGroupManager_1_1_9.GroupDeletedEvent:1.0.0"
...
class TransferSwitch(EDevice):
    idlType = "pdumodel.TransferSwitch:6.0.0"
    ...
    # enumeration
    class Type(Enumeration):
        idlType = "pdumodel.TransferSwitch_6_0_0.Type:1.0.0"
        values = ["STS", "ATS", "HTS"]
    ...
    class TransferReason(Enumeration):
        idlType = "pdumodel.TransferSwitch_6_0_0.TransferReason:1.0.0"
    ...
    # structure
    class MetaData(Structure):
        idlType = "pdumodel.TransferSwitch_6_0_0.MetaData:1.0.0"
    ...
    # structure
    class Sensors(Structure):
        idlType = "pdumodel.TransferSwitch_6_0_0.Sensors:1.0.0"
        elements = ["selectedSource", "operationalState", "sourceVoltagePhaseSyncAngle", "overloadAlarm", "phaseSyncAlarm", "switchFault", "bypassState"]

        def __init__(self, selectedSource=None, operationalState=None, sourceVoltagePhaseSyncAngle=None, overloadAlarm=None, phaseSyncAlarm=None, switchFault=None, bypassState=None):
    ...
    # structure
    class Settings(Structure):
        idlType = "pdumodel.TransferSwitch_6_0_0.Settings:1.0.0"
    ...
    class Statistics(Structure):
        idlType = "pdumodel.TransferSwitch_6_0_0.Statistics:1.0.0"
    ...
    # value object
    class SettingsChangedEvent(raritan.rpc.event.UserEvent):
        idlType = "pdumodel.TransferSwitch_6_0_0.SettingsChangedEvent:1.0.0"
    ...
    class TransferLogEntry(Structure):
        idlType = "pdumodel.TransferSwitch_6_0_0.TransferLogEntry:1.0.0"
...
# interface
class Pdu(Interface):
    idlType = "pdumodel.Pdu:6.4.4"

    ERR_INVALID_PARAM = 1

    # enumeration
    class PduOrientation(Enumeration):
        idlType = "pdumodel.Pdu_6_4_4.PduOrientation:1.0.0"
    ...
    # structure
    class MetaData(Structure):
        idlType = "pdumodel.Pdu_6_4_4.MetaData:1.0.0"
    ...
    # structure
    class Sensors(Structure):
        idlType = "pdumodel.Pdu_6_4_4.Sensors:1.0.0"
    ...
    class Statistic(Structure):
        idlType = "pdumodel.Pdu_6_4_4.Statistic:1.0.0"
    ...
    # enumeration
    class StartupState(Enumeration):
        idlType = "pdumodel.Pdu_6_4_4.StartupState:1.0.0"
    ...
    # structure
    class Settings(Structure):
        idlType = "pdumodel.Pdu_6_4_4.Settings:1.0.0"
    ...
    class OutletSequenceState(Structure):
        idlType = "pdumodel.Pdu_6_4_4.OutletSequenceState:1.0.0"
    ...
    class PortWithProperties(Structure):
        idlType = "pdumodel.Pdu_6_4_4.PortWithProperties:1.0.0"
    ...
    # value object
    class SettingsChangedEvent(raritan.rpc.event.UserEvent):
        idlType = "pdumodel.Pdu_6_4_4.SettingsChangedEvent:1.0.0"
    ...
    class LoadSheddingModeChangedEvent(raritan.rpc.event.UserEvent):
        idlType = "pdumodel.Pdu_6_4_4.LoadSheddingModeChangedEvent:1.0.0"
    ...
    class OutletSequenceStateChangedEvent(raritan.rpc.idl.Event):
        idlType = "pdumodel.Pdu_6_4_4.OutletSequenceStateChangedEvent:1.0.0"
    ...
    class PortAppearedEvent(raritan.rpc.idl.Event):
        idlType = "pdumodel.Pdu_6_4_4.PortAppearedEvent:1.0.0"
    ...
    class PortDisappearedEvent(raritan.rpc.idl.Event):
        idlType = "pdumodel.Pdu_6_4_4.PortDisappearedEvent:1.0.0"
