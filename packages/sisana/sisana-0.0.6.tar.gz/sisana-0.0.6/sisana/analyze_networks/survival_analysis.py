...
def survival_analysis(metadata, filetype: str, sampgroup_colname: str, alivestatus_colname: str, days_colname: str, groups: list, outdir: str, appendname=""):
    """
    Description:
    ...
    -----------
        ...
        - appendname: str, Optional; A name to append to the end of the base file name of the output file.
