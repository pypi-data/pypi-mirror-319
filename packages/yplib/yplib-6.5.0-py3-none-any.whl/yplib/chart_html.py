...
def profile_html():
    option = ['{',
              ...
              '                + "</br><table style=\'width:100%;\'><tr><td style=\'width:80px;\'>Start:</td><td>" + params.value[1] + "</td></tr>"',
              '                + "<tr><td style=\'width:80px;\'>End:</td><td>" + params.value[2] + "</td></tr>"',
              '                + "<tr><td style=\'width:80px;\'>Duration:</td><td>" + params.value[3] + "</td></tr></table>";',
              '        }',
              '    },',
              '    title: {',
              '        text: "-chart_name-",',
