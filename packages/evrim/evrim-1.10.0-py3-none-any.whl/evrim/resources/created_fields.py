...
from ..types import (
    ...
    created_field_profile_attach_params,
)
    ...
    def profile_attach(
        ...
        *,
        ...
        return self._post(
            ...
            body=maybe_transform(
                {"profile_id": profile_id}, created_field_profile_attach_params.CreatedFieldProfileAttachParams
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
...
class CreatedFieldsResourceWithRawResponse:
    def __init__(self, created_fields: CreatedFieldsResource) -> None:
        ...
        self.profile_attach = to_raw_response_wrapper(
            created_fields.profile_attach,
        )
...
class AsyncCreatedFieldsResourceWithRawResponse:
    def __init__(self, created_fields: AsyncCreatedFieldsResource) -> None:
        ...
        self.profile_attach = async_to_raw_response_wrapper(
            created_fields.profile_attach,
        )
...
class CreatedFieldsResourceWithStreamingResponse:
    def __init__(self, created_fields: CreatedFieldsResource) -> None:
        ...
        self.profile_attach = to_streamed_response_wrapper(
            created_fields.profile_attach,
        )
...
class AsyncCreatedFieldsResourceWithStreamingResponse:
    def __init__(self, created_fields: AsyncCreatedFieldsResource) -> None:
        ...
        self.profile_attach = async_to_streamed_response_wrapper(
            created_fields.profile_attach,
        )
