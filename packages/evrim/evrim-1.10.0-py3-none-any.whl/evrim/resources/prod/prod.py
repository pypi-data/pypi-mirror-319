...
from ...types import prod_schema_list_params
...
from ...types.prod_schema_list_response import ProdSchemaListResponse
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                query=maybe_transform(
                    ...
                    prod_schema_list_params.ProdSchemaListParams,
                ),
            ),
            cast_to=ProdSchemaListResponse,
        )
...
class ProdResourceWithRawResponse:
    def __init__(self, prod: ProdResource) -> None:
        ...
        self.schema_list = to_raw_response_wrapper(
            prod.schema_list,
        )
...
class AsyncProdResourceWithRawResponse:
    def __init__(self, prod: AsyncProdResource) -> None:
        ...
        self.schema_list = async_to_raw_response_wrapper(
            prod.schema_list,
        )
...
class ProdResourceWithStreamingResponse:
    def __init__(self, prod: ProdResource) -> None:
        ...
        self.schema_list = to_streamed_response_wrapper(
            prod.schema_list,
        )
...
class AsyncProdResourceWithStreamingResponse:
    def __init__(self, prod: AsyncProdResource) -> None:
        ...
        self.schema_list = async_to_streamed_response_wrapper(
            prod.schema_list,
        )
