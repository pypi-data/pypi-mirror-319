...
from ...types.profiles import collection_create_params
from ...types.profile_to_collection import ProfileToCollection
...
class CollectionsResource(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        return self._post(
            f"/prod/v0/profiles/{profile_id}/collections/",
            body=maybe_transform({"collection_id": collection_id}, collection_create_params.CollectionCreateParams),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=ProfileToCollection,
        )
        ...
        *,
        ...
        return await self._post(
            ...
            body=await async_maybe_transform(
                {"collection_id": collection_id}, collection_create_params.CollectionCreateParams
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
