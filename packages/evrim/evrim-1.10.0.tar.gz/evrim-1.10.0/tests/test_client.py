...
def _get_open_connections(client: Evrim | AsyncEvrim) -> int:
...
class TestEvrim:
    client = Evrim(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=True)
    ...
    def test_multipart_repeating_array(self, client: Evrim) -> None:
        request = client._build_request(
    ...
    def test_base_url_env(self) -> None:
        with update_env(EVRIM_BASE_URL="http://localhost:5000/from/env"):
            client = Evrim(bearer_token=bearer_token, _strict_response_validation=True)
    ...
    def test_base_url_trailing_slash(self, client: Evrim) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: Evrim) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: Evrim) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = Evrim(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            strict_client.get("/foo", cast_to=Model)

        client = Evrim(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=False)
    ...
    @mock.patch("evrim._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
    def test_retrying_timeout_errors_doesnt_leak(self, respx_mock: MockRouter) -> None:
        respx_mock.post("/prod/v0/profiles/").mock(side_effect=httpx.TimeoutException("Test timeout error"))
    ...
    def test_retrying_status_errors_doesnt_leak(self, respx_mock: MockRouter) -> None:
        respx_mock.post("/prod/v0/profiles/").mock(return_value=httpx.Response(500))
    ...
    def test_retries_taken(
        ...
        respx_mock.post("/prod/v0/profiles/").mock(side_effect=retry_handler)

        response = client.profiles.with_raw_response.create(specification="specification", template_id=0)
    ...
    @mock.patch("evrim._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
    def test_omit_retry_count_header(self, client: Evrim, failures_before_success: int, respx_mock: MockRouter) -> None:
        client = client.with_options(max_retries=4)
        ...
        response = client.profiles.with_raw_response.create(
            specification="specification", template_id=0, extra_headers={"x-stainless-retry-count": Omit()}
        )
    ...
    def test_overwrite_retry_count_header(
        self, client: Evrim, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = client.with_options(max_retries=4)
        ...
        response = client.profiles.with_raw_response.create(
            specification="specification", template_id=0, extra_headers={"x-stainless-retry-count": "42"}
        )
...
class TestAsyncEvrim:
    client = AsyncEvrim(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=True)
    ...
    def test_multipart_repeating_array(self, async_client: AsyncEvrim) -> None:
    ...
    def test_base_url_env(self) -> None:
        with update_env(EVRIM_BASE_URL="http://localhost:5000/from/env"):
            client = AsyncEvrim(bearer_token=bearer_token, _strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"
    ...
    def test_base_url_trailing_slash(self, client: AsyncEvrim) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: AsyncEvrim) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: AsyncEvrim) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = AsyncEvrim(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            await strict_client.get("/foo", cast_to=Model)

        client = AsyncEvrim(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=False)
    ...
    async def test_retries_taken(
        ...
        response = await client.profiles.with_raw_response.create(specification="specification", template_id=0)
    ...
    async def test_omit_retry_count_header(
        self, async_client: AsyncEvrim, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = async_client.with_options(max_retries=4)
