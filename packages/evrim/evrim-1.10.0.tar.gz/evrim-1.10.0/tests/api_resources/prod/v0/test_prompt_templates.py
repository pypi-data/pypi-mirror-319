...
class TestPromptTemplates:
    ...
    def test_method_create(self, client: Evrim) -> None:
        prompt_template = client.prod.v0.prompt_templates.create(
            prompt="prompt",
        )
    ...
    def test_raw_response_create(self, client: Evrim) -> None:
        response = client.prod.v0.prompt_templates.with_raw_response.create(
            prompt="prompt",
        )
    ...
    def test_streaming_response_create(self, client: Evrim) -> None:
        with client.prod.v0.prompt_templates.with_streaming_response.create(
            prompt="prompt",
        ) as response:
    ...
    def test_method_retrieve(self, client: Evrim) -> None:
        prompt_template = client.prod.v0.prompt_templates.retrieve(
            0,
        )
        assert_matches_type(PromptTemplate, prompt_template, path=["response"])
    ...
    def test_raw_response_retrieve(self, client: Evrim) -> None:
        response = client.prod.v0.prompt_templates.with_raw_response.retrieve(
            0,
        )
    ...
    def test_streaming_response_retrieve(self, client: Evrim) -> None:
        with client.prod.v0.prompt_templates.with_streaming_response.retrieve(
            0,
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_method_list(self, client: Evrim) -> None:
        prompt_template = client.prod.v0.prompt_templates.list()
    ...
    def test_raw_response_list(self, client: Evrim) -> None:
        response = client.prod.v0.prompt_templates.with_raw_response.list()
    ...
    def test_streaming_response_list(self, client: Evrim) -> None:
        with client.prod.v0.prompt_templates.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
...
class TestAsyncPromptTemplates:
    ...
    async def test_method_create(self, async_client: AsyncEvrim) -> None:
        prompt_template = await async_client.prod.v0.prompt_templates.create(
            prompt="prompt",
        )
        assert_matches_type(PromptTemplate, prompt_template, path=["response"])
    ...
    async def test_raw_response_create(self, async_client: AsyncEvrim) -> None:
        response = await async_client.prod.v0.prompt_templates.with_raw_response.create(
            prompt="prompt",
        )
    ...
    async def test_streaming_response_create(self, async_client: AsyncEvrim) -> None:
        async with async_client.prod.v0.prompt_templates.with_streaming_response.create(
            prompt="prompt",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_retrieve(self, async_client: AsyncEvrim) -> None:
        prompt_template = await async_client.prod.v0.prompt_templates.retrieve(
            0,
        )
        assert_matches_type(PromptTemplate, prompt_template, path=["response"])
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncEvrim) -> None:
        response = await async_client.prod.v0.prompt_templates.with_raw_response.retrieve(
            0,
        )
    ...
    async def test_streaming_response_retrieve(self, async_client: AsyncEvrim) -> None:
        async with async_client.prod.v0.prompt_templates.with_streaming_response.retrieve(
            0,
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_list(self, async_client: AsyncEvrim) -> None:
        prompt_template = await async_client.prod.v0.prompt_templates.list()
        assert_matches_type(PromptTemplateListResponse, prompt_template, path=["response"])

    @parametrize
    async def test_raw_response_list(self, async_client: AsyncEvrim) -> None:
        response = await async_client.prod.v0.prompt_templates.with_raw_response.list()
    ...
    async def test_streaming_response_list(self, async_client: AsyncEvrim) -> None:
        async with async_client.prod.v0.prompt_templates.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
