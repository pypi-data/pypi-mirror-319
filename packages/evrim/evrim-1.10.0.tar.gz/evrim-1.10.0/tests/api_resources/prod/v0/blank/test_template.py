...
class TestTemplate:
    ...
    def test_method_create(self, client: Evrim) -> None:
        template = client.prod.v0.blank.template.create()
        assert_matches_type(BlankTemplate, template, path=["response"])

    @parametrize
    def test_raw_response_create(self, client: Evrim) -> None:
        response = client.prod.v0.blank.template.with_raw_response.create()
    ...
    def test_streaming_response_create(self, client: Evrim) -> None:
        with client.prod.v0.blank.template.with_streaming_response.create() as response:
...
class TestAsyncTemplate:
    ...
    async def test_method_create(self, async_client: AsyncEvrim) -> None:
        template = await async_client.prod.v0.blank.template.create()
        assert_matches_type(BlankTemplate, template, path=["response"])

    @parametrize
    async def test_raw_response_create(self, async_client: AsyncEvrim) -> None:
        response = await async_client.prod.v0.blank.template.with_raw_response.create()
    ...
    async def test_streaming_response_create(self, async_client: AsyncEvrim) -> None:
        async with async_client.prod.v0.blank.template.with_streaming_response.create() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
