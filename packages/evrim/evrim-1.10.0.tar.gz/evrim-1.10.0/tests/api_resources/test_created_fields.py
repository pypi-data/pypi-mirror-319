...
class TestCreatedFields:
    ...
    @parametrize
    def test_method_profile_attach(self, client: Evrim) -> None:
        created_field = client.created_fields.profile_attach(
    ...
    @parametrize
    def test_raw_response_profile_attach(self, client: Evrim) -> None:
        response = client.created_fields.with_raw_response.profile_attach(
            field_id="321669910225",
            profile_id=0,
        )
    ...
    @parametrize
    def test_streaming_response_profile_attach(self, client: Evrim) -> None:
        with client.created_fields.with_streaming_response.profile_attach(
            field_id="321669910225",
            profile_id=0,
        ) as response:
            assert not response.is_closed
    ...
    @parametrize
    def test_path_params_profile_attach(self, client: Evrim) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `field_id` but received ''"):
            client.created_fields.with_raw_response.profile_attach(
                field_id="",
                profile_id=0,
            )
...
class TestAsyncCreatedFields:
    ...
    @parametrize
    async def test_method_profile_attach(self, async_client: AsyncEvrim) -> None:
        created_field = await async_client.created_fields.profile_attach(
            field_id="321669910225",
            profile_id=0,
        )
        assert created_field is None
    ...
    @parametrize
    async def test_raw_response_profile_attach(self, async_client: AsyncEvrim) -> None:
        response = await async_client.created_fields.with_raw_response.profile_attach(
            field_id="321669910225",
            profile_id=0,
        )
    ...
    @parametrize
    async def test_streaming_response_profile_attach(self, async_client: AsyncEvrim) -> None:
        async with async_client.created_fields.with_streaming_response.profile_attach(
            field_id="321669910225",
            profile_id=0,
        ) as response:
            assert not response.is_closed
    ...
    @parametrize
    async def test_path_params_profile_attach(self, async_client: AsyncEvrim) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `field_id` but received ''"):
            await async_client.created_fields.with_raw_response.profile_attach(
                field_id="",
                profile_id=0,
            )
