...
class Fluctuation(BaseIndicator):
    (FLUCT_BEARISH_L3, FLUCT_BEARISH_L2, FLUCT_BEARISH_L1, FLUCT_BEARISH, NA, FLUCT_BULLISH, FLUCT_BULLISH_L1, FLUCT_BULLISH_L2, FLUCT_BULLISH_L3) = (-4, -3, -2, -1, 0, 1, 2, 3, 4)
    ...
    def handle_api_resp(self, item):
        ...
        if item.get(internal_key, None) is not None and item[internal_key] == 'FLUCT_BULLISH_L3':
