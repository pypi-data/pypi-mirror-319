...
pub use crate::types::v0_2_0::{Values, ProbabilityDistribution};
pub use crate::types::v0_3_0::{VariableRole, DiscreteVariableAnonymousElements, DiscreteVariableNamedElements, Variable, Factor, FactorRole};
...
pub struct VFG {
    ...
    #[cfg_attr(feature = "json", serde(with = "json::visualization_metadata", default, skip_serializing_if = "Option::is_none"))]
...
mod json_tests {
    ...
    fn test_metadata_serialization() {
        let vfg = VFG {
            ...
            visualization_metadata: Some(r#"{"layout":"force-directed","node_size":10}"#.to_string()),
            factors: vec![],
