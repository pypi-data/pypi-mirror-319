...
class InboundShipmentPlanItem(BaseModel):
    """
    ...
    fulfillment_network_sku: StrictStr = Field(description="Amazon's fulfillment network SKU of the item.", alias="FulfillmentNetworkSKU")
    ...
    __properties: ClassVar[List[str]] = ["SellerSKU", "FulfillmentNetworkSKU", "Quantity", "PrepDetailsList"]
