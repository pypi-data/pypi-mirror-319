...
class CreateInventoryItemRequest(BaseModel):
    ...
    marketplace_id: StrictStr = Field(description="The marketplaceId.", alias="marketplaceId")
    product_name: StrictStr = Field(description="The name of the item.", alias="productName")
    __properties: ClassVar[List[str]] = ["sellerSku", "marketplaceId", "productName"]
