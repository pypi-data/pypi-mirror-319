...
class GetPackingSlipResponse(BaseModel):
    """
    Response payload with packing slip.
    """ # noqa: E501
    payload: Optional[PackingSlip] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "payload": PackingSlip.from_dict(obj["payload"]) if obj.get("payload") is not None else None,
