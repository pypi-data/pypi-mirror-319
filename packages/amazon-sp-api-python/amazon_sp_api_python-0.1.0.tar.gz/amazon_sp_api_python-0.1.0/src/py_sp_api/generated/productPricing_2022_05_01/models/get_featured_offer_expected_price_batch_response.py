...
class GetFeaturedOfferExpectedPriceBatchResponse(BaseModel):
    ...
    """ # noqa: E501
    responses: Optional[Annotated[List[FeaturedOfferExpectedPriceResponse], Field(min_length=1)]] = Field(default=None, description="A batched list of FOEP responses.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "responses": [FeaturedOfferExpectedPriceResponse.from_dict(_item) for _item in obj["responses"]] if obj.get("responses") is not None else None
        })
        return _obj
