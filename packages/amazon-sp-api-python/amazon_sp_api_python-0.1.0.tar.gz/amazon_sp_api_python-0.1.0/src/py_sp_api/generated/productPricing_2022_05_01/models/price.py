...
class Price(BaseModel):
    ...
    shipping_price: Optional[MoneyType] = Field(default=None, alias="shippingPrice")
    points: Optional[Points] = None
    __properties: ClassVar[List[str]] = ["listingPrice", "shippingPrice", "points"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "shippingPrice": MoneyType.from_dict(obj["shippingPrice"]) if obj.get("shippingPrice") is not None else None,
