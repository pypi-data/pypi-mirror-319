...
class SubmitInvoiceRequest(BaseModel):
    ...
    """ # noqa: E501
    invoices: Optional[List[InvoiceDetail]] = Field(default=None, description="An array of invoice details to be submitted.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "invoices": [InvoiceDetail.from_dict(_item) for _item in obj["invoices"]] if obj.get("invoices") is not None else None
        })
        return _obj
