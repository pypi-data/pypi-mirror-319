...
class GetReportScheduleResponse(BaseModel):
    """
    The response for the getReportSchedule operation.
    """ # noqa: E501
    payload: Optional[ReportSchedule] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "payload": ReportSchedule.from_dict(obj["payload"]) if obj.get("payload") is not None else None,
