...
class ReportDocument(BaseModel):
    ...
    encryption_details: ReportDocumentEncryptionDetails = Field(alias="encryptionDetails")
    compression_algorithm: Optional[StrictStr] = Field(default=None, description="If the report document contents have been compressed, the compression algorithm used is returned in this property and you must decompress the report when you download. Otherwise, you can download the report directly. Refer to [Step 2. Download and decrypt the report](doc:reports-api-v2020-09-04-use-case-guide#step-2-download-and-decrypt-the-report) in the use case guide, where sample code is provided.", alias="compressionAlgorithm")
    __properties: ClassVar[List[str]] = ["reportDocumentId", "url", "encryptionDetails", "compressionAlgorithm"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "url": obj.get("url"),
            "encryptionDetails": ReportDocumentEncryptionDetails.from_dict(obj["encryptionDetails"]) if obj.get("encryptionDetails") is not None else None,
