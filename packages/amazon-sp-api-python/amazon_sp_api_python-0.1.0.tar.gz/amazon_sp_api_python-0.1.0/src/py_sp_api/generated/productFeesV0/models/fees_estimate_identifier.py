...
class FeesEstimateIdentifier(BaseModel):
    ...
    """ # noqa: E501
    marketplace_id: Optional[StrictStr] = Field(default=None, description="A marketplace identifier.", alias="MarketplaceId")
    ...
    id_value: Optional[StrictStr] = Field(default=None, description="The item identifier.", alias="IdValue")
    ...
    price_to_estimate_fees: Optional[PriceToEstimateFees] = Field(default=None, alias="PriceToEstimateFees")
    seller_input_identifier: Optional[StrictStr] = Field(default=None, description="A unique identifier provided by the caller to track this request.", alias="SellerInputIdentifier")
    optional_fulfillment_program: Optional[OptionalFulfillmentProgram] = Field(default=None, alias="OptionalFulfillmentProgram")
    __properties: ClassVar[List[str]] = ["MarketplaceId", "SellerId", "IdType", "IdValue", "IsAmazonFulfilled", "PriceToEstimateFees", "SellerInputIdentifier", "OptionalFulfillmentProgram"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "SellerInputIdentifier": obj.get("SellerInputIdentifier"),
