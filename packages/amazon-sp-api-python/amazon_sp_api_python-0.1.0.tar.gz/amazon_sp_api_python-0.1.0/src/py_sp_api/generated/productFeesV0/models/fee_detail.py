...
class FeeDetail(BaseModel):
    ...
    included_fee_detail_list: Optional[List[IncludedFeeDetail]] = Field(default=None, description="A list of other fees that contribute to a given fee.", alias="IncludedFeeDetailList")
    __properties: ClassVar[List[str]] = ["FeeType", "FeeAmount", "FeePromotion", "TaxAmount", "FinalFee", "IncludedFeeDetailList"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in included_fee_detail_list (list)
        _items = []
        if self.included_fee_detail_list:
            for _item_included_fee_detail_list in self.included_fee_detail_list:
                if _item_included_fee_detail_list:
                    _items.append(_item_included_fee_detail_list.to_dict())
            _dict['IncludedFeeDetailList'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "IncludedFeeDetailList": [IncludedFeeDetail.from_dict(_item) for _item in obj["IncludedFeeDetailList"]] if obj.get("IncludedFeeDetailList") is not None else None
        })
        return _obj
