...
class CreateFulfillmentReturnRequest(BaseModel):
    ...
    """ # noqa: E501
    items: List[CreateReturnItem] = Field(description="An array of items to be returned.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [CreateReturnItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
