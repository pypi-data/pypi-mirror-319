...
from py_sp_api.generated.fbaInbound.api_client import ApiClient, RequestSerialized
from py_sp_api.generated.fbaInbound.api_response import ApiResponse
from py_sp_api.generated.fbaInbound.rest import RESTResponseType
...
class FbaInboundApi:
    ...
    def get_item_eligibility_preview(
        self,
        asin: Annotated[StrictStr, Field(description="The ASIN of the item for which you want an eligibility preview.")],
        program: Annotated[StrictStr, Field(description="The program that you want to check eligibility against.")],
        marketplace_ids: Annotated[Optional[Annotated[List[StrictStr], Field(max_length=1)]], Field(description="The identifier for the marketplace in which you want to determine eligibility. Required only when program=INBOUND.")] = None,
        ...
        :type program: str
        :param marketplace_ids: The identifier for the marketplace in which you want to determine eligibility. Required only when program=INBOUND.
        ...
        _param = self._get_item_eligibility_preview_serialize(
            asin=asin,
            program=program,
    ...
    @validate_call
    def get_item_eligibility_preview_with_http_info(
        self,
        asin: Annotated[StrictStr, Field(description="The ASIN of the item for which you want an eligibility preview.")],
        program: Annotated[StrictStr, Field(description="The program that you want to check eligibility against.")],
        marketplace_ids: Annotated[Optional[Annotated[List[StrictStr], Field(max_length=1)]], Field(description="The identifier for the marketplace in which you want to determine eligibility. Required only when program=INBOUND.")] = None,
    ...
    @validate_call
    def get_item_eligibility_preview_without_preload_content(
        self,
        asin: Annotated[StrictStr, Field(description="The ASIN of the item for which you want an eligibility preview.")],
        program: Annotated[StrictStr, Field(description="The program that you want to check eligibility against.")],
        marketplace_ids: Annotated[Optional[Annotated[List[StrictStr], Field(max_length=1)]], Field(description="The identifier for the marketplace in which you want to determine eligibility. Required only when program=INBOUND.")] = None,
    ...
    def _get_item_eligibility_preview_serialize(
        self,
        asin,
        program,
        marketplace_ids,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/fba/inbound/v1/eligibility/itemPreview',
