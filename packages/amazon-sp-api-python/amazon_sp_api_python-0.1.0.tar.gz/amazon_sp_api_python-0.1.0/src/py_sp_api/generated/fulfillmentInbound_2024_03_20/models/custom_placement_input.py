...
class CustomPlacementInput(BaseModel):
    ...
    """ # noqa: E501
    items: Annotated[List[ItemInput], Field(min_length=1, max_length=2000)] = Field(description="Items included while creating Inbound Plan.")
    warehouse_id: Annotated[str, Field(min_length=1, strict=True, max_length=1024)] = Field(description="Warehouse Id.", alias="warehouseId")
    __properties: ClassVar[List[str]] = ["items", "warehouseId"]
