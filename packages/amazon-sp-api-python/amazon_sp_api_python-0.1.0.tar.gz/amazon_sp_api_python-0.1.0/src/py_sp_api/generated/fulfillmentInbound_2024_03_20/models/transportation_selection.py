...
class TransportationSelection(BaseModel):
    ...
    shipment_id: Annotated[str, Field(min_length=38, strict=True, max_length=38)] = Field(description="Shipment ID that the transportation Option is for.", alias="shipmentId")
    transportation_option_id: Annotated[str, Field(min_length=38, strict=True, max_length=38)] = Field(description="Transportation option being selected for the provided shipment.", alias="transportationOptionId")
    __properties: ClassVar[List[str]] = ["contactInformation", "shipmentId", "transportationOptionId"]
