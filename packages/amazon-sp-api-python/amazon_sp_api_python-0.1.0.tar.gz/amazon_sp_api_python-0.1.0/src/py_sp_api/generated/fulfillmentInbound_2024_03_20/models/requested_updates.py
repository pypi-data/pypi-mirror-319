...
class RequestedUpdates(BaseModel):
    ...
    """ # noqa: E501
    boxes: Optional[List[BoxUpdateInput]] = Field(default=None, description="A list of boxes that will be present in the shipment after the update.")
    items: Optional[List[ItemInput]] = Field(default=None, description="A list of all items that will be present in the shipment after the update.")
