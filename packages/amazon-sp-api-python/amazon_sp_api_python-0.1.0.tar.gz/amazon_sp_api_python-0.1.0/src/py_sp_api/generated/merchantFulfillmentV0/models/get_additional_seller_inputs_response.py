...
class GetAdditionalSellerInputsResponse(BaseModel):
    ...
    Response schema.
    """ # noqa: E501
    payload: Optional[GetAdditionalSellerInputsResult] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "payload": GetAdditionalSellerInputsResult.from_dict(obj["payload"]) if obj.get("payload") is not None else None,
