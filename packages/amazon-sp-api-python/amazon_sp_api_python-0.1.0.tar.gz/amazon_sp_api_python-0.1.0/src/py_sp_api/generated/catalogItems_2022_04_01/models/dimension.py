...
class Dimension(BaseModel):
    ...
    """ # noqa: E501
    unit: Optional[StrictStr] = Field(default=None, description="Measurement unit of the dimension value.")
    value: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Numeric dimension value.")
