...
class ItemDimensionsByMarketplace(BaseModel):
    ...
    item: Optional[Dimensions] = None
    package: Optional[Dimensions] = None
    __properties: ClassVar[List[str]] = ["marketplaceId", "item", "package"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "item": Dimensions.from_dict(obj["item"]) if obj.get("item") is not None else None,
            "package": Dimensions.from_dict(obj["package"]) if obj.get("package") is not None else None
        })
        return _obj
