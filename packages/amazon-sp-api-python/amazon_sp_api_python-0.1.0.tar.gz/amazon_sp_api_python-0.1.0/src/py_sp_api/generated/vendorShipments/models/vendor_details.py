...
class VendorDetails(BaseModel):
    ...
    vendor_shipment_identifier: Optional[StrictStr] = Field(default=None, description="Unique vendor shipment id which is not used in last 365 days", alias="vendorShipmentIdentifier")
    __properties: ClassVar[List[str]] = ["sellingParty", "vendorShipmentIdentifier"]
