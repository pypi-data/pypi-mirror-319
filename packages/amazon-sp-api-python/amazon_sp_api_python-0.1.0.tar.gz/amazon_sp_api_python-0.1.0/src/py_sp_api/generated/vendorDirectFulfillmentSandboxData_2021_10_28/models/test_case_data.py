...
class TestCaseData(BaseModel):
    ...
    """ # noqa: E501
    scenarios: Optional[List[Scenario]] = Field(default=None, description="Set of use cases that describes the possible test scenarios.")
    __properties: ClassVar[List[str]] = ["scenarios"]
