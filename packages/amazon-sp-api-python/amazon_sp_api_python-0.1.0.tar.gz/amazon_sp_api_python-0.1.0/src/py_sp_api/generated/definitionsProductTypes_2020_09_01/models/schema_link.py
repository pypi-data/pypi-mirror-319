...
class SchemaLink(BaseModel):
    ...
    """ # noqa: E501
    link: SchemaLinkLink
    checksum: StrictStr = Field(description="Checksum hash of the schema (Base64 MD5). Can be used to verify schema contents, identify changes between schema versions, and for caching.")
    __properties: ClassVar[List[str]] = ["link", "checksum"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "link": SchemaLinkLink.from_dict(obj["link"]) if obj.get("link") is not None else None,
