...
class GetPricingResponse(BaseModel):
    ...
    """ # noqa: E501
    payload: Optional[Annotated[List[Price], Field(max_length=20)]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "payload": [Price.from_dict(_item) for _item in obj["payload"]] if obj.get("payload") is not None else None,
