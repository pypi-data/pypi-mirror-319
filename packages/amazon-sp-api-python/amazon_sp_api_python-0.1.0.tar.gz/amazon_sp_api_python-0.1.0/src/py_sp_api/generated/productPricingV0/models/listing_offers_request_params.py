...
class ListingOffersRequestParams(BaseModel):
    ...
    seller_sku: StrictStr = Field(description="The seller stock keeping unit (SKU) of the item. This is the same SKU passed as a path parameter.", alias="SellerSKU")
    __properties: ClassVar[List[str]] = ["MarketplaceId", "ItemCondition", "CustomerType", "SellerSKU"]
