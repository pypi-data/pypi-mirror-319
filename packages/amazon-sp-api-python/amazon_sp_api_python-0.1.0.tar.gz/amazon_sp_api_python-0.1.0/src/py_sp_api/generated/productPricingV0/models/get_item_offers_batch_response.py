...
class GetItemOffersBatchResponse(BaseModel):
    ...
    """ # noqa: E501
    responses: Optional[Annotated[List[ItemOffersResponse], Field(min_length=1, max_length=20)]] = Field(default=None, description="A list of `getItemOffers` batched responses.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "responses": [ItemOffersResponse.from_dict(_item) for _item in obj["responses"]] if obj.get("responses") is not None else None
        })
        return _obj
