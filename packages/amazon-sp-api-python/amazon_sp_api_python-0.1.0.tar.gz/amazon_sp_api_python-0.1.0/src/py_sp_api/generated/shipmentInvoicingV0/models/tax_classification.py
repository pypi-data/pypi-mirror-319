...
class TaxClassification(BaseModel):
    ...
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="The type of tax.", alias="Name")
    value: Optional[StrictStr] = Field(default=None, description="The entity's tax identifier.", alias="Value")
