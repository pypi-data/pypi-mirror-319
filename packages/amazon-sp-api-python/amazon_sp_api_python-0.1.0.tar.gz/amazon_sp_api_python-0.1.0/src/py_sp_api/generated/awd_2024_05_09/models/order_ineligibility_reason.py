...
class OrderIneligibilityReason(BaseModel):
    ...
    """ # noqa: E501
    code: StrictStr = Field(description="Code for the order ineligibility.")
    description: StrictStr = Field(description="Description detailing the ineligibility reason of the order.")
