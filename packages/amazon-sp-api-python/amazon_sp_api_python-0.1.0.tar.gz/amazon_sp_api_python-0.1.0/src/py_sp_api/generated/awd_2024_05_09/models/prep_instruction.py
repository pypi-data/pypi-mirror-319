...
class PrepInstruction(BaseModel):
    ...
    prep_type: Optional[StrictStr] = Field(default=None, description="The type of preparation to be done. For more information about preparing items, refer to [Prep guidance](https://sellercentral.amazon.com/help/hub/reference/external/GF4G7547KSLDX2KC) on Seller Central.", alias="prepType")
    __properties: ClassVar[List[str]] = ["prepOwner", "prepType"]
