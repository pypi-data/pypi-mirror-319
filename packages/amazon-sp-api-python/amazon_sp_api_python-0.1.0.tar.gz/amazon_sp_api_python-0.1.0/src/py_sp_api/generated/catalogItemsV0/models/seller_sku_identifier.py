...
class SellerSKUIdentifier(BaseModel):
    ...
    seller_id: StrictStr = Field(description="The seller identifier submitted for the operation.", alias="SellerId")
    seller_sku: StrictStr = Field(description="The seller stock keeping unit (SKU) of the item.", alias="SellerSKU")
    __properties: ClassVar[List[str]] = ["MarketplaceId", "SellerId", "SellerSKU"]
