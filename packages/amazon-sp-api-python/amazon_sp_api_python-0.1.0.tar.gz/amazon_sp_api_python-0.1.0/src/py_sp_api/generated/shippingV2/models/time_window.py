...
class TimeWindow(BaseModel):
    ...
    """ # noqa: E501
    start: Optional[datetime] = Field(default=None, description="The start time of the time window.")
    end: Optional[datetime] = Field(default=None, description="The end time of the time window.")
