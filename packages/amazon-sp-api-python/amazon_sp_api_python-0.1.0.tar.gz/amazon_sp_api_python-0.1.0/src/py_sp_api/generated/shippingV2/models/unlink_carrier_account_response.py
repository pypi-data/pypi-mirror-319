...
class UnlinkCarrierAccountResponse(BaseModel):
    ...
    """ # noqa: E501
    is_unlinked: Optional[StrictBool] = Field(default=None, description="Is Carrier unlinked from Merchant", alias="isUnlinked")
    __properties: ClassVar[List[str]] = ["isUnlinked"]
