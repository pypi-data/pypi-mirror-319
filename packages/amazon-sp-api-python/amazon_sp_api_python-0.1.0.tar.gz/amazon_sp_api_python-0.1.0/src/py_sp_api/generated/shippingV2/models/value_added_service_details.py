...
class ValueAddedServiceDetails(BaseModel):
    ...
    """ # noqa: E501
    collect_on_delivery: Optional[CollectOnDelivery] = Field(default=None, alias="collectOnDelivery")
    __properties: ClassVar[List[str]] = ["collectOnDelivery"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.collect_on_delivery:
            _dict['collectOnDelivery'] = self.collect_on_delivery.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "collectOnDelivery": CollectOnDelivery.from_dict(obj["collectOnDelivery"]) if obj.get("collectOnDelivery") is not None else None
        })
        return _obj
