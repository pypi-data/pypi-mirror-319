...
class AdhocDisbursementEvent(BaseModel):
    ...
    """ # noqa: E501
    transaction_type: Optional[StrictStr] = Field(default=None, description="Indicates the type of transaction.  Example: \"Disbursed to Amazon Gift Card balance\"", alias="TransactionType")
    ...
    transaction_id: Optional[StrictStr] = Field(default=None, description="The identifier for the transaction.", alias="TransactionId")
    transaction_amount: Optional[Currency] = Field(default=None, alias="TransactionAmount")
    __properties: ClassVar[List[str]] = ["TransactionType", "PostedDate", "TransactionId", "TransactionAmount"]
