...
class ListContentDocumentAsinRelationsResponse(BaseModel):
    ...
    asin_metadata_set: List[AsinMetadata] = Field(description="The set of ASIN metadata.", alias="asinMetadataSet")
    __properties: ClassVar[List[str]] = ["warnings", "nextPageToken", "asinMetadataSet"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in asin_metadata_set (list)
        _items = []
        if self.asin_metadata_set:
            for _item_asin_metadata_set in self.asin_metadata_set:
                if _item_asin_metadata_set:
                    _items.append(_item_asin_metadata_set.to_dict())
            _dict['asinMetadataSet'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "asinMetadataSet": [AsinMetadata.from_dict(_item) for _item in obj["asinMetadataSet"]] if obj.get("asinMetadataSet") is not None else None
        })
        return _obj
