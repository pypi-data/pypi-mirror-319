...
class GetContentDocumentResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["warnings", "contentRecord"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of content_record
        if self.content_record:
            _dict['contentRecord'] = self.content_record.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "contentRecord": ContentRecord.from_dict(obj["contentRecord"]) if obj.get("contentRecord") is not None else None
        })
        return _obj
