...
class GetInventorySummariesResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["payload", "pagination", "errors"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "payload": GetInventorySummariesResult.from_dict(obj["payload"]) if obj.get("payload") is not None else None,
