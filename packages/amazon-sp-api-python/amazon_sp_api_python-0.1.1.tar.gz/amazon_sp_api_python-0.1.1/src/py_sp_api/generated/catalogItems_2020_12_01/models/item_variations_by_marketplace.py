...
class ItemVariationsByMarketplace(BaseModel):
    ...
    asins: List[StrictStr] = Field(description="Identifiers (ASINs) of the related items.")
    variation_type: StrictStr = Field(description="Type of variation relationship of the Amazon catalog item in the request to the related item(s): \"PARENT\" or \"CHILD\".", alias="variationType")
    __properties: ClassVar[List[str]] = ["marketplaceId", "asins", "variationType"]
