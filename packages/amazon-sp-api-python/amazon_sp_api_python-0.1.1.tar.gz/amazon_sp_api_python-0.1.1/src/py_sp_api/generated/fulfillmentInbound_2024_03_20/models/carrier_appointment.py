...
class CarrierAppointment(BaseModel):
    ...
    """ # noqa: E501
    end_time: datetime = Field(description="The end timestamp of the appointment in UTC.", alias="endTime")
    start_time: datetime = Field(description="The start timestamp of the appointment in UTC.", alias="startTime")
