...
class PlacementOptionSummary(BaseModel):
    ...
    status: Annotated[str, Field(min_length=1, strict=True, max_length=1024)] = Field(description="The status of a placement option. Possible values: `OFFERED`, `ACCEPTED`.")
    __properties: ClassVar[List[str]] = ["placementOptionId", "status"]
