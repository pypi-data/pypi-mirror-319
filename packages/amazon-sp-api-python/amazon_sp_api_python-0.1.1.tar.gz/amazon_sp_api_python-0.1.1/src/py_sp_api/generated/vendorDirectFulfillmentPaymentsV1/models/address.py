...
class Address(BaseModel):
    ...
    city: StrictStr = Field(description="The city where the person, business or institution is located.")
    ...
    postal_code: StrictStr = Field(description="The postal code of that address. It conatins a series of letters or digits or both, sometimes including spaces or punctuation.", alias="postalCode")
