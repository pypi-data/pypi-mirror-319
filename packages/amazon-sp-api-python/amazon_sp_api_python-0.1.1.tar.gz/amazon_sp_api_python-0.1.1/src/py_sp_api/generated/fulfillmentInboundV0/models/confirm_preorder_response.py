...
class ConfirmPreorderResponse(BaseModel):
    """
    The response schema for the confirmPreorder operation.
    """ # noqa: E501
    payload: Optional[ConfirmPreorderResult] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "payload": ConfirmPreorderResult.from_dict(obj["payload"]) if obj.get("payload") is not None else None,
