...
class NonPartneredSmallParcelDataOutput(BaseModel):
    """
    Information returned by Amazon about a Small Parcel shipment by a carrier that has not partnered with Amazon.
    """ # noqa: E501
    package_list: List[NonPartneredSmallParcelPackageOutput] = Field(description="A list of packages, including carrier, tracking number, and status information for each package.", alias="PackageList")
    __properties: ClassVar[List[str]] = ["PackageList"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "PackageList": [NonPartneredSmallParcelPackageOutput.from_dict(_item) for _item in obj["PackageList"]] if obj.get("PackageList") is not None else None
        })
        return _obj
