...
class SubmitShipmentStatusUpdatesResponse(BaseModel):
    """
    The response schema for the submitShipmentStatusUpdates operation.
    """ # noqa: E501
    payload: Optional[TransactionReference] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "payload": TransactionReference.from_dict(obj["payload"]) if obj.get("payload") is not None else None,
