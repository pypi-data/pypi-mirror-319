...
class GetCustomerInvoiceResponse(BaseModel):
    """
    The response schema for the getCustomerInvoice operation.
    """ # noqa: E501
    payload: Optional[CustomerInvoice] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "payload": CustomerInvoice.from_dict(obj["payload"]) if obj.get("payload") is not None else None,
