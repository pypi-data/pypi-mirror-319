...
class CustomerInvoice(BaseModel):
    ...
    """ # noqa: E501
    purchase_order_number: Annotated[str, Field(strict=True)] = Field(description="The purchase order number for this order.", alias="purchaseOrderNumber")
    content: StrictStr = Field(description="The Base64encoded customer invoice.")
    __properties: ClassVar[List[str]] = ["purchaseOrderNumber", "content"]
