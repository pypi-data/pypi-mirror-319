...
class ImagingServicesFeeEvent(BaseModel):
    ...
    """ # noqa: E501
    imaging_request_billing_item_id: Optional[StrictStr] = Field(default=None, description="The identifier for the imaging services request.", alias="ImagingRequestBillingItemID")
    asin: Optional[StrictStr] = Field(default=None, description="The Amazon Standard Identification Number (ASIN) of the item for which the imaging service was requested.", alias="ASIN")
    ...
    __properties: ClassVar[List[str]] = ["ImagingRequestBillingItemID", "ASIN", "PostedDate", "FeeList"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "ImagingRequestBillingItemID": obj.get("ImagingRequestBillingItemID"),
            "ASIN": obj.get("ASIN"),
