...
class TrialShipmentEvent(BaseModel):
    ...
    financial_event_group_id: Optional[StrictStr] = Field(default=None, description="The identifier of the financial event group.", alias="FinancialEventGroupId")
    ...
    sku: Optional[StrictStr] = Field(default=None, description="The seller SKU of the item. The seller SKU is qualified by the seller's seller ID, which is included with every call to the Selling Partner API.", alias="SKU")
    fee_list: Optional[List[FeeComponent]] = Field(default=None, description="A list of fee component information.", alias="FeeList")
    __properties: ClassVar[List[str]] = ["AmazonOrderId", "FinancialEventGroupId", "PostedDate", "SKU", "FeeList"]
