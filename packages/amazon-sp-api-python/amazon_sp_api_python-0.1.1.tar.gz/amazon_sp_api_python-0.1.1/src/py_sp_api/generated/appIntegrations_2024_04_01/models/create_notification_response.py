...
class CreateNotificationResponse(BaseModel):
    ...
    """ # noqa: E501
    notification_id: Optional[StrictStr] = Field(default=None, description="The unique identifier assigned to each notification.", alias="notificationId")
    __properties: ClassVar[List[str]] = ["notificationId"]
