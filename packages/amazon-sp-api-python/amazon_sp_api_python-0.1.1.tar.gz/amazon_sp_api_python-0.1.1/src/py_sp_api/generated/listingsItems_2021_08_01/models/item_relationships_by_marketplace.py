...
class ItemRelationshipsByMarketplace(BaseModel):
    ...
    relationships: List[ItemRelationship] = Field(description="Relationships for the listing item.")
    __properties: ClassVar[List[str]] = ["marketplaceId", "relationships"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "relationships": [ItemRelationship.from_dict(_item) for _item in obj["relationships"]] if obj.get("relationships") is not None else None
        })
        return _obj
