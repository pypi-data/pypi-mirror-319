...
class ItemIdentifiersByMarketplace(BaseModel):
    ...
    """ # noqa: E501
    marketplace_id: Optional[StrictStr] = Field(default=None, description="A marketplace identifier. Identifies the Amazon marketplace for the listings item.", alias="marketplaceId")
    asin: Optional[StrictStr] = Field(default=None, description="Amazon Standard Identification Number (ASIN) of the listings item.")
    __properties: ClassVar[List[str]] = ["marketplaceId", "asin"]
