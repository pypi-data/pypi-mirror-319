...
class GetMarketplaceParticipationsResponse(BaseModel):
    ...
    """ # noqa: E501
    payload: Optional[List[MarketplaceParticipation]] = Field(default=None, description="List of marketplace participations.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "payload": [MarketplaceParticipation.from_dict(_item) for _item in obj["payload"]] if obj.get("payload") is not None else None,
