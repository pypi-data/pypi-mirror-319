...
class OrderItemsBuyerInfoList(BaseModel):
    ...
    """ # noqa: E501
    order_items: List[OrderItemBuyerInfo] = Field(description="A single order item's buyer information list.", alias="OrderItems")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "OrderItems": [OrderItemBuyerInfo.from_dict(_item) for _item in obj["OrderItems"]] if obj.get("OrderItems") is not None else None,
