...
class GetSchemaResponse(BaseModel):
    ...
    GetSchemaResponse
    """ # noqa: E501
    links: Optional[GetSchemaResponseLinks] = Field(default=None, alias="_links")
    payload: Optional[Dict[str, Dict[str, Any]]] = Field(default=None, description="A JSON schema document describing the expected payload of the action. This object can be validated against <a href=http://json-schema.org/draft-04/schema>http://json-schema.org/draft-04/schema</a>.")
    ...
    __properties: ClassVar[List[str]] = ["_links", "payload", "errors"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "_links": GetSchemaResponseLinks.from_dict(obj["_links"]) if obj.get("_links") is not None else None,
