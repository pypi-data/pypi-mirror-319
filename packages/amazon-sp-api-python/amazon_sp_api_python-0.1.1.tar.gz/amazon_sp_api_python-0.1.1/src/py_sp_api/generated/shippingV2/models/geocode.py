...
class Geocode(BaseModel):
    ...
    """ # noqa: E501
    latitude: Optional[StrictStr] = Field(default=None, description="The latitude of access point.")
    longitude: Optional[StrictStr] = Field(default=None, description="The longitude of access point.")
