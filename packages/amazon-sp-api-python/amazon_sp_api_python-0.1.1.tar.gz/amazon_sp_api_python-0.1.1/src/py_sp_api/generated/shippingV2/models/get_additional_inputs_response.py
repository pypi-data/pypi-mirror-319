...
class GetAdditionalInputsResponse(BaseModel):
    ...
    """ # noqa: E501
    payload: Optional[Dict[str, Dict[str, Any]]] = Field(default=None, description="The JSON schema to use to provide additional inputs when required to purchase a shipping offering.")
