...
class SupportedDocumentDetail(BaseModel):
    ...
    """ # noqa: E501
    name: DocumentType
    is_mandatory: StrictBool = Field(description="When true, the supported document type is required.", alias="isMandatory")
    __properties: ClassVar[List[str]] = ["name", "isMandatory"]
