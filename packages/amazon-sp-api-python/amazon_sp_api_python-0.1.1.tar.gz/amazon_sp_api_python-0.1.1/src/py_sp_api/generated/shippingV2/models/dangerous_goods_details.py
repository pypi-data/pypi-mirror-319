...
class DangerousGoodsDetails(BaseModel):
    ...
    transportation_regulatory_class: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="The specific regulatory class  of the item being shipped.", alias="transportationRegulatoryClass")
