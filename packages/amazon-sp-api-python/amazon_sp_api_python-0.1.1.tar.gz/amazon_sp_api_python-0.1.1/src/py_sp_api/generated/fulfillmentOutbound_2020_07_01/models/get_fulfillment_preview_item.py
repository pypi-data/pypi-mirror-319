...
class GetFulfillmentPreviewItem(BaseModel):
    ...
    seller_fulfillment_order_item_id: Annotated[str, Field(strict=True, max_length=50)] = Field(description="A fulfillment order item identifier that the seller creates to track items in the fulfillment preview.", alias="sellerFulfillmentOrderItemId")
    __properties: ClassVar[List[str]] = ["sellerSku", "quantity", "perUnitDeclaredValue", "sellerFulfillmentOrderItemId"]
