...
class Destination(BaseModel):
    ...
    """ # noqa: E501
    delivery_address: Optional[VariablePrecisionAddress] = Field(default=None, alias="deliveryAddress")
    ip_address: Optional[StrictStr] = Field(default=None, description="An IP Address.", alias="ipAddress")
    __properties: ClassVar[List[str]] = ["deliveryAddress", "ipAddress"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "deliveryAddress": VariablePrecisionAddress.from_dict(obj["deliveryAddress"]) if obj.get("deliveryAddress") is not None else None,
