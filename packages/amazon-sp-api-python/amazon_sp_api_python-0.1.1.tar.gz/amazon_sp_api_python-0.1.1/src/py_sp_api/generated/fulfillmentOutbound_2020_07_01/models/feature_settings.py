...
class FeatureSettings(BaseModel):
    ...
    feature_fulfillment_policy: Optional[StrictStr] = Field(default=None, description="Specifies the policy to use when fulfilling an order.", alias="featureFulfillmentPolicy")
    __properties: ClassVar[List[str]] = ["featureName", "featureFulfillmentPolicy"]

    @field_validator('feature_fulfillment_policy')
    def feature_fulfillment_policy_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "featureFulfillmentPolicy": obj.get("featureFulfillmentPolicy")
        })
        return _obj
