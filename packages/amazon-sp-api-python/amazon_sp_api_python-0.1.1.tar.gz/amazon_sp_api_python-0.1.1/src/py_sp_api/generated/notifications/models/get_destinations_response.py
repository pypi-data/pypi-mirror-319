...
class GetDestinationsResponse(BaseModel):
    ...
    """ # noqa: E501
    payload: Optional[List[Destination]] = Field(default=None, description="A list of destinations.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "payload": [Destination.from_dict(_item) for _item in obj["payload"]] if obj.get("payload") is not None else None,
