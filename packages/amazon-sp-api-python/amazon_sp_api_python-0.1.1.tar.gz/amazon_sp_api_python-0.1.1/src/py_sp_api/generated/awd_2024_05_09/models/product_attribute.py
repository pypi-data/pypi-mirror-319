...
class ProductAttribute(BaseModel):
    ...
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="Product attribute name.")
    value: Optional[StrictStr] = Field(default=None, description="Product attribute value.")
