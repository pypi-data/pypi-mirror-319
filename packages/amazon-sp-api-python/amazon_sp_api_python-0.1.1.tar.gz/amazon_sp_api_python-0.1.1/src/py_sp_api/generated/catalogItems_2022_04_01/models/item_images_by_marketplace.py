...
class ItemImagesByMarketplace(BaseModel):
    ...
    images: List[ItemImage] = Field(description="Images for an item in the Amazon catalog for the indicated Amazon marketplace.")
    __properties: ClassVar[List[str]] = ["marketplaceId", "images"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "images": [ItemImage.from_dict(_item) for _item in obj["images"]] if obj.get("images") is not None else None
        })
        return _obj
