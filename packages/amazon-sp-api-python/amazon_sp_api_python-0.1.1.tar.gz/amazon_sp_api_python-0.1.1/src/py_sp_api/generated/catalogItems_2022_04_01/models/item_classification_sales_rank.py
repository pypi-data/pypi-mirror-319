...
class ItemClassificationSalesRank(BaseModel):
    ...
    """ # noqa: E501
    classification_id: StrictStr = Field(description="Identifier of the classification associated with the sales rank.", alias="classificationId")
    ...
    __properties: ClassVar[List[str]] = ["classificationId", "title", "link", "rank"]
