...
class SetAppointmentResponse(BaseModel):
    ...
    warnings: Optional[List[Warning]] = Field(default=None, description="A list of warnings returned in the sucessful execution response of an API request.")
    ...
    __properties: ClassVar[List[str]] = ["appointmentId", "warnings", "errors"]
