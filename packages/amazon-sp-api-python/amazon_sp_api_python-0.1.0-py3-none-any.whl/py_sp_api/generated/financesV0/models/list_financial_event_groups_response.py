...
class ListFinancialEventGroupsResponse(BaseModel):
    ...
    """ # noqa: E501
    payload: Optional[ListFinancialEventGroupsPayload] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "payload": ListFinancialEventGroupsPayload.from_dict(obj["payload"]) if obj.get("payload") is not None else None,
