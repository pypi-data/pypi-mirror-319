...
class TaxWithheldComponent(BaseModel):
    ...
    taxes_withheld: Optional[List[ChargeComponent]] = Field(default=None, description="A list of charge information on the seller's account.", alias="TaxesWithheld")
    __properties: ClassVar[List[str]] = ["TaxCollectionModel", "TaxesWithheld"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in taxes_withheld (list)
        _items = []
        if self.taxes_withheld:
            for _item_taxes_withheld in self.taxes_withheld:
                if _item_taxes_withheld:
                    _items.append(_item_taxes_withheld.to_dict())
            _dict['TaxesWithheld'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "TaxesWithheld": [ChargeComponent.from_dict(_item) for _item in obj["TaxesWithheld"]] if obj.get("TaxesWithheld") is not None else None
        })
        return _obj
