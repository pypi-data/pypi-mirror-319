...
class ScheduledPackageId(BaseModel):
    ...
    package_id: Optional[StrictStr] = Field(default=None, description="An Amazon-defined identifier for the scheduled package.", alias="packageId")
    __properties: ClassVar[List[str]] = ["amazonOrderId", "packageId"]
