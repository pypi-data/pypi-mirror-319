...
class CreateQueryResponse(BaseModel):
    ...
    """ # noqa: E501
    query_id: StrictStr = Field(description="The identifier for the query. This identifier is unique only in combination with a selling partner account ID.", alias="queryId")
