...
class GetPaymentMethodsResponse(BaseModel):
    ...
    """ # noqa: E501
    payment_methods: Optional[List[PaymentMethodDetails]] = Field(default=None, description="The list of payment methods with payment method details.", alias="paymentMethods")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "paymentMethods": [PaymentMethodDetails.from_dict(_item) for _item in obj["paymentMethods"]] if obj.get("paymentMethods") is not None else None
        })
        return _obj
