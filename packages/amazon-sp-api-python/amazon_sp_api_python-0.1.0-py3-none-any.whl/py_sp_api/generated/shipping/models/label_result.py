...
class LabelResult(BaseModel):
    ...
    """ # noqa: E501
    container_reference_id: Optional[Annotated[str, Field(strict=True, max_length=40)]] = Field(default=None, description="An identifier for the container. This must be unique within all the containers in the same shipment.", alias="containerReferenceId")
    tracking_id: Optional[StrictStr] = Field(default=None, description="The tracking identifier assigned to the container.", alias="trackingId")
    label: Optional[Label] = None
    __properties: ClassVar[List[str]] = ["containerReferenceId", "trackingId", "label"]
