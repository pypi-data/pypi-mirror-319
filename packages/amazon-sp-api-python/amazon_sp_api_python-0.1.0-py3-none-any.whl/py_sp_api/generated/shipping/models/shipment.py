...
class Shipment(BaseModel):
    ...
    accepted_rate: Optional[AcceptedRate] = Field(default=None, alias="acceptedRate")
    shipper: Optional[Party] = None
    containers: List[Container] = Field(description="A list of container.")
    __properties: ClassVar[List[str]] = ["shipmentId", "clientReferenceId", "shipFrom", "shipTo", "acceptedRate", "shipper", "containers"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of shipper
        if self.shipper:
            _dict['shipper'] = self.shipper.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "shipper": Party.from_dict(obj["shipper"]) if obj.get("shipper") is not None else None,
