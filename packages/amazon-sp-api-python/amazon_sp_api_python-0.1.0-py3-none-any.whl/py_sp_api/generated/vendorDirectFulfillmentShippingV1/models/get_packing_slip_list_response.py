...
class GetPackingSlipListResponse(BaseModel):
    """
    Response payload with the list of Packing Slips.
    """ # noqa: E501
    payload: Optional[PackingSlipList] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "payload": PackingSlipList.from_dict(obj["payload"]) if obj.get("payload") is not None else None,
