...
class GetCustomerInvoicesResponse(BaseModel):
    """
    The response schema for the getCustomerInvoices operation.
    """ # noqa: E501
    payload: Optional[CustomerInvoiceList] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "payload": CustomerInvoiceList.from_dict(obj["payload"]) if obj.get("payload") is not None else None,
