...
class GetShippingLabelResponse(BaseModel):
    """
    The response schema for the getShippingLabel operation.
    """ # noqa: E501
    payload: Optional[ShippingLabel] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "payload": ShippingLabel.from_dict(obj["payload"]) if obj.get("payload") is not None else None,
