...
class ActiveAccount(BaseModel):
    ...
    """ # noqa: E501
    account_id: Optional[StrictStr] = Field(default=None, description="Account Id associated with this account.", alias="accountId")
    ...
    __properties: ClassVar[List[str]] = ["accountId", "carrierId"]
