...
class TaxDetail(BaseModel):
    ...
    tax_registration_number: StrictStr = Field(description="The shipper's tax registration number associated with the shipment for customs compliance purposes in certain regions.", alias="taxRegistrationNumber")
    __properties: ClassVar[List[str]] = ["taxType", "taxRegistrationNumber"]
