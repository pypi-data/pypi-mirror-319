...
class SegmentedFeaturedOffer(BaseModel):
    ...
    featured_offer_segments: List[FeaturedOfferSegment] = Field(description="The list of segment information in which the offer is featured.", alias="featuredOfferSegments")
    __properties: ClassVar[List[str]] = ["sellerId", "condition", "subCondition", "fulfillmentType", "listingPrice", "shippingOptions", "points", "primeDetails", "featuredOfferSegments"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in featured_offer_segments (list)
        _items = []
        if self.featured_offer_segments:
            for _item_featured_offer_segments in self.featured_offer_segments:
                if _item_featured_offer_segments:
                    _items.append(_item_featured_offer_segments.to_dict())
            _dict['featuredOfferSegments'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "featuredOfferSegments": [FeaturedOfferSegment.from_dict(_item) for _item in obj["featuredOfferSegments"]] if obj.get("featuredOfferSegments") is not None else None
        })
        return _obj
