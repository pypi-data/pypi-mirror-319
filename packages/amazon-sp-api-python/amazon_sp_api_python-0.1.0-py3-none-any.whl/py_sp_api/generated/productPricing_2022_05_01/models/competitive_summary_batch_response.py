...
class CompetitiveSummaryBatchResponse(BaseModel):
    ...
    """ # noqa: E501
    responses: Annotated[List[CompetitiveSummaryResponse], Field(min_length=1, max_length=20)] = Field(description="The response list for the `competitiveSummaryBatch` operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "responses": [CompetitiveSummaryResponse.from_dict(_item) for _item in obj["responses"]] if obj.get("responses") is not None else None
        })
        return _obj
