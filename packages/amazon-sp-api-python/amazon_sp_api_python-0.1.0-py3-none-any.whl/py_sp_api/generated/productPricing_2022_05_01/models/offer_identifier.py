...
class OfferIdentifier(BaseModel):
    ...
    sku: Optional[StrictStr] = Field(default=None, description="The seller SKU of the item. This will only be present for the target offer, which belongs to the requesting seller.")
    asin: StrictStr = Field(description="The ASIN of the item.")
    fulfillment_type: Optional[FulfillmentType] = Field(default=None, alias="fulfillmentType")
    __properties: ClassVar[List[str]] = ["marketplaceId", "sellerId", "sku", "asin", "fulfillmentType"]
