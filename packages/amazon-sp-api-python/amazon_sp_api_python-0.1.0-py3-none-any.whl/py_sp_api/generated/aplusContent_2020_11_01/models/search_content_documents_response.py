...
class SearchContentDocumentsResponse(BaseModel):
    ...
    content_metadata_records: List[ContentMetadataRecord] = Field(description="A list of A+ Content metadata records.", alias="contentMetadataRecords")
    __properties: ClassVar[List[str]] = ["warnings", "nextPageToken", "contentMetadataRecords"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in content_metadata_records (list)
        _items = []
        if self.content_metadata_records:
            for _item_content_metadata_records in self.content_metadata_records:
                if _item_content_metadata_records:
                    _items.append(_item_content_metadata_records.to_dict())
            _dict['contentMetadataRecords'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "contentMetadataRecords": [ContentMetadataRecord.from_dict(_item) for _item in obj["contentMetadataRecords"]] if obj.get("contentMetadataRecords") is not None else None
        })
        return _obj
