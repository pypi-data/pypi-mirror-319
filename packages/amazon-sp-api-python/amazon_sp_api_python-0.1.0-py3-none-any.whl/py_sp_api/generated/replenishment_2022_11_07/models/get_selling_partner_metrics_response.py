...
class GetSellingPartnerMetricsResponse(BaseModel):
    ...
    """ # noqa: E501
    metrics: Optional[List[GetSellingPartnerMetricsResponseMetric]] = Field(default=None, description="A list of metrics data for the selling partner.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "metrics": [GetSellingPartnerMetricsResponseMetric.from_dict(_item) for _item in obj["metrics"]] if obj.get("metrics") is not None else None
        })
        return _obj
