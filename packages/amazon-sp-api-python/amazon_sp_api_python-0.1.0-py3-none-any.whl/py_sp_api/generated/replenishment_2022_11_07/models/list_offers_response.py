...
class ListOffersResponse(BaseModel):
    ...
    """ # noqa: E501
    offers: Optional[List[ListOffersResponseOffer]] = Field(default=None, description="A list of offers.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "offers": [ListOffersResponseOffer.from_dict(_item) for _item in obj["offers"]] if obj.get("offers") is not None else None,
