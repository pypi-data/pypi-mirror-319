...
class OutboundOrderCreationData(BaseModel):
    ...
    """ # noqa: E501
    order_preferences: Optional[List[OrderAttribute]] = Field(default=None, description="Order preferences for the outbound order.", alias="orderPreferences")
    ...
    __properties: ClassVar[List[str]] = ["orderPreferences", "packagesToOutbound", "productsToOutbound"]
