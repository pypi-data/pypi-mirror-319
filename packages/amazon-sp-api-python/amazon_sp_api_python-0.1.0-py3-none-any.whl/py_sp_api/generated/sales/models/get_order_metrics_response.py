...
class GetOrderMetricsResponse(BaseModel):
    ...
    """ # noqa: E501
    payload: Optional[List[OrderMetricsInterval]] = Field(default=None, description="A set of order metrics, each scoped to a particular time interval.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "payload": [OrderMetricsInterval.from_dict(_item) for _item in obj["payload"]] if obj.get("payload") is not None else None,
