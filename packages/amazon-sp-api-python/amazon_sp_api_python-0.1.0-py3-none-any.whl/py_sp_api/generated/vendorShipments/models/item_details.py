...
class ItemDetails(BaseModel):
    ...
    handling_code: Optional[StrictStr] = Field(default=None, description="Identification of the instructions on how specified item/carton/pallet should be handled.", alias="handlingCode")
    __properties: ClassVar[List[str]] = ["purchaseOrderNumber", "lotNumber", "expiry", "maximumRetailPrice", "handlingCode"]

    @field_validator('handling_code')
    def handling_code_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "handlingCode": obj.get("handlingCode")
        })
        return _obj
