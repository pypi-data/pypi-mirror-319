...
class GetListingOffersBatchResponse(BaseModel):
    ...
    """ # noqa: E501
    responses: Optional[Annotated[List[ListingOffersResponse], Field(min_length=1, max_length=20)]] = Field(default=None, description="A list of `getListingOffers` batched responses.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "responses": [ListingOffersResponse.from_dict(_item) for _item in obj["responses"]] if obj.get("responses") is not None else None
        })
        return _obj
