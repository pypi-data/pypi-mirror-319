...
class ListPlacementOptionsResponse(BaseModel):
    ...
    placement_options: List[PlacementOption] = Field(description="Placement options generated for the inbound plan.", alias="placementOptions")
    __properties: ClassVar[List[str]] = ["pagination", "placementOptions"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "placementOptions": [PlacementOption.from_dict(_item) for _item in obj["placementOptions"]] if obj.get("placementOptions") is not None else None
        })
        return _obj
