...
class OrderList(BaseModel):
    ...
    orders: Optional[List[Order]] = Field(default=None, description="Represents a purchase order within the OrderList.")
    __properties: ClassVar[List[str]] = ["pagination", "orders"]
