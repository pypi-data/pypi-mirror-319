...
class OrderItem(BaseModel):
    ...
    tax_details: Optional[OrderItemTaxDetails] = Field(default=None, alias="taxDetails")
    total_price: Optional[Money] = Field(default=None, alias="totalPrice")
    __properties: ClassVar[List[str]] = ["itemSequenceNumber", "buyerProductIdentifier", "vendorProductIdentifier", "title", "orderedQuantity", "scheduledDeliveryShipment", "giftDetails", "netPrice", "taxDetails", "totalPrice"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "taxDetails": OrderItemTaxDetails.from_dict(obj["taxDetails"]) if obj.get("taxDetails") is not None else None,
