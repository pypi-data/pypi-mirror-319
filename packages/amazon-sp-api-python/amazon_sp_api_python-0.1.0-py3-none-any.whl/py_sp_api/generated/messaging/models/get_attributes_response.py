...
class GetAttributesResponse(BaseModel):
    ...
    """ # noqa: E501
    buyer: Optional[GetAttributesResponseBuyer] = None
    ...
    __properties: ClassVar[List[str]] = ["buyer", "errors"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "buyer": GetAttributesResponseBuyer.from_dict(obj["buyer"]) if obj.get("buyer") is not None else None,
