...
class RangeSlot(BaseModel):
    ...
    end_date_time: Optional[datetime] = Field(default=None, description="End date time of slot in ISO 8601 format with precision of seconds.", alias="endDateTime")
    capacity: Optional[StrictInt] = Field(default=None, description="Capacity of the slot.")
    __properties: ClassVar[List[str]] = ["startDateTime", "endDateTime", "capacity"]
