...
class AssignAppointmentResourcesRequest(BaseModel):
    ...
    """ # noqa: E501
    resources: List[AppointmentResource] = Field(description="List of resources that performs or performed job appointment fulfillment.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "resources": [AppointmentResource.from_dict(_item) for _item in obj["resources"]] if obj.get("resources") is not None else None
        })
        return _obj
