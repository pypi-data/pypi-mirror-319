...
class GetInvoiceStatusResponse(BaseModel):
    ...
    """ # noqa: E501
    payload: Optional[ShipmentInvoiceStatusResponse] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "payload": ShipmentInvoiceStatusResponse.from_dict(obj["payload"]) if obj.get("payload") is not None else None,
