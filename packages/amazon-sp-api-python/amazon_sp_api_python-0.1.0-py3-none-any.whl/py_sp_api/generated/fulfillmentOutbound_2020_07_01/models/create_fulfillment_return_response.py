...
class CreateFulfillmentReturnResponse(BaseModel):
    ...
    """ # noqa: E501
    payload: Optional[CreateFulfillmentReturnResult] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "payload": CreateFulfillmentReturnResult.from_dict(obj["payload"]) if obj.get("payload") is not None else None,
