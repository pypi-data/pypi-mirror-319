...
class ListAllFulfillmentOrdersResponse(BaseModel):
    ...
    """ # noqa: E501
    payload: Optional[ListAllFulfillmentOrdersResult] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "payload": ListAllFulfillmentOrdersResult.from_dict(obj["payload"]) if obj.get("payload") is not None else None,
