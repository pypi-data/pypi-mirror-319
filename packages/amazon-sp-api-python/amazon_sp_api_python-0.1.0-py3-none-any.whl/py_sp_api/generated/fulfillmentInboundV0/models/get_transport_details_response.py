...
class GetTransportDetailsResponse(BaseModel):
    """
    The response schema for the getTransportDetails operation.
    """ # noqa: E501
    payload: Optional[GetTransportDetailsResult] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "payload": GetTransportDetailsResult.from_dict(obj["payload"]) if obj.get("payload") is not None else None,
