...
class GetPreorderInfoResponse(BaseModel):
    """
    The response schema for the getPreorderInfo operation.
    """ # noqa: E501
    payload: Optional[GetPreorderInfoResult] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "payload": GetPreorderInfoResult.from_dict(obj["payload"]) if obj.get("payload") is not None else None,
