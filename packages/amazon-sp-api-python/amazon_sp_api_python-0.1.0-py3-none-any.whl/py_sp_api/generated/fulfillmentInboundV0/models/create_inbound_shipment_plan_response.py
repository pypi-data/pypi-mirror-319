...
class CreateInboundShipmentPlanResponse(BaseModel):
    """
    The response schema for the createInboundShipmentPlan operation.
    """ # noqa: E501
    payload: Optional[CreateInboundShipmentPlanResult] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "payload": CreateInboundShipmentPlanResult.from_dict(obj["payload"]) if obj.get("payload") is not None else None,
