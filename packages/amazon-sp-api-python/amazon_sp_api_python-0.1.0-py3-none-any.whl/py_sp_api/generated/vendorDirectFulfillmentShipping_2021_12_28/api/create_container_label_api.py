...
class CreateContainerLabelApi:
    ...
    def create_container_label(
        self,
        body: Annotated[CreateContainerLabelRequest, Field(description="Request body containing the container label data.")],
        ...
        :type body: CreateContainerLabelRequest
        ...
        _param = self._create_container_label_serialize(
            body=body,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "CreateContainerLabelResponse",
            '400': "ErrorList",
            '403': "ErrorList",
            '404': "ErrorList",
            '413': "ErrorList",
    ...
    @validate_call
    def create_container_label_with_http_info(
        self,
        body: Annotated[CreateContainerLabelRequest, Field(description="Request body containing the container label data.")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CreateContainerLabelResponse]:
        """createContainerLabel
    ...
    @validate_call
    def create_container_label_without_preload_content(
        self,
        body: Annotated[CreateContainerLabelRequest, Field(description="Request body containing the container label data.")],
        _request_timeout: Union[
            None,
    ...
    def _create_container_label_serialize(
        self,
        body,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/vendor/directFulfillment/shipping/2021-12-28/containerLabel',
