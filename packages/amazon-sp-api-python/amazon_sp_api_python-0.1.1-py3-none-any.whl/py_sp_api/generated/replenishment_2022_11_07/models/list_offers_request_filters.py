...
class ListOffersRequestFilters(BaseModel):
    ...
    skus: Optional[Annotated[List[StrictStr], Field(min_length=1, max_length=20)]] = Field(default=None, description="A list of SKUs to filter. This filter is only supported for sellers and not for vendors.")
    ...
    eligibilities: Optional[Annotated[List[EligibilityStatus], Field(min_length=1)]] = Field(default=None, description="A list of eligibilities associated with an offer.")
    preferences: Optional[Preference] = None
    promotions: Optional[Promotion] = None
    ...
    __properties: ClassVar[List[str]] = ["marketplaceId", "skus", "asins", "eligibilities", "preferences", "promotions", "programTypes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "skus": obj.get("skus"),
            "asins": obj.get("asins"),
            "eligibilities": obj.get("eligibilities"),
            "preferences": Preference.from_dict(obj["preferences"]) if obj.get("preferences") is not None else None,
            "promotions": Promotion.from_dict(obj["promotions"]) if obj.get("promotions") is not None else None,
