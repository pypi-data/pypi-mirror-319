...
class ListOfferMetricsResponse(BaseModel):
    ...
    """ # noqa: E501
    offers: Optional[List[ListOfferMetricsResponseOffer]] = Field(default=None, description="A list of offers and associated metrics.")
    pagination: Optional[PaginationResponse] = None
    __properties: ClassVar[List[str]] = ["offers", "pagination"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "offers": [ListOfferMetricsResponseOffer.from_dict(_item) for _item in obj["offers"]] if obj.get("offers") is not None else None,
