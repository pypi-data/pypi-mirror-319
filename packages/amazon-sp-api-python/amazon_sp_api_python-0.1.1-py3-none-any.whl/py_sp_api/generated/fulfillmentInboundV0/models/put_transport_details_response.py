...
class PutTransportDetailsResponse(BaseModel):
    """
    Workflow status for a shipment with an Amazon-partnered carrier.
    """ # noqa: E501
    payload: Optional[CommonTransportResult] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "payload": CommonTransportResult.from_dict(obj["payload"]) if obj.get("payload") is not None else None,
