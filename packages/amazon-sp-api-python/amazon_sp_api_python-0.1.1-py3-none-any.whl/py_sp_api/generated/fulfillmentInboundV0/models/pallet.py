...
class Pallet(BaseModel):
    ...
    weight: Optional[Weight] = Field(default=None, alias="Weight")
    is_stacked: StrictBool = Field(description="Indicates whether pallets will be stacked when carrier arrives for pick-up.", alias="IsStacked")
    __properties: ClassVar[List[str]] = ["Dimensions", "Weight", "IsStacked"]
