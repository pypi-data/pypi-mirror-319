...
class ReportDocumentEncryptionDetails(BaseModel):
    """
    Encryption details required for decryption of a report document's contents.
    """ # noqa: E501
    standard: StrictStr = Field(description="The encryption standard required to decrypt the document contents.")
    initialization_vector: StrictStr = Field(description="The vector to decrypt the document contents using Cipher Block Chaining (CBC).", alias="initializationVector")
    key: StrictStr = Field(description="The encryption key used to decrypt the document contents.")
