...
class GetReportSchedulesResponse(BaseModel):
    """
    The response for the getReportSchedules operation.
    """ # noqa: E501
    payload: Optional[List[ReportSchedule]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "payload": [ReportSchedule.from_dict(_item) for _item in obj["payload"]] if obj.get("payload") is not None else None,
