...
class GetShippingLabelListResponse(BaseModel):
    """
    The response schema for the getShippingLabels operation.
    """ # noqa: E501
    payload: Optional[ShippingLabelList] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "payload": ShippingLabelList.from_dict(obj["payload"]) if obj.get("payload") is not None else None,
