...
class PackedItems(BaseModel):
    ...
    buyer_product_identifier: Optional[StrictStr] = Field(default=None, description="Buyer Standard Identification Number (ASIN) of an item.", alias="buyerProductIdentifier")
    ...
    packed_quantity: Optional[ItemQuantity] = Field(default=None, alias="packedQuantity")
    item_details: Optional[PackageItemDetails] = Field(default=None, alias="itemDetails")
    __properties: ClassVar[List[str]] = ["itemSequenceNumber", "buyerProductIdentifier", "vendorProductIdentifier", "packedQuantity", "itemDetails"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "itemDetails": PackageItemDetails.from_dict(obj["itemDetails"]) if obj.get("itemDetails") is not None else None
        })
        return _obj
