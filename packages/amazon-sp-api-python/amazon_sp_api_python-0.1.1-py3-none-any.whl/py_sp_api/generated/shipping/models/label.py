...
class Label(BaseModel):
    ...
    """ # noqa: E501
    label_stream: Optional[StrictStr] = Field(default=None, description="Contains binary image data encoded as a base-64 string.", alias="labelStream")
    label_specification: Optional[LabelSpecification] = Field(default=None, alias="labelSpecification")
