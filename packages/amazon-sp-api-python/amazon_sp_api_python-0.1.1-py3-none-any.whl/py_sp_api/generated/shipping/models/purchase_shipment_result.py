...
class PurchaseShipmentResult(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["shipmentId", "serviceRate", "labelResults"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of service_rate
        if self.service_rate:
            _dict['serviceRate'] = self.service_rate.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "serviceRate": ServiceRate.from_dict(obj["serviceRate"]) if obj.get("serviceRate") is not None else None,
