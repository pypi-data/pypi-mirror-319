...
class GetListingOffersBatchRequest(BaseModel):
    ...
    """ # noqa: E501
    requests: Optional[Annotated[List[ListingOffersRequest], Field(min_length=1, max_length=20)]] = Field(default=None, description="A list of `getListingOffers` batched requests to run.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "requests": [ListingOffersRequest.from_dict(_item) for _item in obj["requests"]] if obj.get("requests") is not None else None
        })
        return _obj
