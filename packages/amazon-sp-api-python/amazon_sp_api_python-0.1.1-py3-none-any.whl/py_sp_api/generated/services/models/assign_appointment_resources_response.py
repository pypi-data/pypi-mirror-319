...
class AssignAppointmentResourcesResponse(BaseModel):
    ...
    """ # noqa: E501
    payload: Optional[AssignAppointmentResourcesResponsePayload] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "payload": AssignAppointmentResourcesResponsePayload.from_dict(obj["payload"]) if obj.get("payload") is not None else None,
