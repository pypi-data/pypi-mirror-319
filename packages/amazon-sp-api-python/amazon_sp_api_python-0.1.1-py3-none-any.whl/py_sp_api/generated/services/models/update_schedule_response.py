...
class UpdateScheduleResponse(BaseModel):
    ...
    """ # noqa: E501
    payload: Optional[List[UpdateScheduleRecord]] = Field(default=None, description="Contains the `UpdateScheduleRecords` for which the error/warning has occurred.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "payload": [UpdateScheduleRecord.from_dict(_item) for _item in obj["payload"]] if obj.get("payload") is not None else None,
