...
class Event(BaseModel):
    ...
    event_time: datetime = Field(description="The ISO 8601 formatted timestamp of the event.", alias="eventTime")
    __properties: ClassVar[List[str]] = ["eventCode", "location", "eventTime"]
