...
class ValueAddedService(BaseModel):
    ...
    """ # noqa: E501
    id: StrictStr = Field(description="The identifier for the value-added service.")
    name: StrictStr = Field(description="The name of the value-added service.")
    cost: Currency
    __properties: ClassVar[List[str]] = ["id", "name", "cost"]
