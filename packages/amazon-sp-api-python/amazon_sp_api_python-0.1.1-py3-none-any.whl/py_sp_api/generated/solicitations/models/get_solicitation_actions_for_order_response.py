...
class GetSolicitationActionsForOrderResponse(BaseModel):
    ...
    """ # noqa: E501
    links: Optional[GetSolicitationActionsForOrderResponseLinks] = Field(default=None, alias="_links")
    embedded: Optional[GetSolicitationActionsForOrderResponseEmbedded] = Field(default=None, alias="_embedded")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "_links": GetSolicitationActionsForOrderResponseLinks.from_dict(obj["_links"]) if obj.get("_links") is not None else None,
            "_embedded": GetSolicitationActionsForOrderResponseEmbedded.from_dict(obj["_embedded"]) if obj.get("_embedded") is not None else None,
