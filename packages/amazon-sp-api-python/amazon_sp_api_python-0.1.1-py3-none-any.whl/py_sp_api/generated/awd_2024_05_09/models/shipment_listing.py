...
class ShipmentListing(BaseModel):
    ...
    shipments: Optional[List[InboundShipmentSummary]] = Field(default=None, description="List of inbound shipment summaries.")
    __properties: ClassVar[List[str]] = ["nextToken", "shipments"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "shipments": [InboundShipmentSummary.from_dict(_item) for _item in obj["shipments"]] if obj.get("shipments") is not None else None
        })
        return _obj
