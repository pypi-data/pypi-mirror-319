...
class InboundOrderReference(BaseModel):
    ...
    """ # noqa: E501
    order_id: StrictStr = Field(description="Order ID of the inbound order.", alias="orderId")
    order_version: StrictStr = Field(description="Order version of the inbound order.", alias="orderVersion")
    __properties: ClassVar[List[str]] = ["orderId", "orderVersion"]
