...
class SellerDealPaymentEvent(BaseModel):
    ...
    deal_id: Optional[StrictStr] = Field(default=None, description="The unique identifier of the deal.", alias="dealId")
    deal_description: Optional[StrictStr] = Field(default=None, description="The internal description of the deal.", alias="dealDescription")
    event_type: Optional[StrictStr] = Field(default=None, description="The type of event: SellerDealComplete.", alias="eventType")
    fee_type: Optional[StrictStr] = Field(default=None, description="The type of fee: RunLightningDealFee.", alias="feeType")
    ...
    __properties: ClassVar[List[str]] = ["postedDate", "dealId", "dealDescription", "eventType", "feeType", "feeAmount", "taxAmount", "totalAmount"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "dealDescription": obj.get("dealDescription"),
