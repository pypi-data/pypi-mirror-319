...
class FeeComponent(BaseModel):
    ...
    """ # noqa: E501
    fee_type: Optional[StrictStr] = Field(default=None, description="The type of fee. For more information about Selling on Amazon fees, see [Selling on Amazon Fee Schedule](https://sellercentral.amazon.com/gp/help/200336920) on Seller Central. For more information about Fulfillment by Amazon fees, see [FBA features, services and fees](https://sellercentral.amazon.com/gp/help/201074400) on Seller Central.", alias="FeeType")
    fee_amount: Optional[Currency] = Field(default=None, alias="FeeAmount")
    __properties: ClassVar[List[str]] = ["FeeType", "FeeAmount"]
