...
class Issue(BaseModel):
    ...
    attribute_name: Optional[StrictStr] = Field(default=None, description="Name of the attribute associated with the issue, if applicable.", alias="attributeName")
    __properties: ClassVar[List[str]] = ["code", "message", "severity", "attributeName"]
