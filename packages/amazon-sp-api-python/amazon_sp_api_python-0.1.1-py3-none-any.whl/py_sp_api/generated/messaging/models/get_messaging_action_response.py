...
class GetMessagingActionResponse(BaseModel):
    ...
    """ # noqa: E501
    links: Optional[GetMessagingActionResponseLinks] = Field(default=None, alias="_links")
    embedded: Optional[GetMessagingActionResponseEmbedded] = Field(default=None, alias="_embedded")
    payload: Optional[MessagingAction] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "_links": GetMessagingActionResponseLinks.from_dict(obj["_links"]) if obj.get("_links") is not None else None,
            "_embedded": GetMessagingActionResponseEmbedded.from_dict(obj["_embedded"]) if obj.get("_embedded") is not None else None,
            "payload": MessagingAction.from_dict(obj["payload"]) if obj.get("payload") is not None else None,
