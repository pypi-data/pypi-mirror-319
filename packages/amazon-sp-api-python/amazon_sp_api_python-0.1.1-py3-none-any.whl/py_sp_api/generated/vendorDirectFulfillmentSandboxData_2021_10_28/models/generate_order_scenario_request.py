...
class GenerateOrderScenarioRequest(BaseModel):
    ...
    """ # noqa: E501
    orders: Optional[List[OrderScenarioRequest]] = Field(default=None, description="The list of test orders requested as indicated by party identifiers.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "orders": [OrderScenarioRequest.from_dict(_item) for _item in obj["orders"]] if obj.get("orders") is not None else None
        })
        return _obj
