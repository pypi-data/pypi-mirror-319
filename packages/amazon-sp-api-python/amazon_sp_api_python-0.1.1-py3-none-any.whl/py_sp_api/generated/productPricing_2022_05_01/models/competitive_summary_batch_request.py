...
class CompetitiveSummaryBatchRequest(BaseModel):
    ...
    """ # noqa: E501
    requests: Annotated[List[CompetitiveSummaryRequest], Field(min_length=1, max_length=20)] = Field(description="A batched list of `competitiveSummary` requests.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "requests": [CompetitiveSummaryRequest.from_dict(_item) for _item in obj["requests"]] if obj.get("requests") is not None else None
        })
        return _obj
