...
class ImageCropSpecification(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["size", "offset"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "size": ImageDimensions.from_dict(obj["size"]) if obj.get("size") is not None else None,
            "offset": ImageOffsets.from_dict(obj["offset"]) if obj.get("offset") is not None else None
        })
        return _obj
