...
class StandardSingleSideImageModule(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["imagePositionType", "block"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "imagePositionType": obj.get("imagePositionType"),
            "block": StandardImageTextBlock.from_dict(obj["block"]) if obj.get("block") is not None else None
        })
        return _obj
