...
class ServicesCapability(BaseModel):
    ...
    """ # noqa: E501
    is_supported: Optional[StrictBool] = Field(default=None, description="When true, `SupplySource` supports the Service capability.", alias="isSupported")
    operational_configuration: Optional[OperationalConfiguration] = Field(default=None, alias="operationalConfiguration")
    __properties: ClassVar[List[str]] = ["isSupported", "operationalConfiguration"]
