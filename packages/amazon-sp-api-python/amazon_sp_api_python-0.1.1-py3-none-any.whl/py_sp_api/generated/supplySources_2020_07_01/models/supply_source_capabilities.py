...
class SupplySourceCapabilities(BaseModel):
    ...
    """ # noqa: E501
    outbound: Optional[OutboundCapability] = None
    services: Optional[ServicesCapability] = None
    __properties: ClassVar[List[str]] = ["outbound", "services"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "outbound": OutboundCapability.from_dict(obj["outbound"]) if obj.get("outbound") is not None else None,
            "services": ServicesCapability.from_dict(obj["services"]) if obj.get("services") is not None else None
        })
        return _obj
