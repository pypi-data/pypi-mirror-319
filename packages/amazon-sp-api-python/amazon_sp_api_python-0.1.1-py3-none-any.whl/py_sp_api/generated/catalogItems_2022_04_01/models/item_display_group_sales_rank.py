...
class ItemDisplayGroupSalesRank(BaseModel):
    ...
    """ # noqa: E501
    website_display_group: StrictStr = Field(description="Name of the website display group associated with the sales rank", alias="websiteDisplayGroup")
    ...
    __properties: ClassVar[List[str]] = ["websiteDisplayGroup", "title", "link", "rank"]
