...
class CreateFeedDocumentResult(BaseModel):
    """
    Information required to encrypt and upload a feed document's contents.
    """ # noqa: E501
    feed_document_id: StrictStr = Field(description="The identifier of the feed document.", alias="feedDocumentId")
    url: StrictStr = Field(description="The presigned URL for uploading the feed contents. This URL expires after 5 minutes.")
    encryption_details: FeedDocumentEncryptionDetails = Field(alias="encryptionDetails")
    __properties: ClassVar[List[str]] = ["feedDocumentId", "url", "encryptionDetails"]
