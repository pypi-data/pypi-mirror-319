...
class ListPackingOptionsResponse(BaseModel):
    ...
    """ # noqa: E501
    packing_options: List[PackingOption] = Field(description="List of packing options.", alias="packingOptions")
    pagination: Optional[Pagination] = None
    __properties: ClassVar[List[str]] = ["packingOptions", "pagination"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "packingOptions": [PackingOption.from_dict(_item) for _item in obj["packingOptions"]] if obj.get("packingOptions") is not None else None,
