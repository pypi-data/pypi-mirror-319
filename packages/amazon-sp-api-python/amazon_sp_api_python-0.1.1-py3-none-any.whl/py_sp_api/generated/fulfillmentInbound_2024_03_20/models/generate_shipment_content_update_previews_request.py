...
class GenerateShipmentContentUpdatePreviewsRequest(BaseModel):
    ...
    """ # noqa: E501
    boxes: Annotated[List[BoxUpdateInput], Field(min_length=1, max_length=5000)] = Field(description="A list of boxes that will be present in the shipment after the update.")
    items: Annotated[List[ItemInput], Field(min_length=1, max_length=2000)] = Field(description="A list of all items that will be present in the shipment after the update.")
    __properties: ClassVar[List[str]] = ["boxes", "items"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "boxes": [BoxUpdateInput.from_dict(_item) for _item in obj["boxes"]] if obj.get("boxes") is not None else None,
