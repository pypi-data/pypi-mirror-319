...
class CanvasDataAggregator:
    ...
    async def _fetch_assignment_groups(self, course_id: str) -> list[AssignmentGroup]:
        ...
        return (
            AssignmentGroupIndexQueryData(**query_result).legacy_node.assignment_groups
            or []
        )
    ...
    async def _fetch_assignments(self, group_id: str) -> list[Assignment]:
        ...
        nodes = AssignmentIndexQueryData(
            **query_result
        ).node.assignments_connection.nodes
    ...
    async def _fetch_modules(self, course_id: str) -> list[Module]:
        ...
        nodes = (
            ModuleIndexQueryData(**query_result).legacy_node.modules_connection.nodes
            or []
        )
