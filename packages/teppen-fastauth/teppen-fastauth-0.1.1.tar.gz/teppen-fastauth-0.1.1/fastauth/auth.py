...
from jwt.exceptions import InvalidSignatureError, ExpiredSignatureError, PyJWKSetError, InvalidAudienceError, PyJWKClientConnectionError
...
def get_bearer_access_token_decode(
    ...
    try:
        ...
        raise HTTPException(500, "JWKSエンドポイントに接続できませんでした。バックエンドアプリのProxy設定を解除してみて下さい。")
