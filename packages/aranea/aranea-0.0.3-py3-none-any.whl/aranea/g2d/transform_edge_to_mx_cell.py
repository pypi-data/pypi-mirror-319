...
from aranea.models.graph_model import Edge, ProtocolType, TextOrientation
...
def get_text_orientation_style_string(
...
def transform_edge_to_mx_cell(
    ...
    if text := edge.text:
        ...
        mx_cell_style.textDirection = get_text_orientation_style_string(text[1])
