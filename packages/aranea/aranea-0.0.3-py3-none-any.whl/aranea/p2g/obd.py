...
from aranea.models.graph_model import (ComponentNode, EcuClassification,
                                       get_default_text)
from aranea.p2g.util import REM, color2str, gendocstring, is_horizontal
    ...
    for path in page.get_drawings(extended=False):
        ...
        for item in [i for i in path["items"] if i[0] == "re"]:
            ...
            if (
                ...
                word_blocks: list[_DictTextBlock] = page.get_text("dict")[  # pyright: ignore
                    "blocks"
                ]
                blocks: list[_DictTextBlock] = [  # pyright: ignore
                    b
                ...
                spans_list: list[list[dict[str, Any]]] = [
                    l["spans"] for b in blocks for l in b["lines"]  # pyright: ignore
                ]
                size = 0
