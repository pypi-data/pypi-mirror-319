...
class StarGift(TLObject):  # type: ignore
    ...
    __slots__: List[str] = ["id", "sticker", "stars", "convert_stars", "limited", "sold_out", "birthday", "can_upgrade", "availability_remains", "availability_total", "first_sale_date", "last_sale_date", "upgrade_stars"]

    ID = 0x2cc73c8
    QUALNAME = "types.StarGift"

    def __init__(self, *, id: int, sticker: "raw.base.Document", stars: int, convert_stars: int, limited: Optional[bool] = None, sold_out: Optional[bool] = None, birthday: Optional[bool] = None, can_upgrade: Optional[bool] = None, availability_remains: Optional[int] = None, availability_total: Optional[int] = None, first_sale_date: Optional[int] = None, last_sale_date: Optional[int] = None, upgrade_stars: Optional[int] = None) -> None:
        self.id = id  # long
    ...
    def read(b: BytesIO, *args: Any) -> "StarGift":
        ...
        return StarGift(id=id, sticker=sticker, stars=stars, convert_stars=convert_stars, limited=limited, sold_out=sold_out, birthday=birthday, can_upgrade=can_upgrade, availability_remains=availability_remains, availability_total=availability_total, first_sale_date=first_sale_date, last_sale_date=last_sale_date, upgrade_stars=upgrade_stars)
