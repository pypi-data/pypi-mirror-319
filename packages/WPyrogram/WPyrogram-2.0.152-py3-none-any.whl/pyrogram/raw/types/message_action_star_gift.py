...
class MessageActionStarGift(TLObject):  # type: ignore
    ...
    def read(b: BytesIO, *args: Any) -> "MessageActionStarGift":
        ...
        return MessageActionStarGift(gift=gift, name_hidden=name_hidden, saved=saved, converted=converted, upgraded=upgraded, transferred=transferred, can_upgrade=can_upgrade, refunded=refunded, message=message, convert_stars=convert_stars, upgrade_msg_id=upgrade_msg_id, upgrade_stars=upgrade_stars)
