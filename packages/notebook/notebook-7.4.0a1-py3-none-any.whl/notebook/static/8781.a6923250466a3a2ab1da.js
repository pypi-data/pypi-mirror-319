...
async function main() {
  const mimeExtensionsMods = [
    __webpack_require__(17728),
    __webpack_require__(69031),
    __webpack_require__(23325),
    __webpack_require__(63681),
  ];
  const mimeExtensions = await Promise.all(mimeExtensionsMods);

  // Load the base plugins available on all pages
  let baseMods = [
      __webpack_require__(93481),
  __webpack_require__(23167),
  __webpack_require__(81444),
  __webpack_require__(29057),
  __webpack_require__(76266),
  __webpack_require__(98433),
  __webpack_require__(80236),
  
      (__webpack_require__(21177)["default"].filter)(({id}) => [
...
'@jupyterlab/application-extension:top-spacer',
      ...
      (__webpack_require__(61413)["default"].filter)(({id}) => [
...
'@jupyterlab/apputils-extension:utilityCommands',
      ...
      __webpack_require__(99792),
  
      (__webpack_require__(85806)["default"].filter)(({id}) => [
...
'@jupyterlab/completer-extension:manager',
      ...
      (__webpack_require__(24859)["default"].filter)(({id}) => [
...
'@jupyterlab/console-extension:tracker',
      ...
      __webpack_require__(88767),
  
      (__webpack_require__(75818)["default"].filter)(({id}) => [
...
'@jupyterlab/docmanager-extension:manager',
      ...
      (__webpack_require__(59730)["default"].filter)(({id}) => [
       '@jupyterlab/documentsearch-extension:plugin',
      ].includes(id)),
      
      (__webpack_require__(81768)["default"].filter)(({id}) => [
       '@jupyterlab/filebrowser-extension:factory',
'@jupyterlab/filebrowser-extension:default-file-browser',
      ].includes(id)),
      
      (__webpack_require__(96014)["default"].filter)(({id}) => [
       '@jupyterlab/fileeditor-extension:plugin',
'@jupyterlab/fileeditor-extension:widget-factory',
      ].includes(id)),
      
      (__webpack_require__(21498)["default"].filter)(({id}) => [
       '@jupyterlab/help-extension:resources',
      ].includes(id)),
      __webpack_require__(56101),
  __webpack_require__(58750),
  __webpack_require__(6539),
  
      (__webpack_require__(38792)["default"].filter)(({id}) => [
       '@jupyterlab/mainmenu-extension:plugin',
      ].includes(id)),
      __webpack_require__(36219),
  __webpack_require__(27342),
  __webpack_require__(3788),
  
      (__webpack_require__(3582)["default"].filter)(({id}) => [
...
'@jupyterlab/notebook-extension:widget-factory',
      ...
      __webpack_require__(86982),
  __webpack_require__(98300),
  __webpack_require__(17013),
  __webpack_require__(58493),
  __webpack_require__(93921),
  __webpack_require__(15296),
  __webpack_require__(18833),
  __webpack_require__(50392),
  __webpack_require__(67405),
...
'@jupyterlab/filebrowser-extension:share-file',
      ...
      __webpack_require__(85144),
  
      (__webpack_require__(2146)["default"].filter)(({id}) => [
       '@jupyterlab/running-extension:plugin',
      ].includes(id)),
      __webpack_require__(64146),
    ...
    case '/notebooks': {
      baseMods = baseMods.concat([
        __webpack_require__(88174),
  __webpack_require__(57581),
  
      (__webpack_require__(59421)["default"].filter)(({id}) => [
...
'@jupyterlab/notebook-extension:update-raw-mimetype',
      ...
      (__webpack_require__(6075)["default"].filter)(({id}) => [
       '@jupyterlab/toc-extension:registry',
'@jupyterlab/toc-extension:tracker',
      ].includes(id)),
      
      (__webpack_require__(47167)["default"].filter)(({id}) => [
...
'@jupyterlab/fileeditor-extension:search',
  ...
  const NotebookApp = (__webpack_require__(82251).NotebookApp);
...
//# sourceMappingURL=8781.a6923250466a3a2ab1da.js.map?v=a6923250466a3a2ab1da