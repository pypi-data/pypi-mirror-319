...
class _PonytaRegistry:
    ...
    def _retrieve_online_features_tradie_empty(
        ...
        return {
            ...
            **{
                ...
                "total_claim_attempts": _response[0]["total_claim_attempts"] if _response[0]["total_claim_attempts"] is not None else 0,
    ...
    def _retrieve_online_features_table_data_exact_match(
        ...
        # handle for empty returns
        if not _response.json():
