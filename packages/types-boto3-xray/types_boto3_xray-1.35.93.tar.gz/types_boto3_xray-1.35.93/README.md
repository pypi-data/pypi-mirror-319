<a id="types-boto3-xray"></a>

# types-boto3-xray

[![PyPI - types-boto3-xray](https://img.shields.io/pypi/v/types-boto3-xray.svg?color=blue)](https://pypi.org/project/types-boto3-xray/)
[![PyPI - Python Version](https://img.shields.io/pypi/pyversions/types-boto3-xray.svg?color=blue)](https://pypi.org/project/types-boto3-xray/)
[![Docs](https://img.shields.io/readthedocs/boto3-stubs.svg?color=blue)](https://youtype.github.io/types_boto3_docs/)
[![PyPI - Downloads](https://static.pepy.tech/badge/types-boto3-xray)](https://pypistats.org/packages/types-boto3-xray)

![boto3.typed](https://github.com/youtype/mypy_boto3_builder/raw/main/logo.png)

Type annotations for [boto3 XRay 1.35.93](https://pypi.org/project/boto3/)
...
[types-boto3-xray docs](https://youtype.github.io/types_boto3_docs/types_boto3_xray/).

See how it helps you find and fix potential bugs:

![types-boto3 demo](https://github.com/youtype/mypy_boto3_builder/raw/main/demo.gif)

- [types-boto3-xray](#types-boto3-xray)
...
- Install `types-boto3[xray]` in your environment:
...
- Install `types-boto3[xray]` with services you use in your environment:
...
`types-boto3-xray` dependency in production. However, there is an issue in
...
from types_boto3_xray import XRayClient
...
`types_boto3_xray.paginator` module contains type annotations for all
paginators.
...
`types_boto3_xray.literals` module contains literals extracted from shapes that
can be used in user code for type checking.

Full list of `XRay` Literals can be found in
[docs](https://youtype.github.io/types_boto3_docs/types_boto3_xray/literals/).
...
`types_boto3_xray.type_defs` module contains structures and shapes assembled to
typed dictionaries and unions for additional type checking.

Full list of `XRay` TypeDefs can be found in
[docs](https://youtype.github.io/types_boto3_docs/types_boto3_xray/type_defs/).
...
`types-boto3-xray` version is the same as related `boto3` version and follows
...
[boto3 docs](https://youtype.github.io/types_boto3_docs/types_boto3_xray/)
