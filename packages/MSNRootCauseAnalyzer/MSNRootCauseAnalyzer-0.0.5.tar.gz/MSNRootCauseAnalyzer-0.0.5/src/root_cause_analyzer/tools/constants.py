...
DEFAULT_DIMENSIONS_MAP = {
    "User": ["IsMUIDStable", "IF(LoginState IN ('MSA', 'AAD', 'AAD-AL'), LoginState, 'Non Signed') AS LoginState"],   
...
EXP_MIN_SIG_EXP_CONTRIBUTION = 0.0006  # TODO: just for testing, need to adjust