...
from positron_common.cli.auto_complete import set_env_auto_complete

@track_command_usage("set_env")
def set_env(
  env: Annotated[str, typer.Argument(help='The environment to set.',
                                     autocompletion=set_env_auto_complete)] = 'dev',
):
    """
    Sets your robbie deploy env. ADVANCED USE ONLY.
    """
