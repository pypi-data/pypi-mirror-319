...
class Disc_class:
    ...
    def widgetise(self, **kwargs):
        '''
        Function that turns two variables into a slider widget. Returns the line data, figure, and plotting axis.
        '''
...
class icelines:
    ...
    def find_icelines(self, super):
        ...
        positions = []
        for temperature in iceline_molecules_and_temps.values():
        ...
        for molecule, location in zip(iceline_molecules_and_temps.keys(), positions):
