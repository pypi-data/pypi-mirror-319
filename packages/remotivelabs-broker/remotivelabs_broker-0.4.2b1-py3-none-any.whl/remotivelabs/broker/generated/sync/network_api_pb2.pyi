...
class Signal(_message.Message):
    __slots__ = ("id", "integer", "double", "arbitration", "empty", "str_value", "raw", "timestamp")
    ...
    raw: bytes
    timestamp: int
    def __init__(self, id: _Optional[_Union[_common_pb2.SignalId, _Mapping]] = ..., integer: _Optional[int] = ..., double: _Optional[float] = ..., arbitration: bool = ..., empty: bool = ..., str_value: _Optional[str] = ..., raw: _Optional[bytes] = ..., timestamp: _Optional[int] = ...) -> None: ...
