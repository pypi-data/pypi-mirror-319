...
class TestClient:
            ...
            json={
                "data": {
                    "pipeline_by_pk": {
                        ...
                        "workspace": {"id": 1, "name": "test - Default Workspace"},
                    }
                }
            },
        )
    ...
    def test_upload_model_and_wait_for_convert_timedout(self):
        ...
        with tempfile.NamedTemporaryFile() as f:
            ...
            with pytest.raises(ModelConversionTimeoutError):
    ...
    def test_register_mlflow_model(self):
        ...
        assert 1 == variant.id()
        assert 4 == len(responses.calls)
        assert 1 == upload_resp.call_count
        assert 1 == udw_resp.call_count
        assert 1 == get_configured_resp.call_count
        assert 1 == configure_resp.call_count
        upload_call = responses.calls[1]
        assert upload_call.request.body.encoding == "utf-8"
        assert "multipart/form-data" in upload_call.request.body.content_type
    ...
    def test_pipelines_by_name(self):
        ...
        add_pipeline_by_id_responder(self.test_client.api_endpoint, 1)
        add_get_workspace_by_id_responder(self.test_client.api_endpoint, 1)
    ...
    def test_list_pipelines(self, respx_mock):
        ...
        add_pipeline_by_id_responder(self.test_client.api_endpoint, 1)
        add_pipeline_by_id_responder(self.test_client.api_endpoint, 2)
        pipelines = self.test_client.list_pipelines()
    ...
    def test_get_pipeline(self):
        ...
        add_get_pipeline_by_id_responder(self.test_client.api_endpoint)
    ...
    @responses.activate
    def test_get_pipeline_specific_version(self):
        add_get_workspace_by_id_responder(self.test_client.api_endpoint)
        add_default_workspace_responder(self.test_client.api_endpoint)
        add_get_pipeline_by_id_responder(self.test_client.api_endpoint)
        add_pipeline_variant_by_id_responder(self.test_client.api_endpoint)
    ...
    @responses.activate
    def test_get_pipeline_when_pipeline_does_not_exist(self):
        add_get_workspace_by_id_responder(self.test_client.api_endpoint)
        add_default_workspace_responder(self.test_client.api_endpoint)
        add_get_pipeline_by_id_responder(self.test_client.api_endpoint)
    ...
    @responses.activate
    def test_get_pipeline_specific_version_does_not_exist(self):
        add_get_workspace_by_id_responder(self.test_client.api_endpoint)
        add_default_workspace_responder(self.test_client.api_endpoint)
        add_get_pipeline_by_id_responder(self.test_client.api_endpoint)
        add_pipeline_variant_by_id_responder(self.test_client.api_endpoint)
    ...
    def test_get_model(self, respx_mock):
        add_get_model_by_id_responder(self.test_client.api_endpoint, 2)
        add_get_workspace_by_id_responder(self.test_client.api_endpoint)
        add_default_workspace_responder(self.test_client.api_endpoint)
        example_models_1 = {
            "id": 1,
    ...
    def test_get_model_name_does_not_exist(self, respx_mock):
        ...
        with pytest.raises(Exception):
            test_model_version = self.test_client.get_model(
                name="test-model-does-not-exist"
            )
    ...
    def test_build_assay(self, respx_mock):
        ...
        responses.add(
            ...
            json={
                "data": {
                    "user_default_workspace": [
                        {"workspace": {"id": 1, "name": "some-workspace"}}
                    ]
                }
            },
        )
