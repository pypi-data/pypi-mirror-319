...
def test_absolute_energy_full_series():
    ...
    result = calculate_absolute_energy(data)
...
def test_absolute_energy_with_start_and_end():
    data = pd.Series([1, 2, 3, 4])
    result = calculate_absolute_energy(data, start=1, end=3)
...
def test_absolute_energy_with_start_only():
    data = pd.Series([1, 2, 3, 4])
    result = calculate_absolute_energy(data, start=2)
...
def test_absolute_energy_start_end_out_of_bounds():
    data = pd.Series([1, 2, 3, 4])
    result = calculate_absolute_energy(data, start=10, end=15)
...
def test_absolute_energy_start_greater_than_end():
    data = pd.Series([1, 2, 3, 4])
    result = calculate_absolute_energy(data, start=3, end=2)
