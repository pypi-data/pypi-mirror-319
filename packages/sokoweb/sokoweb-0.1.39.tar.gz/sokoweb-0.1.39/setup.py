...
setup(
    ...
    package_data={
        "sokoweb": [
            "docker/*",
            "hyperledger_docker/*",
            "hyperledger_docker/chaincode/*",
            "hyperledger_docker/scripts/*"
        ]
    },
    cmdclass={
    ...
    entry_points={
        'console_scripts': [
            ...
            'sokoweb-hyperledger-up = sokoweb.sokoweb.cli:hyperledger_up',
            'sokoweb-hyperledger-down = sokoweb.sokoweb.cli:hyperledger_down',
        ],
    },
