...
class Generate_Transcation:
    ...
    def genearate_transaction(self, transaction_model, object_name, connection, Owner):
        ...
        obj_itemchange.process_data(connection, sql_models, object_name, Owner)
        ...
        if "follow_up_actions" in transaction_model["transaction"]:
            ...
            obj_followup_act.process_data(connection, follow_up_actions, object_name)
