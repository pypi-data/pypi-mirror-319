...
SCRIPT_DIR = os.path.join(os.path.dirname(__file__), "mount")
...
def execute_command_on_container(ecs_client, task_name, container_name, region, cluster, script_dir):
...
def main():
    ...
    execute_command_on_container(ecs_client, task_name, container_name, region, cluster, SCRIPT_DIR)
