...
if reader==None :
    print("Obtention impossible d'un easyocr reader")
else :
...
def recognize(filename: str) -> Cni:
    ...
    if reader is None:
        logger.error(f"Impossible de charger le Reader EasyOCR")
        return None
...
def extract_text_from_image(final: MatLike, use_tesseract: bool = True) -> str:
    """
