...
@dataclass
class CommandData:
    name: str = field(metadata={"description": "The name of the command"})
    value: Any = field(metadata={"description": "The value of the command"})
    timestamp: datetime = field(
        default_factory=datetime.now,
        metadata={"description": "Timestamp when the command was sent"}
    )
...
class VariableData:
    ...
    value: float = field(metadata={"description": "The value of the variable"})
    timestamp: datetime = field(
        default_factory=datetime.now,
...
class DataRequest(BaseExchange):
    ...
    data: Optional[Union[DataCollection, VariableData, CommandData]] = field(default=None)
...
class DataResponse(BaseExchange):
    ...
    data: Optional[Union[DataCollection, VariableData]] = field(default=None)
