...
def parse_csv_lines(lines,
    ...
    json_obj_new = adagenes.BiomarkerFrame(variant_data, genome_version=genome_version, preexisting_features=json_obj.preexisting_features)
    #json_obj.data = variant_data
    json_obj_new.data_type = mutation_level
    json_obj_new.preexisting_features = json_obj.preexisting_features
    return json_obj_new
