...
class Console:
	...
	#--------------------------------------------------------------------------------
	@classmethod
	def IsPrintEnable(classType, isEnable: bool) -> None:
		"""출력 활성화 (기본값: True)"""
	...
	#--------------------------------------------------------------------------------
	@classmethod
	def Print(classType, *values: object) -> None:
		"""문자열 출력. (간단한 버전)"""
	...
	#--------------------------------------------------------------------------------
	@classmethod
	def PrintDetailed(classType, *values: object, sep: Optional[str] = SPACE, end: Optional[str] = LINEFEED, file: SupportsWrite[str] | None = None, flush: Literal[False] = False) -> None:
		"""문자열 출력. (상세한 버전)"""
		if not Console.__IsPrintEnable:
			return
