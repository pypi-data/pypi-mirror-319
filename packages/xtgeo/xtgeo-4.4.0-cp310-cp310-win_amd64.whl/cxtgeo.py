...
def surf_export_irap_ascii(fc, mx, my, xori, yori, xinc, yinc, rot, swig_np_dbl_in_v1, option):
    return _cxtgeo.surf_export_irap_ascii(fc, mx, my, xori, yori, xinc, yinc, rot, swig_np_dbl_in_v1, option)
...
def grdcp3d_calc_xyz(ncol, nrow, nlay, swig_np_dbl_in_v1, swig_np_flt_in_v1, swig_np_int_in_v1, option, swig_np_dbl_aout_v1, swig_np_dbl_aout_v2, swig_np_dbl_aout_v3):
    return _cxtgeo.grdcp3d_calc_xyz(ncol, nrow, nlay, swig_np_dbl_in_v1, swig_np_flt_in_v1, swig_np_int_in_v1, option, swig_np_dbl_aout_v1, swig_np_dbl_aout_v2, swig_np_dbl_aout_v3)

def grd3d_conv_roxapi_grid(nx, ny, nz, nxyz, swig_np_int_in_v1, swig_np_dbl_in_v1, swig_np_dbl_inplace_v1, swig_np_dbl_inplace_v2, swig_np_int_inplace_v1):
    return _cxtgeo.grd3d_conv_roxapi_grid(nx, ny, nz, nxyz, swig_np_int_in_v1, swig_np_dbl_in_v1, swig_np_dbl_inplace_v1, swig_np_dbl_inplace_v2, swig_np_int_inplace_v1)
...
def grd3d_conv_grid_roxapi(ncol, nrow, nlay, swig_np_dbl_in_v1, swig_np_dbl_in_v2, swig_np_int_in_v1, swig_np_dbl_aout_v1, swig_np_dbl_aout_v2, swig_np_dbl_aout_v3):
    return _cxtgeo.grd3d_conv_grid_roxapi(ncol, nrow, nlay, swig_np_dbl_in_v1, swig_np_dbl_in_v2, swig_np_int_in_v1, swig_np_dbl_aout_v1, swig_np_dbl_aout_v2, swig_np_dbl_aout_v3)
...
def grd3d_collapse_inact(nx, ny, nz, swig_np_dbl_inplace_v1, swig_np_int_inplace_v1):
    return _cxtgeo.grd3d_collapse_inact(nx, ny, nz, swig_np_dbl_inplace_v1, swig_np_int_inplace_v1)

def grdcp3d_midpoint(i, j, k, ncol, nrow, nlay, coordsv, ncoord, zcornsv, nzcorn, x, y, z):
    return _cxtgeo.grdcp3d_midpoint(i, j, k, ncol, nrow, nlay, coordsv, ncoord, zcornsv, nzcorn, x, y, z)
