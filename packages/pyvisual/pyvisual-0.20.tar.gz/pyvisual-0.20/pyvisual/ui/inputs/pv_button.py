...
class PvButton(Widget):
    def __init__(self, container, x=0, y=0,
        ...
        self.label = PvText(None, x=0, y=0, text=self.text,
        ...
        if container:
            # Add to the provided pyvisual container
    ...
    def on_mouse_pos(self, container, pos):
...
if __name__ == "__main__":
    ...
    button10 = PvButton(window, 500, 300)

    # # Create buttons with rounded edges
    button1 = PvButton(
        container=window, x=325, y=275, width=200, height=60, text="Button 1",
    ...
    button2 = PvButton(
        container=window, x=325, y=375, width=200, height=60, text="Button 2",
