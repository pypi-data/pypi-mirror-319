...
class QHttpServer(PySide6.QtHttpServer.QAbstractHttpServer):
    ...
    def addAfterRequestHandler(self, context: PySide6.QtCore.QObject, callback: typing.Callable[..., typing.Any]) -> None: ...
    ...
    def route(self, rule: str, callback: typing.Callable[..., typing.Any]) -> bool: ...
...
class QHttpServerResponder(Shiboken.Object):
    ...
    @typing.overload
    def writeBeginChunked(self, headers: PySide6.QtNetwork.QHttpHeaders, trailerNames: typing.Sequence[PySide6.QtNetwork.QHttpHeaders.WellKnownHeader], status: PySide6.QtHttpServer.QHttpServerResponder.StatusCode = ...) -> None: ...
    @typing.overload
