...
class QAxBase(Shiboken.Object):
    ...
    @typing.overload
    def dynamicCall(self, name: bytes | bytearray | memoryview, vars: typing.Sequence[typing.Any]) -> typing.Any: ...
    @typing.overload
    ...
    @typing.overload
    def querySubObject(self, name: bytes | bytearray | memoryview, vars: typing.Sequence[typing.Any]) -> PySide6.QtAxContainer.QAxObject: ...
    @typing.overload
...
class QAxScript(PySide6.QtCore.QObject):
    ...
    @typing.overload
    def call(self, function: str, arguments: typing.Sequence[typing.Any]) -> typing.Any: ...
    @typing.overload
