...
class QDBusAbstractInterface(PySide6.QtDBus.QDBusAbstractInterfaceBase):
    ...
    def asyncCallWithArgumentList(self, method: str, args: typing.Sequence[typing.Any]) -> PySide6.QtDBus.QDBusPendingCall: ...
    @typing.overload
    ...
    def callWithArgumentList(self, mode: PySide6.QtDBus.QDBus.CallMode, method: str, args: typing.Sequence[typing.Any]) -> PySide6.QtDBus.QDBusMessage: ...
    @typing.overload
    def callWithCallback(self, method: str, args: typing.Sequence[typing.Any], receiver: PySide6.QtCore.QObject, member: bytes | bytearray | memoryview) -> bool: ...
    @typing.overload
    def callWithCallback(self, method: str, args: typing.Sequence[typing.Any], receiver: PySide6.QtCore.QObject, member: bytes | bytearray | memoryview, errorSlot: bytes | bytearray | memoryview) -> bool: ...
    ...
    def internalConstCall(self, mode: PySide6.QtDBus.QDBus.CallMode, method: str, args: typing.Sequence[typing.Any] = ...) -> PySide6.QtDBus.QDBusMessage: ...
...
class QDBusArgument(Shiboken.Object):
    ...
    @typing.overload
    def __lshift__(self, list: typing.Sequence[typing.Any]) -> PySide6.QtDBus.QDBusArgument: ...
    @typing.overload
    def __lshift__(self, arg: typing.Sequence[str]) -> PySide6.QtDBus.QDBusArgument: ...
    @typing.overload
    ...
    @typing.overload
    def __rshift__(self, arg: typing.Sequence[str]) -> PySide6.QtDBus.QDBusArgument: ...
    @typing.overload
...
class QDBusConnection(Shiboken.Object):
    ...
    @typing.overload
    def connect(self, service: str, path: str, interface: str, name: str, argumentMatch: typing.Sequence[str], signature: str, receiver: PySide6.QtCore.QObject, slot: bytes | bytearray | memoryview) -> bool: ...
    @typing.overload
    @staticmethod
    ...
    @typing.overload
    def disconnect(self, service: str, path: str, interface: str, name: str, argumentMatch: typing.Sequence[str], signature: str, receiver: PySide6.QtCore.QObject, slot: bytes | bytearray | memoryview) -> bool: ...
    @staticmethod
...
class QDBusMessage(Shiboken.Object):
    ...
    @typing.overload
    def createReply(self, arguments: typing.Sequence[typing.Any] = ...) -> PySide6.QtDBus.QDBusMessage: ...
    @typing.overload
...
class QDBusServiceWatcher(PySide6.QtCore.QObject):
    ...
    @typing.overload
    def __init__(self, service: str, connection: PySide6.QtDBus.QDBusConnection, watchMode: PySide6.QtDBus.QDBusServiceWatcher.WatchModeFlag = ..., parent: PySide6.QtCore.QObject | None= ...) -> None: ...
    @typing.overload
    def __init__(self, parent: PySide6.QtCore.QObject | None= ...) -> None: ...
