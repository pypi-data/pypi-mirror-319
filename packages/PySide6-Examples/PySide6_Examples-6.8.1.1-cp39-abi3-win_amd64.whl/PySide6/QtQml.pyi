...
class ListProperty(PySide6.QtCore.Property):
    ...
    def __init__(self, type: type, append: typing.Callable[..., typing.Any] | None= ..., at: typing.Callable[..., typing.Any] | None= ..., clear: typing.Callable[..., typing.Any] | None= ..., count: typing.Callable[..., typing.Any] | None= ...) -> None: ...
...
class QJSManagedValue(Shiboken.Object):
    ...
    def call(self, arguments: typing.Sequence[PySide6.QtQml.QJSValue] = ...) -> PySide6.QtQml.QJSValue: ...
    def callAsConstructor(self, arguments: typing.Sequence[PySide6.QtQml.QJSValue] = ...) -> PySide6.QtQml.QJSValue: ...
    def callWithInstance(self, instance: PySide6.QtQml.QJSValue | PySide6.QtQml.QJSValue.SpecialValue | bool | str | bytes | bytearray | memoryview | float | int, arguments: typing.Sequence[PySide6.QtQml.QJSValue] = ...) -> PySide6.QtQml.QJSValue: ...
    @typing.overload
    ...
    def jsMetaInstantiate(self, values: typing.Sequence[PySide6.QtQml.QJSValue] = ...) -> PySide6.QtQml.QJSManagedValue: ...
...
class QJSValue(Shiboken.Object):
    ...
    def call(self, args: typing.Sequence[PySide6.QtQml.QJSValue] = ...) -> PySide6.QtQml.QJSValue: ...
    def callAsConstructor(self, args: typing.Sequence[PySide6.QtQml.QJSValue] = ...) -> PySide6.QtQml.QJSValue: ...
    def callWithInstance(self, instance: PySide6.QtQml.QJSValue | PySide6.QtQml.QJSValue.SpecialValue | bool | str | bytes | bytearray | memoryview | float | int, args: typing.Sequence[PySide6.QtQml.QJSValue] = ...) -> PySide6.QtQml.QJSValue: ...
    def deleteProperty(self, name: str) -> bool: ...
...
class QQmlApplicationEngine(PySide6.QtQml.QQmlEngine):
    ...
    def setExtraFileSelectors(self, extraFileSelectors: typing.Sequence[str]) -> None: ...
...
class QQmlComponent(PySide6.QtCore.QObject):
    ...
    @typing.overload
    def __init__(self, arg__1: PySide6.QtQml.QQmlEngine, fileName: str, mode: PySide6.QtQml.QQmlComponent.CompilationMode, parent: PySide6.QtCore.QObject | None= ...) -> None: ...
    @typing.overload
    def __init__(self, engine: PySide6.QtQml.QQmlEngine, uri: str, typeName: str, mode: PySide6.QtQml.QQmlComponent.CompilationMode, parent: PySide6.QtCore.QObject | None= ...) -> None: ...
    @typing.overload
    def __init__(self, engine: PySide6.QtQml.QQmlEngine, uri: str, typeName: str, parent: PySide6.QtCore.QObject | None= ...) -> None: ...
    @typing.overload
    def __init__(self, arg__1: PySide6.QtQml.QQmlEngine, fileName: str, parent: PySide6.QtCore.QObject | None= ...) -> None: ...
    @typing.overload
    def __init__(self, arg__1: PySide6.QtQml.QQmlEngine, parent: PySide6.QtCore.QObject | None= ...) -> None: ...
    @typing.overload
    def __init__(self, arg__1: PySide6.QtQml.QQmlEngine, url: PySide6.QtCore.QUrl | str, mode: PySide6.QtQml.QQmlComponent.CompilationMode, parent: PySide6.QtCore.QObject | None= ...) -> None: ...
    @typing.overload
    def __init__(self, arg__1: PySide6.QtQml.QQmlEngine, url: PySide6.QtCore.QUrl | str, parent: PySide6.QtCore.QObject | None= ...) -> None: ...
    @typing.overload
    def __init__(self, parent: PySide6.QtCore.QObject | None= ...) -> None: ...
...
class QQmlContext(PySide6.QtCore.QObject):
    ...
    def setContextProperties(self, properties: typing.Sequence[PySide6.QtQml.QQmlContext.PropertyPair]) -> None: ...
    @typing.overload
...
class QQmlDebuggingEnabler(Shiboken.Object):
    ...
    @staticmethod
    def setServices(services: typing.Sequence[str]) -> None: ...
    @staticmethod
...
class QQmlEngine(PySide6.QtQml.QJSEngine):
    ...
    def importPlugin(self, filePath: str, uri: str, errors: typing.Sequence[PySide6.QtQml.QQmlError]) -> bool: ...
