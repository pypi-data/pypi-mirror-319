...
class HecRas_Geom:
    ...
    def read_from_file(self, file_ras_geom: str):
        ...
        v_hdf_groups = read_hdf_groups(file_ras_geom_hdf)
        v_hdf_datasets = read_hdf_datasets(file_ras_geom_hdf)
    ...
    def read_cl(self):
        ...
        if v_hdf_datasets.str.contains('Geometry/River Centerlines/Attributes').any():
            df_cl_attributes = read_hdf_df(file_ras_geom_hdf, 'Geometry/River Centerlines/Attributes').reset_index()
            df_cl_xy = read_hdf_info_value(file_ras_geom_hdf, 
    ...
    def read_xs(self):
        ...
        if v_hdf_datasets.str.contains('Geometry/Cross Sections/Attributes').any():
            df_xs_attributes = read_hdf_df(file_ras_geom_hdf, 'Geometry/Cross Sections/Attributes').reset_index()

            temp_df_xs_attributes = df_xs_attributes.loc[:, 'index':'RS']

            df_xs_xy = read_hdf_info_value(file_ras_geom_hdf, 
            ...
            if v_hdf_datasets.str.contains("Geometry/Cross Sections/Station Elevation Values").any():
                df_xs_staelev = read_hdf_info_value(file_ras_geom_hdf, 
            ...
            df_xs_manning = read_hdf_info_value(file_ras_geom_hdf, 
            ...
            if v_hdf_datasets.str.contains("Geometry/Cross Sections/Ineffective Blocks").any():
                df_xs_ineffective = read_hdf_info_value(file_ras_geom_hdf, 
            ...
            if v_hdf_datasets.str.contains("Geometry/Cross Sections/Obstruction Blocks").any():
                df_xs_blocked = read_hdf_info_value(file_ras_geom_hdf, 
            ...
            if v_hdf_datasets.str.contains("Geometry/Ineffective Flow Areas/Attributes").any():
                df_xs_ineffective_attributes = read_hdf_df(file_ras_geom_hdf, 'Geometry/Ineffective Flow Areas/Attributes').reset_index()
                df_xs_ineffective_xy = read_hdf_info_value(file_ras_geom_hdf, 
            ...
            if v_hdf_datasets.str.contains("Geometry/Blocked Obstruction/Attributes").any():
                df_xs_blocked_attributes = read_hdf_df(file_ras_geom_hdf, 'Geometry/Blocked Obstruction/Attributes').reset_index()
                df_xs_blocked_xy = read_hdf_info_value(file_ras_geom_hdf, 
    ...
    def read_structures(self):
        ...
        if v_hdf_datasets.str.contains('Geometry/Structures/Attributes').any():
            df_struct_attributes = read_hdf_df(file_ras_geom_hdf, 'Geometry/Structures/Attributes').reset_index()
            ...
            df_struct_info = read_hdf_df(file_ras_geom_hdf, 'Geometry/Structures/Table Info')

            if v_hdf_datasets.str.contains('Geometry/Structures/Centerline Points').any():
                df_struct_xy = read_hdf_info_value(file_ras_geom_hdf,
            ...
            df_struct_coeff = read_hdf_df(file_ras_geom_hdf, 'Geometry/Structures/Bridge Coefficient Attributes')
            ...
            if v_hdf_datasets.str.contains('Geometry/Structures/Profile Data').any():
                ...
                temp_df_profile_values = read_hdf_df(file_ras_geom_hdf, 'Geometry/Structures/Profile Data').set_axis(['Sta', 'Elevation'], axis=1)
                df_struct_staelev = read_hdf_info_value(df_info=temp_df_profile_info,
            ...
            if v_hdf_datasets.str.contains('Geometry/Structures/Pier Attributes').any():
                df_struct_pier_attrib = read_hdf_df(file_ras_geom_hdf, 'Geometry/Structures/Pier Attributes')
            ...
            if v_hdf_datasets.str.contains('Geometry/Structures/Pier Data').any():
                ...
                temp_df_profile_values = read_hdf_df(file_ras_geom_hdf, 'Geometry/Structures/Pier Data').set_axis(['Width', 'Elevation'], axis=1)
                df_struct_pier_data = read_hdf_info_value(df_info=temp_df_profile_info,
                                                        df_values=temp_df_profile_values,
            ...
            if v_hdf_datasets.str.contains('Geometry/Structures/Abutment Attributes').any():
                df_struct_abut_attrib = read_hdf_df(file_ras_geom_hdf, 'Geometry/Structures/Abutment Attributes')
                ...
                temp_df_profile_info = pd.concat([temp_df_profile_1, temp_df_profile_2]).sort_values(['index_start'])
                temp_df_profile_values = read_hdf_df(file_ras_geom_hdf, 'Geometry/Structures/Abutment Data').set_axis(['Width', 'Elevation'], axis=1)
                df_struct_abut_data = read_hdf_info_value(df_info=temp_df_profile_info,
                                                        df_values=temp_df_profile_values,
                                                        df_attributes=temp_df_struct_attributes,
                                                        info_columns_to_keep='type')
            else:
            ...
            if v_hdf_datasets.str.contains('Geometry/Structures/Culvert Groups/Attributes').any():
                df_struct_culvert_attrib = read_hdf_df(file_ras_geom_hdf, 'Geometry/Structures/Culvert Groups/Attributes')
                ...
                df_struct_culvert_barrel_attrib = read_hdf_df(file_ras_geom_hdf, 'Geometry/Structures/Culvert Groups/Barrels/Attributes')
                ...
                if v_hdf_datasets.str.contains('Geometry/Structures/Culvert Groups/Barrels/Centerline Points').any():
                    df_struct_culvert_barrel_xy = read_hdf_info_value(file_ras_geom_hdf,
    ...
    def read_2d_area(self):
        ...
        if v_hdf_datasets.str.contains('Geometry/2D Flow Areas/Attributes').any():
            df_2d_area_attributes = read_hdf_df(file_ras_geom_hdf, 'Geometry/2D Flow Areas/Attributes').reset_index()
            df_2d_area_xy = read_hdf_info_value(file_hdf=file_ras_geom_hdf, 
            ...
            df_2d_area_pts_xy = read_hdf_info_value(file_ras_geom_hdf, 
        ...
        if v_hdf_datasets.str.contains('Geometry/2D Flow Area Break Lines/Attributes').any():
            df_breakline_attributes = read_hdf_df(file_ras_geom_hdf, 'Geometry/2D Flow Area Break Lines/Attributes').reset_index()
            df_breakline_xy = read_hdf_info_value(file_ras_geom_hdf, 
        ...
        if v_hdf_datasets.str.contains('Geometry/2D Flow Area Refinement Regions/Attributes').any():
            df_refinement_attributes = read_hdf_df(file_ras_geom_hdf, 'Geometry/2D Flow Area Refinement Regions/Attributes').reset_index()
            df_refinement_xy = read_hdf_info_value(file_ras_geom_hdf, 
    ...
    def read_ref_points(self):
        ...
        if v_hdf_datasets.str.contains('Geometry/Reference Points/Attributes').any():
            df_ref_point_attributes = read_hdf_df(file_ras_geom_hdf, 'Geometry/Reference Points/Attributes').reset_index()
            ...
            df_ref_point_xy = read_hdf_df(file_ras_geom_hdf, 'Geometry/Reference Points/Points').reset_index()
    ...
    def read_ref_lines(self):
        ...
        if v_hdf_datasets.str.contains('Geometry/Reference Lines/Attributes').any():
            df_ref_line_attributes = read_hdf_df(file_ras_geom_hdf, 'Geometry/Reference Lines/Attributes').reset_index()
            ...
            df_ref_line_xy = read_hdf_info_value(file_ras_geom_hdf, 
    ...
    def read_bc(self):
        ...
        if v_hdf_datasets.str.contains('Geometry/Boundary Condition Lines/Attributes').any():
            df_bc_attributes = read_hdf_df(file_ras_geom_hdf, 'Geometry/Boundary Condition Lines/Attributes').reset_index()
            df_bc_attributes = df_bc_attributes.assign(id = lambda x: ds.str_concat(x['Name'], '|', x['SA-2D'])).pipe(ds.pd_select_simple, ['id'])
            df_bc_xy = read_hdf_info_value(file_ras_geom_hdf, 
    ...
    def read_cell_faces(self):
        ...
        for name_perimeter in v_perimeters:
            if v_hdf_datasets.str.contains(f'Geometry/2D Flow Areas/{name_perimeter}/FacePoints Coordinate').any():
                df_face_xy = read_hdf_df(file_ras_geom_hdf, f'Geometry/2D Flow Areas/{name_perimeter}/FacePoints Coordinate').reset_index()
                df_face_info = read_hdf_df(file_ras_geom_hdf, f'Geometry/2D Flow Areas/{name_perimeter}/Cells Face and Orientation Info').reset_index()
                df_face_join = read_hdf_df(file_ras_geom_hdf, f'Geometry/2D Flow Areas/{name_perimeter}/Cells FacePoint Indexes').reset_index()
        ...
        if df_face_line_xy is not None:
            (df_face_line_xy
                .drop_duplicates()
                .assign(rn = lambda _: np.range(_.shape[0]))
                .melt()
            )
            pass
