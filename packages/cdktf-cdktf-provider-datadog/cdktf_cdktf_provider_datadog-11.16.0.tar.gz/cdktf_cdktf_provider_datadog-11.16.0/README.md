# CDKTF prebuilt bindings for DataDog/datadog provider version 3.51.0

This repo builds and publishes the [Terraform datadog provider](https://registry.terraform.io/providers/DataDog/datadog/3.51.0/docs) bindings for [CDK for Terraform](https://cdk.tf).
...
* [Terraform datadog provider](https://registry.terraform.io/providers/DataDog/datadog/3.51.0)
