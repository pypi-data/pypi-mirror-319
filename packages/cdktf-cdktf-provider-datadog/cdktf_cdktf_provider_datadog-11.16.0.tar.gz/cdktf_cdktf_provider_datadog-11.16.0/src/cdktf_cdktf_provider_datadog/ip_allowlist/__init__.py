...
class IpAllowlist(
    ...
    def __init__(
        ...
        *,
        ...
        '''Create a new {@link https://registry.terraform.io/providers/datadog/datadog/3.51.0/docs/resources/ip_allowlist datadog_ip_allowlist} Resource.

        :param scope: The scope in which to define this construct.
        :param id: The scoped construct ID. Must be unique amongst siblings in the same scope
        :param enabled: Whether the IP Allowlist is enabled. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.51.0/docs/resources/ip_allowlist#enabled IpAllowlist#enabled}
        :param entry: entry block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.51.0/docs/resources/ip_allowlist#entry IpAllowlist#entry}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing IpAllowlist that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/3.51.0/docs/resources/ip_allowlist#import import section} in the documentation of this resource for the id to use
...
class IpAllowlistEntry:
    def __init__(
        ...
        *,
        ...
        '''
        :param cidr_block: IP address or range of addresses. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.51.0/docs/resources/ip_allowlist#cidr_block IpAllowlist#cidr_block}
        :param note: Note accompanying IP address. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.51.0/docs/resources/ip_allowlist#note IpAllowlist#note}
        '''
        if __debug__:
