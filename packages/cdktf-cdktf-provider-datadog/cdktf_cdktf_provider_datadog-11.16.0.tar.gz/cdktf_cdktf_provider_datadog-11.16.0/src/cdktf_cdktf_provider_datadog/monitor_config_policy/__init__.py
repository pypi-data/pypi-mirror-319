...
Refer to the Terraform Registry for docs: [`datadog_monitor_config_policy`](https://registry.terraform.io/providers/datadog/datadog/3.51.0/docs/resources/monitor_config_policy).
'''
...
class MonitorConfigPolicy(
    ...
    def __init__(
        ...
        *,
        ...
        :param policy_type: The monitor config policy type Valid values are ``tag``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.51.0/docs/resources/monitor_config_policy#policy_type MonitorConfigPolicy#policy_type}
        :param id: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.51.0/docs/resources/monitor_config_policy#id MonitorConfigPolicy#id}. Please be aware that the id field is automatically added to all resources in Terraform providers using a Terraform provider SDK version below 2. If you experience problems setting this value it might not be settable. Please take a look at the provider documentation to ensure it should be settable.
        :param tag_policy: tag_policy block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.51.0/docs/resources/monitor_config_policy#tag_policy MonitorConfigPolicy#tag_policy}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing MonitorConfigPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/3.51.0/docs/resources/monitor_config_policy#import import section} in the documentation of this resource for the id to use
    ...
    def put_tag_policy(
        ...
        *,
        ...
        '''
        :param tag_key: The key of the tag. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.51.0/docs/resources/monitor_config_policy#tag_key MonitorConfigPolicy#tag_key}
        :param tag_key_required: If a tag key is required for monitor creation. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.51.0/docs/resources/monitor_config_policy#tag_key_required MonitorConfigPolicy#tag_key_required}
        :param valid_tag_values: Valid values for the tag. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.51.0/docs/resources/monitor_config_policy#valid_tag_values MonitorConfigPolicy#valid_tag_values}
        '''
