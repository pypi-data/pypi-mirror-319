...
Refer to the Terraform Registry for docs: [`datadog_integration_aws_account`](https://registry.terraform.io/providers/datadog/datadog/3.51.0/docs/resources/integration_aws_account).
'''
...
class IntegrationAwsAccount(
    ...
    def __init__(
        ...
        *,
        ...
        :param aws_account_id: Your AWS Account ID without dashes. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.51.0/docs/resources/integration_aws_account#aws_account_id IntegrationAwsAccount#aws_account_id}
        :param aws_partition: AWS Account partition. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.51.0/docs/resources/integration_aws_account#aws_partition IntegrationAwsAccount#aws_partition}
        :param account_tags: Tags to apply to all metrics in the account. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.51.0/docs/resources/integration_aws_account#account_tags IntegrationAwsAccount#account_tags}
        :param auth_config: auth_config block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.51.0/docs/resources/integration_aws_account#auth_config IntegrationAwsAccount#auth_config}
        :param aws_regions: aws_regions block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.51.0/docs/resources/integration_aws_account#aws_regions IntegrationAwsAccount#aws_regions}
        :param logs_config: logs_config block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.51.0/docs/resources/integration_aws_account#logs_config IntegrationAwsAccount#logs_config}
        :param metrics_config: metrics_config block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.51.0/docs/resources/integration_aws_account#metrics_config IntegrationAwsAccount#metrics_config}
        :param resources_config: resources_config block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.51.0/docs/resources/integration_aws_account#resources_config IntegrationAwsAccount#resources_config}
        :param traces_config: traces_config block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.51.0/docs/resources/integration_aws_account#traces_config IntegrationAwsAccount#traces_config}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing IntegrationAwsAccount that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/3.51.0/docs/resources/integration_aws_account#import import section} in the documentation of this resource for the id to use
    ...
    def put_auth_config(
        ...
        *,
        ...
        '''
        :param aws_auth_config_keys: aws_auth_config_keys block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.51.0/docs/resources/integration_aws_account#aws_auth_config_keys IntegrationAwsAccount#aws_auth_config_keys}
        :param aws_auth_config_role: aws_auth_config_role block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.51.0/docs/resources/integration_aws_account#aws_auth_config_role IntegrationAwsAccount#aws_auth_config_role}
        '''
    ...
    def put_aws_regions(
        ...
        *,
        ...
        '''
        :param include_all: Include all regions. Defaults to ``true``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.51.0/docs/resources/integration_aws_account#include_all IntegrationAwsAccount#include_all}
        :param include_only: Include only these regions. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.51.0/docs/resources/integration_aws_account#include_only IntegrationAwsAccount#include_only}
        '''
    ...
    def put_logs_config(
        ...
        *,
        ...
        '''
        :param lambda_forwarder: lambda_forwarder block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.51.0/docs/resources/integration_aws_account#lambda_forwarder IntegrationAwsAccount#lambda_forwarder}
        '''
    ...
    def put_metrics_config(
        ...
        *,
        ...
        '''
        :param automute_enabled: Enable EC2 automute for AWS metrics Defaults to ``true``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.51.0/docs/resources/integration_aws_account#automute_enabled IntegrationAwsAccount#automute_enabled}
        :param collect_cloudwatch_alarms: Enable CloudWatch alarms collection Defaults to ``false``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.51.0/docs/resources/integration_aws_account#collect_cloudwatch_alarms IntegrationAwsAccount#collect_cloudwatch_alarms}
        :param collect_custom_metrics: Enable custom metrics collection Defaults to ``false``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.51.0/docs/resources/integration_aws_account#collect_custom_metrics IntegrationAwsAccount#collect_custom_metrics}
        :param enabled: Enable AWS metrics collection Defaults to ``true``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.51.0/docs/resources/integration_aws_account#enabled IntegrationAwsAccount#enabled}
        :param namespace_filters: namespace_filters block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.51.0/docs/resources/integration_aws_account#namespace_filters IntegrationAwsAccount#namespace_filters}
        :param tag_filters: tag_filters block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.51.0/docs/resources/integration_aws_account#tag_filters IntegrationAwsAccount#tag_filters}
        '''
    ...
    def put_resources_config(
        ...
        *,
        ...
        '''
        :param cloud_security_posture_management_collection: Enable Cloud Security Management to scan AWS resources for vulnerabilities, misconfigurations, identity risks, and compliance violations. Requires ``extended_collection`` to be set to ``true``. Defaults to ``false``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.51.0/docs/resources/integration_aws_account#cloud_security_posture_management_collection IntegrationAwsAccount#cloud_security_posture_management_collection}
        :param extended_collection: Whether Datadog collects additional attributes and configuration information about the resources in your AWS account. Required for ``cloud_security_posture_management_collection``. Defaults to ``true``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.51.0/docs/resources/integration_aws_account#extended_collection IntegrationAwsAccount#extended_collection}
        '''
    ...
    def put_traces_config(
        ...
        *,
        ...
        '''
        :param xray_services: xray_services block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.51.0/docs/resources/integration_aws_account#xray_services IntegrationAwsAccount#xray_services}
        '''
...
class IntegrationAwsAccountAuthConfigAwsAuthConfigKeys:
    def __init__(
        ...
        *,
        ...
        '''
        :param access_key_id: AWS Access Key ID. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.51.0/docs/resources/integration_aws_account#access_key_id IntegrationAwsAccount#access_key_id}
        :param secret_access_key: AWS Secret Access Key. This value is write-only; changes made outside of Terraform will not be drift-detected. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.51.0/docs/resources/integration_aws_account#secret_access_key IntegrationAwsAccount#secret_access_key}
        '''
        if __debug__:
...
class IntegrationAwsAccountAuthConfigAwsAuthConfigRole:
    def __init__(
        ...
        *,
        ...
        '''
        :param external_id: AWS IAM External ID for associated role. If omitted, one will be generated. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.51.0/docs/resources/integration_aws_account#external_id IntegrationAwsAccount#external_id}
        :param role_name: AWS IAM Role name. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.51.0/docs/resources/integration_aws_account#role_name IntegrationAwsAccount#role_name}
        '''
        if __debug__:
...
class IntegrationAwsAccountLogsConfigLambdaForwarder:
    def __init__(
        ...
        *,
        ...
        '''
        :param lambdas: List of Datadog Lambda Log Forwarder ARNs in your AWS account. Defaults to ``[]``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.51.0/docs/resources/integration_aws_account#lambdas IntegrationAwsAccount#lambdas}
        :param sources: List of service IDs set to enable automatic log collection. Use ```datadog_integration_aws_available_logs_services`` data source <https://registry.terraform.io/providers/DataDog/datadog/latest/docs/data-sources/integration_aws_available_logs_services>`_ to get allowed values. Defaults to ``[]``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.51.0/docs/resources/integration_aws_account#sources IntegrationAwsAccount#sources}
        '''
        if __debug__:
...
class IntegrationAwsAccountMetricsConfigNamespaceFilters:
    def __init__(
        ...
        *,
        ...
        '''
        :param exclude_only: Exclude only these namespaces from metrics collection. Use ```datadog_integration_aws_available_namespaces`` data source <https://registry.terraform.io/providers/DataDog/datadog/latest/docs/data-sources/integration_aws_available_namespaces>`_ to get allowed values. Defaults to ``["AWS/SQS", "AWS/ElasticMapReduce"]``. ``AWS/SQS`` and ``AWS/ElasticMapReduce`` are excluded by default to reduce your AWS CloudWatch costs from ``GetMetricData`` API calls. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.51.0/docs/resources/integration_aws_account#exclude_only IntegrationAwsAccount#exclude_only}
        :param include_only: Include only these namespaces for metrics collection. Use ```datadog_integration_aws_available_namespaces`` data source <https://registry.terraform.io/providers/DataDog/datadog/latest/docs/data-sources/integration_aws_available_namespaces>`_ to get allowed values. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.51.0/docs/resources/integration_aws_account#include_only IntegrationAwsAccount#include_only}
        '''
        if __debug__:
...
class IntegrationAwsAccountMetricsConfigTagFilters:
    def __init__(
        ...
        *,
        ...
        '''
        :param namespace: The AWS service for which the tag filters defined in ``tags`` will be applied. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.51.0/docs/resources/integration_aws_account#namespace IntegrationAwsAccount#namespace}
        :param tags: The AWS resource tags to filter on for the service specified by ``namespace``. Defaults to ``[]``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.51.0/docs/resources/integration_aws_account#tags IntegrationAwsAccount#tags}
        '''
        if __debug__:
...
class IntegrationAwsAccountTracesConfigOutputReference(
    ...
    def put_xray_services(
        ...
        *,
        ...
        '''
        :param include_all: Include all services. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.51.0/docs/resources/integration_aws_account#include_all IntegrationAwsAccount#include_all}
        :param include_only: Include only these services. Defaults to ``[]``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.51.0/docs/resources/integration_aws_account#include_only IntegrationAwsAccount#include_only}
        '''
