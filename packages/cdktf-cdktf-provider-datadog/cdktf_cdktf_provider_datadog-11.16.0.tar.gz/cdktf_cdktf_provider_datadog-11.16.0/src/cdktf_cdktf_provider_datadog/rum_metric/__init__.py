...
class RumMetric(
    ...
    def __init__(
        ...
        *,
        ...
        :param event_type: The type of RUM events to filter on. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.51.0/docs/resources/rum_metric#event_type RumMetric#event_type}
        :param name: The name of the RUM-based metric. This field can't be updated after creation. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.51.0/docs/resources/rum_metric#name RumMetric#name}
        :param compute: compute block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.51.0/docs/resources/rum_metric#compute RumMetric#compute}
        :param filter: filter block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.51.0/docs/resources/rum_metric#filter RumMetric#filter}
        :param group_by: group_by block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.51.0/docs/resources/rum_metric#group_by RumMetric#group_by}
        :param uniqueness: uniqueness block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.51.0/docs/resources/rum_metric#uniqueness RumMetric#uniqueness}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing RumMetric that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/3.51.0/docs/resources/rum_metric#import import section} in the documentation of this resource for the id to use
    ...
    def put_compute(
        ...
        *,
        ...
        '''
        :param aggregation_type: The type of aggregation to use. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.51.0/docs/resources/rum_metric#aggregation_type RumMetric#aggregation_type}
        :param include_percentiles: Toggle to include or exclude percentile aggregations for distribution metrics. Only present when ``aggregation_type`` is ``distribution``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.51.0/docs/resources/rum_metric#include_percentiles RumMetric#include_percentiles}
        :param path: The path to the value the RUM-based metric will aggregate on. Only present when ``aggregation_type`` is ``distribution``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.51.0/docs/resources/rum_metric#path RumMetric#path}
        '''
    ...
    def put_filter(self, *, query: typing.Optional[builtins.str] = None) -> None:
        '''
        :param query: The search query. Follows RUM search syntax. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.51.0/docs/resources/rum_metric#query RumMetric#query}
        '''
    ...
    def put_uniqueness(self, *, when: typing.Optional[builtins.str] = None) -> None:
        '''
        :param when: When to count updatable events. ``match`` when the event is first seen, or ``end`` when the event is complete. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.51.0/docs/resources/rum_metric#when RumMetric#when}
        '''
...
class RumMetricGroupBy:
    def __init__(
        ...
        *,
        ...
        '''
        :param path: The path to the value the RUM-based metric will be aggregated over. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.51.0/docs/resources/rum_metric#path RumMetric#path}
        :param tag_name: Name of the tag that gets created. By default, ``path`` is used as the tag name. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.51.0/docs/resources/rum_metric#tag_name RumMetric#tag_name}
        '''
        if __debug__:
