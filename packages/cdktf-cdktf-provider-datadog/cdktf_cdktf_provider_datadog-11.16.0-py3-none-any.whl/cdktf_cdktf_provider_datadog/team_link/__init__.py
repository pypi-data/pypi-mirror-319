...
class TeamLink(
    ...
    def __init__(
        ...
        *,
        ...
        :param label: The link's label. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.51.0/docs/resources/team_link#label TeamLink#label}
        :param team_id: ID of the team the link is associated with. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.51.0/docs/resources/team_link#team_id TeamLink#team_id}
        :param url: The URL for the link. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.51.0/docs/resources/team_link#url TeamLink#url}
        :param position: The link's position, used to sort links for the team. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.51.0/docs/resources/team_link#position TeamLink#position}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing TeamLink that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/3.51.0/docs/resources/team_link#import import section} in the documentation of this resource for the id to use
