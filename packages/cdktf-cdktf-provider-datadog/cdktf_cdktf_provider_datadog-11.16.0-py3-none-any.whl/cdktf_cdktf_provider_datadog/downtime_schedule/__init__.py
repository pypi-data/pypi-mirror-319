...
class DowntimeSchedule(
    ...
    '''Represents a {@link https://registry.terraform.io/providers/datadog/datadog/3.51.0/docs/resources/downtime_schedule datadog_downtime_schedule}.'''
    ...
    def __init__(
        ...
        *,
        ...
        '''Create a new {@link https://registry.terraform.io/providers/datadog/datadog/3.51.0/docs/resources/downtime_schedule datadog_downtime_schedule} Resource.

        :param scope_: The scope in which to define this construct.
        :param id: The scoped construct ID. Must be unique amongst siblings in the same scope
        :param scope: The scope to which the downtime applies. Must follow the `common search syntax <https://docs.datadoghq.com/logs/explorer/search_syntax/>`_. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.51.0/docs/resources/downtime_schedule#scope DowntimeSchedule#scope}
        :param display_timezone: The timezone in which to display the downtime's start and end times in Datadog applications. This is not used as an offset for scheduling. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.51.0/docs/resources/downtime_schedule#display_timezone DowntimeSchedule#display_timezone}
        :param message: A message to include with notifications for this downtime. Email notifications can be sent to specific users by using the same ``@username`` notation as events. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.51.0/docs/resources/downtime_schedule#message DowntimeSchedule#message}
        :param monitor_identifier: monitor_identifier block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.51.0/docs/resources/downtime_schedule#monitor_identifier DowntimeSchedule#monitor_identifier}
        :param mute_first_recovery_notification: If the first recovery notification during a downtime should be muted. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.51.0/docs/resources/downtime_schedule#mute_first_recovery_notification DowntimeSchedule#mute_first_recovery_notification}
        :param notify_end_states: States that will trigger a monitor notification when the ``notify_end_types`` action occurs. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.51.0/docs/resources/downtime_schedule#notify_end_states DowntimeSchedule#notify_end_states}
        :param notify_end_types: Actions that will trigger a monitor notification if the downtime is in the ``notify_end_types`` state. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.51.0/docs/resources/downtime_schedule#notify_end_types DowntimeSchedule#notify_end_types}
        :param one_time_schedule: one_time_schedule block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.51.0/docs/resources/downtime_schedule#one_time_schedule DowntimeSchedule#one_time_schedule}
        :param recurring_schedule: recurring_schedule block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.51.0/docs/resources/downtime_schedule#recurring_schedule DowntimeSchedule#recurring_schedule}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing DowntimeSchedule that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/3.51.0/docs/resources/downtime_schedule#import import section} in the documentation of this resource for the id to use
    ...
    def put_monitor_identifier(
        ...
        *,
        ...
        '''
        :param monitor_id: ID of the monitor to prevent notifications. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.51.0/docs/resources/downtime_schedule#monitor_id DowntimeSchedule#monitor_id}
        :param monitor_tags: A list of monitor tags. For example, tags that are applied directly to monitors, not tags that are used in monitor queries (which are filtered by the scope parameter), to which the downtime applies. The resulting downtime applies to monitors that match **all** provided monitor tags. Setting ``monitor_tags`` to ``[*]`` configures the downtime to mute all monitors for the given scope. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.51.0/docs/resources/downtime_schedule#monitor_tags DowntimeSchedule#monitor_tags}
        '''
    ...
    def put_one_time_schedule(
        ...
        *,
        ...
        '''
        :param end: ISO-8601 Datetime to end the downtime. Must include a UTC offset of zero. If not provided, the downtime never ends. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.51.0/docs/resources/downtime_schedule#end DowntimeSchedule#end}
        :param start: ISO-8601 Datetime to start the downtime. Must include a UTC offset of zero. If not provided, the downtime starts the moment it is created. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.51.0/docs/resources/downtime_schedule#start DowntimeSchedule#start}
        '''
    ...
    def put_recurring_schedule(
        ...
        *,
        ...
        '''
        :param recurrence: recurrence block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.51.0/docs/resources/downtime_schedule#recurrence DowntimeSchedule#recurrence}
        :param timezone: The timezone in which to schedule the downtime. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.51.0/docs/resources/downtime_schedule#timezone DowntimeSchedule#timezone}
        '''
...
class DowntimeScheduleConfig(_cdktf_9a9027ec.TerraformMetaArguments):
    ...
    def scope(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.51.0/docs/resources/downtime_schedule#scope DowntimeSchedule#scope}
        '''
    ...
    def display_timezone(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.51.0/docs/resources/downtime_schedule#display_timezone DowntimeSchedule#display_timezone}
        '''
    ...
    def message(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.51.0/docs/resources/downtime_schedule#message DowntimeSchedule#message}
        '''
    ...
    def monitor_identifier(
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.51.0/docs/resources/downtime_schedule#monitor_identifier DowntimeSchedule#monitor_identifier}
        '''
    ...
    def mute_first_recovery_notification(
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.51.0/docs/resources/downtime_schedule#mute_first_recovery_notification DowntimeSchedule#mute_first_recovery_notification}
        '''
    ...
    def notify_end_states(self) -> typing.Optional[typing.List[builtins.str]]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.51.0/docs/resources/downtime_schedule#notify_end_states DowntimeSchedule#notify_end_states}
        '''
    ...
    def notify_end_types(self) -> typing.Optional[typing.List[builtins.str]]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.51.0/docs/resources/downtime_schedule#notify_end_types DowntimeSchedule#notify_end_types}
        '''
    ...
    def one_time_schedule(self) -> typing.Optional["DowntimeScheduleOneTimeSchedule"]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.51.0/docs/resources/downtime_schedule#one_time_schedule DowntimeSchedule#one_time_schedule}
        '''
    ...
    def recurring_schedule(
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.51.0/docs/resources/downtime_schedule#recurring_schedule DowntimeSchedule#recurring_schedule}
        '''
...
class DowntimeScheduleMonitorIdentifier:
    ...
    def monitor_id(self) -> typing.Optional[jsii.Number]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.51.0/docs/resources/downtime_schedule#monitor_id DowntimeSchedule#monitor_id}
        '''
    ...
    def monitor_tags(self) -> typing.Optional[typing.List[builtins.str]]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.51.0/docs/resources/downtime_schedule#monitor_tags DowntimeSchedule#monitor_tags}
        '''
...
class DowntimeScheduleOneTimeSchedule:
    ...
    def end(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.51.0/docs/resources/downtime_schedule#end DowntimeSchedule#end}
        '''
    ...
    def start(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.51.0/docs/resources/downtime_schedule#start DowntimeSchedule#start}
        '''
...
class DowntimeScheduleRecurringSchedule:
    ...
    def recurrence(
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.51.0/docs/resources/downtime_schedule#recurrence DowntimeSchedule#recurrence}
        '''
    ...
    def timezone(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.51.0/docs/resources/downtime_schedule#timezone DowntimeSchedule#timezone}
        '''
...
class DowntimeScheduleRecurringScheduleRecurrence:
    def __init__(
        ...
        *,
        ...
        '''
        :param duration: The length of the downtime. Must begin with an integer and end with one of 'm', 'h', d', or 'w'. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.51.0/docs/resources/downtime_schedule#duration DowntimeSchedule#duration}
        :param rrule: The ``RRULE`` standard for defining recurring events. For example, to have a recurring event on the first day of each month, set the type to ``rrule`` and set the ``FREQ`` to ``MONTHLY`` and ``BYMONTHDAY`` to ``1``. Most common ``rrule`` options from the `iCalendar Spec <https://tools.ietf.org/html/rfc5545>`_ are supported. **Note**: Attributes specifying the duration in ``RRULE`` are not supported (for example, ``DTSTART``, ``DTEND``, ``DURATION``). More examples available in this `downtime guide <https://docs.datadoghq.com/monitors/guide/suppress-alert-with-downtimes/?tab=api>`_. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.51.0/docs/resources/downtime_schedule#rrule DowntimeSchedule#rrule}
        :param start: ISO-8601 Datetime to start the downtime. Must not include a UTC offset. If not provided, the downtime starts the moment it is created. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.51.0/docs/resources/downtime_schedule#start DowntimeSchedule#start}
        '''
        if __debug__:
    ...
    def duration(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.51.0/docs/resources/downtime_schedule#duration DowntimeSchedule#duration}
        '''
    ...
    def rrule(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.51.0/docs/resources/downtime_schedule#rrule DowntimeSchedule#rrule}
        '''
