...
class ApmRetentionFilter(
    ...
    def __init__(
        ...
        *,
        ...
        '''Create a new {@link https://registry.terraform.io/providers/datadog/datadog/3.51.0/docs/resources/apm_retention_filter datadog_apm_retention_filter} Resource.

        :param scope: The scope in which to define this construct.
        :param id: The scoped construct ID. Must be unique amongst siblings in the same scope
        :param enabled: the status of the retention filter. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.51.0/docs/resources/apm_retention_filter#enabled ApmRetentionFilter#enabled}
        :param filter_type: The type of the retention filter, currently only spans-processing-sampling is available. Valid values are ``spans-sampling-processor``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.51.0/docs/resources/apm_retention_filter#filter_type ApmRetentionFilter#filter_type}
        :param name: The name of the retention filter. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.51.0/docs/resources/apm_retention_filter#name ApmRetentionFilter#name}
        :param rate: Sample rate to apply to spans going through this retention filter as a string, a value of 1.0 keeps all spans matching the query. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.51.0/docs/resources/apm_retention_filter#rate ApmRetentionFilter#rate}
        :param filter: filter block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.51.0/docs/resources/apm_retention_filter#filter ApmRetentionFilter#filter}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing ApmRetentionFilter that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/3.51.0/docs/resources/apm_retention_filter#import import section} in the documentation of this resource for the id to use
    ...
    def put_filter(self, *, query: typing.Optional[builtins.str] = None) -> None:
        '''
        :param query: The search query - follow the span search syntax, use ``AND`` between tags and ``\\`` to escape special characters, use nanosecond for duration. Defaults to ``"*"``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.51.0/docs/resources/apm_retention_filter#query ApmRetentionFilter#query}
        '''
