...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-sagemaker-metrics)](https://pypistats.org/packages/mypy-boto3-sagemaker-metrics)
...
`mypy-boto3-sagemaker-metrics` dependency in production. However, there is an
