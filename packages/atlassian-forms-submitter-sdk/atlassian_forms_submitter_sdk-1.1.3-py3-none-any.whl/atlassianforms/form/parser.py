...
class FieldType(Enum):
    """Enum representing different field types in the Service Desk form."""

    TEXT = "text"
    CASCADING_SELECT = "cascadingselect"
    TEXTAREA = "textarea"
    ORGANIZATION_PICKER = "organisationpicker"
    RICH_TEXT = "rt"
    TEXT_LINE = "tl"
    DATE_TIME = "dt"
    CHOICE_DROPDOWN = "cd"
...
class ServiceDeskFormField:
    ...
    def has_autocomplete(self) -> bool:
        ...
        """
        return self.auto_complete_url is not None and self.auto_complete_url != "None"
