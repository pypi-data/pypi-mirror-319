...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-iot1click-devices)](https://pypistats.org/packages/mypy-boto3-iot1click-devices)
...
`mypy-boto3-iot1click-devices` dependency in production. However, there is an
