...
class EmployeeDeviceLink(BaseTableModel):
    company_id: Optional[str] = Column(foreign_key_table='company', foreign_key_column='company_id')
    employee_id: Optional[str] = Column(foreign_key_table='employee', foreign_key_column='employee_id')
...
class NotificationRecipientLink(BaseTableModel):
    company_id: Optional[str] = Column(foreign_key_table='company', foreign_key_column='company_id')
    notification_id: Optional[str] = Column(foreign_key_table='notification', foreign_key_column='notification_id')
    recipient_id: Optional[str] = Column(foreign_key_table='employee', foreign_key_column='employee_id')
    ack_status: Optional[str] = Column()
...
class PushNotificationLog(BaseTableModel):
    ...
    notification_id: Optional[str] = Column(foreign_key_table='notification', foreign_key_column='notification_id')
    recipient_id: Optional[str] = Column(foreign_key_table='employee', foreign_key_column='employee_id')
    device_id: Optional[str] = Column(foreign_key_table='employee_device_link', foreign_key_column='device_id')
