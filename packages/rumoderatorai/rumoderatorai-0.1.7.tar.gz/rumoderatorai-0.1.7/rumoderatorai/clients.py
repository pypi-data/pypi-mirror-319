...
class Client:
    ...
    async def _check_connection(self):
        ...
        async with self.session.post(self._cfg._base_url, json={}) as response:
    ...
    async def _get(self, path: str, json: dict = {}) -> HTTPResponse:
        ...
        Send GET request
        """
        async with self.session.get(self._url(path), headers=HEADERS, json=self._json(**json)) as response:
    ...
    async def _post(self, path: str, json: dict = {}) -> HTTPResponse:
        ...
        Send POST request
        """
        async with self.session.post(self._url(path), headers=HEADERS, json=self._json(**json)) as response:
            return HTTPResponse(await response.json(), response.status)

    async def get_text_class(self, text: str, model: str | None = None) -> classes.TextClassResponse:
        """
        ...
        return self._preprocess_response(
            response.json, classes.TextClassResponse
        )
    ...
    async def get_image_class(
        ...
        return self._preprocess_response(
            response.json, classes.ImageClassResponse
        )
    
    async def get_ocr(self, image: Image.Image | Path | str) -> classes.OcrResponse:
        """
    ...
    async def get_multimodal_text_class(self, text: str | None = None,
        ...
        return self._preprocess_response(response.json, classes.TextClassResponse)
    ...
    async def get_stats(self, limit: int = 3) -> classes.StatsResponse:
        ...
        return self._preprocess_response(
            response.json, classes.StatsResponse
        )
    ...
    async def get_key_info(self) -> classes.KeyInfoResponse:
        ...
        return self._preprocess_response(
            response.json, classes.KeyInfoResponse
        )
    ...
    async def get_prediction(self, unique_id: str) -> classes.PredictionResponse:
        ...
        return self._preprocess_response(
            response.json, classes.PredictionResponse
        )
    ...
    async def get_ips(self) -> classes.IpsResponse:
        ...
        return self._preprocess_response(response.json, classes.IpsResponse)
    ...
    async def get_prices(self) -> classes.PricesResponse:
        ...
        return self._preprocess_response(
            response.json, classes.PricesResponse
        )
