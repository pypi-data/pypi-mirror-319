...
from atlaz.io_operations.file_mediator import handle_apply_changes, read_json, remove_explanation_file, remove_json_files
...
def apply_changes():
    """
    Reads atlaz/frontend/files.json (or wherever you write them),
    then copies each file's content to the original location in the repo.
    """
