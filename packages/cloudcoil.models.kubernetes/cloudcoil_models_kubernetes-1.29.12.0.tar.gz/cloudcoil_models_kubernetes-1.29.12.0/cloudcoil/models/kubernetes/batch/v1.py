...
class JobStatus(BaseModel):
    active: Annotated[
        Optional[int], Field(description="The number of pending and running pods.")
    ] = None
    ...
    failed: Annotated[
        Optional[int],
        Field(description="The number of pods which reached phase Failed."),
    ] = None
    ...
    succeeded: Annotated[
        Optional[int],
        Field(description="The number of pods which reached phase Succeeded."),
    ] = None
