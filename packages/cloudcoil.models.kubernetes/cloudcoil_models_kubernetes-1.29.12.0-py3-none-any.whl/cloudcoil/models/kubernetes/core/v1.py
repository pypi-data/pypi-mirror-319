...
class HostIP(BaseModel):
    ip: Annotated[Optional[str], Field(description="IP is the IP address assigned to the host")] = (
        None
    )
...
class PodIP(BaseModel):
    ip: Annotated[Optional[str], Field(description="IP is the IP address assigned to the pod")] = (
        None
    )
...
class PodResourceClaim(BaseModel):
    ...
    source: Annotated[
        Optional[ClaimSource],
        Field(description="Source describes where to find the ResourceClaim."),
    ] = None
