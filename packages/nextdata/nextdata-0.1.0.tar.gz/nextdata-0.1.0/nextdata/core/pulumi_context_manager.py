...
class PulumiContextManager:
    ...
    def _setup_glue_job(self, table_path: Path, job_type: Literal["etl", "retl"]):
        ...
        glue_job = aws.glue.Job(
            ...
            # },
            default_arguments=pulumi.Output.all(bucket=bucket_name).apply(
                lambda args: {
                    ...
                    "--IncrementalColumn": incremental_column,
                    "--IsFullLoad": "false",
                    # "--extra-py-files": f"s3://{args['bucket']}/{script_key}",
                    ...
                    "--additional-python-modules": "nextdata boto3==1.26.137",
