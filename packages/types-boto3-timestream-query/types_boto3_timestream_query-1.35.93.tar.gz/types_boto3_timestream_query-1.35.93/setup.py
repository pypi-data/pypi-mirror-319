"""
Setup script for types-boto3-timestream-query.
...
setup(
    name="types-boto3-timestream-query",
    version="1.35.93",
    packages=["types_boto3_timestream_query"],
    ...
    package_data={"types_boto3_timestream_query": ["py.typed", "*.pyi"]},
    python_requires=">=3.8",
    project_urls={
