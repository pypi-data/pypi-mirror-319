...
####+BEGINNOT: b:py3:pypi:setup/pkgName :comment "Not Auto Detected" :pkgName "graphviz" :pkgNameSpace "bisos"
...
# ./pypiUploadVer EXISTED -- forPypiVersion=0.20 -- forSysVersion=0.16 -- constant=NA
def pkgVersion():
        return '0.20'
...
####+BEGINNOT: b:py3:pypi:setup/scripts :comment ""
