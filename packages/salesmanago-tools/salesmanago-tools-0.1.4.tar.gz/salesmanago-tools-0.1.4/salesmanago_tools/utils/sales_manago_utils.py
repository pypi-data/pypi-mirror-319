...
class SalesmanagoBaseClient:
    def __init__(self, clientId: str, apiKey: str, sha: str, owner: str, account_name: str | None = None):
        """
        ...
        :param account_name: Optional account name (default is None).
        """
        self.api_key = apiKey
        self.sha = sha
...
class SalesmanagoDataClient(SalesmanagoBaseClient):
    ...
    async def push_people_to_salesmanago(self, people_list_to_push: list[dict], tags: list[str] = []):
        ...
        :param people_list_to_push: A list of people data (dictionaries) to push to Salesmanago.
        :param account: The account associated with the data (default is "SEOSENSE").
    ...
    async def update_tag_salesmanago(self, email, tags, call_id=None):
        ...
        :param call_id: An optional call ID to associate with the contact.
        :return: None
        """
        payload = {
            "clientId": self.client_id,
