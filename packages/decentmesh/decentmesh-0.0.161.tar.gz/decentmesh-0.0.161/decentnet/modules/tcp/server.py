...
class TCPServer:
    ...
    async def graceful_shutdown(beam_message_queue, beam_pipe_comm, relay, sock_name):
        ...
        await relay.disconnect_beacon(relay.local_port, relay.beam_pub_key)
        await remove_alive_beam_from_db_w_pub_key(relay.beam_pub_key)
        await relay.network.rm_edge(relay.beam.pub_key, relay.beam_pub_key)
