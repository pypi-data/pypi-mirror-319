...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-wellarchitected)](https://pypistats.org/packages/mypy-boto3-wellarchitected)
...
`mypy-boto3-wellarchitected` dependency in production. However, there is an
