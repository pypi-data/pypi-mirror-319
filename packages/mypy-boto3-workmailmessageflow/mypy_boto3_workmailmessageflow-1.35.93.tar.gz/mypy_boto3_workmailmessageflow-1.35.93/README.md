...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-workmailmessageflow)](https://pypistats.org/packages/mypy-boto3-workmailmessageflow)
...
`mypy-boto3-workmailmessageflow` dependency in production. However, there is an
