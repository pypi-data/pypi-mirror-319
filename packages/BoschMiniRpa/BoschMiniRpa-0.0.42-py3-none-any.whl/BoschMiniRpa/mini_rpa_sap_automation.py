...
SAP_INFO_SET_ROWS_TR_CSS_SELECTOR = "tr[id^='SHresultgrid2-mrss-cont-none-Row']"
SAP_INFO_SET_ROWS_SPAN_CSS_SELECTOR = "tr[id^='SHresultgrid2-mrss-cont-none-Row'] td:first-child div span"
...
class MiniRpaSapAutomation:
    ...
    def input_sap_info_set(self, info_set_name):
        ...
        sleep(2)
        self.web_rpa.click_or_input_by_css_selector(SAP_INFO_SET_SPAN_CSS_SELECTOR, 'click')
        sleep(2)
