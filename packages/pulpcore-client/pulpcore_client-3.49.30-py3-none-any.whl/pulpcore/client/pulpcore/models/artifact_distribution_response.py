...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, pulp_labels=None, base_url=None, pulp_created=None, pulp_last_updated=None, content_guard=None, pulp_href=None, hidden=False, name=None, base_path=None, local_vars_configuration=None):  # noqa: E501
