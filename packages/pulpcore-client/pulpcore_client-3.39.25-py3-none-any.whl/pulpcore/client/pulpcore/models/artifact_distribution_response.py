...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, content_guard=None, pulp_href=None, pulp_created=None, base_url=None, pulp_labels=None, base_path=None, hidden=False, name=None, local_vars_configuration=None):  # noqa: E501
