...
class WorkersApi(object):
    ...
    def list(self,  **kwargs):  # noqa: E501
        ...
        :param datetime last_heartbeat: Filter results where last_heartbeat matches value
        :param datetime last_heartbeat__gt: Filter results where last_heartbeat is greater than value
        :param datetime last_heartbeat__gte: Filter results where last_heartbeat is greater than or equal to value
        :param datetime last_heartbeat__lt: Filter results where last_heartbeat is less than value
        :param datetime last_heartbeat__lte: Filter results where last_heartbeat is less than or equal to value
        :param list[datetime] last_heartbeat__range: Filter results where last_heartbeat is between two comma separated values
    ...
    def list_with_http_info(self,  **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(PaginatedWorkerResponseList, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        if 'last_heartbeat__range' in local_var_params and local_var_params['last_heartbeat__range'] is not None:  # noqa: E501
            ...
            collection_formats['last_heartbeat__range'] = 'csv'  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            response_type='PaginatedWorkerResponseList',  # noqa: E501
