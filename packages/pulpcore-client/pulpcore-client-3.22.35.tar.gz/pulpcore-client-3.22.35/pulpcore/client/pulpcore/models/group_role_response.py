...
class GroupRoleResponse(object):
    ...
    def __init__(self, pulp_href=None, pulp_created=None, role=None, content_object=None, description=None, permissions=None, local_vars_configuration=None):  # noqa: E501
