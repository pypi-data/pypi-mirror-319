...
class DistributionResponse(object):
    ...
    def __init__(self, pulp_href=None, pulp_created=None, base_path=None, base_url=None, content_guard=None, pulp_labels=None, name=None, repository=None, local_vars_configuration=None):  # noqa: E501
