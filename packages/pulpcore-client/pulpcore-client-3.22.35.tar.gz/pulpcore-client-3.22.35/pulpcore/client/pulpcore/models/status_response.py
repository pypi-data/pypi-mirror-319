...
class StatusResponse(object):
    ...
    def __init__(self, versions=None, online_workers=None, online_content_apps=None, database_connection=None, redis_connection=None, storage=None, content_settings=None, local_vars_configuration=None):  # noqa: E501
