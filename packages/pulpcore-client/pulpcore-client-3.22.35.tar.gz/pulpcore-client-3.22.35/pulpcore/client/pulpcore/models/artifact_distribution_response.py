...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, name=None, content_guard=None, base_url=None, pulp_href=None, pulp_labels=None, pulp_created=None, base_path=None, local_vars_configuration=None):  # noqa: E501
