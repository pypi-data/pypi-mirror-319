...
class GroupsRolesApi(object):
    ...
    def create(self, group_href, group_role,  **kwargs):  # noqa: E501
        """Create a group role  # noqa: E501

        ViewSet for GroupRole.  NOTE: This API endpoint is in \"tech preview\" and subject to change  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create(group_href, group_role, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param str group_href: (required)
        :param GroupRole group_role: (required)
        ...
        return self.create_with_http_info(group_href, group_role,  **kwargs)  # noqa: E501

    def create_with_http_info(self, group_href, group_role,  **kwargs):  # noqa: E501
        """Create a group role  # noqa: E501

        ViewSet for GroupRole.  NOTE: This API endpoint is in \"tech preview\" and subject to change  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_with_http_info(group_href, group_role, async_req=True)
        >>> result = thread.get()
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(GroupRoleResponse, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        if self.api_client.client_side_validation and ('group_role' not in local_var_params or  # noqa: E501
                                                        local_var_params['group_role'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `group_role` when calling `create`")  # noqa: E501
        ...
        body_params = None
        if 'group_role' in local_var_params:
            body_params = local_var_params['group_role']
        # HTTP header `Accept`
        ...
        return self.api_client.call_api(
            ...
            response_type='GroupRoleResponse',  # noqa: E501
    ...
    def delete(self, groups_group_role_href,  **kwargs):  # noqa: E501
        """Delete a group role  # noqa: E501

        ViewSet for GroupRole.  NOTE: This API endpoint is in \"tech preview\" and subject to change  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete(groups_group_role_href, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param str groups_group_role_href: (required)
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.delete_with_http_info(groups_group_role_href,  **kwargs)  # noqa: E501

    def delete_with_http_info(self, groups_group_role_href,  **kwargs):  # noqa: E501
        """Delete a group role  # noqa: E501

        ViewSet for GroupRole.  NOTE: This API endpoint is in \"tech preview\" and subject to change  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_with_http_info(groups_group_role_href, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('groups_group_role_href' not in local_var_params or  # noqa: E501
                                                        local_var_params['groups_group_role_href'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `groups_group_role_href` when calling `delete`")  # noqa: E501

        collection_formats = {}

        path_params = {}
        if 'groups_group_role_href' in local_var_params:
            path_params['groups_group_role_href'] = local_var_params['groups_group_role_href']  # noqa: E501
    ...
    def list_with_http_info(self, group_href,  **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(PaginatedGroupRoleResponseList, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='PaginatedGroupRoleResponseList',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get('_return_http_data_only'),  # noqa: E501
            _preload_content=local_var_params.get('_preload_content', True),
    ...
    def read(self, groups_group_role_href,  **kwargs):  # noqa: E501
        """Inspect a group role  # noqa: E501

        ViewSet for GroupRole.  NOTE: This API endpoint is in \"tech preview\" and subject to change  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.read(groups_group_role_href, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.read_with_http_info(groups_group_role_href,  **kwargs)  # noqa: E501

    def read_with_http_info(self, groups_group_role_href,  **kwargs):  # noqa: E501
        """Inspect a group role  # noqa: E501

        ViewSet for GroupRole.  NOTE: This API endpoint is in \"tech preview\" and subject to change  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.read_with_http_info(groups_group_role_href, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('groups_group_role_href' not in local_var_params or  # noqa: E501
                                                        local_var_params['groups_group_role_href'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `groups_group_role_href` when calling `read`")  # noqa: E501
