...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, hidden=False, base_url=None, content_guard=None, pulp_href=None, pulp_created=None, prn=None, no_content_change_since=None, pulp_last_updated=None, pulp_labels=None, name=None, base_path=None, local_vars_configuration=None):  # noqa: E501
