...
def _f3d_options_update(self, arg: typing.Union[typing.Mapping[str, typing.Any], typing.Iterable[tuple[str, typing.Any]]]) -> None:
    ...
F3D_ABSOLUTE_DLLS: list = ['D:/a/f3d-superbuild/f3d-superbuild/fsbb/install/bin', 'D:/a/f3d-superbuild/f3d-superbuild/fsbb/install/lib', 'C:/Users/runneradmin/AppData/Local/Temp/tmp0mcfjqq2/build/bin']
F3D_RELATIVE_DLLS: list = list()
__version__: str = '3.0.0'
abs_path: str = 'C:/Users/runneradmin/AppData/Local/Temp/tmp0mcfjqq2/build/bin'
root: pathlib.WindowsPath  # value = WindowsPath('C:/Users/runneradmin/AppData/Local/Temp/tmp0mcfjqq2/build/f3d')
