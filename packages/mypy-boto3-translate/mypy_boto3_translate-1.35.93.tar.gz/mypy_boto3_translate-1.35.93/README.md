...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-translate)](https://pypistats.org/packages/mypy-boto3-translate)
...
`mypy-boto3-translate` dependency in production. However, there is an issue in
