...
class Falcon3AudioEncoder(metaclass=DummyObject):
    _backends = ["torch"]
...
class Falcon3AudioForConditionalGeneration(metaclass=DummyObject):
    _backends = ["torch"]
...
class Falcon3AudioPreTrainedModel(metaclass=DummyObject):
    _backends = ["torch"]
