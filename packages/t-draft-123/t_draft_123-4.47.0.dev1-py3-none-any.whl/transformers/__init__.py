...
try:
    ...
    _import_structure["models.falcon3_vl"].extend(["Falcon3VLImageProcessor"])
...
try:
    ...
    _import_structure["models.falcon3_vl"].extend(
        [
...
if TYPE_CHECKING:
    ...
    try:
        ...
        from .models.falcon3_vl import Falcon3VLImageProcessor
