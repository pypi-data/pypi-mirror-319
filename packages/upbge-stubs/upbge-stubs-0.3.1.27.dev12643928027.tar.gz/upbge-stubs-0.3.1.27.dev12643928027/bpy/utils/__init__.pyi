...
def unregister_class(cls: typing.Type) -> None:
...
def register_tool(tool_cls: bpy.types.WorkSpaceTool, *args, after: typing.Any = None, separator: bool = False, group: bool = False) -> None:
