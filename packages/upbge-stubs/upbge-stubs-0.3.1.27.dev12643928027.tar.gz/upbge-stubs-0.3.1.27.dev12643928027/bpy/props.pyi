...
def CollectionProperty(type: bpy.types.PropertyGroup = None, *args, name: str = '', description: str = '', translation_context: str = '*args', options: typing.Any = {'ANIMATABLE'}, override: typing.Any = set(), tags: typing.Any = set()) -> None:
...
def PointerProperty(type: bpy.types.PropertyGroup = None, *args, name: str = '', description: str = '', translation_context: str = '*args', options: typing.Any = {'ANIMATABLE'}, override: typing.Any = set(), tags: typing.Any = set(), poll: typing.Any = None, update: typing.Any = None) -> None:
