...
class Fl(object):
    ...
    @staticmethod
    def reset_marked_text(*args):
        r"""reset_marked_text()"""
        return _fltk.Fl_reset_marked_text(*args)

    @staticmethod
    def insertion_point_location(*args):
        r"""insertion_point_location(int x, int y, int height)"""
        return _fltk.Fl_insertion_point_location(*args)
...
GL_SILENCE_DEPRECATION = _fltk.GL_SILENCE_DEPRECATION
