...
if TYPE_CHECKING:
    ...
    from mastapy._private.nodal_analysis.elmer import _186, _187
...
class _Cast_ElmerResults:
    ...
    def elmer_results_from_electromagnetic_analysis(
        self: "CastSelf",
    ) -> "_186.ElmerResultsFromElectromagneticAnalysis":
        from mastapy._private.nodal_analysis.elmer import _186

        return self.__parent__._cast(_186.ElmerResultsFromElectromagneticAnalysis)

    @property
    def elmer_results_from_mechanical_analysis(
        self: "CastSelf",
    ) -> "_187.ElmerResultsFromMechanicalAnalysis":
        from mastapy._private.nodal_analysis.elmer import _187

        return self.__parent__._cast(_187.ElmerResultsFromMechanicalAnalysis)
