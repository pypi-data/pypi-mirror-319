...
from mastapy._private.nodal_analysis.elmer.results import _193
...
class _Cast_Data3D:
    ...
    @property
    def data(self: "CastSelf") -> "_193.Data":
        return self.__parent__._cast(_193.Data)
