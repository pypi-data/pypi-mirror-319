...
if TYPE_CHECKING:
    ...
    from mastapy._private.nodal_analysis.dev_tools_analyses import _203
...
class CMSModel(_0.APIBase):
    ...
    def software_used_for_reduction(
        self: "Self",
    ) -> "_253.SoftwareUsedForReductionType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.nodal_analysis.component_mode_synthesis._253",
    ...
    @property
    def fe_model(self: "Self") -> "_203.FEModel":
    ...
    @property
    def reduction_information(self: "Self") -> "_1638.AnalysisRunInformation":
    ...
    @property
    def reduction_options(self: "Self") -> "_247.CMSOptions":
    ...
    @property
    def element_face_groups(self: "Self") -> "List[_243.CMSElementFaceGroup]":
