...
from mastapy._private.fe_tools.enums import _1291
...
class MaterialPropertiesReporting(_0.APIBase):
    ...
    def class_(self: "Self", value: "_1291.MaterialPropertyClass") -> None:
    ...
    def elastic_modulus_components(
        self: "Self",
    ) -> "_225.ElasticModulusOrthotropicComponents":
    ...
    def poissons_ratio_components(
        self: "Self",
    ) -> "_238.PoissonRatioOrthotropicComponents":
    ...
    def shear_modulus_components(
        self: "Self",
    ) -> "_240.ShearModulusOrthotropicComponents":
    ...
    def thermal_expansion_coefficient_components(
        self: "Self",
    ) -> "_241.ThermalExpansionOrthotropicComponents":
