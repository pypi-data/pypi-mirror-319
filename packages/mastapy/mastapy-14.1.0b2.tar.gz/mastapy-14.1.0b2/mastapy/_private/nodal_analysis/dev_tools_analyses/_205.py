...
class _Cast_FEModelHarmonicAnalysisDrawStyle:
    ...
    @property
    def fe_model_tab_draw_style(self: "CastSelf") -> "_211.FEModelTabDrawStyle":
        return self.__parent__._cast(_211.FEModelTabDrawStyle)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class FEModelHarmonicAnalysisDrawStyle(_211.FEModelTabDrawStyle):
    """FEModelHarmonicAnalysisDrawStyle
