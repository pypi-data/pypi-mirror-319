...
class _Cast_InternalTransientSolver:
    ...
    @property
    def transient_solver(self: "CastSelf") -> "_122.TransientSolver":
        return self.__parent__._cast(_122.TransientSolver)
    ...
    def wilson_theta_transient_solver(
        self: "CastSelf",
    ) -> "_123.WilsonThetaTransientSolver":
        from mastapy._private.nodal_analysis.system_solvers import _123

        return self.__parent__._cast(_123.WilsonThetaTransientSolver)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class InternalTransientSolver(_122.TransientSolver):
    """InternalTransientSolver
