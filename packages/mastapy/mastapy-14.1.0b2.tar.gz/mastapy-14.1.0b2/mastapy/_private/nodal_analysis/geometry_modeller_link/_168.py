...
if TYPE_CHECKING:
    ...
    from mastapy._private.nodal_analysis.geometry_modeller_link import _170
...
class GeometryModellerDimension(_0.APIBase):
    ...
    @property
    def type_(self: "Self") -> "_170.GeometryModellerDimensionType":
    ...
    def type_(self: "Self", value: "_170.GeometryModellerDimensionType") -> None:
