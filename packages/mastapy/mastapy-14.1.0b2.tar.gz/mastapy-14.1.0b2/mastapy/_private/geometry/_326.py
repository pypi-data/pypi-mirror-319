...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.drawing import _2315, _2321
...
class _Cast_DrawStyleBase:
    ...
    @property
    def contour_draw_style(self: "CastSelf") -> "_2315.ContourDrawStyle":
        from mastapy._private.system_model.drawing import _2315

        return self.__parent__._cast(_2315.ContourDrawStyle)
    ...
    def model_view_options_draw_style(
        ...
        return self.__parent__._cast(_2321.ModelViewOptionsDrawStyle)
    ...
    def cylindrical_gear_geometric_entity_draw_style(
        self: "CastSelf",
    ) -> "_4177.CylindricalGearGeometricEntityDrawStyle":
        from mastapy._private.system_model.analyses_and_results.power_flows import _4177

        return self.__parent__._cast(_4177.CylindricalGearGeometricEntityDrawStyle)

    @property
    def power_flow_draw_style(self: "CastSelf") -> "_4223.PowerFlowDrawStyle":
        from mastapy._private.system_model.analyses_and_results.power_flows import _4223

        return self.__parent__._cast(_4223.PowerFlowDrawStyle)
