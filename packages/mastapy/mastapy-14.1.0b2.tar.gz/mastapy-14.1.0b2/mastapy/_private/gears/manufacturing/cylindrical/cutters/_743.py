...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears import _351, _369
    from mastapy._private.gears.manufacturing.cylindrical.cutters import (
        _737,
        _739,
        _740,
    )
    from mastapy._private.gears.manufacturing.cylindrical.cutters.tangibles import _761
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CylindricalGearRackDesign(_744.CylindricalGearRealCutterDesign):
    """CylindricalGearRackDesign
    ...
    @property
    def worm_type(self: "Self") -> "_369.WormType":
        ...
        return constructor.new_from_mastapy("mastapy._private.gears._369", "WormType")(
            value
        )

    @worm_type.setter
    @enforce_parameter_types
    def worm_type(self: "Self", value: "_369.WormType") -> None:
