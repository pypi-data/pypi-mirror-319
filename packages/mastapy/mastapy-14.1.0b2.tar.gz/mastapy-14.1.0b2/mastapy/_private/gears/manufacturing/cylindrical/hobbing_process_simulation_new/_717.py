...
T = TypeVar("T", bound="_716.ProcessSimulationInput")
...
class _Cast_ProcessSimulationNew:
    ...
    def hobbing_process_simulation_new(
        self: "CastSelf",
    ) -> "_704.HobbingProcessSimulationNew":
        from mastapy._private.gears.manufacturing.cylindrical.hobbing_process_simulation_new import (
            _704,
        )

        return self.__parent__._cast(_704.HobbingProcessSimulationNew)

    @property
    def worm_grinding_process_simulation_new(
        self: "CastSelf",
    ) -> "_731.WormGrindingProcessSimulationNew":
        from mastapy._private.gears.manufacturing.cylindrical.hobbing_process_simulation_new import (
            _731,
        )

        return self.__parent__._cast(_731.WormGrindingProcessSimulationNew)
...
class ProcessSimulationNew(_0.APIBase, Generic[T]):
    ...
    @property
    def gear_tooth_shape_calculation(self: "Self") -> "_712.ProcessGearShape":
    ...
    @property
    def lead_calculation(self: "Self") -> "_713.ProcessLeadCalculation":
    ...
    @property
    def pitch_calculation(self: "Self") -> "_714.ProcessPitchCalculation":
    ...
    @property
    def profile_calculation(self: "Self") -> "_715.ProcessProfileCalculation":
    ...
    def total_modification_calculation(
        self: "Self",
    ) -> "_719.ProcessTotalModificationCalculation":
