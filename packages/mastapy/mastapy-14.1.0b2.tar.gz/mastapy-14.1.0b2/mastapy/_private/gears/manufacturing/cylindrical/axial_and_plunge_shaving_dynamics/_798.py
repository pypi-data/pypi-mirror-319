...
class _Cast_ShavingDynamicsCalculationForDesignedGears:
    ...
    def shaving_dynamics_calculation(
        self: "CastSelf",
    ) -> "_797.ShavingDynamicsCalculation":
        return self.__parent__._cast(_797.ShavingDynamicsCalculation)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ShavingDynamicsCalculationForDesignedGears(_797.ShavingDynamicsCalculation[T]):
    """ShavingDynamicsCalculationForDesignedGears
    ...
    @property
    def redressing_chart(self: "Self") -> "_1934.TwoDChartDefinition":
    ...
    @property
    def redressing(self: "Self") -> "_795.ShaverRedressing[T]":
