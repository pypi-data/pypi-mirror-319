...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class HobbingProcessTotalModificationCalculation(_697.HobbingProcessCalculation):
    """HobbingProcessTotalModificationCalculation
    ...
    @property
    def total_errors_chart_left_flank(self: "Self") -> "_1932.ThreeDChartDefinition":
    ...
    @property
    def total_errors_chart_right_flank(self: "Self") -> "_1932.ThreeDChartDefinition":
        """mastapy.utility_gui.charts.ThreeDChartDefinition
