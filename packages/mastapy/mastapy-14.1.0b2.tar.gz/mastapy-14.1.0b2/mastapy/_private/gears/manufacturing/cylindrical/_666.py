...
from mastapy._private.gears.manufacturing.cylindrical import _664, _668
...
class MicroGeometryInputsProfile(
    _664.MicroGeometryInputs[_668.ProfileModificationSegment]
):
    """MicroGeometryInputsProfile
    ...
    @property
    def profile_micro_geometry_range(self: "Self") -> "_1548.Range":
