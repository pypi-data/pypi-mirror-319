...
class _Cast_HobbingProcessSimulationInput:
    ...
    @property
    def process_simulation_input(self: "CastSelf") -> "_716.ProcessSimulationInput":
        return self.__parent__._cast(_716.ProcessSimulationInput)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class HobbingProcessSimulationInput(_716.ProcessSimulationInput):
    """HobbingProcessSimulationInput
    ...
    def process_method(self: "Self", value: "_689.ActiveProcessMethod") -> None:
    ...
    @property
    def hob_manufacture_error(self: "Self") -> "_707.HobManufactureError":
    ...
    @property
    def hob_resharpening_error(self: "Self") -> "_708.HobResharpeningError":
