...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.manufacturing.bevel import _810, _826
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ConicalMeshManufacturingAnalysis(_1271.GearMeshImplementationAnalysis):
    """ConicalMeshManufacturingAnalysis
    ...
    @property
    def tca(self: "Self") -> "_826.EaseOffBasedTCA":
    ...
    def meshed_gears(
        self: "Self",
    ) -> "List[_810.ConicalMeshedGearManufacturingAnalysis]":
