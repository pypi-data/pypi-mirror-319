...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class WormGrindingCutterCalculation(_725.WormGrindingProcessCalculation):
    """WormGrindingCutterCalculation
    ...
    @property
    def grinder_tooth_shape_chart(self: "Self") -> "_1934.TwoDChartDefinition":
    ...
    @property
    def input_gear_point_of_interest(self: "Self") -> "_684.PointOfInterest":
