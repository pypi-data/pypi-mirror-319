...
class _Cast_ShaverRedressing:
    ...
    @property
    def axial_shaver_redressing(self: "CastSelf") -> "_781.AxialShaverRedressing":
        from mastapy._private.gears.manufacturing.cylindrical.axial_and_plunge_shaving_dynamics import (
            _781,
        )

        return self.__parent__._cast(_781.AxialShaverRedressing)

    @property
    def plunge_shaver_redressing(self: "CastSelf") -> "_788.PlungeShaverRedressing":
        from mastapy._private.gears.manufacturing.cylindrical.axial_and_plunge_shaving_dynamics import (
            _788,
        )

        return self.__parent__._cast(_788.PlungeShaverRedressing)
