...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.manufacturing.cylindrical.cutters import _751, _752
...
class _Cast_MutableCommon:
    ...
    @property
    def mutable_curve(self: "CastSelf") -> "_751.MutableCurve":
        from mastapy._private.gears.manufacturing.cylindrical.cutters import _751

        return self.__parent__._cast(_751.MutableCurve)

    @property
    def mutable_fillet(self: "CastSelf") -> "_752.MutableFillet":
        from mastapy._private.gears.manufacturing.cylindrical.cutters import _752

        return self.__parent__._cast(_752.MutableFillet)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class MutableCommon(_734.CurveInLinkedList):
    """MutableCommon
    ...
    @section.setter
    @enforce_parameter_types
    def section(self: "Self", value: "_640.CutterFlankSections") -> None:
