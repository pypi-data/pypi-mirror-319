...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.manufacturing.cylindrical import _665, _666, _667
...
T = TypeVar("T", bound="_667.ModificationSegment")
...
class _Cast_MicroGeometryInputs:
    ...
    @property
    def micro_geometry_inputs_lead(self: "CastSelf") -> "_665.MicroGeometryInputsLead":
        from mastapy._private.gears.manufacturing.cylindrical import _665

        return self.__parent__._cast(_665.MicroGeometryInputsLead)

    @property
    def micro_geometry_inputs_profile(
        self: "CastSelf",
    ) -> "_666.MicroGeometryInputsProfile":
        from mastapy._private.gears.manufacturing.cylindrical import _666

        return self.__parent__._cast(_666.MicroGeometryInputsProfile)
