...
from mastapy._private.gears.manufacturing.cylindrical.plunge_shaving import _674
...
class _Cast_PlungeShaverOutputs:
    ...
    @property
    def real_plunge_shaver_outputs(self: "CastSelf") -> "_685.RealPlungeShaverOutputs":
        from mastapy._private.gears.manufacturing.cylindrical.plunge_shaving import _685

        return self.__parent__._cast(_685.RealPlungeShaverOutputs)

    @property
    def virtual_plunge_shaver_outputs(
        self: "CastSelf",
    ) -> "_688.VirtualPlungeShaverOutputs":
        from mastapy._private.gears.manufacturing.cylindrical.plunge_shaving import _688

        return self.__parent__._cast(_688.VirtualPlungeShaverOutputs)
...
class PlungeShaverOutputs(_0.APIBase):
    ...
    def chart(self: "Self", value: "_674.ChartType") -> None:
    ...
    @enforce_parameter_types
    def selected_flank(self: "Self", value: "_658.Flank") -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    @property
    def calculation_details(self: "Self") -> "_680.PlungeShaverGeneration":
