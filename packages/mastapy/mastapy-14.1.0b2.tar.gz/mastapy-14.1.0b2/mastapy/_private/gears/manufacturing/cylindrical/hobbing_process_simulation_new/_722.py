...
class _Cast_WormGrinderManufactureError:
    ...
    @property
    def rack_manufacture_error(self: "CastSelf") -> "_720.RackManufactureError":
        return self.__parent__._cast(_720.RackManufactureError)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class WormGrinderManufactureError(_720.RackManufactureError):
    """WormGrinderManufactureError
