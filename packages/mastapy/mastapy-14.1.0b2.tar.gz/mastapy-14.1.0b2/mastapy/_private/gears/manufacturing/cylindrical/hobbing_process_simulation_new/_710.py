...
class _Cast_MountingError:
    ...
    @property
    def gear_mounting_error(self: "CastSelf") -> "_696.GearMountingError":
        from mastapy._private.gears.manufacturing.cylindrical.hobbing_process_simulation_new import (
            _696,
        )

        return self.__parent__._cast(_696.GearMountingError)

    @property
    def rack_mounting_error(self: "CastSelf") -> "_721.RackMountingError":
        from mastapy._private.gears.manufacturing.cylindrical.hobbing_process_simulation_new import (
            _721,
        )

        return self.__parent__._cast(_721.RackMountingError)
