...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CylindricalGearShaper(_749.InvoluteCutterDesign):
    """CylindricalGearShaper
    ...
    @property
    def shaper_edge_type(self: "Self") -> "_1115.ShaperEdgeTypes":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears.gear_designs.cylindrical._1115", "ShaperEdgeTypes"
        )(value)

    @shaper_edge_type.setter
    @enforce_parameter_types
    def shaper_edge_type(self: "Self", value: "_1115.ShaperEdgeTypes") -> None:
