...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.manufacturing.bevel import _812, _814
...
class _Cast_ConicalMeshFlankMicroGeometryConfig:
    ...
    def conical_mesh_flank_manufacturing_config(
        ...
        return self.__parent__._cast(_812.ConicalMeshFlankManufacturingConfig)
    ...
    def conical_mesh_flank_nurbs_micro_geometry_config(
        ...
        return self.__parent__._cast(_814.ConicalMeshFlankNURBSMicroGeometryConfig)
