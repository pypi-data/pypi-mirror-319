...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.manufacturing.bevel.control_parameters import _848
...
class _Cast_ConicalMeshFlankManufacturingConfig:
    ...
    def conical_mesh_flank_micro_geometry_config(
        self: "CastSelf",
    ) -> "_813.ConicalMeshFlankMicroGeometryConfig":
        return self.__parent__._cast(_813.ConicalMeshFlankMicroGeometryConfig)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ConicalMeshFlankManufacturingConfig(_813.ConicalMeshFlankMicroGeometryConfig):
    """ConicalMeshFlankManufacturingConfig
    ...
    def control_parameters(
        self: "Self",
    ) -> "_848.ConicalGearManufacturingControlParameters":
    ...
    def specified_cradle_style_machine_settings(
        self: "Self",
    ) -> "_855.CradleStyleConicalMachineSettingsGenerated":
