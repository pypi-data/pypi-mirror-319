...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.materials import _605, _639
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class BevelGearMaterial(_616.GearMaterial):
    """BevelGearMaterial
    ...
    @property
    def sn_curve_definition(self: "Self") -> "_639.SNCurveDefinition":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears.materials._639", "SNCurveDefinition"
        )(value)

    @sn_curve_definition.setter
    @enforce_parameter_types
    def sn_curve_definition(self: "Self", value: "_639.SNCurveDefinition") -> None:
