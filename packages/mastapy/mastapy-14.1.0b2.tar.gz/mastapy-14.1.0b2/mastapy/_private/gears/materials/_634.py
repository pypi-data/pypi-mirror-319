...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.rating.cylindrical.plastic_vdi2736 import _514
    from mastapy._private.materials import _304, _305, _307
...
class PlasticSNCurve(_0.APIBase):
    ...
    @property
    def material(self: "Self") -> "_633.PlasticCylindricalGearMaterial":
