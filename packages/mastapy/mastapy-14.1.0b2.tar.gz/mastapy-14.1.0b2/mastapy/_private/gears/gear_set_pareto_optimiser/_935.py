...
if TYPE_CHECKING:
    ...
    from mastapy._private.utility.reporting_property_framework import _1851
...
class ChartInfoBase(_0.APIBase, Generic[TAnalysis, TCandidate]):
    ...
    @property
    def chart_type(self: "Self") -> "_1851.CustomChartType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.utility.reporting_property_framework._1851",
            "CustomChartType",
        )(value)
    ...
    def select_chart_type(
        self: "Self",
    ) -> "_1610.ParetoOptimisationStrategyChartInformation.ScatterOrBarChart":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.math_utility.optimisation.ParetoOptimisationStrategyChartInformation._1610",
    ...
    def select_chart_type(
        self: "Self",
        value: "_1610.ParetoOptimisationStrategyChartInformation.ScatterOrBarChart",
    ) -> None:
