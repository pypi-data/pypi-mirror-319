...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class StraightBevelGearSetParetoOptimiser(_943.GearSetParetoOptimiser):
    """StraightBevelGearSetParetoOptimiser
    ...
    @property
    def selected_candidate_geometry(self: "Self") -> "_995.StraightBevelGearSetDesign":
    ...
    def all_candidate_gear_sets(
        self: "Self",
    ) -> "List[_995.StraightBevelGearSetDesign]":
    ...
    @property
    def candidate_gear_sets(self: "Self") -> "List[_995.StraightBevelGearSetDesign]":
        """List[mastapy.gears.gear_designs.straight_bevel.StraightBevelGearSetDesign]
