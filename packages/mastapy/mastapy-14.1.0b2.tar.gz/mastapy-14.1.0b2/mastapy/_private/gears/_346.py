...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.gear_designs.cylindrical import _1052, _1123
    from mastapy._private.gears.rating.cylindrical import _473, _497
    from mastapy._private.materials import _275
...
class GearSetDesignGroup(_0.APIBase):
    ...
    def default_rough_toleranced_metal_measurement(
        self: "Self",
    ) -> "_1123.TolerancedMetalMeasurements":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears.gear_designs.cylindrical._1123",
    ...
    @enforce_parameter_types
    def default_rough_toleranced_metal_measurement(
        self: "Self", value: "_1123.TolerancedMetalMeasurements"
    ) -> None:
    ...
    @enforce_parameter_types
    def micro_geometry_model_for_simple_mesh_stiffness(
        self: "Self", value: "_355.MicroGeometryModel"
    ) -> None:
    ...
    def general_transmission_properties(
        self: "Self",
    ) -> "_275.GeneralTransmissionProperties":
    ...
    @property
    def settings(self: "Self") -> "_473.CylindricalGearDesignAndRatingSettingsItem":
