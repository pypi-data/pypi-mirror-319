...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.gear_designs.conical import _1216
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class KlingelnbergConicalGearSetDesign(_1204.ConicalGearSetDesign):
    """KlingelnbergConicalGearSetDesign
    ...
    @property
    def gear_finish(self: "Self") -> "_1216.KlingelnbergFinishingMethods":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears.gear_designs.conical._1216",
            "KlingelnbergFinishingMethods",
        )(value)

    @gear_finish.setter
    @enforce_parameter_types
    def gear_finish(self: "Self", value: "_1216.KlingelnbergFinishingMethods") -> None:
    ...
    @property
    def conical_meshes(self: "Self") -> "List[_1014.KlingelnbergConicalGearMeshDesign]":
    ...
    def klingelnberg_conical_meshes(
        self: "Self",
    ) -> "List[_1014.KlingelnbergConicalGearMeshDesign]":
        """List[mastapy.gears.gear_designs.klingelnberg_conical.KlingelnbergConicalGearMeshDesign]
