...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ISO132812013AccuracyGrader(_1190.ISO1328AccuracyGraderCommon):
    """ISO132812013AccuracyGrader
    ...
    @property
    def sector_pitch_tolerance(self: "Self") -> "_1192.OverridableTolerance":
        """mastapy.gears.gear_designs.cylindrical.accuracy_and_tolerances.OverridableTolerance
    ...
    @property
    def single_pitch_tolerance(self: "Self") -> "_1192.OverridableTolerance":
        """mastapy.gears.gear_designs.cylindrical.accuracy_and_tolerances.OverridableTolerance
