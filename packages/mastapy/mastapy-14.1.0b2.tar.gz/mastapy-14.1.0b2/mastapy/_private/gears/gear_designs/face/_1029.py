...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class FaceGearWheelDesign(_1021.FaceGearDesign):
    """FaceGearWheelDesign
    ...
    def face_width_and_diameters_specification_method(
        self: "Self",
    ) -> "_1022.FaceGearDiameterFaceWidthSpecificationMethod":
    ...
    @enforce_parameter_types
    def face_width_and_diameters_specification_method(
        self: "Self", value: "_1022.FaceGearDiameterFaceWidthSpecificationMethod"
    ) -> None:
