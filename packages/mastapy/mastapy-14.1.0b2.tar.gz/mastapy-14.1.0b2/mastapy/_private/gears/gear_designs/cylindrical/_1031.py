...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.gear_designs.cylindrical import _1075, _1096
...
class _Cast_BacklashSpecification:
    ...
    def relative_values_specification(
        self: "CastSelf",
    ) -> "_1108.RelativeValuesSpecification":
        pass

        return self.__parent__._cast(_1108.RelativeValuesSpecification)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class BacklashSpecification(_1108.RelativeValuesSpecification["BacklashSpecification"]):
    """BacklashSpecification
    ...
    @property
    def left_flank(self: "Self") -> "_1096.LinearBacklashSpecification":
    ...
    @property
    def right_flank(self: "Self") -> "_1096.LinearBacklashSpecification":
        """mastapy.gears.gear_designs.cylindrical.LinearBacklashSpecification
    ...
    @property
    def angular_backlash(self: "Self") -> "List[_1075.CylindricalMeshAngularBacklash]":
    ...
    @property
    def flanks(self: "Self") -> "List[_1096.LinearBacklashSpecification]":
    ...
    @property
    def both_flanks(self: "Self") -> "_1096.LinearBacklashSpecification":
        """mastapy.gears.gear_designs.cylindrical.LinearBacklashSpecification
