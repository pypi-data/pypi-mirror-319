...
class _Cast_CylindricalGearAbstractRack:
    ...
    def cylindrical_gear_basic_rack(
        self: "CastSelf",
    ) -> "_1046.CylindricalGearBasicRack":
        from mastapy._private.gears.gear_designs.cylindrical import _1046

        return self.__parent__._cast(_1046.CylindricalGearBasicRack)

    @property
    def cylindrical_gear_pinion_type_cutter(
        self: "CastSelf",
    ) -> "_1061.CylindricalGearPinionTypeCutter":
        from mastapy._private.gears.gear_designs.cylindrical import _1061

        return self.__parent__._cast(_1061.CylindricalGearPinionTypeCutter)
...
class CylindricalGearAbstractRack(_0.APIBase):
    ...
    @property
    def gear(self: "Self") -> "_1050.CylindricalGearDesign":
    ...
    @property
    def left_flank(self: "Self") -> "_1045.CylindricalGearAbstractRackFlank":
    ...
    @property
    def right_flank(self: "Self") -> "_1045.CylindricalGearAbstractRackFlank":
        """mastapy.gears.gear_designs.cylindrical.CylindricalGearAbstractRackFlank
    ...
    @property
    def shaper_for_agma_rating(self: "Self") -> "_745.CylindricalGearShaper":
    ...
    @property
    def flanks(self: "Self") -> "List[_1045.CylindricalGearAbstractRackFlank]":
    ...
    @property
    def both_flanks(self: "Self") -> "_1045.CylindricalGearAbstractRackFlank":
        """mastapy.gears.gear_designs.cylindrical.CylindricalGearAbstractRackFlank
