...
class TiffAnalysisSettings(
    _1646.IndependentReportablePropertiesBase["TiffAnalysisSettings"]
):
    """TiffAnalysisSettings
    ...
    @property
    def core_material_properties(self: "Self") -> "_1089.HardenedMaterialProperties":
    ...
    @property
    def surface_material_properties(self: "Self") -> "_1089.HardenedMaterialProperties":
        """mastapy.gears.gear_designs.cylindrical.HardenedMaterialProperties
