...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.gear_designs.hypoid import _1017, _1018
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class HypoidGearSetDesign(_1243.AGMAGleasonConicalGearSetDesign):
    """HypoidGearSetDesign
    ...
    @property
    def gears(self: "Self") -> "List[_1017.HypoidGearDesign]":
    ...
    @property
    def meshes(self: "Self") -> "List[_1018.HypoidGearMeshDesign]":
    ...
    @property
    def hypoid_meshes(self: "Self") -> "List[_1018.HypoidGearMeshDesign]":
        """List[mastapy.gears.gear_designs.hypoid.HypoidGearMeshDesign]
