...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.gear_designs.cylindrical import _1034, _1086
...
class GearSetManufacturingConfigurationSetup(_0.APIBase):
    ...
    def create_new_suitable_cutters(
        self: "Self",
    ) -> "_1034.CreateNewSuitableCutterOption":
    ...
    def create_new_suitable_cutters(
        self: "Self", value: "_1034.CreateNewSuitableCutterOption"
    ) -> None:
    ...
    @property
    def gears(self: "Self") -> "List[_1086.GearManufacturingConfigSetupViewModel]":
