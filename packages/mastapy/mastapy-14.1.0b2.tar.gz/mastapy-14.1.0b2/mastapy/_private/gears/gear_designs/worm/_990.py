...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.gear_designs.worm import _988, _989, _991, _992
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class WormGearMeshDesign(_981.GearMeshDesign):
    """WormGearMeshDesign
    ...
    @property
    def wheel(self: "Self") -> "_992.WormWheelDesign":
    ...
    @property
    def worm(self: "Self") -> "_988.WormDesign":
