...
class _Cast_ISO6336GeometryForShapedGears:
    ...
    @property
    def iso6336_geometry_base(self: "CastSelf") -> "_1093.ISO6336GeometryBase":
        return self.__parent__._cast(_1093.ISO6336GeometryBase)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ISO6336GeometryForShapedGears(_1093.ISO6336GeometryBase):
    """ISO6336GeometryForShapedGears
