...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.gear_designs.spiral_bevel import _1001, _1003, _1004
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class SpiralBevelGearMeshDesign(_1229.BevelGearMeshDesign):
    """SpiralBevelGearMeshDesign
    ...
    def spiral_bevel_meshed_gears(
        self: "Self",
    ) -> "List[_1004.SpiralBevelMeshedGearDesign]":
