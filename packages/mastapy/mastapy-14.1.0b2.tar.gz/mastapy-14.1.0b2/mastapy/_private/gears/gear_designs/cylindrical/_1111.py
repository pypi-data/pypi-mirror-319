...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.gear_designs.cylindrical import _1113, _1114
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class Scuffing(_1646.IndependentReportablePropertiesBase["Scuffing"]):
    """Scuffing
    ...
    @enforce_parameter_types
    def coefficient_of_friction_method_flash_temperature_method(
        self: "Self", value: "_1112.ScuffingCoefficientOfFrictionMethods"
    ) -> None:
    ...
    @enforce_parameter_types
    def scuffing_temperature_method_agma(
        self: "Self", value: "_1113.ScuffingTemperatureMethodsAGMA"
    ) -> None:
    ...
    def scuffing_temperature_method_iso(
        self: "Self",
    ) -> "_1114.ScuffingTemperatureMethodsISO":
    ...
    @enforce_parameter_types
    def scuffing_temperature_method_iso(
        self: "Self", value: "_1114.ScuffingTemperatureMethodsISO"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.Gears.GearDesigns.Cylindrical.ScuffingTemperatureMethodsISO",
