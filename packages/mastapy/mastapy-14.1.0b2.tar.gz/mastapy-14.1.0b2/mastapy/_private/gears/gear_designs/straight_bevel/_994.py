...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.gear_designs.straight_bevel import _993, _995, _996
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class StraightBevelGearMeshDesign(_1229.BevelGearMeshDesign):
    """StraightBevelGearMeshDesign
    ...
    def straight_bevel_meshed_gears(
        self: "Self",
    ) -> "List[_996.StraightBevelMeshedGearDesign]":
