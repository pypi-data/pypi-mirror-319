...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CylindricalGearProfileModification(_601.ProfileModification):
    """CylindricalGearProfileModification
    ...
    @property
    def profile_modification_chart(self: "Self") -> "_1934.TwoDChartDefinition":
    ...
    def profile_modification_for_customer_102cad(
        self: "Self",
    ) -> "_1170.ProfileModificationForCustomer102CAD":
