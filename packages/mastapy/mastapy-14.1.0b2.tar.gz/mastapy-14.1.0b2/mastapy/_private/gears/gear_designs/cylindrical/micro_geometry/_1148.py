...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.gear_designs.cylindrical import _1050, _1066, _1079
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CylindricalGearSetMicroGeometry(_1279.GearSetImplementationDetail):
    """CylindricalGearSetMicroGeometry
    ...
    def cylindrical_mesh_micro_geometries(
        self: "Self",
    ) -> "List[_1139.CylindricalGearMeshMicroGeometry]":
    ...
    def duplicate_and_add_to(
        self: "Self", gear_set_design: "_1066.CylindricalGearSetDesign"
    ) -> "CylindricalGearSetMicroGeometry":
        """mastapy.gears.gear_designs.cylindrical.micro_geometry.CylindricalGearSetMicroGeometry
    ...
    def duplicate_specifying_separate_micro_geometry_for_each_planet_and_add_to(
        self: "Self", gear_set_design: "_1079.CylindricalPlanetaryGearSetDesign"
    ) -> "_1279.GearSetImplementationDetail":
        """mastapy.gears.analysis.GearSetImplementationDetail
