...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.materials import _635
    from mastapy._private.gears.rating.hypoid import _460
    from mastapy._private.gears.rating.iso_10300 import _439, _447, _454
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class BevelHypoidGearRatingSettingsItem(_1895.NamedDatabaseItem):
    """BevelHypoidGearRatingSettingsItem
    ...
    @property
    def bevel_gear_rating_method(self: "Self") -> "_635.RatingMethods":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears.materials._635", "RatingMethods"
        )(value)

    @bevel_gear_rating_method.setter
    @enforce_parameter_types
    def bevel_gear_rating_method(self: "Self", value: "_635.RatingMethods") -> None:
    ...
    def bevel_general_load_factors_k_method(
        self: "Self",
    ) -> "_439.GeneralLoadFactorCalculationMethod":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears.rating._439", "GeneralLoadFactorCalculationMethod"
        )(value)

    @bevel_general_load_factors_k_method.setter
    @enforce_parameter_types
    def bevel_general_load_factors_k_method(
        self: "Self", value: "_439.GeneralLoadFactorCalculationMethod"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.Gears.Rating.Iso10300.GeneralLoadFactorCalculationMethod",
    ...
    def bevel_pitting_factor_calculation_method(
        self: "Self",
    ) -> "_454.PittingFactorCalculationMethod":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears.rating._454", "PittingFactorCalculationMethod"
        )(value)

    @bevel_pitting_factor_calculation_method.setter
    @enforce_parameter_types
    def bevel_pitting_factor_calculation_method(
        self: "Self", value: "_454.PittingFactorCalculationMethod"
    ) -> None:
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def hypoid_gear_rating_method(self: "Self") -> "_460.HypoidRatingMethod":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears.rating.hypoid._460", "HypoidRatingMethod"
        )(value)

    @hypoid_gear_rating_method.setter
    @enforce_parameter_types
    def hypoid_gear_rating_method(
        self: "Self", value: "_460.HypoidRatingMethod"
    ) -> None:
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def iso_rating_method_for_bevel_gears(self: "Self") -> "_447.ISO10300RatingMethod":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears.rating._447", "ISO10300RatingMethod"
        )(value)

    @iso_rating_method_for_bevel_gears.setter
    @enforce_parameter_types
    def iso_rating_method_for_bevel_gears(
        self: "Self", value: "_447.ISO10300RatingMethod"
    ) -> None:
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def iso_rating_method_for_hypoid_gears(self: "Self") -> "_447.ISO10300RatingMethod":
        """mastapy.gears.rating.isoISO10300RatingMethod"""
