...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CylindricalGearTableWithMGCharts(_1842.CustomTable):
    """CylindricalGearTableWithMGCharts
    ...
    @property
    def item_detail(self: "Self") -> "_1072.CylindricalGearTableMGItemDetail":
    ...
    @enforce_parameter_types
    def item_detail(
        self: "Self", value: "_1072.CylindricalGearTableMGItemDetail"
    ) -> None:
