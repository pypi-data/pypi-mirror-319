...
T = TypeVar("T", bound="_982.GearSetDesign")
...
class _Cast_GearSetCreationOptions:
    ...
    def cylindrical_gear_pair_creation_options(
        ...
        from mastapy._private.gears.gear_designs.creation_options import _1193

        return self.__parent__._cast(_1193.CylindricalGearPairCreationOptions)

    @property
    def hypoid_gear_set_creation_options(
        self: "CastSelf",
    ) -> "_1196.HypoidGearSetCreationOptions":
        from mastapy._private.gears.gear_designs.creation_options import _1196

        return self.__parent__._cast(_1196.HypoidGearSetCreationOptions)

    @property
    def spiral_bevel_gear_set_creation_options(
        self: "CastSelf",
    ) -> "_1197.SpiralBevelGearSetCreationOptions":
        from mastapy._private.gears.gear_designs.creation_options import _1197

        return self.__parent__._cast(_1197.SpiralBevelGearSetCreationOptions)
