...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.gear_designs.cylindrical import _1044, _1069
...
class CylindricalGearCuttingOptions(_0.APIBase):
    ...
    def geometry_specification_type(
        self: "Self", value: "_1088.GeometrySpecificationType"
    ) -> None:
    ...
    @property
    def cylindrical_gear_cutter(self: "Self") -> "_1044.CylindricalGearAbstractRack":
    ...
    def manufacturing_configuration_selection(
        self: "Self",
    ) -> "_1069.CylindricalGearSetManufacturingConfigurationSelection":
