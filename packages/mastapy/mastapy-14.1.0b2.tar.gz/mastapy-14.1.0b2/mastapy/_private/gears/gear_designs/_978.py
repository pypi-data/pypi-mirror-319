...
if TYPE_CHECKING:
    ...
    from mastapy._private.utility.property import _1902
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class DesignConstraintsCollection(_1895.NamedDatabaseItem):
    """DesignConstraintsCollection
    ...
    def design_constraints(
        self: "Self",
    ) -> "List[_1902.DeletableCollectionMember[_976.DesignConstraint]]":
