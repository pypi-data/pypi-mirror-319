...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.gear_designs.cylindrical import _1081, _1082
...
class DIN3967SystemOfGearFits(_0.APIBase):
    ...
    def tooth_thickness_reduction_allowance(
        self: "Self", value: "_1081.DIN3967AllowanceSeries"
    ) -> None:
    ...
    @property
    def tooth_thickness_tolerance(self: "Self") -> "_1082.DIN3967ToleranceSeries":
    ...
    def tooth_thickness_tolerance(
        self: "Self", value: "_1082.DIN3967ToleranceSeries"
    ) -> None:
        value = conversion.mp_to_pn_enum(
