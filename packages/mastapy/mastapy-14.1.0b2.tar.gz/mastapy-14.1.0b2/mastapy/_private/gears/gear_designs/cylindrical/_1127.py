...
from mastapy._private.utility.units_and_measurements.measurements import _1728, _1749
...
class ToothThicknessSpecificationBase(_0.APIBase):
    ...
    def chordal_span(
        self: "Self",
    ) -> "_1074.CylindricalGearToothThicknessSpecification[_1728.LengthShort]":
    ...
    def profile_shift_coefficient(
        self: "Self",
    ) -> "_1074.CylindricalGearToothThicknessSpecification[_1749.Number]":
    ...
    def tooth_thickness(
        self: "Self",
    ) -> "List[_1074.CylindricalGearToothThicknessSpecification[_1728.LengthShort]]":
