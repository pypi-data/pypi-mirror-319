...
class _Cast_CylindricalGearSetMacroGeometryOptimiser:
    ...
    @property
    def gear_set_optimiser(self: "CastSelf") -> "_350.GearSetOptimiser":
        return self.__parent__._cast(_350.GearSetOptimiser)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CylindricalGearSetMacroGeometryOptimiser(_350.GearSetOptimiser):
    """CylindricalGearSetMacroGeometryOptimiser
