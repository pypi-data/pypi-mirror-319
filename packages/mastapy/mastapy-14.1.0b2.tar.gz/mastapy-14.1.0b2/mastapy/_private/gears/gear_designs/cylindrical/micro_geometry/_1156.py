...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class LeadModificationForCustomer102CAD(_1167.ModificationForCustomer102CAD):
    """LeadModificationForCustomer102CAD
    ...
    @property
    def lead_with_variation(self: "Self") -> "_1934.TwoDChartDefinition":
    ...
    def lead_relief_points_for_customer_102(
        self: "Self",
    ) -> "List[_1157.LeadReliefSpecificationForCustomer102]":
