...
class _Cast_CylindricalGearAbstractRackFlank:
    ...
    def cylindrical_gear_basic_rack_flank(
        self: "CastSelf",
    ) -> "_1047.CylindricalGearBasicRackFlank":
        from mastapy._private.gears.gear_designs.cylindrical import _1047

        return self.__parent__._cast(_1047.CylindricalGearBasicRackFlank)

    @property
    def cylindrical_gear_pinion_type_cutter_flank(
        self: "CastSelf",
    ) -> "_1062.CylindricalGearPinionTypeCutterFlank":
        from mastapy._private.gears.gear_designs.cylindrical import _1062

        return self.__parent__._cast(_1062.CylindricalGearPinionTypeCutterFlank)

    @property
    def standard_rack_flank(self: "CastSelf") -> "_1118.StandardRackFlank":
        from mastapy._private.gears.gear_designs.cylindrical import _1118

        return self.__parent__._cast(_1118.StandardRackFlank)
...
class CylindricalGearAbstractRackFlank(_0.APIBase):
    ...
    @property
    def cutter(self: "Self") -> "_1044.CylindricalGearAbstractRack":
