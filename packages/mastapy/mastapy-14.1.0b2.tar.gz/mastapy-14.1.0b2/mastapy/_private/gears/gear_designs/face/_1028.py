...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.gear_designs.face import _1024, _1025, _1027
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class FaceGearSetMicroGeometry(_1279.GearSetImplementationDetail):
    """FaceGearSetMicroGeometry
    ...
    def face_mesh_micro_geometries(
        self: "Self",
    ) -> "List[_1024.FaceGearMeshMicroGeometry]":
