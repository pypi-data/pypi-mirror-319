...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.gear_designs.conical.micro_geometry import _1221
...
class _Cast_FlankMicroGeometry:
    ...
    def cylindrical_gear_flank_micro_geometry(
        self: "CastSelf",
    ) -> "_1136.CylindricalGearFlankMicroGeometry":
        from mastapy._private.gears.gear_designs.cylindrical.micro_geometry import _1136

        return self.__parent__._cast(_1136.CylindricalGearFlankMicroGeometry)

    @property
    def conical_gear_flank_micro_geometry(
        self: "CastSelf",
    ) -> "_1221.ConicalGearFlankMicroGeometry":
        from mastapy._private.gears.gear_designs.conical.micro_geometry import _1221

        return self.__parent__._cast(_1221.ConicalGearFlankMicroGeometry)
...
class FlankMicroGeometry(_0.APIBase):
    ...
    @property
    def gear_design(self: "Self") -> "_979.GearDesign":
