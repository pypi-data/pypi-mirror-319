...
from mastapy._private.gears.micro_geometry import _592, _593, _594, _595, _598
...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.micro_geometry import _596, _597, _599, _600
...
class _Cast_ProfileModification:
    ...
    @property
    def modification(self: "CastSelf") -> "_598.Modification":
        return self.__parent__._cast(_598.Modification)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ProfileModification(_598.Modification):
    """ProfileModification
    ...
    @property
    def measured_data(self: "Self") -> "_1594.Vector2DListAccessor":
    ...
    @enforce_parameter_types
    def measured_data(self: "Self", value: "_1594.Vector2DListAccessor") -> None:
