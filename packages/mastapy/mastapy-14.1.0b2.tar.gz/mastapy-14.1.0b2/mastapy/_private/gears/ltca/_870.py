...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.ltca import _861, _868
...
class _Cast_GearFilletNodeStressResultsRow:
    ...
    def cylindrical_gear_fillet_node_stress_results_row(
        self: "CastSelf",
    ) -> "_861.CylindricalGearFilletNodeStressResultsRow":
        from mastapy._private.gears.ltca import _861

        return self.__parent__._cast(_861.CylindricalGearFilletNodeStressResultsRow)
