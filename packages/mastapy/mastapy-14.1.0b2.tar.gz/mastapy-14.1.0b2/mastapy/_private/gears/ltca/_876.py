...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.ltca import _857, _862, _869, _870
...
class _Cast_GearRootFilletStressResults:
    ...
    def conical_gear_root_fillet_stress_results(
        self: "CastSelf",
    ) -> "_857.ConicalGearRootFilletStressResults":
        from mastapy._private.gears.ltca import _857

        return self.__parent__._cast(_857.ConicalGearRootFilletStressResults)

    @property
    def cylindrical_gear_root_fillet_stress_results(
        self: "CastSelf",
    ) -> "_862.CylindricalGearRootFilletStressResults":
        from mastapy._private.gears.ltca import _862

        return self.__parent__._cast(_862.CylindricalGearRootFilletStressResults)
...
class GearRootFilletStressResults(_0.APIBase):
    ...
    @property
    def columns(self: "Self") -> "List[_869.GearFilletNodeStressResultsColumn]":
    ...
    @property
    def rows(self: "Self") -> "List[_870.GearFilletNodeStressResultsRow]":
