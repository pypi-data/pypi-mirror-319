...
class _Cast_CylindricalMeshLoadDistributionAtRotation:
    ...
    def gear_mesh_load_distribution_at_rotation(
        self: "CastSelf",
    ) -> "_873.GearMeshLoadDistributionAtRotation":
        return self.__parent__._cast(_873.GearMeshLoadDistributionAtRotation)
...
class CylindricalMeshLoadDistributionAtRotation(
    ...
    @property
    def mesh_alignment(self: "Self") -> "_1162.MeshAlignment":
    ...
    def loaded_contact_lines(
        self: "Self",
    ) -> "List[_889.CylindricalGearMeshLoadedContactLine]":
