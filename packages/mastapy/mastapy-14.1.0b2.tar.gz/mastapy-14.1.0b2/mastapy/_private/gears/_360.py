...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class PocketingPowerLossCoefficients(_1895.NamedDatabaseItem):
    """PocketingPowerLossCoefficients
    ...
    def extrapolation_options(
        self: "Self", value: "_1569.ExtrapolationOptions"
    ) -> None:
    ...
    def specifications_for_the_effect_of_oil_kinematic_viscosity(
        self: "Self",
    ) -> "List[_364.SpecificationForTheEffectOfOilKinematicViscosity]":
