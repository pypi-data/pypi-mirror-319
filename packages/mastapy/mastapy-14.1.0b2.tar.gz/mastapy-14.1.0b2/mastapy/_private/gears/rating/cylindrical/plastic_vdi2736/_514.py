...
from mastapy._private.gears.materials import _634
...
if TYPE_CHECKING:
    ...
    from mastapy._private.materials import _307
...
class _Cast_PlasticSNCurveForTheSpecifiedOperatingConditions:
    ...
    @property
    def plastic_sn_curve(self: "CastSelf") -> "_634.PlasticSNCurve":
        return self.__parent__._cast(_634.PlasticSNCurve)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class PlasticSNCurveForTheSpecifiedOperatingConditions(_634.PlasticSNCurve):
    """PlasticSNCurveForTheSpecifiedOperatingConditions
    ...
    @property
    def lubricant(self: "Self") -> "_307.VDI2736LubricantType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.materials._307", "VDI2736LubricantType"
        )(value)

    @lubricant.setter
    @enforce_parameter_types
    def lubricant(self: "Self", value: "_307.VDI2736LubricantType") -> None:
