...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.rating.face import _466, _467
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class FaceGearSetRating(_382.GearSetRating):
    """FaceGearSetRating
    ...
    @property
    def face_gear_set(self: "Self") -> "_1027.FaceGearSetDesign":
    ...
    @property
    def gear_ratings(self: "Self") -> "List[_467.FaceGearRating]":
    ...
    @property
    def gear_mesh_ratings(self: "Self") -> "List[_466.FaceGearMeshRating]":
    ...
    @property
    def face_mesh_ratings(self: "Self") -> "List[_466.FaceGearMeshRating]":
        """List[mastapy.gears.rating.face.FaceGearMeshRating]
