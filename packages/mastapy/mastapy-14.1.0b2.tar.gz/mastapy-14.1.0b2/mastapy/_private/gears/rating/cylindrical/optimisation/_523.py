...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.rating import _387
...
class _Cast_SafetyFactorOptimisationStepResult:
    ...
    def safety_factor_optimisation_step_result_angle(
        ...
        from mastapy._private.gears.rating.cylindrical.optimisation import _524

        return self.__parent__._cast(_524.SafetyFactorOptimisationStepResultAngle)

    @property
    def safety_factor_optimisation_step_result_number(
        self: "CastSelf",
    ) -> "_525.SafetyFactorOptimisationStepResultNumber":
        from mastapy._private.gears.rating.cylindrical.optimisation import _525

        return self.__parent__._cast(_525.SafetyFactorOptimisationStepResultNumber)

    @property
    def safety_factor_optimisation_step_result_short_length(
        self: "CastSelf",
    ) -> "_526.SafetyFactorOptimisationStepResultShortLength":
        from mastapy._private.gears.rating.cylindrical.optimisation import _526

        return self.__parent__._cast(_526.SafetyFactorOptimisationStepResultShortLength)
...
class SafetyFactorOptimisationStepResult(_0.APIBase):
    ...
    @property
    def normalised_safety_factors(self: "Self") -> "_387.SafetyFactorResults":
    ...
    @property
    def safety_factors(self: "Self") -> "_387.SafetyFactorResults":
        """mastapy.gears.rating.SafetyFactorResults
