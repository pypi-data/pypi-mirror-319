...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.rating.cylindrical.iso6336 import _527, _528, _534, _536
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ISO63362006GearSingleFlankRating(_538.ISO6336AbstractMetalGearSingleFlankRating):
    """ISO63362006GearSingleFlankRating
    ...
    def tooth_fatigue_fracture_results(
        self: "Self",
    ) -> "_527.CylindricalGearToothFatigueFractureResults":
    ...
    def tooth_fatigue_fracture_results_according_to_french_proposal(
        self: "Self",
    ) -> "_528.CylindricalGearToothFatigueFractureResultsN1457":
