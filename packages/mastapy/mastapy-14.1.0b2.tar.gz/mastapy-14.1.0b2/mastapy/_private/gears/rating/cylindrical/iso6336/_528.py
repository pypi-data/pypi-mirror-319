...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.rating.cylindrical.iso6336 import _546, _549
...
class CylindricalGearToothFatigueFractureResultsN1457(_0.APIBase):
    ...
    @property
    def fatigue_damage_chart(self: "Self") -> "_1932.ThreeDChartDefinition":
    ...
    @property
    def critical_section(self: "Self") -> "_549.ToothFlankFractureAnalysisRowN1457":
    ...
    def mesh_contact_point_a_section(
        self: "Self",
    ) -> "_549.ToothFlankFractureAnalysisRowN1457":
        """mastapy.gears.rating.cylindrical.iso6336.ToothFlankFractureAnalysisRowN1457
    ...
    def mesh_contact_point_ab_section(
        self: "Self",
    ) -> "_546.ToothFlankFractureAnalysisContactPointN1457":
    ...
    @property
    def analysis_rows(self: "Self") -> "List[_549.ToothFlankFractureAnalysisRowN1457]":
    ...
    def contact_points(
        self: "Self",
    ) -> "List[_546.ToothFlankFractureAnalysisContactPointN1457]":
