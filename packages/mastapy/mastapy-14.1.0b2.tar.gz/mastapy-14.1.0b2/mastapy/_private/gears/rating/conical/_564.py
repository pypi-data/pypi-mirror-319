...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.rating.straight_bevel_diff import _420
...
class _Cast_ConicalMeshedGearRating:
    ...
    def straight_bevel_diff_meshed_gear_rating(
        self: "CastSelf",
    ) -> "_420.StraightBevelDiffMeshedGearRating":
        from mastapy._private.gears.rating.straight_bevel_diff import _420

        return self.__parent__._cast(_420.StraightBevelDiffMeshedGearRating)
...
class ConicalMeshedGearRating(_0.APIBase):
    ...
    @property
    def active_flank(self: "Self") -> "_1200.ConicalFlanks":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears.gear_designs.conical._1200", "ConicalFlanks"
        )(value)
