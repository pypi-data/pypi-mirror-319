...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.rating.straight_bevel_diff import _418, _420
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class StraightBevelDiffGearMeshRating(_558.ConicalGearMeshRating):
    """StraightBevelDiffGearMeshRating
    ...
    @property
    def meshed_gears(self: "Self") -> "List[_420.StraightBevelDiffMeshedGearRating]":
    ...
    @property
    def gears_in_mesh(self: "Self") -> "List[_420.StraightBevelDiffMeshedGearRating]":
        """List[mastapy.gears.rating.straight_bevel_diff.StraightBevelDiffMeshedGearRating]
