...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.rating.cylindrical import _470, _493, _504
...
class _Cast_ScuffingResultsRow:
    ...
    @property
    def agma_scuffing_results_row(self: "CastSelf") -> "_470.AGMAScuffingResultsRow":
        from mastapy._private.gears.rating.cylindrical import _470

        return self.__parent__._cast(_470.AGMAScuffingResultsRow)

    @property
    def iso_scuffing_results_row(self: "CastSelf") -> "_493.ISOScuffingResultsRow":
        from mastapy._private.gears.rating.cylindrical import _493

        return self.__parent__._cast(_493.ISOScuffingResultsRow)
...
class ScuffingResultsRow(_0.APIBase):
    ...
    @property
    def pinion(self: "Self") -> "_504.ScuffingResultsRowGear":
