...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.rating.cylindrical import _475, _476
...
class _Cast_GearFlankRating:
    ...
    def cylindrical_gear_flank_duty_cycle_rating(
        self: "CastSelf",
    ) -> "_475.CylindricalGearFlankDutyCycleRating":
        from mastapy._private.gears.rating.cylindrical import _475

        return self.__parent__._cast(_475.CylindricalGearFlankDutyCycleRating)

    @property
    def cylindrical_gear_flank_rating(
        self: "CastSelf",
    ) -> "_476.CylindricalGearFlankRating":
        from mastapy._private.gears.rating.cylindrical import _476

        return self.__parent__._cast(_476.CylindricalGearFlankRating)
