...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.rating.cylindrical.iso6336 import _550
...
class ToothFlankFractureAnalysisPointN1457(_0.APIBase):
    ...
    def stress_analysis_with_maximum_equivalent_stress(
        self: "Self",
    ) -> "_550.ToothFlankFractureStressStepAtAnalysisPointN1457":
    ...
    def stress_history(
        self: "Self",
    ) -> "List[_550.ToothFlankFractureStressStepAtAnalysisPointN1457]":
