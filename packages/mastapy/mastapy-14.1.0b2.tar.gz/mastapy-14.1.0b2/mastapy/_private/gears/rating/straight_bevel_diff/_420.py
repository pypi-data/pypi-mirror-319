...
class _Cast_StraightBevelDiffMeshedGearRating:
    ...
    @property
    def conical_meshed_gear_rating(self: "CastSelf") -> "_564.ConicalMeshedGearRating":
        return self.__parent__._cast(_564.ConicalMeshedGearRating)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class StraightBevelDiffMeshedGearRating(_564.ConicalMeshedGearRating):
    """StraightBevelDiffMeshedGearRating
