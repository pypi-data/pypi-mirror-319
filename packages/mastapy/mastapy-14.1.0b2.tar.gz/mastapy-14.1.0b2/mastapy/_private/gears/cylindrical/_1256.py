...
from mastapy._private.gears.cylindrical import _1260
...
class _Cast_CylindricalGearLTCAContactChartDataAsTextFile:
    ...
    def gear_ltca_contact_chart_data_as_text_file(
        self: "CastSelf",
    ) -> "_1260.GearLTCAContactChartDataAsTextFile":
        return self.__parent__._cast(_1260.GearLTCAContactChartDataAsTextFile)
