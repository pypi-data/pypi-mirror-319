...
from mastapy._private.gears.cylindrical import _1261
...
class _Cast_CylindricalGearLTCAContactCharts:
    ...
    @property
    def gear_ltca_contact_charts(self: "CastSelf") -> "_1261.GearLTCAContactCharts":
        return self.__parent__._cast(_1261.GearLTCAContactCharts)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CylindricalGearLTCAContactCharts(_1261.GearLTCAContactCharts):
    """CylindricalGearLTCAContactCharts
