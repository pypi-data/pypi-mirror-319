...
if TYPE_CHECKING:
    ...
    from mastapy._private.math_utility.convergence import _1634
...
class _Cast_DataLogger:
    ...
    @property
    def convergence_logger(self: "CastSelf") -> "_1634.ConvergenceLogger":
        from mastapy._private.math_utility.convergence import _1634

        return self.__parent__._cast(_1634.ConvergenceLogger)

    @property
    def data_logger_with_charts(self: "CastSelf") -> "_1917.DataLoggerWithCharts":
        from mastapy._private.utility_gui import _1917

        return self.__parent__._cast(_1917.DataLoggerWithCharts)
