...
class _Cast_GenericMatrix:
    ...
    @property
    def complex_matrix(self: "CastSelf") -> "_1553.ComplexMatrix":
        from mastapy._private.math_utility import _1553

        return self.__parent__._cast(_1553.ComplexMatrix)

    @property
    def complex_vector(self: "CastSelf") -> "_1555.ComplexVector":
        from mastapy._private.math_utility import _1555

        return self.__parent__._cast(_1555.ComplexVector)

    @property
    def complex_vector_3d(self: "CastSelf") -> "_1556.ComplexVector3D":
        from mastapy._private.math_utility import _1556

        return self.__parent__._cast(_1556.ComplexVector3D)

    @property
    def complex_vector_6d(self: "CastSelf") -> "_1557.ComplexVector6D":
        from mastapy._private.math_utility import _1557

        return self.__parent__._cast(_1557.ComplexVector6D)

    @property
    def euler_parameters(self: "CastSelf") -> "_1568.EulerParameters":
        from mastapy._private.math_utility import _1568

        return self.__parent__._cast(_1568.EulerParameters)

    @property
    def quaternion(self: "CastSelf") -> "_1583.Quaternion":
        from mastapy._private.math_utility import _1583

        return self.__parent__._cast(_1583.Quaternion)
    ...
    @property
    def real_vector(self: "CastSelf") -> "_1585.RealVector":
        from mastapy._private.math_utility import _1585

        return self.__parent__._cast(_1585.RealVector)

    @property
    def square_matrix(self: "CastSelf") -> "_1590.SquareMatrix":
        from mastapy._private.math_utility import _1590

        return self.__parent__._cast(_1590.SquareMatrix)

    @property
    def vector_6d(self: "CastSelf") -> "_1595.Vector6D":
        from mastapy._private.math_utility import _1595

        return self.__parent__._cast(_1595.Vector6D)
