...
if TYPE_CHECKING:
    ...
    from mastapy._private.math_utility.measured_data_scaling import _1629
...
class DataScalingOptions(_0.APIBase):
    ...
    def dynamic_scaling(self: "Self", value: "_1565.DynamicsResponseScaling") -> None:
    ...
    @property
    def weighting(self: "Self") -> "_1549.AcousticWeighting":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.math_utility._1549", "AcousticWeighting"
        )(value)

    @weighting.setter
    @enforce_parameter_types
    def weighting(self: "Self", value: "_1549.AcousticWeighting") -> None:
    ...
    def acceleration_reference_values(
        self: "Self",
    ) -> "_1629.DataScalingReferenceValues[_1673.Acceleration]":
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_1673.Acceleration](temp)

    @property
    def angle_reference_values(
        self: "Self",
    ) -> "_1629.DataScalingReferenceValues[_1674.Angle]":
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_1674.Angle](temp)

    @property
    def angular_acceleration_reference_values(
        self: "Self",
    ) -> "_1629.DataScalingReferenceValues[_1678.AngularAcceleration]":
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_1678.AngularAcceleration](
            temp
        )
    ...
    def angular_velocity_reference_values(
        self: "Self",
    ) -> "_1629.DataScalingReferenceValues[_1682.AngularVelocity]":
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_1682.AngularVelocity](temp)

    @property
    def damage_rate(
        self: "Self",
    ) -> "_1629.DataScalingReferenceValues[_1690.DamageRate]":
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_1690.DamageRate](temp)

    @property
    def energy_reference_values(
        self: "Self",
    ) -> "_1629.DataScalingReferenceValues[_1697.Energy]":
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_1697.Energy](temp)

    @property
    def force_reference_values(
        self: "Self",
    ) -> "_1629.DataScalingReferenceValues[_1703.Force]":
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_1703.Force](temp)

    @property
    def frequency_reference_values(
        self: "Self",
    ) -> "_1629.DataScalingReferenceValues[_1709.Frequency]":
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_1709.Frequency](temp)

    @property
    def linear_stiffness_reference_values(
        self: "Self",
    ) -> "_1629.DataScalingReferenceValues[_1737.LinearStiffness]":
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_1737.LinearStiffness](temp)

    @property
    def mass_per_unit_time_reference_values(
        self: "Self",
    ) -> "_1629.DataScalingReferenceValues[_1745.MassPerUnitTime]":
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_1745.MassPerUnitTime](temp)

    @property
    def medium_length_reference_values(
        self: "Self",
    ) -> "_1629.DataScalingReferenceValues[_1726.LengthMedium]":
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_1726.LengthMedium](temp)

    @property
    def percentage(
        self: "Self",
    ) -> "_1629.DataScalingReferenceValues[_1750.Percentage]":
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_1750.Percentage](temp)

    @property
    def power_reference_values(
        self: "Self",
    ) -> "_1629.DataScalingReferenceValues[_1751.Power]":
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_1751.Power](temp)

    @property
    def power_small_per_unit_area_reference_values(
        self: "Self",
    ) -> "_1629.DataScalingReferenceValues[_1755.PowerSmallPerArea]":
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_1755.PowerSmallPerArea](
            temp
        )
    ...
    def power_small_reference_values(
        self: "Self",
    ) -> "_1629.DataScalingReferenceValues[_1754.PowerSmall]":
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_1754.PowerSmall](temp)

    @property
    def pressure_reference_values(
        self: "Self",
    ) -> "_1629.DataScalingReferenceValues[_1762.PressureSmall]":
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_1762.PressureSmall](temp)

    @property
    def safety_factor(
        self: "Self",
    ) -> "_1629.DataScalingReferenceValues[_1771.SafetyFactor]":
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_1771.SafetyFactor](temp)

    @property
    def short_length_reference_values(
        self: "Self",
    ) -> "_1629.DataScalingReferenceValues[_1728.LengthShort]":
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_1728.LengthShort](temp)

    @property
    def short_time_reference_values(
        self: "Self",
    ) -> "_1629.DataScalingReferenceValues[_1785.TimeShort]":
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_1785.TimeShort](temp)

    @property
    def small_angle_reference_values(
        self: "Self",
    ) -> "_1629.DataScalingReferenceValues[_1676.AngleSmall]":
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_1676.AngleSmall](temp)

    @property
    def small_energy_reference_values(
        self: "Self",
    ) -> "_1629.DataScalingReferenceValues[_1700.EnergySmall]":
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_1700.EnergySmall](temp)

    @property
    def small_velocity_reference_values(
        self: "Self",
    ) -> "_1629.DataScalingReferenceValues[_1794.VelocitySmall]":
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_1794.VelocitySmall](temp)

    @property
    def stress_reference_values(
        self: "Self",
    ) -> "_1629.DataScalingReferenceValues[_1776.Stress]":
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_1776.Stress](temp)

    @property
    def temperature_reference_values(
        self: "Self",
    ) -> "_1629.DataScalingReferenceValues[_1777.Temperature]":
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_1777.Temperature](temp)

    @property
    def torque_converter_inverse_k(
        self: "Self",
    ) -> "_1629.DataScalingReferenceValues[_1788.TorqueConverterInverseK]":
        ...
        return constructor.new(type_.Namespace, type_.Name)[
            _1788.TorqueConverterInverseK
        ](temp)

    @property
    def torque_converter_k(
        self: "Self",
    ) -> "_1629.DataScalingReferenceValues[_1789.TorqueConverterK]":
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_1789.TorqueConverterK](
            temp
        )
    ...
    def torque_reference_values(
        self: "Self",
    ) -> "_1629.DataScalingReferenceValues[_1787.Torque]":
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_1787.Torque](temp)

    @property
    def unmeasureable(self: "Self") -> "_1629.DataScalingReferenceValues[_1749.Number]":
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_1749.Number](temp)

    @property
    def velocity_reference_values(
        self: "Self",
    ) -> "_1629.DataScalingReferenceValues[_1793.Velocity]":
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_1793.Velocity](temp)

    @property
    def very_short_length_reference_values(
        self: "Self",
    ) -> "_1629.DataScalingReferenceValues[_1731.LengthVeryShort]":
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_1731.LengthVeryShort](temp)

    @property
    def very_short_time_reference_values(
        self: "Self",
    ) -> "_1629.DataScalingReferenceValues[_1786.TimeVeryShort]":
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_1786.TimeVeryShort](temp)

    @property
    def very_small_angle_reference_values(
        self: "Self",
    ) -> "_1629.DataScalingReferenceValues[_1677.AngleVerySmall]":
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_1677.AngleVerySmall](temp)
