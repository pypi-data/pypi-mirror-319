...
from mastapy._private.math_utility.measured_data_scaling import _1630
...
class _Cast_DataScalingReferenceValues:
    ...
    def data_scaling_reference_values_base(
        self: "CastSelf",
    ) -> "_1630.DataScalingReferenceValuesBase":
        return self.__parent__._cast(_1630.DataScalingReferenceValuesBase)
...
class DataScalingReferenceValues(
    _1630.DataScalingReferenceValuesBase, Generic[TMeasurement]
):
    """DataScalingReferenceValues
