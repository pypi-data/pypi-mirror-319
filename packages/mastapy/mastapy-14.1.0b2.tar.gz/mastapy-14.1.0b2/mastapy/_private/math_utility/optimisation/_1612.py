...
from mastapy._private.math_utility.optimisation import _1613
...
if TYPE_CHECKING:
    ...
    from mastapy._private.math_utility.optimisation import _1606, _1607, _1614
...
class _Cast_ParetoOptimisationVariable:
    ...
    def pareto_optimisation_variable_base(
        self: "CastSelf",
    ) -> "_1613.ParetoOptimisationVariableBase":
        return self.__parent__._cast(_1613.ParetoOptimisationVariableBase)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ParetoOptimisationVariable(_1613.ParetoOptimisationVariableBase):
    """ParetoOptimisationVariable
    ...
    def property_target_for_dominant_candidate_search(
        self: "Self",
    ) -> "_1614.PropertyTargetForDominantCandidateSearch":
    ...
    def property_target_for_dominant_candidate_search(
        self: "Self", value: "_1614.PropertyTargetForDominantCandidateSearch"
    ) -> None:
