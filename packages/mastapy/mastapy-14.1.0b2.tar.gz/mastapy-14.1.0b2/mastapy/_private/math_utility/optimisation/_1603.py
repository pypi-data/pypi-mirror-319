...
class _Cast_OptimizationInput:
    ...
    @property
    def optimization_variable(self: "CastSelf") -> "_1604.OptimizationVariable":
        return self.__parent__._cast(_1604.OptimizationVariable)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class OptimizationInput(_1604.OptimizationVariable):
    """OptimizationInput
