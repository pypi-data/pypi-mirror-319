...
class OptimisationHistory(_0.APIBase):
    ...
    @property
    def input_history(self: "Self") -> "List[_1604.OptimizationVariable]":
    ...
    @property
    def target_history(self: "Self") -> "List[_1604.OptimizationVariable]":
        """List[mastapy.math_utility.optimisation.OptimizationVariable]
    ...
    def add_input_history(self: "Self", value: "_1604.OptimizationVariable") -> None:
    ...
    @enforce_parameter_types
    def add_target_history(self: "Self", value: "_1604.OptimizationVariable") -> None:
        """Method does not return.
