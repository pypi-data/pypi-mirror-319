...
if TYPE_CHECKING:
    ...
    from mastapy._private.math_utility.optimisation import _1603, _1615
...
class _Cast_OptimizationVariable:
    ...
    @property
    def optimization_input(self: "CastSelf") -> "_1603.OptimizationInput":
        from mastapy._private.math_utility.optimisation import _1603

        return self.__parent__._cast(_1603.OptimizationInput)

    @property
    def reporting_optimization_input(
        self: "CastSelf",
    ) -> "_1615.ReportingOptimizationInput":
        from mastapy._private.math_utility.optimisation import _1615

        return self.__parent__._cast(_1615.ReportingOptimizationInput)
...
class OptimizationVariable(_0.APIBase):
    ...
    @property
    def measurement(self: "Self") -> "_1666.MeasurementBase":
    ...
    def measurement(self: "Self", value: "_1666.MeasurementBase") -> None:
