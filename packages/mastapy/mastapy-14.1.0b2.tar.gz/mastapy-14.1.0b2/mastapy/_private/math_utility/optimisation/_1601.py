...
class _Cast_Optimisable:
    ...
    @property
    def abstract_optimisable(self: "CastSelf") -> "_1598.AbstractOptimisable":
        return self.__parent__._cast(_1598.AbstractOptimisable)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class Optimisable(_1598.AbstractOptimisable):
    """Optimisable
