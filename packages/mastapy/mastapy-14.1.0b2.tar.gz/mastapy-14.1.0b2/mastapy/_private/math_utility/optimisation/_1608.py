...
if TYPE_CHECKING:
    ...
    from mastapy._private.math_utility.optimisation import _1606, _1607, _1610
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ParetoOptimisationStrategy(_1895.NamedDatabaseItem):
    """ParetoOptimisationStrategy
    ...
    def charts(
        self: "Self",
    ) -> "List[_1610.ParetoOptimisationStrategyChartInformation]":
    ...
    @property
    def inputs(self: "Self") -> "List[_1606.ParetoOptimisationInput]":
    ...
    @property
    def outputs(self: "Self") -> "List[_1607.ParetoOptimisationOutput]":
