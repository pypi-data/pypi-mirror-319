...
class TwodimensionalFunctionLookupTable(
    _1625.LookupTableBase["TwodimensionalFunctionLookupTable"]
):
    """TwodimensionalFunctionLookupTable
    ...
    @property
    def lookup_table(self: "Self") -> "_1624.GriddedSurfaceAccessor":
    ...
    def lookup_table(self: "Self", value: "_1624.GriddedSurfaceAccessor") -> None:
