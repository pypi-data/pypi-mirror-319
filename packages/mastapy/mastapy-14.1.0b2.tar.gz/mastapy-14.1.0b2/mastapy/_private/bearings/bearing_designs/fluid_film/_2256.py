...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_designs.fluid_film import _2263, _2264
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class PadFluidFilmBearing(_2199.DetailedBearing):
    """PadFluidFilmBearing
    ...
    @enforce_parameter_types
    def rotational_direction(self: "Self", value: "_1964.RotationalDirections") -> None:
