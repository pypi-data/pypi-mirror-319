...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_designs.fluid_film import _2251, _2252, _2253
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class PlainOilFedJournalBearing(_2260.PlainJournalBearing):
    """PlainOilFedJournalBearing
    ...
    @property
    def feed_type(self: "Self") -> "_1954.JournalOilFeedType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.bearings._1954", "JournalOilFeedType"
        )(value)

    @feed_type.setter
    @enforce_parameter_types
    def feed_type(self: "Self", value: "_1954.JournalOilFeedType") -> None:
    ...
    @property
    def axial_groove_oil_feed(self: "Self") -> "_2251.AxialGrooveJournalBearing":
    ...
    @property
    def axial_hole_oil_feed(self: "Self") -> "_2252.AxialHoleJournalBearing":
    ...
    def circumferential_groove_oil_feed(
        self: "Self",
    ) -> "_2253.CircumferentialFeedJournalBearing":
