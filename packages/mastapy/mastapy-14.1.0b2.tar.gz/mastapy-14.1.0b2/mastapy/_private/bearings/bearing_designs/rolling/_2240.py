...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class TaperRollerBearing(_2229.NonBarrelRollerBearing):
    """TaperRollerBearing
    ...
    @property
    def bearing_measurement_type(self: "Self") -> "_1943.BearingMeasurementType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.bearings._1943", "BearingMeasurementType"
        )(value)

    @bearing_measurement_type.setter
    @enforce_parameter_types
    def bearing_measurement_type(
        self: "Self", value: "_1943.BearingMeasurementType"
    ) -> None:
