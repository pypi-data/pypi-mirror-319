...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_designs.rolling import _2208, _2221, _2233
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class FourPointContactBallBearing(_2227.MultiPointContactBallBearing):
    """FourPointContactBallBearing
    ...
    def contact_angle_and_internal_clearance_definition(
        self: "Self",
    ) -> "_2221.FourPointContactAngleDefinition":
    ...
    def contact_angle_and_internal_clearance_definition(
        self: "Self", value: "_2221.FourPointContactAngleDefinition"
    ) -> None:
