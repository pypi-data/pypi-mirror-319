...
class _Cast_AxialGrooveJournalBearing:
    ...
    @property
    def axial_feed_journal_bearing(self: "CastSelf") -> "_2250.AxialFeedJournalBearing":
        return self.__parent__._cast(_2250.AxialFeedJournalBearing)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class AxialGrooveJournalBearing(_2250.AxialFeedJournalBearing):
    """AxialGrooveJournalBearing
