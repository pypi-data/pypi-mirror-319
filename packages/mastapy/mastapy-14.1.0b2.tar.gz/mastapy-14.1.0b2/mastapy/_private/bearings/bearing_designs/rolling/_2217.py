...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_designs.rolling import _2228, _2230, _2233
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CylindricalRollerBearing(_2229.NonBarrelRollerBearing):
    """CylindricalRollerBearing
    ...
    @enforce_parameter_types
    def permissible_axial_load_default_calculation_method(
        self: "Self", value: "_2010.CylindricalRollerMaxAxialLoadMethod"
    ) -> None:
