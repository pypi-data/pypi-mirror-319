...
class _Cast_CylindricalHousingJournalBearing:
    ...
    @property
    def plain_journal_housing(self: "CastSelf") -> "_2261.PlainJournalHousing":
        return self.__parent__._cast(_2261.PlainJournalHousing)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CylindricalHousingJournalBearing(_2261.PlainJournalHousing):
    """CylindricalHousingJournalBearing
