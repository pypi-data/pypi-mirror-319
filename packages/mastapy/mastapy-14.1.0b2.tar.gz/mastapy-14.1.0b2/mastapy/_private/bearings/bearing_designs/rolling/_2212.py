...
class BearingProtectionDetailsModifier(_0.APIBase):
    ...
    @property
    def current_protection_level(self: "Self") -> "_2213.BearingProtectionLevel":
    ...
    @property
    def new_protection_level(self: "Self") -> "_2213.BearingProtectionLevel":
        """mastapy.bearings.bearing_designs.rolling.BearingProtectionLevel"""
    ...
    def new_protection_level(
        self: "Self", value: "_2213.BearingProtectionLevel"
    ) -> None:
