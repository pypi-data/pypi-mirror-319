...
from mastapy._private.bearings.tolerances import _1976, _1977, _1990
...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.tolerances import _1968, _1974, _1980
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class SupportTolerance(_1976.InterferenceTolerance):
    """SupportTolerance
    ...
    def tolerance_band_designation(self: "Self", value: "_1977.ITDesignation") -> None:
    ...
    @enforce_parameter_types
    def tolerance_deviation_class(
        self: "Self", value: "_1990.SupportToleranceLocationDesignation"
    ) -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
