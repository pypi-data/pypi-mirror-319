...
from mastapy._private.bearings.roller_bearing_profiles import _2006
...
class _Cast_UserSpecifiedRollerRaceProfilePoint:
    ...
    @property
    def roller_race_profile_point(self: "CastSelf") -> "_2006.RollerRaceProfilePoint":
        return self.__parent__._cast(_2006.RollerRaceProfilePoint)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class UserSpecifiedRollerRaceProfilePoint(_2006.RollerRaceProfilePoint):
    """UserSpecifiedRollerRaceProfilePoint
