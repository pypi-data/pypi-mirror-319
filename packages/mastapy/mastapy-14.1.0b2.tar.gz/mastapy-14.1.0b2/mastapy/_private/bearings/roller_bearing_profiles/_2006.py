...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.roller_bearing_profiles import _2008
...
class _Cast_RollerRaceProfilePoint:
    ...
    def user_specified_roller_race_profile_point(
        self: "CastSelf",
    ) -> "_2008.UserSpecifiedRollerRaceProfilePoint":
        from mastapy._private.bearings.roller_bearing_profiles import _2008

        return self.__parent__._cast(_2008.UserSpecifiedRollerRaceProfilePoint)
