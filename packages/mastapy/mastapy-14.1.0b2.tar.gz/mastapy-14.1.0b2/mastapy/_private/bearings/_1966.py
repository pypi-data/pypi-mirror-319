...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_results.rolling.skf_module import _2163
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class SKFSettings(_1654.PerMachineSettings):
    """SKFSettings
    ...
    @property
    def skf_authentication(self: "Self") -> "_2163.SKFAuthentication":
