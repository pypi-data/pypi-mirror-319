...
class _Cast_LoadedBallBearingRaceResults:
    ...
    def loaded_rolling_bearing_race_results(
        self: "CastSelf",
    ) -> "_2100.LoadedRollingBearingRaceResults":
        return self.__parent__._cast(_2100.LoadedRollingBearingRaceResults)

    @property
    def loaded_four_point_contact_ball_bearing_race_results(
        self: "CastSelf",
    ) -> "_2084.LoadedFourPointContactBallBearingRaceResults":
        from mastapy._private.bearings.bearing_results.rolling import _2084

        return self.__parent__._cast(_2084.LoadedFourPointContactBallBearingRaceResults)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class LoadedBallBearingRaceResults(_2100.LoadedRollingBearingRaceResults):
    """LoadedBallBearingRaceResults
