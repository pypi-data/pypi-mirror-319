...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class Frequencies(_2164.SKFCalculationResult):
    """Frequencies
    ...
    @property
    def frequency_of_over_rolling(self: "Self") -> "_2150.FrequencyOfOverRolling":
    ...
    @property
    def rotational_frequency(self: "Self") -> "_2162.RotationalFrequency":
