...
if TYPE_CHECKING:
    ...
    from mastapy._private.utility.property import _1904, _1905, _1906, _1907
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class LoadedRollingBearingDutyCycle(_2024.LoadedNonLinearBearingDutyCycleResults):
    """LoadedRollingBearingDutyCycle
    ...
    def ansiabma_dynamic_equivalent_load_summary(
        self: "Self",
    ) -> "_1904.DutyCyclePropertySummaryForce[_1942.BearingLoadCaseResultsLightweight]":
    ...
    def maximum_element_normal_stress_inner_summary(
        ...
        "_1907.DutyCyclePropertySummaryStress[_1942.BearingLoadCaseResultsLightweight]"
    ):
    ...
    def maximum_static_contact_stress_duty_cycle(
        self: "Self",
    ) -> "_2129.MaximumStaticContactStressDutyCycle":
    ...
    def maximum_truncation_summary(
        self: "Self",
    ) -> "_1905.DutyCyclePropertySummaryPercentage[_1942.BearingLoadCaseResultsLightweight]":
    ...
    def misalignment_summary(
        self: "Self",
    ) -> "_1906.DutyCyclePropertySummarySmallAngle[_1942.BearingLoadCaseResultsLightweight]":
