...
class SKFModuleResults(_0.APIBase):
    ...
    @property
    def adjusted_speed(self: "Self") -> "_2144.AdjustedSpeed":
    ...
    @property
    def bearing_loads(self: "Self") -> "_2146.BearingLoads":
    ...
    @property
    def bearing_rating_life(self: "Self") -> "_2147.BearingRatingLife":
    ...
    @property
    def frequencies(self: "Self") -> "_2149.Frequencies":
    ...
    @property
    def friction(self: "Self") -> "_2151.Friction":
    ...
    @property
    def minimum_load(self: "Self") -> "_2159.MinimumLoad":
    ...
    @property
    def static_safety_factors(self: "Self") -> "_2167.StaticSafetyFactors":
    ...
    @property
    def viscosities(self: "Self") -> "_2168.Viscosities":
