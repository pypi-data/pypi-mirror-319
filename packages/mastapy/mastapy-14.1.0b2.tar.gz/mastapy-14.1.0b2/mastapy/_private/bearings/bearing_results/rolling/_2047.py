...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_results.rolling import _2046, _2048
...
class _Cast_ISOTR141792001Results:
    ...
    @property
    def isotr1417912001_results(self: "CastSelf") -> "_2046.ISOTR1417912001Results":
        from mastapy._private.bearings.bearing_results.rolling import _2046

        return self.__parent__._cast(_2046.ISOTR1417912001Results)

    @property
    def isotr1417922001_results(self: "CastSelf") -> "_2048.ISOTR1417922001Results":
        from mastapy._private.bearings.bearing_results.rolling import _2048

        return self.__parent__._cast(_2048.ISOTR1417922001Results)
