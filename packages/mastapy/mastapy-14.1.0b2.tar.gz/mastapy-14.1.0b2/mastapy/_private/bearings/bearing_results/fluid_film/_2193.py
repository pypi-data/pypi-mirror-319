...
from mastapy._private.bearings.bearing_results.fluid_film import _2191
...
class _Cast_LoadedPlainOilFedJournalBearingRow:
    ...
    def loaded_plain_journal_bearing_row(
        self: "CastSelf",
    ) -> "_2191.LoadedPlainJournalBearingRow":
        return self.__parent__._cast(_2191.LoadedPlainJournalBearingRow)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class LoadedPlainOilFedJournalBearingRow(_2191.LoadedPlainJournalBearingRow):
    """LoadedPlainOilFedJournalBearingRow
