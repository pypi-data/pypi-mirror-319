...
class _Cast_ThreePointContactInternalClearance:
    ...
    @property
    def internal_clearance(self: "CastSelf") -> "_2041.InternalClearance":
        return self.__parent__._cast(_2041.InternalClearance)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ThreePointContactInternalClearance(_2041.InternalClearance):
    """ThreePointContactInternalClearance
