...
class _Cast_LoadedRollerStripLoadResults:
    ...
    def loaded_abstract_spherical_roller_bearing_strip_load_results(
        self: "CastSelf",
    ) -> "_2049.LoadedAbstractSphericalRollerBearingStripLoadResults":
    ...
    def loaded_asymmetric_spherical_roller_bearing_strip_load_results(
        self: "CastSelf",
    ) -> "_2059.LoadedAsymmetricSphericalRollerBearingStripLoadResults":
    ...
    def loaded_non_barrel_roller_bearing_strip_load_results(
        self: "CastSelf",
    ) -> "_2094.LoadedNonBarrelRollerBearingStripLoadResults":
        from mastapy._private.bearings.bearing_results.rolling import _2094

        return self.__parent__._cast(_2094.LoadedNonBarrelRollerBearingStripLoadResults)

    @property
    def loaded_spherical_roller_radial_bearing_strip_load_results(
        self: "CastSelf",
    ) -> "_2110.LoadedSphericalRollerRadialBearingStripLoadResults":
    ...
    def loaded_toroidal_roller_bearing_strip_load_results(
        self: "CastSelf",
    ) -> "_2127.LoadedToroidalRollerBearingStripLoadResults":
        from mastapy._private.bearings.bearing_results.rolling import _2127

        return self.__parent__._cast(_2127.LoadedToroidalRollerBearingStripLoadResults)
