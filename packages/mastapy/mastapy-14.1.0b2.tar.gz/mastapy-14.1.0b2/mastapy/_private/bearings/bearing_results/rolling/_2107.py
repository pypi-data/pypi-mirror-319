...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_results.rolling import _2082, _2106, _2113
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class LoadedSphericalRollerBearingElement(_2096.LoadedRollerBearingElement):
    """LoadedSphericalRollerBearingElement
