...
from mastapy._private.bearings.bearing_results.rolling.fitting import _2181
...
class _Cast_OuterRingFittingThermalResults:
    ...
    def ring_fitting_thermal_results(
        self: "CastSelf",
    ) -> "_2181.RingFittingThermalResults":
        return self.__parent__._cast(_2181.RingFittingThermalResults)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class OuterRingFittingThermalResults(_2181.RingFittingThermalResults):
    """OuterRingFittingThermalResults
