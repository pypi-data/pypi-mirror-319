...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class LoadedBallBearingRow(_2102.LoadedRollingBearingRow):
    """LoadedBallBearingRow
    ...
    @property
    def loaded_bearing(self: "Self") -> "_2070.LoadedBallBearingResults":
    ...
    @property
    def race_results(self: "Self") -> "List[_2069.LoadedBallBearingRaceResults]":
