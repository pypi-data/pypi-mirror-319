...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_results.rolling import _2092, _2097, _2101
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class LoadedNeedleRollerBearingResults(_2077.LoadedCylindricalRollerBearingResults):
    """LoadedNeedleRollerBearingResults
