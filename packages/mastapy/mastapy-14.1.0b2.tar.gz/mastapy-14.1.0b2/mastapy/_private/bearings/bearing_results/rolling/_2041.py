...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_results.rolling import _2142
...
class _Cast_InternalClearance:
    ...
    def three_point_contact_internal_clearance(
        self: "CastSelf",
    ) -> "_2142.ThreePointContactInternalClearance":
        from mastapy._private.bearings.bearing_results.rolling import _2142

        return self.__parent__._cast(_2142.ThreePointContactInternalClearance)
