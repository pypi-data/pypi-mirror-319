...
from mastapy._private.bearings.bearing_results.rolling.iso_rating_results import _2173
...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_results.rolling.abma import _2183, _2184
...
class _Cast_ANSIABMAResults:
    ...
    @property
    def iso_results(self: "CastSelf") -> "_2173.ISOResults":
        return self.__parent__._cast(_2173.ISOResults)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ANSIABMAResults(_2173.ISOResults):
    """ANSIABMAResults
