...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_results import _2016, _2024, _2027
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class LoadedTaperRollerBearingDutyCycle(_2091.LoadedNonBarrelRollerBearingDutyCycle):
    """LoadedTaperRollerBearingDutyCycle
