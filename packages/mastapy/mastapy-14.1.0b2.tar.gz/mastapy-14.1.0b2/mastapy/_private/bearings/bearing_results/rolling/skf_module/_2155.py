...
from mastapy._private.bearings.bearing_results.rolling.skf_module import _2164
...
class _Cast_GreaseLifeAndRelubricationInterval:
    ...
    @property
    def skf_calculation_result(self: "CastSelf") -> "_2164.SKFCalculationResult":
        return self.__parent__._cast(_2164.SKFCalculationResult)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class GreaseLifeAndRelubricationInterval(_2164.SKFCalculationResult):
    """GreaseLifeAndRelubricationInterval
    ...
    @property
    def grease(self: "Self") -> "_2154.Grease":
    ...
    @property
    def grease_quantity(self: "Self") -> "_2156.GreaseQuantity":
    ...
    @property
    def initial_fill(self: "Self") -> "_2157.InitialFill":
