...
if TYPE_CHECKING:
    ...
    from mastapy._private.electric_machines import _1328, _1369
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CADToothAndSlot(_1293.AbstractToothAndSlot):
    """CADToothAndSlot
    ...
    def individual_conductor_specification_source(
        self: "Self",
    ) -> "_1328.IndividualConductorSpecificationSource":
    ...
    def individual_conductor_specification_source(
        self: "Self", value: "_1328.IndividualConductorSpecificationSource"
    ) -> None:
