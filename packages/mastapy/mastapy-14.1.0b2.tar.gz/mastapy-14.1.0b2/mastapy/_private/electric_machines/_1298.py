...
from mastapy._private.electric_machines import _1335
...
if TYPE_CHECKING:
    ...
    from mastapy._private.electric_machines import _1297
...
class _Cast_CADMagnetsForLayer:
    ...
    @property
    def magnet_design(self: "CastSelf") -> "_1335.MagnetDesign":
        return self.__parent__._cast(_1335.MagnetDesign)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CADMagnetsForLayer(_1335.MagnetDesign):
    """CADMagnetsForLayer
    ...
    @property
    def cad_magnet_details(self: "Self") -> "List[_1297.CADMagnetDetails]":
