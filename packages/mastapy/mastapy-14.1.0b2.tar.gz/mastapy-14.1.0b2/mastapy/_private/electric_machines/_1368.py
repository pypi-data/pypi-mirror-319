...
if TYPE_CHECKING:
    ...
    from mastapy._private.electric_machines import _1324, _1332
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class VShapedMagnetLayerSpecification(_1349.RotorInternalLayerSpecification):
    """VShapedMagnetLayerSpecification
    ...
    @property
    def magnet_clearance(self: "Self") -> "_1332.MagnetClearance":
    ...
    @enforce_parameter_types
    def magnet_clearance(self: "Self", value: "_1332.MagnetClearance") -> None:
    ...
    @property
    def upper_flux_barrier_web_specification(self: "Self") -> "_1324.FluxBarrierOrWeb":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.electric_machines._1324", "FluxBarrierOrWeb"
        )(value)

    @upper_flux_barrier_web_specification.setter
    @enforce_parameter_types
    def upper_flux_barrier_web_specification(
        self: "Self", value: "_1324.FluxBarrierOrWeb"
    ) -> None:
        value = conversion.mp_to_pn_enum(
