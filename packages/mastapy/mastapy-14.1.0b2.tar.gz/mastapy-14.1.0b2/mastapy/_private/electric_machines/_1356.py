...
if TYPE_CHECKING:
    ...
    from mastapy._private.electric_machines import _1308, _1331
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class StatorRotorMaterial(_288.Material):
    """StatorRotorMaterial
    ...
    def coefficient_specification_method(
        self: "Self",
    ) -> "_1331.IronLossCoefficientSpecificationMethod":
    ...
    @enforce_parameter_types
    def coefficient_specification_method(
        self: "Self", value: "_1331.IronLossCoefficientSpecificationMethod"
    ) -> None:
    ...
    @property
    def loss_curves(self: "Self") -> "_1934.TwoDChartDefinition":
    ...
    @property
    def bh_curve_specification(self: "Self") -> "_267.BHCurveSpecification":
    ...
    @property
    def core_loss_coefficients(self: "Self") -> "_1308.CoreLossCoefficients":
