...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class BasicDynamicForceLoadCase(_1417.ElectricMachineLoadCaseBase):
    """BasicDynamicForceLoadCase
    ...
    def analysis_period(
        self: "Self", value: "_183.ElectricMachineAnalysisPeriod"
    ) -> None:
    ...
    def number_of_steps_per_operating_point_specification_method(
        self: "Self",
    ) -> "_1426.NumberOfStepsPerOperatingPointSpecificationMethod":
    ...
    @enforce_parameter_types
    def number_of_steps_per_operating_point_specification_method(
        self: "Self", value: "_1426.NumberOfStepsPerOperatingPointSpecificationMethod"
    ) -> None:
    ...
    @property
    def operating_points(self: "Self") -> "List[_1407.DynamicForcesOperatingPoint]":
    ...
    def remove_operating_point(
        self: "Self", operating_point: "_1407.DynamicForcesOperatingPoint"
    ) -> None:
        """Method does not return.
