...
if TYPE_CHECKING:
    ...
    from mastapy._private.electric_machines.load_cases_and_analyses import _1417, _1432
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class SpeedTorqueCurveLoadCase(_1425.NonLinearDQModelMultipleOperatingPointsLoadCase):
    """SpeedTorqueCurveLoadCase
