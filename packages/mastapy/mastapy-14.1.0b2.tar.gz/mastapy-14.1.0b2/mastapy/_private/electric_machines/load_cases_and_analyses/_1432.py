...
if TYPE_CHECKING:
    ...
    from mastapy._private.electric_machines.results import _1399
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class SpeedTorqueCurveAnalysis(_1410.ElectricMachineAnalysis):
    """SpeedTorqueCurveAnalysis
    ...
    @property
    def load_case(self: "Self") -> "_1433.SpeedTorqueCurveLoadCase":
    ...
    @property
    def results_points(self: "Self") -> "List[_1399.MaximumTorqueResultsPoints]":
