...
if TYPE_CHECKING:
    ...
    from mastapy._private.electric_machines import _1362, _1363
...
class _Cast_ToothAndSlot:
    ...
    @property
    def abstract_tooth_and_slot(self: "CastSelf") -> "_1293.AbstractToothAndSlot":
        return self.__parent__._cast(_1293.AbstractToothAndSlot)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ToothAndSlot(_1293.AbstractToothAndSlot):
    """ToothAndSlot
    ...
    @property
    def tooth_taper_specification(self: "Self") -> "_1363.ToothTaperSpecification":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.electric_machines._1363", "ToothTaperSpecification"
        )(value)

    @tooth_taper_specification.setter
    @enforce_parameter_types
    def tooth_taper_specification(
        self: "Self", value: "_1363.ToothTaperSpecification"
    ) -> None:
    ...
    @property
    def tooth_slot_style(self: "Self") -> "_1362.ToothSlotStyle":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.electric_machines._1362", "ToothSlotStyle"
        )(value)

    @tooth_slot_style.setter
    @enforce_parameter_types
    def tooth_slot_style(self: "Self", value: "_1362.ToothSlotStyle") -> None:
        value = conversion.mp_to_pn_enum(
