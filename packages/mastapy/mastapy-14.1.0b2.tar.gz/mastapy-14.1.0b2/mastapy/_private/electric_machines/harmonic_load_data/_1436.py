...
if TYPE_CHECKING:
    ...
    from mastapy._private.utility_gui.charts import _1929, _1933
...
class _Cast_ElectricMachineHarmonicLoadDataBase:
    ...
    def electric_machine_harmonic_load_data(
        ...
        return self.__parent__._cast(_7562.ElectricMachineHarmonicLoadData)

    @property
    def electric_machine_harmonic_load_data_from_excel(
        self: "CastSelf",
    ) -> "_7563.ElectricMachineHarmonicLoadDataFromExcel":
        from mastapy._private.system_model.analyses_and_results.static_loads import (
            _7563,
        )

        return self.__parent__._cast(_7563.ElectricMachineHarmonicLoadDataFromExcel)

    @property
    def electric_machine_harmonic_load_data_from_flux(
        self: "CastSelf",
    ) -> "_7564.ElectricMachineHarmonicLoadDataFromFlux":
        from mastapy._private.system_model.analyses_and_results.static_loads import (
            _7564,
        )

        return self.__parent__._cast(_7564.ElectricMachineHarmonicLoadDataFromFlux)

    @property
    def electric_machine_harmonic_load_data_from_jmag(
        self: "CastSelf",
    ) -> "_7565.ElectricMachineHarmonicLoadDataFromJMAG":
        from mastapy._private.system_model.analyses_and_results.static_loads import (
            _7565,
        )

        return self.__parent__._cast(_7565.ElectricMachineHarmonicLoadDataFromJMAG)

    @property
    def electric_machine_harmonic_load_data_from_masta(
        self: "CastSelf",
    ) -> "_7566.ElectricMachineHarmonicLoadDataFromMASTA":
        from mastapy._private.system_model.analyses_and_results.static_loads import (
            _7566,
        )

        return self.__parent__._cast(_7566.ElectricMachineHarmonicLoadDataFromMASTA)

    @property
    def electric_machine_harmonic_load_data_from_motor_cad(
        self: "CastSelf",
    ) -> "_7567.ElectricMachineHarmonicLoadDataFromMotorCAD":
        from mastapy._private.system_model.analyses_and_results.static_loads import (
            _7567,
        )

        return self.__parent__._cast(_7567.ElectricMachineHarmonicLoadDataFromMotorCAD)

    @property
    def electric_machine_harmonic_load_data_from_motor_packages(
        self: "CastSelf",
    ) -> "_7568.ElectricMachineHarmonicLoadDataFromMotorPackages":
        from mastapy._private.system_model.analyses_and_results.static_loads import (
            _7568,
        )
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ElectricMachineHarmonicLoadDataBase(_1442.SpeedDependentHarmonicLoadData):
    """ElectricMachineHarmonicLoadDataBase
    ...
    @enforce_parameter_types
    def data_type_for_force_moment_distribution_and_temporal_spatial_harmonics_charts(
        self: "Self", value: "_1440.HarmonicLoadDataType"
    ) -> None:
    ...
    @enforce_parameter_types
    def display_option_for_slice_data(
        self: "Self", value: "_1437.ForceDisplayOption"
    ) -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
    ...
    @property
    def force_distribution_3d(self: "Self") -> "_1933.ThreeDVectorChartDefinition":
    ...
    @enforce_parameter_types
    def selected_tooth(self: "Self", value: "_1441.SimpleElectricMachineTooth") -> None:
        wrapper_type = list_with_selected_item.ListWithSelectedItem_SimpleElectricMachineTooth.wrapper_type()
        enclosed_type = list_with_selected_item.ListWithSelectedItem_SimpleElectricMachineTooth.implicit_type()
    ...
    @property
    def rotor_x_force(self: "Self") -> "_1580.MultipleFourierSeriesInterpolator":
    ...
    @property
    def rotor_y_force(self: "Self") -> "_1580.MultipleFourierSeriesInterpolator":
        """mastapy.math_utility.MultipleFourierSeriesInterpolator
    ...
    @property
    def stator_axial_loads(self: "Self") -> "_1444.StatorToothLoadInterpolator":
    ...
    @property
    def stator_radial_loads(self: "Self") -> "_1444.StatorToothLoadInterpolator":
        """mastapy.electric_machines.harmonic_load_data.StatorToothLoadInterpolator
    ...
    @property
    def stator_tangential_loads(self: "Self") -> "_1444.StatorToothLoadInterpolator":
        """mastapy.electric_machines.harmonic_load_data.StatorToothLoadInterpolator
    ...
    @property
    def stator_tooth_moments(self: "Self") -> "_1445.StatorToothMomentInterpolator":
    ...
    def multiple_fourier_series_interpolator_for(
        self: "Self",
        harmonic_load_data_type: "_1440.HarmonicLoadDataType",
        slice_index: "int",
    ) -> "_1580.MultipleFourierSeriesInterpolator":
        """mastapy.math_utility.MultipleFourierSeriesInterpolator
    ...
    def stator_tooth_load_interpolator_for(
        ...
        harmonic_load_data_type: "_1440.HarmonicLoadDataType",
        slice_index: "int",
    ) -> "_1444.StatorToothLoadInterpolator":
        """mastapy.electric_machines.harmonic_load_data.StatorToothLoadInterpolator
    ...
    def stator_tooth_moment_interpolator_for(
        ...
        harmonic_load_data_type: "_1440.HarmonicLoadDataType",
        slice_index: "int",
    ) -> "_1445.StatorToothMomentInterpolator":
        """mastapy.electric_machines.harmonic_load_data.StatorToothMomentInterpolator
