...
from mastapy._private.electric_machines.harmonic_load_data import _1443
...
class _Cast_StatorToothMomentInterpolator:
    ...
    @property
    def stator_tooth_interpolator(self: "CastSelf") -> "_1443.StatorToothInterpolator":
        return self.__parent__._cast(_1443.StatorToothInterpolator)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class StatorToothMomentInterpolator(_1443.StatorToothInterpolator):
    """StatorToothMomentInterpolator
