...
class CoolingDuctLayerSpecification(_0.APIBase):
    ...
    @property
    def shape(self: "Self") -> "_1306.CoolingDuctShape":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.electric_machines._1306", "CoolingDuctShape"
        )(value)

    @shape.setter
    @enforce_parameter_types
    def shape(self: "Self", value: "_1306.CoolingDuctShape") -> None:
