...
if TYPE_CHECKING:
    ...
    from mastapy._private.electric_machines import _1373
    from mastapy._private.electric_machines.load_cases_and_analyses import _1421, _1424
...
class _Cast_OnLoadElectricMachineResults:
    ...
    @property
    def electric_machine_results(self: "CastSelf") -> "_1384.ElectricMachineResults":
        return self.__parent__._cast(_1384.ElectricMachineResults)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class OnLoadElectricMachineResults(_1384.ElectricMachineResults):
    """OnLoadElectricMachineResults
    ...
    @property
    def motoring_or_generating(self: "Self") -> "_1424.MotoringOrGenerating":
    ...
    @property
    def power_factor_direction(self: "Self") -> "_1421.LeadingOrLagging":
