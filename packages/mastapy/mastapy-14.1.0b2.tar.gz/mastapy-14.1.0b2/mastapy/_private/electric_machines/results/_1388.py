...
if TYPE_CHECKING:
    ...
    from mastapy._private.electric_machines.results import _1402, _1403
...
class ElectricMachineResultsForOpenCircuitAndOnLoad(_0.APIBase):
    ...
    @property
    def linear_dq_model_chart(self: "Self") -> "_1934.TwoDChartDefinition":
    ...
    @property
    def on_load_results(self: "Self") -> "_1402.OnLoadElectricMachineResults":
    ...
    @property
    def open_circuit_results(self: "Self") -> "_1403.OpenCircuitElectricMachineResults":
    ...
    @property
    def all_on_load_results(self: "Self") -> "List[_1402.OnLoadElectricMachineResults]":
    ...
    def all_open_circuit_results(
        self: "Self",
    ) -> "List[_1403.OpenCircuitElectricMachineResults]":
    ...
    def on_load_results_for_slices(
        self: "Self",
    ) -> "List[_1402.OnLoadElectricMachineResults]":
        """List[mastapy.electric_machines.results.OnLoadElectricMachineResults]
