...
if TYPE_CHECKING:
    ...
    from mastapy._private.electric_machines.results import _1398, _1400
...
class _Cast_ElectricMachineDQModel:
    ...
    @property
    def linear_dq_model(self: "CastSelf") -> "_1398.LinearDQModel":
        from mastapy._private.electric_machines.results import _1398

        return self.__parent__._cast(_1398.LinearDQModel)

    @property
    def non_linear_dq_model(self: "CastSelf") -> "_1400.NonLinearDQModel":
        from mastapy._private.electric_machines.results import _1400

        return self.__parent__._cast(_1400.NonLinearDQModel)
