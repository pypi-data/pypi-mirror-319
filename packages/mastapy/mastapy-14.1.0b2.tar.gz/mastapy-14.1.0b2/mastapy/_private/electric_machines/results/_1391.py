...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="ElectricMachineResultsForStatorToothAtTimeStep._Cast_ElectricMachineResultsForStatorToothAtTimeStep",
    )
...
class _Cast_ElectricMachineResultsForStatorToothAtTimeStep:
    ...
    __parent__: "ElectricMachineResultsForStatorToothAtTimeStep"
...
class ElectricMachineResultsForStatorToothAtTimeStep(_0.APIBase):
    ...
    TYPE: ClassVar["Type"] = _ELECTRIC_MACHINE_RESULTS_FOR_STATOR_TOOTH_AT_TIME_STEP
    ...
    def axial_moment(self: "Self") -> "float":
        ...
        Note:
            This property is readonly.
        """
        temp = pythonnet_property_get(self.wrapped, "AxialMoment")
    ...
    def stator_tooth_index(self: "Self") -> "int":
        ...
        Note:
            This property is readonly.
        """
        temp = pythonnet_property_get(self.wrapped, "StatorToothIndex")
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_ElectricMachineResultsForStatorToothAtTimeStep":
        """Cast to another type.

        Returns:
            _Cast_ElectricMachineResultsForStatorToothAtTimeStep
        """
        return _Cast_ElectricMachineResultsForStatorToothAtTimeStep(self)
