...
if TYPE_CHECKING:
    ...
    from mastapy._private.electric_machines import _1336, _1367, _1368
...
class _Cast_RotorInternalLayerSpecification:
    ...
    def u_shaped_layer_specification(
        self: "CastSelf",
    ) -> "_1367.UShapedLayerSpecification":
        from mastapy._private.electric_machines import _1367

        return self.__parent__._cast(_1367.UShapedLayerSpecification)

    @property
    def v_shaped_magnet_layer_specification(
        self: "CastSelf",
    ) -> "_1368.VShapedMagnetLayerSpecification":
        from mastapy._private.electric_machines import _1368

        return self.__parent__._cast(_1368.VShapedMagnetLayerSpecification)
...
class RotorInternalLayerSpecification(_0.APIBase):
    ...
    @property
    def magnets(self: "Self") -> "_1336.MagnetForLayer":
