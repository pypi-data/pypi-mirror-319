...
if TYPE_CHECKING:
    ...
    from mastapy._private.materials.efficiency import _317
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class OilPumpDetail(_1646.IndependentReportablePropertiesBase["OilPumpDetail"]):
    """OilPumpDetail
    ...
    @property
    def electric_power_consumed_vs_speed(self: "Self") -> "_1594.Vector2DListAccessor":
    ...
    @property
    def oil_flow_rate_vs_speed(self: "Self") -> "_1594.Vector2DListAccessor":
        """mastapy.math_utility.Vector2DListAccessor"""
    ...
    @property
    def oil_pump_drive_type(self: "Self") -> "_317.OilPumpDriveType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.materials.efficiency._317", "OilPumpDriveType"
        )(value)

    @oil_pump_drive_type.setter
    @enforce_parameter_types
    def oil_pump_drive_type(self: "Self", value: "_317.OilPumpDriveType") -> None:
    ...
    @property
    def operating_oil_pressure_vs_speed(self: "Self") -> "_1594.Vector2DListAccessor":
        """mastapy.math_utility.Vector2DListAccessor"""
