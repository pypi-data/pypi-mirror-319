...
from mastapy._private.materials.efficiency import _321
...
class _Cast_IndependentResistiveTorque:
    ...
    @property
    def resistive_torque(self: "CastSelf") -> "_321.ResistiveTorque":
        return self.__parent__._cast(_321.ResistiveTorque)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class IndependentResistiveTorque(_321.ResistiveTorque):
    """IndependentResistiveTorque
