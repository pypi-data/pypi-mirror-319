...
from mastapy._private.math_utility import _1591
...
class _Cast_ShaftPointStress:
    ...
    @property
    def stress_point(self: "CastSelf") -> "_1591.StressPoint":
        return self.__parent__._cast(_1591.StressPoint)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ShaftPointStress(_1591.StressPoint):
    """ShaftPointStress
