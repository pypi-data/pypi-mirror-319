...
if TYPE_CHECKING:
    ...
    from mastapy._private.utility_gui.charts import _1925, _1931
...
class _Cast_ConstantLine:
    ...
    @property
    def mode_constant_line(self: "CastSelf") -> "_1925.ModeConstantLine":
        from mastapy._private.utility_gui.charts import _1925

        return self.__parent__._cast(_1925.ModeConstantLine)
...
class ConstantLine(_0.APIBase):
    ...
    @property
    def axis(self: "Self") -> "_1931.SMTAxis":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.utility_gui.charts._1931", "SMTAxis"
        )(value)
