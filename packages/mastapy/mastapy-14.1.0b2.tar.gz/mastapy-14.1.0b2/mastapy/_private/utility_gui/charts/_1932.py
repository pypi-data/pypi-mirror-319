...
if TYPE_CHECKING:
    ...
    from mastapy._private.utility.report import _1805, _1810
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ThreeDChartDefinition(_1926.NDChartDefinition):
    """ThreeDChartDefinition
    ...
    @property
    def z_axis(self: "Self") -> "_1805.AxisSettings":
    ...
    @property
    def x_axis_range(self: "Self") -> "_1548.Range":
    ...
    def x_axis_range(self: "Self", value: "_1548.Range") -> None:
        pythonnet_property_set(self.wrapped, "XAxisRange", value.wrapped)

    @property
    def y_axis_range(self: "Self") -> "_1548.Range":
        """mastapy.math_utility.Range"""
    ...
    @y_axis_range.setter
    @enforce_parameter_types
    def y_axis_range(self: "Self", value: "_1548.Range") -> None:
        pythonnet_property_set(self.wrapped, "YAxisRange", value.wrapped)

    @property
    def z_axis_range(self: "Self") -> "_1548.Range":
        """mastapy.math_utility.Range"""
    ...
    @z_axis_range.setter
    @enforce_parameter_types
    def z_axis_range(self: "Self", value: "_1548.Range") -> None:
        pythonnet_property_set(self.wrapped, "ZAxisRange", value.wrapped)

    def data_points_for_surfaces(self: "Self") -> "List[_1928.PointsForSurface]":
