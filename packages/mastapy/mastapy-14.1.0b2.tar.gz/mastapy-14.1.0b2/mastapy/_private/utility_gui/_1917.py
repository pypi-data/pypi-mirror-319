...
if TYPE_CHECKING:
    ...
    from mastapy._private.utility_gui import _1916
...
class _Cast_DataLoggerWithCharts:
    ...
    @property
    def data_logger(self: "CastSelf") -> "_1635.DataLogger":
        return self.__parent__._cast(_1635.DataLogger)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class DataLoggerWithCharts(_1635.DataLogger):
    """DataLoggerWithCharts
    ...
    @property
    def logged_items(self: "Self") -> "List[_1916.DataLoggerItem]":
