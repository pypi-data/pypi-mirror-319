...
if TYPE_CHECKING:
    ...
    from mastapy._private.cycloidal import _1511, _1518
...
class CycloidalDiscModificationsSpecification(_0.APIBase):
    ...
    def crowning_specification_method(
        self: "Self",
    ) -> "_1511.CrowningSpecificationMethod":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.cycloidal._1511", "CrowningSpecificationMethod"
        )(value)

    @crowning_specification_method.setter
    @enforce_parameter_types
    def crowning_specification_method(
        self: "Self", value: "_1511.CrowningSpecificationMethod"
    ) -> None:
    ...
    def direction_of_measured_modifications(
        self: "Self",
    ) -> "_1518.DirectionOfMeasuredModifications":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.cycloidal._1518", "DirectionOfMeasuredModifications"
        )(value)

    @direction_of_measured_modifications.setter
    @enforce_parameter_types
    def direction_of_measured_modifications(
        self: "Self", value: "_1518.DirectionOfMeasuredModifications"
    ) -> None:
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def measured_profile_modification(self: "Self") -> "_1594.Vector2DListAccessor":
