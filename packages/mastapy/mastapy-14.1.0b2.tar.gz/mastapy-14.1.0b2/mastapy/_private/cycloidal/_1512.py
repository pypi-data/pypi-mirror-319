...
if TYPE_CHECKING:
    ...
    from mastapy._private.cycloidal import _1513, _1520, _1521
...
class CycloidalAssemblyDesign(_0.APIBase):
    ...
    @property
    def ring_pins(self: "Self") -> "_1521.RingPinsDesign":
    ...
    @property
    def disc_phases(self: "Self") -> "List[_1520.NamedDiscPhase]":
    ...
    @property
    def discs(self: "Self") -> "List[_1513.CycloidalDiscDesign]":
