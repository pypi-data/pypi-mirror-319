...
if TYPE_CHECKING:
    ...
    from mastapy._private.detailed_rigid_connectors.interference_fits import _1506
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class InterferenceFitHalfDesign(_1447.DetailedRigidConnectorHalfDesign):
    """InterferenceFitHalfDesign
    ...
    @property
    def stress_region(self: "Self") -> "_1506.StressRegions":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.detailed_rigid_connectors.interference_fits._1506",
            "StressRegions",
        )(value)
    ...
    @property
    def tolerance(self: "Self") -> "_1989.SupportTolerance":
