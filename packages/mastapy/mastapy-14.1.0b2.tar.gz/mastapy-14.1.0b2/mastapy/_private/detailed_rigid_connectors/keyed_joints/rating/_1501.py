...
from mastapy._private.detailed_rigid_connectors.interference_fits.rating import _1508
...
if TYPE_CHECKING:
    ...
    from mastapy._private.detailed_rigid_connectors.keyed_joints.rating import _1500
...
class _Cast_KeywayRating:
    ...
    def shaft_hub_connection_rating(
        self: "CastSelf",
    ) -> "_1495.ShaftHubConnectionRating":
        from mastapy._private.detailed_rigid_connectors.rating import _1495

        return self.__parent__._cast(_1495.ShaftHubConnectionRating)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class KeywayRating(_1508.InterferenceFitRating):
    """KeywayRating
    ...
    @property
    def keyed_joint_design(self: "Self") -> "_1496.KeyedJointDesign":
    ...
    @property
    def keyway_half_ratings(self: "Self") -> "List[_1500.KeywayHalfRating]":
