...
from mastapy._private.detailed_rigid_connectors.splines.ratings import _1490
...
class _Cast_GBT17855SplineHalfRating:
    ...
    @property
    def spline_half_rating(self: "CastSelf") -> "_1490.SplineHalfRating":
        return self.__parent__._cast(_1490.SplineHalfRating)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class GBT17855SplineHalfRating(_1490.SplineHalfRating):
    """GBT17855SplineHalfRating
