...
if TYPE_CHECKING:
    ...
    from mastapy._private.detailed_rigid_connectors.splines import _1474, _1479
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class GBT3478SplineJointDesign(_1459.ISO4156SplineJointDesign):
    """GBT3478SplineJointDesign
    ...
    def major_diameter_standard_tolerance_grade(
        self: "Self", value: "_1977.ITDesignation"
    ) -> None:
