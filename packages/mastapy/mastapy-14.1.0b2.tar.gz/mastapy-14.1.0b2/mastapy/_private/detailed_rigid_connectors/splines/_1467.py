...
if TYPE_CHECKING:
    ...
    from mastapy._private.detailed_rigid_connectors.splines import _1454, _1474
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class SAESplineJointDesign(_1479.StandardSplineJointDesign):
    """SAESplineJointDesign
    ...
    @property
    def fit_type(self: "Self") -> "_1454.FitTypes":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.detailed_rigid_connectors.splines._1454", "FitTypes"
        )(value)

    @fit_type.setter
    @enforce_parameter_types
    def fit_type(self: "Self", value: "_1454.FitTypes") -> None:
