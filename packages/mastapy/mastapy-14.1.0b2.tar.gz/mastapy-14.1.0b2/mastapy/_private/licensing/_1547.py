...
if TYPE_CHECKING:
    ...
    from mastapy._private.licensing import _7736, _7737, _7738
...
class LicenceServer:
    ...
    @staticmethod
    @enforce_parameter_types
    def update_server_settings(server_details: "_7736.LicenceServerDetails") -> None:
    ...
    @staticmethod
    def get_server_settings() -> "_7736.LicenceServerDetails":
    ...
    @staticmethod
    def get_licensed_module_details() -> "Iterable[_7737.ModuleDetails]":
    ...
    @staticmethod
    def get_available_module_details() -> "Iterable[_7737.ModuleDetails]":
        """Iterable[mastapy.licensing.ModuleDetails]"""
        return conversion.pn_to_mp_objects_in_iterable(
    ...
    @staticmethod
    def get_requested_module_statuses() -> "Iterable[_7738.ModuleLicenceStatus]":
