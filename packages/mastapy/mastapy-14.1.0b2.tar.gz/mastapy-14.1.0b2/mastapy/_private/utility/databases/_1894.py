...
from mastapy._private.utility.databases import _1896, _1897
...
if TYPE_CHECKING:
    ...
    from mastapy._private.utility.databases import _1890, _1895

    Self = TypeVar("Self", bound="NamedDatabase")
    CastSelf = TypeVar("CastSelf", bound="NamedDatabase._Cast_NamedDatabase")

TValue = TypeVar("TValue", bound="_1895.NamedDatabaseItem")
...
class _Cast_NamedDatabase:
    ...
    @property
    def bearing_settings_database(self: "CastSelf") -> "_1947.BearingSettingsDatabase":
        from mastapy._private.bearings import _1947

        return self.__parent__._cast(_1947.BearingSettingsDatabase)

    @property
    def iso14179_settings_database(
        self: "CastSelf",
    ) -> "_2043.ISO14179SettingsDatabase":
        from mastapy._private.bearings.bearing_results.rolling import _2043

        return self.__parent__._cast(_2043.ISO14179SettingsDatabase)
    ...
    def conical_gear_optimization_strategy_database(
        ...
        return self.__parent__._cast(_2297.ConicalGearOptimizationStrategyDatabase)

    @property
    def optimization_strategy_database(
        self: "CastSelf",
    ) -> "_2305.OptimizationStrategyDatabase":
        from mastapy._private.system_model.optimization import _2305

        return self.__parent__._cast(_2305.OptimizationStrategyDatabase)
    ...
    def supercharger_rotor_set_database(
        ...
        return self.__parent__._cast(_2639.SuperchargerRotorSetDatabase)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class NamedDatabase(_1897.SQLDatabase[_1896.NamedKey, TValue]):
    """NamedDatabase
    ...
    @enforce_parameter_types
    def duplicate(
        self: "Self", new_name: "str", item: "_1895.NamedDatabaseItem"
    ) -> "_1895.NamedDatabaseItem":
    ...
    @enforce_parameter_types
    def rename(
        self: "Self", item: "_1895.NamedDatabaseItem", new_name: "str"
    ) -> "bool":
        """bool
