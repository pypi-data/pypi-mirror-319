...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf", bound="TextFileDelimiterOptions._Cast_TextFileDelimiterOptions"
    )
...
class _Cast_TextFileDelimiterOptions:
    ...
    __parent__: "TextFileDelimiterOptions"

    @property
    def text_file_delimiter_options(self: "CastSelf") -> "TextFileDelimiterOptions":
...
class TextFileDelimiterOptions(_0.APIBase):
    ...
    TYPE: ClassVar["Type"] = _TEXT_FILE_DELIMITER_OPTIONS
    ...
    def other(self: "Self") -> "str":
        """str"""
        temp = pythonnet_property_get(self.wrapped, "Other")
    ...
    def other(self: "Self", value: "str") -> None:
        pythonnet_property_set(
    ...
    def treat_consecutive_delimiters_as_one(self: "Self") -> "bool":
        """bool"""
        temp = pythonnet_property_get(self.wrapped, "TreatConsecutiveDelimitersAsOne")
    ...
    @enforce_parameter_types
    def treat_consecutive_delimiters_as_one(self: "Self", value: "bool") -> None:
        pythonnet_property_set(
            self.wrapped,
    ...
    def use_comma(self: "Self") -> "bool":
        """bool"""
        temp = pythonnet_property_get(self.wrapped, "UseComma")
    ...
    @use_comma.setter
    @enforce_parameter_types
    def use_comma(self: "Self", value: "bool") -> None:
        pythonnet_property_set(
    ...
    def use_semi_colon(self: "Self") -> "bool":
        """bool"""
        temp = pythonnet_property_get(self.wrapped, "UseSemiColon")
    ...
    @enforce_parameter_types
    def use_semi_colon(self: "Self", value: "bool") -> None:
        pythonnet_property_set(
    ...
    def use_space(self: "Self") -> "bool":
        """bool"""
        temp = pythonnet_property_get(self.wrapped, "UseSpace")
    ...
    @use_space.setter
    @enforce_parameter_types
    def use_space(self: "Self", value: "bool") -> None:
        pythonnet_property_set(
    ...
    def use_tab(self: "Self") -> "bool":
        """bool"""
        temp = pythonnet_property_get(self.wrapped, "UseTab")
    ...
    @use_tab.setter
    @enforce_parameter_types
    def use_tab(self: "Self", value: "bool") -> None:
        pythonnet_property_set(
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_TextFileDelimiterOptions":
        """Cast to another type.

        Returns:
            _Cast_TextFileDelimiterOptions
        """
        return _Cast_TextFileDelimiterOptions(self)
