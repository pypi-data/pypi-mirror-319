...
class _Cast_MethodOutcomeWithResult:
    ...
    @property
    def method_outcome(self: "CastSelf") -> "_1650.MethodOutcome":
        return self.__parent__._cast(_1650.MethodOutcome)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class MethodOutcomeWithResult(_1650.MethodOutcome, Generic[T]):
    """MethodOutcomeWithResult
