...
class _Cast_OrderForTE:
    ...
    @property
    def gear_mesh_for_te(self: "CastSelf") -> "_1861.GearMeshForTE":
        from mastapy._private.utility.modal_analysis.gears import _1861

        return self.__parent__._cast(_1861.GearMeshForTE)

    @property
    def gear_order_for_te(self: "CastSelf") -> "_1862.GearOrderForTE":
        from mastapy._private.utility.modal_analysis.gears import _1862

        return self.__parent__._cast(_1862.GearOrderForTE)

    @property
    def harmonic_order_for_te(self: "CastSelf") -> "_1864.HarmonicOrderForTE":
        from mastapy._private.utility.modal_analysis.gears import _1864

        return self.__parent__._cast(_1864.HarmonicOrderForTE)

    @property
    def label_only_order(self: "CastSelf") -> "_1865.LabelOnlyOrder":
        from mastapy._private.utility.modal_analysis.gears import _1865

        return self.__parent__._cast(_1865.LabelOnlyOrder)

    @property
    def order_selector(self: "CastSelf") -> "_1867.OrderSelector":
        from mastapy._private.utility.modal_analysis.gears import _1867

        return self.__parent__._cast(_1867.OrderSelector)

    @property
    def order_with_radius(self: "CastSelf") -> "_1868.OrderWithRadius":
        from mastapy._private.utility.modal_analysis.gears import _1868

        return self.__parent__._cast(_1868.OrderWithRadius)

    @property
    def rolling_bearing_order(self: "CastSelf") -> "_1869.RollingBearingOrder":
        from mastapy._private.utility.modal_analysis.gears import _1869

        return self.__parent__._cast(_1869.RollingBearingOrder)

    @property
    def shaft_order_for_te(self: "CastSelf") -> "_1870.ShaftOrderForTE":
        from mastapy._private.utility.modal_analysis.gears import _1870

        return self.__parent__._cast(_1870.ShaftOrderForTE)

    @property
    def user_defined_order_for_te(self: "CastSelf") -> "_1871.UserDefinedOrderForTE":
        from mastapy._private.utility.modal_analysis.gears import _1871

        return self.__parent__._cast(_1871.UserDefinedOrderForTE)
