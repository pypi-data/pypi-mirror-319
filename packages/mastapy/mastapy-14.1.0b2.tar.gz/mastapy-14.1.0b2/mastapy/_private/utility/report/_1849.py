...
if TYPE_CHECKING:
    ...
    from mastapy._private.utility.report import _1835, _1847
...
class _Cast_UserTextRow:
    ...
    def custom_report_property_item(
        self: "CastSelf",
    ) -> "_1835.CustomReportPropertyItem":
        from mastapy._private.utility.report import _1835

        return self.__parent__._cast(_1835.CustomReportPropertyItem)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class UserTextRow(_1840.CustomRow):
    """UserTextRow
    ...
    @property
    def heading_size(self: "Self") -> "_1847.HeadingSize":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.utility.report._1847", "HeadingSize"
        )(value)

    @heading_size.setter
    @enforce_parameter_types
    def heading_size(self: "Self", value: "_1847.HeadingSize") -> None:
