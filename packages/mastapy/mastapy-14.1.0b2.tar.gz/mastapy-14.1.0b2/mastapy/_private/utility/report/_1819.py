...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CustomReportChartItem(_1835.CustomReportPropertyItem):
    """CustomReportChartItem
    ...
    @property
    def point_shape(self: "Self") -> "_1811.SMTChartPointShape":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.utility.report._1811", "SMTChartPointShape"
        )(value)

    @point_shape.setter
    @enforce_parameter_types
    def point_shape(self: "Self", value: "_1811.SMTChartPointShape") -> None:
