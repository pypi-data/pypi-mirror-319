...
if TYPE_CHECKING:
    ...
    from mastapy._private.utility.property import _1904, _1905, _1906, _1907, _1908
...
TMeasurement = TypeVar("TMeasurement", bound="_1666.MeasurementBase")
T = TypeVar("T")
...
class _Cast_DutyCyclePropertySummary:
    ...
    def duty_cycle_property_summary_force(
        self: "CastSelf",
    ) -> "_1904.DutyCyclePropertySummaryForce":
        from mastapy._private.utility.property import _1904

        return self.__parent__._cast(_1904.DutyCyclePropertySummaryForce)

    @property
    def duty_cycle_property_summary_percentage(
        self: "CastSelf",
    ) -> "_1905.DutyCyclePropertySummaryPercentage":
        from mastapy._private.utility.property import _1905

        return self.__parent__._cast(_1905.DutyCyclePropertySummaryPercentage)

    @property
    def duty_cycle_property_summary_small_angle(
        self: "CastSelf",
    ) -> "_1906.DutyCyclePropertySummarySmallAngle":
        from mastapy._private.utility.property import _1906

        return self.__parent__._cast(_1906.DutyCyclePropertySummarySmallAngle)

    @property
    def duty_cycle_property_summary_stress(
        self: "CastSelf",
    ) -> "_1907.DutyCyclePropertySummaryStress":
        from mastapy._private.utility.property import _1907

        return self.__parent__._cast(_1907.DutyCyclePropertySummaryStress)

    @property
    def duty_cycle_property_summary_very_short_length(
        self: "CastSelf",
    ) -> "_1908.DutyCyclePropertySummaryVeryShortLength":
        from mastapy._private.utility.property import _1908

        return self.__parent__._cast(_1908.DutyCyclePropertySummaryVeryShortLength)
