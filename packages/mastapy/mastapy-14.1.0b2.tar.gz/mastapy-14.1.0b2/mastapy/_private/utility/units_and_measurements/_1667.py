...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class MeasurementSettings(_1654.PerMachineSettings):
    """MeasurementSettings
    ...
    @enforce_parameter_types
    def selected_measurement(self: "Self", value: "_1666.MeasurementBase") -> None:
        wrapper_type = (
    ...
    @property
    def current_selected_measurement(self: "Self") -> "_1666.MeasurementBase":
    ...
    @enforce_parameter_types
    def find_measurement_by_name(self: "Self", name: "str") -> "_1666.MeasurementBase":
        """mastapy.utility.units_and_measurements.MeasurementBase
    ...
    @enforce_parameter_types
    def get_measurement(
        self: "Self", measurement_type: "_7724.MeasurementType"
    ) -> "_1666.MeasurementBase":
        """mastapy.utility.units_and_measurements.MeasurementBase
