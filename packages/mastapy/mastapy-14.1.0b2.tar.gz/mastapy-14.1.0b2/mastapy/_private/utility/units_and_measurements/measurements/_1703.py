...
class _Cast_Force:
    ...
    @property
    def measurement_base(self: "CastSelf") -> "_1666.MeasurementBase":
        return self.__parent__._cast(_1666.MeasurementBase)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class Force(_1666.MeasurementBase):
    """Force
    ...
    @property
    def kilograms_force(self: "Self") -> "_1671.Unit":
    ...
    @property
    def kilonewtons(self: "Self") -> "_1671.Unit":
        """mastapy.utility.units_and_measurements.Unit
    ...
    @property
    def millinewtons(self: "Self") -> "_1671.Unit":
        """mastapy.utility.units_and_measurements.Unit
    ...
    @property
    def newtons(self: "Self") -> "_1671.Unit":
        """mastapy.utility.units_and_measurements.Unit
    ...
    @property
    def ounces_force(self: "Self") -> "_1671.Unit":
        """mastapy.utility.units_and_measurements.Unit
    ...
    @property
    def pounds_force(self: "Self") -> "_1671.Unit":
        """mastapy.utility.units_and_measurements.Unit
