...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class LengthShort(_1666.MeasurementBase):
    """LengthShort
    ...
    @property
    def inches(self: "Self") -> "_1671.Unit":
        """mastapy.utility.units_and_measurements.Unit
    ...
    @property
    def metres(self: "Self") -> "_1671.Unit":
        """mastapy.utility.units_and_measurements.Unit
    ...
    @property
    def micrometres(self: "Self") -> "_1671.Unit":
        """mastapy.utility.units_and_measurements.Unit
    ...
    @property
    def millimetres(self: "Self") -> "_1671.Unit":
        """mastapy.utility.units_and_measurements.Unit
    ...
    @property
    def thousandths_of_an_inch(self: "Self") -> "_1671.Unit":
        """mastapy.utility.units_and_measurements.Unit
