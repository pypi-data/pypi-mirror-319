...
from mastapy._private.bearings.tolerances import _1990
...
class EnumWithSelectedValue_SupportToleranceLocationDesignation(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_SupportToleranceLocationDesignation]",
    ) -> "_1990.SupportToleranceLocationDesignation":
        ...
        Returns:
            _1990.SupportToleranceLocationDesignation
        """
        return _1990.SupportToleranceLocationDesignation
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1990.SupportToleranceLocationDesignation.type_()

    @property
    def selected_value(self: "Self") -> "_1990.SupportToleranceLocationDesignation":
    ...
    def available_values(
        self: "Self",
    ) -> "List[_1990.SupportToleranceLocationDesignation]":
