...
class Overridable_CylindricalRollerMaxAxialLoadMethod(mixins.OverridableMixin, Enum):
    ...
    def wrapped_type(
        cls: "Type[Overridable_CylindricalRollerMaxAxialLoadMethod]",
    ) -> "_2010.CylindricalRollerMaxAxialLoadMethod":
        ...
        Returns:
            _2010.CylindricalRollerMaxAxialLoadMethod
        """
        return _2010.CylindricalRollerMaxAxialLoadMethod
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2010.CylindricalRollerMaxAxialLoadMethod.type_()

    @property
    def value(self: "Self") -> "_2010.CylindricalRollerMaxAxialLoadMethod":
    ...
    @property
    def override_value(self: "Self") -> "_2010.CylindricalRollerMaxAxialLoadMethod":
        """mastapy.bearings.bearing_results.CylindricalRollerMaxAxialLoadMethod
    ...
    @property
    def calculated_value(self: "Self") -> "_2010.CylindricalRollerMaxAxialLoadMethod":
        """mastapy.bearings.bearing_results.CylindricalRollerMaxAxialLoadMethod
