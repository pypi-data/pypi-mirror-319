...
class EnumWithSelectedValue_DynamicsResponse3DChartType(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_DynamicsResponse3DChartType]",
    ) -> "_4732.DynamicsResponse3DChartType":
        ...
        Returns:
            _4732.DynamicsResponse3DChartType
        """
        return _4732.DynamicsResponse3DChartType
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _4732.DynamicsResponse3DChartType.type_()

    @property
    def selected_value(self: "Self") -> "_4732.DynamicsResponse3DChartType":
    ...
    @property
    def available_values(self: "Self") -> "List[_4732.DynamicsResponse3DChartType]":
