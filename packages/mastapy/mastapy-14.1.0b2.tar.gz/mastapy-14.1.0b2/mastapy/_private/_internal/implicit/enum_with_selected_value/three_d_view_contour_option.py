...
class EnumWithSelectedValue_ThreeDViewContourOption(
    ...
    def wrapped_type(
        ...
        Returns:
            _1887.ThreeDViewContourOption
        """
        return _1887.ThreeDViewContourOption
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1887.ThreeDViewContourOption.type_()

    @property
    def selected_value(self: "Self") -> "_1887.ThreeDViewContourOption":
    ...
    @property
    def available_values(self: "Self") -> "List[_1887.ThreeDViewContourOption]":
