...
class EnumWithSelectedValue_StressConcentrationMethod(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_StressConcentrationMethod]",
    ) -> "_2177.StressConcentrationMethod":
        ...
        Returns:
            _2177.StressConcentrationMethod
        """
        return _2177.StressConcentrationMethod
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2177.StressConcentrationMethod.type_()

    @property
    def selected_value(self: "Self") -> "_2177.StressConcentrationMethod":
    ...
    @property
    def available_values(self: "Self") -> "List[_2177.StressConcentrationMethod]":
