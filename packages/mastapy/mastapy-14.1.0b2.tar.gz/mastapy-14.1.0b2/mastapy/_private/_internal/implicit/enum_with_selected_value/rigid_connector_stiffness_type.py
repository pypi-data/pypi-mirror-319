...
class EnumWithSelectedValue_RigidConnectorStiffnessType(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_RigidConnectorStiffnessType]",
    ) -> "_2670.RigidConnectorStiffnessType":
        ...
        Returns:
            _2670.RigidConnectorStiffnessType
        """
        return _2670.RigidConnectorStiffnessType
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2670.RigidConnectorStiffnessType.type_()

    @property
    def selected_value(self: "Self") -> "_2670.RigidConnectorStiffnessType":
    ...
    @property
    def available_values(self: "Self") -> "List[_2670.RigidConnectorStiffnessType]":
