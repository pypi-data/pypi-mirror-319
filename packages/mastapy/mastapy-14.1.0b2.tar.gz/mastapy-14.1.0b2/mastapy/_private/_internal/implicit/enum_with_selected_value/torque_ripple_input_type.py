...
class EnumWithSelectedValue_TorqueRippleInputType(
    ...
    def wrapped_type(
        ...
        Returns:
            _7670.TorqueRippleInputType
        """
        return _7670.TorqueRippleInputType
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _7670.TorqueRippleInputType.type_()

    @property
    def selected_value(self: "Self") -> "_7670.TorqueRippleInputType":
    ...
    @property
    def available_values(self: "Self") -> "List[_7670.TorqueRippleInputType]":
