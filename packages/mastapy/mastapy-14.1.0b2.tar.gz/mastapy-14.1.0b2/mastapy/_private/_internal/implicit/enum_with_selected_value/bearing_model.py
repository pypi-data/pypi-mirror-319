...
class EnumWithSelectedValue_BearingModel(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_BearingModel]") -> "Any":
        ...
        Returns:
            Any
        """
        return _1944.BearingModel.type_()

    @property
    def selected_value(self: "Self") -> "_1944.BearingModel":
    ...
    @property
    def available_values(self: "Self") -> "List[_1944.BearingModel]":
