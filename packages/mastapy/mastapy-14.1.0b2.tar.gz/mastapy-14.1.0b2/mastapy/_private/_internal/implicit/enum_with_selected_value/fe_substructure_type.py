...
class EnumWithSelectedValue_FESubstructureType(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    def wrapped_type(
        ...
        Returns:
            _2458.FESubstructureType
        """
        return _2458.FESubstructureType
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_FESubstructureType]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2458.FESubstructureType.type_()

    @property
    def selected_value(self: "Self") -> "_2458.FESubstructureType":
    ...
    @property
    def available_values(self: "Self") -> "List[_2458.FESubstructureType]":
