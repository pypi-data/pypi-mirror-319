...
class EnumWithSelectedValue_DestinationDesignState(
    ...
    def wrapped_type(
        ...
        Returns:
            _7685.DestinationDesignState
        """
        return _7685.DestinationDesignState
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _7685.DestinationDesignState.type_()

    @property
    def selected_value(self: "Self") -> "_7685.DestinationDesignState":
    ...
    @property
    def available_values(self: "Self") -> "List[_7685.DestinationDesignState]":
