...
from mastapy._private.utility.enums import _1888
...
class EnumWithSelectedValue_ThreeDViewContourOptionFirstSelection(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_ThreeDViewContourOptionFirstSelection]",
    ) -> "_1888.ThreeDViewContourOptionFirstSelection":
        ...
        Returns:
            _1888.ThreeDViewContourOptionFirstSelection
        """
        return _1888.ThreeDViewContourOptionFirstSelection
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1888.ThreeDViewContourOptionFirstSelection.type_()

    @property
    def selected_value(self: "Self") -> "_1888.ThreeDViewContourOptionFirstSelection":
    ...
    def available_values(
        self: "Self",
    ) -> "List[_1888.ThreeDViewContourOptionFirstSelection]":
