...
class EnumWithSelectedValue_RigidConnectorTypes(
    ...
    def wrapped_type(
        ...
        Returns:
            _2674.RigidConnectorTypes
        """
        return _2674.RigidConnectorTypes
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_RigidConnectorTypes]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2674.RigidConnectorTypes.type_()

    @property
    def selected_value(self: "Self") -> "_2674.RigidConnectorTypes":
    ...
    @property
    def available_values(self: "Self") -> "List[_2674.RigidConnectorTypes]":
