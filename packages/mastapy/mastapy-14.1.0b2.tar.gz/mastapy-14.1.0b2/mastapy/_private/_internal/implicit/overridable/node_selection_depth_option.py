...
class Overridable_NodeSelectionDepthOption(mixins.OverridableMixin, Enum):
    ...
    def wrapped_type(
    ...
    ) -> "_2472.NodeSelectionDepthOption":
        ...
        Returns:
            _2472.NodeSelectionDepthOption
        """
        return _2472.NodeSelectionDepthOption
    ...
    def implicit_type(cls: "Type[Overridable_NodeSelectionDepthOption]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2472.NodeSelectionDepthOption.type_()

    @property
    def value(self: "Self") -> "_2472.NodeSelectionDepthOption":
    ...
    @property
    def override_value(self: "Self") -> "_2472.NodeSelectionDepthOption":
        """mastapy.system_model.fe.NodeSelectionDepthOption
    ...
    @property
    def calculated_value(self: "Self") -> "_2472.NodeSelectionDepthOption":
        """mastapy.system_model.fe.NodeSelectionDepthOption
