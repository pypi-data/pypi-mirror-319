...
class EnumWithSelectedValue_LinkNodeSource(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_LinkNodeSource]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2468.LinkNodeSource.type_()

    @property
    def selected_value(self: "Self") -> "_2468.LinkNodeSource":
    ...
    @property
    def available_values(self: "Self") -> "List[_2468.LinkNodeSource]":
