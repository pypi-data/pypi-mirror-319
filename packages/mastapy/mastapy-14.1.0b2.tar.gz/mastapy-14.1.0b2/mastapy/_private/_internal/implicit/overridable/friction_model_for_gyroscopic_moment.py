...
class Overridable_FrictionModelForGyroscopicMoment(mixins.OverridableMixin, Enum):
    ...
    def wrapped_type(
        ...
        Returns:
            _2040.FrictionModelForGyroscopicMoment
        """
        return _2040.FrictionModelForGyroscopicMoment
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2040.FrictionModelForGyroscopicMoment.type_()

    @property
    def value(self: "Self") -> "_2040.FrictionModelForGyroscopicMoment":
    ...
    @property
    def override_value(self: "Self") -> "_2040.FrictionModelForGyroscopicMoment":
        """mastapy.bearings.bearing_results.rolling.FrictionModelForGyroscopicMoment
    ...
    @property
    def calculated_value(self: "Self") -> "_2040.FrictionModelForGyroscopicMoment":
        """mastapy.bearings.bearing_results.rolling.FrictionModelForGyroscopicMoment
