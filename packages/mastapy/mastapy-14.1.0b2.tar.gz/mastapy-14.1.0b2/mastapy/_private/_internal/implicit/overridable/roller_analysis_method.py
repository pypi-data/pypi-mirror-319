...
from mastapy._private.bearings.bearing_results.rolling import _2137
...
class Overridable_RollerAnalysisMethod(mixins.OverridableMixin, Enum):
    ...
    def wrapped_type(
        ...
        Returns:
            _2137.RollerAnalysisMethod
        """
        return _2137.RollerAnalysisMethod
    ...
    def implicit_type(cls: "Type[Overridable_RollerAnalysisMethod]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2137.RollerAnalysisMethod.type_()

    @property
    def value(self: "Self") -> "_2137.RollerAnalysisMethod":
    ...
    @property
    def override_value(self: "Self") -> "_2137.RollerAnalysisMethod":
        """mastapy.bearings.bearing_results.rolling.RollerAnalysisMethod
    ...
    @property
    def calculated_value(self: "Self") -> "_2137.RollerAnalysisMethod":
        """mastapy.bearings.bearing_results.rolling.RollerAnalysisMethod
