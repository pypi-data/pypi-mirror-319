...
from mastapy._private.system_model.part_model import _2548
...
class EnumWithSelectedValue_ShaftDiameterModificationDueToRollingBearingRing(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_ShaftDiameterModificationDueToRollingBearingRing]",
    ) -> "_2548.ShaftDiameterModificationDueToRollingBearingRing":
        ...
        Returns:
            _2548.ShaftDiameterModificationDueToRollingBearingRing
        """
        return _2548.ShaftDiameterModificationDueToRollingBearingRing
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2548.ShaftDiameterModificationDueToRollingBearingRing.type_()
    ...
    def available_values(
        self: "Self",
    ) -> "List[_2548.ShaftDiameterModificationDueToRollingBearingRing]":
