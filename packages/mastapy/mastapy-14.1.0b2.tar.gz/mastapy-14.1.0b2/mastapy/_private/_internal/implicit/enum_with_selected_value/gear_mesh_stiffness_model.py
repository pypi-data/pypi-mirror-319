...
class EnumWithSelectedValue_GearMeshStiffnessModel(
    ...
    def wrapped_type(
        ...
        Returns:
            _5557.GearMeshStiffnessModel
        """
        return _5557.GearMeshStiffnessModel
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _5557.GearMeshStiffnessModel.type_()

    @property
    def selected_value(self: "Self") -> "_5557.GearMeshStiffnessModel":
    ...
    @property
    def available_values(self: "Self") -> "List[_5557.GearMeshStiffnessModel]":
