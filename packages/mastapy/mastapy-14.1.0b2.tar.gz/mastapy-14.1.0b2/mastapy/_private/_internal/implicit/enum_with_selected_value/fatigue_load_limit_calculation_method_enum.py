...
from mastapy._private.bearings.bearing_designs.rolling import _2220
...
class EnumWithSelectedValue_FatigueLoadLimitCalculationMethodEnum(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_FatigueLoadLimitCalculationMethodEnum]",
    ) -> "_2220.FatigueLoadLimitCalculationMethodEnum":
        ...
        Returns:
            _2220.FatigueLoadLimitCalculationMethodEnum
        """
        return _2220.FatigueLoadLimitCalculationMethodEnum
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2220.FatigueLoadLimitCalculationMethodEnum.type_()

    @property
    def selected_value(self: "Self") -> "_2220.FatigueLoadLimitCalculationMethodEnum":
    ...
    def available_values(
        self: "Self",
    ) -> "List[_2220.FatigueLoadLimitCalculationMethodEnum]":
