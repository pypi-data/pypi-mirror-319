...
class ListWithSelectedItem_CylindricalGearSet(
    _2601.CylindricalGearSet, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_CylindricalGearSet]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2601.CylindricalGearSet.TYPE

    @property
    def selected_value(self: "Self") -> "_2601.CylindricalGearSet":
    ...
    @property
    def available_values(self: "Self") -> "List[_2601.CylindricalGearSet]":
