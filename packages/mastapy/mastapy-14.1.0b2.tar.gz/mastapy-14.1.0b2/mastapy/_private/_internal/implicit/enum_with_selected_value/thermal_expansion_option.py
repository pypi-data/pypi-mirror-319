...
from mastapy._private.system_model.fe import _2481
...
class EnumWithSelectedValue_ThermalExpansionOption(
    ...
    def wrapped_type(
        ...
        Returns:
            _2481.ThermalExpansionOption
        """
        return _2481.ThermalExpansionOption
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2481.ThermalExpansionOption.type_()

    @property
    def selected_value(self: "Self") -> "_2481.ThermalExpansionOption":
    ...
    @property
    def available_values(self: "Self") -> "List[_2481.ThermalExpansionOption]":
