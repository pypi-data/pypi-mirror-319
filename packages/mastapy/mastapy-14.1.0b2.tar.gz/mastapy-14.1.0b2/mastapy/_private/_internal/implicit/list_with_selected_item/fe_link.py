...
class ListWithSelectedItem_FELink(_2488.FELink, mixins.ListWithSelectedItemMixin):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_FELink]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2488.FELink.TYPE

    @property
    def selected_value(self: "Self") -> "_2488.FELink":
    ...
    @property
    def available_values(self: "Self") -> "List[_2488.FELink]":
