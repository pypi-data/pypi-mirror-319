...
class ListWithSelectedItem_AcousticAnalysisSetup(
    _2704.AcousticAnalysisSetup, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_AcousticAnalysisSetup]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2704.AcousticAnalysisSetup.TYPE

    @property
    def selected_value(self: "Self") -> "_2704.AcousticAnalysisSetup":
    ...
    @property
    def available_values(self: "Self") -> "List[_2704.AcousticAnalysisSetup]":
