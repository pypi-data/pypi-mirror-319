...
class EnumWithSelectedValue_ComponentOrientationOption(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_ComponentOrientationOption]",
    ) -> "_2435.ComponentOrientationOption":
        ...
        Returns:
            _2435.ComponentOrientationOption
        """
        return _2435.ComponentOrientationOption
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2435.ComponentOrientationOption.type_()

    @property
    def selected_value(self: "Self") -> "_2435.ComponentOrientationOption":
    ...
    @property
    def available_values(self: "Self") -> "List[_2435.ComponentOrientationOption]":
