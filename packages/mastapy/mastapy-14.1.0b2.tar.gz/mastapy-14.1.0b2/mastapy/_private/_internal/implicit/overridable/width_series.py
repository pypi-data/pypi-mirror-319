...
from mastapy._private.bearings.bearing_designs.rolling import _2244
...
class Overridable_WidthSeries(mixins.OverridableMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls: "Type[Overridable_WidthSeries]") -> "_2244.WidthSeries":
    ...
    def implicit_type(cls: "Type[Overridable_WidthSeries]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2244.WidthSeries.type_()

    @property
    def value(self: "Self") -> "_2244.WidthSeries":
    ...
    @property
    def override_value(self: "Self") -> "_2244.WidthSeries":
        """mastapy.bearings.bearing_designs.rolling.WidthSeries
    ...
    @property
    def calculated_value(self: "Self") -> "_2244.WidthSeries":
        """mastapy.bearings.bearing_designs.rolling.WidthSeries
