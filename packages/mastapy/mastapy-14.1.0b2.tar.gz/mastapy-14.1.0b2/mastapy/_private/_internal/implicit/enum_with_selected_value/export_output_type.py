...
class EnumWithSelectedValue_ExportOutputType(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_ExportOutputType]") -> "Any":
        ...
        Returns:
            Any
        """
        return _5871.ExportOutputType.type_()

    @property
    def selected_value(self: "Self") -> "_5871.ExportOutputType":
    ...
    @property
    def available_values(self: "Self") -> "List[_5871.ExportOutputType]":
