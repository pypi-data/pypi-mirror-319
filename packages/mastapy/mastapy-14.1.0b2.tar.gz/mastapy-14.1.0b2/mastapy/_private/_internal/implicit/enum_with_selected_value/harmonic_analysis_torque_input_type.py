...
class EnumWithSelectedValue_HarmonicAnalysisTorqueInputType(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_HarmonicAnalysisTorqueInputType]",
    ) -> "_5895.HarmonicAnalysisTorqueInputType":
        ...
        Returns:
            _5895.HarmonicAnalysisTorqueInputType
        """
        return _5895.HarmonicAnalysisTorqueInputType
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _5895.HarmonicAnalysisTorqueInputType.type_()

    @property
    def selected_value(self: "Self") -> "_5895.HarmonicAnalysisTorqueInputType":
    ...
    @property
    def available_values(self: "Self") -> "List[_5895.HarmonicAnalysisTorqueInputType]":
