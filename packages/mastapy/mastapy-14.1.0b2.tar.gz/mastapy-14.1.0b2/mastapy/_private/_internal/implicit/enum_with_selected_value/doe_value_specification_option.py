...
class EnumWithSelectedValue_DoeValueSpecificationOption(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_DoeValueSpecificationOption]",
    ) -> "_4451.DoeValueSpecificationOption":
        ...
        Returns:
            _4451.DoeValueSpecificationOption
        """
        return _4451.DoeValueSpecificationOption
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _4451.DoeValueSpecificationOption.type_()

    @property
    def selected_value(self: "Self") -> "_4451.DoeValueSpecificationOption":
    ...
    @property
    def available_values(self: "Self") -> "List[_4451.DoeValueSpecificationOption]":
