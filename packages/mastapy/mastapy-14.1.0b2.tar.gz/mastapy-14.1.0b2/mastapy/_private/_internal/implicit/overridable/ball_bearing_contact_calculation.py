...
class Overridable_BallBearingContactCalculation(mixins.OverridableMixin, Enum):
    ...
    def wrapped_type(
        ...
        Returns:
            _2035.BallBearingContactCalculation
        """
        return _2035.BallBearingContactCalculation
    ...
    def implicit_type(cls: "Type[Overridable_BallBearingContactCalculation]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2035.BallBearingContactCalculation.type_()

    @property
    def value(self: "Self") -> "_2035.BallBearingContactCalculation":
    ...
    @property
    def override_value(self: "Self") -> "_2035.BallBearingContactCalculation":
        """mastapy.bearings.bearing_results.rolling.BallBearingContactCalculation
    ...
    @property
    def calculated_value(self: "Self") -> "_2035.BallBearingContactCalculation":
        """mastapy.bearings.bearing_results.rolling.BallBearingContactCalculation
