...
class EnumWithSelectedValue_BearingToleranceDefinitionOptions(
    ...
    def wrapped_type(
        ...
        Returns:
            _1971.BearingToleranceDefinitionOptions
        """
        return _1971.BearingToleranceDefinitionOptions
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1971.BearingToleranceDefinitionOptions.type_()

    @property
    def selected_value(self: "Self") -> "_1971.BearingToleranceDefinitionOptions":
    ...
    def available_values(
        self: "Self",
    ) -> "List[_1971.BearingToleranceDefinitionOptions]":
