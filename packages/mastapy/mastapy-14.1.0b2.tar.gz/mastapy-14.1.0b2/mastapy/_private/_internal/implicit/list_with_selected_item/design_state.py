...
class ListWithSelectedItem_DesignState(
    _5788.DesignState, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_DesignState]") -> "Any":
        ...
        Returns:
            Any
        """
        return _5788.DesignState.TYPE

    @property
    def selected_value(self: "Self") -> "_5788.DesignState":
    ...
    @property
    def available_values(self: "Self") -> "List[_5788.DesignState]":
