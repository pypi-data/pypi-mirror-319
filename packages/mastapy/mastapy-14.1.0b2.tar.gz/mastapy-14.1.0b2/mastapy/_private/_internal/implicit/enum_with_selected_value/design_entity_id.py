...
class EnumWithSelectedValue_DesignEntityId(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_DesignEntityId]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2273.DesignEntityId.type_()

    @property
    def selected_value(self: "Self") -> "_2273.DesignEntityId":
    ...
    @property
    def available_values(self: "Self") -> "List[_2273.DesignEntityId]":
