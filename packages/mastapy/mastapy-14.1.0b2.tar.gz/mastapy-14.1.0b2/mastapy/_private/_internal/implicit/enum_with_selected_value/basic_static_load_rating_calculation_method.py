...
class EnumWithSelectedValue_BasicStaticLoadRatingCalculationMethod(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_BasicStaticLoadRatingCalculationMethod]",
    ) -> "_1938.BasicStaticLoadRatingCalculationMethod":
        ...
        Returns:
            _1938.BasicStaticLoadRatingCalculationMethod
        """
        return _1938.BasicStaticLoadRatingCalculationMethod
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1938.BasicStaticLoadRatingCalculationMethod.type_()

    @property
    def selected_value(self: "Self") -> "_1938.BasicStaticLoadRatingCalculationMethod":
    ...
    def available_values(
        self: "Self",
    ) -> "List[_1938.BasicStaticLoadRatingCalculationMethod]":
