...
from mastapy._private.system_model.analyses_and_results.static_loads import _7561
...
class ListWithSelectedItem_ElectricMachineDataImportType(
    ...
    def wrapped_type(
        cls: "Type[ListWithSelectedItem_ElectricMachineDataImportType]",
    ) -> "_7561.ElectricMachineDataImportType":
        ...
        Returns:
            _7561.ElectricMachineDataImportType
        """
        return _7561.ElectricMachineDataImportType
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _7561.ElectricMachineDataImportType.type_()
