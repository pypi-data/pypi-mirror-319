...
class ListWithSelectedItem_FESubstructure(
    _2453.FESubstructure, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_FESubstructure]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2453.FESubstructure.TYPE

    @property
    def selected_value(self: "Self") -> "_2453.FESubstructure":
    ...
    @property
    def available_values(self: "Self") -> "List[_2453.FESubstructure]":
