...
class Overridable_UnbalancedMassInclusionOption(mixins.OverridableMixin, Enum):
    ...
    def wrapped_type(
        ...
        Returns:
            _2551.UnbalancedMassInclusionOption
        """
        return _2551.UnbalancedMassInclusionOption
    ...
    def implicit_type(cls: "Type[Overridable_UnbalancedMassInclusionOption]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2551.UnbalancedMassInclusionOption.type_()

    @property
    def value(self: "Self") -> "_2551.UnbalancedMassInclusionOption":
    ...
    @property
    def override_value(self: "Self") -> "_2551.UnbalancedMassInclusionOption":
        """mastapy.system_model.part_model.UnbalancedMassInclusionOption
    ...
    @property
    def calculated_value(self: "Self") -> "_2551.UnbalancedMassInclusionOption":
        """mastapy.system_model.part_model.UnbalancedMassInclusionOption
