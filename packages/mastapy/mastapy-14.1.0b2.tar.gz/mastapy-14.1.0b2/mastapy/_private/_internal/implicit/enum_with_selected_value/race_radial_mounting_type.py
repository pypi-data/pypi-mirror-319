...
from mastapy._private.bearings.bearing_results import _2032
...
class EnumWithSelectedValue_RaceRadialMountingType(
    ...
    def wrapped_type(
        ...
        Returns:
            _2032.RaceRadialMountingType
        """
        return _2032.RaceRadialMountingType
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2032.RaceRadialMountingType.type_()

    @property
    def selected_value(self: "Self") -> "_2032.RaceRadialMountingType":
    ...
    @property
    def available_values(self: "Self") -> "List[_2032.RaceRadialMountingType]":
