...
class ListWithSelectedItem_CylindricalGear(
    _2600.CylindricalGear, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_CylindricalGear]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2600.CylindricalGear.TYPE

    @property
    def selected_value(self: "Self") -> "_2600.CylindricalGear":
    ...
    @property
    def available_values(self: "Self") -> "List[_2600.CylindricalGear]":
