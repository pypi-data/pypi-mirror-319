...
class EnumWithSelectedValue_ExcitationAnalysisViewOption(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_ExcitationAnalysisViewOption]",
    ) -> "_2331.ExcitationAnalysisViewOption":
        ...
        Returns:
            _2331.ExcitationAnalysisViewOption
        """
        return _2331.ExcitationAnalysisViewOption
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2331.ExcitationAnalysisViewOption.type_()

    @property
    def selected_value(self: "Self") -> "_2331.ExcitationAnalysisViewOption":
    ...
    @property
    def available_values(self: "Self") -> "List[_2331.ExcitationAnalysisViewOption]":
