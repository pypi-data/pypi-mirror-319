...
class EnumWithSelectedValue_RollerBearingProfileTypes(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_RollerBearingProfileTypes]",
    ) -> "_1958.RollerBearingProfileTypes":
        ...
        Returns:
            _1958.RollerBearingProfileTypes
        """
        return _1958.RollerBearingProfileTypes
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1958.RollerBearingProfileTypes.type_()

    @property
    def selected_value(self: "Self") -> "_1958.RollerBearingProfileTypes":
    ...
    @property
    def available_values(self: "Self") -> "List[_1958.RollerBearingProfileTypes]":
