...
class ListWithSelectedItem_Component(_2514.Component, mixins.ListWithSelectedItemMixin):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_Component]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2514.Component.TYPE

    @property
    def selected_value(self: "Self") -> "_2514.Component":
    ...
    @property
    def available_values(self: "Self") -> "List[_2514.Component]":
