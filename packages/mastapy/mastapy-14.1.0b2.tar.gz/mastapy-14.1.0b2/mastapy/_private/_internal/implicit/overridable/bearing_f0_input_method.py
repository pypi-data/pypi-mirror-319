...
class Overridable_BearingF0InputMethod(mixins.OverridableMixin, Enum):
    ...
    def wrapped_type(
        ...
        Returns:
            _2510.BearingF0InputMethod
        """
        return _2510.BearingF0InputMethod
    ...
    def implicit_type(cls: "Type[Overridable_BearingF0InputMethod]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2510.BearingF0InputMethod.type_()

    @property
    def value(self: "Self") -> "_2510.BearingF0InputMethod":
    ...
    @property
    def override_value(self: "Self") -> "_2510.BearingF0InputMethod":
        """mastapy.system_model.part_model.BearingF0InputMethod
    ...
    @property
    def calculated_value(self: "Self") -> "_2510.BearingF0InputMethod":
        """mastapy.system_model.part_model.BearingF0InputMethod
