...
class EnumWithSelectedValue_DampingSpecification(
    ...
    def wrapped_type(
        ...
        Returns:
            _5856.DampingSpecification
        """
        return _5856.DampingSpecification
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_DampingSpecification]") -> "Any":
        ...
        Returns:
            Any
        """
        return _5856.DampingSpecification.type_()

    @property
    def selected_value(self: "Self") -> "_5856.DampingSpecification":
    ...
    @property
    def available_values(self: "Self") -> "List[_5856.DampingSpecification]":
