...
class EnumWithSelectedValue_TorqueConverterLockupRule(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_TorqueConverterLockupRule]",
    ) -> "_5631.TorqueConverterLockupRule":
        ...
        Returns:
            _5631.TorqueConverterLockupRule
        """
        return _5631.TorqueConverterLockupRule
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _5631.TorqueConverterLockupRule.type_()

    @property
    def selected_value(self: "Self") -> "_5631.TorqueConverterLockupRule":
    ...
    @property
    def available_values(self: "Self") -> "List[_5631.TorqueConverterLockupRule]":
