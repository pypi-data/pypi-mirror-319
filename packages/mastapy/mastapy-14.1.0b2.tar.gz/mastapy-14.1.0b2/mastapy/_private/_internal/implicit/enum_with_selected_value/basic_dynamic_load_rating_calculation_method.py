...
class EnumWithSelectedValue_BasicDynamicLoadRatingCalculationMethod(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_BasicDynamicLoadRatingCalculationMethod]",
    ) -> "_1937.BasicDynamicLoadRatingCalculationMethod":
        ...
        Returns:
            _1937.BasicDynamicLoadRatingCalculationMethod
        """
        return _1937.BasicDynamicLoadRatingCalculationMethod
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1937.BasicDynamicLoadRatingCalculationMethod.type_()

    @property
    def selected_value(self: "Self") -> "_1937.BasicDynamicLoadRatingCalculationMethod":
    ...
    def available_values(
        self: "Self",
    ) -> "List[_1937.BasicDynamicLoadRatingCalculationMethod]":
