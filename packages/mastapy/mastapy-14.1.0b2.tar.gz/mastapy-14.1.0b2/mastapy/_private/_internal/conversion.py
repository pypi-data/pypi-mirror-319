...
def mp_to_pn_objects_in_dotnet_list(list_of_objects: "List[Any]") -> "Any":
    """Unwrap all mastapy objects to a C
...
def mp_to_pn_dict_float(mp_dict: "Dict[str, float]") -> "Any":
    """Convert a python dictionary to a C
...
def pn_to_mp_tuple(pn_tuple: "_SYSTEM.Tuple"):
    """Convert a C

    Args:
        pn_tuple (System.Tuple[...]): C
...
def pn_to_mp_list_float_2d(
    pn_list: _SYSTEM.Array[_SYSTEM.Double],
) -> "List[List[float]]":
