...
from mastapy._private.system_model.part_model import _2544, _2548
...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model import _2274, _2280, _2281, _2291, _2292, _2293
    ...
    from mastapy._private.system_model.database_access import _2333
    from mastapy._private.system_model.fe import _2430
    from mastapy._private.system_model.optimization.system_optimiser import _2308, _2309
    ...
    from mastapy._private.system_model.part_model.acoustics import _2706
    ...
    from mastapy._private.system_model_gui import _1913
    from mastapy._private.utility import _1642, _1643, _1660
    from mastapy._private.utility.model_validation import _1855
...
class Design(_0.APIBase):
    ...
    @property
    def masta_gui(self: "Self") -> "_1913.MASTAGUI":
    ...
    @enforce_parameter_types
    def gear_set_configuration(
        self: "Self", value: "_2587.ActiveGearSetDesignSelectionGroup"
    ) -> None:
    ...
    @enforce_parameter_types
    def input_power_load(self: "Self", value: "_2544.PowerLoad") -> None:
        wrapper_type = (
    ...
    @enforce_parameter_types
    def output_power_load(self: "Self", value: "_2544.PowerLoad") -> None:
        wrapper_type = (
            list_with_selected_item.ListWithSelectedItem_PowerLoad.wrapper_type()
        )
        enclosed_type = (
    ...
    @enforce_parameter_types
    def shaft_diameter_modification_due_to_rolling_bearing_rings(
        self: "Self", value: "_2548.ShaftDiameterModificationDueToRollingBearingRing"
    ) -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
    ...
    def thermal_expansion_for_grounded_nodes(
        self: "Self",
    ) -> "_2292.ThermalExpansionOptionForGroundedNodes":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model._2292",
    ...
    @enforce_parameter_types
    def thermal_expansion_for_grounded_nodes(
        self: "Self", value: "_2292.ThermalExpansionOptionForGroundedNodes"
    ) -> None:
        value = conversion.mp_to_pn_enum(
    ...
    def unbalanced_mass_inclusion(
        self: "Self",
    ) -> "_2551.UnbalancedMassInclusionOption":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.part_model._2551",
    ...
    @enforce_parameter_types
    def unbalanced_mass_inclusion(
        self: "Self", value: "_2551.UnbalancedMassInclusionOption"
    ) -> None:
        value = conversion.mp_to_pn_enum(
    ...
    def acoustic_analysis_setups(
        self: "Self",
    ) -> "_2706.AcousticAnalysisSetupCollection":
    ...
    @property
    def default_system_temperatures(self: "Self") -> "_2293.TransmissionTemperatureSet":
    ...
    @property
    def electric_machine_group(self: "Self") -> "_2280.MAAElectricMachineGroup":
    ...
    @property
    def fe_batch_operations(self: "Self") -> "_2430.BatchOperations":
    ...
    @property
    def file_save_details_all(self: "Self") -> "_1642.FileHistory":
    ...
    @property
    def file_save_details_most_recent(self: "Self") -> "_1643.FileHistoryItem":
    ...
    @property
    def skf_loss_moment_multipliers(self: "Self") -> "_1660.SKFLossMomentMultipliers":
    ...
    def selected_gear_set_selection_group(
        self: "Self",
    ) -> "_2587.ActiveGearSetDesignSelectionGroup":
    ...
    @property
    def settings(self: "Self") -> "_2274.DesignSettings":
    ...
    @property
    def system(self: "Self") -> "_2291.SystemReporting":
    ...
    @property
    def system_optimiser_details(self: "Self") -> "_2309.SystemOptimiserDetails":
    ...
    def bearing_detail_configurations(
        self: "Self",
    ) -> "List[_2698.BearingDetailConfiguration]":
    ...
    @property
    def design_configurations(self: "Self") -> "List[_2700.DesignConfiguration]":
    ...
    def fe_substructure_configurations(
        self: "Self",
    ) -> "List[_2695.ActiveFESubstructureSelectionGroup]":
    ...
    def gear_set_configurations(
        self: "Self",
    ) -> "List[_2587.ActiveGearSetDesignSelectionGroup]":
    ...
    def iso14179_settings_per_bearing_type(
        self: "Self",
    ) -> "List[_2044.ISO14179SettingsPerBearingType]":
    ...
    def shaft_detail_configurations(
        self: "Self",
    ) -> "List[_2697.ActiveShaftDesignSelectionGroup]":
    ...
    @property
    def databases(self: "Self") -> "_2333.Databases":
    ...
    @property
    def design_states(self: "Self") -> "List[_5788.DesignState]":
    ...
    @property
    def duty_cycles(self: "Self") -> "List[_5789.DutyCycle]":
    ...
    @property
    def gear_set_config(self: "Self") -> "_2608.GearSetConfiguration":
    ...
    @enforce_parameter_types
    def gear_set_config(self: "Self", value: "_2608.GearSetConfiguration") -> None:
        pythonnet_property_set(self.wrapped, "GearSetConfig", value.wrapped)

    @property
    def masta_settings(self: "Self") -> "_2281.MASTASettings":
    ...
    @property
    def root_assembly(self: "Self") -> "_2547.RootAssembly":
    ...
    @property
    def system_optimiser(self: "Self") -> "_2308.SystemOptimiser":
    ...
    def time_series_load_case_groups(
        self: "Self",
    ) -> "List[_5796.TimeSeriesLoadCaseGroup]":
    ...
    def add_synchroniser_shift_empty(self: "Self") -> "_3064.SynchroniserShift":
    ...
    @enforce_parameter_types
    def add_synchroniser_shift(self: "Self", name: "str") -> "_3064.SynchroniserShift":
        """mastapy.system_model.analyses_and_results.synchroniser_analysis.SynchroniserShift
    ...
    @enforce_parameter_types
    def design_state_named(self: "Self", name: "str") -> "_5788.DesignState":
        """mastapy.system_model.analyses_and_results.load_case_groups.DesignState
    ...
    @enforce_parameter_types
    def duty_cycle_named(self: "Self", name: "str") -> "_5789.DutyCycle":
        """mastapy.system_model.analyses_and_results.load_case_groups.DutyCycle
    ...
    def remove_bearing_from_database(
        self: "Self", rolling_bearing: "_2233.RollingBearing"
    ) -> None:
        """Method does not return.
    ...
    def remove_design_configuration(
        self: "Self", config: "_2700.DesignConfiguration"
    ) -> None:
        """Method does not return.
    ...
    def remove_gear_set_selection_group(
        self: "Self", group: "_2587.ActiveGearSetDesignSelectionGroup"
    ) -> None:
        """Method does not return.
    ...
    def remove_synchroniser_shift(
        self: "Self", shift: "_3064.SynchroniserShift"
    ) -> None:
        """Method does not return.
    ...
    @enforce_parameter_types
    def save(self: "Self", file_name: "str", save_results: "bool") -> "_1855.Status":
        """mastapy.utility.model_validation.Status
    ...
    def save_load_case_results(
        self: "Self", file_name: "str", load_cases: "List[_7495.LoadCase]"
    ) -> None:
        """Method does not return.
    ...
    def all_parts_of_type_assembly(self: "Self") -> "List[_2503.Assembly]":
    ...
    def load(
        file_path: "str",
        load_full_fe_option: "_1641.ExternalFullFEFileOption" = _1641.ExternalFullFEFileOption.MESH_AND_EXPANSION_VECTORS,
    ) -> "Design":
        """mastapy.system_model.Design
