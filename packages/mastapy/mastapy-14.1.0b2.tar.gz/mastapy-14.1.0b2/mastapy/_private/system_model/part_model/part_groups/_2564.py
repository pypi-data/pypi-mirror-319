...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.part_groups import _2559, _2562, _2565
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ParallelPartGroupSelection(_2563.ParallelPartGroup):
    """ParallelPartGroupSelection
    ...
    @property
    def design_measurements(self: "Self") -> "List[_2562.DesignMeasurements]":
