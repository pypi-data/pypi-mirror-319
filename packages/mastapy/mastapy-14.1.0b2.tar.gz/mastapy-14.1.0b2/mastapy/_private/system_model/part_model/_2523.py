...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class FEPart(_2506.AbstractShaftOrHousing):
    """FEPart
    ...
    @enforce_parameter_types
    def default_fe_substructure(self: "Self", value: "_2453.FESubstructure") -> None:
        wrapper_type = (
    ...
    def create_fe_substructure(self: "Self") -> "_2453.FESubstructure":
    ...
    def remove_fe_substructure(
        self: "Self", fe_substructure: "_2453.FESubstructure"
    ) -> "bool":
        """bool
