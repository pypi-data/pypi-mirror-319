...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="CylindricalGearLinearTrainCreationOptions._Cast_CylindricalGearLinearTrainCreationOptions",
    )
...
class _Cast_CylindricalGearLinearTrainCreationOptions:
    ...
    __parent__: "CylindricalGearLinearTrainCreationOptions"
...
class CylindricalGearLinearTrainCreationOptions(_0.APIBase):
    ...
    TYPE: ClassVar["Type"] = _CYLINDRICAL_GEAR_LINEAR_TRAIN_CREATION_OPTIONS
    ...
    def number_of_gears(self: "Self") -> "int":
        """int"""
        temp = pythonnet_property_get(self.wrapped, "NumberOfGears")
    ...
    @enforce_parameter_types
    def number_of_gears(self: "Self", value: "int") -> None:
        pythonnet_property_set(
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_CylindricalGearLinearTrainCreationOptions":
        """Cast to another type.

        Returns:
            _Cast_CylindricalGearLinearTrainCreationOptions
        """
        return _Cast_CylindricalGearLinearTrainCreationOptions(self)
