...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.gears import _2600, _2602, _2607
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class PlanetaryGearSet(_2601.CylindricalGearSet):
    """PlanetaryGearSet
    ...
    @property
    def phase_requirement(self: "Self") -> "_1105.PlanetGearSetPhaseRequirement":
    ...
    def phase_requirement(
        self: "Self", value: "_1105.PlanetGearSetPhaseRequirement"
    ) -> None:
    ...
    @property
    def annuluses(self: "Self") -> "List[_2600.CylindricalGear]":
    ...
    @property
    def planets(self: "Self") -> "List[_2602.CylindricalPlanetGear]":
    ...
    @property
    def suns(self: "Self") -> "List[_2600.CylindricalGear]":
        """List[mastapy.system_model.part_model.gears.CylindricalGear]
    ...
    def add_annulus(self: "Self") -> "_2600.CylindricalGear":
    ...
    def add_planet(self: "Self") -> "_2600.CylindricalGear":
        """mastapy.system_model.part_model.gears.CylindricalGear"""
    ...
    def add_sun(self: "Self") -> "_2600.CylindricalGear":
        """mastapy.system_model.part_model.gears.CylindricalGear"""
