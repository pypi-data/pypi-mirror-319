...
from mastapy._private.system_model.part_model.gears import _2600, _2601
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CylindricalGearFromCAD(_2578.MountableComponentFromCAD):
    """CylindricalGearFromCAD
    ...
    @enforce_parameter_types
    def existing_gear_set(self: "Self", value: "_2601.CylindricalGearSet") -> None:
    ...
    @meshing_gear.setter
    @enforce_parameter_types
    def meshing_gear(self: "Self", value: "_2600.CylindricalGear") -> None:
        wrapper_type = (
