...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.couplings import _2687, _2689
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class Synchroniser(_2549.SpecialisedAssembly):
    """Synchroniser
    ...
    @property
    def clutch_connection_left(self: "Self") -> "_2411.ClutchConnection":
    ...
    @property
    def clutch_connection_right(self: "Self") -> "_2411.ClutchConnection":
        """mastapy.system_model.connections_and_sockets.couplings.ClutchConnection
    ...
    @property
    def hub_and_sleeve(self: "Self") -> "_2689.SynchroniserSleeve":
    ...
    @property
    def left_cone(self: "Self") -> "_2687.SynchroniserHalf":
    ...
    @property
    def right_cone(self: "Self") -> "_2687.SynchroniserHalf":
        """mastapy.system_model.part_model.couplings.SynchroniserHalf
