...
from mastapy._private.system_model.part_model.acoustics import _2722
...
class _Cast_ResultPlaneOptions:
    ...
    @property
    def result_surface_options(self: "CastSelf") -> "_2722.ResultSurfaceOptions":
        return self.__parent__._cast(_2722.ResultSurfaceOptions)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ResultPlaneOptions(_2722.ResultSurfaceOptions):
    """ResultPlaneOptions
    ...
    @property
    def axis_for_plane_normal(self: "Self") -> "_1551.Axis":
    ...
    def axis_for_plane_normal(self: "Self", value: "_1551.Axis") -> None:
