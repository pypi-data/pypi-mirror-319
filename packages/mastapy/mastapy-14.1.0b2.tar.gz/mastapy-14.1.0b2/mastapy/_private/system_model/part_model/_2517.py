...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.connections_and_sockets import _2341, _2345
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class Connector(_2536.MountableComponent):
    """Connector
    ...
    @property
    def outer_component(self: "Self") -> "_2505.AbstractShaft":
    ...
    @property
    def outer_connection(self: "Self") -> "_2341.Connection":
    ...
    @property
    def outer_socket(self: "Self") -> "_2345.CylindricalSocket":
