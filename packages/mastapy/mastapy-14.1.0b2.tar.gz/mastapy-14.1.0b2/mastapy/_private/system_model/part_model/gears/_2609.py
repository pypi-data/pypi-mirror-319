...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.gears import _2598, _2605
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class HypoidGear(_2588.AGMAGleasonConicalGear):
    """HypoidGear
    ...
    @property
    def conical_gear_design(self: "Self") -> "_1017.HypoidGearDesign":
    ...
    @property
    def hypoid_gear_design(self: "Self") -> "_1017.HypoidGearDesign":
        """mastapy.gears.gear_designs.hypoid.HypoidGearDesign
