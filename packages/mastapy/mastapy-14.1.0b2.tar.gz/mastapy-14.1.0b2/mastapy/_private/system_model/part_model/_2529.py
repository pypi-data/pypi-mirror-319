...
from mastapy._private.bearings.tolerances import _1969, _1971
...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model import _2508, _2545
...
class _Cast_InternalClearanceTolerance:
    ...
    def axial_internal_clearance_tolerance(
        ...
        return self.__parent__._cast(_2508.AxialInternalClearanceTolerance)
    ...
    def radial_internal_clearance_tolerance(
        ...
        return self.__parent__._cast(_2545.RadialInternalClearanceTolerance)
...
class InternalClearanceTolerance(_0.APIBase):
    ...
    def clearance_class(self: "Self", value: "_1969.InternalClearanceClass") -> None:
