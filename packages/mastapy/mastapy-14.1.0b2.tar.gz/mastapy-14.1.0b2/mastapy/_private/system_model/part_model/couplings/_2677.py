...
from mastapy._private.system_model.part_model.couplings import _2670, _2673, _2674
...
if TYPE_CHECKING:
    ...
    from mastapy._private.detailed_rigid_connectors.splines import _1469, _1474
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ShaftHubConnection(_2517.Connector):
    """ShaftHubConnection
    ...
    @property
    def spline_type(self: "Self") -> "_1469.SplineDesignTypes":
    ...
    @spline_type.setter
    @enforce_parameter_types
    def spline_type(self: "Self", value: "_1469.SplineDesignTypes") -> None:
    ...
    @enforce_parameter_types
    def stiffness_type(
        self: "Self", value: "_2670.RigidConnectorStiffnessType"
    ) -> None:
    ...
    @property
    def tilt_stiffness_type(self: "Self") -> "_2671.RigidConnectorTiltStiffnessTypes":
    ...
    def tilt_stiffness_type(
        self: "Self", value: "_2671.RigidConnectorTiltStiffnessTypes"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.PartModel.Couplings.RigidConnectorTiltStiffnessTypes",
    ...
    @enforce_parameter_types
    def tooth_spacing_type(
        self: "Self", value: "_2673.RigidConnectorToothSpacingType"
    ) -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
    ...
    @type_.setter
    @enforce_parameter_types
    def type_(self: "Self", value: "_2674.RigidConnectorTypes") -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
    ...
    def external_half_manufacturing_error(
        self: "Self",
    ) -> "_2679.SplineHalfManufacturingError":
    ...
    @property
    def interference_fit_design(self: "Self") -> "_1504.InterferenceFitDesign":
    ...
    @property
    def left_flank_lead_relief(self: "Self") -> "_2680.SplineLeadRelief":
    ...
    @property
    def major_fit_options(self: "Self") -> "_2678.SplineFitOptions":
    ...
    @property
    def minor_fit_options(self: "Self") -> "_2678.SplineFitOptions":
        """mastapy.system_model.part_model.couplings.SplineFitOptions
    ...
    @property
    def right_flank_lead_relief(self: "Self") -> "_2680.SplineLeadRelief":
        """mastapy.system_model.part_model.couplings.SplineLeadRelief
    ...
    @property
    def spline_joint_design(self: "Self") -> "_1474.SplineJointDesign":
    ...
    @property
    def spline_pitch_error_options(self: "Self") -> "_2682.SplinePitchErrorOptions":
    ...
    @property
    def fit_options(self: "Self") -> "List[_2678.SplineFitOptions]":
    ...
    @property
    def lead_reliefs(self: "Self") -> "List[_2680.SplineLeadRelief]":
    ...
    def spline_half_manufacturing_errors(
        self: "Self",
    ) -> "List[_2679.SplineHalfManufacturingError]":
    ...
    def tooth_locations_external_spline_half(
        self: "Self",
    ) -> "List[_2672.RigidConnectorToothLocation]":
