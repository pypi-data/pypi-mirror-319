...
from mastapy._private.system_model import _2288
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class PowerLoad(_2552.VirtualComponent):
    """PowerLoad
    ...
    @enforce_parameter_types
    def electric_machine_detail_selector(
        self: "Self", value: "_1312.ElectricMachineDetail"
    ) -> None:
    ...
    def electric_machine_search_region_specification_method(
        self: "Self",
    ) -> "_2519.ElectricMachineSearchRegionSpecificationMethod":
    ...
    @enforce_parameter_types
    def electric_machine_search_region_specification_method(
        self: "Self", value: "_2519.ElectricMachineSearchRegionSpecificationMethod"
    ) -> None:
    ...
    @property
    def engine_fuel_consumption_grid(self: "Self") -> "_1624.GriddedSurfaceAccessor":
    ...
    @property
    def engine_torque_grid(self: "Self") -> "_1624.GriddedSurfaceAccessor":
        """mastapy.math_utility.measured_data.GriddedSurfaceAccessor"""
    ...
    @enforce_parameter_types
    def engine_torque_grid(self: "Self", value: "_1624.GriddedSurfaceAccessor") -> None:
    ...
    @enforce_parameter_types
    def power_load_type(self: "Self", value: "_2288.PowerLoadType") -> None:
    ...
    @property
    def oil_pump_detail(self: "Self") -> "_316.OilPumpDetail":
    ...
    @property
    def single_blade_details(self: "Self") -> "_2554.WindTurbineSingleBladeDetails":
