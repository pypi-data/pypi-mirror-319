...
from mastapy._private.system_model.part_model import _2505, _2525
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class Shaft(_2505.AbstractShaft):
    """Shaft
    ...
    @cad_model.setter
    @enforce_parameter_types
    def cad_model(self: "Self", value: "_2525.GuideDxfModel") -> None:
        wrapper_type = (
    ...
    @property
    def guide_image(self: "Self") -> "_2526.GuideImage":
    ...
    @property
    def fe_substructure_replacing_this(self: "Self") -> "_2453.FESubstructure":
    ...
    @enforce_parameter_types
    def mount_component(
        self: "Self", component: "_2536.MountableComponent", offset: "float"
    ) -> None:
        """Method does not return.
