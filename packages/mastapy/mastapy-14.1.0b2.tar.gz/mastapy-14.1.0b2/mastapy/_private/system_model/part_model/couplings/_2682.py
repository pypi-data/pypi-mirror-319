...
class SplinePitchErrorOptions(_0.APIBase):
    ...
    def pitch_error_input_type(
        self: "Self",
        value: "Union[_2681.SplinePitchErrorInputType, Tuple[_2681.SplinePitchErrorInputType, bool]]",
    ) -> None:
    ...
    @property
    def pitch_error_options_left_flank(self: "Self") -> "_2667.PitchErrorFlankOptions":
    ...
    @property
    def pitch_error_options_right_flank(self: "Self") -> "_2667.PitchErrorFlankOptions":
        """mastapy.system_model.part_model.couplings.PitchErrorFlankOptions
    ...
    @property
    def pitch_error_flank_options(self: "Self") -> "List[_2667.PitchErrorFlankOptions]":
