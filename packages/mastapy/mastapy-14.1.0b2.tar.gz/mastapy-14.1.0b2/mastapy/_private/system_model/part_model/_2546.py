...
class _Cast_RollingBearingElementLoadCase:
    ...
    @property
    def rolling_bearing_element(self: "CastSelf") -> "_2234.RollingBearingElement":
        return self.__parent__._cast(_2234.RollingBearingElement)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class RollingBearingElementLoadCase(_2234.RollingBearingElement):
    """RollingBearingElementLoadCase
