...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CylindricalGear(_2605.Gear):
    """CylindricalGear
    ...
    @property
    def active_gear_design(self: "Self") -> "_1050.CylindricalGearDesign":
    ...
    @property
    def cylindrical_gear_design(self: "Self") -> "_1050.CylindricalGearDesign":
        """mastapy.gears.gear_designs.cylindrical.CylindricalGearDesign
