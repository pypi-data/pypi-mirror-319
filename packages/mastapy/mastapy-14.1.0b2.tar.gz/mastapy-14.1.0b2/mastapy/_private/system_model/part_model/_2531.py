...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model import _2507, _2530
...
class LoadSharingSettings(_0.APIBase):
    ...
    @property
    def planetary_load_sharing(self: "Self") -> "_2530.LoadSharingModes":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.part_model._2530", "LoadSharingModes"
        )(value)

    @planetary_load_sharing.setter
    @enforce_parameter_types
    def planetary_load_sharing(self: "Self", value: "_2530.LoadSharingModes") -> None:
    ...
    def planetary_load_sharing_agma_application_level(
        self: "Self",
    ) -> "_2507.AGMALoadSharingTableApplicationLevel":
    ...
    @enforce_parameter_types
    def planetary_load_sharing_agma_application_level(
        self: "Self", value: "_2507.AGMALoadSharingTableApplicationLevel"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.PartModel.AGMALoadSharingTableApplicationLevel",
