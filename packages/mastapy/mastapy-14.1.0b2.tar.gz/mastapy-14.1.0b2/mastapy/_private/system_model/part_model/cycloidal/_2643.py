...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CycloidalAssembly(_2549.SpecialisedAssembly):
    """CycloidalAssembly
    ...
    @property
    def cycloidal_assembly_design(self: "Self") -> "_1512.CycloidalAssemblyDesign":
    ...
    @property
    def ring_pins(self: "Self") -> "_2645.RingPins":
    ...
    @property
    def known_designs(self: "Self") -> "List[_1512.CycloidalAssemblyDesign]":
    ...
    def add_disc(self: "Self") -> "_2644.CycloidalDisc":
    ...
    def design_named(self: "Self", name: "str") -> "_1512.CycloidalAssemblyDesign":
        """mastapy.cycloidal.CycloidalAssemblyDesign
    ...
    def set_active_cycloidal_assembly_design(
        self: "Self", cycloidal_assembly_design: "_1512.CycloidalAssemblyDesign"
    ) -> None:
        """Method does not return.
    ...
    def try_remove_design(
        self: "Self", design: "_1512.CycloidalAssemblyDesign"
    ) -> "bool":
        """bool
