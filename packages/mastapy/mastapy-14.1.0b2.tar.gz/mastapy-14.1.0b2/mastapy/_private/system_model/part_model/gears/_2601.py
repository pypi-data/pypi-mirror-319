...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.gears import _2600, _2617
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CylindricalGearSet(_2607.GearSet):
    """CylindricalGearSet
    ...
    def axial_contact_ratio_requirement(
        self: "Self",
        value: "Union[_340.ContactRatioRequirements, Tuple[_340.ContactRatioRequirements, bool]]",
    ) -> None:
    ...
    @property
    def active_gear_set_design(self: "Self") -> "_1066.CylindricalGearSetDesign":
    ...
    @property
    def cylindrical_gear_set_design(self: "Self") -> "_1066.CylindricalGearSetDesign":
        """mastapy.gears.gear_designs.cylindrical.CylindricalGearSetDesign
    ...
    @property
    def supercharger_rotor_set(self: "Self") -> "_2638.SuperchargerRotorSet":
    ...
    @property
    def cylindrical_gears(self: "Self") -> "List[_2600.CylindricalGear]":
    ...
    @property
    def cylindrical_meshes(self: "Self") -> "List[_2378.CylindricalGearMesh]":
    ...
    @property
    def gear_set_designs(self: "Self") -> "List[_1066.CylindricalGearSetDesign]":
    ...
    def add_gear(self: "Self") -> "_2600.CylindricalGear":
