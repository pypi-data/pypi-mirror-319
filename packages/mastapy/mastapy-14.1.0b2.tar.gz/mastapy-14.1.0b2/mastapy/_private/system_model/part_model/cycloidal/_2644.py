...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.connections_and_sockets.cycloidal import _2408
    from mastapy._private.system_model.part_model import _2506, _2514, _2531, _2540
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CycloidalDisc(_2505.AbstractShaft):
    """CycloidalDisc
    ...
    @property
    def cycloidal_disc_design(self: "Self") -> "_1513.CycloidalDiscDesign":
    ...
    @property
    def disc_material(self: "Self") -> "_288.Material":
    ...
    @property
    def load_sharing_settings(self: "Self") -> "_2531.LoadSharingSettings":
    ...
    def planetary_bearing_sockets(
        self: "Self",
    ) -> "List[_2408.CycloidalDiscPlanetaryBearingSocket]":
