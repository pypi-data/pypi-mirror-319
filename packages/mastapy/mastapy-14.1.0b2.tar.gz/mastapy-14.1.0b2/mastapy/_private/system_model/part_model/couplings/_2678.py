...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar("CastSelf", bound="SplineFitOptions._Cast_SplineFitOptions")
...
class _Cast_SplineFitOptions:
    ...
    __parent__: "SplineFitOptions"

    @property
    def spline_fit_options(self: "CastSelf") -> "SplineFitOptions":
...
class SplineFitOptions(_0.APIBase):
    ...
    TYPE: ClassVar["Type"] = _SPLINE_FIT_OPTIONS
    ...
    def contact_diameter_stiffness(self: "Self") -> "overridable.Overridable_float":
        """Overridable[float]"""
        temp = pythonnet_property_get(self.wrapped, "ContactDiameterStiffness")
    ...
    def contact_diameter_stiffness(
        ...
        pythonnet_property_set(self.wrapped, "ContactDiameterStiffness", value)

    @property
    def diameter_diametral_clearance(self: "Self") -> "overridable.Overridable_float":
        """Overridable[float]"""
        temp = pythonnet_property_get(self.wrapped, "DiameterDiametralClearance")
    ...
    def diameter_diametral_clearance(
        ...
        pythonnet_property_set(self.wrapped, "DiameterDiametralClearance", value)
    ...
    def use_fit_type(self: "Self") -> "bool":
        """bool"""
        temp = pythonnet_property_get(self.wrapped, "UseFitType")
    ...
    @use_fit_type.setter
    @enforce_parameter_types
    def use_fit_type(self: "Self", value: "bool") -> None:
        pythonnet_property_set(
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_SplineFitOptions":
        """Cast to another type.

        Returns:
            _Cast_SplineFitOptions
        """
        return _Cast_SplineFitOptions(self)
