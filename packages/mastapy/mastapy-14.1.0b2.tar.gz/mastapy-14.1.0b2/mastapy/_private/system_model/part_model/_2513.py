...
if TYPE_CHECKING:
    ...
    from mastapy._private.bolts import _1537
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class BoltedJoint(_2549.SpecialisedAssembly):
    """BoltedJoint
    ...
    @property
    def detailed_bolted_joint(self: "Self") -> "_1537.DetailedBoltedJointDesign":
