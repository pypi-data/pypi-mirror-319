...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.couplings import _2661, _2686
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class SynchroniserHalf(_2688.SynchroniserPart):
    """SynchroniserHalf
    ...
    @property
    def cones(self: "Self") -> "List[_2686.SynchroniserCone]":
