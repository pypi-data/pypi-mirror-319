...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class StraightBevelDiffGearSet(_2595.BevelGearSet):
    """StraightBevelDiffGearSet
    ...
    @property
    def straight_bevel_diff_gears(self: "Self") -> "List[_2620.StraightBevelDiffGear]":
    ...
    def straight_bevel_diff_meshes(
        self: "Self",
    ) -> "List[_2394.StraightBevelDiffGearMesh]":
