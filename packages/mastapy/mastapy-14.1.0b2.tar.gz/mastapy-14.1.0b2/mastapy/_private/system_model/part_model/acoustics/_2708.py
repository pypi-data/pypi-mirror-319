...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.acoustics import _2710, _2712
...
class AcousticInputSurfaceOptions(_0.APIBase):
    ...
    @property
    def fe_part_options(self: "Self") -> "List[_2710.FEPartInputSurfaceOptions]":
    ...
    @property
    def hole_meshes(self: "Self") -> "List[_2712.HoleInFaceGroup]":
