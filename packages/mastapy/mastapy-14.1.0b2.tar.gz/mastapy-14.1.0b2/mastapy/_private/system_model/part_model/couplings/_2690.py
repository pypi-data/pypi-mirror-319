...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.couplings import _2691, _2693
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class TorqueConverter(_2660.Coupling):
    """TorqueConverter
    ...
    @property
    def pump(self: "Self") -> "_2691.TorqueConverterPump":
    ...
    @property
    def turbine(self: "Self") -> "_2693.TorqueConverterTurbine":
