...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class SpiralBevelGear(_2594.BevelGear):
    """SpiralBevelGear
    ...
    @property
    def bevel_gear_design(self: "Self") -> "_1001.SpiralBevelGearDesign":
    ...
    @property
    def spiral_bevel_gear_design(self: "Self") -> "_1001.SpiralBevelGearDesign":
        """mastapy.gears.gear_designs.spiral_bevel.SpiralBevelGearDesign
