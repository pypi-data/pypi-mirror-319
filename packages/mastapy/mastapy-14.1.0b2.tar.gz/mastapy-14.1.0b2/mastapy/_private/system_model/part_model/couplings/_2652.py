...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.couplings import _2653, _2663, _2668
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class BeltDrive(_2549.SpecialisedAssembly):
    """BeltDrive
    ...
    @property
    def type_of_belt(self: "Self") -> "_2653.BeltDriveType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.part_model.couplings._2653", "BeltDriveType"
        )(value)

    @type_of_belt.setter
    @enforce_parameter_types
    def type_of_belt(self: "Self", value: "_2653.BeltDriveType") -> None:
    ...
    @property
    def belt_connections(self: "Self") -> "List[_2337.BeltConnection]":
    ...
    @property
    def pulleys(self: "Self") -> "List[_2668.Pulley]":
