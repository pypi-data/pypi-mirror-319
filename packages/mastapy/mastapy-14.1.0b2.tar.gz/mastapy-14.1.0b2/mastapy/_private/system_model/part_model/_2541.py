...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model import _2514, _2531, _2540
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class PlanetCarrier(_2536.MountableComponent):
    """PlanetCarrier
    ...
    @property
    def planetary_sockets(self: "Self") -> "List[_2357.PlanetarySocket]":
