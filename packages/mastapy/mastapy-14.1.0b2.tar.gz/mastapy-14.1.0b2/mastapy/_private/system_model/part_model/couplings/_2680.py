...
if TYPE_CHECKING:
    ...
    from mastapy._private.math_utility.stiffness_calculators import _1596
...
class _Cast_SplineLeadRelief:
    ...
    @property
    def rigid_connector_settings(self: "CastSelf") -> "_2669.RigidConnectorSettings":
        return self.__parent__._cast(_2669.RigidConnectorSettings)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class SplineLeadRelief(_2669.RigidConnectorSettings):
    """SplineLeadRelief
    ...
    @property
    def contact_position(self: "Self") -> "_1596.IndividualContactPosition":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.math_utility.stiffness_calculators._1596",
    ...
    @property
    def microgeometry_clearance_chart(self: "Self") -> "_1934.TwoDChartDefinition":
    ...
    @property
    def crowning(self: "Self") -> "_2662.CrowningSpecification":
