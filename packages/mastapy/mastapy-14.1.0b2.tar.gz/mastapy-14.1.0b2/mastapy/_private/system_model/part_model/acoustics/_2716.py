...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.acoustics import _2713, _2714, _2715
...
class _Cast_MeshedResultSurfaceBase:
    ...
    @property
    def meshed_result_surface(self: "CastSelf") -> "_2715.MeshedResultSurface":
        from mastapy._private.system_model.part_model.acoustics import _2715

        return self.__parent__._cast(_2715.MeshedResultSurface)
