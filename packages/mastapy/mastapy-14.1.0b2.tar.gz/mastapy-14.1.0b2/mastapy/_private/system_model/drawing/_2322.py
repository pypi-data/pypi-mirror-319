...
from mastapy._private.utility.enums import _1888, _1889
...
class _Cast_PartAnalysisCaseWithContourViewable:
    ...
    def abstract_system_deflection_viewable(
        self: "CastSelf",
    ) -> "_2312.AbstractSystemDeflectionViewable":
        from mastapy._private.system_model.drawing import _2312

        return self.__parent__._cast(_2312.AbstractSystemDeflectionViewable)

    @property
    def advanced_system_deflection_viewable(
        self: "CastSelf",
    ) -> "_2313.AdvancedSystemDeflectionViewable":
        from mastapy._private.system_model.drawing import _2313

        return self.__parent__._cast(_2313.AdvancedSystemDeflectionViewable)

    @property
    def dynamic_analysis_viewable(self: "CastSelf") -> "_2317.DynamicAnalysisViewable":
        from mastapy._private.system_model.drawing import _2317

        return self.__parent__._cast(_2317.DynamicAnalysisViewable)

    @property
    def harmonic_analysis_viewable(
        self: "CastSelf",
    ) -> "_2318.HarmonicAnalysisViewable":
        from mastapy._private.system_model.drawing import _2318

        return self.__parent__._cast(_2318.HarmonicAnalysisViewable)

    @property
    def modal_analysis_viewable(self: "CastSelf") -> "_2320.ModalAnalysisViewable":
        from mastapy._private.system_model.drawing import _2320

        return self.__parent__._cast(_2320.ModalAnalysisViewable)

    @property
    def system_deflection_viewable(
        self: "CastSelf",
    ) -> "_2329.SystemDeflectionViewable":
        from mastapy._private.system_model.drawing import _2329

        return self.__parent__._cast(_2329.SystemDeflectionViewable)
...
class PartAnalysisCaseWithContourViewable(_0.APIBase):
    ...
    def contour(
        self: "Self", value: "_1888.ThreeDViewContourOptionFirstSelection"
    ) -> None:
    ...
    @enforce_parameter_types
    def contour_secondary(
        self: "Self", value: "_1889.ThreeDViewContourOptionSecondSelection"
    ) -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
    ...
    @property
    def contour_draw_style(self: "Self") -> "_2315.ContourDrawStyle":
