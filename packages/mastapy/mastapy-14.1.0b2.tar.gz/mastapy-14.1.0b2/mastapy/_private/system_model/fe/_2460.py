...
class _Cast_FESubstructureWithSelection:
    ...
    def fe_substructure_with_selection_components(
        ...
        return self.__parent__._cast(_2461.FESubstructureWithSelectionComponents)
    ...
    def fe_substructure_with_selection_for_modal_analysis(
        ...
        return self.__parent__._cast(_2463.FESubstructureWithSelectionForModalAnalysis)
    ...
    def fe_substructure_with_selection_for_static_analysis(
        ...
        return self.__parent__._cast(_2464.FESubstructureWithSelectionForStaticAnalysis)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class FESubstructureWithSelection(_2429.BaseFEWithSelection):
    """FESubstructureWithSelection
    ...
    @property
    def fe_substructure(self: "Self") -> "_2453.FESubstructure":
    ...
    def element_face_groups(
        self: "Self",
    ) -> "List[_2445.ElementFaceGroupWithSelection]":
    ...
    @property
    def node_groups(self: "Self") -> "List[_2471.NodeGroupWithSelection]":
