...
if TYPE_CHECKING:
    ...
    from mastapy._private.nodal_analysis.dev_tools_analyses import _197, _207
    from mastapy._private.system_model.fe import _2429, _2457
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class FESubstructureWithSelectionForModalAnalysis(_2460.FESubstructureWithSelection):
    """FESubstructureWithSelectionForModalAnalysis
    ...
    @property
    def modal_draw_style(self: "Self") -> "_207.FEModelModalAnalysisDrawStyle":
    ...
    def full_fe_mode_shapes_at_condensation_nodes(
        self: "Self",
    ) -> "List[_2457.FESubstructureNodeModeShapes]":
