...
class ElectricMachineDataSet(_0.APIBase):
    ...
    @enforce_parameter_types
    def node_for_first_tooth(self: "Self", value: "_2455.FESubstructureNode") -> None:
    ...
    @property
    def torque_ripple_input_type(self: "Self") -> "_7670.TorqueRippleInputType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.static_loads._7670",
    ...
    def multiple_fourier_series_interpolator_for(
        self: "Self", harmonic_load_data_type: "_1440.HarmonicLoadDataType"
