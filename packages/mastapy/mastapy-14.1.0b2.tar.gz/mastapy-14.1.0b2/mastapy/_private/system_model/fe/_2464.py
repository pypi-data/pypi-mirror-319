...
if TYPE_CHECKING:
    ...
    from mastapy._private.nodal_analysis.dev_tools_analyses import _210
    from mastapy._private.system_model.fe import _2429, _2470
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class FESubstructureWithSelectionForStaticAnalysis(_2460.FESubstructureWithSelection):
    """FESubstructureWithSelectionForStaticAnalysis
    ...
    @enforce_parameter_types
    def contour_option(self: "Self", value: "_1887.ThreeDViewContourOption") -> None:
    ...
    @property
    def static_draw_style(self: "Self") -> "_210.FEModelStaticAnalysisDrawStyle":
    ...
    def boundary_conditions_all_nodes(
        self: "Self",
    ) -> "List[_2470.NodeBoundaryConditionStaticAnalysis]":
