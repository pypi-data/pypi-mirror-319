...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class FESubstructureWithSelectionForHarmonicAnalysis(_2460.FESubstructureWithSelection):
    """FESubstructureWithSelectionForHarmonicAnalysis
    ...
    @property
    def harmonic_draw_style(self: "Self") -> "_205.FEModelHarmonicAnalysisDrawStyle":
