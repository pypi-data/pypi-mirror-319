...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.fe import _2426, _2433
...
class RaceBearingFE(_0.APIBase):
    ...
    @property
    def alignment_method(self: "Self") -> "_2426.AlignmentMethodForRaceBearing":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.fe._2426", "AlignmentMethodForRaceBearing"
        )(value)

    @alignment_method.setter
    @enforce_parameter_types
    def alignment_method(
        self: "Self", value: "_2426.AlignmentMethodForRaceBearing"
    ) -> None:
    ...
    @property
    def links(self: "Self") -> "List[_2433.BearingRaceNodeLink]":
