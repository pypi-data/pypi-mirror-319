...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.fe import _2476
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class RaceBearingFEWithSelection(_2429.BaseFEWithSelection):
    """RaceBearingFEWithSelection
    ...
    @property
    def race_bearing(self: "Self") -> "_2476.RaceBearingFE":
