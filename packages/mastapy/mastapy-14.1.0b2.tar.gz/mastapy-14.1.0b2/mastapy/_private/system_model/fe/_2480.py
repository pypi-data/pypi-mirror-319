...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.fe import _2474, _2475
...
class SystemDeflectionFEExportOptions(_0.APIBase):
    ...
    @property
    def links(self: "Self") -> "List[_2474.PerLinkExportOptions]":
    ...
    @property
    def nodes(self: "Self") -> "List[_2475.PerNodeExportOptions]":
