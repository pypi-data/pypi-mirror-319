...
class _Cast_NodeGroupWithSelection:
    ...
    def fe_entity_group_with_selection(
        self: "CastSelf",
    ) -> "_2447.FEEntityGroupWithSelection":
        return self.__parent__._cast(_2447.FEEntityGroupWithSelection)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class NodeGroupWithSelection(_2447.FEEntityGroupWithSelection[_246.CMSNodeGroup, int]):
    """NodeGroupWithSelection
