...
from mastapy._private.system_model.fe import _2458, _2481
from mastapy._private.system_model.part_model import _2514, _2518
...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model import _2289
...
class FESubstructure(_69.FEStiffness):
    ...
    @property
    def alignment_method(self: "Self") -> "_2425.AlignmentMethod":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.fe._2425", "AlignmentMethod"
        )(value)

    @alignment_method.setter
    @enforce_parameter_types
    def alignment_method(self: "Self", value: "_2425.AlignmentMethod") -> None:
    ...
    @property
    def bearing_node_alignment(self: "Self") -> "_2431.BearingNodeAlignmentOption":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.fe._2431", "BearingNodeAlignmentOption"
        )(value)

    @bearing_node_alignment.setter
    @enforce_parameter_types
    def bearing_node_alignment(
        self: "Self", value: "_2431.BearingNodeAlignmentOption"
    ) -> None:
        value = conversion.mp_to_pn_enum(
    ...
    @enforce_parameter_types
    def component_to_align_to(self: "Self", value: "_2514.Component") -> None:
        wrapper_type = (
    ...
    @datum.setter
    @enforce_parameter_types
    def datum(self: "Self", value: "_2518.Datum") -> None:
    ...
    @enforce_parameter_types
    def distance_display_unit(self: "Self", value: "_1671.Unit") -> None:
    ...
    @enforce_parameter_types
    def force_display_unit(self: "Self", value: "_1671.Unit") -> None:
        wrapper_type = list_with_selected_item.ListWithSelectedItem_Unit.wrapper_type()
        enclosed_type = (
            list_with_selected_item.ListWithSelectedItem_Unit.implicit_type()
        )
    ...
    @enforce_parameter_types
    def thermal_expansion_option(
        self: "Self", value: "_2481.ThermalExpansionOption"
    ) -> None:
    ...
    @type_.setter
    @enforce_parameter_types
    def type_(self: "Self", value: "_2458.FESubstructureType") -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
    ...
    def alignment_using_axial_node_positions(
        self: "Self",
    ) -> "_2427.AlignmentUsingAxialNodePositions":
    ...
    def alignment_to_component(
        self: "Self",
    ) -> "_2289.RelativeComponentAlignment[_2514.Component]":
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_2514.Component](temp)
    ...
    @property
    def coordinate_system(self: "Self") -> "_1558.CoordinateSystem3D":
    ...
    @property
    def export(self: "Self") -> "_2454.FESubstructureExportOptions":
    ...
    @property
    def fe_part(self: "Self") -> "_2523.FEPart":
    ...
    @property
    def gear_meshing_options(self: "Self") -> "List[_2465.GearMeshingOptions]":
    ...
    @property
    def geometries(self: "Self") -> "List[_2451.FEStiffnessGeometry]":
    ...
    def independent_masta_created_condensation_nodes(
        self: "Self",
    ) -> "List[_2466.IndependentMASTACreatedCondensationNode]":
    ...
    @property
    def links(self: "Self") -> "List[_2488.FELink]":
    ...
    @property
    def replaced_shafts(self: "Self") -> "List[_2555.Shaft]":
    ...
    def shafts_that_can_be_replaced(
        self: "Self",
    ) -> "List[_2479.ReplacedShaftSelectionHelper]":
    ...
    def create_fe_substructure_with_selection_components(
        self: "Self",
    ) -> "_2461.FESubstructureWithSelectionComponents":
    ...
    def create_fe_substructure_with_selection_for_harmonic_analysis(
        self: "Self",
    ) -> "_2462.FESubstructureWithSelectionForHarmonicAnalysis":
    ...
    def create_fe_substructure_with_selection_for_modal_analysis(
        self: "Self",
    ) -> "_2463.FESubstructureWithSelectionForModalAnalysis":
    ...
    def create_fe_substructure_with_selection_for_static_analysis(
        self: "Self",
    ) -> "_2464.FESubstructureWithSelectionForStaticAnalysis":
    ...
    def import_fe_mesh(
        ...
        progress: Optional["_7723.TaskProgress"] = None,
    ) -> None:
        """Method does not return.
    ...
    def import_node_positions(
        self: "Self", file_name: "str", distance_unit: "_1671.Unit"
    ) -> None:
        """Method does not return.
    ...
    def import_reduced_stiffness(
        self: "Self",
        file_name: "str",
        distance_unit: "_1671.Unit",
        force_unit: "_1671.Unit",
    ) -> None:
        """Method does not return.
    ...
    @enforce_parameter_types
    def links_for(
        self: "Self", node: "_2455.FESubstructureNode"
    ) -> "List[_2488.FELink]":
        """List[mastapy.system_model.fe.links.FELink]
    ...
    def load_existing_masta_fe_file_with_progress(
        self: "Self", file_name: "str", progress: "_7723.TaskProgress"
    ) -> None:
        """Method does not return.
    ...
    def load_stl_geometry(
        self: "Self", length_unit: "_1671.Unit", file_path: "str"
    ) -> None:
        """Method does not return.
