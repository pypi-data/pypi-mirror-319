...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class DatumCompoundDynamicAnalysis(_6569.ComponentCompoundDynamicAnalysis):
    """DatumCompoundDynamicAnalysis
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_6462.DatumDynamicAnalysis]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_6462.DatumDynamicAnalysis]":
        """List[mastapy.system_model.analyses_and_results.dynamic_analyses.DatumDynamicAnalysis]
