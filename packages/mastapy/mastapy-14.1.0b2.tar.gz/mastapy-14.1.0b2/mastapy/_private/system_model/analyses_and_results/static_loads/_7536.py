...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ConicalGearManufactureError(_7582.GearManufactureError):
    """ConicalGearManufactureError
    ...
    @property
    def pitch_errors_concave_flank(self: "Self") -> "_1594.Vector2DListAccessor":
    ...
    @property
    def pitch_errors_convex_flank(self: "Self") -> "_1594.Vector2DListAccessor":
        """mastapy.math_utility.Vector2DListAccessor"""
