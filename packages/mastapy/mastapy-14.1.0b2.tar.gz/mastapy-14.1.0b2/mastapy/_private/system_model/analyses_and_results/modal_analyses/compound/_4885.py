...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CylindricalGearSetCompoundModalAnalysis(_4896.GearSetCompoundModalAnalysis):
    """CylindricalGearSetCompoundModalAnalysis
    ...
    def cylindrical_gears_compound_modal_analysis(
        self: "Self",
    ) -> "List[_4883.CylindricalGearCompoundModalAnalysis]":
    ...
    def cylindrical_meshes_compound_modal_analysis(
        self: "Self",
    ) -> "List[_4884.CylindricalGearMeshCompoundModalAnalysis]":
