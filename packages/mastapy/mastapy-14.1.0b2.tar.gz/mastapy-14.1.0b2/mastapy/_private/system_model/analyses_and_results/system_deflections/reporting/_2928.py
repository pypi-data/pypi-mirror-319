...
class _Cast_RigidlyConnectedComponentGroupSystemDeflection:
    ...
    def design_entity_group_analysis(
        self: "CastSelf",
    ) -> "_2730.DesignEntityGroupAnalysis":
        return self.__parent__._cast(_2730.DesignEntityGroupAnalysis)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class RigidlyConnectedComponentGroupSystemDeflection(_2730.DesignEntityGroupAnalysis):
    """RigidlyConnectedComponentGroupSystemDeflection
    ...
    @property
    def mass_properties(self: "Self") -> "_1577.MassProperties":
    ...
    @property
    def components(self: "Self") -> "List[_2793.ComponentSystemDeflection]":
