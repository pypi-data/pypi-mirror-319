...
class BevelDifferentialGearSetCompoundParametricStudyTool(
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4411.BevelDifferentialGearSetParametricStudyTool]":
    ...
    def bevel_differential_gears_compound_parametric_study_tool(
        self: "Self",
    ) -> "List[_4558.BevelDifferentialGearCompoundParametricStudyTool]":
    ...
    def bevel_differential_meshes_compound_parametric_study_tool(
        self: "Self",
    ) -> "List[_4559.BevelDifferentialGearMeshCompoundParametricStudyTool]":
