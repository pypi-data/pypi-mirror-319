...
class SpiralBevelGearSetCompoundStabilityAnalysis(
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_3961.SpiralBevelGearSetStabilityAnalysis]":
    ...
    def spiral_bevel_gears_compound_stability_analysis(
        self: "Self",
    ) -> "List[_4094.SpiralBevelGearCompoundStabilityAnalysis]":
    ...
    def spiral_bevel_meshes_compound_stability_analysis(
        self: "Self",
    ) -> "List[_4095.SpiralBevelGearMeshCompoundStabilityAnalysis]":
