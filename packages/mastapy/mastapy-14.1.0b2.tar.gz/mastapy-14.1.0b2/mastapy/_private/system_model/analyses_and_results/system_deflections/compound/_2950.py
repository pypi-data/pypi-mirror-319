...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class BoltCompoundSystemDeflection(_2956.ComponentCompoundSystemDeflection):
    """BoltCompoundSystemDeflection
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_2788.BoltSystemDeflection]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_2788.BoltSystemDeflection]":
        """List[mastapy.system_model.analyses_and_results.system_deflections.BoltSystemDeflection]
