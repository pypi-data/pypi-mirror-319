...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.analyses_and_results.static_loads import _7624
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class PartToPartShearCouplingSystemDeflection(_2809.CouplingSystemDeflection):
    """PartToPartShearCouplingSystemDeflection
    ...
    @property
    def assembly_load_case(self: "Self") -> "_7624.PartToPartShearCouplingLoadCase":
    ...
    @property
    def power_flow_results(self: "Self") -> "_4217.PartToPartShearCouplingPowerFlow":
