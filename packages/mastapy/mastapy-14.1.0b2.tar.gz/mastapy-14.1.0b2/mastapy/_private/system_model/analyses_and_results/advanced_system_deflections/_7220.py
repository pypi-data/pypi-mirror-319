...
from mastapy._private.system_model.analyses_and_results.system_deflections import _2905
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class AdvancedSystemDeflectionSubAnalysis(_2905.SystemDeflection):
    """AdvancedSystemDeflectionSubAnalysis
