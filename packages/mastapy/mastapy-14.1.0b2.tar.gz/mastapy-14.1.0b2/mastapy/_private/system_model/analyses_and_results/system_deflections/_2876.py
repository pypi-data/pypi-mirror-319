...
class RingPinToDiscContactReporting(_0.APIBase):
    ...
    @property
    def contact(self: "Self") -> "_2930.SplineFlankContactReporting":
    ...
    def information_at_ring_pin_to_disc_contact_point_from_geometry(
        self: "Self",
    ) -> "_7600.InformationAtRingPinToDiscContactPointFromGeometry":
    ...
    def information_for_contact_points_along_face_width(
        self: "Self",
    ) -> "List[_2844.InformationForContactAtPointAlongFaceWidth]":
