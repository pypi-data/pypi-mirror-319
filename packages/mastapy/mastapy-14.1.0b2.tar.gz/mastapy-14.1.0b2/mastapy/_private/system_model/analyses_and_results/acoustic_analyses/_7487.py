...
class HarmonicAcousticAnalysis(_0.APIBase):
    ...
    @property
    def analysis_run_type(self: "Self") -> "_7483.AcousticAnalysisRunType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.acoustic_analyses._7483",
            "AcousticAnalysisRunType",
        )(value)

    @analysis_run_type.setter
    @enforce_parameter_types
    def analysis_run_type(self: "Self", value: "_7483.AcousticAnalysisRunType") -> None:
    ...
    def excitation_details_to_run(
        self: "Self",
    ) -> "List[_7492.SingleExcitationDetails]":
