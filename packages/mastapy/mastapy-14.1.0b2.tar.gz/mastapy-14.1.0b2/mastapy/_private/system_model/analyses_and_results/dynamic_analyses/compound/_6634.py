...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class PulleyCompoundDynamicAnalysis(_6583.CouplingHalfCompoundDynamicAnalysis):
    """PulleyCompoundDynamicAnalysis
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_6503.PulleyDynamicAnalysis]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_6503.PulleyDynamicAnalysis]":
        """List[mastapy.system_model.analyses_and_results.dynamic_analyses.PulleyDynamicAnalysis]
