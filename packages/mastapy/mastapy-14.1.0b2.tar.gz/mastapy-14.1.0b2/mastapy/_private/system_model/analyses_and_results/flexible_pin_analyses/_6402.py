...
class _Cast_CombinationAnalysis:
    ...
    @property
    def flexible_pin_analysis(self: "CastSelf") -> "_6403.FlexiblePinAnalysis":
        from mastapy._private.system_model.analyses_and_results.flexible_pin_analyses import (
            _6403,
        )

        return self.__parent__._cast(_6403.FlexiblePinAnalysis)
    ...
    def wind_turbine_certification_report(
        self: "CastSelf",
    ) -> "_6410.WindTurbineCertificationReport":
        from mastapy._private.system_model.analyses_and_results.flexible_pin_analyses import (
            _6410,
        )

        return self.__parent__._cast(_6410.WindTurbineCertificationReport)
