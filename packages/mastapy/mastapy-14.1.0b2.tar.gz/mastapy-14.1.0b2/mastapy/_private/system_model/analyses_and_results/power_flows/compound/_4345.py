...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class MicrophoneCompoundPowerFlow(_4292.ComponentCompoundPowerFlow):
    """MicrophoneCompoundPowerFlow
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4211.MicrophonePowerFlow]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4211.MicrophonePowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.MicrophonePowerFlow]
