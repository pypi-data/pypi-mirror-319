...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ConceptGearSetModalAnalysis(_4743.GearSetModalAnalysis):
    """ConceptGearSetModalAnalysis
    ...
    @property
    def gears_modal_analysis(self: "Self") -> "List[_4708.ConceptGearModalAnalysis]":
    ...
    def concept_gears_modal_analysis(
        self: "Self",
    ) -> "List[_4708.ConceptGearModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.ConceptGearModalAnalysis]
