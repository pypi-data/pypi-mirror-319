...
from mastapy._private.system_model import _2286
from mastapy._private.system_model.analyses_and_results.static_loads import _7671, _7675
...
if TYPE_CHECKING:
    ...
    from mastapy._private.math_utility import _1594
    from mastapy._private.math_utility.control import _1636
    ...
    from mastapy._private.system_model import _2285, _2287
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class PowerLoadLoadCase(_7675.VirtualComponentLoadCase):
    """PowerLoadLoadCase
    ...
    @enforce_parameter_types
    def constant_resistance_coefficient_time_profile(
        self: "Self", value: "_1594.Vector2DListAccessor"
    ) -> None:
        pythonnet_property_set(
    ...
    def drag_torque_specification_method(
        self: "Self",
    ) -> "_2285.PowerLoadDragTorqueSpecificationMethod":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model._2285",
    ...
    @enforce_parameter_types
    def drag_torque_specification_method(
        self: "Self", value: "_2285.PowerLoadDragTorqueSpecificationMethod"
    ) -> None:
    ...
    @property
    def drag_torque_vs_speed_and_time(self: "Self") -> "_1624.GriddedSurfaceAccessor":
    ...
    def drag_torque_vs_speed_and_time(
        self: "Self", value: "_1624.GriddedSurfaceAccessor"
    ) -> None:
    ...
    @enforce_parameter_types
    def electric_machine_data_set_selector(
        self: "Self", value: "_2443.ElectricMachineDataSet"
    ) -> None:
    ...
    @property
    def engine_throttle_time_profile(self: "Self") -> "_1594.Vector2DListAccessor":
        """mastapy.math_utility.Vector2DListAccessor"""
    ...
    @property
    def speed_vs_time(self: "Self") -> "_1594.Vector2DListAccessor":
        """mastapy.math_utility.Vector2DListAccessor"""
    ...
    @enforce_parameter_types
    def speed_vs_time(self: "Self", value: "_1594.Vector2DListAccessor") -> None:
    ...
    @enforce_parameter_types
    def system_deflection_torque_method(
        self: "Self", value: "_7671.TorqueSpecificationForSystemDeflection"
    ) -> None:
    ...
    def target_speed_input_type(
        self: "Self",
    ) -> "_2287.PowerLoadPIDControlSpeedInputType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model._2287", "PowerLoadPIDControlSpeedInputType"
        )(value)

    @target_speed_input_type.setter
    @enforce_parameter_types
    def target_speed_input_type(
        self: "Self", value: "_2287.PowerLoadPIDControlSpeedInputType"
    ) -> None:
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def target_speed_vs_time(self: "Self") -> "_1594.Vector2DListAccessor":
        """mastapy.math_utility.Vector2DListAccessor"""
    ...
    @enforce_parameter_types
    def target_speed_vs_time(self: "Self", value: "_1594.Vector2DListAccessor") -> None:
    ...
    @enforce_parameter_types
    def torque_input_method(
        self: "Self", value: "_2286.PowerLoadInputTorqueSpecificationMethod"
    ) -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
    ...
    @property
    def torque_vs_angle(self: "Self") -> "_1594.Vector2DListAccessor":
        """mastapy.math_utility.Vector2DListAccessor"""
    ...
    @enforce_parameter_types
    def torque_vs_angle(self: "Self", value: "_1594.Vector2DListAccessor") -> None:
        pythonnet_property_set(self.wrapped, "TorqueVsAngle", value.wrapped)

    @property
    def torque_vs_angle_and_speed(self: "Self") -> "_1624.GriddedSurfaceAccessor":
        """mastapy.math_utility.measured_data.GriddedSurfaceAccessor"""
    ...
    @property
    def torque_vs_time(self: "Self") -> "_1594.Vector2DListAccessor":
        """mastapy.math_utility.Vector2DListAccessor"""
    ...
    @enforce_parameter_types
    def torque_vs_time(self: "Self", value: "_1594.Vector2DListAccessor") -> None:
    ...
    @property
    def wheel_slip_model(self: "Self") -> "_5638.WheelSlipType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.mbd_analyses._5638",
            "WheelSlipType",
        )(value)

    @wheel_slip_model.setter
    @enforce_parameter_types
    def wheel_slip_model(self: "Self", value: "_5638.WheelSlipType") -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.MBDAnalyses.WheelSlipType",
        )
    ...
    @property
    def pid_control_settings(self: "Self") -> "_1636.PIDControlSettings":
        """mastapy.math_utility.control.PIDControlSettings
    ...
    def get_harmonic_load_data_for_import(
        self: "Self",
    ) -> "_7562.ElectricMachineHarmonicLoadData":
