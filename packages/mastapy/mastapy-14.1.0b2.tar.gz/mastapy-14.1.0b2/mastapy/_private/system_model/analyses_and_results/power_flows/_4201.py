...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class KlingelnbergCycloPalloidConicalGearSetPowerFlow(_4164.ConicalGearSetPowerFlow):
    """KlingelnbergCycloPalloidConicalGearSetPowerFlow
    ...
    def conical_gears_power_flow(
        self: "Self",
    ) -> "List[_4200.KlingelnbergCycloPalloidConicalGearPowerFlow]":
    ...
    def conical_meshes_power_flow(
        self: "Self",
    ) -> "List[_4199.KlingelnbergCycloPalloidConicalGearMeshPowerFlow]":
