...
from mastapy._private.system_model.part_model import _2551
...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.analyses_and_results import _2728, _2761
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class StaticLoadCase(_7495.LoadCase):
    """StaticLoadCase
    ...
    def unbalanced_mass_inclusion(
        self: "Self",
        value: "Union[_2551.UnbalancedMassInclusionOption, Tuple[_2551.UnbalancedMassInclusionOption, bool]]",
    ) -> None:
        wrapper_type = (
    ...
    def advanced_system_deflection_options(
        self: "Self",
    ) -> "_7219.AdvancedSystemDeflectionOptions":
    ...
    def te_set_up_for_dynamic_analyses_options(
        self: "Self",
    ) -> "_2761.TESetUpForDynamicAnalysisOptions":
    ...
    @property
    def clutch_engagements(self: "Self") -> "List[_5786.ClutchEngagementStatus]":
    ...
    def concept_clutch_engagements(
        self: "Self",
    ) -> "List[_5787.ConceptSynchroGearEngagementStatus]":
    ...
    @property
    def design_state_load_case_group(self: "Self") -> "_5788.DesignState":
    ...
    @property
    def stability_analysis(self: "Self") -> "_3966.StabilityAnalysis":
    ...
    @enforce_parameter_types
    def duplicate(
        self: "Self", new_design_state_group: "_5788.DesignState", name: "str" = "None"
    ) -> "StaticLoadCase":
