...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class SpiralBevelGearSetDynamicAnalysis(_6429.BevelGearSetDynamicAnalysis):
    """SpiralBevelGearSetDynamicAnalysis
    ...
    def bevel_gears_dynamic_analysis(
        self: "Self",
    ) -> "List[_6514.SpiralBevelGearDynamicAnalysis]":
    ...
    def bevel_meshes_dynamic_analysis(
        self: "Self",
    ) -> "List[_6515.SpiralBevelGearMeshDynamicAnalysis]":
