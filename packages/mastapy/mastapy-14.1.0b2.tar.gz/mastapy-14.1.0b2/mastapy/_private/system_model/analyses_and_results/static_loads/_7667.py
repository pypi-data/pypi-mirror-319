...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class TorqueConverterLoadCase(_7544.CouplingLoadCase):
    """TorqueConverterLoadCase
    ...
    @enforce_parameter_types
    def lock_up_clutch_rule(
        self: "Self", value: "_5631.TorqueConverterLockupRule"
    ) -> None:
    ...
    @property
    def assembly_design(self: "Self") -> "_2690.TorqueConverter":
