...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.ltca import _881
...
class AdvancedSystemDeflectionOptions(_0.APIBase):
    ...
    @enforce_parameter_types
    def specified_gear_set(self: "Self", value: "_2607.GearSet") -> None:
        wrapper_type = (
    ...
    @property
    def use_advanced_ltca(self: "Self") -> "_881.UseAdvancedLTCAOptions":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears.ltca._881", "UseAdvancedLTCAOptions"
        )(value)

    @use_advanced_ltca.setter
    @enforce_parameter_types
    def use_advanced_ltca(self: "Self", value: "_881.UseAdvancedLTCAOptions") -> None:
    ...
    @property
    def time_options(self: "Self") -> "_2762.TimeOptions":
