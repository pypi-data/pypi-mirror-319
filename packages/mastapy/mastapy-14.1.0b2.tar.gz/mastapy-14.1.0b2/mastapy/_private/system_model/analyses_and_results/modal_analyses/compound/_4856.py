...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class BoltedJointCompoundModalAnalysis(_4936.SpecialisedAssemblyCompoundModalAnalysis):
    """BoltedJointCompoundModalAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4697.BoltedJointModalAnalysis]":
    ...
    @property
    def assembly_analysis_cases(self: "Self") -> "List[_4697.BoltedJointModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.BoltedJointModalAnalysis]
