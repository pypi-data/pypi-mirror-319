...
class WormGearSetCompoundMultibodyDynamicsAnalysis(
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_5641.WormGearSetMultibodyDynamicsAnalysis]":
    ...
    def worm_gears_compound_multibody_dynamics_analysis(
        self: "Self",
    ) -> "List[_5777.WormGearCompoundMultibodyDynamicsAnalysis]":
    ...
    def worm_meshes_compound_multibody_dynamics_analysis(
        self: "Self",
    ) -> "List[_5778.WormGearMeshCompoundMultibodyDynamicsAnalysis]":
