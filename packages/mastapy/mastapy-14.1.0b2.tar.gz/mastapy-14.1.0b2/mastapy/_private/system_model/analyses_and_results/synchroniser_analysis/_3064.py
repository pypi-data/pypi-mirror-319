...
class SynchroniserShift(_0.APIBase):
    ...
    @enforce_parameter_types
    def final_design_state(self: "Self", value: "_5788.DesignState") -> None:
        wrapper_type = (
    ...
    @enforce_parameter_types
    def initial_design_state(self: "Self", value: "_5788.DesignState") -> None:
        wrapper_type = (
            list_with_selected_item.ListWithSelectedItem_DesignState.wrapper_type()
        )
        enclosed_type = (
    ...
    @property
    def cone(self: "Self") -> "_2687.SynchroniserHalf":
    ...
    @property
    def sleeve(self: "Self") -> "_2689.SynchroniserSleeve":
