...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ConceptGearMeshSystemDeflection(_2837.GearMeshSystemDeflection):
    """ConceptGearMeshSystemDeflection
    ...
    @property
    def rating(self: "Self") -> "_569.ConceptGearMeshRating":
    ...
    @property
    def component_detailed_analysis(self: "Self") -> "_569.ConceptGearMeshRating":
        """mastapy.gears.rating.concept.ConceptGearMeshRating
    ...
    @property
    def power_flow_results(self: "Self") -> "_4159.ConceptGearMeshPowerFlow":
