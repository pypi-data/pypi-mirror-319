...
class _Cast_ExcitationSourceSelectionGroup:
    ...
    def excitation_source_selection_base(
        self: "CastSelf",
    ) -> "_5974.ExcitationSourceSelectionBase":
        return self.__parent__._cast(_5974.ExcitationSourceSelectionBase)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ExcitationSourceSelectionGroup(_5974.ExcitationSourceSelectionBase):
    """ExcitationSourceSelectionGroup
    ...
    @property
    def sub_items(self: "Self") -> "List[_5974.ExcitationSourceSelectionBase]":
    ...
    def include_only_harmonics_with_order(
        self: "Self", order: "_1588.RoundedOrder"
    ) -> None:
