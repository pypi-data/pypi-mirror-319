...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class OilSealHarmonicAnalysis(_5841.ConnectorHarmonicAnalysis):
    """OilSealHarmonicAnalysis
    ...
    @property
    def component_load_case(self: "Self") -> "_7619.OilSealLoadCase":
    ...
    @property
    def system_deflection_results(self: "Self") -> "_2864.OilSealSystemDeflection":
