...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class SpiralBevelGearSetSystemDeflection(_2785.BevelGearSetSystemDeflection):
    """SpiralBevelGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self: "Self") -> "_4238.SpiralBevelGearSetPowerFlow":
    ...
    def bevel_gears_system_deflection(
        self: "Self",
    ) -> "List[_2889.SpiralBevelGearSystemDeflection]":
