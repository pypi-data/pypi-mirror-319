...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class BeltDriveCompoundPowerFlow(_4367.SpecialisedAssemblyCompoundPowerFlow):
    """BeltDriveCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self: "Self") -> "List[_4140.BeltDrivePowerFlow]":
    ...
    @property
    def assembly_analysis_cases(self: "Self") -> "List[_4140.BeltDrivePowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.BeltDrivePowerFlow]
