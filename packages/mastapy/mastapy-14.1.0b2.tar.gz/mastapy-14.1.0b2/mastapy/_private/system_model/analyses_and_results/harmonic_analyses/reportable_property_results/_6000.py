...
class _Cast_ResultsForOrderIncludingSurfaces:
    ...
    @property
    def results_for_order(self: "CastSelf") -> "_5997.ResultsForOrder":
        from mastapy._private.system_model.analyses_and_results.harmonic_analyses.reportable_property_results import (
            _5997,
        )

        return self.__parent__._cast(_5997.ResultsForOrder)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ResultsForOrderIncludingSurfaces(_5999.ResultsForOrderIncludingNodes):
    """ResultsForOrderIncludingSurfaces
    ...
    def fe_surfaces(
        self: "Self",
    ) -> "List[_5992.HarmonicAnalysisResultsBrokenDownBySurfaceWithinAHarmonic]":
