...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CouplingCompoundModalAnalysis(_4936.SpecialisedAssemblyCompoundModalAnalysis):
    """CouplingCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases(self: "Self") -> "List[_4718.CouplingModalAnalysis]":
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4718.CouplingModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.CouplingModalAnalysis]
