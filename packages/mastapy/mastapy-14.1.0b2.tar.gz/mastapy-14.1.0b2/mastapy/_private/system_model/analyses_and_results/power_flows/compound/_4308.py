...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CVTCompoundPowerFlow(_4277.BeltDriveCompoundPowerFlow):
    """CVTCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self: "Self") -> "List[_4171.CVTPowerFlow]":
    ...
    @property
    def assembly_analysis_cases(self: "Self") -> "List[_4171.CVTPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.CVTPowerFlow]
