...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CVTCompoundCriticalSpeedAnalysis(_6825.BeltDriveCompoundCriticalSpeedAnalysis):
    """CVTCompoundCriticalSpeedAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_6725.CVTCriticalSpeedAnalysis]":
    ...
    @property
    def assembly_analysis_cases(self: "Self") -> "List[_6725.CVTCriticalSpeedAnalysis]":
        """List[mastapy.system_model.analyses_and_results.critical_speed_analyses.CVTCriticalSpeedAnalysis]
