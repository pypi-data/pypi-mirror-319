...
TLinearMeasurement = TypeVar("TLinearMeasurement", bound="_1666.MeasurementBase")
TAngularMeasurement = TypeVar("TAngularMeasurement", bound="_1666.MeasurementBase")
...
class _Cast_ShaftComplexShape:
    ...
    @property
    def shaft_forced_complex_shape(self: "CastSelf") -> "_4126.ShaftForcedComplexShape":
        from mastapy._private.system_model.analyses_and_results.rotor_dynamics import (
            _4126,
        )

        return self.__parent__._cast(_4126.ShaftForcedComplexShape)

    @property
    def shaft_modal_complex_shape(self: "CastSelf") -> "_4127.ShaftModalComplexShape":
        from mastapy._private.system_model.analyses_and_results.rotor_dynamics import (
            _4127,
        )

        return self.__parent__._cast(_4127.ShaftModalComplexShape)

    @property
    def shaft_modal_complex_shape_at_speeds(
        self: "CastSelf",
    ) -> "_4128.ShaftModalComplexShapeAtSpeeds":
        from mastapy._private.system_model.analyses_and_results.rotor_dynamics import (
            _4128,
        )

        return self.__parent__._cast(_4128.ShaftModalComplexShapeAtSpeeds)

    @property
    def shaft_modal_complex_shape_at_stiffness(
        self: "CastSelf",
    ) -> "_4129.ShaftModalComplexShapeAtStiffness":
        from mastapy._private.system_model.analyses_and_results.rotor_dynamics import (
            _4129,
        )

        return self.__parent__._cast(_4129.ShaftModalComplexShapeAtStiffness)
