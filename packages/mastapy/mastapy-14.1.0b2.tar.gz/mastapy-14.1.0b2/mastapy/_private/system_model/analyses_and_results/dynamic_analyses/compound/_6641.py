...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ShaftCompoundDynamicAnalysis(_6545.AbstractShaftCompoundDynamicAnalysis):
    """ShaftCompoundDynamicAnalysis
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_6510.ShaftDynamicAnalysis]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_6510.ShaftDynamicAnalysis]":
        """List[mastapy.system_model.analyses_and_results.dynamic_analyses.ShaftDynamicAnalysis]
