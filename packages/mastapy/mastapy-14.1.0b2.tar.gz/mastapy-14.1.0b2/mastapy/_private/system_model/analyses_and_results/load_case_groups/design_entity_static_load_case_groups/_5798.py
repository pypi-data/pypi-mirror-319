...
TReal = TypeVar("TReal", bound="_2514.Component")
TComponentStaticLoad = TypeVar("TComponentStaticLoad", bound="_7528.ComponentLoadCase")
...
class ComponentStaticLoadCaseGroup(
    _5802.PartStaticLoadCaseGroup, Generic[TReal, TComponentStaticLoad]
):
    """ComponentStaticLoadCaseGroup
