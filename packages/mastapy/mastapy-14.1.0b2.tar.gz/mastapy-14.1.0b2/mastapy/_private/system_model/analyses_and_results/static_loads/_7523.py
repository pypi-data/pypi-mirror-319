...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ClutchConnectionLoadCase(_7542.CouplingConnectionLoadCase):
    """ClutchConnectionLoadCase
    ...
    @property
    def clutch_pressures(self: "Self") -> "_1594.Vector2DListAccessor":
    ...
    @enforce_parameter_types
    def clutch_pressures(self: "Self", value: "_1594.Vector2DListAccessor") -> None:
