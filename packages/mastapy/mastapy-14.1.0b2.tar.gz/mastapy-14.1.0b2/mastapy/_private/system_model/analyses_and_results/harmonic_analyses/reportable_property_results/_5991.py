...
class _Cast_HarmonicAnalysisResultsBrokenDownByNodeWithinAHarmonic:
    ...
    def harmonic_analysis_results_broken_down_by_location_within_a_harmonic(
        self: "CastSelf",
    ) -> "_5990.HarmonicAnalysisResultsBrokenDownByLocationWithinAHarmonic":
...
class HarmonicAnalysisResultsBrokenDownByNodeWithinAHarmonic(
    ...
    @property
    def acceleration(self: "Self") -> "_6002.ResultsForResponseOfANodeOnAHarmonic":
    ...
    @property
    def displacement(self: "Self") -> "_6002.ResultsForResponseOfANodeOnAHarmonic":
        """mastapy.system_model.analyses_and_results.harmonic_analyses.reportable_property_results.ResultsForResponseOfANodeOnAHarmonic
    ...
    @property
    def force(self: "Self") -> "_6002.ResultsForResponseOfANodeOnAHarmonic":
        """mastapy.system_model.analyses_and_results.harmonic_analyses.reportable_property_results.ResultsForResponseOfANodeOnAHarmonic
    ...
    @property
    def velocity(self: "Self") -> "_6002.ResultsForResponseOfANodeOnAHarmonic":
        """mastapy.system_model.analyses_and_results.harmonic_analyses.reportable_property_results.ResultsForResponseOfANodeOnAHarmonic
