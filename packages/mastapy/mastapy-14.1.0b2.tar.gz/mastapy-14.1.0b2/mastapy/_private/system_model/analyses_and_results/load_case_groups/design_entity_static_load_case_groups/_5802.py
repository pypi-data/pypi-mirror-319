...
class _Cast_PartStaticLoadCaseGroup:
    ...
    def abstract_assembly_static_load_case_group(
        self: "CastSelf",
    ) -> "_5797.AbstractAssemblyStaticLoadCaseGroup":
        from mastapy._private.system_model.analyses_and_results.load_case_groups.design_entity_static_load_case_groups import (
            _5797,
        )

        return self.__parent__._cast(_5797.AbstractAssemblyStaticLoadCaseGroup)

    @property
    def component_static_load_case_group(
        self: "CastSelf",
    ) -> "_5798.ComponentStaticLoadCaseGroup":
        from mastapy._private.system_model.analyses_and_results.load_case_groups.design_entity_static_load_case_groups import (
            _5798,
        )

        return self.__parent__._cast(_5798.ComponentStaticLoadCaseGroup)

    @property
    def gear_set_static_load_case_group(
        self: "CastSelf",
    ) -> "_5801.GearSetStaticLoadCaseGroup":
        from mastapy._private.system_model.analyses_and_results.load_case_groups.design_entity_static_load_case_groups import (
            _5801,
        )

        return self.__parent__._cast(_5801.GearSetStaticLoadCaseGroup)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class PartStaticLoadCaseGroup(_5800.DesignEntityStaticLoadCaseGroup):
    """PartStaticLoadCaseGroup
    ...
    @property
    def part_load_cases(self: "Self") -> "List[_7621.PartLoadCase]":
