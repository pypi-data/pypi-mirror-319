...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class PowerLoadCompoundPowerFlow(_4391.VirtualComponentCompoundPowerFlow):
    """PowerLoadCompoundPowerFlow
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4224.PowerLoadPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.PowerLoadPowerFlow]
