...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ConceptCouplingCompoundPowerFlow(_4304.CouplingCompoundPowerFlow):
    """ConceptCouplingCompoundPowerFlow
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4158.ConceptCouplingPowerFlow]":
    ...
    @property
    def assembly_analysis_cases(self: "Self") -> "List[_4158.ConceptCouplingPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.ConceptCouplingPowerFlow]
