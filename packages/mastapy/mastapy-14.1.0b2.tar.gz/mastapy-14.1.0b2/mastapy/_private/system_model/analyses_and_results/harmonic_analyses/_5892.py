...
from mastapy._private.system_model.analyses_and_results.harmonic_analyses import _5856
from mastapy._private.system_model.part_model.acoustics import _2704
...
class _Cast_HarmonicAnalysisOptions:
    ...
    def harmonic_analysis_options_for_advanced_time_stepping_analysis_for_modulation(
        self: "CastSelf",
    ) -> "_7013.HarmonicAnalysisOptionsForAdvancedTimeSteppingAnalysisForModulation":
        from mastapy._private.system_model.analyses_and_results.advanced_time_stepping_analyses_for_modulation import (
            _7013,
        )
...
class HarmonicAnalysisOptions(_0.APIBase):
    ...
    def acoustic_analysis_setup(
        self: "Self", value: "_2704.AcousticAnalysisSetup"
    ) -> None:
    ...
    @enforce_parameter_types
    def damping_specification(
        self: "Self", value: "_5856.DampingSpecification"
    ) -> None:
    ...
    @property
    def per_frequency_damping_profile(self: "Self") -> "_1594.Vector2DListAccessor":
    ...
    @property
    def response_cache_level(self: "Self") -> "_5927.ResponseCacheLevel":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.harmonic_analyses._5927",
            "ResponseCacheLevel",
        )(value)

    @response_cache_level.setter
    @enforce_parameter_types
    def response_cache_level(self: "Self", value: "_5927.ResponseCacheLevel") -> None:
    ...
    @property
    def excitation_selection(self: "Self") -> "_5975.ExcitationSourceSelectionGroup":
    ...
    @property
    def modal_analysis_options(self: "Self") -> "_4765.ModalAnalysisOptions":
    ...
    @property
    def stiffness_options(self: "Self") -> "_5946.StiffnessOptionsForHarmonicAnalysis":
