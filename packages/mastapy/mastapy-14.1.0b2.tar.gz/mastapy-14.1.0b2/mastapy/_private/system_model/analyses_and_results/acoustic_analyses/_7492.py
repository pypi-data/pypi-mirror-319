...
class _Cast_SingleExcitationDetails:
    ...
    def single_harmonic_excitation_analysis_detail(
        self: "CastSelf",
    ) -> "_7493.SingleHarmonicExcitationAnalysisDetail":
        from mastapy._private.system_model.analyses_and_results.acoustic_analyses import (
            _7493,
        )

        return self.__parent__._cast(_7493.SingleHarmonicExcitationAnalysisDetail)

    @property
    def unit_force_excitation_analysis_detail(
        self: "CastSelf",
    ) -> "_7494.UnitForceExcitationAnalysisDetail":
        from mastapy._private.system_model.analyses_and_results.acoustic_analyses import (
            _7494,
        )

        return self.__parent__._cast(_7494.UnitForceExcitationAnalysisDetail)
