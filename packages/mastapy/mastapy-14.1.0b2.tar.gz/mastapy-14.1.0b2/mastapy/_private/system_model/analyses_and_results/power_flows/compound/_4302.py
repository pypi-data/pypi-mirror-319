...
class _Cast_ConnectionCompoundPowerFlow:
    ...
    def cycloidal_disc_planetary_bearing_connection_compound_power_flow(
        self: "CastSelf",
    ) -> "_4313.CycloidalDiscPlanetaryBearingConnectionCompoundPowerFlow":
        from mastapy._private.system_model.analyses_and_results.power_flows.compound import (
            _4313,
        )
    ...
    def planetary_connection_compound_power_flow(
        self: "CastSelf",
    ) -> "_4352.PlanetaryConnectionCompoundPowerFlow":
        from mastapy._private.system_model.analyses_and_results.power_flows.compound import (
            _4352,
        )

        return self.__parent__._cast(_4352.PlanetaryConnectionCompoundPowerFlow)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ConnectionCompoundPowerFlow(_7703.ConnectionCompoundAnalysis):
    """ConnectionCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases(self: "Self") -> "List[_4165.ConnectionPowerFlow]":
    ...
    def connection_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4165.ConnectionPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.ConnectionPowerFlow]
