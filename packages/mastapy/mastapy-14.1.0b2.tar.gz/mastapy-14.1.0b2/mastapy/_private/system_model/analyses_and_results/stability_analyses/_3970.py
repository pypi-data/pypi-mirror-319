...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class StraightBevelDiffGearSetStabilityAnalysis(_3874.BevelGearSetStabilityAnalysis):
    """StraightBevelDiffGearSetStabilityAnalysis
    ...
    def bevel_gears_stability_analysis(
        self: "Self",
    ) -> "List[_3971.StraightBevelDiffGearStabilityAnalysis]":
    ...
    def bevel_meshes_stability_analysis(
        self: "Self",
    ) -> "List[_3969.StraightBevelDiffGearMeshStabilityAnalysis]":
