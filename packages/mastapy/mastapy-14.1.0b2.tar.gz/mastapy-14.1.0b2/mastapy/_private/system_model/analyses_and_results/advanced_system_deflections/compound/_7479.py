...
class WormGearSetCompoundAdvancedSystemDeflection(
    ...
    @property
    def gear_duty_cycle_rating(self: "Self") -> "_394.WormGearSetDutyCycleRating":
    ...
    @property
    def worm_gear_duty_cycle_rating(self: "Self") -> "_394.WormGearSetDutyCycleRating":
        """mastapy.gears.rating.worm.WormGearSetDutyCycleRating
    ...
    def worm_gears_compound_advanced_system_deflection(
        self: "Self",
    ) -> "List[_7477.WormGearCompoundAdvancedSystemDeflection]":
    ...
    def worm_meshes_compound_advanced_system_deflection(
        self: "Self",
    ) -> "List[_7478.WormGearMeshCompoundAdvancedSystemDeflection]":
