...
TConnection = TypeVar("TConnection", bound="_2341.Connection")
TConnectionStaticLoad = TypeVar(
    "TConnectionStaticLoad", bound="_7540.ConnectionLoadCase"
)
...
class ConnectionStaticLoadCaseGroup(
    _5800.DesignEntityStaticLoadCaseGroup, Generic[TConnection, TConnectionStaticLoad]
):
    """ConnectionStaticLoadCaseGroup
