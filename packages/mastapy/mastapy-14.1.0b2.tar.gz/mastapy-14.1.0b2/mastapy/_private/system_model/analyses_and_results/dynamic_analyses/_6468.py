...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class FaceGearSetDynamicAnalysis(_6473.GearSetDynamicAnalysis):
    """FaceGearSetDynamicAnalysis
    ...
    @property
    def gears_dynamic_analysis(self: "Self") -> "List[_6466.FaceGearDynamicAnalysis]":
    ...
    def face_gears_dynamic_analysis(
        self: "Self",
    ) -> "List[_6466.FaceGearDynamicAnalysis]":
        """List[mastapy.system_model.analyses_and_results.dynamic_analyses.FaceGearDynamicAnalysis]
    ...
    def meshes_dynamic_analysis(
        self: "Self",
    ) -> "List[_6467.FaceGearMeshDynamicAnalysis]":
