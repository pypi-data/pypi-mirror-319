...
T = TypeVar("T", bound="_2272.DesignEntity")
...
class _Cast_GenericClutchEngagementStatus:
    ...
    @property
    def clutch_engagement_status(self: "CastSelf") -> "_5786.ClutchEngagementStatus":
        from mastapy._private.system_model.analyses_and_results.load_case_groups import (
            _5786,
        )

        return self.__parent__._cast(_5786.ClutchEngagementStatus)
    ...
    def concept_synchro_gear_engagement_status(
        ...
        return self.__parent__._cast(_5787.ConceptSynchroGearEngagementStatus)
