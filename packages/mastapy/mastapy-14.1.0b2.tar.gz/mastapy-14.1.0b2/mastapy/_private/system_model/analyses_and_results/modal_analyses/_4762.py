...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ModalAnalysis(_7714.StaticLoadAnalysisCase):
    """ModalAnalysis
    ...
    @property
    def analysis_settings(self: "Self") -> "_4765.ModalAnalysisOptions":
    ...
    @property
    def bar_model_export(self: "Self") -> "_4763.ModalAnalysisBarModelFEExportOptions":
    ...
    @property
    def modal_analysis_results(self: "Self") -> "_6463.DynamicAnalysis":
    ...
    @property
    def normal_modes(self: "Self") -> "List[_1566.Eigenmode]":
