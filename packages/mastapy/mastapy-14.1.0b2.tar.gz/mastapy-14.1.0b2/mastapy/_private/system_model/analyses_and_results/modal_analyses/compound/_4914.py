...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class MicrophoneCompoundModalAnalysis(_4861.ComponentCompoundModalAnalysis):
    """MicrophoneCompoundModalAnalysis
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4761.MicrophoneModalAnalysis]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4761.MicrophoneModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.MicrophoneModalAnalysis]
