...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class BoltCompoundPowerFlow(_4292.ComponentCompoundPowerFlow):
    """BoltCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self: "Self") -> "List[_4150.BoltPowerFlow]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4150.BoltPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.BoltPowerFlow]
