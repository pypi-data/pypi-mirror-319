...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class StraightBevelGearSetLoadCase(_7520.BevelGearSetLoadCase):
    """StraightBevelGearSetLoadCase
    ...
    @property
    def bevel_gears_load_case(self: "Self") -> "List[_7655.StraightBevelGearLoadCase]":
    ...
    def straight_bevel_gears_load_case(
        self: "Self",
    ) -> "List[_7655.StraightBevelGearLoadCase]":
        """List[mastapy.system_model.analyses_and_results.static_loads.StraightBevelGearLoadCase]
    ...
    def bevel_meshes_load_case(
        self: "Self",
    ) -> "List[_7656.StraightBevelGearMeshLoadCase]":
