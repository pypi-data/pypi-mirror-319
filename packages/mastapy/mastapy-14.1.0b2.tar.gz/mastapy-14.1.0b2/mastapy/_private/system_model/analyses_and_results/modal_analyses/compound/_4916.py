...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class OilSealCompoundModalAnalysis(_4872.ConnectorCompoundModalAnalysis):
    """OilSealCompoundModalAnalysis
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4768.OilSealModalAnalysis]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4768.OilSealModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.OilSealModalAnalysis]
