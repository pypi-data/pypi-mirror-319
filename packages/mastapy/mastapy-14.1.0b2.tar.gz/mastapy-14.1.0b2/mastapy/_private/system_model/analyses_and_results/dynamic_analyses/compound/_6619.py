...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class MassDiscCompoundDynamicAnalysis(_6668.VirtualComponentCompoundDynamicAnalysis):
    """MassDiscCompoundDynamicAnalysis
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_6488.MassDiscDynamicAnalysis]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_6488.MassDiscDynamicAnalysis]":
        """List[mastapy.system_model.analyses_and_results.dynamic_analyses.MassDiscDynamicAnalysis]
