...
from mastapy._private.system_model.analyses_and_results.static_loads import _7569, _7592
...
class HarmonicLoadDataExcelImport(
    _7592.HarmonicLoadDataImportBase[
        _7569.ElectricMachineHarmonicLoadExcelImportOptions
    ]
):
    """HarmonicLoadDataExcelImport
    ...
    @speed_units.setter
    @enforce_parameter_types
    def speed_units(self: "Self", value: "_1671.Unit") -> None:
    ...
    @enforce_parameter_types
    def units_for_data_being_imported(self: "Self", value: "_1671.Unit") -> None:
        wrapper_type = list_with_selected_item.ListWithSelectedItem_Unit.wrapper_type()
        enclosed_type = (
            list_with_selected_item.ListWithSelectedItem_Unit.implicit_type()
        )
    ...
    @property
    def speeds(self: "Self") -> "List[_7618.NamedSpeed]":
