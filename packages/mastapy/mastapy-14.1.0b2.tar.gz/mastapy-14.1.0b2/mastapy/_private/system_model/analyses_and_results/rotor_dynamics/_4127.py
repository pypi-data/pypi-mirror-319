...
from mastapy._private.system_model.analyses_and_results.rotor_dynamics import _4125
...
class _Cast_ShaftModalComplexShape:
    ...
    @property
    def shaft_complex_shape(self: "CastSelf") -> "_4125.ShaftComplexShape":
        return self.__parent__._cast(_4125.ShaftComplexShape)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ShaftModalComplexShape(_4125.ShaftComplexShape[_1749.Number, _1749.Number]):
    """ShaftModalComplexShape
