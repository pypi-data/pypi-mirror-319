...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ZerolBevelGearSetCompoundPowerFlow(_4285.BevelGearSetCompoundPowerFlow):
    """ZerolBevelGearSetCompoundPowerFlow
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4266.ZerolBevelGearSetPowerFlow]":
    ...
    def zerol_bevel_gears_compound_power_flow(
        self: "Self",
    ) -> "List[_4395.ZerolBevelGearCompoundPowerFlow]":
    ...
    def zerol_bevel_meshes_compound_power_flow(
        self: "Self",
    ) -> "List[_4396.ZerolBevelGearMeshCompoundPowerFlow]":
