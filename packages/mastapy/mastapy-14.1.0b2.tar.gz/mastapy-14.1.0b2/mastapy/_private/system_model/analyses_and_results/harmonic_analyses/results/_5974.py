...
class _Cast_ExcitationSourceSelectionBase:
    ...
    def excitation_source_selection(
        self: "CastSelf",
    ) -> "_5973.ExcitationSourceSelection":
        from mastapy._private.system_model.analyses_and_results.harmonic_analyses.results import (
            _5973,
        )

        return self.__parent__._cast(_5973.ExcitationSourceSelection)

    @property
    def excitation_source_selection_group(
        self: "CastSelf",
    ) -> "_5975.ExcitationSourceSelectionGroup":
        from mastapy._private.system_model.analyses_and_results.harmonic_analyses.results import (
            _5975,
        )

        return self.__parent__._cast(_5975.ExcitationSourceSelectionGroup)
