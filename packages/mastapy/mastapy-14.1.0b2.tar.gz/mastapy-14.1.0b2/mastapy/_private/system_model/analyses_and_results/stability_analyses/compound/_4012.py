...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class BoltCompoundStabilityAnalysis(_4018.ComponentCompoundStabilityAnalysis):
    """BoltCompoundStabilityAnalysis
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_3877.BoltStabilityAnalysis]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_3877.BoltStabilityAnalysis]":
        """List[mastapy.system_model.analyses_and_results.stability_analyses.BoltStabilityAnalysis]
