...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class GearSetHarmonicLoadData(_1438.HarmonicLoadDataBase):
    """GearSetHarmonicLoadData
    ...
    @property
    def gear_mesh_te_order_type(self: "Self") -> "_7584.GearMeshTEOrderType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.static_loads._7584",
            "GearMeshTEOrderType",
        )(value)
    ...
    def gear_mesh_te_order_type(
        self: "Self", value: "_7584.GearMeshTEOrderType"
    ) -> None:
