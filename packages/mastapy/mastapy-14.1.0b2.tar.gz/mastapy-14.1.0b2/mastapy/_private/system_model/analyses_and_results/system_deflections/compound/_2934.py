...
class _Cast_AbstractShaftToMountableComponentConnectionCompoundSystemDeflection:
    ...
    def cycloidal_disc_planetary_bearing_connection_compound_system_deflection(
        self: "CastSelf",
    ) -> "_2977.CycloidalDiscPlanetaryBearingConnectionCompoundSystemDeflection":
        from mastapy._private.system_model.analyses_and_results.system_deflections.compound import (
            _2977,
        )
    ...
    def shaft_to_mountable_component_connection_compound_system_deflection(
        self: "CastSelf",
    ) -> "_3032.ShaftToMountableComponentConnectionCompoundSystemDeflection":
        from mastapy._private.system_model.analyses_and_results.system_deflections.compound import (
            _3032,
        )
...
class AbstractShaftToMountableComponentConnectionCompoundSystemDeflection(
    ...
    def connection_analysis_cases(
        self: "Self",
    ) -> "List[_2766.AbstractShaftToMountableComponentConnectionSystemDeflection]":
