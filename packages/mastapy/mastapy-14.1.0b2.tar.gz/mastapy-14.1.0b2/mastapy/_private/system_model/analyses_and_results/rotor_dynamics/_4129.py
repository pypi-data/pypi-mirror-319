...
from mastapy._private.system_model.analyses_and_results.rotor_dynamics import _4127
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ShaftModalComplexShapeAtStiffness(_4127.ShaftModalComplexShape):
    """ShaftModalComplexShapeAtStiffness
