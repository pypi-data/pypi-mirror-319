...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class WormGearSetLoadCase(_7586.GearSetLoadCase):
    """WormGearSetLoadCase
    ...
    @property
    def gears_load_case(self: "Self") -> "List[_7676.WormGearLoadCase]":
    ...
    @property
    def worm_gears_load_case(self: "Self") -> "List[_7676.WormGearLoadCase]":
        """List[mastapy.system_model.analyses_and_results.static_loads.WormGearLoadCase]
    ...
    @property
    def meshes_load_case(self: "Self") -> "List[_7677.WormGearMeshLoadCase]":
    ...
    @property
    def worm_meshes_load_case(self: "Self") -> "List[_7677.WormGearMeshLoadCase]":
        """List[mastapy.system_model.analyses_and_results.static_loads.WormGearMeshLoadCase]
