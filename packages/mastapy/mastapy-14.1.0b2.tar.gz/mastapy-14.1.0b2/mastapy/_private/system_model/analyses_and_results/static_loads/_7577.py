...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class FaceGearSetLoadCase(_7586.GearSetLoadCase):
    """FaceGearSetLoadCase
    ...
    @property
    def gears_load_case(self: "Self") -> "List[_7575.FaceGearLoadCase]":
    ...
    @property
    def face_gears_load_case(self: "Self") -> "List[_7575.FaceGearLoadCase]":
        """List[mastapy.system_model.analyses_and_results.static_loads.FaceGearLoadCase]
    ...
    @property
    def meshes_load_case(self: "Self") -> "List[_7576.FaceGearMeshLoadCase]":
    ...
    @property
    def face_meshes_load_case(self: "Self") -> "List[_7576.FaceGearMeshLoadCase]":
        """List[mastapy.system_model.analyses_and_results.static_loads.FaceGearMeshLoadCase]
