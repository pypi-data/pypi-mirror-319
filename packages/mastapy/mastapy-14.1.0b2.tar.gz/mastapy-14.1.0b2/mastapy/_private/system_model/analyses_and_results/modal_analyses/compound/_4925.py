...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class PowerLoadCompoundModalAnalysis(_4960.VirtualComponentCompoundModalAnalysis):
    """PowerLoadCompoundModalAnalysis
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4778.PowerLoadModalAnalysis]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4778.PowerLoadModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.PowerLoadModalAnalysis]
