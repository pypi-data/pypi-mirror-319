...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class GearSystemDeflection(_2862.MountableComponentSystemDeflection):
    """GearSystemDeflection
    ...
    @property
    def gear_set(self: "Self") -> "_2838.GearSetSystemDeflection":
    ...
    @property
    def power_flow_results(self: "Self") -> "_4192.GearPowerFlow":
