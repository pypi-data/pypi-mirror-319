...
class _Cast_ResultsForMultipleOrders:
    ...
    def results_for_multiple_orders_for_fe_surface(
        self: "CastSelf",
    ) -> "_5995.ResultsForMultipleOrdersForFESurface":
        from mastapy._private.system_model.analyses_and_results.harmonic_analyses.reportable_property_results import (
            _5995,
        )

        return self.__parent__._cast(_5995.ResultsForMultipleOrdersForFESurface)

    @property
    def results_for_multiple_orders_for_groups(
        self: "CastSelf",
    ) -> "_5996.ResultsForMultipleOrdersForGroups":
        from mastapy._private.system_model.analyses_and_results.harmonic_analyses.reportable_property_results import (
            _5996,
        )

        return self.__parent__._cast(_5996.ResultsForMultipleOrdersForGroups)
