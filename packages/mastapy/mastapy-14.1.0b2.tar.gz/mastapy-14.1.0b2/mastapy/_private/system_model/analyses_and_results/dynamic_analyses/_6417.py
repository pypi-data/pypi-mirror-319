...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class AGMAGleasonConicalGearSetDynamicAnalysis(_6445.ConicalGearSetDynamicAnalysis):
    """AGMAGleasonConicalGearSetDynamicAnalysis
    ...
    def conical_gears_dynamic_analysis(
        self: "Self",
    ) -> "List[_6415.AGMAGleasonConicalGearDynamicAnalysis]":
    ...
    def conical_meshes_dynamic_analysis(
        self: "Self",
    ) -> "List[_6416.AGMAGleasonConicalGearMeshDynamicAnalysis]":
