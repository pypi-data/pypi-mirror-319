...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ConceptGearSetCompoundStabilityAnalysis(_4053.GearSetCompoundStabilityAnalysis):
    """ConceptGearSetCompoundStabilityAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_3887.ConceptGearSetStabilityAnalysis]":
    ...
    def concept_gears_compound_stability_analysis(
        self: "Self",
    ) -> "List[_4022.ConceptGearCompoundStabilityAnalysis]":
    ...
    def concept_meshes_compound_stability_analysis(
        self: "Self",
    ) -> "List[_4023.ConceptGearMeshCompoundStabilityAnalysis]":
