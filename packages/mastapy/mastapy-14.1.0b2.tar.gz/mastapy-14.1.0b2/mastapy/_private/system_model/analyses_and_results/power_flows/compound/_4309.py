...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CVTPulleyCompoundPowerFlow(_4357.PulleyCompoundPowerFlow):
    """CVTPulleyCompoundPowerFlow
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4172.CVTPulleyPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.CVTPulleyPowerFlow]
