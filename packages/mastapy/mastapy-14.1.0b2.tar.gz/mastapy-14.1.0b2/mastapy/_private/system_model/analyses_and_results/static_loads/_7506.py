...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class AGMAGleasonConicalGearSetLoadCase(_7539.ConicalGearSetLoadCase):
    """AGMAGleasonConicalGearSetLoadCase
    ...
    def conical_gears_load_case(
        self: "Self",
    ) -> "List[_7504.AGMAGleasonConicalGearLoadCase]":
    ...
    def conical_meshes_load_case(
        self: "Self",
    ) -> "List[_7505.AGMAGleasonConicalGearMeshLoadCase]":
