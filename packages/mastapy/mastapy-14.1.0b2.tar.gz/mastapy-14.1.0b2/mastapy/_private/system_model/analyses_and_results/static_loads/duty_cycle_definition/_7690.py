...
if TYPE_CHECKING:
    ...
    from mastapy._private.utility.file_access_helpers import _1884
...
class _Cast_MultiTimeSeriesDataInputFileOptions:
    ...
    @property
    def data_input_file_options(self: "CastSelf") -> "_1915.DataInputFileOptions":
        return self.__parent__._cast(_1915.DataInputFileOptions)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class MultiTimeSeriesDataInputFileOptions(_1915.DataInputFileOptions):
    """MultiTimeSeriesDataInputFileOptions
    ...
    @property
    def delimiter_options(self: "Self") -> "_1884.TextFileDelimiterOptions":
