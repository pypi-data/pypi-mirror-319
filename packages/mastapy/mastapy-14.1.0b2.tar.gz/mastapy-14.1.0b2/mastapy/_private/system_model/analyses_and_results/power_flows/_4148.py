...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class BevelGearSetPowerFlow(_4136.AGMAGleasonConicalGearSetPowerFlow):
    """BevelGearSetPowerFlow
    ...
    @property
    def bevel_gears_power_flow(self: "Self") -> "List[_4147.BevelGearPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.BevelGearPowerFlow]
    ...
    @property
    def bevel_meshes_power_flow(self: "Self") -> "List[_4146.BevelGearMeshPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.BevelGearMeshPowerFlow]
