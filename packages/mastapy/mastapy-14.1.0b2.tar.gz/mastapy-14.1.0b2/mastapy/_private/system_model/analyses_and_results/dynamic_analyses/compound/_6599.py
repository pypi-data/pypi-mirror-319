...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class FaceGearSetCompoundDynamicAnalysis(_6604.GearSetCompoundDynamicAnalysis):
    """FaceGearSetCompoundDynamicAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_6468.FaceGearSetDynamicAnalysis]":
    ...
    def face_gears_compound_dynamic_analysis(
        self: "Self",
    ) -> "List[_6597.FaceGearCompoundDynamicAnalysis]":
    ...
    def face_meshes_compound_dynamic_analysis(
        self: "Self",
    ) -> "List[_6598.FaceGearMeshCompoundDynamicAnalysis]":
