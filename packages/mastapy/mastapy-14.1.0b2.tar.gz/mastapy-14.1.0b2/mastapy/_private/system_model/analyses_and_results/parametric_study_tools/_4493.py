...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model import _2272, _2277
...
class ParametricStudyToolOptions(_0.APIBase):
    ...
    def analysis_type(self: "Self", value: "_7508.AnalysisType") -> None:
    ...
    @property
    def parametric_study_type(self: "Self") -> "_7620.ParametricStudyType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.static_loads._7620",
            "ParametricStudyType",
        )(value)

    @parametric_study_type.setter
    @enforce_parameter_types
    def parametric_study_type(self: "Self", value: "_7620.ParametricStudyType") -> None:
    ...
    @property
    def external_full_fe_loader(self: "Self") -> "_2277.ExternalFullFELoader":
    ...
    @property
    def step_results(self: "Self") -> "List[_4495.ParametricStudyToolStepResult]":
    ...
    @property
    def study_variables(self: "Self") -> "List[_4496.ParametricStudyVariable]":
    ...
    def parametric_study_logging_variables(
        self: "Self",
    ) -> "List[_2726.AnalysisCaseVariable]":
    ...
    def add_logging_variable(
        self: "Self", design_entity: "_2272.DesignEntity", path: "List[str]"
    ) -> "_2726.AnalysisCaseVariable":
    ...
    def move_study_variable_down(
        self: "Self", study_variable: "_4496.ParametricStudyVariable"
    ) -> None:
        """Method does not return.
    ...
    def remove_logging_variable(
        self: "Self", analysis_variable: "_2726.AnalysisCaseVariable"
    ) -> None:
        """Method does not return.
