...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class TorqueInputOptions(_7692.PowerLoadInputOptions):
    """TorqueInputOptions
    ...
    @property
    def conversion_to_load_case(self: "Self") -> "_7698.TorqueValuesObtainedFrom":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.static_loads.duty_cycle_definition._7698",
    ...
    def conversion_to_load_case(
        self: "Self", value: "_7698.TorqueValuesObtainedFrom"
    ) -> None:
