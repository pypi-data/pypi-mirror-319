...
if TYPE_CHECKING:
    ...
    from mastapy._private.math_utility import _1563, _1572
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class PointLoadHarmonicLoadData(_1442.SpeedDependentHarmonicLoadData):
    """PointLoadHarmonicLoadData
    ...
    @property
    def degree_of_freedom(self: "Self") -> "_1563.DegreeOfFreedom":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.math_utility._1563", "DegreeOfFreedom"
        )(value)

    @degree_of_freedom.setter
    @enforce_parameter_types
    def degree_of_freedom(self: "Self", value: "_1563.DegreeOfFreedom") -> None:
