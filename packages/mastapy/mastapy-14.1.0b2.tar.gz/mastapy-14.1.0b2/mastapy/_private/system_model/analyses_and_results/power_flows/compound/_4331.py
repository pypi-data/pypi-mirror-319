...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class HypoidGearSetCompoundPowerFlow(_4273.AGMAGleasonConicalGearSetCompoundPowerFlow):
    """HypoidGearSetCompoundPowerFlow
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4197.HypoidGearSetPowerFlow]":
    ...
    def hypoid_gears_compound_power_flow(
        self: "Self",
    ) -> "List[_4329.HypoidGearCompoundPowerFlow]":
    ...
    def hypoid_meshes_compound_power_flow(
        self: "Self",
    ) -> "List[_4330.HypoidGearMeshCompoundPowerFlow]":
    ...
    @property
    def assembly_analysis_cases(self: "Self") -> "List[_4197.HypoidGearSetPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.HypoidGearSetPowerFlow]
