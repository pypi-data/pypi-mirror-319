...
from mastapy._private.system_model.analyses_and_results.static_loads import _7499
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class FEPartLoadCase(_7499.AbstractShaftOrHousingLoadCase):
    """FEPartLoadCase
    ...
    @property
    def angle_source(self: "Self") -> "_2428.AngleSource":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.fe._2428", "AngleSource"
        )(value)
    ...
    @enforce_parameter_types
    def fe_substructure(self: "Self", value: "_2453.FESubstructure") -> None:
        wrapper_type = (
    ...
    def surfaces_for_data_logging(
        self: "Self",
    ) -> "List[_7526.CMSElementFaceGroupWithSelectionOption]":
