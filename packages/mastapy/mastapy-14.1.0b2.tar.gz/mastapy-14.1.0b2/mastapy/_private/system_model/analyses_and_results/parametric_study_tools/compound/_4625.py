...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class MicrophoneCompoundParametricStudyTool(_4572.ComponentCompoundParametricStudyTool):
    """MicrophoneCompoundParametricStudyTool
    ...
    @property
    def component_design(self: "Self") -> "_2534.Microphone":
    ...
    @property
    def properties_changing_all_load_cases(self: "Self") -> "_7616.MicrophoneLoadCase":
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4483.MicrophoneParametricStudyTool]":
