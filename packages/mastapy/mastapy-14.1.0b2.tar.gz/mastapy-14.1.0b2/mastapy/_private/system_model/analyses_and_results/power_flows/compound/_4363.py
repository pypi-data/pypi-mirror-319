...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class RootAssemblyCompoundPowerFlow(_4274.AssemblyCompoundPowerFlow):
    """RootAssemblyCompoundPowerFlow
    ...
    @property
    def compound_static_load(self: "Self") -> "_5785.AbstractStaticLoadCaseGroup":
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4231.RootAssemblyPowerFlow]":
    ...
    @property
    def assembly_analysis_cases(self: "Self") -> "List[_4231.RootAssemblyPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.RootAssemblyPowerFlow]
