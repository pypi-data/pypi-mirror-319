...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class HypoidGearSetStabilityAnalysis(_3862.AGMAGleasonConicalGearSetStabilityAnalysis):
    """HypoidGearSetStabilityAnalysis
    ...
    def agma_gleason_conical_gears_stability_analysis(
        self: "Self",
    ) -> "List[_3923.HypoidGearStabilityAnalysis]":
    ...
    def agma_gleason_conical_meshes_stability_analysis(
        self: "Self",
    ) -> "List[_3921.HypoidGearMeshStabilityAnalysis]":
