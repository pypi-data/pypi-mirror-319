...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_results import _2009, _2017
    from mastapy._private.math_utility.measured_vectors import _1620
    ...
    from mastapy._private.system_model.part_model import _2509, _2511
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class BearingSystemDeflection(_2806.ConnectorSystemDeflection):
    """BearingSystemDeflection
    ...
    @property
    def spring_preload_chart(self: "Self") -> "_1934.TwoDChartDefinition":
    ...
    @property
    def component_detailed_analysis(self: "Self") -> "_2017.LoadedBearingResults":
    ...
    def inner_left_mounting_stiffness(
        self: "Self",
    ) -> "_2009.BearingStiffnessMatrixReporter":
    ...
    @property
    def power_flow_results(self: "Self") -> "_4138.BearingPowerFlow":
    ...
    @property
    def stiffness_between_rings(self: "Self") -> "_2009.BearingStiffnessMatrixReporter":
        """mastapy.bearings.bearing_results.BearingStiffnessMatrixReporter
    ...
    @property
    def stiffness_matrix(self: "Self") -> "_2009.BearingStiffnessMatrixReporter":
        """mastapy.bearings.bearing_results.BearingStiffnessMatrixReporter
    ...
    def race_mounting_options_for_analysis(
        self: "Self",
    ) -> "List[_2511.BearingRaceMountingOptions]":
    ...
    def stiffness_between_each_ring(
        self: "Self",
    ) -> "List[_2009.BearingStiffnessMatrixReporter]":
