...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings import _1946, _1947, _1960, _1966
    ...
    from mastapy._private.system_model.optimization import _2297, _2305
    from mastapy._private.system_model.part_model import _2542
    ...
    from mastapy._private.utility.cad_export import _1898
...
class MASTASettings(_0.APIBase):
    ...
    @property
    def iso14179_settings_database(self: "Self") -> "_2043.ISO14179SettingsDatabase":
    ...
    @property
    def bearing_settings(self: "Self") -> "_1946.BearingSettings":
    ...
    @property
    def bearing_settings_database(self: "Self") -> "_1947.BearingSettingsDatabase":
    ...
    @property
    def rolling_bearing_database(self: "Self") -> "_1960.RollingBearingDatabase":
    ...
    @property
    def skf_settings(self: "Self") -> "_1966.SKFSettings":
    ...
    @property
    def harmonic_analysis_draw_style(self: "Self") -> "_5888.HarmonicAnalysisDrawStyle":
    ...
    @property
    def mbd_analysis_draw_style(self: "Self") -> "_5579.MBDAnalysisDrawStyle":
    ...
    @property
    def modal_analysis_draw_style(self: "Self") -> "_4764.ModalAnalysisDrawStyle":
    ...
    @property
    def power_flow_draw_style(self: "Self") -> "_4223.PowerFlowDrawStyle":
    ...
    @property
    def system_deflection_draw_style(self: "Self") -> "_2906.SystemDeflectionDrawStyle":
    ...
    def model_view_options_draw_style(
        self: "Self",
    ) -> "_2321.ModelViewOptionsDrawStyle":
    ...
    def conical_gear_optimization_strategy_database(
        self: "Self",
    ) -> "_2297.ConicalGearOptimizationStrategyDatabase":
    ...
    def optimization_strategy_database(
        self: "Self",
    ) -> "_2305.OptimizationStrategyDatabase":
    ...
    def supercharger_rotor_set_database(
        self: "Self",
    ) -> "_2639.SuperchargerRotorSetDatabase":
    ...
    @property
    def planet_carrier_settings(self: "Self") -> "_2542.PlanetCarrierSettings":
    ...
    @property
    def cad_export_settings(self: "Self") -> "_1898.CADExportSettings":
    ...
    @property
    def database_settings(self: "Self") -> "_1893.DatabaseSettings":
    ...
    @property
    def program_settings(self: "Self") -> "_1656.ProgramSettings":
    ...
    @property
    def pushbullet_settings(self: "Self") -> "_1657.PushbulletSettings":
    ...
    @property
    def scripting_setup(self: "Self") -> "_1801.ScriptingSetup":
    ...
    @property
    def measurement_settings(self: "Self") -> "_1667.MeasurementSettings":
