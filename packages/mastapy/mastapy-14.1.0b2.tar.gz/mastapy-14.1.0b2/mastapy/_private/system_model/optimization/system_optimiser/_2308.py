...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.gears import _2601, _2607
    from mastapy._private.utility.logging import _1872
...
class SystemOptimiser(_0.APIBase):
    ...
    def selected_duty_cycle_for_system_optimiser(
        self: "Self", value: "_5789.DutyCycle"
    ) -> None:
        wrapper_type = (
    ...
    @property
    def design(self: "Self") -> "_2269.Design":
    ...
    @property
    def details(self: "Self") -> "_2309.SystemOptimiserDetails":
    ...
    @property
    def log(self: "Self") -> "_1872.Logger":
    ...
    @property
    def tooth_number_finder(self: "Self") -> "_2310.ToothNumberFinder":
    ...
    def system_optimisation_gear_sets(
        self: "Self",
    ) -> "List[_5793.SystemOptimisationGearSet]":
    ...
    @property
    def target_ratios(self: "Self") -> "List[_2306.DesignStateTargetRatio]":
    ...
    @property
    def system_optimiser_duty_cycle(self: "Self") -> "_5789.DutyCycle":
    ...
    @enforce_parameter_types
    def system_optimiser_duty_cycle(self: "Self", value: "_5789.DutyCycle") -> None:
