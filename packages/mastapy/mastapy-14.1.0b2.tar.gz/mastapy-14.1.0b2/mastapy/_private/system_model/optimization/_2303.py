...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.optimization import _2295, _2298, _2302
...
TStep = TypeVar("TStep", bound="_2302.OptimizationStep")
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class OptimizationStrategy(_2304.OptimizationStrategyBase, Generic[TStep]):
    """OptimizationStrategy
