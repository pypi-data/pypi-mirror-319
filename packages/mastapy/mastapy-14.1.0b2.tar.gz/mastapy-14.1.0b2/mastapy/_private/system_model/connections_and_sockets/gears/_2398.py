...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class WormGearMesh(_2382.GearMesh):
    """WormGearMesh
    ...
    @property
    def active_gear_mesh_design(self: "Self") -> "_990.WormGearMeshDesign":
    ...
    @property
    def worm_gear_mesh_design(self: "Self") -> "_990.WormGearMeshDesign":
        """mastapy.gears.gear_designs.worm.WormGearMeshDesign
