...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model import _2270, _2272
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class SpringDamperConnection(_2415.CouplingConnection):
    """SpringDamperConnection
    ...
    @property
    def damping_option(self: "Self") -> "_2270.ComponentDampingOption":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model._2270", "ComponentDampingOption"
        )(value)

    @damping_option.setter
    @enforce_parameter_types
    def damping_option(self: "Self", value: "_2270.ComponentDampingOption") -> None:
    ...
    @property
    def damping(self: "Self") -> "_75.LinearDampingConnectionProperties":
