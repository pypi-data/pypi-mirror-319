...
if __tc:
    ...
    from mastapy._private.system_model.analyses_and_results.rotor_dynamics._4127 import (
        ShaftModalComplexShape,
    )
    from mastapy._private.system_model.analyses_and_results.rotor_dynamics._4128 import (
        ShaftModalComplexShapeAtSpeeds,
    )
    from mastapy._private.system_model.analyses_and_results.rotor_dynamics._4129 import (
    ...
    __import_structure = {
        ...
        "_private.system_model.analyses_and_results.rotor_dynamics._4127": [
            "ShaftModalComplexShape"
        ],
        "_private.system_model.analyses_and_results.rotor_dynamics._4128": [
            "ShaftModalComplexShapeAtSpeeds"
        ],
        "_private.system_model.analyses_and_results.rotor_dynamics._4129": [
            "ShaftModalComplexShapeAtStiffness"
        ],
    }
