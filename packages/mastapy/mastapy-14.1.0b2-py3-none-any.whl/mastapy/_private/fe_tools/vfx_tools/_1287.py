...
from mastapy._private.fe_tools.vfx_tools.vfx_enums import _1288, _1289
...
class ProSolveOptions(_0.APIBase):
    ...
    @mpc_type.setter
    @enforce_parameter_types
    def mpc_type(self: "Self", value: "_1288.ProSolveMpcType") -> None:
    ...
    @enforce_parameter_types
    def type_of_solver(self: "Self", value: "_1289.ProSolveSolverType") -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
