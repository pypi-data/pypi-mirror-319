...
class OnedimensionalFunctionLookupTable(
    _1625.LookupTableBase["OnedimensionalFunctionLookupTable"]
):
    """OnedimensionalFunctionLookupTable
    ...
    @property
    def lookup_table(self: "Self") -> "_1594.Vector2DListAccessor":
    ...
    def lookup_table(self: "Self", value: "_1594.Vector2DListAccessor") -> None:
