...
class FourierSeries(_0.APIBase):
    ...
    @enforce_parameter_types
    def harmonic(self: "Self", index: "int") -> "_1575.HarmonicValue":
    ...
    def harmonics_above_cut_off(self: "Self") -> "List[_1575.HarmonicValue]":
        """List[mastapy.math_utility.HarmonicValue]"""
        return conversion.pn_to_mp_objects_in_list(
            pythonnet_method_call(self.wrapped, "HarmonicsAboveCutOff")
        )

    def harmonics_with_zeros_truncated(self: "Self") -> "List[_1575.HarmonicValue]":
        """List[mastapy.math_utility.HarmonicValue]"""
        return conversion.pn_to_mp_objects_in_list(
