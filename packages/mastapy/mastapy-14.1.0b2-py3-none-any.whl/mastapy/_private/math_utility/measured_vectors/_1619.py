...
class _Cast_ForceAndDisplacementResults:
    ...
    def abstract_force_and_displacement_results(
        self: "CastSelf",
    ) -> "_1618.AbstractForceAndDisplacementResults":
        return self.__parent__._cast(_1618.AbstractForceAndDisplacementResults)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ForceAndDisplacementResults(_1618.AbstractForceAndDisplacementResults):
    """ForceAndDisplacementResults
    ...
    @property
    def displacement(self: "Self") -> "_1623.VectorWithLinearAndAngularComponents":
