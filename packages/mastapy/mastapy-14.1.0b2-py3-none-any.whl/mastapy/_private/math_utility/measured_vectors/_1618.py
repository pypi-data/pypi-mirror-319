...
if TYPE_CHECKING:
    ...
    from mastapy._private.math_utility.measured_vectors import _1619, _1620, _1623
...
class _Cast_AbstractForceAndDisplacementResults:
    ...
    def force_and_displacement_results(
        self: "CastSelf",
    ) -> "_1619.ForceAndDisplacementResults":
        from mastapy._private.math_utility.measured_vectors import _1619

        return self.__parent__._cast(_1619.ForceAndDisplacementResults)

    @property
    def force_results(self: "CastSelf") -> "_1620.ForceResults":
        from mastapy._private.math_utility.measured_vectors import _1620

        return self.__parent__._cast(_1620.ForceResults)
...
class AbstractForceAndDisplacementResults(_0.APIBase):
    ...
    @property
    def force(self: "Self") -> "_1623.VectorWithLinearAndAngularComponents":
