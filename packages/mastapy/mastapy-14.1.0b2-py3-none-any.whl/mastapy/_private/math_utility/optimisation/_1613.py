...
class _Cast_ParetoOptimisationVariableBase:
    ...
    @property
    def pareto_optimisation_input(self: "CastSelf") -> "_1606.ParetoOptimisationInput":
        from mastapy._private.math_utility.optimisation import _1606

        return self.__parent__._cast(_1606.ParetoOptimisationInput)

    @property
    def pareto_optimisation_output(
        self: "CastSelf",
    ) -> "_1607.ParetoOptimisationOutput":
        from mastapy._private.math_utility.optimisation import _1607

        return self.__parent__._cast(_1607.ParetoOptimisationOutput)

    @property
    def pareto_optimisation_variable(
        self: "CastSelf",
    ) -> "_1612.ParetoOptimisationVariable":
        from mastapy._private.math_utility.optimisation import _1612

        return self.__parent__._cast(_1612.ParetoOptimisationVariable)

    @property
    def parametric_study_doe_result_variable(
        self: "CastSelf",
    ) -> "_4488.ParametricStudyDOEResultVariable":
        from mastapy._private.system_model.analyses_and_results.parametric_study_tools import (
            _4488,
        )

        return self.__parent__._cast(_4488.ParametricStudyDOEResultVariable)
...
class ParetoOptimisationVariableBase(_0.APIBase):
    ...
    @property
    def integer_range(self: "Self") -> "_1648.IntegerRange":
    ...
    @enforce_parameter_types
    def integer_range(self: "Self", value: "_1648.IntegerRange") -> None:
    ...
    @property
    def range(self: "Self") -> "_1548.Range":
    ...
    @range.setter
    @enforce_parameter_types
    def range(self: "Self", value: "_1548.Range") -> None:
        pythonnet_property_set(self.wrapped, "Range", value.wrapped)

    @property
    def specification_type(self: "Self") -> "_1617.TargetingPropertyTo":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.math_utility.optimisation._1617", "TargetingPropertyTo"
        )(value)

    @specification_type.setter
    @enforce_parameter_types
    def specification_type(self: "Self", value: "_1617.TargetingPropertyTo") -> None:
    ...
    @property
    def specify_input_range_as(self: "Self") -> "_1616.SpecifyOptimisationInputAs":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.math_utility.optimisation._1616",
    ...
    def specify_input_range_as(
        self: "Self", value: "_1616.SpecifyOptimisationInputAs"
    ) -> None:
        value = conversion.mp_to_pn_enum(
