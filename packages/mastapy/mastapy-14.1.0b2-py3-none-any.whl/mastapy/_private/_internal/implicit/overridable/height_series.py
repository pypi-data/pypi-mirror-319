...
class Overridable_HeightSeries(mixins.OverridableMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls: "Type[Overridable_HeightSeries]") -> "_2226.HeightSeries":
    ...
    def implicit_type(cls: "Type[Overridable_HeightSeries]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2226.HeightSeries.type_()

    @property
    def value(self: "Self") -> "_2226.HeightSeries":
    ...
    @property
    def override_value(self: "Self") -> "_2226.HeightSeries":
        """mastapy.bearings.bearing_designs.rolling.HeightSeries
    ...
    @property
    def calculated_value(self: "Self") -> "_2226.HeightSeries":
        """mastapy.bearings.bearing_designs.rolling.HeightSeries
