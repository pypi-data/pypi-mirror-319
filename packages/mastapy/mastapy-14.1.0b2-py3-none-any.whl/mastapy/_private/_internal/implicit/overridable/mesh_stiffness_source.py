...
class Overridable_MeshStiffnessSource(mixins.OverridableMixin, Enum):
    ...
    def wrapped_type(
        ...
        Returns:
            _7614.MeshStiffnessSource
        """
        return _7614.MeshStiffnessSource
    ...
    def implicit_type(cls: "Type[Overridable_MeshStiffnessSource]") -> "Any":
        ...
        Returns:
            Any
        """
        return _7614.MeshStiffnessSource.type_()

    @property
    def value(self: "Self") -> "_7614.MeshStiffnessSource":
    ...
    @property
    def override_value(self: "Self") -> "_7614.MeshStiffnessSource":
        """mastapy.system_model.analyses_and_results.static_loads.MeshStiffnessSource
    ...
    @property
    def calculated_value(self: "Self") -> "_7614.MeshStiffnessSource":
        """mastapy.system_model.analyses_and_results.static_loads.MeshStiffnessSource
