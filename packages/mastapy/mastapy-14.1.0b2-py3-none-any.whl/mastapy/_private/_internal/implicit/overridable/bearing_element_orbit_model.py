...
class Overridable_BearingElementOrbitModel(mixins.OverridableMixin, Enum):
    ...
    def wrapped_type(
    ...
    ) -> "_5503.BearingElementOrbitModel":
        ...
        Returns:
            _5503.BearingElementOrbitModel
        """
        return _5503.BearingElementOrbitModel
    ...
    def implicit_type(cls: "Type[Overridable_BearingElementOrbitModel]") -> "Any":
        ...
        Returns:
            Any
        """
        return _5503.BearingElementOrbitModel.type_()

    @property
    def value(self: "Self") -> "_5503.BearingElementOrbitModel":
    ...
    @property
    def override_value(self: "Self") -> "_5503.BearingElementOrbitModel":
        """mastapy.system_model.analyses_and_results.mbd_analyses.BearingElementOrbitModel
    ...
    @property
    def calculated_value(self: "Self") -> "_5503.BearingElementOrbitModel":
        """mastapy.system_model.analyses_and_results.mbd_analyses.BearingElementOrbitModel
