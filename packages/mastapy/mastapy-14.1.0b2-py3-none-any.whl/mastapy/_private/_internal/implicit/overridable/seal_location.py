...
from mastapy._private.bearings import _1965
...
class Overridable_SealLocation(mixins.OverridableMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls: "Type[Overridable_SealLocation]") -> "_1965.SealLocation":
    ...
    def implicit_type(cls: "Type[Overridable_SealLocation]") -> "Any":
        ...
        Returns:
            Any
        """
        return _1965.SealLocation.type_()

    @property
    def value(self: "Self") -> "_1965.SealLocation":
    ...
    @property
    def override_value(self: "Self") -> "_1965.SealLocation":
        """mastapy.bearings.SealLocation
    ...
    @property
    def calculated_value(self: "Self") -> "_1965.SealLocation":
        """mastapy.bearings.SealLocation
