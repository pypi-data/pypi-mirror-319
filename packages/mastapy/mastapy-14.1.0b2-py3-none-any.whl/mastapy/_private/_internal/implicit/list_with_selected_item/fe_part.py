...
class ListWithSelectedItem_FEPart(_2523.FEPart, mixins.ListWithSelectedItemMixin):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_FEPart]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2523.FEPart.TYPE

    @property
    def selected_value(self: "Self") -> "_2523.FEPart":
    ...
    @property
    def available_values(self: "Self") -> "List[_2523.FEPart]":
