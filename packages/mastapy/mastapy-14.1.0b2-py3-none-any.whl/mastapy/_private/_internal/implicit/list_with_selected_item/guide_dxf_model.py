...
class ListWithSelectedItem_GuideDxfModel(
    _2525.GuideDxfModel, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_GuideDxfModel]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2525.GuideDxfModel.TYPE

    @property
    def selected_value(self: "Self") -> "_2525.GuideDxfModel":
    ...
    @property
    def available_values(self: "Self") -> "List[_2525.GuideDxfModel]":
