...
class ListWithSelectedItem_FESubstructureNode(
    _2455.FESubstructureNode, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_FESubstructureNode]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2455.FESubstructureNode.TYPE

    @property
    def selected_value(self: "Self") -> "_2455.FESubstructureNode":
    ...
    @property
    def available_values(self: "Self") -> "List[_2455.FESubstructureNode]":
