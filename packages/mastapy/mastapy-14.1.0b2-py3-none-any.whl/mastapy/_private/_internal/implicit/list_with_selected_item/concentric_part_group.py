...
class ListWithSelectedItem_ConcentricPartGroup(
    _2560.ConcentricPartGroup, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_ConcentricPartGroup]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2560.ConcentricPartGroup.TYPE

    @property
    def selected_value(self: "Self") -> "_2560.ConcentricPartGroup":
    ...
    @property
    def available_values(self: "Self") -> "List[_2560.ConcentricPartGroup]":
