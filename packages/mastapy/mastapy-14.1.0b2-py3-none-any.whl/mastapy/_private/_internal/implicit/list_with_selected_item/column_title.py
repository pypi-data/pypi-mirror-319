...
class ListWithSelectedItem_ColumnTitle(
    _1883.ColumnTitle, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_ColumnTitle]") -> "Any":
        ...
        Returns:
            Any
        """
        return _1883.ColumnTitle.TYPE

    @property
    def selected_value(self: "Self") -> "_1883.ColumnTitle":
    ...
    @property
    def available_values(self: "Self") -> "List[_1883.ColumnTitle]":
