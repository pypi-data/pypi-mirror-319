...
class ListWithSelectedItem_Datum(_2518.Datum, mixins.ListWithSelectedItemMixin):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_Datum]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2518.Datum.TYPE

    @property
    def selected_value(self: "Self") -> "_2518.Datum":
    ...
    @property
    def available_values(self: "Self") -> "List[_2518.Datum]":
