...
class ListWithSelectedItem_StaticLoadCase(
    _7496.StaticLoadCase, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_StaticLoadCase]") -> "Any":
        ...
        Returns:
            Any
        """
        return _7496.StaticLoadCase.TYPE

    @property
    def selected_value(self: "Self") -> "_7496.StaticLoadCase":
    ...
    @property
    def available_values(self: "Self") -> "List[_7496.StaticLoadCase]":
