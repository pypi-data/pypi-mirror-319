...
class ListWithSelectedItem_DutyCycle(_5789.DutyCycle, mixins.ListWithSelectedItemMixin):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_DutyCycle]") -> "Any":
        ...
        Returns:
            Any
        """
        return _5789.DutyCycle.TYPE

    @property
    def selected_value(self: "Self") -> "_5789.DutyCycle":
    ...
    @property
    def available_values(self: "Self") -> "List[_5789.DutyCycle]":
