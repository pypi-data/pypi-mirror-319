...
class ListWithSelectedItem_ShaftHubConnection(
    _2677.ShaftHubConnection, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_ShaftHubConnection]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2677.ShaftHubConnection.TYPE

    @property
    def selected_value(self: "Self") -> "_2677.ShaftHubConnection":
    ...
    @property
    def available_values(self: "Self") -> "List[_2677.ShaftHubConnection]":
