...
class ListWithSelectedItem_MicrophoneArray(
    _2535.MicrophoneArray, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_MicrophoneArray]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2535.MicrophoneArray.TYPE

    @property
    def selected_value(self: "Self") -> "_2535.MicrophoneArray":
    ...
    @property
    def available_values(self: "Self") -> "List[_2535.MicrophoneArray]":
