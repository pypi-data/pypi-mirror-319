...
class EnumWithSelectedValue_DynamicsResponseType(
    ...
    def wrapped_type(
        ...
        Returns:
            _4733.DynamicsResponseType
        """
        return _4733.DynamicsResponseType
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_DynamicsResponseType]") -> "Any":
        ...
        Returns:
            Any
        """
        return _4733.DynamicsResponseType.type_()

    @property
    def selected_value(self: "Self") -> "_4733.DynamicsResponseType":
    ...
    @property
    def available_values(self: "Self") -> "List[_4733.DynamicsResponseType]":
