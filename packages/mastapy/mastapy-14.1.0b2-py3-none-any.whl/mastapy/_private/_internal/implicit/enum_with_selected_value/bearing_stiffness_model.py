...
class EnumWithSelectedValue_BearingStiffnessModel(
    ...
    def wrapped_type(
        ...
        Returns:
            _5505.BearingStiffnessModel
        """
        return _5505.BearingStiffnessModel
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _5505.BearingStiffnessModel.type_()

    @property
    def selected_value(self: "Self") -> "_5505.BearingStiffnessModel":
    ...
    @property
    def available_values(self: "Self") -> "List[_5505.BearingStiffnessModel]":
