...
from mastapy._private.bearings.bearing_results import _2031
...
class EnumWithSelectedValue_RaceAxialMountingType(
    ...
    def wrapped_type(
        ...
        Returns:
            _2031.RaceAxialMountingType
        """
        return _2031.RaceAxialMountingType
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2031.RaceAxialMountingType.type_()

    @property
    def selected_value(self: "Self") -> "_2031.RaceAxialMountingType":
    ...
    @property
    def available_values(self: "Self") -> "List[_2031.RaceAxialMountingType]":
