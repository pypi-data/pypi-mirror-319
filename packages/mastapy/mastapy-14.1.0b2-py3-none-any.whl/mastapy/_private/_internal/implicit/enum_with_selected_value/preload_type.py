...
from mastapy._private.bearings.bearing_results import _2029
...
class EnumWithSelectedValue_PreloadType(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_PreloadType]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2029.PreloadType.type_()

    @property
    def selected_value(self: "Self") -> "_2029.PreloadType":
    ...
    @property
    def available_values(self: "Self") -> "List[_2029.PreloadType]":
