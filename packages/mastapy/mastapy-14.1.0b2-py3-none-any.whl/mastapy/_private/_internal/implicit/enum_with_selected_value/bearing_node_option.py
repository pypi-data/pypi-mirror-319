...
class EnumWithSelectedValue_BearingNodeOption(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    def wrapped_type(
        ...
        Returns:
            _2432.BearingNodeOption
        """
        return _2432.BearingNodeOption
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_BearingNodeOption]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2432.BearingNodeOption.type_()

    @property
    def selected_value(self: "Self") -> "_2432.BearingNodeOption":
    ...
    @property
    def available_values(self: "Self") -> "List[_2432.BearingNodeOption]":
