...
class EnumWithSelectedValue_PointLoadLoadCase_ForceSpecification(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_PointLoadLoadCase_ForceSpecification]",
    ) -> "_7631.PointLoadLoadCase.ForceSpecification":
        ...
        Returns:
            _7631.PointLoadLoadCase.ForceSpecification
        """
        return _7631.PointLoadLoadCase.ForceSpecification
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _7631.PointLoadLoadCase.ForceSpecification.type_()

    @property
    def selected_value(self: "Self") -> "_7631.PointLoadLoadCase.ForceSpecification":
    ...
    def available_values(
        self: "Self",
    ) -> "List[_7631.PointLoadLoadCase.ForceSpecification]":
