...
class EnumWithSelectedValue_RigidConnectorToothSpacingType(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_RigidConnectorToothSpacingType]",
    ) -> "_2673.RigidConnectorToothSpacingType":
        ...
        Returns:
            _2673.RigidConnectorToothSpacingType
        """
        return _2673.RigidConnectorToothSpacingType
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2673.RigidConnectorToothSpacingType.type_()

    @property
    def selected_value(self: "Self") -> "_2673.RigidConnectorToothSpacingType":
    ...
    @property
    def available_values(self: "Self") -> "List[_2673.RigidConnectorToothSpacingType]":
