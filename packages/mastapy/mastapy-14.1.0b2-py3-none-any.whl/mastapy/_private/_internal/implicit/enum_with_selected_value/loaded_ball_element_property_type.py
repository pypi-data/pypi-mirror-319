...
from mastapy._private.bearings.bearing_results import _2030
...
class EnumWithSelectedValue_LoadedBallElementPropertyType(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_LoadedBallElementPropertyType]",
    ) -> "_2030.LoadedBallElementPropertyType":
        ...
        Returns:
            _2030.LoadedBallElementPropertyType
        """
        return _2030.LoadedBallElementPropertyType
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2030.LoadedBallElementPropertyType.type_()

    @property
    def selected_value(self: "Self") -> "_2030.LoadedBallElementPropertyType":
    ...
    @property
    def available_values(self: "Self") -> "List[_2030.LoadedBallElementPropertyType]":
