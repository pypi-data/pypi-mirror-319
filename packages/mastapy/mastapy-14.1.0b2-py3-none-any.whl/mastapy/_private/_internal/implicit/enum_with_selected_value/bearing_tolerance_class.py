...
class EnumWithSelectedValue_BearingToleranceClass(
    ...
    def wrapped_type(
        ...
        Returns:
            _1970.BearingToleranceClass
        """
        return _1970.BearingToleranceClass
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1970.BearingToleranceClass.type_()

    @property
    def selected_value(self: "Self") -> "_1970.BearingToleranceClass":
    ...
    @property
    def available_values(self: "Self") -> "List[_1970.BearingToleranceClass]":
