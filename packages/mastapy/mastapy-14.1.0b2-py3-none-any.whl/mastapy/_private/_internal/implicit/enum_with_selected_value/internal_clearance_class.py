...
class EnumWithSelectedValue_InternalClearanceClass(
    ...
    def wrapped_type(
        ...
        Returns:
            _1969.InternalClearanceClass
        """
        return _1969.InternalClearanceClass
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1969.InternalClearanceClass.type_()

    @property
    def selected_value(self: "Self") -> "_1969.InternalClearanceClass":
    ...
    @property
    def available_values(self: "Self") -> "List[_1969.InternalClearanceClass]":
