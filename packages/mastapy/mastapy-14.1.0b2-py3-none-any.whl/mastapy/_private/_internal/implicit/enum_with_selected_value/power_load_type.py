...
class EnumWithSelectedValue_PowerLoadType(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_PowerLoadType]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2288.PowerLoadType.type_()

    @property
    def selected_value(self: "Self") -> "_2288.PowerLoadType":
    ...
    @property
    def available_values(self: "Self") -> "List[_2288.PowerLoadType]":
