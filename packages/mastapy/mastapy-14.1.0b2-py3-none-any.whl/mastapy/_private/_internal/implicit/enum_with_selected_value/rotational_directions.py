...
from mastapy._private.bearings import _1964
...
class EnumWithSelectedValue_RotationalDirections(
    ...
    def wrapped_type(
        ...
        Returns:
            _1964.RotationalDirections
        """
        return _1964.RotationalDirections
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_RotationalDirections]") -> "Any":
        ...
        Returns:
            Any
        """
        return _1964.RotationalDirections.type_()

    @property
    def selected_value(self: "Self") -> "_1964.RotationalDirections":
    ...
    @property
    def available_values(self: "Self") -> "List[_1964.RotationalDirections]":
