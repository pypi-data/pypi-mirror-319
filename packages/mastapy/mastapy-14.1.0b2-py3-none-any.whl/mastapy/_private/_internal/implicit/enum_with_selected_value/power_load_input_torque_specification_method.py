...
class EnumWithSelectedValue_PowerLoadInputTorqueSpecificationMethod(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_PowerLoadInputTorqueSpecificationMethod]",
    ) -> "_2286.PowerLoadInputTorqueSpecificationMethod":
        ...
        Returns:
            _2286.PowerLoadInputTorqueSpecificationMethod
        """
        return _2286.PowerLoadInputTorqueSpecificationMethod
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2286.PowerLoadInputTorqueSpecificationMethod.type_()

    @property
    def selected_value(self: "Self") -> "_2286.PowerLoadInputTorqueSpecificationMethod":
    ...
    def available_values(
        self: "Self",
    ) -> "List[_2286.PowerLoadInputTorqueSpecificationMethod]":
