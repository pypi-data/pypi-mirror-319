...
class EnumWithSelectedValue_MeshStiffnessModel(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    def wrapped_type(
        ...
        Returns:
            _2283.MeshStiffnessModel
        """
        return _2283.MeshStiffnessModel
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_MeshStiffnessModel]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2283.MeshStiffnessModel.type_()

    @property
    def selected_value(self: "Self") -> "_2283.MeshStiffnessModel":
    ...
    @property
    def available_values(self: "Self") -> "List[_2283.MeshStiffnessModel]":
