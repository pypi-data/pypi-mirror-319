...
from mastapy._private.bearings import _1962
...
class EnumWithSelectedValue_RollingBearingRaceType(
    ...
    def wrapped_type(
        ...
        Returns:
            _1962.RollingBearingRaceType
        """
        return _1962.RollingBearingRaceType
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1962.RollingBearingRaceType.type_()

    @property
    def selected_value(self: "Self") -> "_1962.RollingBearingRaceType":
    ...
    @property
    def available_values(self: "Self") -> "List[_1962.RollingBearingRaceType]":
