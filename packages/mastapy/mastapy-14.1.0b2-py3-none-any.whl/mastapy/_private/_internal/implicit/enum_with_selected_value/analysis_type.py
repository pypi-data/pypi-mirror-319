...
class EnumWithSelectedValue_AnalysisType(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_AnalysisType]") -> "Any":
        ...
        Returns:
            Any
        """
        return _7508.AnalysisType.type_()

    @property
    def selected_value(self: "Self") -> "_7508.AnalysisType":
    ...
    @property
    def available_values(self: "Self") -> "List[_7508.AnalysisType]":
