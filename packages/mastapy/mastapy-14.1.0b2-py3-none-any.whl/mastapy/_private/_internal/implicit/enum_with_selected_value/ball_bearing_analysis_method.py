...
class EnumWithSelectedValue_BallBearingAnalysisMethod(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_BallBearingAnalysisMethod]",
    ) -> "_2034.BallBearingAnalysisMethod":
        ...
        Returns:
            _2034.BallBearingAnalysisMethod
        """
        return _2034.BallBearingAnalysisMethod
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2034.BallBearingAnalysisMethod.type_()

    @property
    def selected_value(self: "Self") -> "_2034.BallBearingAnalysisMethod":
    ...
    @property
    def available_values(self: "Self") -> "List[_2034.BallBearingAnalysisMethod]":
