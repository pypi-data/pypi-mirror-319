...
from mastapy._private.system_model.analyses_and_results.static_loads import _7588
...
class EnumWithSelectedValue_HarmonicExcitationType(
    ...
    def wrapped_type(
        ...
        Returns:
            _7588.HarmonicExcitationType
        """
        return _7588.HarmonicExcitationType
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _7588.HarmonicExcitationType.type_()

    @property
    def selected_value(self: "Self") -> "_7588.HarmonicExcitationType":
    ...
    @property
    def available_values(self: "Self") -> "List[_7588.HarmonicExcitationType]":
