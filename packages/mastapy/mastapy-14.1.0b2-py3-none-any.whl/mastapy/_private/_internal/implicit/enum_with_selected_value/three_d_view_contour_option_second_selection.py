...
from mastapy._private.utility.enums import _1889
...
class EnumWithSelectedValue_ThreeDViewContourOptionSecondSelection(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_ThreeDViewContourOptionSecondSelection]",
    ) -> "_1889.ThreeDViewContourOptionSecondSelection":
        ...
        Returns:
            _1889.ThreeDViewContourOptionSecondSelection
        """
        return _1889.ThreeDViewContourOptionSecondSelection
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1889.ThreeDViewContourOptionSecondSelection.type_()

    @property
    def selected_value(self: "Self") -> "_1889.ThreeDViewContourOptionSecondSelection":
    ...
    def available_values(
        self: "Self",
    ) -> "List[_1889.ThreeDViewContourOptionSecondSelection]":
