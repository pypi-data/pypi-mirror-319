...
class _Cast_ElementScalarState:
    ...
    @property
    def entity_vector_state(self: "CastSelf") -> "_126.EntityVectorState":
        from mastapy._private.nodal_analysis.states import _126

        return self.__parent__._cast(_126.EntityVectorState)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ElementScalarState(_125.ElementVectorState):
    """ElementScalarState
