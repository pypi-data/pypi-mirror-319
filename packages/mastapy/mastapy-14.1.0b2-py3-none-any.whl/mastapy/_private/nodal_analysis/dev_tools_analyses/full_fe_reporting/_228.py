...
if TYPE_CHECKING:
    ...
    from mastapy._private.fe_tools.vis_tools_global.vis_tools_global_enums import _1283
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ElementPropertiesBeam(_235.ElementPropertiesWithMaterial):
    """ElementPropertiesBeam
    ...
    @property
    def section_type(self: "Self") -> "_1283.BeamSectionType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.fe_tools.vis_tools_global.vis_tools_global_enums._1283",
            "BeamSectionType",
        )(value)
