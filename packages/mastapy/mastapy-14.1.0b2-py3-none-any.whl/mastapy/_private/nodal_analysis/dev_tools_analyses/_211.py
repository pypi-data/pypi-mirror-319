...
class _Cast_FEModelTabDrawStyle:
    ...
    def fe_model_harmonic_analysis_draw_style(
        self: "CastSelf",
    ) -> "_205.FEModelHarmonicAnalysisDrawStyle":
        from mastapy._private.nodal_analysis.dev_tools_analyses import _205

        return self.__parent__._cast(_205.FEModelHarmonicAnalysisDrawStyle)

    @property
    def fe_model_modal_analysis_draw_style(
        self: "CastSelf",
    ) -> "_207.FEModelModalAnalysisDrawStyle":
        from mastapy._private.nodal_analysis.dev_tools_analyses import _207

        return self.__parent__._cast(_207.FEModelModalAnalysisDrawStyle)

    @property
    def fe_model_static_analysis_draw_style(
        self: "CastSelf",
    ) -> "_210.FEModelStaticAnalysisDrawStyle":
        from mastapy._private.nodal_analysis.dev_tools_analyses import _210

        return self.__parent__._cast(_210.FEModelStaticAnalysisDrawStyle)
