...
class DiagonalNonLinearStiffness(_0.APIBase):
    ...
    @property
    def theta_x_stiffness(self: "Self") -> "_1594.Vector2DListAccessor":
    ...
    def theta_x_stiffness(self: "Self", value: "_1594.Vector2DListAccessor") -> None:
        pythonnet_property_set(self.wrapped, "ThetaXStiffness", value.wrapped)

    @property
    def theta_y_stiffness(self: "Self") -> "_1594.Vector2DListAccessor":
        """mastapy.math_utility.Vector2DListAccessor"""
    ...
    @enforce_parameter_types
    def theta_y_stiffness(self: "Self", value: "_1594.Vector2DListAccessor") -> None:
        pythonnet_property_set(self.wrapped, "ThetaYStiffness", value.wrapped)

    @property
    def theta_z_stiffness(self: "Self") -> "_1594.Vector2DListAccessor":
        """mastapy.math_utility.Vector2DListAccessor"""
    ...
    @enforce_parameter_types
    def theta_z_stiffness(self: "Self", value: "_1594.Vector2DListAccessor") -> None:
        pythonnet_property_set(self.wrapped, "ThetaZStiffness", value.wrapped)

    @property
    def x_stiffness(self: "Self") -> "_1594.Vector2DListAccessor":
        """mastapy.math_utility.Vector2DListAccessor"""
    ...
    @x_stiffness.setter
    @enforce_parameter_types
    def x_stiffness(self: "Self", value: "_1594.Vector2DListAccessor") -> None:
        pythonnet_property_set(self.wrapped, "XStiffness", value.wrapped)

    @property
    def y_stiffness(self: "Self") -> "_1594.Vector2DListAccessor":
        """mastapy.math_utility.Vector2DListAccessor"""
    ...
    @y_stiffness.setter
    @enforce_parameter_types
    def y_stiffness(self: "Self", value: "_1594.Vector2DListAccessor") -> None:
        pythonnet_property_set(self.wrapped, "YStiffness", value.wrapped)

    @property
    def z_stiffness(self: "Self") -> "_1594.Vector2DListAccessor":
        """mastapy.math_utility.Vector2DListAccessor"""
    ...
    @z_stiffness.setter
    @enforce_parameter_types
    def z_stiffness(self: "Self", value: "_1594.Vector2DListAccessor") -> None:
