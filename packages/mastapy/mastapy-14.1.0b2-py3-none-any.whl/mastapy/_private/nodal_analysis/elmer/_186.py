...
class _Cast_ElmerResultsFromElectromagneticAnalysis:
    ...
    @property
    def elmer_results(self: "CastSelf") -> "_185.ElmerResults":
        return self.__parent__._cast(_185.ElmerResults)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ElmerResultsFromElectromagneticAnalysis(_185.ElmerResults):
    """ElmerResultsFromElectromagneticAnalysis
