...
if TYPE_CHECKING:
    ...
    from mastapy._private.nodal_analysis.elmer.results import _194, _195
...
class _Cast_Data:
    ...
    @property
    def data_1d(self: "CastSelf") -> "_194.Data1D":
        from mastapy._private.nodal_analysis.elmer.results import _194

        return self.__parent__._cast(_194.Data1D)

    @property
    def data_3d(self: "CastSelf") -> "_195.Data3D":
        from mastapy._private.nodal_analysis.elmer.results import _195

        return self.__parent__._cast(_195.Data3D)
