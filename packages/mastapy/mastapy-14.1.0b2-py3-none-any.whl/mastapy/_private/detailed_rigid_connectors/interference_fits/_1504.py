...
from mastapy._private.detailed_rigid_connectors.interference_fits import _1507
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class InterferenceFitDesign(_1446.DetailedRigidConnectorDesign):
    """InterferenceFitDesign
    ...
    @property
    def assembly_method(self: "Self") -> "_1502.AssemblyMethods":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.detailed_rigid_connectors.interference_fits._1502",
            "AssemblyMethods",
        )(value)

    @assembly_method.setter
    @enforce_parameter_types
    def assembly_method(self: "Self", value: "_1502.AssemblyMethods") -> None:
    ...
    @property
    def calculation_method(self: "Self") -> "_1503.CalculationMethods":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.detailed_rigid_connectors.interference_fits._1503",
            "CalculationMethods",
        )(value)

    @calculation_method.setter
    @enforce_parameter_types
    def calculation_method(self: "Self", value: "_1503.CalculationMethods") -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.DetailedRigidConnectors.InterferenceFits.CalculationMethods",
        )
    ...
    @enforce_parameter_types
    def joint_interface_type(
        self: "Self", value: "_1507.Table4JointInterfaceTypes"
    ) -> None:
