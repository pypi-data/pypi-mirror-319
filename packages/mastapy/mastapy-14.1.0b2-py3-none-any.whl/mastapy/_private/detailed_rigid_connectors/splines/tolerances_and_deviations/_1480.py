...
from mastapy._private.detailed_rigid_connectors.splines import _1471, _1477
...
class FitAndTolerance(_0.APIBase):
    ...
    def fit_class(self: "Self", value: "_1471.SplineFitClassType") -> None:
    ...
    @enforce_parameter_types
    def tolerance_class(self: "Self", value: "_1477.SplineToleranceClassTypes") -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
