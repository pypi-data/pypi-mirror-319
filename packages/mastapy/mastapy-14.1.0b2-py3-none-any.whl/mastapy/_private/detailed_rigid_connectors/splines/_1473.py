...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class SplineHalfDesign(_1447.DetailedRigidConnectorHalfDesign):
    """SplineHalfDesign
    ...
    @property
    def heat_treatment(self: "Self") -> "_1457.HeatTreatmentTypes":
    ...
    @enforce_parameter_types
    def heat_treatment(self: "Self", value: "_1457.HeatTreatmentTypes") -> None:
    ...
    @property
    def fit_and_tolerance(self: "Self") -> "_1480.FitAndTolerance":
