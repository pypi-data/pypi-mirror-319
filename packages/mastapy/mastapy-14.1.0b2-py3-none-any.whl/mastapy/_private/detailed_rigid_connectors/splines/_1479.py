...
from mastapy._private.detailed_rigid_connectors.splines import _1462, _1463, _1474
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class StandardSplineJointDesign(_1474.SplineJointDesign):
    """StandardSplineJointDesign
    ...
    @enforce_parameter_types
    def module_preferred(self: "Self", value: "_1462.Modules") -> None:
    ...
    @enforce_parameter_types
    def pressure_angle_preferred(
        self: "Self", value: "_1463.PressureAngleTypes"
    ) -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
