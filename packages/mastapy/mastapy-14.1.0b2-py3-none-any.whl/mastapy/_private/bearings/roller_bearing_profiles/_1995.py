...
class ProfileSet(_0.APIBase):
    ...
    @property
    def active_profile_type(self: "Self") -> "_1958.RollerBearingProfileTypes":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.bearings._1958", "RollerBearingProfileTypes"
        )(value)

    @active_profile_type.setter
    @enforce_parameter_types
    def active_profile_type(
        self: "Self", value: "_1958.RollerBearingProfileTypes"
    ) -> None:
    ...
    @property
    def active_profile(self: "Self") -> "_2003.RollerBearingProfile":
