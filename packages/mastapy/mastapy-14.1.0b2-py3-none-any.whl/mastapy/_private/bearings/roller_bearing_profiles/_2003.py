...
class _Cast_RollerBearingProfile:
    ...
    def roller_bearing_conical_profile(
        self: "CastSelf",
    ) -> "_1997.RollerBearingConicalProfile":
        from mastapy._private.bearings.roller_bearing_profiles import _1997

        return self.__parent__._cast(_1997.RollerBearingConicalProfile)

    @property
    def roller_bearing_crowned_profile(
        self: "CastSelf",
    ) -> "_1998.RollerBearingCrownedProfile":
        from mastapy._private.bearings.roller_bearing_profiles import _1998

        return self.__parent__._cast(_1998.RollerBearingCrownedProfile)

    @property
    def roller_bearing_din_lundberg_profile(
        self: "CastSelf",
    ) -> "_1999.RollerBearingDinLundbergProfile":
        from mastapy._private.bearings.roller_bearing_profiles import _1999

        return self.__parent__._cast(_1999.RollerBearingDinLundbergProfile)

    @property
    def roller_bearing_flat_profile(
        self: "CastSelf",
    ) -> "_2000.RollerBearingFlatProfile":
        from mastapy._private.bearings.roller_bearing_profiles import _2000

        return self.__parent__._cast(_2000.RollerBearingFlatProfile)

    @property
    def roller_bearing_johns_gohar_profile(
        self: "CastSelf",
    ) -> "_2001.RollerBearingJohnsGoharProfile":
        from mastapy._private.bearings.roller_bearing_profiles import _2001

        return self.__parent__._cast(_2001.RollerBearingJohnsGoharProfile)

    @property
    def roller_bearing_lundberg_profile(
        self: "CastSelf",
    ) -> "_2002.RollerBearingLundbergProfile":
        from mastapy._private.bearings.roller_bearing_profiles import _2002

        return self.__parent__._cast(_2002.RollerBearingLundbergProfile)

    @property
    def roller_bearing_tangential_crowned_profile(
        self: "CastSelf",
    ) -> "_2004.RollerBearingTangentialCrownedProfile":
        from mastapy._private.bearings.roller_bearing_profiles import _2004

        return self.__parent__._cast(_2004.RollerBearingTangentialCrownedProfile)

    @property
    def roller_bearing_user_specified_profile(
        self: "CastSelf",
    ) -> "_2005.RollerBearingUserSpecifiedProfile":
        from mastapy._private.bearings.roller_bearing_profiles import _2005

        return self.__parent__._cast(_2005.RollerBearingUserSpecifiedProfile)
