...
from mastapy._private.bearings.roller_bearing_profiles import _2003
...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.roller_bearing_profiles import _1994, _1996, _2007
...
class _Cast_RollerBearingUserSpecifiedProfile:
    ...
    @property
    def roller_bearing_profile(self: "CastSelf") -> "_2003.RollerBearingProfile":
        return self.__parent__._cast(_2003.RollerBearingProfile)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class RollerBearingUserSpecifiedProfile(_2003.RollerBearingProfile):
    """RollerBearingUserSpecifiedProfile
    ...
    @property
    def data_to_use(self: "Self") -> "_1994.ProfileDataToUse":
    ...
    def data_to_use(self: "Self", value: "_1994.ProfileDataToUse") -> None:
    ...
    @property
    def profile_to_fit(self: "Self") -> "_1996.ProfileToFit":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.bearings.roller_bearing_profiles._1996", "ProfileToFit"
        )(value)

    @profile_to_fit.setter
    @enforce_parameter_types
    def profile_to_fit(self: "Self", value: "_1996.ProfileToFit") -> None:
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def points(self: "Self") -> "List[_2007.UserSpecifiedProfilePoint]":
