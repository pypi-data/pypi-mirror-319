...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf", bound="UserSpecifiedProfilePoint._Cast_UserSpecifiedProfilePoint"
    )
...
class _Cast_UserSpecifiedProfilePoint:
    ...
    __parent__: "UserSpecifiedProfilePoint"

    @property
    def user_specified_profile_point(self: "CastSelf") -> "UserSpecifiedProfilePoint":
...
class UserSpecifiedProfilePoint(_0.APIBase):
    ...
    TYPE: ClassVar["Type"] = _USER_SPECIFIED_PROFILE_POINT
    ...
    def deviation(self: "Self", value: "float") -> None:
        pythonnet_property_set(
    ...
    @position.setter
    @enforce_parameter_types
    def position(self: "Self", value: "float") -> None:
        pythonnet_property_set(
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_UserSpecifiedProfilePoint":
        """Cast to another type.

        Returns:
            _Cast_UserSpecifiedProfilePoint
        """
        return _Cast_UserSpecifiedProfilePoint(self)
