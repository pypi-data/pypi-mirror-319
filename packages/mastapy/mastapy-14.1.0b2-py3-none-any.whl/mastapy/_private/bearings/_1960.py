...
from mastapy._private.bearings import _1961
...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings import _1936, _1952, _1963
...
class RollingBearingDatabase(
    _1897.SQLDatabase[_1961.RollingBearingKey, _2233.RollingBearing]
):
    """RollingBearingDatabase
    ...
    def add_to_database(self: "Self", bearing: "_2233.RollingBearing") -> None:
    ...
    @enforce_parameter_types
    def create_bearing(
        self: "Self", type_: "_1963.RollingBearingType", designation: "str" = "None"
    ) -> "_2233.RollingBearing":
    ...
    @enforce_parameter_types
    def remove_from_database(self: "Self", bearing: "_2233.RollingBearing") -> None:
        """Method does not return.
    ...
    def search_for_rolling_bearing_with_catalog(
        self: "Self", catalog: "_1936.BearingCatalog"
    ) -> "List[_2233.RollingBearing]":
    ...
    def search_for_rolling_bearing_with_name_and_catalog(
        self: "Self", designation: "str", catalog: "_1936.BearingCatalog"
    ) -> "_2233.RollingBearing":
        """mastapy.bearings.bearing_designs.rolling.RollingBearing
    ...
    def search_for_rolling_bearing_with_name_catalog_and_type(
        self: "Self",
        designation: "str",
        catalog: "_1936.BearingCatalog",
        type_: "_1963.RollingBearingType",
    ) -> "List[_2233.RollingBearing]":
        """List[mastapy.bearings.bearing_designs.rolling.RollingBearing]
    ...
    def search_for_rolling_bearing(
        ...
        catalog: "_1936.BearingCatalog",
        type_: "_1963.RollingBearingType",
        bore_range: "_1548.Range",
        outer_diameter_range: "_1548.Range",
        width_range: "_1548.Range",
        dynamic_capacity_range: "_1548.Range",
        number_of_rows: "int",
        material_type: "_1952.HybridSteelAll",
    ) -> "List[_2233.RollingBearing]":
        """List[mastapy.bearings.bearing_designs.rolling.RollingBearing]
