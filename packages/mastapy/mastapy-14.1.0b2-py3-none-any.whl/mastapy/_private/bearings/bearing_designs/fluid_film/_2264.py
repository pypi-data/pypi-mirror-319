...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings import _1967
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class TiltingPadThrustBearing(_2256.PadFluidFilmBearing):
    """TiltingPadThrustBearing
    ...
    @property
    def tilting_pad_type(self: "Self") -> "_1967.TiltingPadTypes":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.bearings._1967", "TiltingPadTypes"
        )(value)

    @tilting_pad_type.setter
    @enforce_parameter_types
    def tilting_pad_type(self: "Self", value: "_1967.TiltingPadTypes") -> None:
