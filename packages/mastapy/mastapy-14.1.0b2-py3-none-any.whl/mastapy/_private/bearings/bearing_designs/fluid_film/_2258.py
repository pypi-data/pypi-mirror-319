...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_designs.fluid_film import _2259, _2261
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class PlainGreaseFilledJournalBearing(_2260.PlainJournalBearing):
    """PlainGreaseFilledJournalBearing
    ...
    def housing_type(
        self: "Self",
    ) -> "_2259.PlainGreaseFilledJournalBearingHousingType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.bearings.bearing_designs.fluid_film._2259",
    ...
    def housing_type(
        self: "Self", value: "_2259.PlainGreaseFilledJournalBearingHousingType"
    ) -> None:
    ...
    @property
    def housing_detail(self: "Self") -> "_2261.PlainJournalHousing":
