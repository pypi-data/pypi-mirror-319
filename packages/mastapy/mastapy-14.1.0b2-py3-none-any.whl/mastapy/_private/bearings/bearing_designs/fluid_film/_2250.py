...
class _Cast_AxialFeedJournalBearing:
    ...
    def axial_groove_journal_bearing(
        self: "CastSelf",
    ) -> "_2251.AxialGrooveJournalBearing":
        from mastapy._private.bearings.bearing_designs.fluid_film import _2251

        return self.__parent__._cast(_2251.AxialGrooveJournalBearing)

    @property
    def axial_hole_journal_bearing(self: "CastSelf") -> "_2252.AxialHoleJournalBearing":
        from mastapy._private.bearings.bearing_designs.fluid_film import _2252

        return self.__parent__._cast(_2252.AxialHoleJournalBearing)
