...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_designs.fluid_film import _2254, _2255, _2257
...
class _Cast_PlainJournalHousing:
    ...
    def cylindrical_housing_journal_bearing(
        self: "CastSelf",
    ) -> "_2254.CylindricalHousingJournalBearing":
        from mastapy._private.bearings.bearing_designs.fluid_film import _2254

        return self.__parent__._cast(_2254.CylindricalHousingJournalBearing)

    @property
    def machinery_encased_journal_bearing(
        self: "CastSelf",
    ) -> "_2255.MachineryEncasedJournalBearing":
        from mastapy._private.bearings.bearing_designs.fluid_film import _2255

        return self.__parent__._cast(_2255.MachineryEncasedJournalBearing)

    @property
    def pedestal_journal_bearing(self: "CastSelf") -> "_2257.PedestalJournalBearing":
        from mastapy._private.bearings.bearing_designs.fluid_film import _2257

        return self.__parent__._cast(_2257.PedestalJournalBearing)
...
class PlainJournalHousing(_0.APIBase):
    ...
    @property
    def heat_emitting_area_method(self: "Self") -> "_2011.DefaultOrUserInput":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.bearings.bearing_results._2011", "DefaultOrUserInput"
        )(value)

    @heat_emitting_area_method.setter
    @enforce_parameter_types
    def heat_emitting_area_method(
        self: "Self", value: "_2011.DefaultOrUserInput"
    ) -> None:
