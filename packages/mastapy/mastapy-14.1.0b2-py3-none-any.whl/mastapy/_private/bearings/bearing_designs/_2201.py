...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class LinearBearing(_2198.BearingDesign):
    """LinearBearing
    ...
    @property
    def stiffness_options(self: "Self") -> "_1949.BearingStiffnessMatrixOption":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.bearings._1949", "BearingStiffnessMatrixOption"
        )(value)

    @stiffness_options.setter
    @enforce_parameter_types
    def stiffness_options(
        self: "Self", value: "_1949.BearingStiffnessMatrixOption"
    ) -> None:
