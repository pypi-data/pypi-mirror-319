...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ConceptAxialClearanceBearing(_2267.ConceptClearanceBearing):
    """ConceptAxialClearanceBearing
    ...
    @property
    def node_position(self: "Self") -> "_2265.BearingNodePosition":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.bearings.bearing_designs.concept._2265",
            "BearingNodePosition",
        )(value)

    @node_position.setter
    @enforce_parameter_types
    def node_position(self: "Self", value: "_2265.BearingNodePosition") -> None:
