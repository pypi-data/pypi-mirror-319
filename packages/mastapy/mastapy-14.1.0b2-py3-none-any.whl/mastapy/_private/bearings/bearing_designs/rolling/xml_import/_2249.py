...
from mastapy._private.bearings.bearing_designs.rolling.xml_import import _2245
...
class _Cast_XMLVariableAssignment:
    ...
    def abstract_xml_variable_assignment(
        self: "CastSelf",
    ) -> "_2245.AbstractXmlVariableAssignment":
        return self.__parent__._cast(_2245.AbstractXmlVariableAssignment)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class XMLVariableAssignment(_2245.AbstractXmlVariableAssignment, Generic[T]):
    """XMLVariableAssignment
