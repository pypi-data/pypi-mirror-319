...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_designs.rolling import _2224, _2225
...
class GeometricConstants(_0.APIBase):
    ...
    def geometric_constants_for_rolling_frictional_moments(
        self: "Self",
    ) -> "_2224.GeometricConstantsForRollingFrictionalMoments":
    ...
    def geometric_constants_for_sliding_frictional_moments(
        self: "Self",
    ) -> "_2225.GeometricConstantsForSlidingFrictionalMoments":
