...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_designs.rolling.xml_import import _2249
...
class _Cast_AbstractXmlVariableAssignment:
    ...
    @property
    def xml_variable_assignment(self: "CastSelf") -> "_2249.XMLVariableAssignment":
        from mastapy._private.bearings.bearing_designs.rolling.xml_import import _2249

        return self.__parent__._cast(_2249.XMLVariableAssignment)
