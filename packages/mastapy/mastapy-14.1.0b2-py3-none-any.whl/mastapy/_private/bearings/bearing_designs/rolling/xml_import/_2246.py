...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar("CastSelf", bound="BearingImportFile._Cast_BearingImportFile")
...
class _Cast_BearingImportFile:
    ...
    __parent__: "BearingImportFile"

    @property
    def bearing_import_file(self: "CastSelf") -> "BearingImportFile":
...
class BearingImportFile(_0.APIBase):
    ...
    TYPE: ClassVar["Type"] = _BEARING_IMPORT_FILE
    ...
    def import_bearing(self: "Self") -> None:
        """Method does not return."""
        pythonnet_method_call(self.wrapped, "ImportBearing")

    def view_bearing(self: "Self") -> None:
        """Method does not return."""
        pythonnet_method_call(self.wrapped, "ViewBearing")
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_BearingImportFile":
        """Cast to another type.

        Returns:
            _Cast_BearingImportFile
        """
        return _Cast_BearingImportFile(self)
