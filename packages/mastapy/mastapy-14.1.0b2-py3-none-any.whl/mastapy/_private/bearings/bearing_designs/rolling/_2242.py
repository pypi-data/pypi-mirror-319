...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ThrustBallBearing(_2208.BallBearing):
    """ThrustBallBearing
    ...
    @property
    def outer_ring_mounting(self: "Self") -> "_1956.OuterRingMounting":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.bearings._1956", "OuterRingMounting"
        )(value)

    @outer_ring_mounting.setter
    @enforce_parameter_types
    def outer_ring_mounting(self: "Self", value: "_1956.OuterRingMounting") -> None:
