...
class _Cast_LoadedPlainJournalBearingRow:
    ...
    def loaded_plain_oil_fed_journal_bearing_row(
        self: "CastSelf",
    ) -> "_2193.LoadedPlainOilFedJournalBearingRow":
        from mastapy._private.bearings.bearing_results.fluid_film import _2193

        return self.__parent__._cast(_2193.LoadedPlainOilFedJournalBearingRow)
...
class LoadedPlainJournalBearingRow(_0.APIBase):
    ...
    @property
    def row(self: "Self") -> "_1945.BearingRow":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.bearings._1945", "BearingRow"
        )(value)
