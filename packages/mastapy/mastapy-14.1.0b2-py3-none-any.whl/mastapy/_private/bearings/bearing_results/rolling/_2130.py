...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_results.rolling import _2128, _2129
...
class _Cast_MaximumStaticContactStressResultsAbstract:
    ...
    def maximum_static_contact_stress(
        ...
        from mastapy._private.bearings.bearing_results.rolling import _2128

        return self.__parent__._cast(_2128.MaximumStaticContactStress)

    @property
    def maximum_static_contact_stress_duty_cycle(
        self: "CastSelf",
    ) -> "_2129.MaximumStaticContactStressDutyCycle":
        from mastapy._private.bearings.bearing_results.rolling import _2129

        return self.__parent__._cast(_2129.MaximumStaticContactStressDutyCycle)
