...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings import _1942, _1951
    from mastapy._private.bearings.bearing_results import _2017, _2025
    ...
    from mastapy._private.bearings.bearing_results.rolling.skf_module import _2166
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class LoadedRollingBearingResults(_2022.LoadedDetailedBearingResults):
    """LoadedRollingBearingResults
    ...
    def fluid_film_temperature_source(
        self: "Self",
    ) -> "_1951.FluidFilmTemperatureOptions":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.bearings._1951", "FluidFilmTemperatureOptions"
        )(value)
    ...
    @property
    def ansiabma(self: "Self") -> "_2185.ANSIABMAResults":
    ...
    @property
    def din7322010(self: "Self") -> "_2037.DIN7322010Results":
    ...
    @property
    def iso2812007(self: "Self") -> "_2171.ISO2812007Results":
    ...
    @property
    def iso762006(self: "Self") -> "_2172.ISO762006Results":
    ...
    @property
    def isotr1417912001(self: "Self") -> "_2046.ISOTR1417912001Results":
    ...
    @property
    def isotr1417922001(self: "Self") -> "_2048.ISOTR1417922001Results":
    ...
    @property
    def isots162812008(self: "Self") -> "_2174.ISOTS162812008Results":
    ...
    def inner_ring_fitting_at_assembly(
        self: "Self",
    ) -> "_2178.InnerRingFittingThermalResults":
    ...
    def maximum_static_contact_stress(
        self: "Self",
    ) -> "_2128.MaximumStaticContactStress":
    ...
    def outer_ring_fitting_at_assembly(
        self: "Self",
    ) -> "_2180.OuterRingFittingThermalResults":
    ...
    @property
    def skf_module_results(self: "Self") -> "_2166.SKFModuleResults":
    ...
    @property
    def all_mounting_results(self: "Self") -> "List[_2181.RingFittingThermalResults]":
    ...
    @property
    def rows(self: "Self") -> "List[_2102.LoadedRollingBearingRow]":
