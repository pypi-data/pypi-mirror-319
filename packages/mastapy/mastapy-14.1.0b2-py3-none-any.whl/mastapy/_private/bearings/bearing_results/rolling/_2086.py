...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_results.rolling import _2084, _2085, _2102
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class LoadedFourPointContactBallBearingRow(_2071.LoadedBallBearingRow):
    """LoadedFourPointContactBallBearingRow
    ...
    def race_results(
        self: "Self",
    ) -> "List[_2084.LoadedFourPointContactBallBearingRaceResults]":
