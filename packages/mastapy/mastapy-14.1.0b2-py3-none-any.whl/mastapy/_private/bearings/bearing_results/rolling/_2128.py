...
class _Cast_MaximumStaticContactStress:
    ...
    def maximum_static_contact_stress_results_abstract(
        self: "CastSelf",
    ) -> "_2130.MaximumStaticContactStressResultsAbstract":
        return self.__parent__._cast(_2130.MaximumStaticContactStressResultsAbstract)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class MaximumStaticContactStress(_2130.MaximumStaticContactStressResultsAbstract):
    """MaximumStaticContactStress
