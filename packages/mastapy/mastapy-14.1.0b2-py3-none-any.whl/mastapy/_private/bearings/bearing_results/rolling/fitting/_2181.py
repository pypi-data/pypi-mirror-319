...
class _Cast_RingFittingThermalResults:
    ...
    def inner_ring_fitting_thermal_results(
        ...
        from mastapy._private.bearings.bearing_results.rolling.fitting import _2178

        return self.__parent__._cast(_2178.InnerRingFittingThermalResults)

    @property
    def outer_ring_fitting_thermal_results(
        self: "CastSelf",
    ) -> "_2180.OuterRingFittingThermalResults":
        from mastapy._private.bearings.bearing_results.rolling.fitting import _2180

        return self.__parent__._cast(_2180.OuterRingFittingThermalResults)
...
class RingFittingThermalResults(_0.APIBase):
    ...
    @property
    def interference_values(self: "Self") -> "List[_2179.InterferenceComponents]":
