...
class _Cast_ISOTR1417912001Results:
    ...
    @property
    def isotr141792001_results(self: "CastSelf") -> "_2047.ISOTR141792001Results":
        return self.__parent__._cast(_2047.ISOTR141792001Results)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ISOTR1417912001Results(_2047.ISOTR141792001Results):
    """ISOTR1417912001Results
