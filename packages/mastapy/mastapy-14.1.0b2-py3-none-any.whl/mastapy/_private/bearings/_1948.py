...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings import _1950, _1957
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class BearingSettingsItem(_1895.NamedDatabaseItem):
    """BearingSettingsItem
    ...
    @property
    def failure_probability_for_rating_life_percent(self: "Self") -> "_1957.RatingLife":
    ...
    def include_exponent_and_reduction_factors_in_isots162812008(
        self: "Self",
    ) -> "_1950.ExponentAndReductionFactorsInISO16281Calculation":
    ...
    @enforce_parameter_types
    def include_exponent_and_reduction_factors_in_isots162812008(
        self: "Self", value: "_1950.ExponentAndReductionFactorsInISO16281Calculation"
    ) -> None:
    ...
    @enforce_parameter_types
    def lubricant_film_temperature_calculation_pressure_fed_grease_filled_bearings(
        self: "Self", value: "_1951.FluidFilmTemperatureOptions"
    ) -> None:
