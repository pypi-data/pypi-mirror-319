...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="ISO2812007BallBearingDynamicEquivalentLoadCalculator._Cast_ISO2812007BallBearingDynamicEquivalentLoadCalculator",
    )
...
class _Cast_ISO2812007BallBearingDynamicEquivalentLoadCalculator:
    ...
    __parent__: "ISO2812007BallBearingDynamicEquivalentLoadCalculator"
...
class ISO2812007BallBearingDynamicEquivalentLoadCalculator(_0.APIBase):
    ...
    TYPE: ClassVar["Type"] = _ISO2812007_BALL_BEARING_DYNAMIC_EQUIVALENT_LOAD_CALCULATOR
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_ISO2812007BallBearingDynamicEquivalentLoadCalculator":
        """Cast to another type.

        Returns:
            _Cast_ISO2812007BallBearingDynamicEquivalentLoadCalculator
        """
        return _Cast_ISO2812007BallBearingDynamicEquivalentLoadCalculator(self)
