...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.tolerances import _1968, _1973, _1979, _1985
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class RingTolerance(_1976.InterferenceTolerance):
    """RingTolerance
    ...
    @property
    def roundness_specification(self: "Self") -> "_1985.RoundnessSpecification":
