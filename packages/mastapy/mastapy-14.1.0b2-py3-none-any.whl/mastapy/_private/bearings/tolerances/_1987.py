...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.tolerances import _1968, _1982, _1988
...
class _Cast_SupportDetail:
    ...
    def bearing_connection_component(
        self: "CastSelf",
    ) -> "_1968.BearingConnectionComponent":
        from mastapy._private.bearings.tolerances import _1968

        return self.__parent__._cast(_1968.BearingConnectionComponent)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class SupportDetail(_1975.InterferenceDetail):
    """SupportDetail
    ...
    @property
    def material_source(self: "Self") -> "_1988.SupportMaterialSource":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.bearings.tolerances._1988", "SupportMaterialSource"
        )(value)
    ...
    @property
    def radial_specification_method(self: "Self") -> "_1982.RadialSpecificationMethod":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.bearings.tolerances._1982", "RadialSpecificationMethod"
        )(value)

    @radial_specification_method.setter
    @enforce_parameter_types
    def radial_specification_method(
        self: "Self", value: "_1982.RadialSpecificationMethod"
    ) -> None:
