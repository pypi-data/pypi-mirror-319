...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class InterferenceTolerance(_1968.BearingConnectionComponent):
    """InterferenceTolerance
    ...
    @property
    def definition_option(self: "Self") -> "_1971.BearingToleranceDefinitionOptions":
    ...
    def mounting_point_surface_finish(
        self: "Self",
    ) -> "_1955.MountingPointSurfaceFinishes":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.bearings._1955", "MountingPointSurfaceFinishes"
        )(value)

    @mounting_point_surface_finish.setter
    @enforce_parameter_types
    def mounting_point_surface_finish(
        self: "Self", value: "_1955.MountingPointSurfaceFinishes"
    ) -> None:
        value = conversion.mp_to_pn_enum(
