...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.tolerances import _1981, _1986, _1992
...
class _Cast_RoundnessSpecification:
    ...
    def independent_reportable_properties_base(
        self: "CastSelf",
    ) -> "_1646.IndependentReportablePropertiesBase":
        pass

        return self.__parent__._cast(_1646.IndependentReportablePropertiesBase)
...
class RoundnessSpecification(
    _1646.IndependentReportablePropertiesBase["RoundnessSpecification"]
):
    """RoundnessSpecification
    ...
    @property
    def specification_type(self: "Self") -> "_1986.RoundnessSpecificationType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.bearings.tolerances._1986", "RoundnessSpecificationType"
        )(value)

    @specification_type.setter
    @enforce_parameter_types
    def specification_type(
        self: "Self", value: "_1986.RoundnessSpecificationType"
    ) -> None:
    ...
    @property
    def type_of_fit(self: "Self") -> "_1992.TypeOfFit":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.bearings.tolerances._1992", "TypeOfFit"
        )(value)

    @type_of_fit.setter
    @enforce_parameter_types
    def type_of_fit(self: "Self", value: "_1992.TypeOfFit") -> None:
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def user_specified_deviation(self: "Self") -> "_1594.Vector2DListAccessor":
    ...
    @property
    def roundness_distribution(self: "Self") -> "List[_1981.RaceRoundnessAtAngle]":
