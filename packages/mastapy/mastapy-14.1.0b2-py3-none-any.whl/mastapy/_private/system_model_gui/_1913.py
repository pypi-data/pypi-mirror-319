...
if TYPE_CHECKING:
    ...
    from mastapy._private.math_utility import _1552, _1570
    ...
    from mastapy._private.utility.operation_modes import _1852
...
class MASTAGUI(_0.APIBase):
    ...
    @property
    def active_design(self: "Self") -> "_2269.Design":
    ...
    @enforce_parameter_types
    def active_design(self: "Self", value: "_2269.Design") -> None:
    ...
    @enforce_parameter_types
    def gear_tip_radius_clash_test_request(
        self: "Self", value: "_164.GearTipRadiusClashTest"
    ) -> None:
        pythonnet_property_set(
    ...
    @property
    def open_designs(self: "Self") -> "List[_2269.Design]":
    ...
    @property
    def operation_mode(self: "Self") -> "_1852.OperationMode":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.utility.operation_modes._1852", "OperationMode"
        )(value)

    @operation_mode.setter
    @enforce_parameter_types
    def operation_mode(self: "Self", value: "_1852.OperationMode") -> None:
    ...
    @property
    def selected_design_entity(self: "Self") -> "_2272.DesignEntity":
    ...
    @enforce_parameter_types
    def selected_design_entity(self: "Self", value: "_2272.DesignEntity") -> None:
    ...
    def add_electric_machine_from_cad_face_group(
        self: "Self",
        cad_face_group: "_329.CADFaceGroup",
        geometry_modeller_design_information: "_167.GeometryModellerDesignInformation",
        dimensions: "Dict[str, _168.GeometryModellerDimension]",
    ) -> None:
        """Method does not return.
    ...
    def add_fe_substructure_from_data(
        self: "Self",
        vertices_and_facets: "_1570.FacetedBody",
        geometry_modeller_design_information: "_167.GeometryModellerDesignInformation",
        dimensions: "Dict[str, _168.GeometryModellerDimension]",
        body_moniker: "str",
    ) -> None:
    ...
    def add_line_from_geometry_modeller(
        self: "Self", circles_on_axis: "_1552.CirclesOnAxis"
    ) -> None:
        """Method does not return.
    ...
    def are_new_input_available(self: "Self") -> "_175.MeshRequest":
    ...
    def circle_pairs_from_geometry_modeller(
        self: "Self",
        preselection_circles: "_1552.CirclesOnAxis",
        selected_circles: "List[_1552.CirclesOnAxis]",
    ) -> None:
        """Method does not return.
    ...
    def create_geometry_modeller_dimension(
        self: "Self",
    ) -> "_168.GeometryModellerDimension":
    ...
    def create_mesh_request_result(self: "Self") -> "_176.MeshRequestResult":
    ...
    def create_new_cad_face_group(self: "Self") -> "_329.CADFaceGroup":
    ...
    def create_new_circles_on_axis(self: "Self") -> "_1552.CirclesOnAxis":
    ...
    def create_new_faceted_body(self: "Self") -> "_1570.FacetedBody":
    ...
    @enforce_parameter_types
    def open_design_in_new_tab(self: "Self", design: "_2269.Design") -> None:
        """Method does not return.
    ...
    def set_gear_tip_diameter_clash_test_result(
        self: "Self", result: "_164.GearTipRadiusClashTest"
    ) -> None:
        """Method does not return.
    ...
    def set_mesh_request_result(
        self: "Self", mesh_request_result: "_176.MeshRequestResult"
    ) -> None:
        """Method does not return.
