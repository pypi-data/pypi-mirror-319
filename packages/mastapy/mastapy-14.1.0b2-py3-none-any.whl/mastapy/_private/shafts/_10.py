...
_DESIGN_SHAFT_SECTION_END = python_net_import(
...
if TYPE_CHECKING:
    ...
    Self = TypeVar("Self", bound="DesignShaftSectionEnd")
    CastSelf = TypeVar(
        "CastSelf", bound="DesignShaftSectionEnd._Cast_DesignShaftSectionEnd"
    )
...
class _Cast_DesignShaftSectionEnd:
    """Special nested class for casting DesignShaftSectionEnd to subclasses."""

    __parent__: "DesignShaftSectionEnd"

    @property
    def design_shaft_section_end(self: "CastSelf") -> "DesignShaftSectionEnd":
...
class DesignShaftSectionEnd(_0.APIBase):
    ...
    TYPE: ClassVar["Type"] = _DESIGN_SHAFT_SECTION_END
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_DesignShaftSectionEnd":
        """Cast to another type.

        Returns:
            _Cast_DesignShaftSectionEnd
        """
        return _Cast_DesignShaftSectionEnd(self)
