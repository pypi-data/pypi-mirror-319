...
from mastapy._private.nodal_analysis.geometry_modeller_link import _177
...
class _Cast_ShaftProfileFromImport:
    ...
    @property
    def profile_from_import(self: "CastSelf") -> "_177.ProfileFromImport":
        return self.__parent__._cast(_177.ProfileFromImport)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ShaftProfileFromImport(_177.ProfileFromImport):
    """ShaftProfileFromImport
