...
if TYPE_CHECKING:
    ...
    from mastapy._private.electric_machines.harmonic_load_data import _1444, _1445
...
class _Cast_StatorToothInterpolator:
    ...
    def stator_tooth_load_interpolator(
        ...
        from mastapy._private.electric_machines.harmonic_load_data import _1444

        return self.__parent__._cast(_1444.StatorToothLoadInterpolator)

    @property
    def stator_tooth_moment_interpolator(
        self: "CastSelf",
    ) -> "_1445.StatorToothMomentInterpolator":
        from mastapy._private.electric_machines.harmonic_load_data import _1445

        return self.__parent__._cast(_1445.StatorToothMomentInterpolator)
