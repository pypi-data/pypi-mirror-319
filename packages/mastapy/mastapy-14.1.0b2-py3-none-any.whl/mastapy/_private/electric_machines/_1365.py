...
from mastapy._private.electric_machines import _1316, _1364
...
class _Cast_TwoDimensionalFEModelForElectromagneticAnalysis:
    ...
    def two_dimensional_fe_model_for_analysis(
        self: "CastSelf",
    ) -> "_1364.TwoDimensionalFEModelForAnalysis":
        return self.__parent__._cast(_1364.TwoDimensionalFEModelForAnalysis)
...
class TwoDimensionalFEModelForElectromagneticAnalysis(
    _1364.TwoDimensionalFEModelForAnalysis[_1316.ElectricMachineMeshingOptions]
):
    """TwoDimensionalFEModelForElectromagneticAnalysis
