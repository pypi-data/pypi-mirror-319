...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="ElectricMachineEfficiencyMapSettings._Cast_ElectricMachineEfficiencyMapSettings",
    )
...
class _Cast_ElectricMachineEfficiencyMapSettings:
    ...
    __parent__: "ElectricMachineEfficiencyMapSettings"
...
class ElectricMachineEfficiencyMapSettings(_0.APIBase):
    ...
    TYPE: ClassVar["Type"] = _ELECTRIC_MACHINE_EFFICIENCY_MAP_SETTINGS
    ...
    def minimum_torque(self: "Self") -> "float":
        """float"""
        temp = pythonnet_property_get(self.wrapped, "MinimumTorque")
    ...
    @enforce_parameter_types
    def minimum_torque(self: "Self", value: "float") -> None:
        pythonnet_property_set(
    ...
    def number_of_torque_values(self: "Self") -> "int":
        """int"""
        temp = pythonnet_property_get(self.wrapped, "NumberOfTorqueValues")
    ...
    @enforce_parameter_types
    def number_of_torque_values(self: "Self", value: "int") -> None:
        pythonnet_property_set(
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_ElectricMachineEfficiencyMapSettings":
        """Cast to another type.

        Returns:
            _Cast_ElectricMachineEfficiencyMapSettings
        """
        return _Cast_ElectricMachineEfficiencyMapSettings(self)
