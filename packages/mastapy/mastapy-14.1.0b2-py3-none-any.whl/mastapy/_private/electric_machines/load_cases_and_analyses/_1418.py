...
class ElectricMachineLoadCaseGroup(_0.APIBase):
    ...
    @property
    def dynamic_forces_load_cases(self: "Self") -> "List[_1406.DynamicForceLoadCase]":
    ...
    def dynamic_forces_load_cases_without_non_linear_dq_model(
        self: "Self",
    ) -> "List[_1404.BasicDynamicForceLoadCase]":
    ...
    @property
    def efficiency_map_load_cases(self: "Self") -> "List[_1409.EfficiencyMapLoadCase]":
    ...
    def mechanical_load_cases(
        self: "Self",
    ) -> "List[_1419.ElectricMachineMechanicalLoadCase]":
    ...
    def single_operating_point_load_cases_with_non_linear_dq_model(
        self: "Self",
    ) -> "List[_1434.SpeedTorqueLoadCase]":
    ...
    def single_operating_point_load_cases_without_non_linear_dq_model(
        self: "Self",
    ) -> "List[_1416.ElectricMachineLoadCase]":
    ...
    def speed_torque_curve_load_cases(
        self: "Self",
    ) -> "List[_1433.SpeedTorqueCurveLoadCase]":
    ...
    @enforce_parameter_types
    def add_load_case(
        self: "Self", load_case_type: "_1422.LoadCaseType"
    ...
    def add_load_case_named(
        self: "Self", load_case_type: "_1422.LoadCaseType", name: "str"
    ) -> "_1417.ElectricMachineLoadCaseBase":
        """mastapy.electric_machines.load_cases_and_analyses.ElectricMachineLoadCaseBase
    ...
    def perform_compound_analysis(
        self: "Self",
        setup: "_1318.ElectricMachineSetup",
        load_case_type: "_1422.LoadCaseType",
    ) -> "_1650.MethodOutcome":
    ...
    def perform_compound_analysis_with_progress(
        ...
        setup: "_1318.ElectricMachineSetup",
        load_case_type: "_1422.LoadCaseType",
        task_progress: "_7723.TaskProgress",
    ) -> "_1650.MethodOutcome":
        """mastapy.utility.MethodOutcome
    ...
    def try_remove_load_case(
        self: "Self", load_case: "_1417.ElectricMachineLoadCaseBase"
    ) -> "bool":
        """bool
