...
if TYPE_CHECKING:
    ...
    from mastapy._private.electric_machines.results import _1382
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ElectricMachineFEMechanicalAnalysis(_1410.ElectricMachineAnalysis):
    """ElectricMachineFEMechanicalAnalysis
    ...
    def electric_machine_mechanical_results(
        self: "Self",
    ) -> "_1382.ElectricMachineMechanicalResults":
    ...
    @property
    def load_case(self: "Self") -> "_1419.ElectricMachineMechanicalLoadCase":
