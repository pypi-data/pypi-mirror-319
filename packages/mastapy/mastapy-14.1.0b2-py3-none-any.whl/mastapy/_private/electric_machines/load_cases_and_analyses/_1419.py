...
if TYPE_CHECKING:
    ...
    from mastapy._private.nodal_analysis.elmer import _191
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ElectricMachineMechanicalLoadCase(_1417.ElectricMachineLoadCaseBase):
    """ElectricMachineMechanicalLoadCase
    ...
    @property
    def solver_type(self: "Self") -> "_191.MechanicalSolverType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.nodal_analysis.elmer._191", "MechanicalSolverType"
        )(value)

    @solver_type.setter
    @enforce_parameter_types
    def solver_type(self: "Self", value: "_191.MechanicalSolverType") -> None:
