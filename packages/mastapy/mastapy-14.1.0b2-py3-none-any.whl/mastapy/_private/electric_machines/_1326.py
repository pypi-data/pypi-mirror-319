...
class _Cast_HairpinConductor:
    ...
    @property
    def winding_conductor(self: "CastSelf") -> "_1369.WindingConductor":
        return self.__parent__._cast(_1369.WindingConductor)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class HairpinConductor(_1369.WindingConductor):
    """HairpinConductor
