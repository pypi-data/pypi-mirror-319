...
if TYPE_CHECKING:
    ...
    from mastapy._private.electric_machines import _1312, _1319, _1341
    from mastapy._private.electric_machines.load_cases_and_analyses import _1418
...
class ElectricMachineGroup(_0.APIBase):
    ...
    @property
    def electric_machine_details(self: "Self") -> "List[_1312.ElectricMachineDetail]":
    ...
    def electric_machine_load_case_groups(
        self: "Self",
    ) -> "List[_1418.ElectricMachineLoadCaseGroup]":
    ...
    def add_electric_machine_detail(
        self: "Self", type_: "_1319.ElectricMachineType", name: "str" = "Motor"
    ...
    ) -> "_1418.ElectricMachineLoadCaseGroup":
    ...
    def duplicate_electric_machine_detail(
        self: "Self", detail: "_1312.ElectricMachineDetail"
    ) -> "_1312.ElectricMachineDetail":
    ...
    def remove_electric_machine_detail(
        self: "Self", motor: "_1312.ElectricMachineDetail"
    ) -> "bool":
        """bool
    ...
    def try_remove_load_case_group(
        self: "Self", load_case_group: "_1418.ElectricMachineLoadCaseGroup"
    ) -> "bool":
        """bool
