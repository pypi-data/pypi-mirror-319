...
class CADMagnetDetails(_0.APIBase):
    ...
    @property
    def magnetisation_direction(self: "Self") -> "_1337.MagnetisationDirection":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.electric_machines._1337", "MagnetisationDirection"
        )(value)

    @magnetisation_direction.setter
    @enforce_parameter_types
    def magnetisation_direction(
        self: "Self", value: "_1337.MagnetisationDirection"
    ) -> None:
