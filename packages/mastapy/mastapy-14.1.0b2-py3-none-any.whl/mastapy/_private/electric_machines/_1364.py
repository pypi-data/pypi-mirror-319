...
if TYPE_CHECKING:
    ...
    from mastapy._private.electric_machines import _1317, _1365, _1366
...
T = TypeVar("T", bound="_1317.ElectricMachineMeshingOptionsBase")
...
class _Cast_TwoDimensionalFEModelForAnalysis:
    ...
    def two_dimensional_fe_model_for_mechanical_analysis(
        ...
        from mastapy._private.electric_machines import _1366

        return self.__parent__._cast(_1366.TwoDimensionalFEModelForMechanicalAnalysis)
