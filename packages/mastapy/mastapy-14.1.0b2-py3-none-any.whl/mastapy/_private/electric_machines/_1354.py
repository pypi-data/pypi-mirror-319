...
if TYPE_CHECKING:
    ...
    from mastapy._private.electric_machines import _1355, _1361
...
class _Cast_Stator:
    ...
    @property
    def abstract_stator(self: "CastSelf") -> "_1292.AbstractStator":
        return self.__parent__._cast(_1292.AbstractStator)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class Stator(_1292.AbstractStator):
    """Stator
    ...
    def stator_cutout_specifications(
        self: "Self",
    ) -> "List[_1355.StatorCutoutSpecification]":
    ...
    @property
    def tooth_and_slot(self: "Self") -> "_1361.ToothAndSlot":
