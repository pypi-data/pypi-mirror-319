...
if TYPE_CHECKING:
    ...
    from mastapy._private.electric_machines.results import _1390, _1391, _1392, _1394
...
class ElectricMachineResultsTimeStep(_0.APIBase):
    ...
    @property
    def flux_density_in_air_gap_chart(self: "Self") -> "_1934.TwoDChartDefinition":
    ...
    @property
    def force_density_in_air_gap_mst_chart(self: "Self") -> "_1934.TwoDChartDefinition":
        """mastapy.utility_gui.charts.TwoDChartDefinition
    ...
    def results_for_stator_teeth(
        self: "Self",
    ) -> "List[_1391.ElectricMachineResultsForStatorToothAtTimeStep]":
    ...
    def results_at_locations(
        self: "Self",
    ) -> "List[_1394.ElectricMachineResultsTimeStepAtLocation]":
    ...
    def results_for_line_to_line(
        self: "Self",
    ) -> "List[_1392.ElectricMachineResultsLineToLineAtTimeStep]":
    ...
    def results_for_phases(
        self: "Self",
    ) -> "List[_1390.ElectricMachineResultsForPhaseAtTimeStep]":
