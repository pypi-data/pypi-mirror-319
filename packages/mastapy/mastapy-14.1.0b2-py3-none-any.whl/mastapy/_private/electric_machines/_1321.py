...
if TYPE_CHECKING:
    ...
    from mastapy._private.electric_machines import _1296, _1320
...
class _Cast_FieldWindingSpecificationBase:
    ...
    def cad_field_winding_specification(
        self: "CastSelf",
    ) -> "_1296.CADFieldWindingSpecification":
        from mastapy._private.electric_machines import _1296

        return self.__parent__._cast(_1296.CADFieldWindingSpecification)

    @property
    def field_winding_specification(
        self: "CastSelf",
    ) -> "_1320.FieldWindingSpecification":
        from mastapy._private.electric_machines import _1320

        return self.__parent__._cast(_1320.FieldWindingSpecification)
