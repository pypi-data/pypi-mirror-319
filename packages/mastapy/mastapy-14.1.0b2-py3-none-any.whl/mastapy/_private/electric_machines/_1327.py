...
from mastapy._private.electric_machines.harmonic_load_data import _1439
...
class _Cast_HarmonicLoadDataControlExcitationOptionForElectricMachineMode:
    ...
    def harmonic_load_data_control_excitation_option_base(
        self: "CastSelf",
    ) -> "_1439.HarmonicLoadDataControlExcitationOptionBase":
        return self.__parent__._cast(_1439.HarmonicLoadDataControlExcitationOptionBase)
