...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.rating.cylindrical import _478, _486, _495, _500, _501
    from mastapy._private.gears.rating.cylindrical.din3990 import _552
    from mastapy._private.gears.rating.cylindrical.iso6336 import _531, _533, _535, _538
...
class ISO6336AbstractMetalMeshSingleFlankRating(
    ...
    def sorted_micro_pitting_results(
        self: "Self",
    ) -> "_478.CylindricalGearMicroPittingResults":
    ...
    def isodin_cylindrical_gear_single_flank_ratings(
        self: "Self",
    ) -> "List[_538.ISO6336AbstractMetalGearSingleFlankRating]":
