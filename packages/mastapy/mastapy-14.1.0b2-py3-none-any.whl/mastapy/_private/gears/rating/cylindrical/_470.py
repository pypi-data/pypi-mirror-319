...
from mastapy._private.gears.rating.cylindrical import _503
...
class _Cast_AGMAScuffingResultsRow:
    ...
    @property
    def scuffing_results_row(self: "CastSelf") -> "_503.ScuffingResultsRow":
        return self.__parent__._cast(_503.ScuffingResultsRow)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class AGMAScuffingResultsRow(_503.ScuffingResultsRow):
    """AGMAScuffingResultsRow
