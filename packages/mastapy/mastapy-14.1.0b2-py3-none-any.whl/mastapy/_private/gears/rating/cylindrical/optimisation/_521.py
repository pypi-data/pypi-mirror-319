...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.rating.cylindrical.optimisation import _522, _523
...
T = TypeVar("T", bound="_523.SafetyFactorOptimisationStepResult")
...
class OptimisationResultsPair(_0.APIBase, Generic[T]):
    ...
    @property
    def results(self: "Self") -> "_522.SafetyFactorOptimisationResults[T]":
    ...
    def results_without_warnings(
        self: "Self",
    ) -> "_522.SafetyFactorOptimisationResults[T]":
        """mastapy.gears.rating.cylindrical.optimisation.SafetyFactorOptimisationResults[T]
