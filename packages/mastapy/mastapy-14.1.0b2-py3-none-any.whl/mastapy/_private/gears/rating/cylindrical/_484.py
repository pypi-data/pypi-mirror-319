...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CylindricalGearSingleFlankRating(_383.GearSingleFlankRating):
    """CylindricalGearSingleFlankRating
    ...
    def geometry_data_source_for_rating(
        self: "Self",
    ) -> "_480.CylindricalGearRatingGeometryDataSource":
    ...
    @property
    def is_gear_driving_or_driven(self: "Self") -> "_375.FlankLoadingState":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears.rating._375", "FlankLoadingState"
        )(value)
    ...
    @property
    def metal_plastic(self: "Self") -> "_294.MetalPlasticType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.materials._294", "MetalPlasticType"
        )(value)
