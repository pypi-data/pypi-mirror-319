...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.rating.cylindrical.iso6336 import _549
...
class _Cast_ToothFlankFractureAnalysisContactPointN1457:
    ...
    def tooth_flank_fracture_analysis_row_n1457(
        ...
        return self.__parent__._cast(_549.ToothFlankFractureAnalysisRowN1457)
...
class ToothFlankFractureAnalysisContactPointN1457(_0.APIBase):
    ...
    @property
    def position_on_profile(self: "Self") -> "_1063.CylindricalGearProfileMeasurement":
