...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.rating.cylindrical import _479, _482, _494
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CylindricalGearDutyCycleRating(_376.GearDutyCycleRating):
    """CylindricalGearDutyCycleRating
    ...
    def cylindrical_gear_mesh_ratings(
        self: "Self",
    ) -> "List[_494.MeshRatingForReports]":
