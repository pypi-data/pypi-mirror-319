...
from mastapy._private.gears.rating.cylindrical.optimisation import _523
...
class _Cast_SafetyFactorOptimisationStepResultNumber:
    ...
    def safety_factor_optimisation_step_result(
        self: "CastSelf",
    ) -> "_523.SafetyFactorOptimisationStepResult":
        return self.__parent__._cast(_523.SafetyFactorOptimisationStepResult)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class SafetyFactorOptimisationStepResultNumber(_523.SafetyFactorOptimisationStepResult):
    """SafetyFactorOptimisationStepResultNumber
