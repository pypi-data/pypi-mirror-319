...
from mastapy._private.gears.rating.cylindrical.iso6336 import _546
...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.rating.cylindrical.iso6336 import _548
...
class _Cast_ToothFlankFractureAnalysisRowN1457:
    ...
    def tooth_flank_fracture_analysis_contact_point_n1457(
        ...
        return self.__parent__._cast(_546.ToothFlankFractureAnalysisContactPointN1457)
...
class ToothFlankFractureAnalysisRowN1457(
    ...
    def analysis_point_with_maximum_fatigue_damage(
        self: "Self",
    ) -> "_548.ToothFlankFractureAnalysisPointN1457":
    ...
    @property
    def watch_points(self: "Self") -> "List[_548.ToothFlankFractureAnalysisPointN1457]":
