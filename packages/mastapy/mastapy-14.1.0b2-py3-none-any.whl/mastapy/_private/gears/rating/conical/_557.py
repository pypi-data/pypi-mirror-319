...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.rating.conical import _559, _560
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ConicalGearDutyCycleRating(_376.GearDutyCycleRating):
    """ConicalGearDutyCycleRating
    ...
    @property
    def gear_ratings(self: "Self") -> "List[_559.ConicalGearRating]":
    ...
    @property
    def conical_gear_ratings(self: "Self") -> "List[_559.ConicalGearRating]":
        """List[mastapy.gears.rating.conical.ConicalGearRating]
