...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.rating.virtual_cylindrical_gears import _403, _404, _408
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class KlingelnbergVirtualCylindricalGear(_407.VirtualCylindricalGear):
    """KlingelnbergVirtualCylindricalGear
