...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.gear_designs.cylindrical import _1068
...
class _Cast_GearSetOptimiser:
    ...
    def cylindrical_gear_set_macro_geometry_optimiser(
        ...
        return self.__parent__._cast(_1068.CylindricalGearSetMacroGeometryOptimiser)
...
class GearSetOptimiser(_0.APIBase):
    ...
    ) -> "_349.GearSetOptimisationResults":
