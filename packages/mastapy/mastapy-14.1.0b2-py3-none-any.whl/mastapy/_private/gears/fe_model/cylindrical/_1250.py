...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CylindricalGearMeshFEModel(_1246.GearMeshFEModel):
    """CylindricalGearMeshFEModel
    ...
    def stiffness_wrt_contacts_for(
        self: "Self", gear: "_1245.GearFEModel", flank: "_344.GearFlanks"
    ) -> "List[_866.GearContactStiffness]":
    ...
    def generate_stiffness_wrt_contacts_for_flank(
        self: "Self", flank: "_344.GearFlanks", progress: "_7723.TaskProgress"
    ) -> None:
        """Method does not return.
