...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class FaceGearSetDesign(_982.GearSetDesign):
    """FaceGearSetDesign
    ...
    @property
    def face_gear(self: "Self") -> "_1029.FaceGearWheelDesign":
    ...
    @property
    def pinion(self: "Self") -> "_1026.FaceGearPinionDesign":
    ...
    @property
    def gears(self: "Self") -> "List[_1021.FaceGearDesign]":
    ...
    @property
    def face_gears(self: "Self") -> "List[_1021.FaceGearDesign]":
        """List[mastapy.gears.gear_designs.face.FaceGearDesign]
    ...
    @property
    def face_meshes(self: "Self") -> "List[_1023.FaceGearMeshDesign]":
