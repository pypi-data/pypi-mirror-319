...
from mastapy._private.gears.gear_designs.conical import _1201
...
class _Cast_DummyConicalGearCutter:
    ...
    @property
    def conical_gear_cutter(self: "CastSelf") -> "_1201.ConicalGearCutter":
        return self.__parent__._cast(_1201.ConicalGearCutter)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class DummyConicalGearCutter(_1201.ConicalGearCutter):
    """DummyConicalGearCutter
