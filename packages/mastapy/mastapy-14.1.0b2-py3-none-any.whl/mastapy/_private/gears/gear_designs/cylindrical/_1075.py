...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.gear_designs.cylindrical import _1107, _1124
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CylindricalMeshAngularBacklash(_1078.CylindricalMeshLinearBacklashSpecification):
    """CylindricalMeshAngularBacklash
