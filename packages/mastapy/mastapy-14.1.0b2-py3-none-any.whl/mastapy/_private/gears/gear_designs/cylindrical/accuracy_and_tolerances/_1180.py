...
class _Cast_AGMA20151AccuracyGrades:
    ...
    @property
    def accuracy_grades(self: "CastSelf") -> "_332.AccuracyGrades":
        from mastapy._private.gears import _332

        return self.__parent__._cast(_332.AccuracyGrades)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class AGMA20151AccuracyGrades(_1185.CylindricalAccuracyGrades):
    """AGMA20151AccuracyGrades
