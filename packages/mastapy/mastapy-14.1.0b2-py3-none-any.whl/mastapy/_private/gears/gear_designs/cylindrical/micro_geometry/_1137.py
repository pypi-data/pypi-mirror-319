...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CylindricalGearLeadModification(_591.LeadModification):
    """CylindricalGearLeadModification
    ...
    @property
    def lead_modification_chart(self: "Self") -> "_1934.TwoDChartDefinition":
    ...
    def lead_modification_for_customer_102cad(
        self: "Self",
    ) -> "_1156.LeadModificationForCustomer102CAD":
