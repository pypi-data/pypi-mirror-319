...
class FinishStockSpecification(
    _1108.RelativeValuesSpecification["FinishStockSpecification"]
):
    """FinishStockSpecification
    ...
    def finish_stock_rough_thickness_specification_method(
        self: "Self", value: "_1131.FinishStockType"
    ) -> None:
    ...
    def normal(
        self: "Self",
    ) -> "_1124.TolerancedValueSpecification[FinishStockSpecification]":
