...
class _Cast_CylindricalGearPinionTypeCutterFlank:
    ...
    def cylindrical_gear_abstract_rack_flank(
        self: "CastSelf",
    ) -> "_1045.CylindricalGearAbstractRackFlank":
        return self.__parent__._cast(_1045.CylindricalGearAbstractRackFlank)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CylindricalGearPinionTypeCutterFlank(_1045.CylindricalGearAbstractRackFlank):
    """CylindricalGearPinionTypeCutterFlank
    ...
    @property
    def cutter(self: "Self") -> "_1061.CylindricalGearPinionTypeCutter":
