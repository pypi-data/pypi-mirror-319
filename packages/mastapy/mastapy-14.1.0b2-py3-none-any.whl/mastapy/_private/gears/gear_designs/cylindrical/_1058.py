...
class CylindricalGearMicroGeometrySettings(
    _1646.IndependentReportablePropertiesBase["CylindricalGearMicroGeometrySettings"]
):
    """CylindricalGearMicroGeometrySettings
    ...
    @property
    def flank_side_with_zero_face_width(self: "Self") -> "_590.FlankSide":
    ...
    def flank_side_with_zero_face_width(self: "Self", value: "_590.FlankSide") -> None:
