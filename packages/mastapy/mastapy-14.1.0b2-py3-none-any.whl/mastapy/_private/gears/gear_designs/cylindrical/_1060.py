...
from mastapy._private.gears.micro_geometry import _592, _593, _594, _595
...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.micro_geometry import _590, _596, _597, _599, _600
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CylindricalGearMicroGeometrySettingsItem(_1895.NamedDatabaseItem):
    """CylindricalGearMicroGeometrySettingsItem
    ...
    @property
    def default_flank_side_with_zero_face_width(self: "Self") -> "_590.FlankSide":
    ...
    @enforce_parameter_types
    def default_location_of_evaluation_lower_limit(
        self: "Self", value: "_592.LocationOfEvaluationLowerLimit"
    ) -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
    ...
    @enforce_parameter_types
    def default_location_of_evaluation_upper_limit(
        self: "Self", value: "_593.LocationOfEvaluationUpperLimit"
    ) -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
    ...
    @enforce_parameter_types
    def default_location_of_root_relief_evaluation(
        self: "Self", value: "_594.LocationOfRootReliefEvaluation"
    ) -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
    ...
    @enforce_parameter_types
    def default_location_of_tip_relief_evaluation(
        self: "Self", value: "_595.LocationOfTipReliefEvaluation"
    ) -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
    ...
    def default_micro_geometry_lead_tolerance_chart_view(
        self: "Self",
    ) -> "_1165.MicroGeometryLeadToleranceChartView":
    ...
    @enforce_parameter_types
    def default_micro_geometry_lead_tolerance_chart_view(
        self: "Self", value: "_1165.MicroGeometryLeadToleranceChartView"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.Gears.GearDesigns.Cylindrical.MicroGeometry.MicroGeometryLeadToleranceChartView",
    ...
    @enforce_parameter_types
    def default_scale_and_range_of_flank_relief_axes_for_micro_geometry_tolerance_charts(
        self: "Self", value: "_1083.DoubleAxisScaleAndRange"
    ) -> None:
        value = conversion.mp_to_pn_enum(
    ...
    def ltca_root_stress_surface_chart_option(
        self: "Self",
    ) -> "_1110.RootStressSurfaceChartOption":
    ...
    @enforce_parameter_types
    def ltca_root_stress_surface_chart_option(
        self: "Self", value: "_1110.RootStressSurfaceChartOption"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.Gears.GearDesigns.Cylindrical.RootStressSurfaceChartOption",
    ...
    def main_profile_modification_ends_at_the_start_of_root_relief_by_default(
        self: "Self",
    ) -> "_596.MainProfileReliefEndsAtTheStartOfRootReliefOption":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears.micro_geometry._596",
    ...
    @enforce_parameter_types
    def main_profile_modification_ends_at_the_start_of_root_relief_by_default(
        self: "Self", value: "_596.MainProfileReliefEndsAtTheStartOfRootReliefOption"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.Gears.MicroGeometry.MainProfileReliefEndsAtTheStartOfRootReliefOption",
    ...
    def main_profile_modification_ends_at_the_start_of_tip_relief_by_default(
        self: "Self",
    ) -> "_597.MainProfileReliefEndsAtTheStartOfTipReliefOption":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears.micro_geometry._597",
    ...
    @enforce_parameter_types
    def main_profile_modification_ends_at_the_start_of_tip_relief_by_default(
        self: "Self", value: "_597.MainProfileReliefEndsAtTheStartOfTipReliefOption"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.Gears.MicroGeometry.MainProfileReliefEndsAtTheStartOfTipReliefOption",
    ...
    @enforce_parameter_types
    def micro_geometry_lead_relief_definition(
        self: "Self", value: "_1099.MicroGeometryConvention"
    ) -> None:
        value = conversion.mp_to_pn_enum(
    ...
    def micro_geometry_profile_relief_definition(
        self: "Self",
    ) -> "_1100.MicroGeometryProfileConvention":
    ...
    @enforce_parameter_types
    def micro_geometry_profile_relief_definition(
        self: "Self", value: "_1100.MicroGeometryProfileConvention"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.Gears.GearDesigns.Cylindrical.MicroGeometryProfileConvention",
    ...
    def parabolic_root_relief_starts_tangent_to_main_profile_relief_by_default(
        self: "Self",
    ) -> "_599.ParabolicRootReliefStartsTangentToMainProfileRelief":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears.micro_geometry._599",
    ...
    @enforce_parameter_types
    def parabolic_root_relief_starts_tangent_to_main_profile_relief_by_default(
        self: "Self", value: "_599.ParabolicRootReliefStartsTangentToMainProfileRelief"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.Gears.MicroGeometry.ParabolicRootReliefStartsTangentToMainProfileRelief",
    ...
    def parabolic_tip_relief_starts_tangent_to_main_profile_relief_by_default(
        self: "Self",
    ) -> "_600.ParabolicTipReliefStartsTangentToMainProfileRelief":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears.micro_geometry._600",
    ...
    @enforce_parameter_types
    def parabolic_tip_relief_starts_tangent_to_main_profile_relief_by_default(
        self: "Self", value: "_600.ParabolicTipReliefStartsTangentToMainProfileRelief"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.Gears.MicroGeometry.ParabolicTipReliefStartsTangentToMainProfileRelief",
