...
class _Cast_RelativeValuesSpecification:
    ...
    @property
    def backlash_specification(self: "CastSelf") -> "_1031.BacklashSpecification":
        from mastapy._private.gears.gear_designs.cylindrical import _1031

        return self.__parent__._cast(_1031.BacklashSpecification)

    @property
    def finish_stock_specification(
        self: "CastSelf",
    ) -> "_1130.FinishStockSpecification":
        from mastapy._private.gears.gear_designs.cylindrical.thickness_stock_and_backlash import (
            _1130,
        )

        return self.__parent__._cast(_1130.FinishStockSpecification)
