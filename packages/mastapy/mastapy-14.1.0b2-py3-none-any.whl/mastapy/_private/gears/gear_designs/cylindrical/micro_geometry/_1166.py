...
class MicroGeometryViewingOptions(_0.APIBase):
    ...
    def contact_results(self: "Self", value: "_858.ContactResultType") -> None:
    ...
    @property
    def gear_option(self: "Self") -> "_1153.DrawDefiningGearOrBoth":
    ...
    @gear_option.setter
    @enforce_parameter_types
    def gear_option(self: "Self", value: "_1153.DrawDefiningGearOrBoth") -> None:
    ...
    @enforce_parameter_types
    def root_stress_results_type(self: "Self", value: "_93.StressResultsType") -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
    ...
    def show_gear(
        self: "Self",
    ) -> "list_with_selected_item_and_image.ListWithSelectedItemAndImage_DrawDefiningGearOrBoth":
        """ListWithSelectedItemAndImage[mastapy.gears.gear_designs.cylindrical.micro_geometry.DrawDefiningGearOrBoth]"""
        temp = pythonnet_property_get(self.wrapped, "ShowGear")

        if temp is None:
            return None

        value = list_with_selected_item_and_image.ListWithSelectedItemAndImage_DrawDefiningGearOrBoth.wrapped_type()
        return overridable_enum_runtime.create(temp, value)

    @show_gear.setter
    @enforce_parameter_types
    def show_gear(self: "Self", value: "_1153.DrawDefiningGearOrBoth") -> None:
        wrapper_type = list_with_selected_item_and_image.ListWithSelectedItemAndImage_DrawDefiningGearOrBoth.wrapper_type()
        enclosed_type = list_with_selected_item_and_image.ListWithSelectedItemAndImage_DrawDefiningGearOrBoth.implicit_type()
