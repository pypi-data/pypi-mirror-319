...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.gear_designs.cylindrical import _1090, _1091
...
class CaseHardeningProperties(_0.APIBase):
    ...
    def hardness_profile_calculation_method(
        self: "Self",
    ) -> "_1090.HardnessProfileCalculationMethod":
    ...
    @enforce_parameter_types
    def hardness_profile_calculation_method(
        self: "Self", value: "_1090.HardnessProfileCalculationMethod"
    ) -> None:
    ...
    @property
    def heat_treatment_type(self: "Self") -> "_1091.HeatTreatmentType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears.gear_designs.cylindrical._1091", "HeatTreatmentType"
        )(value)
