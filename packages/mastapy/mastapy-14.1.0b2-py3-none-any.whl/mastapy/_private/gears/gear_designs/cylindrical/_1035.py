...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.gear_designs.cylindrical import _1036, _1037
...
class _Cast_CrossedAxisCylindricalGearPair:
    ...
    def crossed_axis_cylindrical_gear_pair_line_contact(
        ...
        return self.__parent__._cast(_1036.CrossedAxisCylindricalGearPairLineContact)

    @property
    def crossed_axis_cylindrical_gear_pair_point_contact(
        self: "CastSelf",
    ) -> "_1037.CrossedAxisCylindricalGearPairPointContact":
        from mastapy._private.gears.gear_designs.cylindrical import _1037

        return self.__parent__._cast(_1037.CrossedAxisCylindricalGearPairPointContact)
...
class CrossedAxisCylindricalGearPair(_0.APIBase):
    ...
    @property
    def shaver(self: "Self") -> "_763.CylindricalCutterSimulatableGear":
