...
from mastapy._private.gears.gear_designs.cylindrical import _1035
...
class _Cast_CrossedAxisCylindricalGearPairPointContact:
    ...
    def crossed_axis_cylindrical_gear_pair(
        self: "CastSelf",
    ) -> "_1035.CrossedAxisCylindricalGearPair":
        return self.__parent__._cast(_1035.CrossedAxisCylindricalGearPair)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CrossedAxisCylindricalGearPairPointContact(_1035.CrossedAxisCylindricalGearPair):
    """CrossedAxisCylindricalGearPairPointContact
