...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears import _369
    from mastapy._private.gears.gear_designs import _980
    from mastapy._private.gears.gear_designs.worm import _989, _990
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class WormGearSetDesign(_982.GearSetDesign):
    """WormGearSetDesign
    ...
    @property
    def gears(self: "Self") -> "List[_989.WormGearDesign]":
    ...
    @property
    def worm_gears(self: "Self") -> "List[_989.WormGearDesign]":
        """List[mastapy.gears.gear_designs.worm.WormGearDesign]
    ...
    @property
    def worm_meshes(self: "Self") -> "List[_990.WormGearMeshDesign]":
