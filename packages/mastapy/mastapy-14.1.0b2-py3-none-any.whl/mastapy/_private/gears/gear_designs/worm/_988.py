...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears import _368
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class WormDesign(_989.WormGearDesign):
    """WormDesign
    ...
    @property
    def addendum_factor(self: "Self") -> "_368.WormAddendumFactor":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears._368", "WormAddendumFactor"
        )(value)

    @addendum_factor.setter
    @enforce_parameter_types
    def addendum_factor(self: "Self", value: "_368.WormAddendumFactor") -> None:
