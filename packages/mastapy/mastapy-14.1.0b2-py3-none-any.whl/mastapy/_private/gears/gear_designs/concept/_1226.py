...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.gear_designs.concept import _1224, _1225
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ConceptGearSetDesign(_982.GearSetDesign):
    """ConceptGearSetDesign
    ...
    @property
    def gears(self: "Self") -> "List[_1224.ConceptGearDesign]":
    ...
    @property
    def concept_gears(self: "Self") -> "List[_1224.ConceptGearDesign]":
        """List[mastapy.gears.gear_designs.concept.ConceptGearDesign]
    ...
    @property
    def concept_meshes(self: "Self") -> "List[_1225.ConceptGearMeshDesign]":
