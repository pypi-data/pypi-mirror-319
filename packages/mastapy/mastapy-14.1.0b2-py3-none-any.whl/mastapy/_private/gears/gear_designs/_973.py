...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class BevelHypoidGearDesignSettingsItem(_1895.NamedDatabaseItem):
    """BevelHypoidGearDesignSettingsItem
    ...
    @property
    def quality_grade_type(self: "Self") -> "_362.QualityGradeTypes":
    ...
    @enforce_parameter_types
    def quality_grade_type(self: "Self", value: "_362.QualityGradeTypes") -> None:
