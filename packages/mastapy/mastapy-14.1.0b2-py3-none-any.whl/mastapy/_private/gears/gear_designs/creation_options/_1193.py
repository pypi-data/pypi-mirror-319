...
from mastapy._private.gears.gear_designs.creation_options import _1195
...
class _Cast_CylindricalGearPairCreationOptions:
    ...
    @property
    def gear_set_creation_options(self: "CastSelf") -> "_1195.GearSetCreationOptions":
        return self.__parent__._cast(_1195.GearSetCreationOptions)
...
class CylindricalGearPairCreationOptions(
    _1195.GearSetCreationOptions[_1066.CylindricalGearSetDesign]
):
    """CylindricalGearPairCreationOptions
