...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.cylindrical import _1257
...
class _Cast_GearLTCAContactCharts:
    ...
    def cylindrical_gear_ltca_contact_charts(
        self: "CastSelf",
    ) -> "_1257.CylindricalGearLTCAContactCharts":
        from mastapy._private.gears.cylindrical import _1257

        return self.__parent__._cast(_1257.CylindricalGearLTCAContactCharts)
