...
class PointsWithWorstResults(_0.APIBase):
    ...
    def coefficient_of_friction(
        self: "Self",
    ) -> "_890.CylindricalGearMeshLoadedContactPoint":
    ...
    @property
    def max_pressure(self: "Self") -> "_890.CylindricalGearMeshLoadedContactPoint":
        """mastapy.gears.ltca.cylindrical.CylindricalGearMeshLoadedContactPoint
    ...
    @property
    def max_shear_stress(self: "Self") -> "_890.CylindricalGearMeshLoadedContactPoint":
        """mastapy.gears.ltca.cylindrical.CylindricalGearMeshLoadedContactPoint
    ...
    @property
    def sliding_velocity(self: "Self") -> "_890.CylindricalGearMeshLoadedContactPoint":
        """mastapy.gears.ltca.cylindrical.CylindricalGearMeshLoadedContactPoint
