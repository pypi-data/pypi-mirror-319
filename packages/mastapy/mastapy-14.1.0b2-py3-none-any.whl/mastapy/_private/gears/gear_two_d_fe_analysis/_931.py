...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.gear_two_d_fe_analysis import _932
...
class CylindricalGearTwoDimensionalFEAnalysis(_0.APIBase):
    ...
    def findley_critical_plane_analysis(
        self: "Self",
    ) -> "_932.FindleyCriticalPlaneAnalysis":
    ...
    def get_stress_states(self: "Self", index: "int") -> "_128.NodeVectorState":
