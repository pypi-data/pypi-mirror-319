...
class _Cast_BarForPareto:
    ...
    def pareto_optimisation_strategy_bars(
        self: "CastSelf",
    ) -> "_1609.ParetoOptimisationStrategyBars":
        return self.__parent__._cast(_1609.ParetoOptimisationStrategyBars)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class BarForPareto(
    _1609.ParetoOptimisationStrategyBars, Generic[TAnalysis, TCandidate]
):
    """BarForPareto
