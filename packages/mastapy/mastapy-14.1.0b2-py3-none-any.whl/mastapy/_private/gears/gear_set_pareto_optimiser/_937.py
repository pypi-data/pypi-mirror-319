...
from mastapy._private.gears.gear_set_pareto_optimiser import _934
...
if TYPE_CHECKING:
    ...
    from mastapy._private.math_utility.optimisation import _1600, _1605, _1608
...
class _Cast_DesignSpaceSearchBase:
    ...
    @property
    def gear_set_pareto_optimiser(self: "CastSelf") -> "_943.GearSetParetoOptimiser":
        from mastapy._private.gears.gear_set_pareto_optimiser import _943

        return self.__parent__._cast(_943.GearSetParetoOptimiser)
    ...
    def micro_geometry_design_space_search(
        self: "CastSelf",
    ) -> "_947.MicroGeometryDesignSpaceSearch":
        from mastapy._private.gears.gear_set_pareto_optimiser import _947

        return self.__parent__._cast(_947.MicroGeometryDesignSpaceSearch)
...
class DesignSpaceSearchBase(_0.APIBase, Generic[TAnalysis, TCandidate]):
    ...
    @enforce_parameter_types
    def display_candidates(self: "Self", value: "_934.CandidateDisplayChoice") -> None:
    ...
    @property
    def remove_candidates_with(self: "Self") -> "_946.LargerOrSmaller":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears.gear_set_pareto_optimiser._946", "LargerOrSmaller"
        )(value)

    @remove_candidates_with.setter
    @enforce_parameter_types
    def remove_candidates_with(self: "Self", value: "_946.LargerOrSmaller") -> None:
    ...
    def chart_details(
        self: "Self",
    ) -> "List[_935.ChartInfoBase[TAnalysis, TCandidate]]":
    ...
    @property
    def filters(self: "Self") -> "List[_1605.ParetoOptimisationFilter]":
    ...
    @property
    def input_setters(self: "Self") -> "List[_1600.InputSetter[TAnalysis]]":
    ...
    def optimisation_targets(
        self: "Self",
    ) -> "List[_954.OptimisationTarget[TAnalysis]]":
    ...
    def reasons_for_invalid_candidates(
        self: "Self",
    ) -> "List[_969.ReasonsForInvalidDesigns]":
