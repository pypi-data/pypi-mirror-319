...
from mastapy._private.gears.gear_set_pareto_optimiser import _935, _942
...
class _Cast_ParetoOptimiserChartInformation:
    ...
    @property
    def chart_info_base(self: "CastSelf") -> "_935.ChartInfoBase":
        return self.__parent__._cast(_935.ChartInfoBase)
...
class ParetoOptimiserChartInformation(
    _935.ChartInfoBase[_373.AbstractGearSetRating, _942.GearSetOptimiserCandidate]
):
    """ParetoOptimiserChartInformation
