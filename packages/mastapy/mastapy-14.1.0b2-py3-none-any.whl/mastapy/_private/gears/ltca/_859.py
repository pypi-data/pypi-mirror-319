...
class _Cast_CylindricalGearFilletNodeStressResults:
    ...
    def gear_fillet_node_stress_results(
        self: "CastSelf",
    ) -> "_868.GearFilletNodeStressResults":
        return self.__parent__._cast(_868.GearFilletNodeStressResults)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CylindricalGearFilletNodeStressResults(_868.GearFilletNodeStressResults):
    """CylindricalGearFilletNodeStressResults
