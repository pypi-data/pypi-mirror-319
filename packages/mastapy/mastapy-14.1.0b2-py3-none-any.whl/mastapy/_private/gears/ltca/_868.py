...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.ltca import _856, _859
...
class _Cast_GearFilletNodeStressResults:
    ...
    def conical_gear_fillet_stress_results(
        self: "CastSelf",
    ) -> "_856.ConicalGearFilletStressResults":
        from mastapy._private.gears.ltca import _856

        return self.__parent__._cast(_856.ConicalGearFilletStressResults)

    @property
    def cylindrical_gear_fillet_node_stress_results(
        self: "CastSelf",
    ) -> "_859.CylindricalGearFilletNodeStressResults":
        from mastapy._private.gears.ltca import _859

        return self.__parent__._cast(_859.CylindricalGearFilletNodeStressResults)
