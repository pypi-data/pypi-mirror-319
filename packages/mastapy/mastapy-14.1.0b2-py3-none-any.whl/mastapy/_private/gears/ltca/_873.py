...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.ltca import _874, _880
    from mastapy._private.gears.ltca.conical import _902
...
class _Cast_GearMeshLoadDistributionAtRotation:
    ...
    def cylindrical_mesh_load_distribution_at_rotation(
        self: "CastSelf",
    ) -> "_892.CylindricalMeshLoadDistributionAtRotation":
        from mastapy._private.gears.ltca.cylindrical import _892

        return self.__parent__._cast(_892.CylindricalMeshLoadDistributionAtRotation)

    @property
    def conical_mesh_load_distribution_at_rotation(
        self: "CastSelf",
    ) -> "_902.ConicalMeshLoadDistributionAtRotation":
        from mastapy._private.gears.ltca.conical import _902

        return self.__parent__._cast(_902.ConicalMeshLoadDistributionAtRotation)
...
class GearMeshLoadDistributionAtRotation(_0.APIBase):
    ...
    def gear_a_in_mesh(
        self: "Self",
    ) -> "_880.MeshedGearLoadDistributionAnalysisAtRotation":
    ...
    @property
    def loaded_contact_lines(self: "Self") -> "List[_874.GearMeshLoadedContactLine]":
    ...
    def meshed_gears(
        self: "Self",
    ) -> "List[_880.MeshedGearLoadDistributionAnalysisAtRotation]":
