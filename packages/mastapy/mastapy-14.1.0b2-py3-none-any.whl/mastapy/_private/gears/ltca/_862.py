...
class _Cast_CylindricalGearRootFilletStressResults:
    ...
    def gear_root_fillet_stress_results(
        self: "CastSelf",
    ) -> "_876.GearRootFilletStressResults":
        return self.__parent__._cast(_876.GearRootFilletStressResults)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CylindricalGearRootFilletStressResults(_876.GearRootFilletStressResults):
    """CylindricalGearRootFilletStressResults
