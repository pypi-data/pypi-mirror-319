...
class _Cast_CylindricalGearMeshLoadedContactPoint:
    ...
    def gear_mesh_loaded_contact_point(
        self: "CastSelf",
    ) -> "_875.GearMeshLoadedContactPoint":
        return self.__parent__._cast(_875.GearMeshLoadedContactPoint)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CylindricalGearMeshLoadedContactPoint(_875.GearMeshLoadedContactPoint):
    """CylindricalGearMeshLoadedContactPoint
