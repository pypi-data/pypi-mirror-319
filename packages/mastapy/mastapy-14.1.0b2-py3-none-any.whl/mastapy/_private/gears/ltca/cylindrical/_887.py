...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.analysis import _1263, _1266, _1267
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CylindricalGearLoadDistributionAnalysis(_871.GearLoadDistributionAnalysis):
    """CylindricalGearLoadDistributionAnalysis
    ...
    @property
    def rating(self: "Self") -> "_479.CylindricalGearRating":
    ...
    @property
    def tiff_analysis(self: "Self") -> "_929.CylindricalGearTIFFAnalysis":
