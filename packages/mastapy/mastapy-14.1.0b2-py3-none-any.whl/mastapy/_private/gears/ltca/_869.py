...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.ltca import _860, _868
...
class _Cast_GearFilletNodeStressResultsColumn:
    ...
    def cylindrical_gear_fillet_node_stress_results_column(
        self: "CastSelf",
    ) -> "_860.CylindricalGearFilletNodeStressResultsColumn":
        from mastapy._private.gears.ltca import _860

        return self.__parent__._cast(_860.CylindricalGearFilletNodeStressResultsColumn)
...
class GearFilletNodeStressResultsColumn(_0.APIBase):
    ...
    @property
    def node_results(self: "Self") -> "List[_868.GearFilletNodeStressResults]":
