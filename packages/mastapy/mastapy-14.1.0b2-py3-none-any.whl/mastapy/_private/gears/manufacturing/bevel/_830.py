...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.manufacturing.bevel import _829, _843
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ManufacturingMachine(_1895.NamedDatabaseItem):
    """ManufacturingMachine
    ...
    @property
    def machine_type(self: "Self") -> "_829.MachineTypes":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears.manufacturing.bevel._829", "MachineTypes"
        )(value)

    @machine_type.setter
    @enforce_parameter_types
    def machine_type(self: "Self", value: "_829.MachineTypes") -> None:
    ...
    @property
    def wheel_formate_machine_type(self: "Self") -> "_843.WheelFormatMachineTypes":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears.manufacturing.bevel._843", "WheelFormatMachineTypes"
        )(value)

    @wheel_formate_machine_type.setter
    @enforce_parameter_types
    def wheel_formate_machine_type(
        self: "Self", value: "_843.WheelFormatMachineTypes"
    ) -> None:
        value = conversion.mp_to_pn_enum(
