...
from mastapy._private.gears.manufacturing.bevel.basic_machine_settings import _852
...
class _Cast_BasicConicalGearMachineSettingsGenerated:
    ...
    def basic_conical_gear_machine_settings(
        ...
        return self.__parent__._cast(_852.BasicConicalGearMachineSettings)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class BasicConicalGearMachineSettingsGenerated(_852.BasicConicalGearMachineSettings):
    """BasicConicalGearMachineSettingsGenerated
