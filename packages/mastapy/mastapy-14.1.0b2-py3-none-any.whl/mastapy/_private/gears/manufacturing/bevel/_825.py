...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.manufacturing.bevel.cutters import _846, _847
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ConicalWheelManufacturingConfig(_807.ConicalGearManufacturingConfig):
    """ConicalWheelManufacturingConfig
    ...
    def specified_machine_settings(
        self: "Self",
    ) -> "_852.BasicConicalGearMachineSettings":
    ...
    @property
    def wheel_finish_cutter(self: "Self") -> "_846.WheelFinishCutter":
    ...
    @property
    def wheel_rough_cutter(self: "Self") -> "_847.WheelRoughCutter":
