...
class BevelMachineSettingOptimizationResult(_0.APIBase):
    ...
    def calculated_deviations_concave(
        self: "Self",
    ) -> "_805.ConicalFlankDeviationsData":
    ...
    @property
    def calculated_deviations_convex(self: "Self") -> "_805.ConicalFlankDeviationsData":
        """mastapy.gears.manufacturing.bevel.ConicalFlankDeviationsData
    ...
    @property
    def imported_deviations_concave(self: "Self") -> "_805.ConicalFlankDeviationsData":
        """mastapy.gears.manufacturing.bevel.ConicalFlankDeviationsData
    ...
    @property
    def imported_deviations_convex(self: "Self") -> "_805.ConicalFlankDeviationsData":
        """mastapy.gears.manufacturing.bevel.ConicalFlankDeviationsData
