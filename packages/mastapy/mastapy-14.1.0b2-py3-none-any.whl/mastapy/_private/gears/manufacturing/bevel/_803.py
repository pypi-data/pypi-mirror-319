...
class _Cast_AbstractTCA:
    ...
    @property
    def ease_off_based_tca(self: "CastSelf") -> "_826.EaseOffBasedTCA":
        from mastapy._private.gears.manufacturing.bevel import _826

        return self.__parent__._cast(_826.EaseOffBasedTCA)
...
class AbstractTCA(_0.APIBase):
    ...
    @property
    def conical_mesh_misalignments(self: "Self") -> "_1208.ConicalMeshMisalignments":
