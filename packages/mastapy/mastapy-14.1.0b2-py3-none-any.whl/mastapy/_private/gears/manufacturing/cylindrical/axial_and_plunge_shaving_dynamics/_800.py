...
class ShavingDynamicsConfiguration(_0.APIBase):
    ...
    def conventional_shaving_dynamics(
        self: "Self",
    ) -> "_797.ShavingDynamicsCalculation[_782.ConventionalShavingDynamics]":
    ...
    def plunge_shaving_dynamics(
        self: "Self",
    ) -> "_797.ShavingDynamicsCalculation[_786.PlungeShaverDynamics]":
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_786.PlungeShaverDynamics](
            temp
        )
