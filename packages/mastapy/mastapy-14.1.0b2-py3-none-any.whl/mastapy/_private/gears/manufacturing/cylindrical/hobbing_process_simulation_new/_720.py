...
class _Cast_RackManufactureError:
    ...
    @property
    def hob_manufacture_error(self: "CastSelf") -> "_707.HobManufactureError":
        from mastapy._private.gears.manufacturing.cylindrical.hobbing_process_simulation_new import (
            _707,
        )

        return self.__parent__._cast(_707.HobManufactureError)
    ...
    def worm_grinder_manufacture_error(
        ...
        return self.__parent__._cast(_722.WormGrinderManufactureError)
