...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.manufacturing.cylindrical.cutters.tangibles import _756
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class HobSimulationCalculator(_774.RackSimulationCalculator):
    """HobSimulationCalculator
    ...
    @property
    def hob(self: "Self") -> "_756.CylindricalGearHobShape":
