...
class _Cast_ShavingDynamics:
    ...
    def conventional_shaving_dynamics(
        self: "CastSelf",
    ) -> "_782.ConventionalShavingDynamics":
        from mastapy._private.gears.manufacturing.cylindrical.axial_and_plunge_shaving_dynamics import (
            _782,
        )

        return self.__parent__._cast(_782.ConventionalShavingDynamics)

    @property
    def plunge_shaver_dynamics(self: "CastSelf") -> "_786.PlungeShaverDynamics":
        from mastapy._private.gears.manufacturing.cylindrical.axial_and_plunge_shaving_dynamics import (
            _786,
        )

        return self.__parent__._cast(_786.PlungeShaverDynamics)
