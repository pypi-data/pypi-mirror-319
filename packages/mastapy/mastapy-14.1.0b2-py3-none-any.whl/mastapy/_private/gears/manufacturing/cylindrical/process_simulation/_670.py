...
class _Cast_CutterProcessSimulation:
    ...
    def form_wheel_grinding_process_simulation(
        self: "CastSelf",
    ) -> "_671.FormWheelGrindingProcessSimulation":
        from mastapy._private.gears.manufacturing.cylindrical.process_simulation import (
            _671,
        )

        return self.__parent__._cast(_671.FormWheelGrindingProcessSimulation)

    @property
    def shaping_process_simulation(self: "CastSelf") -> "_672.ShapingProcessSimulation":
        from mastapy._private.gears.manufacturing.cylindrical.process_simulation import (
            _672,
        )

        return self.__parent__._cast(_672.ShapingProcessSimulation)
