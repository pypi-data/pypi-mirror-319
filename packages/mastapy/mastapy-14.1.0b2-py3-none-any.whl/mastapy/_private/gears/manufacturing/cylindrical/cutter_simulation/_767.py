...
from mastapy._private.gears.manufacturing.cylindrical.cutter_simulation import _770
...
class _Cast_FinishCutterSimulation:
    ...
    @property
    def gear_cutter_simulation(self: "CastSelf") -> "_770.GearCutterSimulation":
        return self.__parent__._cast(_770.GearCutterSimulation)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class FinishCutterSimulation(_770.GearCutterSimulation):
    """FinishCutterSimulation
