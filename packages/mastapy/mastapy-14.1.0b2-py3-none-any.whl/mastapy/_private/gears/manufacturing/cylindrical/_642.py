...
_CYLINDRICAL_GEAR_BLANK = python_net_import(
...
if TYPE_CHECKING:
    ...
    Self = TypeVar("Self", bound="CylindricalGearBlank")
    CastSelf = TypeVar(
        "CastSelf", bound="CylindricalGearBlank._Cast_CylindricalGearBlank"
    )
...
class _Cast_CylindricalGearBlank:
    """Special nested class for casting CylindricalGearBlank to subclasses."""

    __parent__: "CylindricalGearBlank"

    @property
    def cylindrical_gear_blank(self: "CastSelf") -> "CylindricalGearBlank":
...
class CylindricalGearBlank(_0.APIBase):
    ...
    TYPE: ClassVar["Type"] = _CYLINDRICAL_GEAR_BLANK
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_CylindricalGearBlank":
        """Cast to another type.

        Returns:
            _Cast_CylindricalGearBlank
        """
        return _Cast_CylindricalGearBlank(self)
