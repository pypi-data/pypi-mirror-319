...
class _Cast_ConventionalShavingDynamics:
    ...
    @property
    def shaving_dynamics(self: "CastSelf") -> "_796.ShavingDynamics":
        return self.__parent__._cast(_796.ShavingDynamics)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ConventionalShavingDynamics(_796.ShavingDynamics):
    """ConventionalShavingDynamics
