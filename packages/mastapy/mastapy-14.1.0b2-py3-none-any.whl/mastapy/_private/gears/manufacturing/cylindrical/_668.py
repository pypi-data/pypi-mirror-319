...
from mastapy._private.gears.manufacturing.cylindrical import _667
...
class _Cast_ProfileModificationSegment:
    ...
    @property
    def modification_segment(self: "CastSelf") -> "_667.ModificationSegment":
        return self.__parent__._cast(_667.ModificationSegment)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ProfileModificationSegment(_667.ModificationSegment):
    """ProfileModificationSegment
