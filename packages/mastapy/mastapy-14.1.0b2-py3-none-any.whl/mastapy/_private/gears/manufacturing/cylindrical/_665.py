...
from mastapy._private.gears.manufacturing.cylindrical import _663, _664
...
class _Cast_MicroGeometryInputsLead:
    ...
    @property
    def micro_geometry_inputs(self: "CastSelf") -> "_664.MicroGeometryInputs":
        return self.__parent__._cast(_664.MicroGeometryInputs)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class MicroGeometryInputsLead(_664.MicroGeometryInputs[_663.LeadModificationSegment]):
    """MicroGeometryInputsLead
    ...
    @property
    def lead_micro_geometry_range(self: "Self") -> "_1548.Range":
