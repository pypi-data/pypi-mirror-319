...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class WormGrindingProcessProfileCalculation(_725.WormGrindingProcessCalculation):
    """WormGrindingProcessProfileCalculation
    ...
    @property
    def left_flank(self: "Self") -> "_693.CalculateProfileDeviationAccuracy":
    ...
    @property
    def right_flank(self: "Self") -> "_693.CalculateProfileDeviationAccuracy":
        """mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new.CalculateProfileDeviationAccuracy
