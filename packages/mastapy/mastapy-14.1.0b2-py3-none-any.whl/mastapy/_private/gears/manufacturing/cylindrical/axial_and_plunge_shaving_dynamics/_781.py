...
class _Cast_AxialShaverRedressing:
    ...
    @property
    def shaver_redressing(self: "CastSelf") -> "_795.ShaverRedressing":
        return self.__parent__._cast(_795.ShaverRedressing)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class AxialShaverRedressing(_795.ShaverRedressing[_782.ConventionalShavingDynamics]):
    """AxialShaverRedressing
