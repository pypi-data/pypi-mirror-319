...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.manufacturing.cylindrical import _665, _666
...
class CylindricalGearSpecifiedMicroGeometry(_0.APIBase):
    ...
    @property
    def lead_micro_geometry(self: "Self") -> "_665.MicroGeometryInputsLead":
    ...
    @property
    def profile_micro_geometry(self: "Self") -> "List[_666.MicroGeometryInputsProfile]":
