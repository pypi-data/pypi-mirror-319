...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf", bound="RollAngleReportObject._Cast_RollAngleReportObject"
    )
...
class _Cast_RollAngleReportObject:
    ...
    __parent__: "RollAngleReportObject"

    @property
    def roll_angle_report_object(self: "CastSelf") -> "RollAngleReportObject":
...
class RollAngleReportObject(_0.APIBase):
    ...
    TYPE: ClassVar["Type"] = _ROLL_ANGLE_REPORT_OBJECT
    ...
    def required_roll_angle_range(self: "Self") -> "float":
        ...
        Note:
            This property is readonly.
        """
        temp = pythonnet_property_get(self.wrapped, "RequiredRollAngleRange")
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_RollAngleReportObject":
        """Cast to another type.

        Returns:
            _Cast_RollAngleReportObject
        """
        return _Cast_RollAngleReportObject(self)
