...
class _Cast_RealPlungeShaverOutputs:
    ...
    @property
    def plunge_shaver_outputs(self: "CastSelf") -> "_682.PlungeShaverOutputs":
        return self.__parent__._cast(_682.PlungeShaverOutputs)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class RealPlungeShaverOutputs(_682.PlungeShaverOutputs):
    """RealPlungeShaverOutputs
    ...
    @property
    def lead_measurement_method(self: "Self") -> "_676.MicroGeometryDefinitionMethod":
    ...
    def lead_measurement_method(
        self: "Self", value: "_676.MicroGeometryDefinitionMethod"
    ) -> None:
    ...
    def profile_measurement_method(
        self: "Self",
    ) -> "_676.MicroGeometryDefinitionMethod":
        """mastapy.gears.manufacturing.cylindrical.plunge_shaving.MicroGeometryDefinitionMethod"""
    ...
    def left_flank_micro_geometry(
        self: "Self",
    ) -> "_644.CylindricalGearSpecifiedMicroGeometry":
    ...
    @property
    def shaver(self: "Self") -> "_741.CylindricalGearPlungeShaver":
    ...
    def micro_geometry(
        self: "Self",
    ) -> "List[_644.CylindricalGearSpecifiedMicroGeometry]":
