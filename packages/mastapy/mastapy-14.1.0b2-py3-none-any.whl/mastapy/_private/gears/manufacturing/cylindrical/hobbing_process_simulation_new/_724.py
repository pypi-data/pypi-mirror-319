...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class WormGrindingLeadCalculation(_725.WormGrindingProcessCalculation):
    """WormGrindingLeadCalculation
    ...
    @property
    def left_flank_lead_modification_chart(self: "Self") -> "_1934.TwoDChartDefinition":
    ...
    @property
    def left_flank(self: "Self") -> "_691.CalculateLeadDeviationAccuracy":
    ...
    @property
    def right_flank(self: "Self") -> "_691.CalculateLeadDeviationAccuracy":
        """mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new.CalculateLeadDeviationAccuracy
