...
from mastapy._private.gears.manufacturing.cylindrical.plunge_shaving import _676, _677
...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.manufacturing.cylindrical.plunge_shaving import _684
...
class PlungeShaverInputsAndMicroGeometry(_0.APIBase):
    ...
    @enforce_parameter_types
    def micro_geometry_source(
        self: "Self", value: "_677.MicroGeometryDefinitionType"
    ) -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
    ...
    @property
    def points_of_interest_left_flank(self: "Self") -> "List[_684.PointOfInterest]":
    ...
    @property
    def points_of_interest_right_flank(self: "Self") -> "List[_684.PointOfInterest]":
        """List[mastapy.gears.manufacturing.cylindrical.plunge_shaving.PointOfInterest]
