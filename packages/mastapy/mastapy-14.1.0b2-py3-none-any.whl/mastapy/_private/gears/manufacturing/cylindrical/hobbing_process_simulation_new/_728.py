...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class WormGrindingProcessPitchCalculation(_725.WormGrindingProcessCalculation):
    """WormGrindingProcessPitchCalculation
    ...
    @property
    def pitch_modification_chart(self: "Self") -> "_1934.TwoDChartDefinition":
    ...
    @property
    def left_flank(self: "Self") -> "_692.CalculatePitchDeviationAccuracy":
    ...
    @property
    def right_flank(self: "Self") -> "_692.CalculatePitchDeviationAccuracy":
        """mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new.CalculatePitchDeviationAccuracy
