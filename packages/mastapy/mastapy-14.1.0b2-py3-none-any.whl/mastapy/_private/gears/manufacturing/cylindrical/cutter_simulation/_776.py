...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.manufacturing.cylindrical.cutters.tangibles import _757
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ShaperSimulationCalculator(_762.CutterSimulationCalc):
    """ShaperSimulationCalculator
    ...
    @property
    def shaper(self: "Self") -> "_757.CylindricalGearShaperTangible":
