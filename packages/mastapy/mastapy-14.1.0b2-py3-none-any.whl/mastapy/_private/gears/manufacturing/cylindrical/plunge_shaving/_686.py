...
from mastapy._private.gears.manufacturing.cylindrical.plunge_shaving import _673
...
class _Cast_ShaverPointCalculationError:
    ...
    @property
    def calculation_error(self: "CastSelf") -> "_673.CalculationError":
        return self.__parent__._cast(_673.CalculationError)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ShaverPointCalculationError(_673.CalculationError):
    """ShaverPointCalculationError
