...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.manufacturing.cylindrical.cutters.tangibles import _760
...
class _Cast_CutterSimulationCalc:
    ...
    def form_wheel_grinding_simulation_calculator(
        self: "CastSelf",
    ) -> "_769.FormWheelGrindingSimulationCalculator":
        from mastapy._private.gears.manufacturing.cylindrical.cutter_simulation import (
            _769,
        )

        return self.__parent__._cast(_769.FormWheelGrindingSimulationCalculator)

    @property
    def hob_simulation_calculator(self: "CastSelf") -> "_771.HobSimulationCalculator":
        from mastapy._private.gears.manufacturing.cylindrical.cutter_simulation import (
            _771,
        )

        return self.__parent__._cast(_771.HobSimulationCalculator)
    ...
    def shaper_simulation_calculator(
        self: "CastSelf",
    ) -> "_776.ShaperSimulationCalculator":
        from mastapy._private.gears.manufacturing.cylindrical.cutter_simulation import (
            _776,
        )

        return self.__parent__._cast(_776.ShaperSimulationCalculator)

    @property
    def shaving_simulation_calculator(
        self: "CastSelf",
    ) -> "_777.ShavingSimulationCalculator":
        from mastapy._private.gears.manufacturing.cylindrical.cutter_simulation import (
            _777,
        )

        return self.__parent__._cast(_777.ShavingSimulationCalculator)

    @property
    def virtual_simulation_calculator(
        self: "CastSelf",
    ) -> "_778.VirtualSimulationCalculator":
        from mastapy._private.gears.manufacturing.cylindrical.cutter_simulation import (
            _778,
        )

        return self.__parent__._cast(_778.VirtualSimulationCalculator)

    @property
    def worm_grinder_simulation_calculator(
        self: "CastSelf",
    ) -> "_779.WormGrinderSimulationCalculator":
        from mastapy._private.gears.manufacturing.cylindrical.cutter_simulation import (
            _779,
        )

        return self.__parent__._cast(_779.WormGrinderSimulationCalculator)
...
class CutterSimulationCalc(_0.APIBase):
    ...
    @property
    def gear(self: "Self") -> "_763.CylindricalCutterSimulatableGear":
    ...
    @property
    def stock_removed_at_designed_sap(self: "Self") -> "_768.FinishStockPoint":
    ...
    @property
    def stock_removed_at_reference_diameter(self: "Self") -> "_768.FinishStockPoint":
        """mastapy.gears.manufacturing.cylindrical.cutter_simulation.FinishStockPoint
    ...
    @property
    def stock_removed_at_rough_tip_form(self: "Self") -> "_768.FinishStockPoint":
        """mastapy.gears.manufacturing.cylindrical.cutter_simulation.FinishStockPoint
    ...
    @property
    def finish_stock_indexed_arcs(self: "Self") -> "List[_768.FinishStockPoint]":
    ...
    @property
    def gear_fillet_points(self: "Self") -> "List[_760.NamedPoint]":
    ...
    @property
    def main_profile_finish_stock(self: "Self") -> "List[_768.FinishStockPoint]":
        """List[mastapy.gears.manufacturing.cylindrical.cutter_simulation.FinishStockPoint]
