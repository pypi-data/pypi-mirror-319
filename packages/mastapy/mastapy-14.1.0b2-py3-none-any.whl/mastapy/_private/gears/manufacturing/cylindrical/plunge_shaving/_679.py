...
class PlungeShaverCalculationInputs(_0.APIBase):
    ...
    @property
    def shaver_hand(self: "Self") -> "_351.Hand":
        """mastapy.gears.Hand"""
    ...
    @shaver_hand.setter
    @enforce_parameter_types
    def shaver_hand(self: "Self", value: "_351.Hand") -> None:
    ...
    @property
    def input_gear_geometry(self: "Self") -> "_763.CylindricalCutterSimulatableGear":
