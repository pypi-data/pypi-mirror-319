...
if TYPE_CHECKING:
    ...
    from mastapy._private.cycloidal import _1514, _1517
...
class CycloidalDiscDesign(_0.APIBase):
    ...
    @property
    def crowning_chart(self: "Self") -> "_1934.TwoDChartDefinition":
    ...
    @property
    def exporter(self: "Self") -> "_1514.CycloidalDiscDesignExporter":
    ...
    def modifications_specification(
        self: "Self",
    ) -> "_1517.CycloidalDiscModificationsSpecification":
