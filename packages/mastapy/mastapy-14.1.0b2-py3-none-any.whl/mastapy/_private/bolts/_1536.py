...
if TYPE_CHECKING:
    ...
    from mastapy._private.bolts import _1525, _1527, _1529, _1534, _1539, _1542
...
class DetailedBoltDesign(_0.APIBase):
    ...
    @property
    def clamped_parts(self: "Self") -> "List[_1534.ClampedSection]":
    ...
    @enforce_parameter_types
    def clamped_parts(self: "Self", value: "List[_1534.ClampedSection]") -> None:
    ...
    @property
    def joint_geometry(self: "Self") -> "_1539.JointGeometries":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.bolts._1539", "JointGeometries"
        )(value)

    @joint_geometry.setter
    @enforce_parameter_types
    def joint_geometry(self: "Self", value: "_1539.JointGeometries") -> None:
    ...
    def rolled_before_or_after_heat_treatment(
        self: "Self",
    ) -> "_1542.RolledBeforeOrAfterHeatTreatment":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.bolts._1542", "RolledBeforeOrAfterHeatTreatment"
        )(value)

    @rolled_before_or_after_heat_treatment.setter
    @enforce_parameter_types
    def rolled_before_or_after_heat_treatment(
        self: "Self", value: "_1542.RolledBeforeOrAfterHeatTreatment"
    ) -> None:
    ...
    @property
    def bolt_geometry(self: "Self") -> "_1527.BoltGeometry":
    ...
    @property
    def material_of_bolt(self: "Self") -> "_1529.BoltMaterial":
    ...
    @property
    def material_of_nut(self: "Self") -> "_1525.BoltedJointMaterial":
    ...
    @property
    def material_of_tapped_thread(self: "Self") -> "_1525.BoltedJointMaterial":
        """mastapy.bolts.BoltedJointMaterial
    ...
    @property
    def clamped_sections(self: "Self") -> "List[_1534.ClampedSection]":
        """List[mastapy.bolts.ClampedSection]
