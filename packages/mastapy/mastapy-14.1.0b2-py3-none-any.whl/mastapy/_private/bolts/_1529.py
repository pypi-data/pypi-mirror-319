...
if TYPE_CHECKING:
    ...
    from mastapy._private.bolts import _1544
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class BoltMaterial(_1525.BoltedJointMaterial):
    """BoltMaterial
    ...
    @property
    def strength_grade(self: "Self") -> "_1544.StrengthGrades":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.bolts._1544", "StrengthGrades"
        )(value)

    @strength_grade.setter
    @enforce_parameter_types
    def strength_grade(self: "Self", value: "_1544.StrengthGrades") -> None:
