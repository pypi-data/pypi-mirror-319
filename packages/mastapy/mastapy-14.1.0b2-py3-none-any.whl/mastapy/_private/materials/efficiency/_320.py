...
if TYPE_CHECKING:
    ...
    from mastapy._private.materials.efficiency import _313, _315
...
class _Cast_PowerLoss:
    ...
    @property
    def independent_power_loss(self: "CastSelf") -> "_313.IndependentPowerLoss":
        from mastapy._private.materials.efficiency import _313

        return self.__parent__._cast(_313.IndependentPowerLoss)

    @property
    def load_and_speed_combined_power_loss(
        self: "CastSelf",
    ) -> "_315.LoadAndSpeedCombinedPowerLoss":
        from mastapy._private.materials.efficiency import _315

        return self.__parent__._cast(_315.LoadAndSpeedCombinedPowerLoss)
