...
class AcousticRadiationEfficiency(_0.APIBase):
    ...
    @property
    def input_type(self: "Self") -> "_257.AcousticRadiationEfficiencyInputType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.materials._257", "AcousticRadiationEfficiencyInputType"
        )(value)

    @input_type.setter
    @enforce_parameter_types
    def input_type(
        self: "Self", value: "_257.AcousticRadiationEfficiencyInputType"
    ) -> None:
    ...
    @property
    def radiation_efficiency_curve(self: "Self") -> "_1594.Vector2DListAccessor":
