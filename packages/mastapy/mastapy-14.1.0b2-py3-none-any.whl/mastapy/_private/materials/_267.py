...
class BHCurveSpecification(_0.APIBase):
    ...
    @property
    def bh_curve(self: "Self") -> "_1594.Vector2DListAccessor":
    ...
    def bh_curve(self: "Self", value: "_1594.Vector2DListAccessor") -> None:
        pythonnet_property_set(self.wrapped, "BHCurve", value.wrapped)

    @property
    def bh_curve_plot(self: "Self") -> "_1934.TwoDChartDefinition":
    ...
    def bh_curve_extrapolation_method(
        self: "Self",
    ) -> "_266.BHCurveExtrapolationMethod":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.materials._266", "BHCurveExtrapolationMethod"
        )(value)

    @bh_curve_extrapolation_method.setter
    @enforce_parameter_types
    def bh_curve_extrapolation_method(
        self: "Self", value: "_266.BHCurveExtrapolationMethod"
    ) -> None:
