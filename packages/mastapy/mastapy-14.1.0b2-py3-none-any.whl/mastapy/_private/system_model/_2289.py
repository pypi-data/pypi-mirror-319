...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model import _2290
...
T = TypeVar("T", bound="_2514.Component")
...
class RelativeComponentAlignment(_0.APIBase, Generic[T]):
    ...
    @property
    def alignment_axis(self: "Self") -> "_1550.AlignmentAxis":
    ...
    def alignment_axis(self: "Self", value: "_1550.AlignmentAxis") -> None:
    ...
    @property
    def axial_offset(self: "Self") -> "_2290.RelativeOffsetOption":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model._2290", "RelativeOffsetOption"
        )(value)

    @axial_offset.setter
    @enforce_parameter_types
    def axial_offset(self: "Self", value: "_2290.RelativeOffsetOption") -> None:
        value = conversion.mp_to_pn_enum(
