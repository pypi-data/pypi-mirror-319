...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.fe import _2445, _2471
...
class _Cast_FEEntityGroupWithSelection:
    ...
    def element_face_group_with_selection(
        self: "CastSelf",
    ) -> "_2445.ElementFaceGroupWithSelection":
        from mastapy._private.system_model.fe import _2445

        return self.__parent__._cast(_2445.ElementFaceGroupWithSelection)

    @property
    def node_group_with_selection(self: "CastSelf") -> "_2471.NodeGroupWithSelection":
        from mastapy._private.system_model.fe import _2471

        return self.__parent__._cast(_2471.NodeGroupWithSelection)
