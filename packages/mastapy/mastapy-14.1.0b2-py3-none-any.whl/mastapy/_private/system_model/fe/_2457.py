...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.fe import _2455, _2456
...
class FESubstructureNodeModeShapes(_0.APIBase):
    ...
    @property
    def condensation_node(self: "Self") -> "_2455.FESubstructureNode":
    ...
    def mode_shapes_at_condensation_node(
        self: "Self",
    ) -> "List[_2456.FESubstructureNodeModeShape]":
