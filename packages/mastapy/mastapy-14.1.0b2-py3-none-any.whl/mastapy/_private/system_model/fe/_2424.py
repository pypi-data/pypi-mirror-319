...
from mastapy._private.math_utility import _1550, _1551
...
class AlignConnectedComponentOptions(_0.APIBase):
    ...
    @property
    def component_direction_normal_to_surface(self: "Self") -> "_1551.Axis":
    ...
    @enforce_parameter_types
    def component_orientation(
        self: "Self", value: "_2435.ComponentOrientationOption"
    ) -> None:
    ...
    def fe_axis_approximately_in_perpendicular_direction(
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.math_utility._1550", "AlignmentAxis"
        )(value)

    @fe_axis_approximately_in_perpendicular_direction.setter
    @enforce_parameter_types
    def fe_axis_approximately_in_perpendicular_direction(
        self: "Self", value: "_1550.AlignmentAxis"
    ) -> None:
    ...
    @property
    def first_component_alignment_axis(self: "Self") -> "_1551.Axis":
        """mastapy.math_utility.Axis"""
    ...
    @enforce_parameter_types
    def first_component_alignment_axis(self: "Self", value: "_1551.Axis") -> None:
        value = conversion.mp_to_pn_enum(value, "SMT.MastaAPI.MathUtility.Axis")
        pythonnet_property_set(self.wrapped, "FirstComponentAlignmentAxis", value)

    @property
    def first_fe_alignment_axis(self: "Self") -> "_1550.AlignmentAxis":
        """mastapy.math_utility.AlignmentAxis"""
    ...
    @enforce_parameter_types
    def first_fe_alignment_axis(self: "Self", value: "_1550.AlignmentAxis") -> None:
        value = conversion.mp_to_pn_enum(
            value, "SMT.MastaAPI.MathUtility.AlignmentAxis"
        )
    ...
    @enforce_parameter_types
    def second_component_alignment_axis(self: "Self", value: "_1551.Axis") -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
            enum_with_selected_value.EnumWithSelectedValue_Axis.implicit_type()
        )
    ...
    @enforce_parameter_types
    def second_fe_alignment_axis(self: "Self", value: "_1550.AlignmentAxis") -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
