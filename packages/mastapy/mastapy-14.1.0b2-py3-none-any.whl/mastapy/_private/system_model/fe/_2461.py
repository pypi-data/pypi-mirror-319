...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.fe import _2429, _2436, _2437, _2446, _2469
...
class _Cast_FESubstructureWithSelectionComponents:
    ...
    def fe_substructure_with_selection(
        self: "CastSelf",
    ) -> "_2460.FESubstructureWithSelection":
        return self.__parent__._cast(_2460.FESubstructureWithSelection)

    @property
    def base_fe_with_selection(self: "CastSelf") -> "_2429.BaseFEWithSelection":
        from mastapy._private.system_model.fe import _2429

        return self.__parent__._cast(_2429.BaseFEWithSelection)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class FESubstructureWithSelectionComponents(_2460.FESubstructureWithSelection):
    """FESubstructureWithSelectionComponents
    ...
    @property
    def manual_alignment(self: "Self") -> "_1559.CoordinateSystemEditor":
    ...
    def beam_element_properties(
        self: "Self",
    ) -> "List[_2446.ElementPropertiesWithSelection[_228.ElementPropertiesBeam]]":
    ...
    @property
    def component_links(self: "Self") -> "List[_2490.FELinkWithSelection]":
    ...
    @property
    def contact_pairs(self: "Self") -> "List[_2436.ContactPairWithSelection]":
    ...
    @property
    def coordinate_systems(self: "Self") -> "List[_2437.CoordinateSystemWithSelection]":
    ...
    def interface_element_properties(
        self: "Self",
    ) -> "List[_2446.ElementPropertiesWithSelection[_229.ElementPropertiesInterface]]":
    ...
    @property
    def links_for_electric_machine(self: "Self") -> "List[_2490.FELinkWithSelection]":
        """List[mastapy.system_model.fe.links.FELinkWithSelection]
    ...
    @property
    def links_for_selected_component(self: "Self") -> "List[_2490.FELinkWithSelection]":
        """List[mastapy.system_model.fe.links.FELinkWithSelection]
    ...
    def mass_element_properties(
        self: "Self",
    ) -> "List[_2446.ElementPropertiesWithSelection[_230.ElementPropertiesMass]]":
    ...
    @property
    def materials(self: "Self") -> "List[_2469.MaterialPropertiesWithSelection]":
    ...
    def other_element_properties(
        self: "Self",
    ) -> "List[_2446.ElementPropertiesWithSelection[_227.ElementPropertiesBase]]":
    ...
    def rigid_element_properties(
        self: "Self",
    ) -> "List[_2446.ElementPropertiesWithSelection[_231.ElementPropertiesRigid]]":
    ...
    def shell_element_properties(
        self: "Self",
    ) -> "List[_2446.ElementPropertiesWithSelection[_232.ElementPropertiesShell]]":
    ...
    def solid_element_properties(
        self: "Self",
    ) -> "List[_2446.ElementPropertiesWithSelection[_233.ElementPropertiesSolid]]":
    ...
    def spring_dashpot_element_properties(
        self: "Self",
    ) -> "List[_2446.ElementPropertiesWithSelection[_234.ElementPropertiesSpringDashpot]]":
