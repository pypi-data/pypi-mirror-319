...
class _Cast_BaseFEWithSelection:
    ...
    def race_bearing_fe_with_selection(
        self: "CastSelf",
    ) -> "_2478.RaceBearingFEWithSelection":
        from mastapy._private.system_model.fe import _2478

        return self.__parent__._cast(_2478.RaceBearingFEWithSelection)
...
class BaseFEWithSelection(_0.APIBase):
    ...
    def select_component(self: "Self", component: "_2514.Component") -> None:
