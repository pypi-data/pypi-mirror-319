...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.fe import _2441, _2442
...
class _Cast_DegreeOfFreedomBoundaryCondition:
    ...
    def degree_of_freedom_boundary_condition_angular(
        self: "CastSelf",
    ) -> "_2441.DegreeOfFreedomBoundaryConditionAngular":
        from mastapy._private.system_model.fe import _2441

        return self.__parent__._cast(_2441.DegreeOfFreedomBoundaryConditionAngular)

    @property
    def degree_of_freedom_boundary_condition_linear(
        self: "CastSelf",
    ) -> "_2442.DegreeOfFreedomBoundaryConditionLinear":
        from mastapy._private.system_model.fe import _2442

        return self.__parent__._cast(_2442.DegreeOfFreedomBoundaryConditionLinear)
