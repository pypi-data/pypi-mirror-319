...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.fe.version_comparer import _2482, _2486
...
class FESubstructureVersionComparer(_0.APIBase):
    ...
    @property
    def load_cases_to_run(self: "Self") -> "_2486.LoadCasesToRun":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.fe.version_comparer._2486", "LoadCasesToRun"
        )(value)

    @load_cases_to_run.setter
    @enforce_parameter_types
    def load_cases_to_run(self: "Self", value: "_2486.LoadCasesToRun") -> None:
    ...
    @property
    def design_results(self: "Self") -> "List[_2482.DesignResults]":
