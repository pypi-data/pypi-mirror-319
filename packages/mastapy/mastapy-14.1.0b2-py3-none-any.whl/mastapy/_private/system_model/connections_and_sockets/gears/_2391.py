...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.connections_and_sockets.gears import _2377, _2383
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class KlingelnbergSpiralBevelGearTeethSocket(_2386.KlingelnbergConicalGearTeethSocket):
    """KlingelnbergSpiralBevelGearTeethSocket
