...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model import _2505, _2536
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class AbstractShaftToMountableComponentConnection(_2341.Connection):
    """AbstractShaftToMountableComponentConnection
    ...
    @property
    def mountable_component(self: "Self") -> "_2536.MountableComponent":
    ...
    @property
    def shaft(self: "Self") -> "_2505.AbstractShaft":
