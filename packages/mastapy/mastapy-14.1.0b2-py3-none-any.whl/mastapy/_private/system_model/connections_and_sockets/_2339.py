...
class _Cast_ComponentConnection:
    ...
    @property
    def component_measurer(self: "CastSelf") -> "_2340.ComponentMeasurer":
        return self.__parent__._cast(_2340.ComponentMeasurer)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ComponentConnection(_2340.ComponentMeasurer):
    """ComponentConnection
    ...
    @property
    def connected_component(self: "Self") -> "_2514.Component":
