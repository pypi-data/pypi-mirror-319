...
class OilSeal(_2517.Connector):
    ...
    @property
    def drag_torque_vs_rotational_speed(self: "Self") -> "_1594.Vector2DListAccessor":
    ...
    @property
    def oil_seal_orientation(self: "Self") -> "_2028.Orientations":
    ...
    @enforce_parameter_types
    def oil_seal_orientation(self: "Self", value: "_2028.Orientations") -> None:
        value = conversion.mp_to_pn_enum(
