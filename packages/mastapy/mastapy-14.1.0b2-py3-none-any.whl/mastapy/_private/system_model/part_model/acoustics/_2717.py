...
class MicrophoneArrayDesign(_0.APIBase):
    ...
    @property
    def envelope_type(self: "Self") -> "_2707.AcousticEnvelopeType":
    ...
    @enforce_parameter_types
    def envelope_type(self: "Self", value: "_2707.AcousticEnvelopeType") -> None:
    ...
    @enforce_parameter_types
    def selected_datum(self: "Self", value: "_2518.Datum") -> None:
    ...
    def spherical_envelope_centre(
        self: "Self",
    ) -> "_2723.SphericalEnvelopeCentreDefinition":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.part_model.acoustics._2723",
    ...
    @enforce_parameter_types
    def spherical_envelope_centre(
        self: "Self", value: "_2723.SphericalEnvelopeCentreDefinition"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.PartModel.Acoustics.SphericalEnvelopeCentreDefinition",
    ...
    @property
    def spherical_envelope_type(self: "Self") -> "_2724.SphericalEnvelopeType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.part_model.acoustics._2724",
    ...
    def spherical_envelope_type(
        self: "Self", value: "_2724.SphericalEnvelopeType"
    ) -> None:
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def selected_part(self: "Self") -> "List[_2718.PartSelectionForAcousticEnvelope]":
