...
from mastapy._private.system_model import _2273
...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.acoustics import _2719, _2720
...
class _Cast_ResultSurfaceOptions:
    ...
    @property
    def result_plane_options(self: "CastSelf") -> "_2719.ResultPlaneOptions":
        from mastapy._private.system_model.part_model.acoustics import _2719

        return self.__parent__._cast(_2719.ResultPlaneOptions)

    @property
    def result_sphere_options(self: "CastSelf") -> "_2720.ResultSphereOptions":
        from mastapy._private.system_model.part_model.acoustics import _2720

        return self.__parent__._cast(_2720.ResultSphereOptions)
...
class ResultSurfaceOptions(_0.APIBase):
    ...
    @enforce_parameter_types
    def reference_component(self: "Self", value: "_2514.Component") -> None:
        wrapper_type = (
    ...
    @enforce_parameter_types
    def reference_component_type(self: "Self", value: "_2273.DesignEntityId") -> None:
