...
if TYPE_CHECKING:
    ...
    Self = TypeVar("Self", bound="ShaftCreationOptions")
    CastSelf = TypeVar(
        "CastSelf", bound="ShaftCreationOptions._Cast_ShaftCreationOptions"
    )
...
class _Cast_ShaftCreationOptions:
    """Special nested class for casting ShaftCreationOptions to subclasses."""

    __parent__: "ShaftCreationOptions"

    @property
    def shaft_creation_options(self: "CastSelf") -> "ShaftCreationOptions":
...
class ShaftCreationOptions(_0.APIBase):
    ...
    TYPE: ClassVar["Type"] = _SHAFT_CREATION_OPTIONS
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_ShaftCreationOptions":
        """Cast to another type.

        Returns:
            _Cast_ShaftCreationOptions
        """
        return _Cast_ShaftCreationOptions(self)
