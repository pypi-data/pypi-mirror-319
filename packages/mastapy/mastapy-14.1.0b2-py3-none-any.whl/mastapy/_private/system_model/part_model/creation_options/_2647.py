...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="CycloidalAssemblyCreationOptions._Cast_CycloidalAssemblyCreationOptions",
    )
...
class _Cast_CycloidalAssemblyCreationOptions:
    ...
    __parent__: "CycloidalAssemblyCreationOptions"
...
class CycloidalAssemblyCreationOptions(_0.APIBase):
    ...
    TYPE: ClassVar["Type"] = _CYCLOIDAL_ASSEMBLY_CREATION_OPTIONS
    ...
    def number_of_discs(self: "Self") -> "int":
        """int"""
        temp = pythonnet_property_get(self.wrapped, "NumberOfDiscs")
    ...
    @enforce_parameter_types
    def number_of_discs(self: "Self", value: "int") -> None:
        pythonnet_property_set(
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_CycloidalAssemblyCreationOptions":
        """Cast to another type.

        Returns:
            _Cast_CycloidalAssemblyCreationOptions
        """
        return _Cast_CycloidalAssemblyCreationOptions(self)
