...
class _Cast_PartDetailConfiguration:
    ...
    def active_gear_set_design_selection_group(
        ...
        return self.__parent__._cast(_2587.ActiveGearSetDesignSelectionGroup)

    @property
    def active_fe_substructure_selection_group(
        self: "CastSelf",
    ) -> "_2695.ActiveFESubstructureSelectionGroup":
        from mastapy._private.system_model.part_model.configurations import _2695

        return self.__parent__._cast(_2695.ActiveFESubstructureSelectionGroup)

    @property
    def active_shaft_design_selection_group(
        self: "CastSelf",
    ) -> "_2697.ActiveShaftDesignSelectionGroup":
        from mastapy._private.system_model.part_model.configurations import _2697

        return self.__parent__._cast(_2697.ActiveShaftDesignSelectionGroup)

    @property
    def bearing_detail_configuration(
        self: "CastSelf",
    ) -> "_2698.BearingDetailConfiguration":
        from mastapy._private.system_model.part_model.configurations import _2698

        return self.__parent__._cast(_2698.BearingDetailConfiguration)
