...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.gears import _2585, _2586
...
TPart = TypeVar("TPart", bound="_2540.Part")
...
class _Cast_PartDetailSelection:
    ...
    def active_cylindrical_gear_set_design_selection(
        self: "CastSelf",
    ) -> "_2585.ActiveCylindricalGearSetDesignSelection":
        from mastapy._private.system_model.part_model.gears import _2585

        return self.__parent__._cast(_2585.ActiveCylindricalGearSetDesignSelection)

    @property
    def active_gear_set_design_selection(
        self: "CastSelf",
    ) -> "_2586.ActiveGearSetDesignSelection":
        from mastapy._private.system_model.part_model.gears import _2586

        return self.__parent__._cast(_2586.ActiveGearSetDesignSelection)

    @property
    def active_fe_substructure_selection(
        self: "CastSelf",
    ) -> "_2694.ActiveFESubstructureSelection":
        from mastapy._private.system_model.part_model.configurations import _2694

        return self.__parent__._cast(_2694.ActiveFESubstructureSelection)

    @property
    def active_shaft_design_selection(
        self: "CastSelf",
    ) -> "_2696.ActiveShaftDesignSelection":
        from mastapy._private.system_model.part_model.configurations import _2696

        return self.__parent__._cast(_2696.ActiveShaftDesignSelection)

    @property
    def bearing_detail_selection(self: "CastSelf") -> "_2699.BearingDetailSelection":
        from mastapy._private.system_model.part_model.configurations import _2699

        return self.__parent__._cast(_2699.BearingDetailSelection)
