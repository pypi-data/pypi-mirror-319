...
class _Cast_RadialInternalClearanceTolerance:
    ...
    def internal_clearance_tolerance(
        self: "CastSelf",
    ) -> "_2529.InternalClearanceTolerance":
        return self.__parent__._cast(_2529.InternalClearanceTolerance)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class RadialInternalClearanceTolerance(_2529.InternalClearanceTolerance):
    """RadialInternalClearanceTolerance
