...
from mastapy._private.bearings.bearing_results import _2010, _2029
...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings import _1936, _1940, _1953
    from mastapy._private.bearings.bearing_designs import _2198
    from mastapy._private.bearings.bearing_results import _2028
    from mastapy._private.bearings.bearing_results.rolling import _2138
    ...
    from mastapy._private.utility.report import _1848
...
class Bearing(_2517.Connector):
    ...
    @enforce_parameter_types
    def bearing_tolerance_class(
        self: "Self", value: "_1970.BearingToleranceClass"
    ) -> None:
    ...
    def bearing_tolerance_definition(
        self: "Self",
    ) -> "_1971.BearingToleranceDefinitionOptions":
    ...
    @enforce_parameter_types
    def bearing_tolerance_definition(
        self: "Self", value: "_1971.BearingToleranceDefinitionOptions"
    ) -> None:
    ...
    @property
    def damping_options(self: "Self") -> "_1940.BearingDampingMatrixOption":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.bearings._1940", "BearingDampingMatrixOption"
        )(value)

    @damping_options.setter
    @enforce_parameter_types
    def damping_options(
        self: "Self", value: "_1940.BearingDampingMatrixOption"
    ) -> None:
        value = conversion.mp_to_pn_enum(
    ...
    def force_at_zero_displacement_input_method(
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.part_model._2510", "BearingF0InputMethod"
        )(value)

    @force_at_zero_displacement_input_method.setter
    @enforce_parameter_types
    def force_at_zero_displacement_input_method(
        self: "Self", value: "_2510.BearingF0InputMethod"
    ) -> None:
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def inner_fitting_chart(self: "Self") -> "_1848.SimpleChartDefinition":
    ...
    @property
    def journal_bearing_type(self: "Self") -> "_1953.JournalBearingType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.bearings._1953", "JournalBearingType"
        )(value)

    @journal_bearing_type.setter
    @enforce_parameter_types
    def journal_bearing_type(self: "Self", value: "_1953.JournalBearingType") -> None:
        value = conversion.mp_to_pn_enum(
    ...
    @model.setter
    @enforce_parameter_types
    def model(self: "Self", value: "_1944.BearingModel") -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    @property
    def outer_fitting_chart(self: "Self") -> "_1848.SimpleChartDefinition":
        """mastapy.utility.report.SimpleChartDefinition
    ...
    def permissible_axial_load_calculation_method(
        self: "Self",
        value: "Union[_2010.CylindricalRollerMaxAxialLoadMethod, Tuple[_2010.CylindricalRollerMaxAxialLoadMethod, bool]]",
    ) -> None:
        wrapper_type = (
    ...
    @preload.setter
    @enforce_parameter_types
    def preload(self: "Self", value: "_2029.PreloadType") -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    def axial_internal_clearance_tolerance(
        self: "Self",
    ) -> "_2508.AxialInternalClearanceTolerance":
    ...
    @property
    def detail(self: "Self") -> "_2198.BearingDesign":
    ...
    def friction_coefficients(
        self: "Self",
    ) -> "_2138.RollingBearingFrictionCoefficients":
    ...
    @property
    def inner_support_detail(self: "Self") -> "_1987.SupportDetail":
    ...
    @property
    def left_support_detail(self: "Self") -> "_1987.SupportDetail":
        """mastapy.bearings.tolerances.SupportDetail
    ...
    @property
    def outer_support_detail(self: "Self") -> "_1987.SupportDetail":
        """mastapy.bearings.tolerances.SupportDetail
    ...
    @property
    def overridden_lubrication_detail(self: "Self") -> "_286.LubricationDetail":
    ...
    def radial_internal_clearance_tolerance(
        self: "Self",
    ) -> "_2545.RadialInternalClearanceTolerance":
    ...
    @property
    def right_support_detail(self: "Self") -> "_1987.SupportDetail":
        """mastapy.bearings.tolerances.SupportDetail
    ...
    @property
    def ring_tolerance_inner(self: "Self") -> "_1973.InnerRingTolerance":
    ...
    @property
    def ring_tolerance_left(self: "Self") -> "_1984.RingTolerance":
    ...
    @property
    def ring_tolerance_outer(self: "Self") -> "_1979.OuterRingTolerance":
    ...
    @property
    def ring_tolerance_right(self: "Self") -> "_1984.RingTolerance":
        """mastapy.bearings.tolerances.RingTolerance
    ...
    @property
    def simple_bearing_detail_property(self: "Self") -> "_2198.BearingDesign":
        """mastapy.bearings.bearing_designs.BearingDesign
    ...
    @property
    def support_tolerance_inner(self: "Self") -> "_1974.InnerSupportTolerance":
        """mastapy.bearings.tolerances.InnerSupportTolerance
    ...
    @property
    def support_tolerance_left(self: "Self") -> "_1989.SupportTolerance":
    ...
    @property
    def support_tolerance_outer(self: "Self") -> "_1980.OuterSupportTolerance":
        """mastapy.bearings.tolerances.OuterSupportTolerance
    ...
    @property
    def support_tolerance_right(self: "Self") -> "_1989.SupportTolerance":
        """mastapy.bearings.tolerances.SupportTolerance
    ...
    @property
    def mounting(self: "Self") -> "List[_2511.BearingRaceMountingOptions]":
    ...
    @property
    def tolerance_combinations(self: "Self") -> "List[_1991.ToleranceCombination]":
    ...
    def try_attach_right_side_to(
        self: "Self", shaft: "_2555.Shaft", offset: "float" = float("nan")
    ...
    def set_detail_from_catalogue(
        self: "Self", catalogue: "_1936.BearingCatalog", designation: "str"
    ) -> None:
