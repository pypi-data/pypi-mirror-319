...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model import _2504, _2534, _2540
    from mastapy._private.system_model.part_model.acoustics import _2717
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class MicrophoneArray(_2549.SpecialisedAssembly):
    """MicrophoneArray
    ...
    @property
    def array_design(self: "Self") -> "_2717.MicrophoneArrayDesign":
