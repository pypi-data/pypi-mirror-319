...
class _Cast_ComponentFromCADBase:
    ...
    @property
    def abstract_shaft_from_cad(self: "CastSelf") -> "_2566.AbstractShaftFromCAD":
        from mastapy._private.system_model.part_model.import_from_cad import _2566

        return self.__parent__._cast(_2566.AbstractShaftFromCAD)

    @property
    def clutch_from_cad(self: "CastSelf") -> "_2567.ClutchFromCAD":
        from mastapy._private.system_model.part_model.import_from_cad import _2567

        return self.__parent__._cast(_2567.ClutchFromCAD)
    ...
    @property
    def connector_from_cad(self: "CastSelf") -> "_2571.ConnectorFromCAD":
        from mastapy._private.system_model.part_model.import_from_cad import _2571

        return self.__parent__._cast(_2571.ConnectorFromCAD)
    ...
    def cylindrical_gear_in_planetary_set_from_cad(
        self: "CastSelf",
    ) -> "_2573.CylindricalGearInPlanetarySetFromCAD":
        from mastapy._private.system_model.part_model.import_from_cad import _2573

        return self.__parent__._cast(_2573.CylindricalGearInPlanetarySetFromCAD)
    ...
    @property
    def planet_shaft_from_cad(self: "CastSelf") -> "_2579.PlanetShaftFromCAD":
        from mastapy._private.system_model.part_model.import_from_cad import _2579

        return self.__parent__._cast(_2579.PlanetShaftFromCAD)

    @property
    def pulley_from_cad(self: "CastSelf") -> "_2580.PulleyFromCAD":
        from mastapy._private.system_model.part_model.import_from_cad import _2580

        return self.__parent__._cast(_2580.PulleyFromCAD)
    ...
    @property
    def shaft_from_cad(self: "CastSelf") -> "_2583.ShaftFromCAD":
        from mastapy._private.system_model.part_model.import_from_cad import _2583

        return self.__parent__._cast(_2583.ShaftFromCAD)

    @property
    def shaft_from_cad_auto(self: "CastSelf") -> "_2584.ShaftFromCADAuto":
        from mastapy._private.system_model.part_model.import_from_cad import _2584

        return self.__parent__._cast(_2584.ShaftFromCADAuto)
