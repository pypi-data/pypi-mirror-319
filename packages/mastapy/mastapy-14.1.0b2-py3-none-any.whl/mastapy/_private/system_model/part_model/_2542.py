...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model import _2284
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class PlanetCarrierSettings(_1654.PerMachineSettings):
    """PlanetCarrierSettings
    ...
    def planet_pin_manufacturing_errors_coordinate_system(
        self: "Self",
    ) -> "_2284.PlanetPinManufacturingErrorsCoordinateSystem":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model._2284",
    ...
    def planet_pin_manufacturing_errors_coordinate_system(
        self: "Self", value: "_2284.PlanetPinManufacturingErrorsCoordinateSystem"
    ) -> None:
