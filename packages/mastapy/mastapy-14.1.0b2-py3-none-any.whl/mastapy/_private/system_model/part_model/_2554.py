...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model import _2553
...
class WindTurbineSingleBladeDetails(_0.APIBase):
    ...
    @property
    def edgewise_modes(self: "Self") -> "_2553.WindTurbineBladeModeDetails":
    ...
    @property
    def flapwise_modes(self: "Self") -> "_2553.WindTurbineBladeModeDetails":
        """mastapy.system_model.part_model.WindTurbineBladeModeDetails
