...
class _Cast_InnerBearingRaceMountingOptions:
    ...
    def bearing_race_mounting_options(
        self: "CastSelf",
    ) -> "_2511.BearingRaceMountingOptions":
        return self.__parent__._cast(_2511.BearingRaceMountingOptions)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class InnerBearingRaceMountingOptions(_2511.BearingRaceMountingOptions):
    """InnerBearingRaceMountingOptions
