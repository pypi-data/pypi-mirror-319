...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ConceptCoupling(_2660.Coupling):
    """ConceptCoupling
    ...
    @property
    def efficiency_vs_speed_ratio(self: "Self") -> "_1594.Vector2DListAccessor":
    ...
    @property
    def half_positioning(self: "Self") -> "_2659.ConceptCouplingHalfPositioning":
    ...
    def half_positioning(
        self: "Self", value: "_2659.ConceptCouplingHalfPositioning"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.PartModel.Couplings.ConceptCouplingHalfPositioning",
