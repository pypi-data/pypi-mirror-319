...
from mastapy._private.bearings.bearing_results import _2031, _2032
...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model import _2528, _2539
...
class _Cast_BearingRaceMountingOptions:
    ...
    def inner_bearing_race_mounting_options(
        self: "CastSelf",
    ) -> "_2528.InnerBearingRaceMountingOptions":
        from mastapy._private.system_model.part_model import _2528

        return self.__parent__._cast(_2528.InnerBearingRaceMountingOptions)

    @property
    def outer_bearing_race_mounting_options(
        self: "CastSelf",
    ) -> "_2539.OuterBearingRaceMountingOptions":
        from mastapy._private.system_model.part_model import _2539

        return self.__parent__._cast(_2539.OuterBearingRaceMountingOptions)
...
class BearingRaceMountingOptions(_0.APIBase):
    ...
    def axial_mounting(self: "Self", value: "_2031.RaceAxialMountingType") -> None:
    ...
    @enforce_parameter_types
    def simple_radial_mounting(
        self: "Self", value: "_2032.RaceRadialMountingType"
    ) -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
    ...
    @property
    def mounting_sleeve_material(self: "Self") -> "_264.BearingMaterial":
