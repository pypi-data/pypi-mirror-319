...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.part_groups import _2561, _2565
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ConcentricPartGroup(_2559.ConcentricOrParallelPartGroup):
    """ConcentricPartGroup
    ...
    def parallel_groups(
        self: "Self",
    ) -> "List[_2561.ConcentricPartGroupParallelToThis]":
