...
from mastapy._private.system_model.part_model.part_groups import _2565
...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.part_groups import _2560, _2563, _2564
...
class _Cast_ConcentricOrParallelPartGroup:
    ...
    @property
    def part_group(self: "CastSelf") -> "_2565.PartGroup":
        return self.__parent__._cast(_2565.PartGroup)

    @property
    def concentric_part_group(self: "CastSelf") -> "_2560.ConcentricPartGroup":
        from mastapy._private.system_model.part_model.part_groups import _2560

        return self.__parent__._cast(_2560.ConcentricPartGroup)

    @property
    def parallel_part_group(self: "CastSelf") -> "_2563.ParallelPartGroup":
        from mastapy._private.system_model.part_model.part_groups import _2563

        return self.__parent__._cast(_2563.ParallelPartGroup)

    @property
    def parallel_part_group_selection(
        self: "CastSelf",
    ) -> "_2564.ParallelPartGroupSelection":
        from mastapy._private.system_model.part_model.part_groups import _2564

        return self.__parent__._cast(_2564.ParallelPartGroupSelection)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ConcentricOrParallelPartGroup(_2565.PartGroup):
    """ConcentricOrParallelPartGroup
