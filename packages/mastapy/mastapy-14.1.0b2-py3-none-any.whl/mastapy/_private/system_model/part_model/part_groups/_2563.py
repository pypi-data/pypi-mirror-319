...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.part_groups import _2560, _2564, _2565
...
class _Cast_ParallelPartGroup:
    ...
    def concentric_or_parallel_part_group(
        self: "CastSelf",
    ) -> "_2559.ConcentricOrParallelPartGroup":
        return self.__parent__._cast(_2559.ConcentricOrParallelPartGroup)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ParallelPartGroup(_2559.ConcentricOrParallelPartGroup):
    """ParallelPartGroup
    ...
    @property
    def concentric_part_groups(self: "Self") -> "List[_2560.ConcentricPartGroup]":
