...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class StraightBevelGearSet(_2595.BevelGearSet):
    """StraightBevelGearSet
    ...
    @property
    def straight_bevel_gears(self: "Self") -> "List[_2622.StraightBevelGear]":
    ...
    @property
    def straight_bevel_meshes(self: "Self") -> "List[_2396.StraightBevelGearMesh]":
