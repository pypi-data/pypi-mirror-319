...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class SpiralBevelGearSet(_2595.BevelGearSet):
    """SpiralBevelGearSet
    ...
    @property
    def spiral_bevel_gears(self: "Self") -> "List[_2618.SpiralBevelGear]":
    ...
    @property
    def spiral_bevel_meshes(self: "Self") -> "List[_2392.SpiralBevelGearMesh]":
