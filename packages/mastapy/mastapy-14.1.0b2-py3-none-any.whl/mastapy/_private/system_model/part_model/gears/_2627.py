...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class WormGearSet(_2607.GearSet):
    """WormGearSet
    ...
    @property
    def active_gear_set_design(self: "Self") -> "_991.WormGearSetDesign":
    ...
    @property
    def worm_gear_set_design(self: "Self") -> "_991.WormGearSetDesign":
        """mastapy.gears.gear_designs.worm.WormGearSetDesign
    ...
    @property
    def worm_gears(self: "Self") -> "List[_2626.WormGear]":
    ...
    @property
    def worm_meshes(self: "Self") -> "List[_2398.WormGearMesh]":
