...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class StraightBevelGear(_2594.BevelGear):
    """StraightBevelGear
    ...
    @property
    def bevel_gear_design(self: "Self") -> "_993.StraightBevelGearDesign":
    ...
    @property
    def straight_bevel_gear_design(self: "Self") -> "_993.StraightBevelGearDesign":
        """mastapy.gears.gear_designs.straight_bevel.StraightBevelGearDesign
