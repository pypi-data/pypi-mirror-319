...
from mastapy._private.system_model.part_model.configurations import _2701
from mastapy._private.system_model.part_model.gears import _2586, _2607
...
class _Cast_ActiveGearSetDesignSelectionGroup:
    ...
    @property
    def part_detail_configuration(self: "CastSelf") -> "_2701.PartDetailConfiguration":
        return self.__parent__._cast(_2701.PartDetailConfiguration)
...
class ActiveGearSetDesignSelectionGroup(
    _2701.PartDetailConfiguration[
        _2586.ActiveGearSetDesignSelection, _2607.GearSet, _982.GearSetDesign
    ]
):
    """ActiveGearSetDesignSelectionGroup
