...
from mastapy._private.system_model.part_model.gears.supercharger_rotor_set import _2638
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class SuperchargerRotorSetDatabase(_1894.NamedDatabase[_2638.SuperchargerRotorSet]):
    """SuperchargerRotorSetDatabase
