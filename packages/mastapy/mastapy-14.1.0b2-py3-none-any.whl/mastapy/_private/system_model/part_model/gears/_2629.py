...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ZerolBevelGearSet(_2595.BevelGearSet):
    """ZerolBevelGearSet
    ...
    @property
    def zerol_bevel_gears(self: "Self") -> "List[_2628.ZerolBevelGear]":
    ...
    @property
    def zerol_bevel_meshes(self: "Self") -> "List[_2400.ZerolBevelGearMesh]":
