...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class DesignSettings(_0.APIBase, _1645.IHaveAllSettings):
    """DesignSettings
    ...
    @property
    def bearing_settings(self: "Self") -> "_1948.BearingSettingsItem":
    ...
    @property
    def design_constraints_settings(self: "Self") -> "_978.DesignConstraintsCollection":
    ...
    @property
    def materials_settings(self: "Self") -> "_292.MaterialsSettingsItem":
