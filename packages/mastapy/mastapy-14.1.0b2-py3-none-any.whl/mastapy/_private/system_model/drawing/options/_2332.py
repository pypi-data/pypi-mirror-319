...
class ModalContributionViewOptions(_0.APIBase):
    ...
    @property
    def filtering_frequency_range(self: "Self") -> "_1548.Range":
    ...
    @enforce_parameter_types
    def filtering_frequency_range(self: "Self", value: "_1548.Range") -> None:
        pythonnet_property_set(self.wrapped, "FilteringFrequencyRange", value.wrapped)

    @property
    def filtering_method(self: "Self") -> "_5978.ModalContributionFilteringMethod":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.harmonic_analyses.results._5978",
    ...
    def filtering_method(
        self: "Self", value: "_5978.ModalContributionFilteringMethod"
    ) -> None:
    ...
    @property
    def frequency_range(self: "Self") -> "_1548.Range":
        """mastapy.math_utility.Range"""
    ...
    @enforce_parameter_types
    def frequency_range(self: "Self", value: "_1548.Range") -> None:
    ...
    @property
    def index_range(self: "Self") -> "_1648.IntegerRange":
    ...
    @index_range.setter
    @enforce_parameter_types
    def index_range(self: "Self", value: "_1648.IntegerRange") -> None:
        pythonnet_property_set(self.wrapped, "IndexRange", value.wrapped)

    @property
    def modes_to_display(self: "Self") -> "_5977.ModalContributionDisplayMethod":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.harmonic_analyses.results._5977",
    ...
    def modes_to_display(
        self: "Self", value: "_5977.ModalContributionDisplayMethod"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.HarmonicAnalyses.Results.ModalContributionDisplayMethod",
