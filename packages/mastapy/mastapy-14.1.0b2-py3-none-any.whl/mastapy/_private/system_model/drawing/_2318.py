...
from mastapy._private.math_utility import _1588
...
from mastapy._private.system_model.drawing.options import _2331
...
class _Cast_HarmonicAnalysisViewable:
    ...
    def part_analysis_case_with_contour_viewable(
        self: "CastSelf",
    ) -> "_2322.PartAnalysisCaseWithContourViewable":
        from mastapy._private.system_model.drawing import _2322

        return self.__parent__._cast(_2322.PartAnalysisCaseWithContourViewable)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class HarmonicAnalysisViewable(_2317.DynamicAnalysisViewable):
    """HarmonicAnalysisViewable
    ...
    @enforce_parameter_types
    def excitation(
        self: "Self", value: "_5804.AbstractPeriodicExcitationDetail"
    ) -> None:
    ...
    @enforce_parameter_types
    def harmonic_analysis_with_varying_stiffness_step(
        self: "Self", value: "_5896.HarmonicAnalysisWithVaryingStiffnessStaticLoadCase"
    ) -> None:
    ...
    @order.setter
    @enforce_parameter_types
    def order(self: "Self", value: "_1588.RoundedOrder") -> None:
        wrapper_type = (
    ...
    @enforce_parameter_types
    def sound_response_type(self: "Self", value: "_4733.DynamicsResponseType") -> None:
    ...
    @enforce_parameter_types
    def uncoupled_mesh(self: "Self", value: "_2837.GearMeshSystemDeflection") -> None:
    ...
    @view_type.setter
    @enforce_parameter_types
    def view_type(self: "Self", value: "_2331.ExcitationAnalysisViewOption") -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
    ...
    @property
    def dynamic_analysis_draw_style(self: "Self") -> "_6464.DynamicAnalysisDrawStyle":
