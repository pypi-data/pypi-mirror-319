...
class ShaftDeflectionDrawingNodeItem(_0.APIBase):
    ...
    @property
    def node_detail(self: "Self") -> "_1619.ForceAndDisplacementResults":
    ...
    @property
    def section_to_the_left_side(self: "Self") -> "_2883.ShaftSectionSystemDeflection":
    ...
    @property
    def section_to_the_right_side(self: "Self") -> "_2883.ShaftSectionSystemDeflection":
        """mastapy.system_model.analyses_and_results.system_deflections.ShaftSectionSystemDeflection
