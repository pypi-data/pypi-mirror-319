...
class _Cast_SteadyStateSynchronousResponseViewable:
    ...
    @property
    def rotor_dynamics_viewable(self: "CastSelf") -> "_2324.RotorDynamicsViewable":
        return self.__parent__._cast(_2324.RotorDynamicsViewable)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class SteadyStateSynchronousResponseViewable(_2324.RotorDynamicsViewable):
    """SteadyStateSynchronousResponseViewable
