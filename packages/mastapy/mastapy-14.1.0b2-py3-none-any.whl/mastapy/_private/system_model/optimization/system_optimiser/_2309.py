...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.optimization.system_optimiser import _2306, _2307
...
class SystemOptimiserDetails(_0.APIBase):
    ...
    def criteria_for_selecting_configurations_to_keep(
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.load_case_groups._5795",
    ...
    @enforce_parameter_types
    def criteria_for_selecting_configurations_to_keep(
        self: "Self", value: "_5795.SystemOptimiserTargets"
    ) -> None:
    ...
    def gear_set_optimisation(
        self: "Self",
    ) -> "_5794.SystemOptimiserGearSetOptimisation":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.load_case_groups._5794",
    ...
    @enforce_parameter_types
    def gear_set_optimisation(
        self: "Self", value: "_5794.SystemOptimiserGearSetOptimisation"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.LoadCaseGroups.SystemOptimiserGearSetOptimisation",
    ...
    @property
    def planet_gear_options(self: "Self") -> "List[_2307.PlanetGearOptions]":
