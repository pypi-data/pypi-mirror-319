...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.optimization import _2296, _2299, _2301
...
class _Cast_OptimizationStep:
    ...
    def conical_gear_optimization_step(
        self: "CastSelf",
    ) -> "_2296.ConicalGearOptimizationStep":
        from mastapy._private.system_model.optimization import _2296

        return self.__parent__._cast(_2296.ConicalGearOptimizationStep)

    @property
    def cylindrical_gear_optimization_step(
        self: "CastSelf",
    ) -> "_2299.CylindricalGearOptimizationStep":
        from mastapy._private.system_model.optimization import _2299

        return self.__parent__._cast(_2299.CylindricalGearOptimizationStep)
...
class OptimizationStep(_0.APIBase):
    ...
    @property
    def optimisation_target(self: "Self") -> "_2301.MicroGeometryOptimisationTarget":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.optimization._2301",
    ...
    def optimisation_target(
        self: "Self", value: "_2301.MicroGeometryOptimisationTarget"
    ) -> None:
