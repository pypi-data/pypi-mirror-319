...
from mastapy._private.system_model.optimization import _2302
...
class _Cast_CylindricalGearOptimizationStep:
    ...
    @property
    def optimization_step(self: "CastSelf") -> "_2302.OptimizationStep":
        return self.__parent__._cast(_2302.OptimizationStep)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CylindricalGearOptimizationStep(_2302.OptimizationStep):
    """CylindricalGearOptimizationStep
