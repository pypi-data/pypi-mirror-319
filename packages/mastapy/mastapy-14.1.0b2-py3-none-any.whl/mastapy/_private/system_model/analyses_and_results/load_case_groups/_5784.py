...
class _Cast_AbstractLoadCaseGroup:
    ...
    def time_series_load_case_group(
        ...
        return self.__parent__._cast(_5796.TimeSeriesLoadCaseGroup)
...
class AbstractLoadCaseGroup(_0.APIBase):
    ...
    @property
    def load_case_root_assemblies(self: "Self") -> "List[_7641.RootAssemblyLoadCase]":
    ...
    def create_load_cases(
        self: "Self", number_of_load_cases: "int", token: "_7723.TaskProgress"
    ) -> "List[_7495.LoadCase]":
    ...
    @enforce_parameter_types
    def perform_pst_with_progress(self: "Self", progress: "_7723.TaskProgress") -> None:
        """Method does not return.
