...
from mastapy._private.system_model.analyses_and_results.load_case_groups import _5790
...
class _Cast_ClutchEngagementStatus:
    ...
    def generic_clutch_engagement_status(
        self: "CastSelf",
    ) -> "_5790.GenericClutchEngagementStatus":
        return self.__parent__._cast(_5790.GenericClutchEngagementStatus)
...
class ClutchEngagementStatus(
    _5790.GenericClutchEngagementStatus[_2411.ClutchConnection]
):
    """ClutchEngagementStatus
