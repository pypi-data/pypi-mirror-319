...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.analyses_and_results.static_loads import _7497
...
TAssembly = TypeVar("TAssembly", bound="_2504.AbstractAssembly")
TAssemblyStaticLoad = TypeVar(
    "TAssemblyStaticLoad", bound="_7497.AbstractAssemblyLoadCase"
)
...
class AbstractAssemblyStaticLoadCaseGroup(
    _5802.PartStaticLoadCaseGroup, Generic[TAssembly, TAssemblyStaticLoad]
):
    """AbstractAssemblyStaticLoadCaseGroup
