...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.gears import _2605, _2607
...
TGearSet = TypeVar("TGearSet", bound="_2607.GearSet")
TGear = TypeVar("TGear", bound="_2605.Gear")
TGearStaticLoad = TypeVar("TGearStaticLoad", bound="_7581.GearLoadCase")
TGearMesh = TypeVar("TGearMesh", bound="_2382.GearMesh")
TGearMeshStaticLoad = TypeVar("TGearMeshStaticLoad", bound="_7583.GearMeshLoadCase")
TGearSetStaticLoad = TypeVar("TGearSetStaticLoad", bound="_7586.GearSetLoadCase")
...
class _Cast_GearSetStaticLoadCaseGroup:
    ...
    def part_static_load_case_group(
        self: "CastSelf",
    ) -> "_5802.PartStaticLoadCaseGroup":
        return self.__parent__._cast(_5802.PartStaticLoadCaseGroup)

    @property
    def design_entity_static_load_case_group(
        self: "CastSelf",
    ) -> "_5800.DesignEntityStaticLoadCaseGroup":
        from mastapy._private.system_model.analyses_and_results.load_case_groups.design_entity_static_load_case_groups import (
            _5800,
        )

        return self.__parent__._cast(_5800.DesignEntityStaticLoadCaseGroup)
...
class GearSetStaticLoadCaseGroup(
    ...
    def gears_load_cases(
        self: "Self",
    ) -> "List[_5798.ComponentStaticLoadCaseGroup[TGear, TGearStaticLoad]]":
    ...
    def meshes_load_cases(
        self: "Self",
    ) -> "List[_5799.ConnectionStaticLoadCaseGroup[TGearMesh, TGearMeshStaticLoad]]":
