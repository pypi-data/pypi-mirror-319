...
from mastapy._private.system_model.analyses_and_results.load_case_groups import _5785
...
class _Cast_DutyCycle:
    ...
    def abstract_static_load_case_group(
        self: "CastSelf",
    ) -> "_5785.AbstractStaticLoadCaseGroup":
        return self.__parent__._cast(_5785.AbstractStaticLoadCaseGroup)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class DutyCycle(_5785.AbstractStaticLoadCaseGroup):
    """DutyCycle
    ...
    def duty_cycle_design_states(
        self: "Self",
    ) -> "List[_5792.SubGroupInSingleDesignState]":
    ...
    @property
    def time_series_importer(self: "Self") -> "_7695.TimeSeriesImporter":
    ...
    def add_static_load(self: "Self", static_load: "_7496.StaticLoadCase") -> None:
        """Method does not return.
    ...
    def remove_design_state_sub_group(
        self: "Self", sub_group: "_5792.SubGroupInSingleDesignState"
    ) -> None:
        """Method does not return.
    ...
    @enforce_parameter_types
    def remove_static_load(self: "Self", static_load: "_7496.StaticLoadCase") -> None:
        """Method does not return.
