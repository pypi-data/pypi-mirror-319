...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class DesignState(_5783.AbstractDesignStateLoadCaseGroup):
    """DesignState
    ...
    @property
    def clutches(self: "Self") -> "List[_5786.ClutchEngagementStatus]":
    ...
    def clutch_engagement_status_for(
        self: "Self", clutch_connection: "_2411.ClutchConnection"
    ) -> "_5786.ClutchEngagementStatus":
    ...
    def concept_synchro_gear_engagement_status_for(
        self: "Self", gear: "_2600.CylindricalGear"
    ) -> "_5787.ConceptSynchroGearEngagementStatus":
