...
if TYPE_CHECKING:
    ...
    from mastapy._private.utility.enums import _1886
    from mastapy._private.utility.report import _1825, _1831, _1832, _1833
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ShaftSystemDeflectionSectionsReport(_1818.CustomReportChart):
    """ShaftSystemDeflectionSectionsReport
    ...
    @property
    def display(self: "Self") -> "_1886.TableAndChartOptions":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.utility.enums._1886", "TableAndChartOptions"
        )(value)

    @display.setter
    @enforce_parameter_types
    def display(self: "Self", value: "_1886.TableAndChartOptions") -> None:
