...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CycloidalAssemblySystemDeflection(_2886.SpecialisedAssemblySystemDeflection):
    """CycloidalAssemblySystemDeflection
    ...
    @property
    def assembly_design(self: "Self") -> "_2643.CycloidalAssembly":
    ...
    @property
    def assembly_load_case(self: "Self") -> "_7548.CycloidalAssemblyLoadCase":
    ...
    @property
    def power_flow_results(self: "Self") -> "_4173.CycloidalAssemblyPowerFlow":
    ...
    def ring_pins_to_disc_connections(
        self: "Self",
    ) -> "List[_2875.RingPinsToDiscConnectionSystemDeflection]":
