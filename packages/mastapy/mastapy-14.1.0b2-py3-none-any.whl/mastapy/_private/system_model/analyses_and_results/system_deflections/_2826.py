...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="CylindricalMeshedGearFlankSystemDeflection._Cast_CylindricalMeshedGearFlankSystemDeflection",
    )
...
class _Cast_CylindricalMeshedGearFlankSystemDeflection:
    ...
    __parent__: "CylindricalMeshedGearFlankSystemDeflection"
...
class CylindricalMeshedGearFlankSystemDeflection(_0.APIBase):
    ...
    TYPE: ClassVar["Type"] = _CYLINDRICAL_MESHED_GEAR_FLANK_SYSTEM_DEFLECTION
    ...
    def minimum_clearance_from_form_diameter_to_sap_diameter(self: "Self") -> "float":
        ...
        temp = pythonnet_property_get(
            self.wrapped, "MinimumClearanceFromFormDiameterToSAPDiameter"
        )
    ...
    def operating_eap_diameter(self: "Self") -> "float":
        ...
        Note:
            This property is readonly.
        """
        temp = pythonnet_property_get(self.wrapped, "OperatingEAPDiameter")
    ...
    def operating_form_diameter(self: "Self") -> "float":
        ...
        Note:
            This property is readonly.
        """
        temp = pythonnet_property_get(self.wrapped, "OperatingFormDiameter")
    ...
    def operating_sap_diameter(self: "Self") -> "float":
        ...
        Note:
            This property is readonly.
        """
        temp = pythonnet_property_get(self.wrapped, "OperatingSAPDiameter")
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_CylindricalMeshedGearFlankSystemDeflection":
        """Cast to another type.

        Returns:
            _Cast_CylindricalMeshedGearFlankSystemDeflection
        """
        return _Cast_CylindricalMeshedGearFlankSystemDeflection(self)
