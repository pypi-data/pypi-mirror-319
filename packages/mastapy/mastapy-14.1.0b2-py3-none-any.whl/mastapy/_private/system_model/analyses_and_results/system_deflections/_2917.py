...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class WormGearSetSystemDeflection(_2838.GearSetSystemDeflection):
    """WormGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self: "Self") -> "_4263.WormGearSetPowerFlow":
    ...
    @property
    def gears_system_deflection(self: "Self") -> "List[_2918.WormGearSystemDeflection]":
    ...
    def worm_gears_system_deflection(
        self: "Self",
    ) -> "List[_2918.WormGearSystemDeflection]":
        """List[mastapy.system_model.analyses_and_results.system_deflections.WormGearSystemDeflection]
