...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class PlanetCarrierSystemDeflection(_2862.MountableComponentSystemDeflection):
    """PlanetCarrierSystemDeflection
    ...
    @property
    def power_flow_results(self: "Self") -> "_4220.PlanetCarrierPowerFlow":
    ...
    @property
    def windup(self: "Self") -> "List[_2926.PlanetCarrierWindup]":
