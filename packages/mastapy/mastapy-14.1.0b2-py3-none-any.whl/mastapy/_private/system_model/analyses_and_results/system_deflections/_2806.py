...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ConnectorSystemDeflection(_2862.MountableComponentSystemDeflection):
    """ConnectorSystemDeflection
    ...
    @property
    def outer_fe_part(self: "Self") -> "_2835.FEPartSystemDeflection":
    ...
    @property
    def outer_fe_substructure_nodes(self: "Self") -> "List[_2455.FESubstructureNode]":
    ...
    @property
    def power_flow_results(self: "Self") -> "_4166.ConnectorPowerFlow":
