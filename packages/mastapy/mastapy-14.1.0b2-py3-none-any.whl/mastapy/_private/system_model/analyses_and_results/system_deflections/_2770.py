...
from mastapy._private.system_model.analyses_and_results.system_deflections import _2763
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class AssemblySystemDeflection(_2763.AbstractAssemblySystemDeflection):
    """AssemblySystemDeflection
    ...
    @property
    def power_flow_results(self: "Self") -> "_4137.AssemblyPowerFlow":
    ...
    @property
    def bearings(self: "Self") -> "List[_2776.BearingSystemDeflection]":
    ...
    @property
    def belt_drives(self: "Self") -> "List[_2778.BeltDriveSystemDeflection]":
    ...
    def bevel_differential_gear_sets(
        self: "Self",
    ) -> "List[_2780.BevelDifferentialGearSetSystemDeflection]":
    ...
    @property
    def bolted_joints(self: "Self") -> "List[_2787.BoltedJointSystemDeflection]":
    ...
    @property
    def bolts(self: "Self") -> "List[_2788.BoltSystemDeflection]":
    ...
    @property
    def cv_ts(self: "Self") -> "List[_2812.CVTSystemDeflection]":
    ...
    @property
    def clutches(self: "Self") -> "List[_2791.ClutchSystemDeflection]":
    ...
    @property
    def component_details(self: "Self") -> "List[_2793.ComponentSystemDeflection]":
    ...
    def concept_couplings(
        self: "Self",
    ) -> "List[_2797.ConceptCouplingSystemDeflection]":
    ...
    @property
    def concept_gear_sets(self: "Self") -> "List[_2799.ConceptGearSetSystemDeflection]":
    ...
    @property
    def connection_details(self: "Self") -> "List[_2805.ConnectionSystemDeflection]":
    ...
    def cycloidal_assemblies(
        self: "Self",
    ) -> "List[_2813.CycloidalAssemblySystemDeflection]":
    ...
    @property
    def cycloidal_discs(self: "Self") -> "List[_2816.CycloidalDiscSystemDeflection]":
    ...
    @property
    def fe_parts(self: "Self") -> "List[_2835.FEPartSystemDeflection]":
    ...
    @property
    def face_gear_sets(self: "Self") -> "List[_2833.FaceGearSetSystemDeflection]":
    ...
    def flexible_pin_assemblies(
        self: "Self",
    ) -> "List[_2836.FlexiblePinAssemblySystemDeflection]":
    ...
    @property
    def hypoid_gear_sets(self: "Self") -> "List[_2842.HypoidGearSetSystemDeflection]":
    ...
    @property
    def mass_discs(self: "Self") -> "List[_2857.MassDiscSystemDeflection]":
    ...
    def measurement_components(
        self: "Self",
    ) -> "List[_2858.MeasurementComponentSystemDeflection]":
    ...
    @property
    def microphones(self: "Self") -> "List[_2861.MicrophoneSystemDeflection]":
    ...
    def mountable_component_details(
        self: "Self",
    ) -> "List[_2862.MountableComponentSystemDeflection]":
    ...
    @property
    def oil_seals(self: "Self") -> "List[_2864.OilSealSystemDeflection]":
    ...
    def part_to_part_shear_couplings(
        self: "Self",
    ) -> "List[_2868.PartToPartShearCouplingSystemDeflection]":
    ...
    @property
    def planet_carriers(self: "Self") -> "List[_2870.PlanetCarrierSystemDeflection]":
    ...
    @property
    def point_loads(self: "Self") -> "List[_2871.PointLoadSystemDeflection]":
    ...
    @property
    def power_loads(self: "Self") -> "List[_2872.PowerLoadSystemDeflection]":
    ...
    @property
    def ring_pins(self: "Self") -> "List[_2874.RingPinsSystemDeflection]":
    ...
    @property
    def rolling_bearings(self: "Self") -> "List[_2776.BearingSystemDeflection]":
        """List[mastapy.system_model.analyses_and_results.system_deflections.BearingSystemDeflection]
    ...
    def rolling_ring_assemblies(
        self: "Self",
    ) -> "List[_2877.RollingRingAssemblySystemDeflection]":
    ...
    @property
    def shafts(self: "Self") -> "List[_2884.ShaftSystemDeflection]":
    ...
    def shafts_and_housings(
        self: "Self",
    ) -> "List[_2764.AbstractShaftOrHousingSystemDeflection]":
    ...
    def sorted_converged_connection_details(
        self: "Self",
    ) -> "List[_2805.ConnectionSystemDeflection]":
        """List[mastapy.system_model.analyses_and_results.system_deflections.ConnectionSystemDeflection]
    ...
    @property
    def spring_dampers(self: "Self") -> "List[_2892.SpringDamperSystemDeflection]":
    ...
    def straight_bevel_diff_gear_sets(
        self: "Self",
    ) -> "List[_2894.StraightBevelDiffGearSetSystemDeflection]":
    ...
    @property
    def synchronisers(self: "Self") -> "List[_2904.SynchroniserSystemDeflection]":
    ...
    def torque_converters(
        self: "Self",
    ) -> "List[_2910.TorqueConverterSystemDeflection]":
    ...
    @property
    def unbalanced_masses(self: "Self") -> "List[_2914.UnbalancedMassSystemDeflection]":
    ...
    @property
    def worm_gear_sets(self: "Self") -> "List[_2917.WormGearSetSystemDeflection]":
