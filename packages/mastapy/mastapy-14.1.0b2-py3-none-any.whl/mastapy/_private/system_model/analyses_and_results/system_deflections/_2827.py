...
class CylindricalMeshedGearSystemDeflection(_0.APIBase):
    ...
    @property
    def left_flank(self: "Self") -> "_2826.CylindricalMeshedGearFlankSystemDeflection":
    ...
    @property
    def right_flank(self: "Self") -> "_2826.CylindricalMeshedGearFlankSystemDeflection":
        """mastapy.system_model.analyses_and_results.system_deflections.CylindricalMeshedGearFlankSystemDeflection
    ...
    def flanks(
        self: "Self",
    ) -> "List[_2826.CylindricalMeshedGearFlankSystemDeflection]":
    ...
    @property
    def both_flanks(self: "Self") -> "_2826.CylindricalMeshedGearFlankSystemDeflection":
        """mastapy.system_model.analyses_and_results.system_deflections.CylindricalMeshedGearFlankSystemDeflection
