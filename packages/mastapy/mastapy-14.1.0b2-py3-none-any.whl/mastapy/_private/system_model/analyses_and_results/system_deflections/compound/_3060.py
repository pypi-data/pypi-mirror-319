...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class WormGearSetCompoundSystemDeflection(_2992.GearSetCompoundSystemDeflection):
    """WormGearSetCompoundSystemDeflection
    ...
    @property
    def worm_gear_set_rating(self: "Self") -> "_394.WormGearSetDutyCycleRating":
    ...
    def worm_gears_compound_system_deflection(
        self: "Self",
    ) -> "List[_3058.WormGearCompoundSystemDeflection]":
    ...
    def worm_meshes_compound_system_deflection(
        self: "Self",
    ) -> "List[_3059.WormGearMeshCompoundSystemDeflection]":
