...
from mastapy._private.system_model.analyses_and_results.system_deflections import _2786
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class SpiralBevelGearSystemDeflection(_2786.BevelGearSystemDeflection):
    """SpiralBevelGearSystemDeflection
    ...
    @property
    def component_detailed_analysis(self: "Self") -> "_422.SpiralBevelGearRating":
    ...
    @property
    def component_load_case(self: "Self") -> "_7646.SpiralBevelGearLoadCase":
    ...
    @property
    def power_flow_results(self: "Self") -> "_4237.SpiralBevelGearPowerFlow":
