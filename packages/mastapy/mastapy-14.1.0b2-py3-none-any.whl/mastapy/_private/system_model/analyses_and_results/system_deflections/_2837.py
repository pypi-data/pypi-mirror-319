...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class GearMeshSystemDeflection(_2845.InterMountableComponentConnectionSystemDeflection):
    """GearMeshSystemDeflection
    ...
    @property
    def gear_a(self: "Self") -> "_2839.GearSystemDeflection":
    ...
    @property
    def gear_b(self: "Self") -> "_2839.GearSystemDeflection":
        """mastapy.system_model.analyses_and_results.system_deflections.GearSystemDeflection
    ...
    @property
    def mesh_separations(self: "Self") -> "List[_2859.MeshSeparationsAtFaceWidth]":
    ...
    @property
    def power_flow_results(self: "Self") -> "_4191.GearMeshPowerFlow":
