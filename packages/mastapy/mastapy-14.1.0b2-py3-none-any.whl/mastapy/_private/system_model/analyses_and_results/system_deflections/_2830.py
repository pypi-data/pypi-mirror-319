...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ExternalCADModelSystemDeflection(_2793.ComponentSystemDeflection):
    """ExternalCADModelSystemDeflection
    ...
    @property
    def component_load_case(self: "Self") -> "_7574.ExternalCADModelLoadCase":
    ...
    @property
    def power_flow_results(self: "Self") -> "_4183.ExternalCADModelPowerFlow":
