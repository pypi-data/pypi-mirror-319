...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ShaftHubConnectionSystemDeflection(_2806.ConnectorSystemDeflection):
    """ShaftHubConnectionSystemDeflection
    ...
    @property
    def component_load_case(self: "Self") -> "_7642.ShaftHubConnectionLoadCase":
    ...
    @property
    def power_flow_results(self: "Self") -> "_4232.ShaftHubConnectionPowerFlow":
    ...
    @property
    def left_flank_contacts(self: "Self") -> "List[_2930.SplineFlankContactReporting]":
    ...
    def major_diameter_contacts(
        self: "Self",
    ) -> "List[_2930.SplineFlankContactReporting]":
        """List[mastapy.system_model.analyses_and_results.system_deflections.reporting.SplineFlankContactReporting]
    ...
    @property
    def right_flank_contacts(self: "Self") -> "List[_2930.SplineFlankContactReporting]":
        """List[mastapy.system_model.analyses_and_results.system_deflections.reporting.SplineFlankContactReporting]
