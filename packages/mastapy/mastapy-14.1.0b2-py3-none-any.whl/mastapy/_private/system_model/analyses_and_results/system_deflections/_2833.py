...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class FaceGearSetSystemDeflection(_2838.GearSetSystemDeflection):
    """FaceGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self: "Self") -> "_4186.FaceGearSetPowerFlow":
    ...
    @property
    def gears_system_deflection(self: "Self") -> "List[_2834.FaceGearSystemDeflection]":
    ...
    def face_gears_system_deflection(
        self: "Self",
    ) -> "List[_2834.FaceGearSystemDeflection]":
        """List[mastapy.system_model.analyses_and_results.system_deflections.FaceGearSystemDeflection]
