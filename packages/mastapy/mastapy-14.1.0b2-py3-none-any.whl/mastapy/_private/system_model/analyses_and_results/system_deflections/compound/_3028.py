...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.fe import _2477
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class RootAssemblyCompoundSystemDeflection(_2938.AssemblyCompoundSystemDeflection):
    """RootAssemblyCompoundSystemDeflection
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_2880.RootAssemblySystemDeflection]":
    ...
    @property
    def bearing_race_f_es(self: "Self") -> "List[_2477.RaceBearingFESystemDeflection]":
