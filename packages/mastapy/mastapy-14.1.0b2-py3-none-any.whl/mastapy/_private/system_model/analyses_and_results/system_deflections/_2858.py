...
from mastapy._private.system_model.analyses_and_results.system_deflections import _2915
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class MeasurementComponentSystemDeflection(_2915.VirtualComponentSystemDeflection):
    """MeasurementComponentSystemDeflection
    ...
    @property
    def component_load_case(self: "Self") -> "_7613.MeasurementComponentLoadCase":
    ...
    @property
    def power_flow_results(self: "Self") -> "_4209.MeasurementComponentPowerFlow":
