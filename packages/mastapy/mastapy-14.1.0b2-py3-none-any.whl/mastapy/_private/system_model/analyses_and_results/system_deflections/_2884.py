...
from mastapy._private.system_model.analyses_and_results.system_deflections import _2765
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ShaftSystemDeflection(_2765.AbstractShaftSystemDeflection):
    """ShaftSystemDeflection
    ...
    @property
    def power_flow_results(self: "Self") -> "_4233.ShaftPowerFlow":
    ...
    def shaft_section_end_with_worst_fatigue_safety_factor(
        self: "Self",
    ) -> "_2882.ShaftSectionEndResultsSystemDeflection":
    ...
    @property
    def mounted_components_applying_torque(self: "Self") -> "List[_1620.ForceResults]":
    ...
    def shaft_section_end_results_by_offset_with_worst_safety_factor(
        self: "Self",
    ) -> "List[_2882.ShaftSectionEndResultsSystemDeflection]":
    ...
    def shaft_section_results(
        self: "Self",
    ) -> "List[_2883.ShaftSectionSystemDeflection]":
