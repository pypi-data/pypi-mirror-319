...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CVTPulleySystemDeflection(_2873.PulleySystemDeflection):
    """CVTPulleySystemDeflection
    ...
    @property
    def power_flow_results(self: "Self") -> "_4172.CVTPulleyPowerFlow":
    ...
    @property
    def fixed_sheave_contact_results(self: "Self") -> "List[_1621.NodeResults]":
    ...
    @property
    def moving_sheave_contact_results(self: "Self") -> "List[_1621.NodeResults]":
        """List[mastapy.math_utility.measured_vectors.NodeResults]
