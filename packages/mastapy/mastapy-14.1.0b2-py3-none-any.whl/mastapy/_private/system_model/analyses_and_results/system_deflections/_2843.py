...
from mastapy._private.system_model.analyses_and_results.system_deflections import _2769
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class HypoidGearSystemDeflection(_2769.AGMAGleasonConicalGearSystemDeflection):
    """HypoidGearSystemDeflection
    ...
    @property
    def power_flow_results(self: "Self") -> "_4196.HypoidGearPowerFlow":
