...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ConceptCouplingSystemDeflection(_2809.CouplingSystemDeflection):
    """ConceptCouplingSystemDeflection
    ...
    @property
    def assembly_load_case(self: "Self") -> "_7531.ConceptCouplingLoadCase":
    ...
    @property
    def power_flow_results(self: "Self") -> "_4158.ConceptCouplingPowerFlow":
