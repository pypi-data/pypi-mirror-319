...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class TorqueConverterSystemDeflection(_2809.CouplingSystemDeflection):
    """TorqueConverterSystemDeflection
    ...
    @property
    def assembly_load_case(self: "Self") -> "_7667.TorqueConverterLoadCase":
    ...
    @property
    def power_flow_results(self: "Self") -> "_4256.TorqueConverterPowerFlow":
