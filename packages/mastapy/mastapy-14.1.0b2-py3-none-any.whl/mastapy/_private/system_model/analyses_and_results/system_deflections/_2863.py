...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="ObservedPinStiffnessReporter._Cast_ObservedPinStiffnessReporter",
    )
...
class _Cast_ObservedPinStiffnessReporter:
    ...
    __parent__: "ObservedPinStiffnessReporter"
...
class ObservedPinStiffnessReporter(_0.APIBase):
    ...
    TYPE: ClassVar["Type"] = _OBSERVED_PIN_STIFFNESS_REPORTER
    ...
    def pin_assembly_stiffness_observed_at_planets(self: "Self") -> "float":
        ...
        temp = pythonnet_property_get(
            self.wrapped, "PinAssemblyStiffnessObservedAtPlanets"
        )
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_ObservedPinStiffnessReporter":
        """Cast to another type.

        Returns:
            _Cast_ObservedPinStiffnessReporter
        """
        return _Cast_ObservedPinStiffnessReporter(self)
