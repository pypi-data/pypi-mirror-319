...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CylindricalGearMeshSystemDeflection(_2837.GearMeshSystemDeflection):
    """CylindricalGearMeshSystemDeflection
    ...
    @property
    def connection_design(self: "Self") -> "_2378.CylindricalGearMesh":
    ...
    @property
    def connection_load_case(self: "Self") -> "_7554.CylindricalGearMeshLoadCase":
    ...
    @property
    def gear_a(self: "Self") -> "_2823.CylindricalGearSystemDeflection":
    ...
    @property
    def gear_b(self: "Self") -> "_2823.CylindricalGearSystemDeflection":
        """mastapy.system_model.analyses_and_results.system_deflections.CylindricalGearSystemDeflection
    ...
    @property
    def power_flow_results(self: "Self") -> "_4178.CylindricalGearMeshPowerFlow":
    ...
    def cylindrical_meshed_gear_system_deflections(
        self: "Self",
    ) -> "List[_2827.CylindricalMeshedGearSystemDeflection]":
    ...
    def mesh_deflections_left_flank(
        self: "Self",
    ) -> "List[_2925.MeshDeflectionResults]":
    ...
    @property
    def gear_set(self: "Self") -> "_2820.CylindricalGearSetSystemDeflection":
