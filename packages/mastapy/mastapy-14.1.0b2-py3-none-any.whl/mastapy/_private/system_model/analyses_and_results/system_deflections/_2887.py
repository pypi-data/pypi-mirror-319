...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class SpiralBevelGearMeshSystemDeflection(_2784.BevelGearMeshSystemDeflection):
    """SpiralBevelGearMeshSystemDeflection
    ...
    @property
    def connection_load_case(self: "Self") -> "_7647.SpiralBevelGearMeshLoadCase":
    ...
    @property
    def power_flow_results(self: "Self") -> "_4236.SpiralBevelGearMeshPowerFlow":
