...
from mastapy._private.system_model.analyses_and_results.system_deflections import _2902
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class SynchroniserSleeveSystemDeflection(_2902.SynchroniserPartSystemDeflection):
    """SynchroniserSleeveSystemDeflection
    ...
    @property
    def power_flow_results(self: "Self") -> "_4253.SynchroniserSleevePowerFlow":
