...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class BoltCompoundModalAnalysis(_4861.ComponentCompoundModalAnalysis):
    """BoltCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self: "Self") -> "List[_4698.BoltModalAnalysis]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4698.BoltModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.BoltModalAnalysis]
