...
class ModalAnalysisBarModelFEExportOptions(_0.APIBase):
    ...
    @enforce_parameter_types
    def coordinate_system(self: "Self", value: "_2523.FEPart") -> None:
        wrapper_type = (
    ...
    @fe_package.setter
    @enforce_parameter_types
    def fe_package(self: "Self", value: "_180.FEExportFormat") -> None:
    ...
    @fe_part.setter
    @enforce_parameter_types
    def fe_part(self: "Self", value: "_2523.FEPart") -> None:
        wrapper_type = (
            list_with_selected_item.ListWithSelectedItem_FEPart.wrapper_type()
        )
        enclosed_type = (
    ...
    @length_unit.setter
    @enforce_parameter_types
    def length_unit(self: "Self", value: "_1671.Unit") -> None:
        wrapper_type = list_with_selected_item.ListWithSelectedItem_Unit.wrapper_type()
        enclosed_type = (
            list_with_selected_item.ListWithSelectedItem_Unit.implicit_type()
        )
    ...
    @property
    def mode_options(self: "Self") -> "_197.EigenvalueOptions":
