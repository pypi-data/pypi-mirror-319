...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class FaceGearCompoundModalAnalysis(_4894.GearCompoundModalAnalysis):
    """FaceGearCompoundModalAnalysis
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4736.FaceGearModalAnalysis]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4736.FaceGearModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.FaceGearModalAnalysis]
