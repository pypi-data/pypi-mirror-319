...
class _Cast_ShaftPerModeResult:
    ...
    @property
    def component_per_mode_result(self: "CastSelf") -> "_4826.ComponentPerModeResult":
        return self.__parent__._cast(_4826.ComponentPerModeResult)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ShaftPerModeResult(_4826.ComponentPerModeResult):
    """ShaftPerModeResult
