...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class FaceGearSetCompoundModalAnalysis(_4896.GearSetCompoundModalAnalysis):
    """FaceGearSetCompoundModalAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4737.FaceGearSetModalAnalysis]":
    ...
    def face_gears_compound_modal_analysis(
        self: "Self",
    ) -> "List[_4889.FaceGearCompoundModalAnalysis]":
    ...
    def face_meshes_compound_modal_analysis(
        self: "Self",
    ) -> "List[_4890.FaceGearMeshCompoundModalAnalysis]":
    ...
    @property
    def assembly_analysis_cases(self: "Self") -> "List[_4737.FaceGearSetModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.FaceGearSetModalAnalysis]
