...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class SpiralBevelGearSetCompoundModalAnalysis(_4854.BevelGearSetCompoundModalAnalysis):
    """SpiralBevelGearSetCompoundModalAnalysis
    ...
    def spiral_bevel_gears_compound_modal_analysis(
        self: "Self",
    ) -> "List[_4937.SpiralBevelGearCompoundModalAnalysis]":
    ...
    def spiral_bevel_meshes_compound_modal_analysis(
        self: "Self",
    ) -> "List[_4938.SpiralBevelGearMeshCompoundModalAnalysis]":
