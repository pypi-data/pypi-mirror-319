...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class PulleyCompoundModalAnalysis(_4875.CouplingHalfCompoundModalAnalysis):
    """PulleyCompoundModalAnalysis
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4779.PulleyModalAnalysis]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4779.PulleyModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.PulleyModalAnalysis]
