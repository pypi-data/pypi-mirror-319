...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class FaceGearSetModalAnalysis(_4743.GearSetModalAnalysis):
    """FaceGearSetModalAnalysis
    ...
    @property
    def system_deflection_results(self: "Self") -> "_2833.FaceGearSetSystemDeflection":
    ...
    @property
    def gears_modal_analysis(self: "Self") -> "List[_4736.FaceGearModalAnalysis]":
    ...
    @property
    def face_gears_modal_analysis(self: "Self") -> "List[_4736.FaceGearModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.FaceGearModalAnalysis]
    ...
    @property
    def meshes_modal_analysis(self: "Self") -> "List[_4735.FaceGearMeshModalAnalysis]":
    ...
    def face_meshes_modal_analysis(
        self: "Self",
    ) -> "List[_4735.FaceGearMeshModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.FaceGearMeshModalAnalysis]
