...
from mastapy._private.math_utility import _1554, _1586
...
if TYPE_CHECKING:
    ...
    from mastapy._private.math_utility import _1579, _1593
    from mastapy._private.math_utility.measured_data_scaling import _1628
    ...
    from mastapy._private.system_model.drawing.options import _2330, _2332
    from mastapy._private.utility.property import _1909
...
class WhineWaterfallSettings(_0.APIBase):
    ...
    @chart_type.setter
    @enforce_parameter_types
    def chart_type(self: "Self", value: "_4732.DynamicsResponse3DChartType") -> None:
    ...
    @enforce_parameter_types
    def complex_component(
        self: "Self", value: "_1554.ComplexPartDisplayOption"
    ) -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
    ...
    @property
    def connected_component_type(self: "Self") -> "_5972.ConnectedComponentType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.harmonic_analyses.results._5972",
    ...
    def connected_component_type(
        self: "Self", value: "_5972.ConnectedComponentType"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.HarmonicAnalyses.Results.ConnectedComponentType",
    ...
    @property
    def coordinate_system(self: "Self") -> "_4715.CoordinateSystemForWhine":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.modal_analyses._4715",
    ...
    def coordinate_system(
        self: "Self", value: "_4715.CoordinateSystemForWhine"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.ModalAnalyses.CoordinateSystemForWhine",
    ...
    @enforce_parameter_types
    def response_type(self: "Self", value: "_4733.DynamicsResponseType") -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
    ...
    def speed_range_for_combining_excitations(
        self: "Self",
    ) -> "_4767.MultipleExcitationsSpeedRangeOption":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.modal_analyses._4767",
    ...
    @enforce_parameter_types
    def speed_range_for_combining_excitations(
        self: "Self", value: "_4767.MultipleExcitationsSpeedRangeOption"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.ModalAnalyses.MultipleExcitationsSpeedRangeOption",
    ...
    @property
    def translation_or_rotation(self: "Self") -> "_1593.TranslationRotation":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.math_utility._1593", "TranslationRotation"
        )(value)

    @translation_or_rotation.setter
    @enforce_parameter_types
    def translation_or_rotation(
        self: "Self", value: "_1593.TranslationRotation"
    ) -> None:
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def vector_magnitude_method(self: "Self") -> "_1579.ComplexMagnitudeMethod":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.math_utility._1579", "ComplexMagnitudeMethod"
        )(value)

    @vector_magnitude_method.setter
    @enforce_parameter_types
    def vector_magnitude_method(
        self: "Self", value: "_1579.ComplexMagnitudeMethod"
    ) -> None:
        value = conversion.mp_to_pn_enum(
    ...
    def whine_waterfall_export_option(
        self: "Self",
    ) -> "_4816.WhineWaterfallExportOption":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.modal_analyses._4816",
    ...
    @enforce_parameter_types
    def whine_waterfall_export_option(
        self: "Self", value: "_4816.WhineWaterfallExportOption"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.ModalAnalyses.WhineWaterfallExportOption",
    ...
    @property
    def data_scaling(self: "Self") -> "_1628.DataScalingOptions":
    ...
    def frequency_options(
        self: "Self",
    ) -> "_5878.FrequencyOptionsForHarmonicAnalysisResults":
    ...
    def modal_contribution_view_options(
        self: "Self",
    ) -> "_2332.ModalContributionViewOptions":
    ...
    def mode_view_options(
        self: "Self",
    ) -> "_2330.AdvancedTimeSteppingAnalysisForModulationModeViewOptions":
    ...
    @property
    def order_cuts_chart_settings(self: "Self") -> "_4769.OrderCutsChartSettings":
    ...
    def reference_speed_options(
        self: "Self",
    ) -> "_5939.SpeedOptionsForHarmonicAnalysisResults":
    ...
    def result_location_selection_groups(
        self: "Self",
    ) -> "_5980.ResultLocationSelectionGroups":
    ...
    @property
    def selected_excitations(self: "Self") -> "_5975.ExcitationSourceSelectionGroup":
    ...
    @property
    def waterfall_chart_settings(self: "Self") -> "_4815.WaterfallChartSettings":
    ...
    @property
    def active_result_locations(self: "Self") -> "List[_5981.ResultNodeSelection]":
    ...
    def degrees_of_freedom(
        self: "Self",
    ) -> "List[_1909.EnumWithBoolean[_1586.ResultOptionsFor3DVector]]":
