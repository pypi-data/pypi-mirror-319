...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class PointLoadCompoundModalAnalysis(_4960.VirtualComponentCompoundModalAnalysis):
    """PointLoadCompoundModalAnalysis
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4777.PointLoadModalAnalysis]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4777.PointLoadModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.PointLoadModalAnalysis]
