...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CVTPulleyCompoundModalAnalysis(_4926.PulleyCompoundModalAnalysis):
    """CVTPulleyCompoundModalAnalysis
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4721.CVTPulleyModalAnalysis]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4721.CVTPulleyModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.CVTPulleyModalAnalysis]
