...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.analyses_and_results import _2727, _2735
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class DesignEntitySingleContextAnalysis(_2729.DesignEntityAnalysis):
    """DesignEntitySingleContextAnalysis
    ...
    @property
    def planetary_original(self: "Self") -> "_2729.DesignEntityAnalysis":
