...
from mastapy._private.system_model.analyses_and_results.stability_analyses import _3859
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ShaftStabilityAnalysis(_3859.AbstractShaftStabilityAnalysis):
    """ShaftStabilityAnalysis
    ...
    @property
    def critical_speeds(self: "Self") -> "List[_3897.CriticalSpeed]":
