...
from mastapy._private.system_model.analyses_and_results.stability_analyses import _3940
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class AbstractAssemblyStabilityAnalysis(_3940.PartStabilityAnalysis):
    """AbstractAssemblyStabilityAnalysis
