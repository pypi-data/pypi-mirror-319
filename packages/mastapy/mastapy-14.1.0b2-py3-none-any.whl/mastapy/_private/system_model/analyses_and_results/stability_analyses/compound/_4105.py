...
class StraightBevelGearSetCompoundStabilityAnalysis(
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_3973.StraightBevelGearSetStabilityAnalysis]":
    ...
    def straight_bevel_gears_compound_stability_analysis(
        self: "Self",
    ) -> "List[_4103.StraightBevelGearCompoundStabilityAnalysis]":
    ...
    def straight_bevel_meshes_compound_stability_analysis(
        self: "Self",
    ) -> "List[_4104.StraightBevelGearMeshCompoundStabilityAnalysis]":
