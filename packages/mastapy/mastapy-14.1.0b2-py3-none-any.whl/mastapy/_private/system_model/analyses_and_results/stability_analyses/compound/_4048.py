...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class FaceGearSetCompoundStabilityAnalysis(_4053.GearSetCompoundStabilityAnalysis):
    """FaceGearSetCompoundStabilityAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_3913.FaceGearSetStabilityAnalysis]":
    ...
    def face_gears_compound_stability_analysis(
        self: "Self",
    ) -> "List[_4046.FaceGearCompoundStabilityAnalysis]":
    ...
    def face_meshes_compound_stability_analysis(
        self: "Self",
    ) -> "List[_4047.FaceGearMeshCompoundStabilityAnalysis]":
