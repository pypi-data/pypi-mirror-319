...
class _Cast_AbstractAssemblyCompoundStabilityAnalysis:
    ...
    def assembly_compound_stability_analysis(
        self: "CastSelf",
    ) -> "_4000.AssemblyCompoundStabilityAnalysis":
        from mastapy._private.system_model.analyses_and_results.stability_analyses.compound import (
            _4000,
        )

        return self.__parent__._cast(_4000.AssemblyCompoundStabilityAnalysis)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class AbstractAssemblyCompoundStabilityAnalysis(_4074.PartCompoundStabilityAnalysis):
    """AbstractAssemblyCompoundStabilityAnalysis
    ...
    def assembly_analysis_cases(
        self: "Self",
    ) -> "List[_3857.AbstractAssemblyStabilityAnalysis]":
