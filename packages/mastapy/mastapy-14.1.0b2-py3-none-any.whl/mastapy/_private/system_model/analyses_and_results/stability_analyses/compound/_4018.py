...
class _Cast_ComponentCompoundStabilityAnalysis:
    ...
    def abstract_shaft_or_housing_compound_stability_analysis(
        self: "CastSelf",
    ) -> "_3995.AbstractShaftOrHousingCompoundStabilityAnalysis":
        from mastapy._private.system_model.analyses_and_results.stability_analyses.compound import (
            _3995,
        )
    ...
    def bolt_compound_stability_analysis(
        self: "CastSelf",
    ) -> "_4012.BoltCompoundStabilityAnalysis":
        from mastapy._private.system_model.analyses_and_results.stability_analyses.compound import (
            _4012,
        )

        return self.__parent__._cast(_4012.BoltCompoundStabilityAnalysis)
    ...
    def datum_compound_stability_analysis(
        self: "CastSelf",
    ) -> "_4044.DatumCompoundStabilityAnalysis":
        from mastapy._private.system_model.analyses_and_results.stability_analyses.compound import (
            _4044,
        )

        return self.__parent__._cast(_4044.DatumCompoundStabilityAnalysis)

    @property
    def external_cad_model_compound_stability_analysis(
        self: "CastSelf",
    ) -> "_4045.ExternalCADModelCompoundStabilityAnalysis":
        from mastapy._private.system_model.analyses_and_results.stability_analyses.compound import (
            _4045,
        )

        return self.__parent__._cast(_4045.ExternalCADModelCompoundStabilityAnalysis)
    ...
    def guide_dxf_model_compound_stability_analysis(
        self: "CastSelf",
    ) -> "_4054.GuideDxfModelCompoundStabilityAnalysis":
        from mastapy._private.system_model.analyses_and_results.stability_analyses.compound import (
            _4054,
        )

        return self.__parent__._cast(_4054.GuideDxfModelCompoundStabilityAnalysis)
    ...
    def microphone_compound_stability_analysis(
        self: "CastSelf",
    ) -> "_4071.MicrophoneCompoundStabilityAnalysis":
        from mastapy._private.system_model.analyses_and_results.stability_analyses.compound import (
            _4071,
        )

        return self.__parent__._cast(_4071.MicrophoneCompoundStabilityAnalysis)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ComponentCompoundStabilityAnalysis(_4074.PartCompoundStabilityAnalysis):
    """ComponentCompoundStabilityAnalysis
    ...
    def component_analysis_cases(
        self: "Self",
    ) -> "List[_3882.ComponentStabilityAnalysis]":
