...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class PartCompoundStabilityAnalysis(_7710.PartCompoundAnalysis):
    """PartCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_3940.PartStabilityAnalysis]":
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_3940.PartStabilityAnalysis]":
        """List[mastapy.system_model.analyses_and_results.stability_analyses.PartStabilityAnalysis]
