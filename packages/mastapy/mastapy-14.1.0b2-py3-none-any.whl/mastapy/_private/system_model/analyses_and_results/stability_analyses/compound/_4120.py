...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class WormGearSetCompoundStabilityAnalysis(_4053.GearSetCompoundStabilityAnalysis):
    """WormGearSetCompoundStabilityAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_3988.WormGearSetStabilityAnalysis]":
    ...
    def worm_gears_compound_stability_analysis(
        self: "Self",
    ) -> "List[_4118.WormGearCompoundStabilityAnalysis]":
    ...
    def worm_meshes_compound_stability_analysis(
        self: "Self",
    ) -> "List[_4119.WormGearMeshCompoundStabilityAnalysis]":
