...
from mastapy._private.system_model.analyses_and_results.stability_analyses import _3978
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class SynchroniserSleeveStabilityAnalysis(_3978.SynchroniserPartStabilityAnalysis):
    """SynchroniserSleeveStabilityAnalysis
