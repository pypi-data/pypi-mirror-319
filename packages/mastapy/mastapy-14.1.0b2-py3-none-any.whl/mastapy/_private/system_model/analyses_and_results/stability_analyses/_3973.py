...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class StraightBevelGearSetStabilityAnalysis(_3874.BevelGearSetStabilityAnalysis):
    """StraightBevelGearSetStabilityAnalysis
    ...
    def bevel_gears_stability_analysis(
        self: "Self",
    ) -> "List[_3974.StraightBevelGearStabilityAnalysis]":
    ...
    def bevel_meshes_stability_analysis(
        self: "Self",
    ) -> "List[_3972.StraightBevelGearMeshStabilityAnalysis]":
