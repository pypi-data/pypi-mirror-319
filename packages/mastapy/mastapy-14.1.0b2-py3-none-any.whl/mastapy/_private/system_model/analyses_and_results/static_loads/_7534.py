...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ConceptGearSetLoadCase(_7586.GearSetLoadCase):
    """ConceptGearSetLoadCase
    ...
    @property
    def gears_load_case(self: "Self") -> "List[_7532.ConceptGearLoadCase]":
    ...
    @property
    def concept_gears_load_case(self: "Self") -> "List[_7532.ConceptGearLoadCase]":
        """List[mastapy.system_model.analyses_and_results.static_loads.ConceptGearLoadCase]
    ...
    @property
    def meshes_load_case(self: "Self") -> "List[_7533.ConceptGearMeshLoadCase]":
    ...
    @property
    def concept_meshes_load_case(self: "Self") -> "List[_7533.ConceptGearMeshLoadCase]":
        """List[mastapy.system_model.analyses_and_results.static_loads.ConceptGearMeshLoadCase]
