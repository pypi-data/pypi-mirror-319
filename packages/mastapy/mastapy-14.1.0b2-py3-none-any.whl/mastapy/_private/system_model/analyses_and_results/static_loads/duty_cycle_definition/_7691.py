...
if TYPE_CHECKING:
    ...
    from mastapy._private.math_utility import _1551
...
class _Cast_PointLoadInputOptions:
    ...
    @property
    def column_input_options(self: "CastSelf") -> "_1914.ColumnInputOptions":
        return self.__parent__._cast(_1914.ColumnInputOptions)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class PointLoadInputOptions(_1914.ColumnInputOptions):
    """PointLoadInputOptions
    ...
    def axis(self: "Self") -> "_1551.Axis":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.math_utility._1551", "Axis"
        )(value)

    @axis.setter
    @enforce_parameter_types
    def axis(self: "Self", value: "_1551.Axis") -> None:
        value = conversion.mp_to_pn_enum(value, "SMT.MastaAPI.MathUtility.Axis")
        pythonnet_property_set(self.wrapped, "Axis", value)

    @property
    def conversion_to_load_case(self: "Self") -> "_7682.AdditionalForcesObtainedFrom":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.static_loads.duty_cycle_definition._7682",
    ...
    def conversion_to_load_case(
        self: "Self", value: "_7682.AdditionalForcesObtainedFrom"
    ) -> None:
    ...
    @point_load.setter
    @enforce_parameter_types
    def point_load(self: "Self", value: "_2543.PointLoad") -> None:
        wrapper_type = (
