...
from mastapy._private.system_model.analyses_and_results.static_loads import _7582
...
class _Cast_CylindricalGearManufactureError:
    ...
    @property
    def gear_manufacture_error(self: "CastSelf") -> "_7582.GearManufactureError":
        return self.__parent__._cast(_7582.GearManufactureError)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CylindricalGearManufactureError(_7582.GearManufactureError):
    """CylindricalGearManufactureError
    ...
    @property
    def pitch_errors_left_flank(self: "Self") -> "_1594.Vector2DListAccessor":
    ...
    @property
    def pitch_errors_right_flank(self: "Self") -> "_1594.Vector2DListAccessor":
        """mastapy.math_utility.Vector2DListAccessor"""
