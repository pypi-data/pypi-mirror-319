...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class BevelGearSetLoadCase(_7506.AGMAGleasonConicalGearSetLoadCase):
    """BevelGearSetLoadCase
    ...
    @property
    def bevel_gears_load_case(self: "Self") -> "List[_7518.BevelGearLoadCase]":
        """List[mastapy.system_model.analyses_and_results.static_loads.BevelGearLoadCase]
    ...
    def agma_gleason_conical_meshes_load_case(
        self: "Self",
    ) -> "List[_7519.BevelGearMeshLoadCase]":
    ...
    @property
    def bevel_meshes_load_case(self: "Self") -> "List[_7519.BevelGearMeshLoadCase]":
        """List[mastapy.system_model.analyses_and_results.static_loads.BevelGearMeshLoadCase]
