...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ZerolBevelGearSetLoadCase(_7520.BevelGearSetLoadCase):
    """ZerolBevelGearSetLoadCase
    ...
    @property
    def bevel_gears_load_case(self: "Self") -> "List[_7679.ZerolBevelGearLoadCase]":
    ...
    def zerol_bevel_gears_load_case(
        self: "Self",
    ) -> "List[_7679.ZerolBevelGearLoadCase]":
        """List[mastapy.system_model.analyses_and_results.static_loads.ZerolBevelGearLoadCase]
    ...
    def bevel_meshes_load_case(
        self: "Self",
    ) -> "List[_7680.ZerolBevelGearMeshLoadCase]":
