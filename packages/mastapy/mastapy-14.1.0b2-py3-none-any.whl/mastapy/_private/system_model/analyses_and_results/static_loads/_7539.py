...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ConicalGearSetLoadCase(_7586.GearSetLoadCase):
    """ConicalGearSetLoadCase
    ...
    @property
    def gears_load_case(self: "Self") -> "List[_7535.ConicalGearLoadCase]":
    ...
    @property
    def conical_gears_load_case(self: "Self") -> "List[_7535.ConicalGearLoadCase]":
        """List[mastapy.system_model.analyses_and_results.static_loads.ConicalGearLoadCase]
    ...
    @property
    def meshes_load_case(self: "Self") -> "List[_7537.ConicalGearMeshLoadCase]":
    ...
    @property
    def conical_meshes_load_case(self: "Self") -> "List[_7537.ConicalGearMeshLoadCase]":
        """List[mastapy.system_model.analyses_and_results.static_loads.ConicalGearMeshLoadCase]
