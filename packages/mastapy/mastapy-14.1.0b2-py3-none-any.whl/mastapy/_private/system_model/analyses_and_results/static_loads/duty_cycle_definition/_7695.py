...
class TimeSeriesImporter(_0.APIBase):
    ...
    @property
    def boost_pressure_chart(self: "Self") -> "_1934.TwoDChartDefinition":
    ...
    @enforce_parameter_types
    def destination_design_state_column(
        self: "Self", value: "_7685.DestinationDesignState"
    ) -> None:
    ...
    @property
    def force_chart(self: "Self") -> "_1934.TwoDChartDefinition":
        """mastapy.utility_gui.charts.TwoDChartDefinition
    ...
    @property
    def import_type(self: "Self") -> "_7599.ImportType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.static_loads._7599",
            "ImportType",
        )(value)

    @import_type.setter
    @enforce_parameter_types
    def import_type(self: "Self", value: "_7599.ImportType") -> None:
    ...
    @property
    def moment_chart(self: "Self") -> "_1934.TwoDChartDefinition":
        """mastapy.utility_gui.charts.TwoDChartDefinition
    ...
    @property
    def speed_chart(self: "Self") -> "_1934.TwoDChartDefinition":
        """mastapy.utility_gui.charts.TwoDChartDefinition
    ...
    @property
    def torque_chart(self: "Self") -> "_1934.TwoDChartDefinition":
        """mastapy.utility_gui.charts.TwoDChartDefinition
    ...
    @property
    def design_state_options(self: "Self") -> "_7684.DesignStateOptions":
    ...
    @property
    def gear_ratio_options(self: "Self") -> "_7687.GearRatioInputOptions":
    ...
    @property
    def load_case_name_inputs(self: "Self") -> "_7688.LoadCaseNameOptions":
    ...
    @property
    def time_step_input(self: "Self") -> "_7696.TimeStepInputOptions":
    ...
    def boost_pressure_inputs(
        self: "Self",
    ) -> "List[_7683.BoostPressureLoadCaseInputOptions]":
    ...
    @property
    def file_inputs(self: "Self") -> "List[_7690.MultiTimeSeriesDataInputFileOptions]":
    ...
    @property
    def force_inputs(self: "Self") -> "List[_7686.ForceInputOptions]":
    ...
    @property
    def moment_inputs(self: "Self") -> "List[_7689.MomentInputOptions]":
    ...
    @property
    def speed_inputs(self: "Self") -> "List[_7694.SpeedInputOptions]":
    ...
    @property
    def torque_inputs(self: "Self") -> "List[_7697.TorqueInputOptions]":
    ...
    @property
    def columns(self: "Self") -> "List[_1883.ColumnTitle]":
