...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="CMSElementFaceGroupWithSelectionOption._Cast_CMSElementFaceGroupWithSelectionOption",
    )
...
class _Cast_CMSElementFaceGroupWithSelectionOption:
    ...
    __parent__: "CMSElementFaceGroupWithSelectionOption"
...
class CMSElementFaceGroupWithSelectionOption(_0.APIBase):
    ...
    TYPE: ClassVar["Type"] = _CMS_ELEMENT_FACE_GROUP_WITH_SELECTION_OPTION
    ...
    def log_surface(self: "Self") -> "bool":
        """bool"""
        temp = pythonnet_property_get(self.wrapped, "LogSurface")
    ...
    def log_surface(self: "Self", value: "bool") -> None:
        pythonnet_property_set(
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_CMSElementFaceGroupWithSelectionOption":
        """Cast to another type.

        Returns:
            _Cast_CMSElementFaceGroupWithSelectionOption
        """
        return _Cast_CMSElementFaceGroupWithSelectionOption(self)
