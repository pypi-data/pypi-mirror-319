...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class HypoidGearSetLoadCase(_7506.AGMAGleasonConicalGearSetLoadCase):
    """HypoidGearSetLoadCase
    ...
    @property
    def hypoid_gears_load_case(self: "Self") -> "List[_7596.HypoidGearLoadCase]":
        """List[mastapy.system_model.analyses_and_results.static_loads.HypoidGearLoadCase]
    ...
    def agma_gleason_conical_meshes_load_case(
        self: "Self",
    ) -> "List[_7597.HypoidGearMeshLoadCase]":
    ...
    @property
    def hypoid_meshes_load_case(self: "Self") -> "List[_7597.HypoidGearMeshLoadCase]":
        """List[mastapy.system_model.analyses_and_results.static_loads.HypoidGearMeshLoadCase]
