...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class TimeSeriesLoadCase(_7495.LoadCase):
    """TimeSeriesLoadCase
    ...
    @property
    def driva_analysis_options(self: "Self") -> "_5580.MBDAnalysisOptions":
    ...
    @property
    def multibody_dynamics_analysis(self: "Self") -> "_5586.MultibodyDynamicsAnalysis":
    ...
    @property
    def time_series_load_case_group(self: "Self") -> "_5796.TimeSeriesLoadCaseGroup":
    ...
    def duplicate(
        self: "Self",
        new_load_case_group: "_5796.TimeSeriesLoadCaseGroup",
        name: "str" = "None",
    ) -> "TimeSeriesLoadCase":
