...
from mastapy._private.system_model.analyses_and_results.static_loads import _7585
...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears import _367
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ConicalGearSetHarmonicLoadData(_7585.GearSetHarmonicLoadData):
    """ConicalGearSetHarmonicLoadData
    ...
    @property
    def te_specification_type(self: "Self") -> "_367.TESpecificationType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears._367", "TESpecificationType"
        )(value)

    @te_specification_type.setter
    @enforce_parameter_types
    def te_specification_type(self: "Self", value: "_367.TESpecificationType") -> None:
