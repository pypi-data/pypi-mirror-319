...
from mastapy._private.system_model.analyses_and_results.static_loads import _7570, _7589
...
class _Cast_HarmonicLoadDataFluxImport:
    ...
    def harmonic_load_data_import_base(
        self: "CastSelf",
    ) -> "_7592.HarmonicLoadDataImportBase":
        from mastapy._private.system_model.analyses_and_results.static_loads import (
            _7592,
        )

        return self.__parent__._cast(_7592.HarmonicLoadDataImportBase)
...
class HarmonicLoadDataFluxImport(
    _7589.HarmonicLoadDataCSVImport[_7570.ElectricMachineHarmonicLoadFluxImportOptions]
):
    """HarmonicLoadDataFluxImport
    ...
    @property
    def inner_diameter_reference(self: "Self") -> "_7601.InnerDiameterReference":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.static_loads._7601",
    ...
    def inner_diameter_reference(
        self: "Self", value: "_7601.InnerDiameterReference"
    ) -> None:
