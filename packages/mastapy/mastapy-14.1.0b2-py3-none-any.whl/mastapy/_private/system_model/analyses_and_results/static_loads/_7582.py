...
class _Cast_GearManufactureError:
    ...
    def conical_gear_manufacture_error(
        self: "CastSelf",
    ) -> "_7536.ConicalGearManufactureError":
        from mastapy._private.system_model.analyses_and_results.static_loads import (
            _7536,
        )

        return self.__parent__._cast(_7536.ConicalGearManufactureError)
    ...
    def cylindrical_gear_manufacture_error(
        ...
        return self.__parent__._cast(_7553.CylindricalGearManufactureError)
