...
from mastapy._private.system_model.analyses_and_results.static_loads import _7562
...
T = TypeVar("T", bound="_7571.ElectricMachineHarmonicLoadImportOptionsBase")
...
class ElectricMachineHarmonicLoadDataFromMotorPackages(
    _7562.ElectricMachineHarmonicLoadData, Generic[T]
):
    """ElectricMachineHarmonicLoadDataFromMotorPackages
