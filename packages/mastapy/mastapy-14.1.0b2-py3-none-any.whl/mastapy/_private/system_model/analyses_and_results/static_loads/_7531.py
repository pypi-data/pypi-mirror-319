...
from mastapy._private.system_model.analyses_and_results.static_loads import _7544
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ConceptCouplingLoadCase(_7544.CouplingLoadCase):
    """ConceptCouplingLoadCase
    ...
    @enforce_parameter_types
    def power_load_for_reference_speed(self: "Self", value: "_2544.PowerLoad") -> None:
        wrapper_type = (
    ...
    def speed_ratio_specification_method(
        self: "Self",
    ) -> "_2271.ConceptCouplingSpeedRatioSpecificationMethod":
    ...
    @enforce_parameter_types
    def speed_ratio_specification_method(
        self: "Self", value: "_2271.ConceptCouplingSpeedRatioSpecificationMethod"
    ) -> None:
    ...
    @property
    def speed_ratio_vs_time(self: "Self") -> "_1594.Vector2DListAccessor":
    ...
    @property
    def speed_ratio_pid_control(self: "Self") -> "_1636.PIDControlSettings":
