...
class ZerolBevelGearSetCompoundAdvancedTimeSteppingAnalysisForModulation(
    ...
    @property
    def component_design(self: "Self") -> "_2629.ZerolBevelGearSet":
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_7082.ZerolBevelGearSetAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def zerol_bevel_gears_compound_advanced_time_stepping_analysis_for_modulation(
        self: "Self",
    ) -> "List[_7211.ZerolBevelGearCompoundAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def zerol_bevel_meshes_compound_advanced_time_stepping_analysis_for_modulation(
        self: "Self",
    ) -> "List[_7212.ZerolBevelGearMeshCompoundAdvancedTimeSteppingAnalysisForModulation]":
