...
class _Cast_HarmonicAnalysisOptionsForAdvancedTimeSteppingAnalysisForModulation:
    ...
    @property
    def harmonic_analysis_options(self: "CastSelf") -> "_5892.HarmonicAnalysisOptions":
        return self.__parent__._cast(_5892.HarmonicAnalysisOptions)
