...
class StraightBevelDiffGearSetCompoundAdvancedTimeSteppingAnalysisForModulation(
    ...
    def assembly_analysis_cases_ready(
        ...
        "List[_7061.StraightBevelDiffGearSetAdvancedTimeSteppingAnalysisForModulation]"
    ):
    ...
    def straight_bevel_diff_gears_compound_advanced_time_stepping_analysis_for_modulation(
        self: "Self",
    ) -> "List[_7190.StraightBevelDiffGearCompoundAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def straight_bevel_diff_meshes_compound_advanced_time_stepping_analysis_for_modulation(
        self: "Self",
    ) -> "List[_7191.StraightBevelDiffGearMeshCompoundAdvancedTimeSteppingAnalysisForModulation]":
