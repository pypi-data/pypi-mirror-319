...
class StraightBevelGearSetCompoundAdvancedTimeSteppingAnalysisForModulation(
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_7064.StraightBevelGearSetAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def straight_bevel_gears_compound_advanced_time_stepping_analysis_for_modulation(
        ...
        "List[_7193.StraightBevelGearCompoundAdvancedTimeSteppingAnalysisForModulation]"
    ):
    ...
    def straight_bevel_meshes_compound_advanced_time_stepping_analysis_for_modulation(
        self: "Self",
    ) -> "List[_7194.StraightBevelGearMeshCompoundAdvancedTimeSteppingAnalysisForModulation]":
