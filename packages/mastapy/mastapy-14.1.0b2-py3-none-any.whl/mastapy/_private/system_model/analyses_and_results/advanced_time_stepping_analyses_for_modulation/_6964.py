...
class BevelDifferentialGearSetAdvancedTimeSteppingAnalysisForModulation(
    ...
    def bevel_gears_advanced_time_stepping_analysis_for_modulation(
        self: "Self",
    ) -> "List[_6962.BevelDifferentialGearAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def bevel_meshes_advanced_time_stepping_analysis_for_modulation(
        ...
        "List[_6963.BevelDifferentialGearMeshAdvancedTimeSteppingAnalysisForModulation]"
    ):
