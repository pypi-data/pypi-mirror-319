...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CylindricalGearAdvancedSystemDeflection(_7277.GearAdvancedSystemDeflection):
    """CylindricalGearAdvancedSystemDeflection
    ...
    def cylindrical_gear_advanced_system_deflection_meshes(
        self: "Self",
    ) -> "List[_7266.CylindricalGearMeshAdvancedSystemDeflection]":
    ...
    def cylindrical_gear_advanced_system_deflections_in_meshes(
        self: "Self",
    ) -> "List[_7268.CylindricalMeshedGearAdvancedSystemDeflection]":
