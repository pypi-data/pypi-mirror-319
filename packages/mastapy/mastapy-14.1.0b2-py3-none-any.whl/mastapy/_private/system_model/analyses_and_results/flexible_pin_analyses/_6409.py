...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class FlexiblePinAnalysisStopStartAnalysis(_6403.FlexiblePinAnalysis):
    """FlexiblePinAnalysisStopStartAnalysis
    ...
    @property
    def shaft_extreme_load_case(self: "Self") -> "_2884.ShaftSystemDeflection":
    ...
    @property
    def shaft_nominal_load_case(self: "Self") -> "_2884.ShaftSystemDeflection":
        """mastapy.system_model.analyses_and_results.system_deflections.ShaftSystemDeflection
