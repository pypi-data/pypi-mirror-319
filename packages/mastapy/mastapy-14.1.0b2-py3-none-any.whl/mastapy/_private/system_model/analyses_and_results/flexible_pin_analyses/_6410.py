...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class WindTurbineCertificationReport(_6402.CombinationAnalysis):
    """WindTurbineCertificationReport
    ...
    def extreme_load_case(self: "Self", value: "_7496.StaticLoadCase") -> None:
        wrapper_type = (
    ...
    @ldd.setter
    @enforce_parameter_types
    def ldd(self: "Self", value: "_5789.DutyCycle") -> None:
        wrapper_type = (
    ...
    @enforce_parameter_types
    def nominal_load_case(self: "Self", value: "_7496.StaticLoadCase") -> None:
        wrapper_type = (
            list_with_selected_item.ListWithSelectedItem_StaticLoadCase.wrapper_type()
        )
        enclosed_type = (
    ...
    @property
    def design(self: "Self") -> "_2547.RootAssembly":
