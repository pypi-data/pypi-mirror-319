...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class GearSetCompoundDynamicAnalysis(_6644.SpecialisedAssemblyCompoundDynamicAnalysis):
    """GearSetCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases(self: "Self") -> "List[_6473.GearSetDynamicAnalysis]":
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_6473.GearSetDynamicAnalysis]":
        """List[mastapy.system_model.analyses_and_results.dynamic_analyses.GearSetDynamicAnalysis]
