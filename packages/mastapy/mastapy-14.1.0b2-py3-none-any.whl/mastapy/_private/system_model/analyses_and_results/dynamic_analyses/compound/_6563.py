...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class BoltCompoundDynamicAnalysis(_6569.ComponentCompoundDynamicAnalysis):
    """BoltCompoundDynamicAnalysis
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_6430.BoltDynamicAnalysis]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_6430.BoltDynamicAnalysis]":
        """List[mastapy.system_model.analyses_and_results.dynamic_analyses.BoltDynamicAnalysis]
