...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class WormGearSetDynamicAnalysis(_6473.GearSetDynamicAnalysis):
    """WormGearSetDynamicAnalysis
    ...
    @property
    def gears_dynamic_analysis(self: "Self") -> "List[_6538.WormGearDynamicAnalysis]":
    ...
    def worm_gears_dynamic_analysis(
        self: "Self",
    ) -> "List[_6538.WormGearDynamicAnalysis]":
        """List[mastapy.system_model.analyses_and_results.dynamic_analyses.WormGearDynamicAnalysis]
    ...
    def meshes_dynamic_analysis(
        self: "Self",
    ) -> "List[_6539.WormGearMeshDynamicAnalysis]":
