...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class BearingCompoundDynamicAnalysis(_6580.ConnectorCompoundDynamicAnalysis):
    """BearingCompoundDynamicAnalysis
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_6419.BearingDynamicAnalysis]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_6419.BearingDynamicAnalysis]":
        """List[mastapy.system_model.analyses_and_results.dynamic_analyses.BearingDynamicAnalysis]
