...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class BevelGearSetDynamicAnalysis(_6417.AGMAGleasonConicalGearSetDynamicAnalysis):
    """BevelGearSetDynamicAnalysis
    ...
    def agma_gleason_conical_gears_dynamic_analysis(
        self: "Self",
    ) -> "List[_6427.BevelGearDynamicAnalysis]":
    ...
    def agma_gleason_conical_meshes_dynamic_analysis(
        self: "Self",
    ) -> "List[_6428.BevelGearMeshDynamicAnalysis]":
