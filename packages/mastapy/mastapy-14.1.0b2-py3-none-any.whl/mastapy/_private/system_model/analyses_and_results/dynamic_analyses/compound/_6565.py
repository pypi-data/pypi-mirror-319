...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ClutchCompoundDynamicAnalysis(_6581.CouplingCompoundDynamicAnalysis):
    """ClutchCompoundDynamicAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_6433.ClutchDynamicAnalysis]":
    ...
    @property
    def assembly_analysis_cases(self: "Self") -> "List[_6433.ClutchDynamicAnalysis]":
        """List[mastapy.system_model.analyses_and_results.dynamic_analyses.ClutchDynamicAnalysis]
