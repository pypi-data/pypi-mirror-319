...
from mastapy._private.system_model.analyses_and_results.dynamic_analyses import _6412
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CycloidalDiscDynamicAnalysis(_6412.AbstractShaftDynamicAnalysis):
    """CycloidalDiscDynamicAnalysis
