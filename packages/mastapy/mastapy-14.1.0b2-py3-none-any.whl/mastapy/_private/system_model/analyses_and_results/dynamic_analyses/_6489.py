...
from mastapy._private.system_model.analyses_and_results.dynamic_analyses import _6537
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class MeasurementComponentDynamicAnalysis(_6537.VirtualComponentDynamicAnalysis):
    """MeasurementComponentDynamicAnalysis
