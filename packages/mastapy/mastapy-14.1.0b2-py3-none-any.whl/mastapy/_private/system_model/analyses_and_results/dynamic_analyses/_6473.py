...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class GearSetDynamicAnalysis(_6513.SpecialisedAssemblyDynamicAnalysis):
    """GearSetDynamicAnalysis
    ...
    @property
    def gears_dynamic_analysis(self: "Self") -> "List[_6471.GearDynamicAnalysis]":
    ...
    @property
    def meshes_dynamic_analysis(self: "Self") -> "List[_6472.GearMeshDynamicAnalysis]":
