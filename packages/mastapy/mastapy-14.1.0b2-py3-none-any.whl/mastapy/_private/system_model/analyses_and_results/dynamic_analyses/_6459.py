...
from mastapy._private.system_model.analyses_and_results.dynamic_analyses import _6472
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CylindricalGearMeshDynamicAnalysis(_6472.GearMeshDynamicAnalysis):
    """CylindricalGearMeshDynamicAnalysis
