...
from mastapy._private.system_model.analyses_and_results.acoustic_analyses import _7492
...
class _Cast_SingleHarmonicExcitationAnalysisDetail:
    ...
    @property
    def single_excitation_details(self: "CastSelf") -> "_7492.SingleExcitationDetails":
        return self.__parent__._cast(_7492.SingleExcitationDetails)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class SingleHarmonicExcitationAnalysisDetail(_7492.SingleExcitationDetails):
    """SingleHarmonicExcitationAnalysisDetail
