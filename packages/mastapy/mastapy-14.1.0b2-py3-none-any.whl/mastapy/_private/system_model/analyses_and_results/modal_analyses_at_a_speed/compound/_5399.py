...
class _Cast_ConnectorCompoundModalAnalysisAtASpeed:
    ...
    def bearing_compound_modal_analysis_at_a_speed(
        self: "CastSelf",
    ) -> "_5371.BearingCompoundModalAnalysisAtASpeed":
        from mastapy._private.system_model.analyses_and_results.modal_analyses_at_a_speed.compound import (
            _5371,
        )

        return self.__parent__._cast(_5371.BearingCompoundModalAnalysisAtASpeed)

    @property
    def oil_seal_compound_modal_analysis_at_a_speed(
        self: "CastSelf",
    ) -> "_5443.OilSealCompoundModalAnalysisAtASpeed":
        from mastapy._private.system_model.analyses_and_results.modal_analyses_at_a_speed.compound import (
            _5443,
        )

        return self.__parent__._cast(_5443.OilSealCompoundModalAnalysisAtASpeed)

    @property
    def shaft_hub_connection_compound_modal_analysis_at_a_speed(
        self: "CastSelf",
    ) -> "_5461.ShaftHubConnectionCompoundModalAnalysisAtASpeed":
        from mastapy._private.system_model.analyses_and_results.modal_analyses_at_a_speed.compound import (
            _5461,
        )
...
class ConnectorCompoundModalAnalysisAtASpeed(
    ...
    def component_analysis_cases(
        self: "Self",
    ) -> "List[_5267.ConnectorModalAnalysisAtASpeed]":
