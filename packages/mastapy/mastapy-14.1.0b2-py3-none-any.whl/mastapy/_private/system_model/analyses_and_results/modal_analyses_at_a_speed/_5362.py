...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ZerolBevelGearSetModalAnalysisAtASpeed(_5249.BevelGearSetModalAnalysisAtASpeed):
    """ZerolBevelGearSetModalAnalysisAtASpeed
    ...
    def bevel_gears_modal_analysis_at_a_speed(
        self: "Self",
    ) -> "List[_5361.ZerolBevelGearModalAnalysisAtASpeed]":
    ...
    def bevel_meshes_modal_analysis_at_a_speed(
        self: "Self",
    ) -> "List[_5360.ZerolBevelGearMeshModalAnalysisAtASpeed]":
