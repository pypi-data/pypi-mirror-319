...
class _Cast_HarmonicAnalysisFEExportOptions:
    ...
    def harmonic_analysis_export_options(
        self: "CastSelf",
    ) -> "_5889.HarmonicAnalysisExportOptions":
        return self.__parent__._cast(_5889.HarmonicAnalysisExportOptions)
...
class HarmonicAnalysisFEExportOptions(
    _5889.HarmonicAnalysisExportOptions[
        _2732.IHaveFEPartHarmonicAnalysisResults, _2523.FEPart
    ]
):
    """HarmonicAnalysisFEExportOptions
    ...
    @enforce_parameter_types
    def distance_unit(self: "Self", value: "_1671.Unit") -> None:
    ...
    @force_unit.setter
    @enforce_parameter_types
    def force_unit(self: "Self", value: "_1671.Unit") -> None:
        wrapper_type = list_with_selected_item.ListWithSelectedItem_Unit.wrapper_type()
        enclosed_type = (
            list_with_selected_item.ListWithSelectedItem_Unit.implicit_type()
        )
