...
class _Cast_ResultsForMultipleOrdersForFESurface:
    ...
    def results_for_multiple_orders(
        self: "CastSelf",
    ) -> "_5994.ResultsForMultipleOrders":
        return self.__parent__._cast(_5994.ResultsForMultipleOrders)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ResultsForMultipleOrdersForFESurface(_5994.ResultsForMultipleOrders):
    """ResultsForMultipleOrdersForFESurface
