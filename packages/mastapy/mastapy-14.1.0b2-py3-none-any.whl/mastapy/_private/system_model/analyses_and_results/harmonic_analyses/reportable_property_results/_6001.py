...
class ResultsForResponseOfAComponentOrSurfaceInAHarmonic(_0.APIBase):
    ...
    def magnitude(
        self: "Self",
    ) -> "_6003.ResultsForSingleDegreeOfFreedomOfResponseOfNodeInHarmonic":
    ...
    def result_at_reference_speed(
        self: "Self",
    ) -> "_5983.DataPointForResponseOfAComponentOrSurfaceAtAFrequencyToAHarmonic":
    ...
    def data_points(
        self: "Self",
    ) -> "List[_5983.DataPointForResponseOfAComponentOrSurfaceAtAFrequencyToAHarmonic]":
