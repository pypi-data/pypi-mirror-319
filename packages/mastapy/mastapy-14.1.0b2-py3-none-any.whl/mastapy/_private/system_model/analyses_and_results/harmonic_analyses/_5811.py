...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class AssemblyHarmonicAnalysis(_5803.AbstractAssemblyHarmonicAnalysis):
    """AssemblyHarmonicAnalysis
    ...
    @property
    def coupled_modal_analysis(self: "Self") -> "_4685.AssemblyModalAnalysis":
    ...
    @property
    def system_deflection_results(self: "Self") -> "_2770.AssemblySystemDeflection":
    ...
    @property
    def bearings(self: "Self") -> "List[_5812.BearingHarmonicAnalysis]":
    ...
    @property
    def belt_drives(self: "Self") -> "List[_5814.BeltDriveHarmonicAnalysis]":
    ...
    @property
    def bolted_joints(self: "Self") -> "List[_5823.BoltedJointHarmonicAnalysis]":
    ...
    @property
    def bolts(self: "Self") -> "List[_5824.BoltHarmonicAnalysis]":
    ...
    @property
    def cv_ts(self: "Self") -> "List[_5846.CVTHarmonicAnalysis]":
    ...
    @property
    def clutches(self: "Self") -> "List[_5827.ClutchHarmonicAnalysis]":
    ...
    def concept_couplings(
        self: "Self",
    ) -> "List[_5833.ConceptCouplingHarmonicAnalysis]":
    ...
    @property
    def concept_gear_sets(self: "Self") -> "List[_5836.ConceptGearSetHarmonicAnalysis]":
    ...
    def cycloidal_assemblies(
        self: "Self",
    ) -> "List[_5848.CycloidalAssemblyHarmonicAnalysis]":
    ...
    @property
    def cycloidal_discs(self: "Self") -> "List[_5850.CycloidalDiscHarmonicAnalysis]":
    ...
    def cylindrical_gear_sets(
        self: "Self",
    ) -> "List[_5854.CylindricalGearSetHarmonicAnalysis]":
    ...
    @property
    def fe_parts(self: "Self") -> "List[_5876.FEPartHarmonicAnalysis]":
    ...
    @property
    def face_gear_sets(self: "Self") -> "List[_5875.FaceGearSetHarmonicAnalysis]":
    ...
    @property
    def hypoid_gear_sets(self: "Self") -> "List[_5899.HypoidGearSetHarmonicAnalysis]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(
        self: "Self",
    ) -> "List[_5906.KlingelnbergCycloPalloidHypoidGearSetHarmonicAnalysis]":
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(
        self: "Self",
    ) -> "List[_5909.KlingelnbergCycloPalloidSpiralBevelGearSetHarmonicAnalysis]":
    ...
    @property
    def loaded_gear_sets(self: "Self") -> "List[_5884.GearSetHarmonicAnalysis]":
    ...
    @property
    def mass_discs(self: "Self") -> "List[_5910.MassDiscHarmonicAnalysis]":
    ...
    @property
    def microphones(self: "Self") -> "List[_5913.MicrophoneHarmonicAnalysis]":
    ...
    @property
    def oil_seals(self: "Self") -> "List[_5915.OilSealHarmonicAnalysis]":
    ...
    def part_to_part_shear_couplings(
        self: "Self",
    ) -> "List[_5919.PartToPartShearCouplingHarmonicAnalysis]":
    ...
    @property
    def planet_carriers(self: "Self") -> "List[_5923.PlanetCarrierHarmonicAnalysis]":
    ...
    @property
    def point_loads(self: "Self") -> "List[_5924.PointLoadHarmonicAnalysis]":
    ...
    @property
    def power_loads(self: "Self") -> "List[_5925.PowerLoadHarmonicAnalysis]":
    ...
    @property
    def ring_pins(self: "Self") -> "List[_5928.RingPinsHarmonicAnalysis]":
    ...
    def rolling_ring_assemblies(
        self: "Self",
    ) -> "List[_5930.RollingRingAssemblyHarmonicAnalysis]":
    ...
    def shaft_hub_connections(
        self: "Self",
    ) -> "List[_5935.ShaftHubConnectionHarmonicAnalysis]":
    ...
    @property
    def shafts(self: "Self") -> "List[_5934.ShaftHarmonicAnalysis]":
    ...
    def spiral_bevel_gear_sets(
        self: "Self",
    ) -> "List[_5942.SpiralBevelGearSetHarmonicAnalysis]":
    ...
    @property
    def spring_dampers(self: "Self") -> "List[_5945.SpringDamperHarmonicAnalysis]":
    ...
    def straight_bevel_diff_gear_sets(
        self: "Self",
    ) -> "List[_5949.StraightBevelDiffGearSetHarmonicAnalysis]":
    ...
    def straight_bevel_gear_sets(
        self: "Self",
    ) -> "List[_5952.StraightBevelGearSetHarmonicAnalysis]":
    ...
    @property
    def synchronisers(self: "Self") -> "List[_5956.SynchroniserHarmonicAnalysis]":
    ...
    def torque_converters(
        self: "Self",
    ) -> "List[_5960.TorqueConverterHarmonicAnalysis]":
    ...
    @property
    def unbalanced_masses(self: "Self") -> "List[_5964.UnbalancedMassHarmonicAnalysis]":
    ...
    @property
    def worm_gear_sets(self: "Self") -> "List[_5968.WormGearSetHarmonicAnalysis]":
    ...
    def zerol_bevel_gear_sets(
        self: "Self",
    ) -> "List[_5971.ZerolBevelGearSetHarmonicAnalysis]":
