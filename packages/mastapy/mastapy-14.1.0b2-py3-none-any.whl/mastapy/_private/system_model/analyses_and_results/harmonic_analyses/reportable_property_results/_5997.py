...
class _Cast_ResultsForOrder:
    ...
    def results_for_order_including_groups(
        self: "CastSelf",
    ) -> "_5998.ResultsForOrderIncludingGroups":
        from mastapy._private.system_model.analyses_and_results.harmonic_analyses.reportable_property_results import (
            _5998,
        )

        return self.__parent__._cast(_5998.ResultsForOrderIncludingGroups)

    @property
    def results_for_order_including_nodes(
        self: "CastSelf",
    ) -> "_5999.ResultsForOrderIncludingNodes":
        from mastapy._private.system_model.analyses_and_results.harmonic_analyses.reportable_property_results import (
            _5999,
        )

        return self.__parent__._cast(_5999.ResultsForOrderIncludingNodes)

    @property
    def results_for_order_including_surfaces(
        self: "CastSelf",
    ) -> "_6000.ResultsForOrderIncludingSurfaces":
        from mastapy._private.system_model.analyses_and_results.harmonic_analyses.reportable_property_results import (
            _6000,
        )

        return self.__parent__._cast(_6000.ResultsForOrderIncludingSurfaces)
...
class ResultsForOrder(_0.APIBase):
    ...
    def component(
        self: "Self",
    ) -> "_5988.HarmonicAnalysisResultsBrokenDownByComponentWithinAHarmonic":
