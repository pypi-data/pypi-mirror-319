...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.analyses_and_results.static_loads import _7521
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class BoltedJointHarmonicAnalysis(_5938.SpecialisedAssemblyHarmonicAnalysis):
    """BoltedJointHarmonicAnalysis
    ...
    @property
    def assembly_load_case(self: "Self") -> "_7521.BoltedJointLoadCase":
    ...
    @property
    def system_deflection_results(self: "Self") -> "_2787.BoltedJointSystemDeflection":
