...
class StiffnessOptionsForHarmonicAnalysis(
    _7700.AbstractAnalysisOptions[_7496.StaticLoadCase]
):
    """StiffnessOptionsForHarmonicAnalysis
    ...
    @property
    def curve_with_stiffness_steps(self: "Self") -> "_1934.TwoDChartDefinition":
    ...
    @enforce_parameter_types
    def torque_input_type(
        self: "Self", value: "_5895.HarmonicAnalysisTorqueInputType"
    ) -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
    ...
    @property
    def torque_speed_curve(self: "Self") -> "_1594.Vector2DListAccessor":
    ...
    @enforce_parameter_types
    def torque_speed_curve(self: "Self", value: "_1594.Vector2DListAccessor") -> None:
