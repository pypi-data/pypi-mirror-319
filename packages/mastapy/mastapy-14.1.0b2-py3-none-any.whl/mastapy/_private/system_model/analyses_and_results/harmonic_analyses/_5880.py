...
class _Cast_GearMeshExcitationDetail:
    ...
    def gear_mesh_misalignment_excitation_detail(
        self: "CastSelf",
    ) -> "_5882.GearMeshMisalignmentExcitationDetail":
        from mastapy._private.system_model.analyses_and_results.harmonic_analyses import (
            _5882,
        )

        return self.__parent__._cast(_5882.GearMeshMisalignmentExcitationDetail)

    @property
    def gear_mesh_te_excitation_detail(
        self: "CastSelf",
    ) -> "_5883.GearMeshTEExcitationDetail":
        from mastapy._private.system_model.analyses_and_results.harmonic_analyses import (
            _5883,
        )

        return self.__parent__._cast(_5883.GearMeshTEExcitationDetail)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class GearMeshExcitationDetail(_5804.AbstractPeriodicExcitationDetail):
    """GearMeshExcitationDetail
    ...
    @property
    def uncoupled_modal_analysis(self: "Self") -> "_4762.ModalAnalysis":
    ...
    @property
    def gear_mesh(self: "Self") -> "_2837.GearMeshSystemDeflection":
    ...
    def get_compliance_and_force_data(self: "Self") -> "_5829.ComplianceAndForceData":
