...
class _Cast_ShaftToMountableComponentConnectionCompoundHarmonicAnalysis:
    ...
    def cycloidal_disc_central_bearing_connection_compound_harmonic_analysis(
        self: "CastSelf",
    ) -> "_6051.CycloidalDiscCentralBearingConnectionCompoundHarmonicAnalysis":
        from mastapy._private.system_model.analyses_and_results.harmonic_analyses.compound import (
            _6051,
        )
    ...
    def planetary_connection_compound_harmonic_analysis(
        self: "CastSelf",
    ) -> "_6092.PlanetaryConnectionCompoundHarmonicAnalysis":
        from mastapy._private.system_model.analyses_and_results.harmonic_analyses.compound import (
            _6092,
        )

        return self.__parent__._cast(_6092.PlanetaryConnectionCompoundHarmonicAnalysis)
...
class ShaftToMountableComponentConnectionCompoundHarmonicAnalysis(
    ...
    def connection_analysis_cases(
        self: "Self",
    ) -> "List[_5936.ShaftToMountableComponentConnectionHarmonicAnalysis]":
