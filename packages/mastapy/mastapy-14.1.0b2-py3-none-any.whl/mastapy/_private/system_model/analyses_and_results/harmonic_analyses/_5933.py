...
class RootAssemblyHarmonicAnalysis(
    _5811.AssemblyHarmonicAnalysis, _2733.IHaveRootHarmonicAnalysisResults
):
    """RootAssemblyHarmonicAnalysis
    ...
    @property
    def export(self: "Self") -> "_5893.HarmonicAnalysisRootAssemblyExportOptions":
    ...
    @property
    def harmonic_analysis_inputs(self: "Self") -> "_5887.HarmonicAnalysis":
    ...
    def results(
        self: "Self",
    ) -> "_6004.RootAssemblyHarmonicAnalysisResultsPropertyAccessor":
    ...
    @property
    def system_deflection_results(self: "Self") -> "_2880.RootAssemblySystemDeflection":
