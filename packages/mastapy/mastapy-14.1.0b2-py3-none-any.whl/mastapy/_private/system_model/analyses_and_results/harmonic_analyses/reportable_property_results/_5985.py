...
class _Cast_FEPartHarmonicAnalysisResultsPropertyAccessor:
    ...
    def harmonic_analysis_results_property_accessor(
        self: "CastSelf",
    ) -> "_5993.HarmonicAnalysisResultsPropertyAccessor":
        return self.__parent__._cast(_5993.HarmonicAnalysisResultsPropertyAccessor)
...
class FEPartHarmonicAnalysisResultsPropertyAccessor(
    ...
    @property
    def combined_orders(self: "Self") -> "_5995.ResultsForMultipleOrdersForFESurface":
    ...
    def excitations(
        self: "Self",
    ) -> "List[_5986.FEPartSingleWhineAnalysisResultsPropertyAccessor]":
    ...
    def orders_for_combined_excitations(
        self: "Self",
    ) -> "List[_6000.ResultsForOrderIncludingSurfaces]":
