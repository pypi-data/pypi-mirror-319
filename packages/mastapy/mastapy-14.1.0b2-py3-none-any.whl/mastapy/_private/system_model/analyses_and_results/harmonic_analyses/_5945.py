...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class SpringDamperHarmonicAnalysis(_5844.CouplingHarmonicAnalysis):
    """SpringDamperHarmonicAnalysis
    ...
    @property
    def assembly_load_case(self: "Self") -> "_7651.SpringDamperLoadCase":
    ...
    @property
    def system_deflection_results(self: "Self") -> "_2892.SpringDamperSystemDeflection":
