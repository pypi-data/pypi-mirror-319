...
from mastapy._private.system_model.analyses_and_results.harmonic_analyses import _5871
...
class _Cast_HarmonicAnalysisExportOptions:
    ...
    def harmonic_analysis_fe_export_options(
        self: "CastSelf",
    ) -> "_5890.HarmonicAnalysisFEExportOptions":
        from mastapy._private.system_model.analyses_and_results.harmonic_analyses import (
            _5890,
        )

        return self.__parent__._cast(_5890.HarmonicAnalysisFEExportOptions)

    @property
    def harmonic_analysis_root_assembly_export_options(
        self: "CastSelf",
    ) -> "_5893.HarmonicAnalysisRootAssemblyExportOptions":
        from mastapy._private.system_model.analyses_and_results.harmonic_analyses import (
            _5893,
        )

        return self.__parent__._cast(_5893.HarmonicAnalysisRootAssemblyExportOptions)

    @property
    def harmonic_analysis_shaft_export_options(
        self: "CastSelf",
    ) -> "_5894.HarmonicAnalysisShaftExportOptions":
        from mastapy._private.system_model.analyses_and_results.harmonic_analyses import (
            _5894,
        )

        return self.__parent__._cast(_5894.HarmonicAnalysisShaftExportOptions)
...
class HarmonicAnalysisExportOptions(_0.APIBase, Generic[TPartAnalysis, TPart]):
    ...
    def distance_units_for_export(self: "Self", value: "_1671.Unit") -> None:
    ...
    @export_type.setter
    @enforce_parameter_types
    def export_type(self: "Self", value: "_5871.ExportOutputType") -> None:
    ...
    @enforce_parameter_types
    def type_of_result_to_export(
        self: "Self", value: "_4733.DynamicsResponseType"
    ) -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
    ...
    @property
    def analysis_options(self: "Self") -> "_5892.HarmonicAnalysisOptions":
