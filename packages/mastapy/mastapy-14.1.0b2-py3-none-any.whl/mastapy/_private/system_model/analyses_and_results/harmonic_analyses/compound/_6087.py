...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class OilSealCompoundHarmonicAnalysis(_6043.ConnectorCompoundHarmonicAnalysis):
    """OilSealCompoundHarmonicAnalysis
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_5915.OilSealHarmonicAnalysis]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_5915.OilSealHarmonicAnalysis]":
        """List[mastapy.system_model.analyses_and_results.harmonic_analyses.OilSealHarmonicAnalysis]
