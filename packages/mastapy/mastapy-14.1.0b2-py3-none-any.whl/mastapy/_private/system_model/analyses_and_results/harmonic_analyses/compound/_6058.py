...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class DatumCompoundHarmonicAnalysis(_6032.ComponentCompoundHarmonicAnalysis):
    """DatumCompoundHarmonicAnalysis
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_5857.DatumHarmonicAnalysis]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_5857.DatumHarmonicAnalysis]":
        """List[mastapy.system_model.analyses_and_results.harmonic_analyses.DatumHarmonicAnalysis]
