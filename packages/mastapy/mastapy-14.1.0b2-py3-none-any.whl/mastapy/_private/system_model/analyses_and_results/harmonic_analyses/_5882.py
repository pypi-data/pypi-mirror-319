...
from mastapy._private.system_model.analyses_and_results.harmonic_analyses import _5880
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class GearMeshMisalignmentExcitationDetail(_5880.GearMeshExcitationDetail):
    """GearMeshMisalignmentExcitationDetail
