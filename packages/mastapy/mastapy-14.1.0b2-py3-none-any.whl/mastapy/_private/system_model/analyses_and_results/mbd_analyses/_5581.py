...
class _Cast_MBDRunUpAnalysisOptions:
    ...
    @property
    def abstract_analysis_options(self: "CastSelf") -> "_7700.AbstractAnalysisOptions":
        return self.__parent__._cast(_7700.AbstractAnalysisOptions)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class MBDRunUpAnalysisOptions(_7700.AbstractAnalysisOptions[_7665.TimeSeriesLoadCase]):
    """MBDRunUpAnalysisOptions
    ...
    def input_velocity_processing_type(
        self: "Self",
    ) -> "_5567.InputVelocityForRunUpProcessingType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.mbd_analyses._5567",
    ...
    @enforce_parameter_types
    def input_velocity_processing_type(
        self: "Self", value: "_5567.InputVelocityForRunUpProcessingType"
    ) -> None:
    ...
    @property
    def run_up_driving_mode(self: "Self") -> "_5604.RunUpDrivingMode":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.mbd_analyses._5604",
            "RunUpDrivingMode",
        )(value)

    @run_up_driving_mode.setter
    @enforce_parameter_types
    def run_up_driving_mode(self: "Self", value: "_5604.RunUpDrivingMode") -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.MBDAnalyses.RunUpDrivingMode",
        )
    ...
    @property
    def run_up_speed_profile(self: "Self") -> "_1934.TwoDChartDefinition":
    ...
    def shape_of_initial_acceleration_period(
        self: "Self",
    ) -> "_5609.ShapeOfInitialAccelerationPeriodForRunUp":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.mbd_analyses._5609",
    ...
    @enforce_parameter_types
    def shape_of_initial_acceleration_period(
        self: "Self", value: "_5609.ShapeOfInitialAccelerationPeriodForRunUp"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.MBDAnalyses.ShapeOfInitialAccelerationPeriodForRunUp",
