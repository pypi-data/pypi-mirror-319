...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.drawing import _2319
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class PartMultibodyDynamicsAnalysis(_7713.PartTimeSeriesLoadAnalysisCase):
    """PartMultibodyDynamicsAnalysis
    ...
    def create_viewable(self: "Self") -> "_2319.MBDAnalysisViewable":
