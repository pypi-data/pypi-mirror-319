...
class _Cast_DynamicTorqueResultAtTime:
    ...
    def abstract_measured_dynamic_response_at_time(
        self: "CastSelf",
    ) -> "_5645.AbstractMeasuredDynamicResponseAtTime":
        return self.__parent__._cast(_5645.AbstractMeasuredDynamicResponseAtTime)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class DynamicTorqueResultAtTime(_5645.AbstractMeasuredDynamicResponseAtTime):
    """DynamicTorqueResultAtTime
