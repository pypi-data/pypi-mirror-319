...
class MBDAnalysisOptions(_0.APIBase):
    ...
    @property
    def analysis_type(self: "Self") -> "_5501.AnalysisTypes":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.mbd_analyses._5501",
            "AnalysisTypes",
        )(value)

    @analysis_type.setter
    @enforce_parameter_types
    def analysis_type(self: "Self", value: "_5501.AnalysisTypes") -> None:
    ...
    @enforce_parameter_types
    def gear_mesh_stiffness_model(
        self: "Self", value: "_5557.GearMeshStiffnessModel"
    ) -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
    ...
    def method_to_define_period(
        self: "Self",
    ) -> "_5564.InertiaAdjustedLoadCasePeriodMethod":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.mbd_analyses._5564",
    ...
    @enforce_parameter_types
    def method_to_define_period(
        self: "Self", value: "_5564.InertiaAdjustedLoadCasePeriodMethod"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.MBDAnalyses.InertiaAdjustedLoadCasePeriodMethod",
    ...
    @enforce_parameter_types
    def reference_power_load_to_define_period(
        self: "Self", value: "_2544.PowerLoad"
    ) -> None:
        wrapper_type = (
    ...
    def static_load_cases_to_create(
        self: "Self",
    ) -> "_5565.InertiaAdjustedLoadCaseResultsToCreate":
    ...
    @enforce_parameter_types
    def static_load_cases_to_create(
        self: "Self", value: "_5565.InertiaAdjustedLoadCaseResultsToCreate"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.MBDAnalyses.InertiaAdjustedLoadCaseResultsToCreate",
    ...
    def external_interface_options(
        self: "Self",
    ) -> "_5651.DynamicExternalInterfaceOptions":
    ...
    def frequency_response_options(
        self: "Self",
    ) -> "_4740.FrequencyResponseAnalysisOptions":
    ...
    @property
    def run_up_analysis_options(self: "Self") -> "_5581.MBDRunUpAnalysisOptions":
    ...
    @property
    def spline_damping_options(self: "Self") -> "_5614.SplineDampingOptions":
    ...
    @property
    def transient_solver_options(self: "Self") -> "_94.TransientSolverOptions":
