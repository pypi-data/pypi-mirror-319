...
class _Cast_AbstractMeasuredDynamicResponseAtTime:
    ...
    def dynamic_force_result_at_time(
        self: "CastSelf",
    ) -> "_5646.DynamicForceResultAtTime":
        from mastapy._private.system_model.analyses_and_results.mbd_analyses.reporting import (
            _5646,
        )

        return self.__parent__._cast(_5646.DynamicForceResultAtTime)

    @property
    def dynamic_torque_result_at_time(
        self: "CastSelf",
    ) -> "_5648.DynamicTorqueResultAtTime":
        from mastapy._private.system_model.analyses_and_results.mbd_analyses.reporting import (
            _5648,
        )

        return self.__parent__._cast(_5648.DynamicTorqueResultAtTime)
