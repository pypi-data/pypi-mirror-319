...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ConceptGearSetCriticalSpeedAnalysis(_6744.GearSetCriticalSpeedAnalysis):
    """ConceptGearSetCriticalSpeedAnalysis
    ...
    def gears_critical_speed_analysis(
        self: "Self",
    ) -> "List[_6710.ConceptGearCriticalSpeedAnalysis]":
    ...
    def meshes_critical_speed_analysis(
        self: "Self",
    ) -> "List[_6711.ConceptGearMeshCriticalSpeedAnalysis]":
