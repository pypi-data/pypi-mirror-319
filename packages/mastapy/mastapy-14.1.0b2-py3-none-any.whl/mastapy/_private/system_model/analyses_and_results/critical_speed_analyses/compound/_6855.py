...
class _Cast_CVTBeltConnectionCompoundCriticalSpeedAnalysis:
    ...
    def belt_connection_compound_critical_speed_analysis(
        self: "CastSelf",
    ) -> "_6824.BeltConnectionCompoundCriticalSpeedAnalysis":
        return self.__parent__._cast(_6824.BeltConnectionCompoundCriticalSpeedAnalysis)
...
class CVTBeltConnectionCompoundCriticalSpeedAnalysis(
    ...
    def connection_analysis_cases_ready(
        self: "Self",
    ) -> "List[_6724.CVTBeltConnectionCriticalSpeedAnalysis]":
