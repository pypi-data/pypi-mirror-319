...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class SpiralBevelGearSetCriticalSpeedAnalysis(_6699.BevelGearSetCriticalSpeedAnalysis):
    """SpiralBevelGearSetCriticalSpeedAnalysis
    ...
    def bevel_gears_critical_speed_analysis(
        self: "Self",
    ) -> "List[_6785.SpiralBevelGearCriticalSpeedAnalysis]":
    ...
    def bevel_meshes_critical_speed_analysis(
        self: "Self",
    ) -> "List[_6786.SpiralBevelGearMeshCriticalSpeedAnalysis]":
