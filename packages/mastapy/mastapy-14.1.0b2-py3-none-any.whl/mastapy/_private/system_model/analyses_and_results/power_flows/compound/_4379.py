...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class StraightBevelGearSetCompoundPowerFlow(_4285.BevelGearSetCompoundPowerFlow):
    """StraightBevelGearSetCompoundPowerFlow
    ...
    def straight_bevel_gears_compound_power_flow(
        self: "Self",
    ) -> "List[_4377.StraightBevelGearCompoundPowerFlow]":
    ...
    def straight_bevel_meshes_compound_power_flow(
        self: "Self",
    ) -> "List[_4378.StraightBevelGearMeshCompoundPowerFlow]":
