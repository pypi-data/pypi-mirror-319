...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class UnbalancedMassCompoundPowerFlow(_4391.VirtualComponentCompoundPowerFlow):
    """UnbalancedMassCompoundPowerFlow
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4259.UnbalancedMassPowerFlow]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4259.UnbalancedMassPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.UnbalancedMassPowerFlow]
