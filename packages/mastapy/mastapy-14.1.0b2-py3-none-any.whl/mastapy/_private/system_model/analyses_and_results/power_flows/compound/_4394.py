...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class WormGearSetCompoundPowerFlow(_4327.GearSetCompoundPowerFlow):
    """WormGearSetCompoundPowerFlow
    ...
    @property
    def gear_set_duty_cycle_rating(self: "Self") -> "_394.WormGearSetDutyCycleRating":
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4263.WormGearSetPowerFlow]":
    ...
    def worm_gears_compound_power_flow(
        self: "Self",
    ) -> "List[_4392.WormGearCompoundPowerFlow]":
    ...
    def worm_meshes_compound_power_flow(
        self: "Self",
    ) -> "List[_4393.WormGearMeshCompoundPowerFlow]":
    ...
    @property
    def assembly_analysis_cases(self: "Self") -> "List[_4263.WormGearSetPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.WormGearSetPowerFlow]
