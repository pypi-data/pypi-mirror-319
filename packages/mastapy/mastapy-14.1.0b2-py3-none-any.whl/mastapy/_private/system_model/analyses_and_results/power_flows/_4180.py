...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CylindricalGearSetPowerFlow(_4193.GearSetPowerFlow):
    """CylindricalGearSetPowerFlow
    ...
    @property
    def gears_power_flow(self: "Self") -> "List[_4179.CylindricalGearPowerFlow]":
    ...
    def cylindrical_gears_power_flow(
        self: "Self",
    ) -> "List[_4179.CylindricalGearPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.CylindricalGearPowerFlow]
    ...
    @property
    def meshes_power_flow(self: "Self") -> "List[_4178.CylindricalGearMeshPowerFlow]":
    ...
    def cylindrical_meshes_power_flow(
        self: "Self",
    ) -> "List[_4178.CylindricalGearMeshPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.CylindricalGearMeshPowerFlow]
    ...
    @property
    def ratings_for_all_designs(self: "Self") -> "List[_483.CylindricalGearSetRating]":
