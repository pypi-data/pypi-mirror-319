...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class BearingCompoundPowerFlow(_4303.ConnectorCompoundPowerFlow):
    """BearingCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self: "Self") -> "List[_4138.BearingPowerFlow]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4138.BearingPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.BearingPowerFlow]
