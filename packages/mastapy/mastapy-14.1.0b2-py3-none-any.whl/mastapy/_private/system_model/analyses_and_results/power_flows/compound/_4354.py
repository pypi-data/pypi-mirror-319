...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class PlanetCarrierCompoundPowerFlow(_4346.MountableComponentCompoundPowerFlow):
    """PlanetCarrierCompoundPowerFlow
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4220.PlanetCarrierPowerFlow]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4220.PlanetCarrierPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.PlanetCarrierPowerFlow]
