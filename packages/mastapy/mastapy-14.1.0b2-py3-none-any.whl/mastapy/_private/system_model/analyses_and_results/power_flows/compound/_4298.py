...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ConceptGearSetCompoundPowerFlow(_4327.GearSetCompoundPowerFlow):
    """ConceptGearSetCompoundPowerFlow
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4161.ConceptGearSetPowerFlow]":
    ...
    def concept_gears_compound_power_flow(
        self: "Self",
    ) -> "List[_4296.ConceptGearCompoundPowerFlow]":
    ...
    def concept_meshes_compound_power_flow(
        self: "Self",
    ) -> "List[_4297.ConceptGearMeshCompoundPowerFlow]":
    ...
    @property
    def assembly_analysis_cases(self: "Self") -> "List[_4161.ConceptGearSetPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.ConceptGearSetPowerFlow]
