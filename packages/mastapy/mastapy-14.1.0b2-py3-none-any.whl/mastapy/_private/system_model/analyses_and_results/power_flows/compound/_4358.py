...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class RingPinsCompoundPowerFlow(_4346.MountableComponentCompoundPowerFlow):
    """RingPinsCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self: "Self") -> "List[_4226.RingPinsPowerFlow]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4226.RingPinsPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.RingPinsPowerFlow]
