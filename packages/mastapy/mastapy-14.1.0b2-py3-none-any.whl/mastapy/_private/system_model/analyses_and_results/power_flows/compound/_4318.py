...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class DatumCompoundPowerFlow(_4292.ComponentCompoundPowerFlow):
    """DatumCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self: "Self") -> "List[_4182.DatumPowerFlow]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4182.DatumPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.DatumPowerFlow]
