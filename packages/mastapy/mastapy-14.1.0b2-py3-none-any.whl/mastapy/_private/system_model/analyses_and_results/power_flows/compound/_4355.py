...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class PointLoadCompoundPowerFlow(_4391.VirtualComponentCompoundPowerFlow):
    """PointLoadCompoundPowerFlow
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4221.PointLoadPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.PointLoadPowerFlow]
