...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CycloidalDiscCompoundPowerFlow(_4268.AbstractShaftCompoundPowerFlow):
    """CycloidalDiscCompoundPowerFlow
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4176.CycloidalDiscPowerFlow]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4176.CycloidalDiscPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.CycloidalDiscPowerFlow]
