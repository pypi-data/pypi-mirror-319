...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class WormGearMeshCompoundPowerFlow(_4326.GearMeshCompoundPowerFlow):
    """WormGearMeshCompoundPowerFlow
    ...
    def connection_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4261.WormGearMeshPowerFlow]":
    ...
    @property
    def connection_analysis_cases(self: "Self") -> "List[_4261.WormGearMeshPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.WormGearMeshPowerFlow]
