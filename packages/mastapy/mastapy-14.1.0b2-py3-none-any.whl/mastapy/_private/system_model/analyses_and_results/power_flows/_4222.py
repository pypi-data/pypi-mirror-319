...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class PowerFlow(_7714.StaticLoadAnalysisCase):
    """PowerFlow
    ...
    @property
    def torsional_system_deflection(self: "Self") -> "_2912.TorsionalSystemDeflection":
