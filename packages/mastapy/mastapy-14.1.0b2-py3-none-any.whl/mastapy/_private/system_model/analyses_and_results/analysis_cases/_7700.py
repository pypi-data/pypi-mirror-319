...
T = TypeVar("T", bound="_7495.LoadCase")
...
class _Cast_AbstractAnalysisOptions:
    ...
    @property
    def system_deflection_options(self: "CastSelf") -> "_2907.SystemDeflectionOptions":
        from mastapy._private.system_model.analyses_and_results.system_deflections import (
            _2907,
        )

        return self.__parent__._cast(_2907.SystemDeflectionOptions)
    ...
    def frequency_response_analysis_options(
        ...
        return self.__parent__._cast(_4740.FrequencyResponseAnalysisOptions)

    @property
    def mbd_run_up_analysis_options(
        self: "CastSelf",
    ) -> "_5581.MBDRunUpAnalysisOptions":
        from mastapy._private.system_model.analyses_and_results.mbd_analyses import (
            _5581,
        )

        return self.__parent__._cast(_5581.MBDRunUpAnalysisOptions)
    ...
    def frequency_options_for_harmonic_analysis_results(
        ...
        return self.__parent__._cast(_5878.FrequencyOptionsForHarmonicAnalysisResults)
    ...
    def speed_options_for_harmonic_analysis_results(
        ...
        return self.__parent__._cast(_5939.SpeedOptionsForHarmonicAnalysisResults)

    @property
    def stiffness_options_for_harmonic_analysis(
        self: "CastSelf",
    ) -> "_5946.StiffnessOptionsForHarmonicAnalysis":
        from mastapy._private.system_model.analyses_and_results.harmonic_analyses import (
            _5946,
        )

        return self.__parent__._cast(_5946.StiffnessOptionsForHarmonicAnalysis)
