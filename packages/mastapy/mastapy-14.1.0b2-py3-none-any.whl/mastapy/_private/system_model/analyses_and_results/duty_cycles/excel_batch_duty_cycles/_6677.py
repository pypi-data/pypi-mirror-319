...
class ExcelFileDetails(_0.APIBase):
    ...
    @cycles_unit.setter
    @enforce_parameter_types
    def cycles_unit(self: "Self", value: "_1671.Unit") -> None:
    ...
    @enforce_parameter_types
    def duration_unit(self: "Self", value: "_1671.Unit") -> None:
        wrapper_type = list_with_selected_item.ListWithSelectedItem_Unit.wrapper_type()
        enclosed_type = (
            list_with_selected_item.ListWithSelectedItem_Unit.implicit_type()
        )
    ...
    @speed_unit.setter
    @enforce_parameter_types
    def speed_unit(self: "Self", value: "_1671.Unit") -> None:
        wrapper_type = list_with_selected_item.ListWithSelectedItem_Unit.wrapper_type()
        enclosed_type = (
            list_with_selected_item.ListWithSelectedItem_Unit.implicit_type()
        )
    ...
    @torque_unit.setter
    @enforce_parameter_types
    def torque_unit(self: "Self", value: "_1671.Unit") -> None:
        wrapper_type = list_with_selected_item.ListWithSelectedItem_Unit.wrapper_type()
        enclosed_type = (
            list_with_selected_item.ListWithSelectedItem_Unit.implicit_type()
        )
