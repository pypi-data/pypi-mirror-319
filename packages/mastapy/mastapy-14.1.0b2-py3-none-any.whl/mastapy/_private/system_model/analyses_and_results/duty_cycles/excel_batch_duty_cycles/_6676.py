...
if TYPE_CHECKING:
    ...
    from mastapy._private.utility import _1659
...
class ExcelBatchDutyCycleSpectraCreatorDetails(_0.APIBase):
    ...
    @property
    def excel_file_details(self: "Self") -> "_6677.ExcelFileDetails":
    ...
    @property
    def masta_file_details(self: "Self") -> "_6680.MASTAFileDetails":
    ...
    @property
    def working_folder(self: "Self") -> "_1659.SelectableFolder":
    ...
    def excel_sheet_design_state_selection(
        self: "Self",
    ) -> "List[_6679.ExcelSheetDesignStateSelector]":
