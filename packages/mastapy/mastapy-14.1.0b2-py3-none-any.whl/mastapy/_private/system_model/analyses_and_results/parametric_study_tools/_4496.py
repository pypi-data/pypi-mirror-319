...
class _Cast_ParametricStudyVariable:
    ...
    @property
    def analysis_case_variable(self: "CastSelf") -> "_2726.AnalysisCaseVariable":
        return self.__parent__._cast(_2726.AnalysisCaseVariable)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ParametricStudyVariable(_2726.AnalysisCaseVariable):
    """ParametricStudyVariable
    ...
    @property
    def dimension(self: "Self") -> "_4487.ParametricStudyDimension":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.parametric_study_tools._4487",
            "ParametricStudyDimension",
        )(value)

    @dimension.setter
    @enforce_parameter_types
    def dimension(self: "Self", value: "_4487.ParametricStudyDimension") -> None:
    ...
    @property
    def distribution(self: "Self") -> "_4484.MonteCarloDistribution":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.parametric_study_tools._4484",
            "MonteCarloDistribution",
        )(value)

    @distribution.setter
    @enforce_parameter_types
    def distribution(self: "Self", value: "_4484.MonteCarloDistribution") -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.ParametricStudyTools.MonteCarloDistribution",
        )
    ...
    @property
    def doe_variable_setter(self: "Self") -> "_4450.DesignOfExperimentsVariableSetter":
