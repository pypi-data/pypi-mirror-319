...
class DutyCycleResultsForAllComponents(_0.APIBase):
    ...
    def results_for_all_gear_sets(
        self: "Self",
    ) -> "_4453.DutyCycleResultsForAllGearSets":
    ...
    def results_for_root_assembly(
        self: "Self",
    ) -> "_4454.DutyCycleResultsForRootAssembly":
    ...
    def results_for_all_bearings(
        self: "Self",
    ) -> "List[_4455.DutyCycleResultsForSingleBearing]":
    ...
    def results_for_all_shafts(
        self: "Self",
    ) -> "List[_4456.DutyCycleResultsForSingleShaft]":
