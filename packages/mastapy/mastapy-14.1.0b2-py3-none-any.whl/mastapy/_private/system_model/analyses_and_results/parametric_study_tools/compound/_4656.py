...
class StraightBevelDiffGearSetCompoundParametricStudyTool(
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4525.StraightBevelDiffGearSetParametricStudyTool]":
    ...
    def straight_bevel_diff_gears_compound_parametric_study_tool(
        self: "Self",
    ) -> "List[_4654.StraightBevelDiffGearCompoundParametricStudyTool]":
    ...
    def straight_bevel_diff_meshes_compound_parametric_study_tool(
        self: "Self",
    ) -> "List[_4655.StraightBevelDiffGearMeshCompoundParametricStudyTool]":
