...
class PowerLoadCompoundParametricStudyTool(
    ...
    @property
    def properties_changing_all_load_cases(self: "Self") -> "_7632.PowerLoadLoadCase":
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4505.PowerLoadParametricStudyTool]":
    ...
    @property
    def load_cases(self: "Self") -> "List[_7632.PowerLoadLoadCase]":
