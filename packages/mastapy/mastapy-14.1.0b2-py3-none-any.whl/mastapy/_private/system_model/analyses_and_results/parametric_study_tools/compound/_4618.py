...
class KlingelnbergCycloPalloidHypoidGearSetCompoundParametricStudyTool(
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4476.KlingelnbergCycloPalloidHypoidGearSetParametricStudyTool]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gears_compound_parametric_study_tool(
        self: "Self",
    ) -> "List[_4616.KlingelnbergCycloPalloidHypoidGearCompoundParametricStudyTool]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_meshes_compound_parametric_study_tool(
        ...
        "List[_4617.KlingelnbergCycloPalloidHypoidGearMeshCompoundParametricStudyTool]"
    ):
