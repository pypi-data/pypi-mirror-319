...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="ParametricStudyDOEResultVariableForParallelCoordinatesPlot._Cast_ParametricStudyDOEResultVariableForParallelCoordinatesPlot",
    )
...
class _Cast_ParametricStudyDOEResultVariableForParallelCoordinatesPlot:
    ...
    __parent__: "ParametricStudyDOEResultVariableForParallelCoordinatesPlot"
...
class ParametricStudyDOEResultVariableForParallelCoordinatesPlot(_0.APIBase):
    ...
    TYPE: ClassVar["Type"] = (
        _PARAMETRIC_STUDY_DOE_RESULT_VARIABLE_FOR_PARALLEL_COORDINATES_PLOT
    )
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_ParametricStudyDOEResultVariableForParallelCoordinatesPlot":
        """Cast to another type.

        Returns:
            _Cast_ParametricStudyDOEResultVariableForParallelCoordinatesPlot
        """
        return _Cast_ParametricStudyDOEResultVariableForParallelCoordinatesPlot(self)
