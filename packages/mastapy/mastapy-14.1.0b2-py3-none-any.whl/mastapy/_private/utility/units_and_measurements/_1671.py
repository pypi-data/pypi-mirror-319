...
class _Cast_Unit:
    ...
    @property
    def degrees_minutes_seconds(self: "CastSelf") -> "_1663.DegreesMinutesSeconds":
        from mastapy._private.utility.units_and_measurements import _1663

        return self.__parent__._cast(_1663.DegreesMinutesSeconds)

    @property
    def enum_unit(self: "CastSelf") -> "_1664.EnumUnit":
        from mastapy._private.utility.units_and_measurements import _1664

        return self.__parent__._cast(_1664.EnumUnit)

    @property
    def inverse_unit(self: "CastSelf") -> "_1665.InverseUnit":
        from mastapy._private.utility.units_and_measurements import _1665

        return self.__parent__._cast(_1665.InverseUnit)

    @property
    def safety_factor_unit(self: "CastSelf") -> "_1669.SafetyFactorUnit":
        from mastapy._private.utility.units_and_measurements import _1669

        return self.__parent__._cast(_1669.SafetyFactorUnit)

    @property
    def time_unit(self: "CastSelf") -> "_1670.TimeUnit":
        from mastapy._private.utility.units_and_measurements import _1670

        return self.__parent__._cast(_1670.TimeUnit)

    @property
    def unit_gradient(self: "CastSelf") -> "_1672.UnitGradient":
        from mastapy._private.utility.units_and_measurements import _1672

        return self.__parent__._cast(_1672.UnitGradient)
