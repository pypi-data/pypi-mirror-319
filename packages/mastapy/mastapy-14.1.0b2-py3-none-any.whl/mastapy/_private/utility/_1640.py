...
if TYPE_CHECKING:
    ...
    from mastapy._private.utility import _1639, _1653
...
class EnvironmentSummary(_0.APIBase):
    ...
    @property
    def current_culture(self: "Self") -> "_1653.NumberFormatInfoSummary":
    ...
    @property
    def dispatchers(self: "Self") -> "List[_1639.DispatcherHelper]":
