...
from mastapy._private.utility import _1661
...
class SystemDirectoryPopulator(_0.APIBase):
    ...
    @enforce_parameter_types
    def selected_version(self: "Self", value: "_1661.SystemDirectory") -> None:
        wrapper_type = (
    ...
    @property
    def current_version(self: "Self") -> "_1661.SystemDirectory":
    ...
    @property
    def version_to_copy(self: "Self") -> "_1661.SystemDirectory":
        """mastapy.utility.SystemDirectory
