...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.optimization import _2295, _2298, _2303, _2304
    ...
    from mastapy._private.utility.databases import _1896
...
class _Cast_NamedDatabaseItem:
    ...
    def pareto_optimisation_strategy(
        self: "CastSelf",
    ) -> "_1608.ParetoOptimisationStrategy":
        from mastapy._private.math_utility.optimisation import _1608

        return self.__parent__._cast(_1608.ParetoOptimisationStrategy)

    @property
    def bearing_settings_item(self: "CastSelf") -> "_1948.BearingSettingsItem":
        from mastapy._private.bearings import _1948

        return self.__parent__._cast(_1948.BearingSettingsItem)

    @property
    def iso14179_settings(self: "CastSelf") -> "_2042.ISO14179Settings":
        from mastapy._private.bearings.bearing_results.rolling import _2042

        return self.__parent__._cast(_2042.ISO14179Settings)

    @property
    def conical_gear_optimisation_strategy(
        self: "CastSelf",
    ) -> "_2295.ConicalGearOptimisationStrategy":
        from mastapy._private.system_model.optimization import _2295

        return self.__parent__._cast(_2295.ConicalGearOptimisationStrategy)

    @property
    def cylindrical_gear_optimisation_strategy(
        self: "CastSelf",
    ) -> "_2298.CylindricalGearOptimisationStrategy":
        from mastapy._private.system_model.optimization import _2298

        return self.__parent__._cast(_2298.CylindricalGearOptimisationStrategy)

    @property
    def optimization_strategy(self: "CastSelf") -> "_2303.OptimizationStrategy":
        from mastapy._private.system_model.optimization import _2303

        return self.__parent__._cast(_2303.OptimizationStrategy)

    @property
    def optimization_strategy_base(
        self: "CastSelf",
    ) -> "_2304.OptimizationStrategyBase":
        from mastapy._private.system_model.optimization import _2304

        return self.__parent__._cast(_2304.OptimizationStrategyBase)

    @property
    def supercharger_rotor_set(self: "CastSelf") -> "_2638.SuperchargerRotorSet":
        from mastapy._private.system_model.part_model.gears.supercharger_rotor_set import (
            _2638,
        )

        return self.__parent__._cast(_2638.SuperchargerRotorSet)
...
class NamedDatabaseItem(_0.APIBase):
    ...
    @property
    def database_key(self: "Self") -> "_1896.NamedKey":
    ...
    @database_key.setter
    @enforce_parameter_types
    def database_key(self: "Self", value: "_1896.NamedKey") -> None:
