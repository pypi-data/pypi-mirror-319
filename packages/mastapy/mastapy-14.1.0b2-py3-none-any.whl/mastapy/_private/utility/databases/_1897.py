...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings import _1947, _1960
    ...
    from mastapy._private.utility.databases import _1892, _1894

    Self = TypeVar("Self", bound="SQLDatabase")
    CastSelf = TypeVar("CastSelf", bound="SQLDatabase._Cast_SQLDatabase")

TKey = TypeVar("TKey", bound="_1892.DatabaseKey")
...
class _Cast_SQLDatabase:
    ...
    @property
    def rolling_bearing_database(self: "CastSelf") -> "_1960.RollingBearingDatabase":
        from mastapy._private.bearings import _1960

        return self.__parent__._cast(_1960.RollingBearingDatabase)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class SQLDatabase(_1890.Database[TKey, TValue]):
    """SQLDatabase
