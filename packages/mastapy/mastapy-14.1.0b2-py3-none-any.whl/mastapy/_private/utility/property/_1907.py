...
class _Cast_DutyCyclePropertySummaryStress:
    ...
    def duty_cycle_property_summary(
        self: "CastSelf",
    ) -> "_1903.DutyCyclePropertySummary":
        return self.__parent__._cast(_1903.DutyCyclePropertySummary)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class DutyCyclePropertySummaryStress(_1903.DutyCyclePropertySummary[_1776.Stress, T]):
    """DutyCyclePropertySummaryStress
