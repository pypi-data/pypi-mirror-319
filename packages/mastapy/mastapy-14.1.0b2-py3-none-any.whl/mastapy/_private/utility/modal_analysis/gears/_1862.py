...
if TYPE_CHECKING:
    ...
    from mastapy._private.utility.modal_analysis.gears import _1863, _1866
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class GearOrderForTE(_1868.OrderWithRadius):
    """GearOrderForTE
    ...
    @property
    def position(self: "Self") -> "_1863.GearPositions":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.utility.modal_analysis.gears._1863", "GearPositions"
        )(value)

    @property
    def additional_orders_and_harmonics(self: "Self") -> "List[_1866.OrderForTE]":
