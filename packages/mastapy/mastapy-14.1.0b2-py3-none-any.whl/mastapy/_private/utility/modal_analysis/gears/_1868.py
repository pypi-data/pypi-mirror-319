...
if TYPE_CHECKING:
    ...
    from mastapy._private.utility.modal_analysis.gears import _1862, _1871
...
class _Cast_OrderWithRadius:
    ...
    @property
    def order_for_te(self: "CastSelf") -> "_1866.OrderForTE":
        return self.__parent__._cast(_1866.OrderForTE)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class OrderWithRadius(_1866.OrderForTE):
    """OrderWithRadius
