...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar("CastSelf", bound="NamedTuple5._Cast_NamedTuple5")
...
class _Cast_NamedTuple5:
    ...
    __parent__: "NamedTuple5"

    @property
    def named_tuple_5(self: "CastSelf") -> "NamedTuple5":
...
class NamedTuple5(_0.APIBase, Generic[T1, T2, T3, T4, T5]):
    ...
    TYPE: ClassVar["Type"] = _NAMED_TUPLE_5
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_NamedTuple5":
        """Cast to another type.

        Returns:
            _Cast_NamedTuple5
        """
        return _Cast_NamedTuple5(self)
