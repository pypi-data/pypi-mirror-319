...
if TYPE_CHECKING:
    ...
    from mastapy._private.html import _322
    from mastapy._private.utility.report import _1825, _1833
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CustomReportText(_1822.CustomReportDefinitionItem):
    """CustomReportText
    ...
    @property
    def heading_type(self: "Self") -> "_322.HeadingType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.html._322", "HeadingType"
        )(value)

    @heading_type.setter
    @enforce_parameter_types
    def heading_type(self: "Self", value: "_322.HeadingType") -> None:
