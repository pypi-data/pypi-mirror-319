...
if TYPE_CHECKING:
    ...
    from mastapy._private.utility.cad_export import _1899
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CustomReportCadDrawing(_1833.CustomReportNameableItem):
    """CustomReportCadDrawing
    ...
    @property
    def stock_drawing(self: "Self") -> "_1899.StockDrawings":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.utility.cad_export._1899", "StockDrawings"
        )(value)

    @stock_drawing.setter
    @enforce_parameter_types
    def stock_drawing(self: "Self", value: "_1899.StockDrawings") -> None:
