...
from typing import Iterator, Iterable, List, Optional, Callable, Any, Union
...
class CoreUtils:
    ...
    def sync_log_objects(
        ...
        given by the name captured when finding the log files. If ``log_id`` is not provided, the ``log_name`` is
        used to find or create the log to upload the logs to. Similarly, if the ``group_id`` is not provided,
        ...
        :type skip_existing_ingestions: bool, optional
        :param ingestion_state: The state to set for the ingestions. Defaults to "queued".
        :type ingestion_state: str, optional
