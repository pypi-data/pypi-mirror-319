...
CompletionsModelBodyWithPromptPromptTypedDict = TypeAliasType(
    "CompletionsModelBodyWithPromptPromptTypedDict", Union[str, List[str]]
)
r"""The prompt (i.e., input text) to generate completions for. Either `prompt` or `tokens` field is required."""


CompletionsModelBodyWithPromptPrompt = TypeAliasType(
    "CompletionsModelBodyWithPromptPrompt", Union[str, List[str]]
)
r"""The prompt (i.e., input text) to generate completions for. Either `prompt` or `tokens` field is required."""


CompletionsModelBodyWithPromptSeedTypedDict = TypeAliasType(
    "CompletionsModelBodyWithPromptSeedTypedDict", Union[List[int], int]
)
...
CompletionsModelBodyWithPromptSeed = TypeAliasType(
    "CompletionsModelBodyWithPromptSeed", Union[List[int], int]
)
r"""Seed to control random procedure. If nothing is given, the API generate the seed randomly, use it for sampling, and return the seed along with the generated result. When using the `n` argument, you can pass a list of seed values to control all of the independent generations."""


class CompletionsModelBodyWithPromptTypedDict(TypedDict):
    model: str
    r"""ID of target endpoint. If you want to send request to specific adapter, using \"ENDPOINT_ID:ADAPTER_ROUTE\" format."""
    prompt: CompletionsModelBodyWithPromptPromptTypedDict
    r"""The prompt (i.e., input text) to generate completions for. Either `prompt` or `tokens` field is required."""
    ...
    **This field is unsupported when `response_format` is specified.**
    ...
    seed: NotRequired[Nullable[CompletionsModelBodyWithPromptSeedTypedDict]]
    r"""Seed to control random procedure. If nothing is given, the API generate the seed randomly, use it for sampling, and return the seed along with the generated result. When using the `n` argument, you can pass a list of seed values to control all of the independent generations."""
...
class CompletionsModelBodyWithPrompt(BaseModel):
    model: str
    r"""ID of target endpoint. If you want to send request to specific adapter, using \"ENDPOINT_ID:ADAPTER_ROUTE\" format."""

    prompt: CompletionsModelBodyWithPromptPrompt
    r"""The prompt (i.e., input text) to generate completions for. Either `prompt` or `tokens` field is required."""
    ...
    **This field is unsupported when `response_format` is specified.**
    ...
    seed: OptionalNullable[CompletionsModelBodyWithPromptSeed] = UNSET
    r"""Seed to control random procedure. If nothing is given, the API generate the seed randomly, use it for sampling, and return the seed along with the generated result. When using the `n` argument, you can pass a list of seed values to control all of the independent generations."""
