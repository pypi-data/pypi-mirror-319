...
class ServerlessToolAssistedChatCompletionStreamBodyLogitBiasTypedDict(TypedDict):
...
class ServerlessToolAssistedChatCompletionStreamBodyLogitBias(BaseModel):
    r"""Accepts a JSON object that maps tokens to an associated bias value. Mathematically, the bias is added to the logits generated by the model prior to sampling. The exact effect will vary per model."""
...
ServerlessToolAssistedChatCompletionStreamBodySeed = TypeAliasType(
    "ServerlessToolAssistedChatCompletionStreamBodySeed", Union[List[int], int]
)
r"""Seed to control random procedure. If nothing is given, random seed is used for sampling, and return the seed along with the generated result. When using the `n` argument, you can pass a list of seed values to control all of the independent generations."""


ServerlessToolAssistedChatCompletionStreamBodyToolChoiceTypedDict = TypeAliasType(
...
ServerlessToolAssistedChatCompletionStreamBodyToolChoice = TypeAliasType(
...
class ServerlessToolAssistedChatCompletionStreamBodyTypedDict(TypedDict):
    ...
    logit_bias: NotRequired[
        Nullable[ServerlessToolAssistedChatCompletionStreamBodyLogitBiasTypedDict]
    ]
    r"""Accepts a JSON object that maps tokens to an associated bias value. Mathematically, the bias is added to the logits generated by the model prior to sampling. The exact effect will vary per model."""
...
class ServerlessToolAssistedChatCompletionStreamBody(BaseModel):
    ...
    ***Tip***
    ...
    tool_choice: Optional[ServerlessToolAssistedChatCompletionStreamBodyToolChoice] = (
        None
    )
    r"""Determines the tool calling behavior of the model.
    When set to `none`, the model will bypass tool execution and generate a response directly.
