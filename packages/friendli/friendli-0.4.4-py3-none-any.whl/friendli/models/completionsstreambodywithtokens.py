...
CompletionsStreamBodyWithTokensSeedTypedDict = TypeAliasType(
    "CompletionsStreamBodyWithTokensSeedTypedDict", Union[List[int], int]
)
...
CompletionsStreamBodyWithTokensSeed = TypeAliasType(
    "CompletionsStreamBodyWithTokensSeed", Union[List[int], int]
)
r"""Seed to control random procedure. If nothing is given, the API generate the seed randomly, use it for sampling, and return the seed along with the generated result. When using the `n` argument, you can pass a list of seed values to control all of the independent generations."""


class CompletionsStreamBodyWithTokensTypedDict(TypedDict):
    model: str
    ...
    **This field is unsupported when `response_format` is specified.**
    ...
    seed: NotRequired[Nullable[CompletionsStreamBodyWithTokensSeedTypedDict]]
    r"""Seed to control random procedure. If nothing is given, the API generate the seed randomly, use it for sampling, and return the seed along with the generated result. When using the `n` argument, you can pass a list of seed values to control all of the independent generations."""
...
class CompletionsStreamBodyWithTokens(BaseModel):
    model: str
    r"""Code of the model to use. See [available model list](https://friendli.ai/docs/guides/serverless_endpoints/pricing#text-generation-models)."""
    ...
    **This field is unsupported when `response_format` is specified.**
    ...
    seed: OptionalNullable[CompletionsStreamBodyWithTokensSeed] = UNSET
    r"""Seed to control random procedure. If nothing is given, the API generate the seed randomly, use it for sampling, and return the seed along with the generated result. When using the `n` argument, you can pass a list of seed values to control all of the independent generations."""
