...
CompletionsModelBodyWithTokensSeedTypedDict = TypeAliasType(
    "CompletionsModelBodyWithTokensSeedTypedDict", Union[List[int], int]
)
...
CompletionsModelBodyWithTokensSeed = TypeAliasType(
    "CompletionsModelBodyWithTokensSeed", Union[List[int], int]
)
r"""Seed to control random procedure. If nothing is given, the API generate the seed randomly, use it for sampling, and return the seed along with the generated result. When using the `n` argument, you can pass a list of seed values to control all of the independent generations."""


class CompletionsModelBodyWithTokensTypedDict(TypedDict):
    model: str
    ...
    **This field is unsupported when `response_format` is specified.**
    ...
    seed: NotRequired[Nullable[CompletionsModelBodyWithTokensSeedTypedDict]]
    r"""Seed to control random procedure. If nothing is given, the API generate the seed randomly, use it for sampling, and return the seed along with the generated result. When using the `n` argument, you can pass a list of seed values to control all of the independent generations."""
...
class CompletionsModelBodyWithTokens(BaseModel):
    model: str
    r"""ID of target endpoint. If you want to send request to specific adapter, using \"ENDPOINT_ID:ADAPTER_ROUTE\" format."""
    ...
    **This field is unsupported when `response_format` is specified.**
    ...
    seed: OptionalNullable[CompletionsModelBodyWithTokensSeed] = UNSET
    r"""Seed to control random procedure. If nothing is given, the API generate the seed randomly, use it for sampling, and return the seed along with the generated result. When using the `n` argument, you can pass a list of seed values to control all of the independent generations."""
