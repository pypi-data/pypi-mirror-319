...
class ServerlessToolAssistedChatCompletionBodyLogitBiasTypedDict(TypedDict):
...
class ServerlessToolAssistedChatCompletionBodyLogitBias(BaseModel):
    r"""Accepts a JSON object that maps tokens to an associated bias value. Mathematically, the bias is added to the logits generated by the model prior to sampling. The exact effect will vary per model."""
...
class ServerlessToolAssistedChatCompletionBodyTypedDict(TypedDict):
    ...
    logit_bias: NotRequired[
        Nullable[ServerlessToolAssistedChatCompletionBodyLogitBiasTypedDict]
    ]
    r"""Accepts a JSON object that maps tokens to an associated bias value. Mathematically, the bias is added to the logits generated by the model prior to sampling. The exact effect will vary per model."""
...
class ServerlessToolAssistedChatCompletionBody(BaseModel):
    ...
    logit_bias: OptionalNullable[ServerlessToolAssistedChatCompletionBodyLogitBias] = (
        UNSET
    )
    r"""Accepts a JSON object that maps tokens to an associated bias value. Mathematically, the bias is added to the logits generated by the model prior to sampling. The exact effect will vary per model."""
