raise Exception("20250109 not used")
...
class Coordinator(SiteUser, #CoursesUser,
        OfficeOperator, CheckdataUser,
                  ClientsNameUser, DataExporter):
    pass


class Secretary(SiteUser, #CoursesUser,
        OfficeUser, OfficeOperator,
                ContactsUser, BeIdUser, ExcerptsUser, CheckdataUser,
                ClientsUser):
    pass


class SocialWorker(SiteUser, CoachingsUser, #CoursesUser,
        ContactsUser,
                   OfficeUser, OfficeOperator, ExcerptsUser, #CareerUser,
                   BeIdUser, GuestOperator, CommentsUser, TrendsUser,
                   ClientsUser, Explorer, #PollsUser,
                   CheckdataUser):
    pass


class SiteStaff(SiteUser, CoachingsStaff, #CoursesUser,
        ContactsStaff,
                OfficeStaff, ExcerptsStaff, #CareerStaff,
                BeIdUser,
                GuestOperator, CommentsStaff, SiteSearcher, TrendsStaff,
                ClientsStaff, Explorer, #PollsStaff,
                CheckdataUser):
    pass
