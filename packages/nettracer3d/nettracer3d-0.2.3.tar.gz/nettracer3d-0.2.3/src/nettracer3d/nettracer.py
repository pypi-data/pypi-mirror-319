...
def upsample_with_padding(data, factor, original_shape): #Not the most nuanced upsampler but essentially just used to undo downsamples... I generally never have use for any other sort of upsample so this one is the one I am using
