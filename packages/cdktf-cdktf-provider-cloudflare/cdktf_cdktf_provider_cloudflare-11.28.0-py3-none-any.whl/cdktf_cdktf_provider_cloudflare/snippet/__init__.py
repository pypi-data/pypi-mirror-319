...
class Snippet(
    ...
    def __init__(
        ...
        *,
        ...
        files: typing.Optional[typing.Union[_cdktf_9a9027ec.IResolvable, typing.Sequence[typing.Union["SnippetFiles", typing.Dict[builtins.str, typing.Any]]]]] = None,
        ...
        '''Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.50.0/docs/resources/snippet cloudflare_snippet} Resource.

        :param scope: The scope in which to define this construct.
        :param id: The scoped construct ID. Must be unique amongst siblings in the same scope
        :param main_module: Main module file name of the snippet. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.50.0/docs/resources/snippet#main_module Snippet#main_module}
        :param name: Name of the snippet. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.50.0/docs/resources/snippet#name Snippet#name}
        :param zone_id: The zone identifier to target for the resource. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.50.0/docs/resources/snippet#zone_id Snippet#zone_id}
        :param files: files block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.50.0/docs/resources/snippet#files Snippet#files}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing Snippet that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.50.0/docs/resources/snippet#import import section} in the documentation of this resource for the id to use
    ...
    def main_module(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__ea4f4299e5185b7e26167f0ca80c3a4db305aa0128abee414effecf871a8cade)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def name(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__6a354656a4b137f2da3bfc974ad3d08979d611bc8fb8631b5d9ee610479d1984)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class SnippetConfig(_cdktf_9a9027ec.TerraformMetaArguments):
    ...
    def files(
        ...
        return typing.cast(typing.Optional[typing.Union[_cdktf_9a9027ec.IResolvable, typing.List["SnippetFiles"]]], result)
...
@jsii.data_type(
    ...
    jsii_struct_bases=[],
    name_mapping={"name": "name", "content": "content"},
)
class SnippetFiles:
    def __init__(
        self,
        *,
        ...
        '''
        :param name: Name of the snippet file. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.50.0/docs/resources/snippet#name Snippet#name}
        :param content: Content of the snippet file. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.50.0/docs/resources/snippet#content Snippet#content}
        '''
        if __debug__:
...
def _typecheckingstub__ea4f4299e5185b7e26167f0ca80c3a4db305aa0128abee414effecf871a8cade(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__6a354656a4b137f2da3bfc974ad3d08979d611bc8fb8631b5d9ee610479d1984(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass
