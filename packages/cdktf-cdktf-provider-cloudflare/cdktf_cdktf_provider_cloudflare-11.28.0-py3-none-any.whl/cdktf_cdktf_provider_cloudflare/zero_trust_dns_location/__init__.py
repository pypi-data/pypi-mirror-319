...
Refer to the Terraform Registry for docs: [`cloudflare_zero_trust_dns_location`](https://registry.terraform.io/providers/cloudflare/cloudflare/4.50.0/docs/resources/zero_trust_dns_location).
'''
...
class ZeroTrustDnsLocation(
    ...
    def __init__(
        ...
        *,
        ...
        :param account_id: The account identifier to target for the resource. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.50.0/docs/resources/zero_trust_dns_location#account_id ZeroTrustDnsLocation#account_id}
        :param name: Name of the teams location. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.50.0/docs/resources/zero_trust_dns_location#name ZeroTrustDnsLocation#name}
        :param client_default: Indicator that this is the default location. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.50.0/docs/resources/zero_trust_dns_location#client_default ZeroTrustDnsLocation#client_default}
        :param dns_destination_ips_id: IPv4 binding assigned to this location. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.50.0/docs/resources/zero_trust_dns_location#dns_destination_ips_id ZeroTrustDnsLocation#dns_destination_ips_id}
        :param dns_destination_ipv6_block_id: IPv6 block binding assigned to this location. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.50.0/docs/resources/zero_trust_dns_location#dns_destination_ipv6_block_id ZeroTrustDnsLocation#dns_destination_ipv6_block_id}
        :param ecs_support: Indicator that this location needs to resolve EDNS queries. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.50.0/docs/resources/zero_trust_dns_location#ecs_support ZeroTrustDnsLocation#ecs_support}
        :param endpoints: endpoints block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.50.0/docs/resources/zero_trust_dns_location#endpoints ZeroTrustDnsLocation#endpoints}
        :param id: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.50.0/docs/resources/zero_trust_dns_location#id ZeroTrustDnsLocation#id}. Please be aware that the id field is automatically added to all resources in Terraform providers using a Terraform provider SDK version below 2. If you experience problems setting this value it might not be settable. Please take a look at the provider documentation to ensure it should be settable.
        :param networks: The networks CIDRs that comprise the location. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.50.0/docs/resources/zero_trust_dns_location#networks ZeroTrustDnsLocation#networks}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing ZeroTrustDnsLocation that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.50.0/docs/resources/zero_trust_dns_location#import import section} in the documentation of this resource for the id to use
    ...
    def put_endpoints(
        ...
        *,
        ...
        '''
        :param doh: doh block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.50.0/docs/resources/zero_trust_dns_location#doh ZeroTrustDnsLocation#doh}
        :param dot: dot block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.50.0/docs/resources/zero_trust_dns_location#dot ZeroTrustDnsLocation#dot}
        :param ipv4: ipv4 block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.50.0/docs/resources/zero_trust_dns_location#ipv4 ZeroTrustDnsLocation#ipv4}
        :param ipv6: ipv6 block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.50.0/docs/resources/zero_trust_dns_location#ipv6 ZeroTrustDnsLocation#ipv6}
        '''
    ...
    def endpoints_input(self) -> typing.Optional["ZeroTrustDnsLocationEndpoints"]:
        return typing.cast(typing.Optional["ZeroTrustDnsLocationEndpoints"], jsii.get(self, "endpointsInput"))
    ...
    def dns_destination_ipv6_block_id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__f3063170631f80d548fe95290df067d8e35b626ddb39b4497512e2afca139882)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class ZeroTrustDnsLocationEndpointsDoh:
    def __init__(
        ...
        *,
        ...
        '''
        :param enabled: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.50.0/docs/resources/zero_trust_dns_location#enabled ZeroTrustDnsLocation#enabled}.
        :param networks: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.50.0/docs/resources/zero_trust_dns_location#networks ZeroTrustDnsLocation#networks}.
        '''
        if __debug__:
...
class ZeroTrustDnsLocationEndpointsDohNetworks:
    def __init__(self, *, network: typing.Optional[builtins.str] = None) -> None:
        '''
        :param network: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.50.0/docs/resources/zero_trust_dns_location#network ZeroTrustDnsLocation#network}.
        '''
        if __debug__:
...
class ZeroTrustDnsLocationEndpointsDohOutputReference(
    ...
    @builtins.property
    @jsii.member(jsii_name="internalValue")
    def internal_value(self) -> typing.Optional[ZeroTrustDnsLocationEndpointsDoh]:
        return typing.cast(typing.Optional[ZeroTrustDnsLocationEndpointsDoh], jsii.get(self, "internalValue"))

    @internal_value.setter
    def internal_value(
        self,
        value: typing.Optional[ZeroTrustDnsLocationEndpointsDoh],
    ) -> None:
        if __debug__:
...
class ZeroTrustDnsLocationEndpointsDotOutputReference(
    ...
    @builtins.property
    @jsii.member(jsii_name="internalValue")
    def internal_value(self) -> typing.Optional[ZeroTrustDnsLocationEndpointsDot]:
        return typing.cast(typing.Optional[ZeroTrustDnsLocationEndpointsDot], jsii.get(self, "internalValue"))

    @internal_value.setter
    def internal_value(
        self,
        value: typing.Optional[ZeroTrustDnsLocationEndpointsDot],
    ) -> None:
        if __debug__:
...
class ZeroTrustDnsLocationEndpointsIpv4OutputReference(
    ...
    @builtins.property
    @jsii.member(jsii_name="internalValue")
    def internal_value(self) -> typing.Optional[ZeroTrustDnsLocationEndpointsIpv4]:
        return typing.cast(typing.Optional[ZeroTrustDnsLocationEndpointsIpv4], jsii.get(self, "internalValue"))

    @internal_value.setter
    def internal_value(
        self,
        value: typing.Optional[ZeroTrustDnsLocationEndpointsIpv4],
    ) -> None:
        if __debug__:
...
class ZeroTrustDnsLocationEndpointsIpv6OutputReference(
    ...
    @builtins.property
    @jsii.member(jsii_name="internalValue")
    def internal_value(self) -> typing.Optional[ZeroTrustDnsLocationEndpointsIpv6]:
        return typing.cast(typing.Optional[ZeroTrustDnsLocationEndpointsIpv6], jsii.get(self, "internalValue"))

    @internal_value.setter
    def internal_value(
        self,
        value: typing.Optional[ZeroTrustDnsLocationEndpointsIpv6],
    ) -> None:
        if __debug__:
...
class ZeroTrustDnsLocationEndpointsOutputReference(
    ...
    def put_doh(
        ...
        *,
        ...
        :param networks: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.50.0/docs/resources/zero_trust_dns_location#networks ZeroTrustDnsLocation#networks}.
        '''
        value = ZeroTrustDnsLocationEndpointsDoh(enabled=enabled, networks=networks)
    ...
    def doh_input(self) -> typing.Optional[ZeroTrustDnsLocationEndpointsDoh]:
        return typing.cast(typing.Optional[ZeroTrustDnsLocationEndpointsDoh], jsii.get(self, "dohInput"))

    @builtins.property
    @jsii.member(jsii_name="dotInput")
    def dot_input(self) -> typing.Optional[ZeroTrustDnsLocationEndpointsDot]:
        return typing.cast(typing.Optional[ZeroTrustDnsLocationEndpointsDot], jsii.get(self, "dotInput"))

    @builtins.property
    @jsii.member(jsii_name="ipv4Input")
    def ipv4_input(self) -> typing.Optional[ZeroTrustDnsLocationEndpointsIpv4]:
        return typing.cast(typing.Optional[ZeroTrustDnsLocationEndpointsIpv4], jsii.get(self, "ipv4Input"))

    @builtins.property
    @jsii.member(jsii_name="ipv6Input")
    def ipv6_input(self) -> typing.Optional[ZeroTrustDnsLocationEndpointsIpv6]:
        return typing.cast(typing.Optional[ZeroTrustDnsLocationEndpointsIpv6], jsii.get(self, "ipv6Input"))

    @builtins.property
    @jsii.member(jsii_name="internalValue")
    def internal_value(self) -> typing.Optional[ZeroTrustDnsLocationEndpoints]:
        return typing.cast(typing.Optional[ZeroTrustDnsLocationEndpoints], jsii.get(self, "internalValue"))

    @internal_value.setter
    def internal_value(
        self,
        value: typing.Optional[ZeroTrustDnsLocationEndpoints],
    ) -> None:
        if __debug__:
...
def _typecheckingstub__f3063170631f80d548fe95290df067d8e35b626ddb39b4497512e2afca139882(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass
