...
Refer to the Terraform Registry for docs: [`cloudflare_zero_trust_gateway_certificate`](https://registry.terraform.io/providers/cloudflare/cloudflare/4.50.0/docs/resources/zero_trust_gateway_certificate).
'''
...
class ZeroTrustGatewayCertificate(
    ...
    def __init__(
        ...
        *,
        ...
        gateway_managed: typing.Optional[typing.Union[builtins.bool, _cdktf_9a9027ec.IResolvable]] = None,
        ...
        :param account_id: The account identifier to target for the resource. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.50.0/docs/resources/zero_trust_gateway_certificate#account_id ZeroTrustGatewayCertificate#account_id}
        :param activate: Whether or not to activate a certificate. A certificate must be activated to use in Gateway certificate settings. Defaults to ``false``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.50.0/docs/resources/zero_trust_gateway_certificate#activate ZeroTrustGatewayCertificate#activate}
        :param custom: The type of certificate (custom or Gateway-managed). Must provide only one of ``custom``, ``gateway_managed``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.50.0/docs/resources/zero_trust_gateway_certificate#custom ZeroTrustGatewayCertificate#custom}
        :param gateway_managed: The type of certificate (custom or Gateway-managed). Must provide only one of ``custom``, ``gateway_managed``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.50.0/docs/resources/zero_trust_gateway_certificate#gateway_managed ZeroTrustGatewayCertificate#gateway_managed}
        :param id: Certificate UUID. Computed for Gateway-managed certificates. Required when using ``custom``. Conflicts with ``gateway_managed``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.50.0/docs/resources/zero_trust_gateway_certificate#id ZeroTrustGatewayCertificate#id} Please be aware that the id field is automatically added to all resources in Terraform providers using a Terraform provider SDK version below 2. If you experience problems setting this value it might not be settable. Please take a look at the provider documentation to ensure it should be settable.
        :param validity_period_days: Number of days the generated certificate will be valid, minimum 1 day and maximum 30 years. Defaults to 5 years. Defaults to ``1826``. Required when using ``gateway_managed``. Conflicts with ``custom``. **Modifying this attribute will force creation of a new resource.** Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.50.0/docs/resources/zero_trust_gateway_certificate#validity_period_days ZeroTrustGatewayCertificate#validity_period_days}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing ZeroTrustGatewayCertificate that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.50.0/docs/resources/zero_trust_gateway_certificate#import import section} in the documentation of this resource for the id to use
    ...
    @jsii.member(jsii_name="resetGatewayManaged")
    def reset_gateway_managed(self) -> None:
        return typing.cast(None, jsii.invoke(self, "resetGatewayManaged", []))
    ...
    @builtins.property
    @jsii.member(jsii_name="qsPackId")
    def qs_pack_id(self) -> builtins.str:
        return typing.cast(builtins.str, jsii.get(self, "qsPackId"))
    ...
    @builtins.property
    @jsii.member(jsii_name="gatewayManagedInput")
    def gateway_managed_input(
        self,
    ) -> typing.Optional[typing.Union[builtins.bool, _cdktf_9a9027ec.IResolvable]]:
        return typing.cast(typing.Optional[typing.Union[builtins.bool, _cdktf_9a9027ec.IResolvable]], jsii.get(self, "gatewayManagedInput"))
    ...
    def custom(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__79c24af12a0e78512c51cc2d204478156fad3fbac1349280a12a9333c39636b6)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "custom", value) # pyright: ignore[reportArgumentType]

    @builtins.property
    @jsii.member(jsii_name="gatewayManaged")
    def gateway_managed(
        self,
    ) -> typing.Union[builtins.bool, _cdktf_9a9027ec.IResolvable]:
        return typing.cast(typing.Union[builtins.bool, _cdktf_9a9027ec.IResolvable], jsii.get(self, "gatewayManaged"))
    ...
    def gateway_managed(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__63d03f9c4deb0011b36d7975e982db9c94179ad93c1dee2ff8cb7a6103a6968a)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "gatewayManaged", value) # pyright: ignore[reportArgumentType]
    ...
    def id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__798dc48563be0eabb657f60c257b9e7b849d2ff764812d0e0e4d27bb93e670c8)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class ZeroTrustGatewayCertificateConfig(_cdktf_9a9027ec.TerraformMetaArguments):
    def __init__(
        ...
        *,
        ...
        if __debug__:
            ...
            check_type(argname="argument gateway_managed", value=gateway_managed, expected_type=type_hints["gateway_managed"])
        ...
        if gateway_managed is not None:
            self._values["gateway_managed"] = gateway_managed
        if id is not None:
            self._values["id"] = id
    ...
    def gateway_managed(
        ...
        '''
        result = self._values.get("gateway_managed")
        return typing.cast(typing.Optional[typing.Union[builtins.bool, _cdktf_9a9027ec.IResolvable]], result)
...
def _typecheckingstub__79c24af12a0e78512c51cc2d204478156fad3fbac1349280a12a9333c39636b6(
    value: typing.Union[builtins.bool, _cdktf_9a9027ec.IResolvable],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__63d03f9c4deb0011b36d7975e982db9c94179ad93c1dee2ff8cb7a6103a6968a(
    value: typing.Union[builtins.bool, _cdktf_9a9027ec.IResolvable],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__798dc48563be0eabb657f60c257b9e7b849d2ff764812d0e0e4d27bb93e670c8(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass
