...
Refer to the Terraform Registry for docs: [`cloudflare_cloud_connector_rules`](https://registry.terraform.io/providers/cloudflare/cloudflare/4.50.0/docs/resources/cloud_connector_rules).
'''
...
class CloudConnectorRules(
    ...
    def __init__(
        ...
        *,
        ...
        '''Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.50.0/docs/resources/cloud_connector_rules cloudflare_cloud_connector_rules} Resource.

        :param scope: The scope in which to define this construct.
        :param id: The scoped construct ID. Must be unique amongst siblings in the same scope
        :param zone_id: The zone identifier to target for the resource. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.50.0/docs/resources/cloud_connector_rules#zone_id CloudConnectorRules#zone_id}
        :param rules: rules block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.50.0/docs/resources/cloud_connector_rules#rules CloudConnectorRules#rules}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing CloudConnectorRules that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.50.0/docs/resources/cloud_connector_rules#import import section} in the documentation of this resource for the id to use
...
class CloudConnectorRulesRules:
    def __init__(
        ...
        *,
        ...
        parameters: typing.Union["CloudConnectorRulesRulesParameters", typing.Dict[builtins.str, typing.Any]],
        provider: builtins.str,
        description: typing.Optional[builtins.str] = None,
        enabled: typing.Optional[typing.Union[builtins.bool, _cdktf_9a9027ec.IResolvable]] = None,
    ) -> None:
        '''
        :param expression: Criteria for an HTTP request to trigger the cloud connector rule. Uses the Firewall Rules expression language based on Wireshark display filters. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.50.0/docs/resources/cloud_connector_rules#expression CloudConnectorRules#expression}
        :param parameters: parameters block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.50.0/docs/resources/cloud_connector_rules#parameters CloudConnectorRules#parameters}
        :param provider: Type of provider. Available values: ``aws_s3``, ``cloudflare_r2``, ``azure_storage``, ``gcp_storage``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.50.0/docs/resources/cloud_connector_rules#provider CloudConnectorRules#provider}
        :param description: Brief summary of the cloud connector rule and its intended use. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.50.0/docs/resources/cloud_connector_rules#description CloudConnectorRules#description}
        :param enabled: Whether the headers rule is active. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.50.0/docs/resources/cloud_connector_rules#enabled CloudConnectorRules#enabled}
        '''
    ...
    @builtins.property
    def parameters(self) -> "CloudConnectorRulesRulesParameters":
        '''parameters block.
        ...
        return typing.cast("CloudConnectorRulesRulesParameters", result)
...
class CloudConnectorRulesRulesOutputReference(
    ...
    def put_parameters(self, *, host: builtins.str) -> None:
        '''
        :param host: Host parameter for cloud connector rule. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.50.0/docs/resources/cloud_connector_rules#host CloudConnectorRules#host}
        '''
...
class CloudConnectorRulesRulesParameters:
    def __init__(self, *, host: builtins.str) -> None:
        '''
        :param host: Host parameter for cloud connector rule. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.50.0/docs/resources/cloud_connector_rules#host CloudConnectorRules#host}
        '''
        if __debug__:
