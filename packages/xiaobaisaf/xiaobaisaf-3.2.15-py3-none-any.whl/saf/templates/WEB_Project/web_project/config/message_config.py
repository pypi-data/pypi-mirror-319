...
class FeiShu_Config(MSG_Config):
    ...
    msg_format          :dict= {"msg_type": "text", "content": {"text": f'{msg} <at user_id="all">所有人</at>'}}
...
class DingDing_Config(MSG_Config):
    ...
    msg_format          :dict= {"msgtype": "text", "text": {"content": msg}, "at": {"isAtAll": "true"}}
...
class WeiXin_Config(MSG_Config):
    ...
    msg_format          :dict= {"msgtype": "text", "text": {"content": msg}, "mentioned_list":["@all"], "mentioned_mobile_list":["@all"]}
    assert_jsonpath     :str = 'errcode'
    assert_value        :int = 0
