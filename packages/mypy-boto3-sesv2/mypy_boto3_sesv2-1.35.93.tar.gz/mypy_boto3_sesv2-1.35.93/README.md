...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-sesv2)](https://pypistats.org/packages/mypy-boto3-sesv2)
...
`mypy-boto3-sesv2` dependency in production. However, there is an issue in
...
`mypy_boto3_sesv2.paginator` module contains type annotations for all
paginators.
