...
class Dataset:
    ...
    def append(self, datasets: List["Dataset"]):
        ...
        self.data_files_df = pd.concat([self.data_files_df] + data_file_dfs, ignore_index=True)
        self.annotations_df = pd.concat([self.annotations_df] + annotations_dfs, ignore_index=True)
