...
class IntSlider:
    ...
    def __init__(self, value, min=0, max=10, step=1, description='Test:', disabled=False, continuous_update=False,
...
class FloatSlider:
    def __init__(self, value, min=0, max=10, step=0.1, description='Test:', disabled=False, continuous_update=False,
                 orientation='horizontal', readout=True, readout_format='d'):
        """
...
class FloatLogSlider:
    def __init__(self, value=10, base=10, min=-10, max=10, step=0.2, description='Test:', disabled=False,
...
class IntRangeSlider:
    def __init__(self, values, min=0, max=10, step=1, description='Test:', disabled=False, continuous_update=False,
                 orientation='horizontal', readout=True, readout_format='d'):
        """
...
class FloatRangeSlider:
    def __init__(self, values, min=0, max=10, step=0.1, description='Test:', disabled=False, continuous_update=False,
                 orientation='horizontal', readout=True, readout_format='d'):
        """
