...
class App:
    ...
    def clarity(self):
        ...
        from .components.angular import clarity
        return clarity.Package(self.server.page, self)

    @property
    def bootstrap(self):
        """ Load Angular Bootstrap components """
        from .components.angular import bootstrap
