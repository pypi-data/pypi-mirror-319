...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-sagemaker-geospatial)](https://pypistats.org/packages/mypy-boto3-sagemaker-geospatial)
...
`mypy-boto3-sagemaker-geospatial` dependency in production. However, there is
