...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-pinpoint-sms-voice)](https://pypistats.org/packages/mypy-boto3-pinpoint-sms-voice)
...
`mypy-boto3-pinpoint-sms-voice` dependency in production. However, there is an
