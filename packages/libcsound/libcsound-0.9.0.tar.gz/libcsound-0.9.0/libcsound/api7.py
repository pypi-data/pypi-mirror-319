...
class Csound:
    ...
    def performanceThread(self, withProcessQueue=False) -> PerformanceThread:
        ...
        if self._perfthread is None:
            self._perfthread = PerformanceThread(self, withProcessQueue=withProcessQueue)
    ...
    def setControlChannel(self, name: str, val: float) -> None:
        ...
        .. code-block:: python
            ...
            # in the next cycle
            thread.task(lambda cs: cs.setControlChannel('foo', 20))
...
class PerformanceThread:
    ...
    def task(self, func: _t.Callable[[Csound], None]) -> None:
        """
        ...
        .. note::
            this sets the process callback for this thread. It will fail if the
