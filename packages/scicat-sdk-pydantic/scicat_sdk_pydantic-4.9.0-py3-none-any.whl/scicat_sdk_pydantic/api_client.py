...
import scicat_sdk_pydantic.models
from scicat_sdk_pydantic import rest
from scicat_sdk_pydantic.exceptions import ApiValueError, ApiException
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(scicat_sdk_pydantic.models, klass)
