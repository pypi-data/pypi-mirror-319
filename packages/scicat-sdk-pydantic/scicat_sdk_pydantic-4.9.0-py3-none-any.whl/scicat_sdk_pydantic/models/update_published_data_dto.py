...
class UpdatePublishedDataDto(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UpdatePublishedDataDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UpdatePublishedDataDto:
        """Create an instance of UpdatePublishedDataDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UpdatePublishedDataDto.parse_obj(obj)

        _obj = UpdatePublishedDataDto.parse_obj({
            "doi": obj.get("doi"),
