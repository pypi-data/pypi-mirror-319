...
class SampleWithAttachmentsAndDatasets(BaseModel):
    ...
    attachments: Optional[conlist(Attachment)] = Field(default=None, description="Attachments that are related to this sample.")
    datasets: Optional[conlist(DatasetClass)] = Field(default=None, description="Datasets that are related to this sample.")
    __properties = ["createdBy", "updatedBy", "createdAt", "updatedAt", "ownerGroup", "accessGroups", "instrumentGroup", "isPublished", "sampleId", "owner", "description", "sampleCharacteristics", "attachments", "datasets"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SampleWithAttachmentsAndDatasets:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SampleWithAttachmentsAndDatasets:
        """Create an instance of SampleWithAttachmentsAndDatasets from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SampleWithAttachmentsAndDatasets.parse_obj(obj)

        _obj = SampleWithAttachmentsAndDatasets.parse_obj({
            ...
            "datasets": [DatasetClass.from_dict(_item) for _item in obj.get("datasets")] if obj.get("datasets") is not None else None
        })
        return _obj
