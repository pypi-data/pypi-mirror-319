...
class UpdateDatasetDto(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UpdateDatasetDto:
        """Create an instance of UpdateDatasetDto from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UpdateDatasetDto:
        """Create an instance of UpdateDatasetDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UpdateDatasetDto.parse_obj(obj)

        _obj = UpdateDatasetDto.parse_obj({
