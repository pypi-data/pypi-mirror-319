...
class CreateMeasurementPeriodDto(BaseModel):
    ...
    __properties = ["instrument", "start", "end", "comment"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateMeasurementPeriodDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateMeasurementPeriodDto:
        """Create an instance of CreateMeasurementPeriodDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateMeasurementPeriodDto.parse_obj(obj)

        _obj = CreateMeasurementPeriodDto.parse_obj({
