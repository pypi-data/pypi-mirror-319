...
class CreateSampleDto(BaseModel):
    ...
    sample_id: Optional[StrictStr] = Field(default=None, alias="sampleId", description="Globally unique identifier of a sample. This could be provided as an input value or generated by the system.")
    __properties = ["ownerGroup", "accessGroups", "instrumentGroup", "owner", "description", "sampleCharacteristics", "isPublished", "sampleId"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateSampleDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateSampleDto:
        """Create an instance of CreateSampleDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateSampleDto.parse_obj(obj)

        _obj = CreateSampleDto.parse_obj({
