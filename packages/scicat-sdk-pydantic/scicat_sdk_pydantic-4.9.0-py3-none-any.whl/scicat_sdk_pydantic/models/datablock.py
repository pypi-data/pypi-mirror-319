...
class Datablock(BaseModel):
    ...
    dataset_id: StrictStr = Field(default=..., alias="datasetId", description="PID of the dataset to which the datablock belongs.")
    ...
    data_file_list: conlist(DataFile) = Field(default=..., alias="dataFileList", description="Embedded schema definition for each file.")
    __properties = ["createdBy", "updatedBy", "createdAt", "updatedAt", "ownerGroup", "accessGroups", "instrumentGroup", "isPublished", "_id", "datasetId", "archiveId", "size", "packedSize", "chkAlg", "version", "dataFileList"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Datablock:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Datablock:
        """Create an instance of Datablock from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return Datablock.parse_obj(obj)

        _obj = Datablock.parse_obj({
