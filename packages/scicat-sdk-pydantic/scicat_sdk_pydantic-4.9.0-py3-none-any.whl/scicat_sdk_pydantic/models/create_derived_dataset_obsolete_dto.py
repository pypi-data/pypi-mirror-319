...
class CreateDerivedDatasetObsoleteDto(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateDerivedDatasetObsoleteDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateDerivedDatasetObsoleteDto:
        """Create an instance of CreateDerivedDatasetObsoleteDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateDerivedDatasetObsoleteDto.parse_obj(obj)

        _obj = CreateDerivedDatasetObsoleteDto.parse_obj({
