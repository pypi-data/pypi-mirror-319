...
class UpdateAttachmentDto(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UpdateAttachmentDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UpdateAttachmentDto:
        """Create an instance of UpdateAttachmentDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UpdateAttachmentDto.parse_obj(obj)

        _obj = UpdateAttachmentDto.parse_obj({
