...
class HealthControllerCheck200Response(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> HealthControllerCheck200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> HealthControllerCheck200Response:
        """Create an instance of HealthControllerCheck200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return HealthControllerCheck200Response.parse_obj(obj)

        _obj = HealthControllerCheck200Response.parse_obj({
