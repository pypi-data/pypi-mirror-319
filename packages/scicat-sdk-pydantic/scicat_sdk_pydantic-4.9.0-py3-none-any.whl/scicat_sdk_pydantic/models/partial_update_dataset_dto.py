...
class PartialUpdateDatasetDto(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PartialUpdateDatasetDto:
        """Create an instance of PartialUpdateDatasetDto from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PartialUpdateDatasetDto:
        """Create an instance of PartialUpdateDatasetDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PartialUpdateDatasetDto.parse_obj(obj)

        _obj = PartialUpdateDatasetDto.parse_obj({
