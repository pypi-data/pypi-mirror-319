...
import time
import scicat_sdk_pydantic
from scicat_sdk_pydantic.rest import ApiException
from pprint import pprint

# Defining the host is optional and defaults to http://localhost
# See configuration.py for a list of all supported configuration parameters.
configuration = scicat_sdk_pydantic.Configuration(
    host = "http://localhost"
)
...
with scicat_sdk_pydantic.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = scicat_sdk_pydantic.AdminApi(api_client)
