...
from scicat_sdk_pydantic.models.create_dataset_dto import CreateDatasetDto  # noqa: E501
...
class TestCreateDatasetDto(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CreateDatasetDto:
        """Test CreateDatasetDto
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateDatasetDto`
        """
        model = CreateDatasetDto()  # noqa: E501
        if include_optional:
