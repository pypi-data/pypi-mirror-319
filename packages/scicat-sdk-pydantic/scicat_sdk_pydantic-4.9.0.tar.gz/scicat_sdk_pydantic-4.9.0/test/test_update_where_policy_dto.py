...
from scicat_sdk_pydantic.models.update_where_policy_dto import UpdateWherePolicyDto  # noqa: E501
...
class TestUpdateWherePolicyDto(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> UpdateWherePolicyDto:
        ...
        """
        model = UpdateWherePolicyDto()  # noqa: E501
        if include_optional:
            return UpdateWherePolicyDto(
                owner_group_list = '',
                data = scicat_sdk_pydantic.models.update_policy_dto.UpdatePolicyDto(
                    owner_group = '', 
                    access_groups = [
                        ''
                        ], 
