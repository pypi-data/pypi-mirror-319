...
from scicat_sdk_pydantic.models.create_job_dto import CreateJobDto  # noqa: E501
    ...
    def make_instance(self, include_optional) -> CreateJobDto:
        ...
        if include_optional:
            return CreateJobDto(
                ...
                job_params = None,
                dataset_list = [
                    scicat_sdk_pydantic.models.i_dataset_list.IDatasetList(
                        pid = '', 
                        files = [
                            ''
                            ], )
