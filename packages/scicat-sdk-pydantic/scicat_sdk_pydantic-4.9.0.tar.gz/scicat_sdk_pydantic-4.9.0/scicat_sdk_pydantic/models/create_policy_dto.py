...
class CreatePolicyDto(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreatePolicyDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreatePolicyDto:
        """Create an instance of CreatePolicyDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreatePolicyDto.parse_obj(obj)

        _obj = CreatePolicyDto.parse_obj({
