...
class UpdateRawDatasetObsoleteDto(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UpdateRawDatasetObsoleteDto:
        """Create an instance of UpdateRawDatasetObsoleteDto from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UpdateRawDatasetObsoleteDto:
        """Create an instance of UpdateRawDatasetObsoleteDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UpdateRawDatasetObsoleteDto.parse_obj(obj)

        _obj = UpdateRawDatasetObsoleteDto.parse_obj({
