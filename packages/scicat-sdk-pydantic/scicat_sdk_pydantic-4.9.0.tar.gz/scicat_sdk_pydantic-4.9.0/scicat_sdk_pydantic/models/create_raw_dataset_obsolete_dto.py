...
class CreateRawDatasetObsoleteDto(BaseModel):
    """
    ...
    input_datasets: Optional[conlist(StrictStr)] = Field(default=None, alias="inputDatasets")
    used_software: Optional[conlist(StrictStr)] = Field(default=None, alias="usedSoftware")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateRawDatasetObsoleteDto:
        """Create an instance of CreateRawDatasetObsoleteDto from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateRawDatasetObsoleteDto:
        """Create an instance of CreateRawDatasetObsoleteDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateRawDatasetObsoleteDto.parse_obj(obj)

        _obj = CreateRawDatasetObsoleteDto.parse_obj({
