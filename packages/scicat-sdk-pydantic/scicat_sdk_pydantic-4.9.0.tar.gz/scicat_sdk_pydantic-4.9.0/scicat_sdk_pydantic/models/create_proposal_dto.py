...
class CreateProposalDto(BaseModel):
    ...
    __properties = ["ownerGroup", "accessGroups", "instrumentGroup", "pi_email", "pi_firstname", "pi_lastname", "email", "firstname", "lastname", "title", "abstract", "startTime", "endTime", "MeasurementPeriodList", "metadata", "parentProposalId", "type", "proposalId"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateProposalDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateProposalDto:
        """Create an instance of CreateProposalDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateProposalDto.parse_obj(obj)

        _obj = CreateProposalDto.parse_obj({
