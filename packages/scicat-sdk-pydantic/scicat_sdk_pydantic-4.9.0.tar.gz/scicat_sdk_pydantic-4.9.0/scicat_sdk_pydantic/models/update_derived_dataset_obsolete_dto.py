...
class UpdateDerivedDatasetObsoleteDto(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UpdateDerivedDatasetObsoleteDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UpdateDerivedDatasetObsoleteDto:
        """Create an instance of UpdateDerivedDatasetObsoleteDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UpdateDerivedDatasetObsoleteDto.parse_obj(obj)

        _obj = UpdateDerivedDatasetObsoleteDto.parse_obj({
