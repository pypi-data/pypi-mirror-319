...
class PartialUpdateRawDatasetObsoleteDto(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PartialUpdateRawDatasetObsoleteDto:
        """Create an instance of PartialUpdateRawDatasetObsoleteDto from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PartialUpdateRawDatasetObsoleteDto:
        """Create an instance of PartialUpdateRawDatasetObsoleteDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PartialUpdateRawDatasetObsoleteDto.parse_obj(obj)

        _obj = PartialUpdateRawDatasetObsoleteDto.parse_obj({
