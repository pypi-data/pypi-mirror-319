...
class UpdateOrigDatablockDto(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UpdateOrigDatablockDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UpdateOrigDatablockDto:
        """Create an instance of UpdateOrigDatablockDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UpdateOrigDatablockDto.parse_obj(obj)

        _obj = UpdateOrigDatablockDto.parse_obj({
