...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-qldb-session)](https://pypistats.org/packages/mypy-boto3-qldb-session)

![boto3.typed](https://github.com/youtype/mypy_boto3_builder/raw/main/logo.png)

Type annotations for
[boto3 QLDBSession 1.35.93](https://pypi.org/project/boto3/) compatible with
...
`mypy-boto3-qldb-session` dependency in production. However, there is an issue
