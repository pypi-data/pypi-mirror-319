...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-sdb)](https://pypistats.org/packages/mypy-boto3-sdb)
...
`mypy-boto3-sdb` dependency in production. However, there is an issue in
