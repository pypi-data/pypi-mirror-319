...
Handler: te.TypeAlias = t.Callable[
    [
        "CachingSerDeserializer[IN, OUT]",
        IN,
        t.Type[OUT],
    ],
    OUT,
...
class CachingSerDeserializer(ABC, t.Generic[IN, OUT]):
    """
    ...
    def __init_subclass__(cls) -> None:
        ...
        def make_handler_from_passthrough_type(
            passthrough_type: t.Type,
        ) -> Handler:
            def result(self, value: IN, as_type: t.Type[OUT]) -> OUT:
    ...
    def __init__(
        self,
        *,
        custom_deserializers: dict[t.Type, t.Callable[[IN, t.Type[OUT]], OUT]],
        lazy: bool,
    ):
    ...
    def process(self, value: IN, as_type: t.Type[OUT]) -> OUT:
    ...
    def _create_fieldwise_class_handler(self, value_type: t.Type) -> Handler:
        # Lazy?
...
class FieldwiseClassHandler:
    ...
    fields: list[tuple[str, str, t.Type, Handler]]
