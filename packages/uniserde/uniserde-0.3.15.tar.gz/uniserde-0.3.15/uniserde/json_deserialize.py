...
class JsonDeserializer(caching_serdeserializer.CachingSerDeserializer[Jsonable, t.Any]):
    ...
    def _deserialize_uuid_from_str(
        self,
        value: t.Any,
        value_type: t.Type[uuid.UUID],
    ) -> uuid.UUID:
        if not isinstance(value, str):
            raise SerdeError(f"Expected UUID string, got `{value}`")

        try:
            return uuid.UUID(value)
        except ValueError:
            raise SerdeError(f"`{value}` is not a valid UUID") from None
    ...
    _handler_cache = {
        ...
        (True, t.Union): _deserialize_optional,
        (False, t.Union): _deserialize_optional,
        (True, t.Any): _deserialize_any,
        (False, t.Any): _deserialize_any,
        (True, ObjectId): _deserialize_object_id_from_str,
        (False, ObjectId): _deserialize_object_id_from_str,
        (True, t.Literal): _deserialize_literal_as_is,
        (False, t.Literal): _deserialize_literal_as_is,
        ...
        (True, uuid.UUID): _deserialize_uuid_from_str,
        (False, uuid.UUID): _deserialize_uuid_from_str,
    }  # type: ignore
