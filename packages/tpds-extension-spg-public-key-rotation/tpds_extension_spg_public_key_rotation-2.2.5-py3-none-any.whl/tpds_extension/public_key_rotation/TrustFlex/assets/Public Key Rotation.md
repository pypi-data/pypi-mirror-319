# Trust Platform Design Suite - Usecase Help - Public Key Rotation
...
## Pre Usecase transaction Steps
 ...
 - Note that *~/.trustplatform/spg_public_key_rotation* is the **Usecase working directory**. It contains the resources generated during transaction diagram execution.
