...
from _bos_client_imp import ObjectInfo, GetObjectStream


class BosReader(io.BufferedIOBase):
    """A read-only, file like representation of a single object stored in BOS."""
    ...
    def prefetch(self) -> None:
        ...
        if self._stream is None:
            self._stream = self._get_stream(self._get_size())
    ...
    def read(self, size: Optional[int] = None) -> bytes:
        ...
        If size is zero or positive, read that many bytes from BOS, or until the end of the object.
        ...
        Returns:
            bytes: Bytes read from BOS Object
