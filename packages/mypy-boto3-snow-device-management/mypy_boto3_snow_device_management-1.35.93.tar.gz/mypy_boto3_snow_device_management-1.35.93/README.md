...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-snow-device-management)](https://pypistats.org/packages/mypy-boto3-snow-device-management)
...
`mypy-boto3-snow-device-management` dependency in production. However, there is
