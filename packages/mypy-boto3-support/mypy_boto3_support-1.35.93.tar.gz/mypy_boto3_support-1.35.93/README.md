...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-support)](https://pypistats.org/packages/mypy-boto3-support)
...
`mypy-boto3-support` dependency in production. However, there is an issue in
