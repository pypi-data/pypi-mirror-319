...
import hexdoc_oneironaut

from .__gradle_version__ import FULL_VERSION, GRADLE_VERSION
from .__version__ import PY_VERSION


class OneironautPlugin(ModPluginImpl):
    @staticmethod
    @hookimpl
    def hexdoc_mod_plugin(branch: str) -> ModPlugin:
        return OneironautModPlugin(branch=branch)


class OneironautModPlugin(ModPluginWithBook):
    @property
    @override
    def modid(self) -> str:
        return "oneironaut"
    ...
    def jinja_template_root(self) -> tuple[Package, str]:
        return hexdoc_oneironaut, "_templates"
