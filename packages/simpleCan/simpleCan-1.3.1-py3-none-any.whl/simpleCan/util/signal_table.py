# -*- coding: UTF-8 -*-
'''
@File    :   signal_table.py
@Time    :   2025/01/06 15:30:00
@Author  :   Jiajie Liu
@Version :   1.0
@Contact :   ljj26god@163.com
@Desc    :   This file contains reads a excel file to set up CAN message environemnt. It also creates a list of tasks to manage all the tasks.
'''
