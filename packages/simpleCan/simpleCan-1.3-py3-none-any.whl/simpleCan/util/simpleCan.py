...
@Desc    :   This file is the main class of simpleCan package. It provides all the necessary interfaces.
'''
import logging
...
class SimpleCan:
    ...
    def generate_msg(self, message_id, data):
        return ds.CanMessage(id = message_id, data = data, period=0, duration=0)

    def send_signal(self, CanMessage, period, duration = 30):
        self.sendMessage(message_id=CanMessage.id, data = CanMessage.data, period=period, duration = duration)
