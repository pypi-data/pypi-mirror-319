...
class QSvgRenderer(PySide6.QtCore.QObject):
    ...
    @typing.overload
    def __init__(self, contents: PySide6.QtCore.QXmlStreamReader, parent: PySide6.QtCore.QObject | None= ...) -> None: ...
    @typing.overload
    def __init__(self, filename: str, parent: PySide6.QtCore.QObject | None= ...) -> None: ...
    @typing.overload
    def __init__(self, parent: PySide6.QtCore.QObject | None= ...) -> None: ...
    @typing.overload
    def __init__(self, contents: PySide6.QtCore.QByteArray | bytes | bytearray | memoryview, parent: PySide6.QtCore.QObject | None= ...) -> None: ...
