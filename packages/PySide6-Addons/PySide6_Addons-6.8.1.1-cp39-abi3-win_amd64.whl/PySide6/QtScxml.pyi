...
class QScxmlDynamicScxmlServiceFactory(PySide6.QtScxml.QScxmlInvokableServiceFactory):
    ...
    def __init__(self, invokeInfo: PySide6.QtScxml.QScxmlExecutableContent.InvokeInfo, names: typing.Sequence[int], parameters: typing.Sequence[PySide6.QtScxml.QScxmlExecutableContent.ParameterInfo], parent: PySide6.QtCore.QObject | None= ...) -> None: ...
...
class QScxmlStateMachine(PySide6.QtCore.QObject):
    ...
    def __init__(self, metaObject: PySide6.QtCore.QMetaObject, parent: PySide6.QtCore.QObject | None= ...) -> None: ...
...
class QScxmlStaticScxmlServiceFactory(PySide6.QtScxml.QScxmlInvokableServiceFactory):
    ...
    def __init__(self, metaObject: PySide6.QtCore.QMetaObject, invokeInfo: PySide6.QtScxml.QScxmlExecutableContent.InvokeInfo, nameList: typing.Sequence[int], parameters: typing.Sequence[PySide6.QtScxml.QScxmlExecutableContent.ParameterInfo], parent: PySide6.QtCore.QObject | None= ...) -> None: ...
