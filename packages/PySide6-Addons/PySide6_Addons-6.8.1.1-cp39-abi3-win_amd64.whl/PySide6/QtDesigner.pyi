...
class QDesignerFormWindowInterface(PySide6.QtWidgets.QWidget):
    ...
    def activateResourceFilePaths(self, paths: typing.Sequence[str]) -> typing.Tuple[int, str]: ...
    ...
    def simplifySelection(self, widgets: typing.Sequence[PySide6.QtWidgets.QWidget]) -> None: ...
...
class QDesignerFormWindowManagerInterface(PySide6.QtCore.QObject):
    ...
    def dragItems(self, item_list: typing.Sequence[PySide6.QtDesigner.QDesignerDnDItemInterface]) -> None: ...
...
class QDesignerWidgetBoxInterface(PySide6.QtWidgets.QWidget):
    ...
    def dropWidgets(self, item_list: typing.Sequence[PySide6.QtDesigner.QDesignerDnDItemInterface], global_mouse_pos: PySide6.QtCore.QPoint) -> None: ...
    def fileName(self) -> str: ...
