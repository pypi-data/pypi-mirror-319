...
class QWebEngineView(PySide6.QtWidgets.QWidget):
    ...
    @typing.overload
    def __init__(self, page: PySide6.QtWebEngineCore.QWebEnginePage, parent: PySide6.QtWidgets.QWidget | None= ...) -> None: ...
    @typing.overload
    def __init__(self, profile: PySide6.QtWebEngineCore.QWebEngineProfile, parent: PySide6.QtWidgets.QWidget | None= ...) -> None: ...
    @typing.overload
