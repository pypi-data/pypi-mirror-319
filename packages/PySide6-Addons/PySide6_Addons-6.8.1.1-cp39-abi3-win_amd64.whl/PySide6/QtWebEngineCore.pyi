...
class QWebEngineCookieStore(PySide6.QtCore.QObject):
    ...
    def setCookieFilter(self, filterCallback: typing.Callable[..., typing.Any]) -> None: ...


class QWebEngineDesktopMediaRequest(Shiboken.Object):

    def __init__(self, other: PySide6.QtWebEngineCore.QWebEngineDesktopMediaRequest) -> None: ...
...
class QWebEngineFrame(Shiboken.Object):
    ...
    @typing.overload
    def printToPdf(self, resultCallback: typing.Callable[..., typing.Any]) -> None: ...
    @typing.overload
    def runJavaScript(self, scriptSource: str, resultCallback: typing.Callable[..., typing.Any]) -> None: ...
    @typing.overload
    def runJavaScript(self, scriptSource: str, worldId: int, resultCallback: typing.Callable[..., typing.Any] = ...) -> None: ...
...
class QWebEnginePage(PySide6.QtCore.QObject):
    ...
    @typing.overload
    def __init__(self, profile: PySide6.QtWebEngineCore.QWebEngineProfile, parent: PySide6.QtCore.QObject | None= ...) -> None: ...
    @typing.overload
    ...
    def chooseFiles(self, mode: PySide6.QtWebEngineCore.QWebEnginePage.FileSelectionMode, oldFiles: typing.Sequence[str], acceptedMimeTypes: typing.Sequence[str]) -> typing.List[str]: ...
    ...
    @typing.overload
    def findText(self, subString: str, options: PySide6.QtWebEngineCore.QWebEnginePage.FindFlag, resultCallback: typing.Callable[..., typing.Any]) -> None: ...
    ...
    @typing.overload
    def printToPdf(self, resultCallback: typing.Callable[..., typing.Any], pageLayout: PySide6.QtGui.QPageLayout = ..., ranges: PySide6.QtGui.QPageRanges = ...) -> None: ...
    ...
    def title(self) -> str: ...
    def toHtml(self, resultCallback: typing.Callable[..., typing.Any]) -> None: ...
    def toPlainText(self, resultCallback: typing.Callable[..., typing.Any]) -> None: ...
...
class QWebEnginePermission(Shiboken.Object):
    ...
    def __init__(self) -> None: ...
    @typing.overload
    def __init__(self, other: PySide6.QtWebEngineCore.QWebEnginePermission) -> None: ...
...
class QWebEngineProfile(PySide6.QtCore.QObject):
    ...
    def clearVisitedLinks(self, urls: typing.Sequence[PySide6.QtCore.QUrl]) -> None: ...
    ...
    def setNotificationPresenter(self, notificationPresenter: typing.Callable[..., typing.Any]) -> None: ...
...
class QWebEngineScriptCollection(Shiboken.Object):
    ...
    @typing.overload
    def insert(self, list: typing.Sequence[PySide6.QtWebEngineCore.QWebEngineScript]) -> None: ...
