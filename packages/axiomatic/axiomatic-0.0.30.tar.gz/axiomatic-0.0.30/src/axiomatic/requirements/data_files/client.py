...
class DataFilesClient:
    ...
    def retrieve(self, *, request_options: typing.Optional[RequestOptions] = None) -> typing.Optional[typing.Any]:
        """
...
class AsyncDataFilesClient:
    ...
    async def retrieve(self, *, request_options: typing.Optional[RequestOptions] = None) -> typing.Optional[typing.Any]:
        """
        Provides database for user menu later used to compose reqs in AXtract
        ...
        async def main() -> None:
            await client.requirements.data_files.retrieve()
