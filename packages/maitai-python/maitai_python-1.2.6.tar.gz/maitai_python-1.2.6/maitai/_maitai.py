...
class Maitai:
    def __init__(
        ...
        *,
        ...
        if api_key:
            raise ValueError(
                "api_key is deprecated. Use provider specific keys instead. Supported variables: openai_api_key, groq_api_key, anthropic_api_key, cerebras_api_key, azure_api_key"
            )
        if openai_api_key:
