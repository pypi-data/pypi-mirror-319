...
class Model(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["created_at", "updated_at", "id", "project_id", "name", "description", "dataset_id", "last_updated_by_user", "metric_config", "schedule", "arthur_shield_dataset", "model_problem_types", "datasets"]
