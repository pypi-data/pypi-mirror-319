...
setup(
    ...
    description="Type annotations for boto3 SSOAdmin 1.35.93 service generated with mypy-boto3-builder 8.8.0",
    classifiers=[
    ...
    package_data={"types_boto3_sso_admin": ["py.typed", "*.pyi"]},
    python_requires=">=3.8",
    project_urls={
