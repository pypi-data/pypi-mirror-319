...
def argmax(output, input, axis, *, loc=None, ip=None) -> _ods_ir.Value:
  return ArgMaxOp(output=output, input=input, axis=axis, loc=loc, ip=ip).result
...
class AvgPool2dOp(_ods_ir.OpView):
  ...
  def __init__(self, output, input, kernel, stride, pad, acc_type, *, quantization_info=None, loc=None, ip=None):
    ...
    not _ods_ir.AttrBuilder.contains('anonymous_515')) else
      _ods_ir.AttrBuilder.get('anonymous_515')(acc_type, context=_ods_context))
...
def avg_pool2d(output, input, kernel, stride, pad, acc_type, *, quantization_info=None, loc=None, ip=None) -> _ods_ir.Value:
  return AvgPool2dOp(output=output, input=input, kernel=kernel, stride=stride, pad=pad, acc_type=acc_type, quantization_info=quantization_info, loc=loc, ip=ip).result
...
def clamp(output, input, min_int, max_int, min_fp, max_fp, *, loc=None, ip=None) -> _ods_ir.Value:
  return ClampOp(output=output, input=input, min_int=min_int, max_int=max_int, min_fp=min_fp, max_fp=max_fp, loc=loc, ip=ip).result
...
def conv2d(output, input, weight, bias, pad, stride, dilation, *, quantization_info=None, local_bound=None, loc=None, ip=None) -> _ods_ir.Value:
  return Conv2DOp(output=output, input=input, weight=weight, bias=bias, pad=pad, stride=stride, dilation=dilation, quantization_info=quantization_info, local_bound=local_bound, loc=loc, ip=ip).result
...
def conv3d(output, input, weight, bias, pad, stride, dilation, *, quantization_info=None, local_bound=None, loc=None, ip=None) -> _ods_ir.Value:
  return Conv3DOp(output=output, input=input, weight=weight, bias=bias, pad=pad, stride=stride, dilation=dilation, quantization_info=quantization_info, local_bound=local_bound, loc=loc, ip=ip).result
...
def depthwise_conv2d(output, input, weight, bias, pad, stride, dilation, *, quantization_info=None, local_bound=None, loc=None, ip=None) -> _ods_ir.Value:
  return DepthwiseConv2DOp(output=output, input=input, weight=weight, bias=bias, pad=pad, stride=stride, dilation=dilation, quantization_info=quantization_info, local_bound=local_bound, loc=loc, ip=ip).result
...
def fully_connected(output, input, weight, bias, *, quantization_info=None, loc=None, ip=None) -> _ods_ir.Value:
  return FullyConnectedOp(output=output, input=input, weight=weight, bias=bias, quantization_info=quantization_info, loc=loc, ip=ip).result
...
def matmul(c, a, b, *, quantization_info=None, loc=None, ip=None) -> _ods_ir.Value:
  return MatMulOp(c=c, a=a, b=b, quantization_info=quantization_info, loc=loc, ip=ip).result
...
def max_pool2d(output, input, kernel, stride, pad, *, loc=None, ip=None) -> _ods_ir.Value:
  return MaxPool2dOp(output=output, input=input, kernel=kernel, stride=stride, pad=pad, loc=loc, ip=ip).result
...
def maximum(output, input1, input2, *, loc=None, ip=None) -> _ods_ir.Value:
  return MaximumOp(output=output, input1=input1, input2=input2, loc=loc, ip=ip).result
...
def minimum(output, input1, input2, *, loc=None, ip=None) -> _ods_ir.Value:
  return MinimumOp(output=output, input1=input1, input2=input2, loc=loc, ip=ip).result
...
def negate(output, input1, *, quantization_info=None, loc=None, ip=None) -> _ods_ir.Value:
  return NegateOp(output=output, input1=input1, quantization_info=quantization_info, loc=loc, ip=ip).result
...
def pad(output, input1, padding, *, pad_const=None, quantization_info=None, loc=None, ip=None) -> _ods_ir.Value:
  return PadOp(output=output, input1=input1, padding=padding, pad_const=pad_const, quantization_info=quantization_info, loc=loc, ip=ip).result
...
def reduce_max(input, axis, *, loc=None, ip=None) -> _ods_ir.Value:
  return ReduceMaxOp(input=input, axis=axis, loc=loc, ip=ip).result
...
def reduce_min(input, axis, *, loc=None, ip=None) -> _ods_ir.Value:
  return ReduceMinOp(input=input, axis=axis, loc=loc, ip=ip).result
...
def reshape(input1, new_shape, *, loc=None, ip=None) -> _ods_ir.Value:
  return ReshapeOp(input1=input1, new_shape=new_shape, loc=loc, ip=ip).result
...
def select(output, pred, on_true, on_false, *, loc=None, ip=None) -> _ods_ir.Value:
  return SelectOp(output=output, pred=pred, on_true=on_true, on_false=on_false, loc=loc, ip=ip).result
...
def transpose_conv2d(output, input, filter, bias, out_pad, stride, out_shape, *, quantization_info=None, local_bound=None, loc=None, ip=None) -> _ods_ir.Value:
  return TransposeConv2DOp(output=output, input=input, filter=filter, bias=bias, out_pad=out_pad, stride=stride, out_shape=out_shape, quantization_info=quantization_info, local_bound=local_bound, loc=loc, ip=ip).result
