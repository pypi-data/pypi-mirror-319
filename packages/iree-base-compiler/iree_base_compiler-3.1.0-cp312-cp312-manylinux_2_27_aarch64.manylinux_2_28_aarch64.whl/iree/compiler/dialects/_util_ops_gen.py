...
class CallOp(_ods_ir.OpView):
  ...
  def __init__(self, results_, callee, operands_, *, tied_operands=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
def call(results_, callee, operands_, *, tied_operands=None, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(CallOp(results_=results_, callee=callee, operands_=operands_, tied_operands=tied_operands, loc=loc, ip=ip))
