...
def call(results_, callee, operands_, *, loc=None, ip=None) -> _ods_ir.Value:
...
class CallVariadicOp(_ods_ir.OpView):
  ...
  def __init__(self, results_, callee, segment_sizes, segment_types, operands_, *, loc=None, ip=None):
    ...
    not _ods_ir.AttrBuilder.contains('anonymous_1168')) else
      _ods_ir.AttrBuilder.get('anonymous_1168')(segment_sizes, context=_ods_context))
...
def call_variadic(results_, callee, segment_sizes, segment_types, operands_, *, loc=None, ip=None) -> _ods_ir.Value:
...
class ConstF32Op(_ods_ir.OpView):
  ...
  def __init__(self, result, value, *, loc=None, ip=None):
    ...
    not _ods_ir.AttrBuilder.contains('anonymous_760')) else
      _ods_ir.AttrBuilder.get('anonymous_760')(value, context=_ods_context))
    results.append(result)
    _ods_successors = None
    super().__init__(self.build_generic(attributes=attributes, results=results, operands=operands, successors=_ods_successors, regions=regions, loc=loc, ip=ip))
...
class ConstF64Op(_ods_ir.OpView):
  ...
  def __init__(self, result, value, *, loc=None, ip=None):
    ...
    attributes["value"] = (value if (
    isinstance(value, _ods_ir.Attribute) or
    not _ods_ir.AttrBuilder.contains('anonymous_762')) else
      _ods_ir.AttrBuilder.get('anonymous_762')(value, context=_ods_context))
    results.append(result)
    _ods_successors = None
    super().__init__(self.build_generic(attributes=attributes, results=results, operands=operands, successors=_ods_successors, regions=regions, loc=loc, ip=ip))
...
class ConstI32Op(_ods_ir.OpView):
  ...
  def __init__(self, result, value, *, loc=None, ip=None):
    ...
    not _ods_ir.AttrBuilder.contains('anonymous_756')) else
      _ods_ir.AttrBuilder.get('anonymous_756')(value, context=_ods_context))
    results.append(result)
    _ods_successors = None
    super().__init__(self.build_generic(attributes=attributes, results=results, operands=operands, successors=_ods_successors, regions=regions, loc=loc, ip=ip))
...
class ConstI64Op(_ods_ir.OpView):
  ...
  def __init__(self, result, value, *, loc=None, ip=None):
    ...
    attributes["value"] = (value if (
    isinstance(value, _ods_ir.Attribute) or
    not _ods_ir.AttrBuilder.contains('anonymous_758')) else
      _ods_ir.AttrBuilder.get('anonymous_758')(value, context=_ods_context))
    results.append(result)
    _ods_successors = None
    super().__init__(self.build_generic(attributes=attributes, results=results, operands=operands, successors=_ods_successors, regions=regions, loc=loc, ip=ip))
...
class FuncOp(_ods_ir.OpView):
  ...
  def __init__(self, function_type, *, ordinal=None, inlining_policy=None, arg_attrs=None, res_attrs=None, loc=None, ip=None):
    ...
    not _ods_ir.AttrBuilder.contains('anonymous_737')) else
      _ods_ir.AttrBuilder.get('anonymous_737')(function_type, context=_ods_context))
    if ordinal is not None: attributes["ordinal"] = (ordinal if (
        isinstance(ordinal, _ods_ir.Attribute) or
        not _ods_ir.AttrBuilder.contains('VM_Ordinal')) else
          _ods_ir.AttrBuilder.get('VM_Ordinal')(ordinal, context=_ods_context))
...
class GlobalF32Op(_ods_ir.OpView):
  ...
  def __init__(self, sym_name, type_, *, sym_visibility=None, is_mutable=None, initial_value=None, inlining_policy=None, ordinal=None, loc=None, ip=None):
    ...
    if initial_value is not None: attributes["initial_value"] = (initial_value if (
        ...
        not _ods_ir.AttrBuilder.contains('anonymous_760')) else
          _ods_ir.AttrBuilder.get('anonymous_760')(initial_value, context=_ods_context))
    if inlining_policy is not None: attributes["inlining_policy"] = (inlining_policy if (
        isinstance(inlining_policy, _ods_ir.Attribute) or
        not _ods_ir.AttrBuilder.contains('Util_InliningPolicyAttrInterface')) else
          _ods_ir.AttrBuilder.get('Util_InliningPolicyAttrInterface')(inlining_policy, context=_ods_context))
...
class GlobalF64Op(_ods_ir.OpView):
  ...
  def __init__(self, sym_name, type_, *, sym_visibility=None, is_mutable=None, initial_value=None, inlining_policy=None, ordinal=None, loc=None, ip=None):
    ...
    if initial_value is not None: attributes["initial_value"] = (initial_value if (
        isinstance(initial_value, _ods_ir.Attribute) or
        not _ods_ir.AttrBuilder.contains('anonymous_762')) else
          _ods_ir.AttrBuilder.get('anonymous_762')(initial_value, context=_ods_context))
    if inlining_policy is not None: attributes["inlining_policy"] = (inlining_policy if (
        isinstance(inlining_policy, _ods_ir.Attribute) or
        not _ods_ir.AttrBuilder.contains('Util_InliningPolicyAttrInterface')) else
          _ods_ir.AttrBuilder.get('Util_InliningPolicyAttrInterface')(inlining_policy, context=_ods_context))
...
class GlobalI32Op(_ods_ir.OpView):
  ...
  def __init__(self, sym_name, type_, *, sym_visibility=None, is_mutable=None, initial_value=None, inlining_policy=None, ordinal=None, loc=None, ip=None):
    ...
    if initial_value is not None: attributes["initial_value"] = (initial_value if (
        isinstance(initial_value, _ods_ir.Attribute) or
        not _ods_ir.AttrBuilder.contains('anonymous_756')) else
          _ods_ir.AttrBuilder.get('anonymous_756')(initial_value, context=_ods_context))
    if inlining_policy is not None: attributes["inlining_policy"] = (inlining_policy if (
        isinstance(inlining_policy, _ods_ir.Attribute) or
        not _ods_ir.AttrBuilder.contains('Util_InliningPolicyAttrInterface')) else
          _ods_ir.AttrBuilder.get('Util_InliningPolicyAttrInterface')(inlining_policy, context=_ods_context))
...
class GlobalI64Op(_ods_ir.OpView):
  ...
  def __init__(self, sym_name, type_, *, sym_visibility=None, is_mutable=None, initial_value=None, inlining_policy=None, ordinal=None, loc=None, ip=None):
    ...
    if initial_value is not None: attributes["initial_value"] = (initial_value if (
        isinstance(initial_value, _ods_ir.Attribute) or
        not _ods_ir.AttrBuilder.contains('anonymous_758')) else
          _ods_ir.AttrBuilder.get('anonymous_758')(initial_value, context=_ods_context))
    if inlining_policy is not None: attributes["inlining_policy"] = (inlining_policy if (
        isinstance(inlining_policy, _ods_ir.Attribute) or
        not _ods_ir.AttrBuilder.contains('Util_InliningPolicyAttrInterface')) else
          _ods_ir.AttrBuilder.get('Util_InliningPolicyAttrInterface')(inlining_policy, context=_ods_context))
...
class RodataTableInlineOp(_ods_ir.OpView):
  ...
  def __init__(self, table_result, data_result, table_type, data_array, *, table_name=None, data_name=None, alignment=None, data_alignment=None, mime_type=None, loc=None, ip=None):
    ...
    not _ods_ir.AttrBuilder.contains('anonymous_851')) else
      _ods_ir.AttrBuilder.get('anonymous_851')(table_type, context=_ods_context))
