...
def async_call(results_, callee, resource_operands, resource_operand_sizes, resource_operand_offsets, resource_operand_ends, resource_operand_lengths, result_sizes, *, tied_operands=None, affinity=None, loc=None, ip=None) -> _ods_ir.Value:
...
class AsyncFuncOp(_ods_ir.OpView):
  ...
  def __init__(self, sym_name, function_type, *, tied_operands=None, sym_visibility=None, arg_attrs=None, res_attrs=None, loc=None, ip=None):
    ...
    not _ods_ir.AttrBuilder.contains('anonymous_726')) else
      _ods_ir.AttrBuilder.get('anonymous_726')(function_type, context=_ods_context))
    if tied_operands is not None: attributes["tied_operands"] = (tied_operands if (
        isinstance(tied_operands, _ods_ir.Attribute) or
        not _ods_ir.AttrBuilder.contains('Util_TiedOpStorageAttr')) else
          _ods_ir.AttrBuilder.get('Util_TiedOpStorageAttr')(tied_operands, context=_ods_context))
...
def cmd_call(results_, callee, resource_operands, resource_operand_sizes, resource_operand_offsets, resource_operand_lengths, result_sizes, resource_operand_accesses, *, tied_operands=None, loc=None, ip=None) -> _ods_ir.Value:
...
class ResourceConstantsOp(_ods_ir.OpView):
  ...
  def __init__(self, results_, result_timepoint, values, result_sizes, *, affinity=None, loc=None, ip=None):
    ...
    not _ods_ir.AttrBuilder.contains('anonymous_689')) else
      _ods_ir.AttrBuilder.get('anonymous_689')(values, context=_ods_context))
    if affinity is not None: attributes["affinity"] = (affinity if (
        isinstance(affinity, _ods_ir.Attribute) or
        not _ods_ir.AttrBuilder.contains('Stream_AffinityAttr')) else
          _ods_ir.AttrBuilder.get('Stream_AffinityAttr')(affinity, context=_ods_context))
...
class TimepointAwaitOp(_ods_ir.OpView):
  ...
  def __init__(self, results_, resource_operands, resource_operand_sizes, await_timepoint, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
def timepoint_await(results_, resource_operands, resource_operand_sizes, await_timepoint, *, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(TimepointAwaitOp(results_=results_, resource_operands=resource_operands, resource_operand_sizes=resource_operand_sizes, await_timepoint=await_timepoint, loc=loc, ip=ip))
