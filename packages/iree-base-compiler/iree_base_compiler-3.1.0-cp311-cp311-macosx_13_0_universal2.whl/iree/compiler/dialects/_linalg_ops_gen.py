...
class Conv1DNcwFcwOp(_ods_ir.OpView):
  ...
  def __init__(self, result_tensors, inputs, outputs, *, strides=None, dilations=None, loc=None, ip=None):
    ...
    if strides is not None: attributes["strides"] = (strides if (
        ...
        not _ods_ir.AttrBuilder.contains('anonymous_714')) else
          _ods_ir.AttrBuilder.get('anonymous_714')(strides, context=_ods_context))
    if dilations is not None: attributes["dilations"] = (dilations if (
        isinstance(dilations, _ods_ir.Attribute) or
        not _ods_ir.AttrBuilder.contains('anonymous_714')) else
          _ods_ir.AttrBuilder.get('anonymous_714')(dilations, context=_ods_context))
    results.extend(result_tensors)
    _ods_successors = None
    super().__init__(self.build_generic(attributes=attributes, results=results, operands=operands, successors=_ods_successors, regions=regions, loc=loc, ip=ip))
...
class Conv2DNchwFchwOp(_ods_ir.OpView):
  ...
  def __init__(self, result_tensors, inputs, outputs, *, strides=None, dilations=None, loc=None, ip=None):
    ...
    if strides is not None: attributes["strides"] = (strides if (
        isinstance(strides, _ods_ir.Attribute) or
        not _ods_ir.AttrBuilder.contains('anonymous_724')) else
          _ods_ir.AttrBuilder.get('anonymous_724')(strides, context=_ods_context))
    if dilations is not None: attributes["dilations"] = (dilations if (
        isinstance(dilations, _ods_ir.Attribute) or
        not _ods_ir.AttrBuilder.contains('anonymous_724')) else
          _ods_ir.AttrBuilder.get('anonymous_724')(dilations, context=_ods_context))
    results.extend(result_tensors)
    _ods_successors = None
    super().__init__(self.build_generic(attributes=attributes, results=results, operands=operands, successors=_ods_successors, regions=regions, loc=loc, ip=ip))
...
class Conv3DNcdhwFcdhwOp(_ods_ir.OpView):
  ...
  def __init__(self, result_tensors, inputs, outputs, *, strides=None, dilations=None, loc=None, ip=None):
    ...
    if strides is not None: attributes["strides"] = (strides if (
        isinstance(strides, _ods_ir.Attribute) or
        not _ods_ir.AttrBuilder.contains('anonymous_761')) else
          _ods_ir.AttrBuilder.get('anonymous_761')(strides, context=_ods_context))
    if dilations is not None: attributes["dilations"] = (dilations if (
        isinstance(dilations, _ods_ir.Attribute) or
        not _ods_ir.AttrBuilder.contains('anonymous_761')) else
          _ods_ir.AttrBuilder.get('anonymous_761')(dilations, context=_ods_context))
    results.extend(result_tensors)
    _ods_successors = None
    super().__init__(self.build_generic(attributes=attributes, results=results, operands=operands, successors=_ods_successors, regions=regions, loc=loc, ip=ip))
