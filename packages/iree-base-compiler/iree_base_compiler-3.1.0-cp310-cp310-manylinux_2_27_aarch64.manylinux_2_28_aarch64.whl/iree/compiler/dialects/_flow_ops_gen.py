...
def call(results_, callee, arguments, argument_dims, result_dims, *, tied_operands=None, loc=None, ip=None) -> _ods_ir.Value:
...
class FuncOp(_ods_ir.OpView):
  ...
  def __init__(self, sym_name, function_type, *, tied_operands=None, sym_visibility=None, arg_attrs=None, res_attrs=None, loc=None, ip=None):
    ...
    not _ods_ir.AttrBuilder.contains('anonymous_649')) else
      _ods_ir.AttrBuilder.get('anonymous_649')(function_type, context=_ods_context))
    if tied_operands is not None: attributes["tied_operands"] = (tied_operands if (
        isinstance(tied_operands, _ods_ir.Attribute) or
        not _ods_ir.AttrBuilder.contains('Util_TiedOpStorageAttr')) else
          _ods_ir.AttrBuilder.get('Util_TiedOpStorageAttr')(tied_operands, context=_ods_context))
...
def tensor_clone(operand, argument_dims, *, loc=None, ip=None) -> _ods_ir.Value:
  return TensorCloneOp(operand=operand, argument_dims=argument_dims, loc=loc, ip=ip).result
...
class TensorTransferOp(_ods_ir.OpView):
  ...
  def __init__(self, operand, argument_dims, target, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
def tensor_transfer(operand, argument_dims, target, *, loc=None, ip=None) -> _ods_ir.Value:
  return TensorTransferOp(operand=operand, argument_dims=argument_dims, target=target, loc=loc, ip=ip).result
