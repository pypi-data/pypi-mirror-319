...
class ContainerContainerDistribution(object):
    ...
    def __init__(self, pulp_labels=None, base_path=None, content_guard=None, hidden=False, name=None, repository=None, repository_version=None, private=None, description=None, local_vars_configuration=None):  # noqa: E501
