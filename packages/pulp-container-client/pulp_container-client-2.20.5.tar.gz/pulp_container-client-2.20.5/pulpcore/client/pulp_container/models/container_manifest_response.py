...
class ContainerManifestResponse(object):
    ...
    def __init__(self, pulp_href=None, pulp_created=None, pulp_last_updated=None, digest=None, schema_version=None, media_type=None, listed_manifests=None, config_blob=None, blobs=None, annotations=None, labels=None, is_bootable=False, is_flatpak=False, local_vars_configuration=None):  # noqa: E501
