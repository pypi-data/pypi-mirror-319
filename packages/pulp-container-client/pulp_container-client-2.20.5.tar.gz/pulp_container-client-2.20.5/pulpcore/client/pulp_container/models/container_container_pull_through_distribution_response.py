...
class ContainerContainerPullThroughDistributionResponse(object):
    ...
    def __init__(self, pulp_labels=None, base_path=None, content_guard=None, pulp_created=None, pulp_last_updated=None, pulp_href=None, hidden=False, name=None, repository=None, remote=None, distributions=None, namespace=None, private=None, description=None, local_vars_configuration=None):  # noqa: E501
