...
class ContainerContainerPushRepository(object):
    ...
    def __init__(self, description=None, retain_repo_versions=None, manifest_signing_service=None, name=None, pulp_labels=None, local_vars_configuration=None):  # noqa: E501
