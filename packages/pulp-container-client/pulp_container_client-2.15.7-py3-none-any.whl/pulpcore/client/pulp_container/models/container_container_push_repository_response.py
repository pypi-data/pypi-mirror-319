...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, latest_version_href=None, description=None, retain_repo_versions=None, manifest_signing_service=None, name=None, pulp_href=None, versions_href=None, pulp_created=None, pulp_labels=None, local_vars_configuration=None):  # noqa: E501
