...
class ContainerContainerPushRepository(object):
    ...
    def __init__(self, manifest_signing_service=None, pulp_labels=None, retain_repo_versions=None, name=None, description=None, local_vars_configuration=None):  # noqa: E501
