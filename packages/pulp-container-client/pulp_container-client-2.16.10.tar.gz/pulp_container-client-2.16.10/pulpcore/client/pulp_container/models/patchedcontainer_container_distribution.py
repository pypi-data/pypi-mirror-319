...
class PatchedcontainerContainerDistribution(object):
    ...
    def __init__(self, base_path=None, repository=None, content_guard=None, hidden=False, pulp_labels=None, name=None, repository_version=None, private=None, description=None, local_vars_configuration=None):  # noqa: E501
