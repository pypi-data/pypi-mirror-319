...
class ContainerContainerDistribution(object):
    ...
    def __init__(self, hidden=False, pulp_labels=None, base_path=None, repository=None, content_guard=None, name=None, repository_version=None, private=None, description=None, local_vars_configuration=None):  # noqa: E501
