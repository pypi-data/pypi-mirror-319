...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, retain_repo_versions=None, pulp_last_updated=None, description=None, manifest_signing_service=None, versions_href=None, pulp_href=None, latest_version_href=None, pulp_labels=None, pulp_created=None, name=None, local_vars_configuration=None):  # noqa: E501
