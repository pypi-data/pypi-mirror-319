...
class ContainerContainerDistributionResponse(object):
    ...
    def __init__(self, pulp_last_updated=None, pulp_href=None, hidden=False, pulp_labels=None, base_path=None, repository=None, pulp_created=None, content_guard=None, name=None, repository_version=None, registry_path=None, remote=None, namespace=None, private=None, description=None, local_vars_configuration=None):  # noqa: E501
