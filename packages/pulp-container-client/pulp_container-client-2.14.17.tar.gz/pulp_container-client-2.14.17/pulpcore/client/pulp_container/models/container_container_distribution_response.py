...
class ContainerContainerDistributionResponse(object):
    ...
    def __init__(self, pulp_created=None, repository=None, content_guard=None, base_path=None, name=None, pulp_labels=None, pulp_href=None, repository_version=None, registry_path=None, namespace=None, private=None, description=None, local_vars_configuration=None):  # noqa: E501
