...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, retain_repo_versions=None, pulp_created=None, manifest_signing_service=None, latest_version_href=None, description=None, versions_href=None, name=None, pulp_labels=None, pulp_href=None, local_vars_configuration=None):  # noqa: E501
