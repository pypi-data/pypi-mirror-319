...
class ContainerContainerPushRepository(object):
    ...
    def __init__(self, retain_repo_versions=None, manifest_signing_service=None, description=None, name=None, pulp_labels=None, local_vars_configuration=None):  # noqa: E501
