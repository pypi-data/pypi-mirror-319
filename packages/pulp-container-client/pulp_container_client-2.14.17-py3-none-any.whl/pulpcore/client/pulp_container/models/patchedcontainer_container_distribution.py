...
class PatchedcontainerContainerDistribution(object):
    ...
    def __init__(self, repository=None, content_guard=None, base_path=None, name=None, pulp_labels=None, repository_version=None, private=None, description=None, local_vars_configuration=None):  # noqa: E501
