...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, pulp_created=None, pulp_href=None, latest_version_href=None, versions_href=None, manifest_signing_service=None, pulp_labels=None, retain_repo_versions=None, name=None, description=None, local_vars_configuration=None):  # noqa: E501
