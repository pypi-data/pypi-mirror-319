...
class ContainerContainerDistributionResponse(object):
    ...
    def __init__(self, pulp_created=None, base_path=None, repository=None, content_guard=None, pulp_href=None, hidden=False, pulp_labels=None, name=None, repository_version=None, registry_path=None, namespace=None, private=None, description=None, local_vars_configuration=None):  # noqa: E501
