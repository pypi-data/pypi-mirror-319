...
class ContainerContainerDistributionResponse(object):
    ...
    def __init__(self, name=None, pulp_href=None, pulp_created=None, content_guard=None, hidden=False, repository=None, pulp_labels=None, base_path=None, repository_version=None, registry_path=None, namespace=None, private=None, description=None, local_vars_configuration=None):  # noqa: E501
