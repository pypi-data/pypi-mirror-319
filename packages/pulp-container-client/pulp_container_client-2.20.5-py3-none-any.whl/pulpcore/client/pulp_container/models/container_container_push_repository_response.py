...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, versions_href=None, pulp_labels=None, pulp_created=None, pulp_last_updated=None, pulp_href=None, description=None, name=None, manifest_signing_service=None, retain_repo_versions=None, latest_version_href=None, local_vars_configuration=None):  # noqa: E501
