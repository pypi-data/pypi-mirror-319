...
class ContentManifestsApi(object):
    ...
    def list(self,  **kwargs):  # noqa: E501
        ...
        :param bool is_bootable: Filter results where is_bootable matches value
        :param bool is_flatpak: Filter results where is_flatpak matches value
        :param int limit: Number of results to return per page.
        :param list[str] media_type: * `application/vnd.docker.distribution.manifest.v1+json` - application/vnd.docker.distribution.manifest.v1+json * `application/vnd.docker.distribution.manifest.v2+json` - application/vnd.docker.distribution.manifest.v2+json * `application/vnd.docker.distribution.manifest.list.v2+json` - application/vnd.docker.distribution.manifest.list.v2+json * `application/vnd.oci.image.manifest.v1+json` - application/vnd.oci.image.manifest.v1+json * `application/vnd.oci.image.index.v1+json` - application/vnd.oci.image.index.v1+json
    ...
    def list_with_http_info(self,  **kwargs):  # noqa: E501
        ...
        if 'is_bootable' in local_var_params and local_var_params['is_bootable'] is not None:  # noqa: E501
            query_params.append(('is_bootable', local_var_params['is_bootable']))  # noqa: E501
        if 'is_flatpak' in local_var_params and local_var_params['is_flatpak'] is not None:  # noqa: E501
            query_params.append(('is_flatpak', local_var_params['is_flatpak']))  # noqa: E501
