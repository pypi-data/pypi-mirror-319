...
class PatchedcontainerContainerPushRepository(object):
    ...
    def __init__(self, retain_repo_versions=None, description=None, manifest_signing_service=None, pulp_labels=None, name=None, local_vars_configuration=None):  # noqa: E501
