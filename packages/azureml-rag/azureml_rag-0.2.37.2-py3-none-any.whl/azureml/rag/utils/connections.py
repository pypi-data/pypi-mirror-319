...
def _token_provider_for_aoai_connection(
    ...
    if is_obo_enabled:
        ...
        return get_bearer_token_provider(
            DefaultAzureCredential(managed_identity_client_id=client_id, process_timeout=60), scopes
        )
...
def get_obo_or_default_azure_credential():
    ...
    if is_obo_enabled:
        ...
        logger.info(f"Using DefaultAzureCredential for authentication. Client id: {client_id} will be used.")
