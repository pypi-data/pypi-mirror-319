...
class InvoicePublic(BaseModel):
  ...
  __properties = [
    'id', 'paid_at', 'created_at', 'currency', 'paid_amount_atom', 'tax_amount_atom',
    'remaining_amount_atom', 'total_discount_amount_atoms', 'billed_to', 'billing_address',
    'card_type', 'last_four', 'lines', 'branding', 'invoice_pdf_url', 'receipt_pdf_url',
    'is_initial_invoice_for_trial_sub', 'trial_start_for_sub', 'trial_end_for_sub', 'status',
    'due_amount_atom', 'due_date', 'applied_balance_amount_atom', 'total_amount_atom'
  ]
