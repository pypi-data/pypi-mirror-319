...
class CheckoutSessionExternal(BaseModel):
  ...
  __properties = [
    ...
    'amount_subtotal_atom', 'amount_total_atom', 'client_reference_id', 'coupon_id', 'currency',
    'customer_id', 'customer_email', 'line_items', 'mode', 'return_url', 'secure_token',
    'setup_intent', 'status', 'subscription_id', 'success_url', 'tax_amount_atom', 'url',
    'trial_end', 'trial_period_days', 'trial_from_price'
  ]
