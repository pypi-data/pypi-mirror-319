...
class Elements:
    ...
    def __set__(self, instance: P, value: tuple | dict) -> None:
        ...
        if isinstance(value, tuple):
            ...
            raise TypeError(
                ...
                'according to the logic of the Elements parameters.'
            )
    ...
    def find(
        ...
        if index is not None:
            try:
                ...
                # We reraise TimeoutException to indicate
                # that elements are not present after timeout.
    ...
    def wait_all_present(
        ...
        - reraise: When the elements state is not as expected,
