...
def lazy_import():
    ...
    globals()['TokenCounts'] = TokenCounts


class AlignmentResponse(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, metrics, reasoning, usage, *args, **kwargs):  # noqa: E501
        """AlignmentResponse - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, metrics, reasoning, usage, *args, **kwargs):  # noqa: E501
        """AlignmentResponse - a model defined in OpenAPI
