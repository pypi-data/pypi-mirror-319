...
def lazy_import():
    ...
    globals()['SnippetModel'] = SnippetModel
    globals()['UsageModel'] = UsageModel


class ContextModel(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'snippets': ([SnippetModel],),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, snippets, usage, *args, **kwargs):  # noqa: E501
        """ContextModel - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, snippets, usage, *args, **kwargs):  # noqa: E501
        """ContextModel - a model defined in OpenAPI
