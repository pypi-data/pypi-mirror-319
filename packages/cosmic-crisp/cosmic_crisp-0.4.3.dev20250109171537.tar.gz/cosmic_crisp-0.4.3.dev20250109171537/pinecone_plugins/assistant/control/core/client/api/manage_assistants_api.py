    ...
    def __init__(self, api_client=None):
        ...
        def __create_assistant(
            ...
            **kwargs
            ...
            [Create an assistant](https://docs.pinecone.io/guides/assistant/create-assistant). This is where you specify the underlying training model, which cloud provider you would like to deploy with, and more.  # noqa: E501
        ...
        def __delete_assistant(
            ...
            **kwargs
            ...
            [Delete an existing assistant](https://docs.pinecone.io/guides/assistant/manage-assistants#delete-an-assistant).  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True
        ...
        def __get_assistant(
            ...
            **kwargs
            ...
            [Get the status](https://docs.pinecone.io/guides/assistant/manage-assistants#get-the-status-of-an-assistant) of an assistant.  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True
        ...
        def __list_assistants(
            ...
            **kwargs
            ...
            [List all assistants in a project](https://docs.pinecone.io/guides/assistant/manage-assistants#list-assistants-for-a-project).  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True
        ...
        def __update_assistant(
            ...
            **kwargs
            ...
            [Update an existing assistant](https://docs.pinecone.io/guides/assistant/manage-assistants#add-instructions-to-an-assistant). You can modify the assistant's instructions.  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True
