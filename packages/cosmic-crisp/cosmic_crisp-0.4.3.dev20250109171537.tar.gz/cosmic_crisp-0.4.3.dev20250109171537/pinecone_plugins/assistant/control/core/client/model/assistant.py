...
class Assistant(ModelNormal):
    ...
    def _from_openapi_data(cls, name, status, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            created_at (str): The date and time the assistant was created.. [optional]  # noqa: E501
            updated_at (str): The date and time the assistant was last updated.. [optional]  # noqa: E501
        """
