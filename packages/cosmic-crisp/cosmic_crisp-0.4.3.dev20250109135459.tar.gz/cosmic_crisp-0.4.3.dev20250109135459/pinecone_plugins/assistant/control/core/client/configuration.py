...
conf = pinecone_plugins.assistant.control.core.client.Configuration(
    ...
    def __init__(self, host=None,
        ...
        """Constructor
        """
        self._base_path = "https://api.pinecone.io/assistant" if host is None else host
        """Default Base url
        """
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("pinecone_plugins.assistant.control.core.client")
