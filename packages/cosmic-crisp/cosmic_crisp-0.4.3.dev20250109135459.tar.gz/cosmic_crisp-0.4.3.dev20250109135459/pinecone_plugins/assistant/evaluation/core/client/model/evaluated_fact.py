...
class EvaluatedFact(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, fact, entailment, *args, **kwargs):  # noqa: E501
        """EvaluatedFact - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, fact, entailment, *args, **kwargs):  # noqa: E501
        """EvaluatedFact - a model defined in OpenAPI
