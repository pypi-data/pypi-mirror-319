...
class SnippetModel(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, content, score, reference, *args, **kwargs):  # noqa: E501
        """SnippetModel - a model defined in OpenAPI

        Args:
            content (str):
            score (float):
            reference ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): The TypedReferenceModel represents a reference for the information provided.
        ...
        Keyword Args:
            ...
            type (str): [optional] if omitted the server will use the default value of "text"  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, content, score, reference, *args, **kwargs):  # noqa: E501
        """SnippetModel - a model defined in OpenAPI
