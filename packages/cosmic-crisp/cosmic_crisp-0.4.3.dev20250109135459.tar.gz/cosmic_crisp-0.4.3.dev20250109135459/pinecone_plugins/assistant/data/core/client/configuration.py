...
conf = pinecone_plugins.assistant.data.core.client.Configuration(
    ...
    def __init__(self, host=None,
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("pinecone_plugins.assistant.data.core.client")
