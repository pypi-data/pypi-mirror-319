...
conf = pinecone_plugins.assistant.evaluation.core.client.Configuration(
    ...
    def __init__(self, host=None,
        ...
        """Constructor
        """
        self._base_path = "https://prod-1-data.ke.pinecone.io/assistant" if host is None else host
        """Default Base url
        """
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("pinecone_plugins.assistant.evaluation.core.client")
