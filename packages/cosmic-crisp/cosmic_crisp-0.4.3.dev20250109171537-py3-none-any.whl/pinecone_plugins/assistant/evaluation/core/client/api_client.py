...
from pinecone_plugins.assistant.evaluation.core.client import rest
from pinecone_plugins.assistant.evaluation.core.client.configuration import Configuration
from pinecone_plugins.assistant.evaluation.core.client.exceptions import PineconeApiTypeError, PineconeApiValueError, PineconeApiException
from pinecone_plugins.assistant.evaluation.core.client.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.metrics_alignment  # this is an instance of the class Endpoint
        api_instance.metrics_alignment()  # this invokes api_instance.metrics_alignment.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.metrics_alignment.callable or self.callable in this class
