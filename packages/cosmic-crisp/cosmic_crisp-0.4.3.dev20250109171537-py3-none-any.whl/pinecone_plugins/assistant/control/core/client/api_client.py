...
from pinecone_plugins.assistant.control.core.client import rest
from pinecone_plugins.assistant.control.core.client.configuration import Configuration
from pinecone_plugins.assistant.control.core.client.exceptions import PineconeApiTypeError, PineconeApiValueError, PineconeApiException
from pinecone_plugins.assistant.control.core.client.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = ManageAssistantsApi()
        api_instance.create_assistant  # this is an instance of the class Endpoint
        api_instance.create_assistant()  # this invokes api_instance.create_assistant.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.create_assistant.callable or self.callable in this class
