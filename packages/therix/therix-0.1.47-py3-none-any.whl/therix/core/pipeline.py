...
class Pipeline:
    ...
    async def async_invoke(
        ...
        async def invoke_pipeline_method(method, *args, **kwargs):
            ...
            return await method(*args, **kwargs, db_url=await self.get_db_url() if self.therix_api_key else None, trace_api=await self.get_trace_api() if self.therix_api_key else None)
