...
class Int64Array(object):
    ...
    @classmethod
    def GetRootAsInt64Array(cls, buf, offset=0):
...
def Start(builder):
    return Int64ArrayStart(builder)
...
def AddValue(builder, value):
    return Int64ArrayAddValue(builder, value)
...
def StartValueVector(builder, numElems):
    return Int64ArrayStartValueVector(builder, numElems)
def Int64ArrayEnd(builder): return builder.EndObject()
def End(builder):
    return Int64ArrayEnd(builder)