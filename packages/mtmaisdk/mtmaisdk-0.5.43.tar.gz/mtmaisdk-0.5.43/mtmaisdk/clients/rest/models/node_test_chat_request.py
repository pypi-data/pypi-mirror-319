...
class NodeTestChatRequest(BaseModel):
    """
    NodeTestChatRequest
    """ # noqa: E501
    thread_id: Optional[StrictStr] = Field(default=None, description="线程id", alias="threadId")
    messages: Optional[List[ChatMessage]] = None
    name: Optional[StrictStr] = Field(default=None, description="名字")
    __properties: ClassVar[List[str]] = ["threadId", "messages", "name"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NodeTestChatRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NodeTestChatRequest from a dict"""
        if obj is None:
            return None
