...
class BlogPost(BaseModel):
    ...
    state: Optional[BlogPostState] = None
    __properties: ClassVar[List[str]] = ["metadata", "title", "content", "state"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "state": BlogPostState.from_dict(obj["state"]) if obj.get("state") is not None else None
        })
        return _obj
