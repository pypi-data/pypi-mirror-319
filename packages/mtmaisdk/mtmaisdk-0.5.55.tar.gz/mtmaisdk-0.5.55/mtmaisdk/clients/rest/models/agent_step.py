...
class AgentStep(BaseModel):
    ...
    action: AgentAction = Field(alias="Action")
    observation: StrictStr = Field(description="步骤观察", alias="Observation")
    __properties: ClassVar[List[str]] = ["metadata", "Action", "Observation"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "Action": AgentAction.from_dict(obj["Action"]) if obj.get("Action") is not None else None,
