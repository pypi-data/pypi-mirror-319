...
class TenantBlog(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["metadata", "title", "tenant"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TenantBlog from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TenantBlog from a dict"""
        if obj is None:
            return None
