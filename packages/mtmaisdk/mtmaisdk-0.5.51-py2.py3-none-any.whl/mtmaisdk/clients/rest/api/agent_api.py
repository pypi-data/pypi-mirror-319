...
class AgentApi:
    ...
    async def agent_node_form(
        ...
        _param = self._agent_node_form_serialize(
            tenant=tenant,
            node=node,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    async def agent_node_form_with_http_info(
        self,
        tenant: Annotated[str, Field(min_length=36, strict=True, max_length=36, description="The tenant id")],
        node: Annotated[str, Field(min_length=36, strict=True, max_length=36, description="The node id")],
        _request_timeout: Union[
    ...
    @validate_call
    async def agent_node_form_without_preload_content(
        self,
        tenant: Annotated[str, Field(min_length=36, strict=True, max_length=36, description="The tenant id")],
        node: Annotated[str, Field(min_length=36, strict=True, max_length=36, description="The node id")],
        _request_timeout: Union[
    ...
    def _agent_node_form_serialize(
        self,
        tenant,
        node,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v1/tenants/{tenant}/nodes/form/{node}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
