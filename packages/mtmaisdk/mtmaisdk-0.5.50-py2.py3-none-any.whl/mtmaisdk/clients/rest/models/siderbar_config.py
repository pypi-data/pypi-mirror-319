...
class SiderbarConfig(BaseModel):
    """
    SiderbarConfig
    """ # noqa: E501
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in sideritems (list)
        _items = []
        if self.sideritems:
            for _item_sideritems in self.sideritems:
                if _item_sideritems:
