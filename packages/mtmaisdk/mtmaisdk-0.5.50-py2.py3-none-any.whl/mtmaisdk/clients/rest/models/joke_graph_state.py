...
class JokeGraphState(BaseModel):
    ...
    topic: Optional[StrictStr] = Field(default=None, description="笑话主题")
    messages: Optional[List[ChatMessage]] = None
    __properties: ClassVar[List[str]] = ["input", "topic", "messages"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of JokeGraphState from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of JokeGraphState from a dict"""
        if obj is None:
            return None
