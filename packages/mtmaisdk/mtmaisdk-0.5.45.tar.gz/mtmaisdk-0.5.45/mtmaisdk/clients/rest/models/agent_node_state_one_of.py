...
class AgentNodeStateOneOf(BaseModel):
    """
    笑话图谱状态
    """ # noqa: E501
    input: Optional[Dict[str, Any]] = Field(default=None, description="输入")
    messages: Optional[List[ChatMessage]] = None
    __properties: ClassVar[List[str]] = ["input", "messages"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AgentNodeStateOneOf from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AgentNodeStateOneOf from a dict"""
        if obj is None:
            return None
