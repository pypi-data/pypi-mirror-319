...
class AgentNodeList(BaseModel):
    """
    AgentNodeList
    """ # noqa: E501
    pagination: Optional[PaginationResponse] = None
    rows: Optional[List[AgentNode]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "rows": [AgentNode.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
        return _obj
