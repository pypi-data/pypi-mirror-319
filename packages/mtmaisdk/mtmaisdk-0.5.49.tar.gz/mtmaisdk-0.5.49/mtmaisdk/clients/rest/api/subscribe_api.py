...
class SubscribeApi:
    ...
    async def subscribe_subscribe(
        ...
        _param = self._subscribe_subscribe_serialize(
            tenant=tenant,
    ...
    @validate_call
    async def subscribe_subscribe_with_http_info(
        self,
        tenant: Annotated[str, Field(min_length=36, strict=True, max_length=36, description="The tenant id")],
        subscribe_request: Optional[SubscribeRequest] = None,
        _request_timeout: Union[
    ...
    @validate_call
    async def subscribe_subscribe_without_preload_content(
        self,
        tenant: Annotated[str, Field(min_length=36, strict=True, max_length=36, description="The tenant id")],
        subscribe_request: Optional[SubscribeRequest] = None,
        _request_timeout: Union[
    ...
    def _subscribe_subscribe_serialize(
        self,
        tenant,
        subscribe_request,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v1/tenants/{tenant}/subscribe',
