...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-wisdom)](https://pypistats.org/packages/mypy-boto3-wisdom)
...
`mypy-boto3-wisdom` dependency in production. However, there is an issue in
