...
#****f* Functions_/resfile, res_filename, model_filename, emb_model_folder
# PURPOSE
...
#   * 210929 (2.2.5) Added model_filename and res_filename
...
#****o* Classes/Graph_, extrnodes, adjlinks, adjnodes, propagate, dtree, antennas
# PURPOSE
...
#   * plist = graph.antennas([keep_nodes=None]):
...
class Graph:
    ...
    def antennas(self, keep_nodes: Sequence[str] = None) -> List[Tuple[str, str]]:
