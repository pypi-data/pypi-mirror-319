...
try:
    import cupy as cp
    from bbhx.cutils.pyWaveformBuild import direct_sum_wrap as direct_sum_wrap_gpu
    from bbhx.cutils.pyWaveformBuild import InterpTDI_wrap as InterpTDI_wrap_gpu

except (ImportError, ModuleNotFoundError) as e:
    print("No CuPy")

from bbhx.cutils.pyWaveformBuild_cpu import direct_sum_wrap as direct_sum_wrap_cpu
from bbhx.cutils.pyWaveformBuild_cpu import InterpTDI_wrap as InterpTDI_wrap_cpu
