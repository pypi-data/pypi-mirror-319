...
try:
    import cupy as cp
    from bbhx.cutils.pyFDResponse import LISA_response_wrap as LISA_response_wrap_gpu

except (ImportError, ModuleNotFoundError) as e:
    print("No CuPy or GPU response available.")

from bbhx.cutils.pyFDResponse_cpu import LISA_response_wrap as LISA_response_wrap_cpu
