...
export declare const PrefixedStr: <Prefix extends string>(prefix: Prefix) => Kinds.PrefixedStr<Prefix>;
...
export declare const KeyVal: <K extends string, V>(key_type: Kind<K>, item_type: Kind<V>) => Kinds.KeyVal<K, V>;
