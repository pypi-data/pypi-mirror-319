...
setuptools.setup(
    name="certora-cli-alpha-oz-change-image",
    version="20250108.10.38.781826",
    author="Certora",
    author_email="support@certora.com",
    description="Runner for the Certora Prover",
    long_description="Commit 4717875.                    Build and Run scripts for executing the Certora Prover on Solidity smart contracts.",
    long_description_content_type="text/markdown",
    url="https://pypi.org/project/certora-cli-alpha-oz-change-image",
