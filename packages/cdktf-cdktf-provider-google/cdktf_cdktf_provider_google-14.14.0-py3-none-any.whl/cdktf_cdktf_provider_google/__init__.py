r'''
# CDKTF prebuilt bindings for hashicorp/google provider version 6.15.0

This repo builds and publishes the [Terraform google provider](https://registry.terraform.io/providers/hashicorp/google/6.15.0/docs) bindings for [CDK for Terraform](https://cdk.tf).
...
* [Terraform google provider](https://registry.terraform.io/providers/hashicorp/google/6.15.0)
