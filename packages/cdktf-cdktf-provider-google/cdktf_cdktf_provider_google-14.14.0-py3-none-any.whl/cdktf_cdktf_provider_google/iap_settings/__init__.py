...
class IapSettings(
    ...
    def __init__(
        ...
        *,
        ...
        '''Create a new {@link https://registry.terraform.io/providers/hashicorp/google/6.15.0/docs/resources/iap_settings google_iap_settings} Resource.

        :param scope: The scope in which to define this construct.
        :param id_: The scoped construct ID. Must be unique amongst siblings in the same scope
        :param name: The resource name of the IAP protected resource. Name can have below resources: - organizations/{organization_id} - folders/{folder_id} - projects/{projects_id} - projects/{projects_id}/iap_web - projects/{projects_id}/iap_web/compute - projects/{projects_id}/iap_web/compute-{region} - projects/{projects_id}/iap_web/compute/service/{service_id} - projects/{projects_id}/iap_web/compute-{region}/service/{service_id} - projects/{projects_id}/iap_web/appengine-{app_id} - projects/{projects_id}/iap_web/appengine-{app_id}/service/{service_id} - projects/{projects_id}/iap_web/appengine-{app_id}/service/{service_id}/version/{version_id} Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.15.0/docs/resources/iap_settings#name IapSettings#name}
        :param access_settings: access_settings block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.15.0/docs/resources/iap_settings#access_settings IapSettings#access_settings}
        :param application_settings: application_settings block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.15.0/docs/resources/iap_settings#application_settings IapSettings#application_settings}
        :param id: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.15.0/docs/resources/iap_settings#id IapSettings#id}. Please be aware that the id field is automatically added to all resources in Terraform providers using a Terraform provider SDK version below 2. If you experience problems setting this value it might not be settable. Please take a look at the provider documentation to ensure it should be settable.
        :param timeouts: timeouts block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.15.0/docs/resources/iap_settings#timeouts IapSettings#timeouts}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing IapSettings that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.15.0/docs/resources/iap_settings#import import section} in the documentation of this resource for the id to use
    ...
    def put_access_settings(
        ...
        *,
        ...
        '''
        :param allowed_domains_settings: allowed_domains_settings block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.15.0/docs/resources/iap_settings#allowed_domains_settings IapSettings#allowed_domains_settings}
        :param cors_settings: cors_settings block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.15.0/docs/resources/iap_settings#cors_settings IapSettings#cors_settings}
        :param gcip_settings: gcip_settings block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.15.0/docs/resources/iap_settings#gcip_settings IapSettings#gcip_settings}
        ...
        :param oauth_settings: oauth_settings block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.15.0/docs/resources/iap_settings#oauth_settings IapSettings#oauth_settings}
        :param reauth_settings: reauth_settings block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.15.0/docs/resources/iap_settings#reauth_settings IapSettings#reauth_settings}
        :param workforce_identity_settings: workforce_identity_settings block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.15.0/docs/resources/iap_settings#workforce_identity_settings IapSettings#workforce_identity_settings}
        '''
    ...
    def put_application_settings(
        ...
        *,
        ...
        '''
        :param access_denied_page_settings: access_denied_page_settings block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.15.0/docs/resources/iap_settings#access_denied_page_settings IapSettings#access_denied_page_settings}
        :param attribute_propagation_settings: attribute_propagation_settings block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.15.0/docs/resources/iap_settings#attribute_propagation_settings IapSettings#attribute_propagation_settings}
        :param cookie_domain: The Domain value to set for cookies generated by IAP. This value is not validated by the API, but will be ignored at runtime if invalid. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.15.0/docs/resources/iap_settings#cookie_domain IapSettings#cookie_domain}
        :param csm_settings: csm_settings block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.15.0/docs/resources/iap_settings#csm_settings IapSettings#csm_settings}
        '''
    ...
    def put_timeouts(
        ...
        *,
        ...
        '''
        :param create: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.15.0/docs/resources/iap_settings#create IapSettings#create}.
        :param delete: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.15.0/docs/resources/iap_settings#delete IapSettings#delete}.
        :param update: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.15.0/docs/resources/iap_settings#update IapSettings#update}.
        '''
...
class IapSettingsAccessSettingsAllowedDomainsSettings:
    def __init__(
        ...
        *,
        ...
        '''
        :param domains: List of trusted domains. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.15.0/docs/resources/iap_settings#domains IapSettings#domains}
        :param enable: Configuration for customers to opt in for the feature. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.15.0/docs/resources/iap_settings#enable IapSettings#enable}
        '''
        if __debug__:
...
class IapSettingsAccessSettingsCorsSettings:
    def __init__(
        ...
        *,
        ...
        '''
        :param allow_http_options: Configuration to allow HTTP OPTIONS calls to skip authorization. If undefined, IAP will not apply any special logic to OPTIONS requests. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.15.0/docs/resources/iap_settings#allow_http_options IapSettings#allow_http_options}
        '''
        if __debug__:
...
class IapSettingsAccessSettingsGcipSettings:
    def __init__(
        ...
        *,
        ...
        '''
        :param login_page_uri: Login page URI associated with the GCIP tenants. Typically, all resources within the same project share the same login page, though it could be overridden at the sub resource level. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.15.0/docs/resources/iap_settings#login_page_uri IapSettings#login_page_uri}
        :param tenant_ids: GCIP tenant ids that are linked to the IAP resource. tenantIds could be a string beginning with a number character to indicate authenticating with GCIP tenant flow, or in the format of _ to indicate authenticating with GCIP agent flow. If agent flow is used, tenantIds should only contain one single element, while for tenant flow, tenantIds can contain multiple elements. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.15.0/docs/resources/iap_settings#tenant_ids IapSettings#tenant_ids}
        '''
        if __debug__:
...
class IapSettingsAccessSettingsOauthSettings:
    def __init__(
        ...
        *,
        ...
        '''
        :param login_hint: Domain hint to send as hd=? parameter in OAuth request flow. Enables redirect to primary IDP by skipping Google's login screen. (https://developers.google.com/identity/protocols/OpenIDConnect#hd-param) Note: IAP does not verify that the id token's hd claim matches this value since access behavior is managed by IAM policies. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.15.0/docs/resources/iap_settings#login_hint IapSettings#login_hint}
        :param programmatic_clients: List of client ids allowed to use IAP programmatically. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.15.0/docs/resources/iap_settings#programmatic_clients IapSettings#programmatic_clients}
        '''
        if __debug__:
...
class IapSettingsAccessSettingsOutputReference(
    ...
    def put_reauth_settings(
        ...
        *,
        ...
        '''
        :param max_age: Reauth session lifetime, how long before a user has to reauthenticate again. A duration in seconds with up to nine fractional digits, ending with 's'. Example: "3.5s". Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.15.0/docs/resources/iap_settings#max_age IapSettings#max_age}
        :param method: Reauth method requested. The possible values are:. - 'LOGIN': Prompts the user to log in again. - 'SECURE_KEY': User must use their secure key 2nd factor device. - 'ENROLLED_SECOND_FACTORS': User can use any enabled 2nd factor. Possible values: ["LOGIN", "SECURE_KEY", "ENROLLED_SECOND_FACTORS"] Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.15.0/docs/resources/iap_settings#method IapSettings#method}
        :param policy_type: How IAP determines the effective policy in cases of hierarchical policies. Policies are merged from higher in the hierarchy to lower in the hierarchy. The possible values are: - 'MINIMUM': This policy acts as a minimum to other policies, lower in the hierarchy. Effective policy may only be the same or stricter. - 'DEFAULT': This policy acts as a default if no other reauth policy is set. Possible values: ["MINIMUM", "DEFAULT"] Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.15.0/docs/resources/iap_settings#policy_type IapSettings#policy_type}
        '''
    ...
    def put_workforce_identity_settings(
        ...
        *,
        ...
        '''
        :param oauth2: oauth2 block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.15.0/docs/resources/iap_settings#oauth2 IapSettings#oauth2}
        :param workforce_pools: The workforce pool resources. Only one workforce pool is accepted. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.15.0/docs/resources/iap_settings#workforce_pools IapSettings#workforce_pools}
        '''
...
class IapSettingsAccessSettingsWorkforceIdentitySettingsOauth2:
    def __init__(
        ...
        *,
        ...
        '''
        :param client_id: The OAuth 2.0 client ID registered in the workforce identity federation OAuth 2.0 Server. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.15.0/docs/resources/iap_settings#client_id IapSettings#client_id}
        :param client_secret: Input only. The OAuth 2.0 client secret created while registering the client ID. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.15.0/docs/resources/iap_settings#client_secret IapSettings#client_secret}
        '''
        if __debug__:
...
class IapSettingsApplicationSettingsAccessDeniedPageSettings:
    def __init__(
        ...
        *,
        ...
        '''
        :param access_denied_page_uri: The URI to be redirected to when access is denied. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.15.0/docs/resources/iap_settings#access_denied_page_uri IapSettings#access_denied_page_uri}
...
class IapSettingsApplicationSettingsCsmSettings:
    def __init__(self, *, rctoken_aud: typing.Optional[builtins.str] = None) -> None:
        '''
        :param rctoken_aud: Audience claim set in the generated RCToken. This value is not validated by IAP. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.15.0/docs/resources/iap_settings#rctoken_aud IapSettings#rctoken_aud}
        '''
        if __debug__:
