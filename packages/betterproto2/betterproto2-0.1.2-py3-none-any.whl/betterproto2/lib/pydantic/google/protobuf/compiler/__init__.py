...
import betterproto2
import betterproto2.lib.pydantic.google.protobuf as betterproto_lib_pydantic_google_protobuf
...
class CodeGeneratorRequest(betterproto2.Message):
    ...
    file_to_generate: List[str] = betterproto2.string_field(1)
    """
    ...
    proto_file: List["betterproto_lib_pydantic_google_protobuf.FileDescriptorProto"] = betterproto2.message_field(15)
    """
...
class CodeGeneratorResponse(betterproto2.Message):
    ...
    file: List["CodeGeneratorResponseFile"] = betterproto2.message_field(15)
...
class CodeGeneratorResponseFile(betterproto2.Message):
    ...
    generated_code_info: "betterproto_lib_pydantic_google_protobuf.GeneratedCodeInfo" = betterproto2.message_field(16)
    """
