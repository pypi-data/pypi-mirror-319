...
class EnumValueOptions(betterproto2.Message):
    ...
    credentials.
    """
    feature_support: "Optional[FieldOptionsFeatureSupport]" = betterproto2.field(
...
class FeatureSetDefaultsFeatureSetEditionDefault(betterproto2.Message):
    ...
    overridable_features: "Optional[FeatureSet]" = betterproto2.field(4, betterproto2.TYPE_MESSAGE, optional=True)
    """
    Defaults of features that can be overridden in this edition.
    """
    fixed_features: "Optional[FeatureSet]" = betterproto2.field(5, betterproto2.TYPE_MESSAGE, optional=True)
    """
...
class FieldOptions(betterproto2.Message):
    ...
    targets: "List[FieldOptionsOptionTargetType]" = betterproto2.field(
        19, betterproto2.TYPE_ENUM, repeated=True, default_factory=lambda: FieldOptionsOptionTargetType.try_value(0)
    )
