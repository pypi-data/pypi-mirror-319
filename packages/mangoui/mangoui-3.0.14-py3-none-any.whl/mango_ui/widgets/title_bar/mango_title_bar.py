...
from mango_ui.models.models import TitleBarMenusModel
...
class MangoTitleBar(QWidget):
    ...
    def __init__(
        ...
        self.div_1 = MangoDiv(THEME.color.color5)
        self.div_2 = MangoDiv(THEME.color.color5)
        self.div_3 = MangoDiv(THEME.color.color5)
        ...
        self.bg.setStyleSheet(f"background-color: {THEME.color.color4}; border-radius: {THEME.border_radius};")
