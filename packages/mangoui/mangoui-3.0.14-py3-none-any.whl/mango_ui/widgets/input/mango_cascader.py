...
from mango_ui.models.models import CascaderModel, DialogCallbackModel
...
class MangoCascade(QToolButton):
    ...
    def set_stylesheet(self):
        style = f'''
              QToolButton {{
                  background-color: {THEME.background_color}; /* 按钮背景颜色 */
                  border-radius: {THEME.border_radius}; /* 按钮圆角半径 */
                  border: 1px solid {THEME.border}; /* 按钮边框样式 */
                  padding-left: 10px;
                  padding-right: 10px;
                  padding: 5px; /* 按钮内边距 */
              ...
              QToolButton:focus {{
                  border: 1px solid {THEME.border}; /* 焦点时边框颜色 */
                  background-color: {THEME.color.color1}; /* 焦点时背景颜色 */
              }}
              ...
              QMenu {{
                  background-color: {THEME.background_color}; /* 菜单背景颜色 */
                  border: 1px solid {THEME.border}; /* 菜单边框样式 */
                  padding: 0; /* 菜单内边距 */
              }}

              QMenu::item {{
                  padding: 10px 15px; /* 菜单项的内边距 */
                  color: {THEME.font_color}; /* 菜单项字体颜色 */
              }}

              QMenu::item:selected {{
                  background-color: {THEME.color.color2}; /* 选中菜单项的背景颜色 */
                  color: {THEME.font_color}; /* 选中菜单项的字体颜色 */
              }}
              '''
