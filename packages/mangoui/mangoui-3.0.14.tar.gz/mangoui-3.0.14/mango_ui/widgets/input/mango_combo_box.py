...
from mango_ui.models.models import ComboBoxDataModel, DialogCallbackModel
...
class MangoComboBox(QComboBox):
    ...
    def set_stylesheet(self, icon=':/icons/down.svg'):
        ...
        QComboBox {{
            ...
            padding-left: 10px;
            padding-right: 10px;
            selection-color: {THEME.hover.color};
            selection-background-color: {THEME.hover.background_color};
            color: {THEME.font_color};
        }}
        QComboBox:focus {{
            border: 1px solid {THEME.color.color5};
            background-color: {THEME.background_color};
        }}
        QComboBox::drop-down {{
            border: none;
