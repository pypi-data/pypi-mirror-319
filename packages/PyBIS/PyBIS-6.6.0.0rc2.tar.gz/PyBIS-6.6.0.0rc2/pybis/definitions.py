...
def openbis_definitions(entity):
    ...
    entities = {
        ...
        "experiment": {
            ...
            "attrs_up": "project tags attachments freeze freezeForDataSets freezeForSamples metaData immutableData".split(),
            "attrs": "code permId identifier type project tags registrator registrationDate modifier modificationDate attachments frozen frozenForDataSets frozenForSamples metaData immutableData".split(),
        ...
        "sample": {
            ...
            "attrs_up": "project parents children container components space experiment tags attachments freeze freezeForComponents freezeForChildren freezeForParents freezeForDataSets metaData immutableData".split(),
            "attrs": "code permId identifier type project parents children components space experiment tags registrator registrationDate modifier modificationDate attachments container frozen frozenForComponents frozenForChildren frozenForParents frozenForDataSets metaData immutableData".split(),
            "ids2type": {
        ...
        "sampleType": {
            ...
            "attrs": "permId code description autoGeneratedCode generatedCodePrefix subcodeUnique listable showContainer showParents showParentMetadata modificationDate validationPlugin metaData managedInternally".split(),
        ...
        "dataSetType": {
            ...
            "attrs": "permId code description mainDataSetPattern mainDataSetPath disallowDeletion modificationDate validationPlugin metaData managedInternally".split(),
        ...
        "experimentType": {
            ...
            "attrs": "permId code description modificationDate validationPlugin metaData managedInternally".split(),
            "search": {
