...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-sso)](https://pypistats.org/packages/mypy-boto3-sso)
...
`mypy-boto3-sso` dependency in production. However, there is an issue in
