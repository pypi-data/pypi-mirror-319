...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-robomaker)](https://pypistats.org/packages/mypy-boto3-robomaker)

![boto3.typed](https://github.com/youtype/mypy_boto3_builder/raw/main/logo.png)

Type annotations for [boto3 RoboMaker 1.35.93](https://pypi.org/project/boto3/)
...
`mypy-boto3-robomaker` dependency in production. However, there is an issue in
