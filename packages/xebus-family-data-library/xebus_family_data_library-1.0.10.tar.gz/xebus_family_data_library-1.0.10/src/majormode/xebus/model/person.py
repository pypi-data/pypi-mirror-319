...
class Person:
    ...
    def __eq__(self, other: Person) -> bool:
        ...
        for attribute_name in self.COMPARISON_ATTRIBUTE_NAMES:
            ...
            if this_attribute_value != other_attribute_value and self._sis_account_id != other._sis_account_id:
                logging.debug(
                    f"The value \"{this_attribute_value}\" of the attribute \"{attribute_name}\" "
                    f"of this instance \"{self.__class__.__name__}\" ({self._sis_account_id}) "
                    f"differs from the value \"{other_attribute_value}\" of the same "
                    f"attribute of the other instance \"{other.__class__.__name__}\" "
                    f"({other._sis_account_id})"
                )
                return False
