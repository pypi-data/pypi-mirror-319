...
FAMILY_PROPERTY_TYPES_VALIDATORS: dict[FamilyPropertyName, Callable[[Any], bool]] = {
    FamilyPropertyName.child_sis_id: lambda v: isinstance(v, str),
    FamilyPropertyName.child_first_name: lambda v: isinstance(v, str),
    FamilyPropertyName.child_last_name: lambda v: isinstance(v, str),
    FamilyPropertyName.child_full_name: lambda v: isinstance(v, str),
    FamilyPropertyName.child_languages: lambda v: isinstance(v, Locale) or (isinstance(v, Iterable) and all([isinstance(e, Locale) for e in v])),
    FamilyPropertyName.child_nationalities: lambda v: isinstance(v, Country) or (isinstance(v, Iterable) and all([isinstance(e, Country) for e in v])),
    FamilyPropertyName.child_date_of_birth: lambda v: isinstance(v, datetime.date),
    FamilyPropertyName.child_grade_level: lambda v: isinstance(v, int),
    FamilyPropertyName.child_class_name: lambda v: isinstance(v, str),
    FamilyPropertyName.child_use_transport: lambda v: isinstance(v, bool),
    FamilyPropertyName.primary_guardian_sis_id: lambda v: isinstance(v, str),
    FamilyPropertyName.primary_guardian_first_name: lambda v: isinstance(v, str),
    FamilyPropertyName.primary_guardian_last_name: lambda v: isinstance(v, str),
    FamilyPropertyName.primary_guardian_full_name: lambda v: isinstance(v, str),
    FamilyPropertyName.primary_guardian_languages: lambda v: isinstance(v, Locale) or (isinstance(v, Iterable) and all([isinstance(e, Locale) for e in v])),
    FamilyPropertyName.primary_guardian_nationalities: lambda v: isinstance(v, Country) or (isinstance(v, Iterable) and all([isinstance(e, Country) for e in v])),
    FamilyPropertyName.primary_guardian_email_address: lambda v: isinstance(v, Contact),
    FamilyPropertyName.primary_guardian_phone_number: lambda v: isinstance(v, Contact),
    FamilyPropertyName.primary_guardian_home_address: lambda v: isinstance(v, str),
    FamilyPropertyName.secondary_guardian_sis_id: lambda v: isinstance(v, str),
    FamilyPropertyName.secondary_guardian_first_name: lambda a: isinstance(a, str),
    FamilyPropertyName.secondary_guardian_last_name: lambda v: isinstance(v, str),
    FamilyPropertyName.secondary_guardian_full_name: lambda v: isinstance(v, str),
    FamilyPropertyName.secondary_guardian_languages: lambda v: isinstance(v, Locale) or (isinstance(v, Iterable) and all([isinstance(e, Locale) for e in v])),
    FamilyPropertyName.secondary_guardian_nationalities: lambda v: isinstance(v, Country) or (isinstance(v, Iterable) and all([isinstance(e, Country) for e in v])),
    FamilyPropertyName.secondary_guardian_email_address: lambda v: isinstance(v, Contact),
    FamilyPropertyName.secondary_guardian_phone_number: lambda v: isinstance(v, Contact),
    FamilyPropertyName.secondary_guardian_home_address: lambda v: isinstance(v, str),
}
