...
def _hook_seq(
    ...
    for name, m in module.named_modules():
        if m != module and type(m) not in TRACING_BLACKLIST:
            ...
            print(f"registering parameter quant for {name}: {m}")
