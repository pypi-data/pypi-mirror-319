...
class APIGatewayTokenAuthorizerEvent(BaseModel):
...
class APIGatewayHTTPRequestInfo(BaseModel):
...
class APIGatewayHTTPRequestContext(BaseModel):
    accountId: str
    apiId: str
...
class APIGatewayHTTPAuthorizerV2Event(BaseModel):
    """
