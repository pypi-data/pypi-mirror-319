...
from Behaviours.Base import CyclicBehaviour
from Agent.DFAgent import DFAgent
from utilities.TCPClient import TCPClient
...
class Communication(CyclicBehaviour):
    ...
    def action(self):    
        ...
        if (self.condition):
            ...
            if self.providers_list_final:
                ...
                print("没有找到对应的 {} DF服务！".format(self.service_name))
    ...
    def searchDFServiceProviders(self):
        ...
        '''
        df_agent = DFAgent()
        self.providers_list_final = [df_agent.SearchDFAgent(self.service_name)]
