...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-sqs)](https://pypistats.org/packages/mypy-boto3-sqs)
...
List all available versions of `mypy-boto3-sqs` available on your platform
with:
...
`mypy-boto3-sqs` dependency in production. However, there is an issue in
