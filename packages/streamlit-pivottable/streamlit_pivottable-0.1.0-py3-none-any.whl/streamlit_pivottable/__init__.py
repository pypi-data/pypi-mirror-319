...
def streamlit_pivottable(name="streamlit_pivottable", data=[],height=100, use_container_width=False, key=None):
    """
    Parameters:
    1. name (str): 
    ...
    component_value = _component_func(name=name, data=data,height=height, use_container_width=use_container_width, key=key, default=0)
