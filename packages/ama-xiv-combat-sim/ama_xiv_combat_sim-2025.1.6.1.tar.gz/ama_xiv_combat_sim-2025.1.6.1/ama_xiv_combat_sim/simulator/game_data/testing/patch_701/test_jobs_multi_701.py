...
class TestJobsMultiUnified701(TestClass):
    def __init__(self):
        super().__init__()
    ...
    def test_mch_aoe(self):
        ...
        rb2.add_next("Chain Saw", targets="t1, t2")
        test_passed3, err_msg3 = self.__job_class_tester.test_aggregate_rotation(
        ...
        test_passed4, err_msg4 = self.__job_class_tester.test_aggregate_rotation(
            rb3, expected_damage_rb2_rb3, expected_time_rb3
        )
