...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-swf)](https://pypistats.org/packages/mypy-boto3-swf)
...
`mypy-boto3-swf` dependency in production. However, there is an issue in
