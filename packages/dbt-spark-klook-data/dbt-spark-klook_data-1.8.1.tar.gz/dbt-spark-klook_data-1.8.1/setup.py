...
package_name = "dbt-spark-klook_data"
...
setup(
    ...
    author="dbt Labs, cyril lu",
    author_email="info@dbtlabs.com,cyril.lu@klook.com",
    ...
    install_requires=[
        ...
        "dbt-core>=1.8.0a1",
        "boto3>=1.35.71",
        "alibabacloud_emr_serverless_spark20230808>=1.8.1",
    ],
    extras_require={
        "ODBC": odbc_extras,
