...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-scheduler)](https://pypistats.org/packages/mypy-boto3-scheduler)
...
`mypy-boto3-scheduler` dependency in production. However, there is an issue in
