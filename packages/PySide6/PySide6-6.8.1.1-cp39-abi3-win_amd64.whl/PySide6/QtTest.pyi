...
class QTest(Shiboken.Object):
    ...
    @typing.overload
    @staticmethod
    def qFindTestData(basepath: str, file: bytes | bytearray | memoryview | None= ..., line: int = ..., builddir: bytes | bytearray | memoryview | None= ..., sourcedir: bytes | bytearray | memoryview | None= ...) -> str: ...
    @typing.overload
    @staticmethod
    def qFindTestData(basepath: bytes | bytearray | memoryview, file: bytes | bytearray | memoryview | None= ..., line: int = ..., builddir: bytes | bytearray | memoryview | None= ..., sourcedir: bytes | bytearray | memoryview | None= ...) -> str: ...
    @staticmethod
    ...
    @typing.overload
    @staticmethod
    def qWaitForWindowFocused(widget: PySide6.QtGui.QWindow, timeout: PySide6.QtCore.QDeadlineTimer | PySide6.QtCore.QDeadlineTimer.ForeverConstant | int= ...) -> bool: ...
    @staticmethod
