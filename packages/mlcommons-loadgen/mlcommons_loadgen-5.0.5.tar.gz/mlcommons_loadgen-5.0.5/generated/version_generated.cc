...
const std::string& LoadgenVersion() {
  static const std::string str = "5.0.5";
  return str;
}

const std::string& LoadgenBuildDateLocal() {
  static const std::string str = "2025-01-07T23:22:51.402064";
  return str;
}

const std::string& LoadgenBuildDateUtc() {
  static const std::string str = "2025-01-07T23:22:51.402082";
  return str;
}

const std::string& LoadgenGitRevision() {
  static const std::string str = "d6c3a8d9e0";
  return str;
}

const std::string& LoadgenGitCommitDate() {
  static const std::string str = "2025-01-07T18:22:16-05:00";
  return str;
}
...
const std::string& LoadgenGitLog() {
  static const std::string str = R"LGVG_RSLD(d6c3a8d9e0c1dfb570733b957e643b5cebd2340e Don't do a loadgen release from dev branch, add python3.12,13 to loadgen test, exclude power-checker from auto format (#1994))LGVG_RSLD";
  return str;
}
...
3a9e2ade7068b507c9e0e77ad61f2456bd90fe46 /VERSION.txt
...
8e59ed620e703fd361f8f5f0c6d86bcf3ce9f6e2 /loadgen.cc
...
2e2c837d5b0a63263deee413447e3ffcc3698880 /test_settings_internal.cc
