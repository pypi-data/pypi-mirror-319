...
class FlowBase:
    ...
    async def get_global(self, key: str, init: Callable[[], Any] = None, async_init: Callable[[], Awaitable[Any]] = None) -> Any:
        """
        获取全局数据
        :param key: 全局key
        :param init: 初始化函数
        ...
        :return: 缓存的数据
        """
        return await self.__global_data.get_data(key, init, async_init)
