...
setup(
    name="grammarchecking2",                  # Package name on PyPI
    ...
    url="https://github.com/projectest20/grammarchecking2",  # URL to your project (GitHub repo or website)
    ...
    package_data={  # Include specific files for each package
        '': ['static/*', 'templates/*', 'uploads/*','index.html', 'style.css', 'script.js'],  # Add paths to your static files
    },
