...
def load_model(
    ...
    # TODO bug if i set default as model_id which is a variable
...
def generate_image(
    ...
    # TODO: ideally i should be able to get python_type from the pipeline class, here i repeat str twice... :(
...
# # trans_func = transform_to_generator(new_workflow)
