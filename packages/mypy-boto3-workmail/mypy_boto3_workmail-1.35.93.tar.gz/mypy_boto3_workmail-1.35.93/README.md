...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-workmail)](https://pypistats.org/packages/mypy-boto3-workmail)
...
`mypy-boto3-workmail` dependency in production. However, there is an issue in
