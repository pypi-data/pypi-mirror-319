...
class CSMPP_Hawkes(torch.nn.Module):
    
    def __init__(self, T, num_clusters, params, model, X_train, step=3, unit='Week', mini_batch = False, batch_input = False):
        super(CSMPP_Hawkes, self).__init__()
        """
        Args:
            T: Scalar
