...
from ..css import JqStyleWidget
from ..options import OptJqWiidgets
from ..js import JsJqWidgets
...
class JqTabs(Component):
    ...
    def add_panel(self, header, content, prepend: bool = False):
