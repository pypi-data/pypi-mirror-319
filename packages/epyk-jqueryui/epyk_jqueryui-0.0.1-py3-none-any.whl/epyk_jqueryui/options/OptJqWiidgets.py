...
class OptAccordion(Options):
    ...
    @property
    def event(self):
        """The type of event that the tabs should react to in order to activate the tab. To activate on hover,
        use "mouseover".
    ...
    def activate(self, js_funcs, profile):
        """Triggered after a panel has been activated (after animation completes). If the accordion was
