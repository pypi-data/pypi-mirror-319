...
from LbDevTools import DATA_DIR, createClangFormat, createGitIgnore
...
def main():
    ...
    manifest_file = Path(projectDir) / "manifest.xml"
    data = dict(
        project=project,
        version=version,
        ...
        lcg_version=LbEnv.ProjectEnv.lookup.getHepToolsInfo(manifest_file.to_posix())[0]
