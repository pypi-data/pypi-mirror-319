...
def GetFingerprintsForMolsInFile(filename: str, generator: typing.Any = None, options: SupplierOptions = ...) -> tuple:
    """
        ...
        C++ signature :
            boost::python::tuple GetFingerprintsForMolsInFile(std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char>> [,boost::python::api::object=None [,RDKit::GeneralMolSupplier::SupplierOptions=<rdkit.Chem.rdMolProcessing.SupplierOptions object at 0x103e990c0>]])
    """
@typing.overload
def GetFingerprintsForMolsInFile(filename: str, generator: typing.Any = None, options: SupplierOptions = ...) -> tuple:
    """
        ...
        C++ signature :
            boost::python::tuple GetFingerprintsForMolsInFile(std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char>> [,boost::python::api::object=None [,RDKit::GeneralMolSupplier::SupplierOptions=<rdkit.Chem.rdMolProcessing.SupplierOptions object at 0x103e99180>]])
    """
