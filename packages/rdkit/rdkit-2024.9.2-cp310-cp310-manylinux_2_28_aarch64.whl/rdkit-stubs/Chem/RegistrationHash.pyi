...
def GetMolHash(all_layers, hash_scheme: HashScheme = ...) -> str:
    ...
    """
def GetMolLayers(original_molecule: rdkit.Chem.rdchem.Mol, data_field_names: typing.Optional[typing.Iterable] = None, escape: typing.Optional[str] = None, cxflag = 1089, enable_tautomer_hash_v2 = False) -> {<HashLayer.NO_STEREO_TAUTOMER_HASH: 5>, <HashLayer.NO_STEREO_SMILES: 4>, <HashLayer.ESCAPE: 2>, <HashLayer.FORMULA: 3>, <HashLayer.TAUTOMER_HASH: 7>, <HashLayer.CANONICAL_SMILES: 1>, <HashLayer.SGROUP_DATA: 6>}:
    """
