...
from builtins import PyCapsule as CapsuleType
...
class OutputGrabber:
    ...
    """
    __firstlineno__: typing.ClassVar[int] = 247
    __static_attributes__: typing.ClassVar[tuple] = ('closed', 'data', 'oldoutput')
    def __del__(self):
        ...
    def __init__(self):
        ...
...
class PDFCatalog(PDFObject):
    ...
    """
    __firstlineno__: typing.ClassVar[int] = 319
    __static_attributes__: typing.ClassVar[tuple] = ('template')
    def __init__(self):
        ...
    def save(self, file):
        ...
class PDFDocument:
    ...
    __static_attributes__: typing.ClassVar[tuple] = ('PageCol', 'fontMapping', 'fontdict', 'fonts', 'info', 'infopos', 'objectPositions', 'objects', 'pagepositions', 'pages', 'startxref', 'xref')
...
class PDFImage(PDFObject):
    __firstlineno__: typing.ClassVar[int] = 473
...
class PDFInfo(PDFObject):
    ...
    """
    __firstlineno__: typing.ClassVar[int] = 330
    __static_attributes__: typing.ClassVar[tuple] = ('author', 'datestr', 'subject', 'title')
    def __init__(self):
        ...
    def save(self, file):
        ...
class PDFLiteral(PDFObject):
    ...
    """
    __firstlineno__: typing.ClassVar[int] = 309
    __static_attributes__: typing.ClassVar[tuple] = ('text')
...
class PDFObject:
    ...
    """
    __firstlineno__: typing.ClassVar[int] = 292
    __static_attributes__: typing.ClassVar[tuple] = tuple()
    def printPDF(self):
        ...
    def save(self, file):
...
class PDFOutline(PDFObject):
    ...
    """
    __firstlineno__: typing.ClassVar[int] = 352
    __static_attributes__: typing.ClassVar[tuple] = ('template')
    def __init__(self):
        ...
    def save(self, file):
...
class PDFPage(PDFObject):
    ...
    of objects as well.
    """
    __firstlineno__: typing.ClassVar[int] = 378
    __static_attributes__: typing.ClassVar[tuple] = ('drawables', 'hasImages', 'pageTransitionString', 'pageheight', 'pagewidth', 'stream', 'template')
    def __init__(self):
        ...
    def clear(self):
        ...
...
class PDFPageCollection(PDFObject):
    ...
    """
    __firstlineno__: typing.ClassVar[int] = 362
    __static_attributes__: typing.ClassVar[tuple] = ('PageList')
    def __init__(self):
        ...
    def save(self, file):
        ...
class PDFStream(PDFObject):
    ...
    """
    __firstlineno__: typing.ClassVar[int] = 436
    __static_attributes__: typing.ClassVar[tuple] = ('compression', 'data')
    def __init__(self):
        ...
    def save(self, file):
        ...
...
class PDFType1Font(PDFObject):
    ...
    __static_attributes__: typing.ClassVar[tuple] = ('fontname', 'keyname', 'template')
