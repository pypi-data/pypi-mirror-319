...
class SubstructureResult(Boost.Python.instance):
    ...
    def GetHitMolecules(self) -> list:
        ...
        """
    @property
    def GetMaxNumResults(*args, **kwargs):
        """
...
class SynthonSpace(Boost.Python.instance):
    ...
    def GetNumProducts(self) -> int:
        """
            ...
            C++ signature :
                __int64 GetNumProducts(class RDKit::SynthonSpaceSearch::SynthonSpace {lvalue})
        """
    ...
    def ReadDBFile(self, inFile: str) -> None:
        """
            ...
            C++ signature :
                void ReadDBFile(class RDKit::SynthonSpaceSearch::SynthonSpace {lvalue},class std::basic_string<char,struct std::char_traits<char>,class std::allocator<char> >)
        """
    ...
    def SubstructureSearch(self, query: Mol, params: typing.Any = None) -> SubstructureResult:
        """
            ...
            C++ signature :
                class RDKit::SynthonSpaceSearch::SearchResults SubstructureSearch(class RDKit::SynthonSpaceSearch::SynthonSpace {lvalue},class RDKit::ROMol [,class boost::python::api::object=None])
        """
    def Summarise(self) -> None:
        """
            ...
            C++ signature :
                void Summarise(class RDKit::SynthonSpaceSearch::SynthonSpace)
        """
...
class SynthonSpaceSearchParams(Boost.Python.instance):
    ...
    def fragSimilarityAdjuster(*args, **kwargs):
        """
        Similarities of fragments are generally low due to low bit densities.  For the fragment matching, reduce the similarity cutoff off by this amount.  Default=0.3.
        """
