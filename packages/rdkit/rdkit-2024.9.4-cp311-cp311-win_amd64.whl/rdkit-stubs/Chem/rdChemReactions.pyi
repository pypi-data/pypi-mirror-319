...
def CreateDifferenceFingerprintForReaction(reaction: ChemicalReaction, ReactionFingerPrintParams: ReactionFingerprintParams = ...) -> UIntSparseIntVect:
    """
        ...
        C++ signature :
            class RDKit::SparseIntVect<unsigned int> * __ptr64 CreateDifferenceFingerprintForReaction(class RDKit::ChemicalReaction [,struct RDKit::ReactionFingerprintParams=<rdkit.Chem.rdChemReactions.ReactionFingerprintParams object at 0x0000027C2B2252C0>])
    """
def CreateStructuralFingerprintForReaction(reaction: ChemicalReaction, ReactionFingerPrintParams: ReactionFingerprintParams = ...) -> ExplicitBitVect:
    """
        ...
        C++ signature :
            class ExplicitBitVect * __ptr64 CreateStructuralFingerprintForReaction(class RDKit::ChemicalReaction [,struct RDKit::ReactionFingerprintParams=<rdkit.Chem.rdChemReactions.ReactionFingerprintParams object at 0x0000027C2B2253C0>])
    """
...
def SanitizeRxn(rxn: ChemicalReaction, sanitizeOps: int = 4294967295, params: AdjustQueryParameters = ..., catchErrors: bool = False) -> SanitizeFlags:
    """
        ...
        C++ signature :
            enum RDKit::RxnOps::SanitizeRxnFlags SanitizeRxn(class RDKit::ChemicalReaction {lvalue} [,unsigned __int64=4294967295 [,struct RDKit::MolOps::AdjustQueryParameters=<rdkit.Chem.rdmolops.AdjustQueryParameters object at 0x0000027C2B2484A0> [,bool=False]]])
    """
