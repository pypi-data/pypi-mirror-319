...
class Canvas:
    ...
    """
    __firstlineno__: typing.ClassVar[int] = 103
    __static_attributes__: typing.ClassVar[tuple] = ('_charSpace', '_code', '_currentMatrix', '_currentPageHasImages', '_doc', '_filename', '_fillColorRGB', '_fillMode', '_fontname', '_fontsize', '_horizScale', '_leading', '_lineCap', '_lineDash', '_lineJoin', '_lineWidth', '_miterLimit', '_mitreLimit', '_pageCompression', '_pageNumber', '_pageTransitionString', '_pagesize', '_preamble', '_rise', '_strokeColorRGB', '_textLineMatrix', '_textMatrix', '_textMode', '_textRenderMode', '_wordSpace', '_x', '_y', 'bottomup')
...
class PDFPathObject:
    ...
    """
    __firstlineno__: typing.ClassVar[int] = 792
    __static_attributes__: typing.ClassVar[tuple] = ('_code')
    def __init__(self):
        ...
    def arc(self, x1, y1, x2, y2, startAng = 0, extent = 90):
        """
...
class PDFTextObject:
    ...
    """
    __firstlineno__: typing.ClassVar[int] = 867
    __static_attributes__: typing.ClassVar[tuple] = ('_canvas', '_charSpace', '_code', '_fillColorRGB', '_fontname', '_fontsize', '_horizScale', '_leading', '_rise', '_strokeColorRGB', '_textRenderMode', '_wordSpace', '_x', '_x0', '_y')
