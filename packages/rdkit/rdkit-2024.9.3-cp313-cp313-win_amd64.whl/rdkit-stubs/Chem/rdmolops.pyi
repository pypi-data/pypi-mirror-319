...
def CombineMols(mol1: Mol, mol2: Mol, offset: Point3D = ...) -> rdkit.Chem.Mol:
    """
        ...
        C++ signature :
            class RDKit::ROMol * __ptr64 CombineMols(class RDKit::ROMol,class RDKit::ROMol [,class RDGeom::Point3D=<rdkit.Geometry.rdGeometry.Point3D object at 0x000002882B6D3540>])
    """
...
def molzip(a: Mol, b: Mol, params: MolzipParams = ...) -> rdkit.Chem.Mol:
    """
        ...
        C++ signature :
            class RDKit::ROMol * __ptr64 molzip(class RDKit::ROMol,class RDKit::ROMol [,struct RDKit::MolzipParams=<rdkit.Chem.rdmolops.MolzipParams object at 0x000002882B66A140>])
    """
@typing.overload
def molzip(a: Mol, params: MolzipParams = ...) -> rdkit.Chem.Mol:
    """
        ...
        C++ signature :
            class RDKit::ROMol * __ptr64 molzip(class RDKit::ROMol [,struct RDKit::MolzipParams=<rdkit.Chem.rdmolops.MolzipParams object at 0x000002882B66A1F0>])
    """
@typing.overload
def molzip(row: dict, params: MolzipParams = ...) -> rdkit.Chem.Mol:
    """
        ...
        C++ signature :
            class RDKit::ROMol * __ptr64 molzip(class boost::python::dict [,struct RDKit::MolzipParams=<rdkit.Chem.rdmolops.MolzipParams object at 0x000002882B66A350>])
    """
def molzipFragments(mols: typing.Any, params: MolzipParams = ...) -> rdkit.Chem.Mol:
    """
        ...
        C++ signature :
            class RDKit::ROMol * __ptr64 molzipFragments(class boost::python::api::object {lvalue} [,struct RDKit::MolzipParams=<rdkit.Chem.rdmolops.MolzipParams object at 0x000002882B66A2A0>])
    """
