...
class _SpacialScore:
    ...
    __static_attributes__: typing.ClassVar[tuple] = ('bond_score', 'chiral_idxs', 'doublebonds_stereo', 'hyb_score', 'mol', 'normalize', 'ring_score', 'score', 'stereo_score')
    _hybridisations: typing.ClassVar[collections.defaultdict]  # value = defaultdict(<function _SpacialScore.<lambda> at 0x0000025C4B36A700>, {rdkit.Chem.rdchem.HybridizationType.SP: 1, rdkit.Chem.rdchem.HybridizationType.SP2: 2, rdkit.Chem.rdchem.HybridizationType.SP3: 3})
