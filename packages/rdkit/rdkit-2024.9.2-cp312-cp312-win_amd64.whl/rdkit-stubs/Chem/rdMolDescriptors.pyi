...
class AtomPairsParameters(Boost.Python.instance):
    ...
    atomTypes: typing.ClassVar[rdkit.rdBase._vectunsigned int]  # value = <rdkit.rdBase._vectunsigned int object at 0x00000240412C18C0>
...
class DoubleCubicLatticeVolume(Boost.Python.instance):
    ...
    def __init__(self, mol: Mol, isProtein: bool = False, includeLigand: bool = True, probeRadius: float = 1.2, depth: int = 4, dotDensity: int = 0) -> None:
        """
            ...
            C++ signature :
                void __init__(struct _object * __ptr64,class RDKit::ROMol [,bool=False [,bool=True [,double=1.2 [,int=4 [,int=0]]]]])
        """
...
class Properties(Boost.Python.instance):
    ...
    def RegisterProperty(propertyFunctor: PropertyFunctor) -> int:
        """
            ...
            C++ signature :
                int RegisterProperty(struct RDKit::Descriptors::PropertyFunctor * __ptr64)
        """
    @staticmethod
    def __reduce__(*args, **kwargs):
        ...
