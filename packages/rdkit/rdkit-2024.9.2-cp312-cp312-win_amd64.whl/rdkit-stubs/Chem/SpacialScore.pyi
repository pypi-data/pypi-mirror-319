...
class _SpacialScore:
    ...
    """
    _hybridisations: typing.ClassVar[collections.defaultdict]  # value = defaultdict(<function _SpacialScore.<lambda> at 0x000001C8A8CD63E0>, {rdkit.Chem.rdchem.HybridizationType.SP: 1, rdkit.Chem.rdchem.HybridizationType.SP2: 2, rdkit.Chem.rdchem.HybridizationType.SP3: 3})
