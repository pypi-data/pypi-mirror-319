...
import typing
__all__ = ['ClusterRenderer', 'ClusterToImg', 'ClusterToPDF', 'ClusterToSVG', 'ClusterUtils', 'DrawClusterTree', 'VisOpts', 'numpy', 'pid', 'piddle']
class ClusterRenderer:
    __firstlineno__: typing.ClassVar[int] = 70
    __static_attributes__: typing.ClassVar[tuple] = ('canvas', 'lineWidth', 'logScale', 'nPts', 'ptColors', 'pts', 'showIndices', 'showNodes', 'size', 'stopAtCentroids', 'tooClose', 'xSpace', 'ySpace')
...
class VisOpts:
    ...
    **Instance variables**
    ...
    """
    __firstlineno__: typing.ClassVar[int] = 25
