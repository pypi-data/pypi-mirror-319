...
import re as re
import typing
__all__ = ['Descriptors', 'DescriptorsMod', 'MolecularDescriptorCalculator', 'logger', 'pickle', 're']
class MolecularDescriptorCalculator(rdkit.ML.Descriptors.Descriptors.DescriptorCalculator):
    ...
    __static_attributes__: typing.ClassVar[tuple] = ('compoundList', 'descriptorNames', 'descriptorVersions', 'simpleList')
