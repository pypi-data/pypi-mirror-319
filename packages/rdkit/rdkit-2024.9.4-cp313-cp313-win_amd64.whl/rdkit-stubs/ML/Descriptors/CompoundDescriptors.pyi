...
import typing
__all__ = ['CompoundDescriptorCalculator', 'Descriptors', 'GetAllDescriptorNames', 'Parser', 'RDConfig', 'chemutils', 'countOptions']
class CompoundDescriptorCalculator(rdkit.ML.Descriptors.Descriptors.DescriptorCalculator):
    ...
    **Notes**
    ...
    """
    __firstlineno__: typing.ClassVar[int] = 62
    __static_attributes__: typing.ClassVar[tuple] = ('atomDict', 'compoundList', 'dbName', 'dbPassword', 'dbTable', 'dbUser', 'descriptorNames', 'nonZeroDescriptors', 'requiredDescriptors', 'simpleList')
