...
import typing
__all__ = ['Alignment', 'Chem', 'ClusterAlignments', 'Geometry', 'GetShapeShapeDistance', 'RDLogger', 'SubshapeAligner', 'SubshapeAlignment', 'SubshapeDistanceMetric', 'SubshapeObjects', 'TransformMol', 'logger', 'numpy']
class SubshapeAligner:
    __firstlineno__: typing.ClassVar[int] = 98
...
class SubshapeDistanceMetric:
    ...
    __firstlineno__: typing.ClassVar[int] = 44
    __static_attributes__: typing.ClassVar[tuple] = tuple()
