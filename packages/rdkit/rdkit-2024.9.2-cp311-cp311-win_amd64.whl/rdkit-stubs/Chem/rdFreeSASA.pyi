...
def CalcSASA(mol: Mol, radii: typing.Any, confIdx: int = -1, query: Atom = None, opts: SASAOpts = ...) -> float:
    """
        ...
        C++ signature :
            double CalcSASA(class RDKit::ROMol,class boost::python::api::object [,int=-1 [,class RDKit::Atom const * __ptr64=None [,struct FreeSASA::SASAOpts=<rdkit.Chem.rdFreeSASA.SASAOpts object at 0x00000284E6160A50>]]])
    """
...
def classifyAtoms(mol: Mol, options: SASAOpts = ...) -> typing.Any:
    """
        ...
        C++ signature :
            class boost::python::api::object classifyAtoms(class RDKit::ROMol {lvalue} [,struct FreeSASA::SASAOpts=<rdkit.Chem.rdFreeSASA.SASAOpts object at 0x00000284E61609E0>])
    """
