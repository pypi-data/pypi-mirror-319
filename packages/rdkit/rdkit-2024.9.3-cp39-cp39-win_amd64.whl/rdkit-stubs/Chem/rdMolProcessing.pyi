...
def GetFingerprintsForMolsInFile(filename: str, generator: typing.Any = None, options: SupplierOptions = ...) -> tuple:
    """
        ...
        C++ signature :
            class boost::python::tuple GetFingerprintsForMolsInFile(class std::basic_string<char,struct std::char_traits<char>,class std::allocator<char> > [,class boost::python::api::object=None [,struct RDKit::GeneralMolSupplier::SupplierOptions=<rdkit.Chem.rdMolProcessing.SupplierOptions object at 0x0000014E539BB110>]])
    """
@typing.overload
def GetFingerprintsForMolsInFile(filename: str, generator: typing.Any = None, options: SupplierOptions = ...) -> tuple:
    """
        ...
        C++ signature :
            class boost::python::tuple GetFingerprintsForMolsInFile(class std::basic_string<char,struct std::char_traits<char>,class std::allocator<char> > [,class boost::python::api::object=None [,struct RDKit::GeneralMolSupplier::SupplierOptions=<rdkit.Chem.rdMolProcessing.SupplierOptions object at 0x0000014E539BB1E0>]])
    """
