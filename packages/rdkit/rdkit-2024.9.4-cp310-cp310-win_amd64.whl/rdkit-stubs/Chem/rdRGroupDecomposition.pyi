...
def RGroupDecompose(cores: typing.Any, mols: typing.Any, asSmiles: bool = False, asRows: bool = True, options: RGroupDecompositionParameters = ...) -> typing.Any:
    """
        ...
        C++ signature :
            class boost::python::api::object RGroupDecompose(class boost::python::api::object,class boost::python::api::object [,bool=False [,bool=True [,struct RDKit::RGroupDecompositionParameters=<rdkit.Chem.rdRGroupDecomposition.RGroupDecompositionParameters object at 0x0000024F03691300>]]])
    """
