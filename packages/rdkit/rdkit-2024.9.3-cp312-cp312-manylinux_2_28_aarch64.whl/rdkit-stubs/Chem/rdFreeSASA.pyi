...
def CalcSASA(mol: Mol, radii: typing.Any, confIdx: int = -1, query: Atom = None, opts: SASAOpts = ...) -> float:
    """
        ...
        C++ signature :
            double CalcSASA(RDKit::ROMol,boost::python::api::object [,int=-1 [,RDKit::Atom const*=None [,FreeSASA::SASAOpts=<rdkit.Chem.rdFreeSASA.SASAOpts object at 0xffff7a1d3f40>]]])
    """
...
def classifyAtoms(mol: Mol, options: SASAOpts = ...) -> typing.Any:
    """
        ...
        C++ signature :
            boost::python::api::object classifyAtoms(RDKit::ROMol {lvalue} [,FreeSASA::SASAOpts=<rdkit.Chem.rdFreeSASA.SASAOpts object at 0xffff7a1d3ed0>])
    """
