...
def count_chimeric_reads_for_path(bam:str | os.PathLike | pathlib.Path,threads:int | None) -> int:
    r"""Calculate the number of chimeric reads in a BAM file."""

def count_chimeric_reads_for_paths(bams:typing.Sequence[str | os.PathLike | pathlib.Path],threads:int | None) -> dict[str, int]:
