...
class DataCenter:
    ...
    async def build_addr_nodes(self, addresses: List[str], attributes: Optional[List[str]] = None) -> List[Dict[str, Any]]:
        ...
        need_first_tx = any(attr in attributes for attr in ["firstTx", "firstTxHash", "firstTxBlock"])
        ...
        need_contract_status = "isContract" in attributes or need_any_queries
        ...
        # Build final nodes list with requested attributes
        ...
        for addr in addresses:
            ...
            if "firstTxHash" in attributes and "firstTx" in attributes:
                node["firstTxHash"] = first_txs.get(addr, {}).get('hash')
