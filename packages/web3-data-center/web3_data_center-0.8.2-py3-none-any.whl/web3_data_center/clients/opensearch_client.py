...
class OpenSearchClient(BaseClient):
    ...
    async def search_first_tx_batch(self, to_addresses: List[str], index: str) -> Dict[str, Dict[str, Any]]:
        """
        ...
        for i in range(0, len(to_addresses), batch_size):
            ...
            try:
                ...
                tasks = [self._search_first_tx_batch([addr], index) for addr in addr_batch]
    ...
    async def search_first_tx_batch(self, to_addresses: List[str], index: str) -> Dict[str, Dict[str, Any]]:
        ...
        for batch in batches:
            tasks.append(self._search_first_tx_batch(batch, index))
