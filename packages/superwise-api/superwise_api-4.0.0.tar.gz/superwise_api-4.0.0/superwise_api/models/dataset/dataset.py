...
class Dataset(SuperwiseEntity):
    ...
    description: Union[str, None] = Field(description="Relevant information about the context of this dataset")
    model_version_id: Union[str, None] = Field()
    created_at: Union[datetime, None] = Field()
    updated_at: Union[datetime, None] = Field()
    created_by: str = Field()
    tags: Union[list[DatasetTag], None] = Field(default=None)
