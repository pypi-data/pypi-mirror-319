...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-shield)](https://pypistats.org/packages/mypy-boto3-shield)
...
`mypy-boto3-shield` dependency in production. However, there is an issue in
