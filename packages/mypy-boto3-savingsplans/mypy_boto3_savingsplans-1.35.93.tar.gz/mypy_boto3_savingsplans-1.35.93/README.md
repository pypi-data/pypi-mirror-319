...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-savingsplans)](https://pypistats.org/packages/mypy-boto3-savingsplans)
...
`mypy-boto3-savingsplans` dependency in production. However, there is an issue
