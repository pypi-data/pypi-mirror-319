...
class SourceEntry(_message.Message):
    __slots__ = ("id", "resource_ids", "name", "num_rows", "schema", "source_type", "pipeline_id")
    ...
    pipeline_id: str
    def __init__(self, id: _Optional[str] = ..., resource_ids: _Optional[_Iterable[str]] = ..., name: _Optional[str] = ..., num_rows: _Optional[int] = ..., schema: _Optional[_Union[_table_pb2.TableSchema, _Mapping]] = ..., source_type: _Optional[_Union[_resource_pb2.ResourceType, str]] = ..., pipeline_id: _Optional[str] = ...) -> None: ...
