...
setuptools.setup(
    ...
    long_description="Model Hierarchical Visualization TensorBoard Plugin : \
        https://gitee.com/ascend/att/tree/master/plugins/tensorboard-plugins/tb_graph_ascend",
    url="https://gitee.com/ascend/att/tree/master/plugins/tensorboard-plugins/tb_graph_ascend",
    author="Ascend Team",
