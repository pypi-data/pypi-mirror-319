...
outputDir_erly = r"C:\Users\perhe\Desktop\tetet"
rin_erly = r"C:\Users\perhe\OneDrive\Documents\Python_skript\test_GNSS\Erly Caldas de Lima\P15600USA_R_20230010000_01D_15S_MO.rnx"
broad_erly = r"C:\Users\perhe\OneDrive\Documents\Python_skript\test_GNSS\Erly Caldas de Lima\P15600USA_R_20230010000_01D_MN.rnx"
...
outputDir_test = r"C:\Users\perhe\Desktop\CSV_export4"
rinObs = r"C:\Users\perhe\OneDrive\Documents\Python_skript\GNSS_repo\TestData\ObservationFiles\OPEC00NOR_S_20220010000_01D_30S_MO_3.04.rnx"
rinnav = r"C:\Users\perhe\OneDrive\Documents\Python_skript\GNSS_repo\TestData\NavigationFiles\BRDC00IGS_R_20220010000_01D_MN.rnx"
# sp3 = r"C:\Users\perhe\OneDrive\Documents\Python_skript\GNSS_repo\TestData\SP3\Testfile_20220101.eph"
analysisResults = GNSS_MultipathAnalysis(rinObs,
...
outputDir_test = r"C:\Users\perhe\Desktop\TEST"
rinObs = r"C:\Users\perhe\OneDrive\Documents\Python_skript\GNSS_repo\TestData\ObservationFiles\OPEC00NOR_S_20220010000_01D_30S_MO_3.04.rnx"
sp3 = r"C:\Users\perhe\OneDrive\Documents\Python_skript\GNSS_repo\TestData\SP3\Testfile_20220101.eph"
analysisResults = GNSS_MultipathAnalysis(rinObs,
                                            # broadcastNav1=rinnav,
...
outputDir_test = r"C:\Users\perhe\Desktop\CSV_export"
rinObs = r"C:\Users\perhe\OneDrive\Documents\Python_skript\GNSS_repo\TestData\ObservationFiles\NMBUS_SAMSUNG_S20.20o"
sp3_NMBUS = r"C:\Users\perhe\OneDrive\Documents\Python_skript\GNSS_repo\TestData\SP3\NMBUS_2020 10 30.SP3"
analysisResults = GNSS_MultipathAnalysis(rinObs,
                                          sp3NavFilename_1=sp3_NMBUS,
...
outputDir = r"C:\Users\perhe\Desktop\TEST BROADCAST"
rinObs = r"C:\Users\perhe\OneDrive\Documents\Python_skript\GNSS_repo\TestData\ObservationFiles\OPEC00NOR_S_20220010000_01D_30S_MO_3.04.rnx"
rinNav = r"C:\Users\perhe\OneDrive\Documents\Python_skript\GNSS_repo\TestData\NavigationFiles\BRDC00IGS_R_20220010000_01D_MN.rnx"
analysisResults = GNSS_MultipathAnalysis(rinObs,
                                         broadcastNav1=rinNav,
...
def write_data_to_csv_file(data_lst, file_path):
    """Write a list of strings to a CSV file"""
    with open(file_path, 'w') as file:
        for line in data_lst:
            file.write(line + '\n')

# Example on how to extract multipath RMS values and put into text file (CSV file)
GNSS_systems = analysisResults["GNSSsystems"]
mp_data_lst = ["System; Band; Code; RMS_MP_AVG"]
for sys in GNSS_systems:
    curr_sys = analysisResults[sys]
    for band in analysisResults[sys]["Bands"]:
        for code in analysisResults[sys][band]["Codes"]:
            curr_code_data = analysisResults[sys][band].get(code)
            rms_multipath_avg = round(curr_code_data["rms_multipath_range1_averaged"],4) if curr_code_data is not None else None
            mp_data_lst.append(f"{sys};{band};{code};{rms_multipath_avg}")


file_path = r"C:\Users\perhe\Desktop\GitHub\results.csv"
write_data_to_csv_file(mp_data_lst, file_path)


#%% Extract elevation and azimuth angle
def generate_timestamps(tFirstObs, tInterval, tLastObs):
    # Convert tFirstObs to a datetime object
    start_datetime = datetime(*tFirstObs.flatten().astype(int))
    num_epochs = int((tLastObs[3] * 3600 + tLastObs[4] * 60 + tLastObs[5] -
                      (tFirstObs[3] * 3600 + tFirstObs[4] * 60 + tFirstObs[5])) / tInterval) + 1
    # Create a list of timestamps for all epochs
    timestamps = [start_datetime + timedelta(seconds=i * tInterval) for i in range(num_epochs)]
    return timestamps
...
time_stamps = generate_timestamps(tFirstObs, tInterval, tLastObs)

for sys in analysisResults["Sat_position"].keys():
    azimuth = np.round(analysisResults["Sat_position"][sys]["azimuth"],2)
    elevation = np.round(analysisResults["Sat_position"][sys]["elevation"],2)
    headers = ["Sat " + str(i) for i in range(len(azimuth[0]))]
    azimuth_with_headers = np.vstack([headers, azimuth])[:,1::]
    elevation_with_headers = np.vstack([headers, elevation])[:,1::]
    # Transpose the arrays to have timestamps as rows
    azimuth_with_timestamps = np.column_stack([["Time"] + time_stamps, azimuth_with_headers])
    elevation_with_timestamps = np.column_stack([["Time"] + time_stamps, elevation_with_headers])
    # Save array to file
    np.savetxt(outputDir + f'/Satellite_azimuths_{sys}.csv', azimuth_with_timestamps, delimiter=';', fmt='%s')
    np.savetxt(outputDir + f'/Satellite_elevation_{sys}.csv', elevation_with_timestamps, delimiter=';', fmt='%s')
...
outputdir = r"C:\Users\perhe\Desktop\ResTest"
rinObs = r"C:\Users\perhe\OneDrive\Documents\Python_skript\GNSS_repo\TestData\ObservationFiles\OPEC00NOR_S_20220010000_01D_30S_MO_3.04_croped.rnx"
rinNav1 = r"C:\Users\perhe\OneDrive\Documents\Python_skript\GNSS_repo\TestData\NavigationFiles/OPEC00NOR_S_20220010000_01D_CN.rnx"
rinNav2 = r"C:\Users\perhe\OneDrive\Documents\Python_skript\GNSS_repo\TestData\NavigationFiles/OPEC00NOR_S_20220010000_01D_EN.rnx"
rinNav3 = r"C:\Users\perhe\OneDrive\Documents\Python_skript\GNSS_repo\TestData\NavigationFiles/OPEC00NOR_S_20220010000_01D_GN.rnx"
rinNav4 = r"C:\Users\perhe\OneDrive\Documents\Python_skript\GNSS_repo\TestData\NavigationFiles/OPEC00NOR_S_20220010000_01D_RN.rnx"
analysisResults = GNSS_MultipathAnalysis(rinObs,
...
from gnssmultipath import GNSS_MultipathAnalysis, GNSSPositionEstimator
import numpy as np
