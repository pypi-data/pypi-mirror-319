# 
# 
# NOTE: This is copied from the diffusers library and modified to allow passing text masks through to the UNet cross attention layers.
# 
# 
...
class MaskedStableDiffusionPipeline(
    DiffusionPipeline,
        ...
        **kwargs,
        ...
        if self.do_classifier_free_guidance:
            ...
            if encoder_attention_mask is not None:
                uncond_mask = torch.ones_like(encoder_attention_mask)
