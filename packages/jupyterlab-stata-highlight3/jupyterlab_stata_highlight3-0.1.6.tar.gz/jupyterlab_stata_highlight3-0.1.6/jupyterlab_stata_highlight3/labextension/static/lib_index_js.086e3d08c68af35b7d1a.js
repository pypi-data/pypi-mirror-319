"use strict";
(self["webpackChunkjupyterlab_stata_highlight3"] = self["webpackChunkjupyterlab_stata_highlight3"] || []).push([["lib_index_js"],{
...
/* harmony export */ });
/* harmony import */ var _codemirror_legacy_modes_mode_simple_mode__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @codemirror/legacy-modes/mode/simple-mode */ "./node_modules/@codemirror/legacy-modes/mode/simple-mode.js");
...
/* harmony import */ var _stata__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./stata */ "./lib/stata.js");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ([
    {
        ...
        requires: [_jupyterlab_codemirror__WEBPACK_IMPORTED_MODULE_1__.IEditorLanguageRegistry, _jupyterlab_settingregistry__WEBPACK_IMPORTED_MODULE_2__.ISettingRegistry],
        autoStart: true,
        activate: async (app, registry, settings) => {
            ...
            const customKeywords = setting.get('keyword').composite;
            let keywords_all = _stata__WEBPACK_IMPORTED_MODULE_3__.builtins_str;
            if (customKeywords.length === 0) {
                ...
                keywords_all =
                    _stata__WEBPACK_IMPORTED_MODULE_3__.builtins_str.slice(0, -1) + '|' + customKeywords.join('|') + ')';
            }
            const stataMode = (0,_codemirror_legacy_modes_mode_simple_mode__WEBPACK_IMPORTED_MODULE_4__.simpleMode)({
                // The start state contains the rules that are initially used
                start: [
                    // Comments
                    {
                        regex: /\/\/\/?.*$/,
                        token: _stata__WEBPACK_IMPORTED_MODULE_3__.color_translator['comment'],
                        sol: true
                    },
                    { regex: /(\s)\/\/\/?.*$/, token: _stata__WEBPACK_IMPORTED_MODULE_3__.color_translator['comment'] },
                    { regex: /\s*\*.*$/, token: _stata__WEBPACK_IMPORTED_MODULE_3__.color_translator['comment'], sol: true },
                    {
                        regex: /\/\*/,
                        token: _stata__WEBPACK_IMPORTED_MODULE_3__.color_translator['comment'],
                        push: 'comments_block'
                    ...
                    {
                        regex: /"/,
                        token: _stata__WEBPACK_IMPORTED_MODULE_3__.color_translator['string'],
                        push: 'string_regular'
                    },
                    {
                        regex: /`"/,
                    ...
                    {
                        regex: /`/,
                        token: _stata__WEBPACK_IMPORTED_MODULE_3__.color_translator['variable-2'],
                        push: 'macro_local'
                    },
                    {
                        regex: /\$/,
                    ...
                    // There are two separate dictionaries because the `\b` at the beginning of the regex seemed not to work. So instead, I either match the preceding space before the keyword or require the keyword to be at beginning of the string. I think this necessitates two different strings.
                    {
                        ...
                        token: _stata__WEBPACK_IMPORTED_MODULE_3__.color_translator['keyword']
                    },
                    {
                    ...
                    {
                        regex: new RegExp('(\\W)' + _stata__WEBPACK_IMPORTED_MODULE_3__.builtins_fun_str),
                        token: ['', _stata__WEBPACK_IMPORTED_MODULE_3__.color_translator['def']]
                    },
                ...
                comments_block: [
                    ...
                    { regex: /\*\/\*/, token: _stata__WEBPACK_IMPORTED_MODULE_3__.color_translator['comment'] },
                    {
                        regex: /(\*\/\s+\*(?!\/)[^\n]*)|(\*\/)/,
                        token: _stata__WEBPACK_IMPORTED_MODULE_3__.color_translator['comment'],
                        pop: true
                ...
                string_compound: [
                    ...
                    { regex: /"'/, token: _stata__WEBPACK_IMPORTED_MODULE_3__.color_translator['string'], pop: true },
                    {
                        regex: /`/,
                        token: _stata__WEBPACK_IMPORTED_MODULE_3__.color_translator['variable-2'],
                        push: 'macro_local'
                    ...
                    { regex: /./, token: _stata__WEBPACK_IMPORTED_MODULE_3__.color_translator['string'] }
                ],
                string_regular: [
                    { regex: /"/, token: _stata__WEBPACK_IMPORTED_MODULE_3__.color_translator['string'], pop: true },
                    {
                ...
                macro_local: [
                    ...
                    { regex: /'/, token: _stata__WEBPACK_IMPORTED_MODULE_3__.color_translator['variable-2'], pop: true },
                    { regex: /./, token: _stata__WEBPACK_IMPORTED_MODULE_3__.color_translator['variable-2'] }
                ],
                macro_global: [
                    { regex: /\}/, token: _stata__WEBPACK_IMPORTED_MODULE_3__.color_translator['variable-2'], pop: true },
                    {
            ...
            registry.addLanguage({
                ...
                mime: 'text/x-stata',
                load: async () => {
                    return new _codemirror_language__WEBPACK_IMPORTED_MODULE_0__.LanguageSupport(_codemirror_language__WEBPACK_IMPORTED_MODULE_0__.StreamLanguage.define(stataMode));
                }
            });
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   builtins_fun_str: () => (/* binding */ builtins_fun_str),
/* harmony export */   builtins_str: () => (/* binding */ builtins_str),
/* harmony export */   color_translator: () => (/* binding */ color_translator)
/* harmony export */ });
// CodeMirror, copyright (c) by Marijn Haverbeke and others
// Distributed under an MIT license: https://codemirror.net/LICENSE
...
//# sourceMappingURL=lib_index_js.086e3d08c68af35b7d1a.js.map