...
class CreateDatasetDto(BaseModel):
    ...
    dataset_name: StrictStr = Field(description="A name for the dataset, given by the creator to carry some semantic meaning. Useful for display purposes e.g. instead of displaying the pid. Will be autofilled if missing using info from sourceFolder.", alias="datasetName")
    ...
    instrument_ids: Optional[StrictStr] = Field(default=None, description="ID of the instrument or instruments where the data included or used in this datasets was collected on.", alias="instrumentIds")
