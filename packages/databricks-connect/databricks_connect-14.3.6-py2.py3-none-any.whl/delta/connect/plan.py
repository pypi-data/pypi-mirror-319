...
class CreateDeltaTable(DeltaLogicalPlan):
    def __init__(
        ...
        , clusteringColumns: List[str] # Edge
    ) -> None:
        super().__init__(None)
        self._mode = mode
        ...
        self._clusteringColumns = clusteringColumns # Edge
    ...
    def to_delta_command(self, client: SparkConnectClient) -> proto.DeltaCommand:
        ...
        command.create_delta_table.clustering_columns.extend(self._clusteringColumns) # Edge
