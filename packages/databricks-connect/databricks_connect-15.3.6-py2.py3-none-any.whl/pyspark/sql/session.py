...
class SparkSession(SparkConversionMixin):
        ...
        def getOrCreate(self) -> "SparkSession":
            ...
            with self._lock:
                ...
                raise RuntimeError(
                    ...
                    "Use DatabricksSession.builder to create a remote Spark session instead.\n"
                    "Refer to https://docs.databricks.com/dev-tools/databricks-connect.html "
                    "on how to configure Databricks Connect."
                )
    ...
    def conf(self) -> RuntimeConfig:
        ...
        >>> spark.conf.set("key", "value")  # doctest: +SKIP
        >>> spark.conf.get("key")  # doctest: +SKIP
        'value'
        """
    ...
    def udf(self) -> "UDFRegistration":
        ...
        >>> spark.sql("SELECT strlen('test')").show()  # doctest: +SKIP
        +------------+
        |strlen(test)|
        +------------+
        |           4|
