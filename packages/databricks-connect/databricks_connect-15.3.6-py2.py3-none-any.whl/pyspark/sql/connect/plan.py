...
class WriteOperation(LogicalPlan):
    def __init__(self, child: "LogicalPlan") -> None:
        ...
        self.clustering_cols: List[str] = []  # Edge
    ...
    def command(self, session: "SparkConnectClient") -> proto.Command:
        ...
        plan.write_operation.clustering_columns.extend(self.clustering_cols)  # Edge
    ...
    def print(self, indent: int = 0) -> str:
        ...
        return (
            ...
            f"clustering_cols='{self.clustering_cols}'"  # Edge
    ...
    def _repr_html_(self) -> str:
        return (
            ...
            f"clustering_cols: '{self.clustering_cols}' <br />"  # Edge
...
class WriteOperationV2(LogicalPlan):
    def __init__(self, child: "LogicalPlan", table_name: str) -> None:
        ...
        self.clustering_columns: List[str] = []  # Edge
        self.options: dict[str, Optional[str]] = {}
    ...
    def command(self, session: "SparkConnectClient") -> proto.Command:
        ...
        plan.write_operation_v2.clustering_columns.extend(self.clustering_columns)  # Edge
