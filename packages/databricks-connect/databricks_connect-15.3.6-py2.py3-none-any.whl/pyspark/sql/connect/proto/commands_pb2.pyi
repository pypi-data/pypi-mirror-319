...
class _StreamingQueryEventTypeEnumTypeWrapper(
    ...
    ASYNC_STATE_COMMIT_COMPLETION_EVENT: _StreamingQueryEventType.ValueType  # 4
...
ASYNC_STATE_COMMIT_COMPLETION_EVENT: StreamingQueryEventType.ValueType  # 4
...
class StreamingQueryListenerBusCommand(google.protobuf.message.Message):
    ...
    CACHE_USER_CREDENTIALS_FIELD_NUMBER: builtins.int
    REMOVE_USER_CREDENTIALS_FIELD_NUMBER: builtins.int
    add_listener_bus_listener: builtins.bool
    remove_listener_bus_listener: builtins.bool
    cache_user_credentials: builtins.bool
    """EDGE"""
    remove_user_credentials: builtins.str
    """EDGE"""
    def __init__(
        self,
        *,
...
class StreamingQueryListenerEventsResult(google.protobuf.message.Message):
    ...
    CREDENTIAL_KEY_FIELD_NUMBER: builtins.int
    @property
    def events(
        self,
    ) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[
    ...
    def __init__(
        ...
        *,
        ...
        credential_key: builtins.str | None = ...,
    ) -> None: ...
    def HasField(
        self,
        field_name: typing_extensions.Literal[
    ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing_extensions.Literal["_credential_key", b"_credential_key"]
    ) -> typing_extensions.Literal["credential_key"] | None: ...
    @typing.overload
    def WhichOneof(
        self,
        oneof_group: typing_extensions.Literal[
