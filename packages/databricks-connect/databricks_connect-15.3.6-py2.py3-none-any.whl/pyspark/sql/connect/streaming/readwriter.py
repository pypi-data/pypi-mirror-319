...
#
from pyspark.sql.connect.utils import check_dependencies, normalize_workspace_includes
...
class DataStreamWriter:
    ...
    def foreach(self, f: Union[Callable[[Row], None], "SupportsProcess"]) -> "DataStreamWriter":
        ...
        self._write_proto.foreach_writer.python_function.additional_includes.extend(
            normalize_workspace_includes()  # EDGE
        )
        return self
    ...
    def foreachBatch(self, func: Callable[["DataFrame", int], None]) -> "DataStreamWriter":
        ...
        self._write_proto.foreach_batch.python_function.additional_includes.extend(
            normalize_workspace_includes()  # EDGE
        )
        return self
