...
def _test() -> None:
    ...
    from pyspark.testing.connectutils import ReusedConnectTestCase, disable_test_for_uc

    ReusedConnectTestCase.update_client_for_uc(globs["spark"])

    # Disable function tests for UC
    if disable_test_for_uc:
        del pyspark.sql.connect.functions.call_function.__doc__
