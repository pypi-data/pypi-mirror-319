...
class SQLTestUtils:
    ...
    def sql_conf(self, pairs):
        ...
        # BEGIN-EDGE
        origin = self.spark.conf.get("spark.testing.databricks.runtimeConfigAllowlist.enabled")
        self.spark.conf.set("spark.testing.databricks.runtimeConfigAllowlist.enabled", False)
        # END-EDGE
        ...
        try:
            ...
            # BEGIN-EDGE
            self.spark.conf.set("spark.testing.databricks.runtimeConfigAllowlist.enabled", origin)
            # END-EDGE
