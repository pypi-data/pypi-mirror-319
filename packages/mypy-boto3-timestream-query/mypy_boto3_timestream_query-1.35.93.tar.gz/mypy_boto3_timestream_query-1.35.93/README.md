...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-timestream-query)](https://pypistats.org/packages/mypy-boto3-timestream-query)
...
`mypy-boto3-timestream-query` dependency in production. However, there is an
