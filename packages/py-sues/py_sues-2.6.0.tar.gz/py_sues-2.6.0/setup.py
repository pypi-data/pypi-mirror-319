...
def git_commit():
    try:
        ...
        print("Warning: Git repository not found, using 'Unknown' commit hash.")
        git_commit = 'Unknown'
...
def readme():
    try:
        ...
        # 返回默认文本或空内容
        return "This project does not have a README file. Please refer to the documentation for further details."
...
if __name__ == "__main__":
    setup(
        ...
        long_description=readme(),  # 使用修改后的 readme 方法
