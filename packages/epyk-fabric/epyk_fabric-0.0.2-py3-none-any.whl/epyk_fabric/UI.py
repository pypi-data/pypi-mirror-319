...
from .html import HtmlFtwForms
from . import groups
from . import PkgImports
...
class Components:
  ...
  def label(self, text=None, width=(100, "px"), height=(None, "px"), html_code=None, tooltip='', options=None,
    ...
    :param profile:
    """
    component = self.page.ui.tags.label(text, width, height, html_code, tooltip, options, profile)
  ...
  def loading(self, text="Loading...", width=(None, "%"), height=(None, "%"), options=None,
              profile=None) -> HtmlFtwForms.Spinner:
  ...
  @property
  def buttons(self) -> groups.FtwCompBtns.Components:
    """
    Related Pages:
  ...
  @property
  def lists(self) -> groups.FtwCompLists.Components:
