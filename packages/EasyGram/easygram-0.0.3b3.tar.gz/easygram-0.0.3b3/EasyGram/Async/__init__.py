...
class AsyncBot:
    ...
    def _coroutine_run_with_thread(self, func: Callable, *args):
        """
        Не смотри!!!Не для тебя сделано >_<!!!
        :param func: Не смотри!!!Не для тебя сделано >_<!!!
        :param args: Не смотри!!!Не для тебя сделано >_<!!!
        :return: Не смотри!!!Не для тебя сделано >_<!!!
        """
        try:
