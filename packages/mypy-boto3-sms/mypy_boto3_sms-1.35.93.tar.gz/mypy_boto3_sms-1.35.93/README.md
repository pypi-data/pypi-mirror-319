...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-sms)](https://pypistats.org/packages/mypy-boto3-sms)
...
`mypy-boto3-sms` dependency in production. However, there is an issue in
