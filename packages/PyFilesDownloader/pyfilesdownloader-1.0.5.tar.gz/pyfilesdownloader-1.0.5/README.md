# [PyDownloader](PyFilesDownloader)

#### 介绍

PyDownloader是一个基于Python的下载器，可以下载各种网站的资源。
...
```python
from PyDownloader import StreamDownloader
...
```python
from PyDownloader import M3U8Downloader
...
```python
from PyDownloader.async_loader.async_m3u8 import AsyncM3U8Downloader
...
```python
# coding: utf-8
from PyDownloader.Qt import QueueStreamDownloaderThread
...
```python
# coding: utf-8
from PyDownloader.Qt import M3u8DownloaderThread
