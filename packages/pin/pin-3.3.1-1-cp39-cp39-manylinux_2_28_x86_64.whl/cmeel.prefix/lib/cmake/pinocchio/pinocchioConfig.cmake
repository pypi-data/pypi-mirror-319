...
set("PINOCCHIO_DOXYGENDOCDIR" "${PACKAGE_PREFIX_DIR}/share/doc/pinocchio/doxygen-html")
set("pinocchio_DEPENDENCIES" "Eigen3;urdfdom_headers;urdfdom;OpenMP;Boost;eigenpy;console_bridge;hpp-fcl")
...
if(${CMAKE_VERSION} VERSION_LESS "3.15.0")
  ...
  find_package(hpp-fcl 2.1.2 REQUIRED)
else()
  SET(Boost_USE_STATIC_LIBS OFF)
  SET(Boost_USE_MULTITHREADED ON)
  SET(Boost_NO_BOOST_CMAKE ON)
  ...
  find_dependency(hpp-fcl 2.1.2 REQUIRED)
endif()
