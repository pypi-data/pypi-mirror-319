...
from runpod_ext.endpoint.helpers import FINAL_STATES, is_completed
from runpod_ext.http_client import ClientSession
...
class Job:
    ...
    def __init__(self, endpoint_id: str, job_id: str, session: ClientSession):
        from runpod_ext import (  # pylint: disable=import-outside-toplevel,cyclic-import
            api_key,
            endpoint_url_base,
        )
