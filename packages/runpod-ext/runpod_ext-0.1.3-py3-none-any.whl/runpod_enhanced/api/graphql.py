...
from runpod_ext import error
from runpod_ext.user_agent import USER_AGENT
...
def run_graphql_query(query: str) -> Dict[str, Any]:
    ...
    Run a GraphQL query
    """
    from runpod_ext import api_key  # pylint: disable=import-outside-toplevel, cyclic-import
