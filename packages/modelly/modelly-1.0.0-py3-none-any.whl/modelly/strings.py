...
MESSAGING_API_ENDPOINT = "https://api-modelly.khulnasoft.com/modelly-messaging/en"
...
en = {
    ...
    "COULD_NOT_GET_SHARE_LINK": "\nCould not create share link. Please check your internet connection or our status page: https://status.modelly.khulnasoft.com.",
    ...
    "BETA_INVITE": "\nThanks for being a Modelly user! If you have questions or feedback, please join our Discord server and chat with us: https://discord.gg/feTf9x3ZSB",
    ...
    "SHARE_LINK_MESSAGE": "\nThis share link expires in 72 hours. For free permanent hosting and GPU upgrades, run `modelly deploy` from the terminal in the working directory to deploy to Hugging Face Spaces (https://huggingface.co/spaces)",
...
if os.getenv("MODELLY_ANALYTICS_ENABLED", "True") == "True" and not wasm_utils.IS_WASM:
