...
from modelly.context import Context, LocalContext
from modelly.events import EventListener, EventListenerMethod
from modelly.layouts import Column, Row

if TYPE_CHECKING:
    from modelly.events import EventListenerCallable
...
def render(
    ...
    *,
    ...
    """
    The render decorator allows Modelly Blocks apps to have dynamic layouts, so that the components and event listeners in your app can change depending on custom logic.
