...
from modelly.themes.utils import (
    colors,
    fonts,
...
from modelly.themes.utils.readme_content import README_CONTENT
...
class ThemeClass:
    ...
    def push_to_hub(
        ...
        from modelly import __version__
...
class Base(ThemeClass):
    def __init__(
        ...
        *,
        ...
        """
        Parameters:
            primary_hue: The primary hue of the theme. Load a preset, like modelly.themes.colors.green (or just the string "green"), or pass your own modelly.themes.utils.Color object.
            secondary_hue: The secondary hue of the theme. Load a preset, like modelly.themes.colors.green (or just the string "green"), or pass your own modelly.themes.utils.Color object.
            neutral_hue: The neutral hue of the theme, used . Load a preset, like modelly.themes.colors.green (or just the string "green"), or pass your own modelly.themes.utils.Color object.
            text_size: The size of the text. Load a preset, like modelly.themes.sizes.text_sm (or just the string "sm"), or pass your own modelly.themes.utils.Size object.
            spacing_size: The size of the spacing. Load a preset, like modelly.themes.sizes.spacing_sm (or just the string "sm"), or pass your own modelly.themes.utils.Size object.
            radius_size: The radius size of corners. Load a preset, like modelly.themes.sizes.radius_sm (or just the string "sm"), or pass your own modelly.themes.utils.Size object.
            font: The primary font to use for the theme. Pass a string for a system font, or a modelly.themes.font.GoogleFont object to load a font from Google Fonts. Pass a list of fonts for fallbacks.
            font_mono: The monospace font to use for the theme, applies to code. Pass a string for a system font, or a modelly.themes.font.GoogleFont object to load a font from Google Fonts. Pass a list of fonts for fallbacks.
        """
    ...
    def set(
        ...
        *,
        ...
        self.checkbox_border_color_focus = checkbox_border_color_focus or getattr(
            self, "checkbox_border_color_focus", "*color_accent"
        )
