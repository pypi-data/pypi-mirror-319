...
from modelly_client.documentation import document_fn
        ...
        with gr.Column(scale=6, elem_id="app"):
            ...
            with gr.Row():
                ...
                with gr.Column(variant="panel", scale=2):
                    img = gr.Image(
                        "https://modelly-static-files.s3.us-west-2.amazonaws.com/header-image.jpg",
                        label="Image",
                        height=320,
                    )
                    with gr.Row():
                        ...
                        def go(*_args):
                            time.sleep(3)
                            return "https://modelly-static-files.s3.us-west-2.amazonaws.com/header-image.jpg"
            ...
            with gr.Row():
                gr.ColorPicker()
                gr.Video(
                    "https://modelly-static-files.s3.us-west-2.amazonaws.com/world.mp4"
                )
                gr.Gallery(
                    [
                        (
                            "https://modelly-static-files.s3.us-west-2.amazonaws.com/lion.jpg",
                            "lion",
                        ),
                        (
                            "https://modelly-static-files.s3.us-west-2.amazonaws.com/logo.png",
                            "logo",
                        ),
                        (
                            "https://modelly-static-files.s3.us-west-2.amazonaws.com/tower.jpg",
                            "tower",
                        ),
                    ],
                    height="200px",
