...
<script lang="ts">
	import type { Modelly, SelectData, ValueData } from "@modelly/utils";
	import StaticImage from "./shared/ImagePreview.svelte";
	import ImageUploader from "./shared/ImageUploader.svelte";
	import { afterUpdate } from "svelte";

	import { Block, Empty, UploadText } from "@modelly/atoms";
	import { Image } from "@modelly/icons";
	import { StatusTracker } from "@modelly/statustracker";
	import { upload, type FileData } from "@modelly/client";
...
{:else}
	...
	>
		...
		<ImageUploader
			...
			on:stream={({ detail }) => modelly.dispatch("stream", detail)}
		...
		>
			...
			{:else if active_source === "clipboard"}
				<UploadText i18n={modelly.i18n} type="clipboard" mode="short" />
			{:else}
