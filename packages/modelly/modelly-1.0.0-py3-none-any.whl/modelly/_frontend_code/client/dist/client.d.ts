import type { ApiData, ApiInfo, ClientOptions, Config, DuplicateOptions, EndpointInfo, JsApiData, PredictReturn, SpaceStatus, Status, UploadResponse, SubmitIterable, ModellyEvent } from "./types";
...
export declare class Client {
    ...
    submit: (endpoint: string | number, data: unknown[] | Record<string, unknown> | undefined, event_data?: unknown, trigger_id?: number | null, all_events?: boolean) => SubmitIterable<ModellyEvent>;
 ...
 * Creates a client instance for interacting with Modelly apps.
 *
 * @param {string} app_reference - The reference or URL to a Modelly space or app.
 ...
 *
 * @param {string} app_reference - The reference or URL to a Modelly space or app to duplicate.
