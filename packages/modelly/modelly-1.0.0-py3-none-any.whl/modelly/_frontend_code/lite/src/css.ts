import type { WorkerProxy } from "@modelly/wasm";
import { is_self_host } from "@modelly/wasm/network";
import { mount_css as default_mount_css } from "@modelly/core";
...
export async function wasm_proxied_mount_css(
	...
	// Modelly Lite can be reloaded without refreshing the page, so we need to remove the existing style element if it exists.
