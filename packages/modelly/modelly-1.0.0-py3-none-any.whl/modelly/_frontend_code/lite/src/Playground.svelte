<script lang="ts">
	...
	import { BaseCode as Code } from "@modelly/code";
	...
	function handle_theme_mode(target: HTMLDivElement): "light" | "dark" {
		const force_light = window.__modelly_mode__ === "website";
...
<style>
	...
	:global(div.lite-demo div.modelly-container) {
		height: 100%;
		overflow-y: scroll;
		margin: 0 !important;
	}

	:global(.modelly-container) {
