<script lang="ts">
	...
	// Although the `samples_dir` prop is not used in any of the core Modelly component, it is kept for backward compatibility
	// with any custom components created with modelly<=4.20.0
