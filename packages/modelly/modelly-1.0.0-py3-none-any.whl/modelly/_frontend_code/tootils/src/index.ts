...
const test_lite = base.extend<{ setup: void }>({
	...
	setup: [
		async ({ page }, use, testInfo) => {
			...
			// Mount the demo files and run the app in the mounted Modelly-lite app via its controller.
