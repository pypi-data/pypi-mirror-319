...
import { B as Block, h as Textbox, S as Static } from "./2.CHjPp1_u.js";
import { default as default2 } from "./Example.BNcnL0Hm.js";
  ...
  return {
    ...
    p(ctx2, dirty) {
      ...
      8192)
        ...
        ctx2[13];
      if (dirty[0] & /*label, info, root, show_label, lines, type, rtl, text_align, max_lines, placeholder, submit_btn, stop_btn, show_copy_button, autofocus, container, autoscroll, max_length, interactive, value, value_is_output, modelly, loading_status*/
...
function instance($$self, $$props, $$invalidate) {
  ...
  const copy_handler = (e) => modelly.dispatch("copy", e.detail);
  $$self.$$set = ($$props2) => {
