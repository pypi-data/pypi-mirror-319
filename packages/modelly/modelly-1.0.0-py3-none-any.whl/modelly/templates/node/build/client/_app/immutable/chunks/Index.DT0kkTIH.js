...
function instance($$self, $$props, $$invalidate) {
  ...
  const change_handler = () => modelly == null ? void 0 : modelly.dispatch("change");
  const select_handler = (e) => modelly == null ? void 0 : modelly.dispatch("select", e.detail);
  $$self.$$set = ($$props2) => {
    ...
    if ("modelly" in $$props2)
      $$invalidate(5, modelly = $$props2.modelly);
    if ("$$scope" in $$props2)
