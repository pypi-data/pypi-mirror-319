...
import { i as BlockTitle, B as Block, S as Static } from "./2.CHjPp1_u.js";
  ...
  return {
    ...
    p(ctx2, [dirty]) {
      ...
      1024)
        ...
        ctx2[10];
      if (dirty & /*$$scope, root, label, info, show_label, interactive, disabled, value, value_is_output, modelly, loading_status*/
      16840847) {
