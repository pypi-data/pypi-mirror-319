...
import { B as Block } from "./2.CHjPp1_u.js";
import Example from "./Example.BNcnL0Hm.js";
...
function create_if_block_6(ctx) {
  ...
  return {
    ...
    p(ctx2, dirty) {
      ...
      if (dirty[0] & /*value, page, samples_per_page, modelly, handle_mouseenter, handle_mouseleave, component_meta, components, component_props, samples_dir, current_hover, root, component_map*/
      61970447) {
...
function create_if_block_2(ctx) {
  ...
  return {
    ...
    p(ctx2, dirty) {
      if (dirty[0] & /*value, page, samples_per_page, modelly, selected_samples, handle_mouseenter, handle_mouseleave, current_hover, sample_labels, component_meta, component_props, samples_dir, root, component_map, components*/
      62232719) {
  ...
  return {
    ...
    p(ctx2, dirty) {
      ...
      16384)
        ...
        ctx2[14];
      if (dirty[0] & /*visible_pages, page, paginate, selected_samples, value, samples_per_page, modelly, current_hover, sample_labels, component_meta, component_props, root, component_map, components, gallery, headers, label, show_label*/
...
function instance($$self, $$props, $$invalidate) {
  ...
  const click_handler = (i, sample_row) => {
    ...
    modelly.dispatch("click", value);
    modelly.dispatch("select", { index: value, value: sample_row });
  };
  ...
  $$self.$$set = ($$props2) => {
    ...
    if ("modelly" in $$props2)
      $$invalidate(15, modelly = $$props2.modelly);
    if ("layout" in $$props2)
