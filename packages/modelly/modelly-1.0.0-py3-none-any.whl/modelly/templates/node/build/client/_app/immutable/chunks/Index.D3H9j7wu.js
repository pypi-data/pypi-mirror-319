...
import { i as BlockTitle, C as Clear, H as Send, J as Square, B as Block, S as Static } from "./2.CHjPp1_u.js";
import { F as File } from "./File.DqOJDDoa.js";
import { M as Microphone } from "./SelectSource.42p_6c1G.js";
...
/* empty css                                                    */
import { I as Image } from "./Image.Bf83hSbn.js";
/* empty css                                                    */
import { I as InteractiveAudio } from "./InteractiveAudio.CAUQOn1s.js";
import { default as default2 } from "./Example.GZIcru9O.js";
...
function create_default_slot(ctx) {
  ...
  return {
    ...
    p(ctx2, dirty) {
      ...
      if (dirty[0] & /*modelly*/
      4)
        multimodaltextbox_changes.i18n = /*modelly*/
        ctx2[2].i18n;
      ...
      if (dirty[0] & /*modelly*/
      4)
        multimodaltextbox_changes.max_file_size = /*modelly*/
  ...
  return {
    ...
    p(ctx2, dirty) {
      ...
      134217728)
        ...
        ctx2[27] ? "focus" : "base";
      if (dirty[0] & /*file_types, root, label, info, show_label, lines, rtl, text_align, waveform_settings, modelly, max_lines, placeholder, submit_btn, stop_btn, autofocus, autoscroll, file_count, sources, interactive, max_plain_text_length, value, value_is_output, dragging, active_source, loading_status*/
...
function instance($$self, $$props, $$invalidate) {
  ...
  const change_handler = () => modelly.dispatch("change", value);
  const input_handler = () => modelly.dispatch("input");
  const submit_handler = () => modelly.dispatch("submit");
  const stop_handler = () => modelly.dispatch("stop");
  const blur_handler = () => modelly.dispatch("blur");
  const select_handler = (e) => modelly.dispatch("select", e.detail);
  const focus_handler = () => modelly.dispatch("focus");
  ...
  const upload_handler = (e) => modelly.dispatch("upload", e.detail);
  const clear_handler = () => modelly.dispatch("clear");
  $$self.$$set = ($$props2) => {
    if ("modelly" in $$props2)
      $$invalidate(2, modelly = $$props2.modelly);
