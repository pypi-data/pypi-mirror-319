...
import { i as BlockTitle, D as DropdownOptions, q as handle_filter, r as handle_change, t as DropdownArrow, v as handle_shared_keys, B as Block, S as Static, w as Dropdown } from "./2.CHjPp1_u.js";
import { default as default2 } from "./Example.Cw1u-wCb.js";
...
function create_if_block(ctx) {
  ...
  return {
    ...
    p(ctx2, dirty) {
      ...
      if (dirty[0] & /*modelly*/
      262144)
        multiselect_1_changes.i18n = /*modelly*/
        ctx2[18].i18n;
      if (dirty[0] & /*interactive*/
      524288)
  ...
  return {
    ...
    p(ctx2, dirty) {
      ...
      16384)
        ...
        ctx2[14];
      if (dirty[0] & /*choices, max_choices, root, label, info, show_label, allow_custom_value, filterable, container, modelly, interactive, value, value_is_output, multiselect, loading_status*/
...
function instance($$self, $$props, $$invalidate) {
  ...
  const change_handler = () => modelly.dispatch("change");
  ...
  const key_up_handler = () => modelly.dispatch("key_up");
  ...
  const change_handler_1 = () => modelly.dispatch("change");
  const input_handler_1 = () => modelly.dispatch("input");
  const select_handler_1 = (e) => modelly.dispatch("select", e.detail);
  const blur_handler_1 = () => modelly.dispatch("blur");
  const focus_handler_1 = () => modelly.dispatch("focus");
  const key_up_handler_1 = (e) => modelly.dispatch("key_up", e.detail);
  $$self.$$set = ($$props2) => {
    if ("label" in $$props2)
