...
import { B as BaseFileUpload, F as File } from "./FileUpload.CQyt8rZa.js";
import { a } from "./FileUpload.CQyt8rZa.js";
...
function create_else_block(ctx) {
  ...
  return {
    ...
    p(ctx2, dirty) {
      ...
      if (dirty[0] & /*modelly*/
      16384)
        fileupload_changes.max_file_size = /*modelly*/
        ctx2[14].max_file_size;
      if (dirty[0] & /*modelly*/
      16384)
        fileupload_changes.i18n = /*modelly*/
        ctx2[14].i18n;
      if (dirty[0] & /*modelly*/
      16384 | dirty[1] & /*$$scope*/
      16) {
  ...
  return {
    ...
    p(ctx2, dirty) {
      ...
      8192)
        ...
        ctx2[13];
      if (dirty[0] & /*_selectable, value, label, show_label, height, modelly, interactive, file_count, file_types, root, allow_reordering, uploading, dragging, loading_status*/
...
function instance($$self, $$props, $$invalidate) {
  ...
  const download_handler = ({ detail }) => modelly.dispatch("download", detail);
  ...
  $$self.$$.update = () => {
    ...
    if ($$self.$$.dirty[0] & /*old_value, value, modelly*/
    2113537) {
