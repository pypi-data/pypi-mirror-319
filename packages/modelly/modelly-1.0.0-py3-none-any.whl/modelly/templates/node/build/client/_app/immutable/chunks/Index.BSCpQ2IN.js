...
import { B as Block, S as Static, k as Index$1 } from "./2.CHjPp1_u.js";
  ...
  return {
    ...
    p(ctx2, [dirty]) {
      ...
      16)
        ...
        ctx2[4];
      if (dirty & /*$$scope, label, open, modelly, loading_status*/
      2147) {
...
function instance($$self, $$props, $$invalidate) {
  ...
  const expand_handler = () => modelly.dispatch("expand");
  const collapse_handler = () => modelly.dispatch("collapse");
  $$self.$$set = ($$props2) => {
    if ("label" in $$props2)
      $$invalidate(1, label = $$props2.label);
