...
import StaticAudio from "./StaticAudio.fVIdECN3.js";
import { I as InteractiveAudio } from "./InteractiveAudio.CAUQOn1s.js";
import { B as Block, S as Static } from "./2.CHjPp1_u.js";
import { U as UploadText } from "./UploadText.U5x9CpaP.js";
import { A } from "./AudioPlayer.DkSzJkCw.js";
  ...
  return {
    ...
    p(ctx2, dirty) {
      ...
      16384)
        ...
        ctx2[14];
      if (dirty[0] & /*label, show_label, show_download_button, value, root, sources, active_source, pending, streaming, loop, modelly, editable, waveform_settings, waveform_options, stream_every, recording, dragging, uploading, _modify_stream, set_time_limit, loading_status*/
  ...
  return {
    ...
    p(ctx2, dirty) {
      ...
      16384)
        block_changes.min_width = /*min_width*/
        ctx2[14];
      if (dirty[0] & /*modelly, show_label, show_download_button, show_share_button, value, label, loop, waveform_settings, waveform_options, editable, loading_status*/
...
function create_default_slot_1(ctx) {
  ...
  return {
    ...
    p(ctx2, dirty) {
      ...
      if (dirty[0] & /*modelly*/
      8388608)
        interactiveaudio_changes.max_file_size = /*modelly*/
      ...
      if (dirty[0] & /*modelly*/
      8388608)
        interactiveaudio_changes.i18n = /*modelly*/
        ctx2[23].i18n;
...
function create_default_slot(ctx) {
  ...
  return {
    ...
    p(ctx2, dirty) {
      ...
      if (dirty[0] & /*modelly*/
      8388608)
        staticaudio_changes.i18n = /*modelly*/
        ctx2[23].i18n;
      if (dirty[0] & /*show_label*/
      2048)
...
function instance($$self, $$props, $$invalidate) {
  ...
  const share_handler = (e) => modelly.dispatch("share", e.detail);
  const error_handler = (e) => modelly.dispatch("error", e.detail);
  ...
  const func_1 = (...args) => modelly.client.stream(...args);
  ...
  const edit_handler = () => modelly.dispatch("edit");
  ...
  const pause_recording_handler = () => modelly.dispatch("pause_recording");
  const stop_recording_handler = (e) => modelly.dispatch("stop_recording");
  const upload_handler = () => modelly.dispatch("upload");
  const clear_handler = () => modelly.dispatch("clear");
  const close_stream_handler = () => modelly.dispatch("close_stream", "stream");
  $$self.$$set = ($$props2) => {
    ...
    if ("modelly" in $$props2)
      $$invalidate(23, modelly = $$props2.modelly);
  };
  $$self.$$.update = () => {
