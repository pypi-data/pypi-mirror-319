...
import { I as IconButton, F as Check, G as Copy, B as Block, S as Static } from "./2.CHjPp1_u.js";
  ...
  return {
    ...
    p(ctx2, [dirty]) {
      ...
      65536)
        ...
        ctx2[16];
      if (dirty & /*$$scope, value, open, theme_mode, show_indices, label_height, modelly, loading_status, show_label, label, container*/
      2243832) {
...
function instance($$self, $$props, $$invalidate) {
  ...
  $$self.$$set = ($$props2) => {
    ...
    if ("modelly" in $$props2)
      $$invalidate(10, modelly = $$props2.modelly);
    if ("open" in $$props2)
