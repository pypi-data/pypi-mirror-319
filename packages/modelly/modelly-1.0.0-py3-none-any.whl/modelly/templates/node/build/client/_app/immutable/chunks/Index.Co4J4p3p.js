...
import { B as Block, S as Static, z as css_units } from "./2.CHjPp1_u.js";
  ...
  return {
    ...
    p(ctx2, [dirty]) {
      ...
      1024)
        ...
        ctx2[10];
      if (dirty & /*$$scope, padding, loading_status, min_height, max_height, value, elem_classes, visible, modelly, show_label, label*/
      35837) {
...
function instance($$self, $$props, $$invalidate) {
  ...
  const click_handler = () => modelly.dispatch("click");
  $$self.$$set = ($$props2) => {
    if ("label" in $$props2)
    ...
    if ("modelly" in $$props2)
      $$invalidate(6, modelly = $$props2.modelly);
