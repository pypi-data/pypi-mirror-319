  ...
  return {
    ...
    p(ctx2, dirty) {
      ...
      512)
        ...
        ctx2[9];
      if (dirty[0] & /*maximum, minimum, step, disabled, label, value, range_input, minimum_value, number_input, root, show_label, info, modelly, loading_status*/
...
function instance($$self, $$props, $$invalidate) {
  ...
  let { label = modelly.i18n("slider.slider") } = $$props;
  ...
  function handle_release(e) {
    modelly.dispatch("release", value);
  }
  function clamp() {
    modelly.dispatch("release", value);
