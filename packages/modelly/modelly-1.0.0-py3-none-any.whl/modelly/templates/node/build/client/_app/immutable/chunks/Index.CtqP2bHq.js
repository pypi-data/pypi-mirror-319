...
import { B as Block, i as BlockTitle } from "./2.CHjPp1_u.js";
  ...
  return {
    ...
    p(ctx2, dirty) {
      ...
      512)
        ...
        ctx2[9];
      if (dirty[0] & /*disabled, datetime, interactive, datevalue, entered_value, include_time, valid, modelly, root, show_label, info, label*/
...
function instance($$self, $$props, $$invalidate) {
  ...
  function input_input_handler() {
    ...
    $$invalidate(12, entered_value), $$invalidate(19, value), $$invalidate(20, old_value), $$invalidate(0, modelly);
  }
  ...
  function input_input_handler_1() {
    ...
    $$invalidate(14, datevalue), $$invalidate(19, value), $$invalidate(20, old_value), $$invalidate(0, modelly);
  }
  const input_handler = () => {
  ...
  $$self.$$.update = () => {
    ...
    if ($$self.$$.dirty[0] & /*value, old_value, modelly*/
    1572865) {
      if (value !== old_value) {
