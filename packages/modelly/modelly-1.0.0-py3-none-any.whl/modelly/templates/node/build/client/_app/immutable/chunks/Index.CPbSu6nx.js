...
import { P as Plot, a as Plot$1 } from "./Plot.RQPLycMU.js";
  ...
  return {
    ...
    p(ctx2, [dirty]) {
      ...
      512)
        ...
        ctx2[9];
      if (dirty & /*$$scope, value, theme_mode, caption, bokeh_version, show_actions_button, modelly, show_label, _selectable, x_lim, loading_status, label*/
      1178737) {
...
function instance($$self, $$props, $$invalidate) {
  ...
  $$self.$$set = ($$props2) => {
    ...
    if ("modelly" in $$props2)
      $$invalidate(13, modelly = $$props2.modelly);
