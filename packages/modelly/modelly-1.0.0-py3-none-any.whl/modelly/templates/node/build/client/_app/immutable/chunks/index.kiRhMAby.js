...
import { U as Upload } from "./Upload.C1X4PigL.js";
import { B as Block, S as Static } from "./2.CHjPp1_u.js";
import { B as BlockLabel } from "./BlockLabel.92rIcaz4.js";
import { V as Video$1 } from "./Video.CzEOFOtQ.js";
import { S as SelectSource } from "./SelectSource.42p_6c1G.js";
/* empty css                                                    */
import "./Image.Bf83hSbn.js";
/* empty css                                                    */
import { W as Webcam } from "./ImageUploader.BgayIxmL.js";
/* empty css                                               */
import { p as prettyBytes, a as playable } from "./Video.CeESA4ek.js";
import { l } from "./Video.CeESA4ek.js";
import { P as Player, V as VideoPreview } from "./VideoPreview.Dwp180G2.js";
import { default as default2 } from "./Example.CzrGxzgA.js";
import { U as UploadText } from "./UploadText.U5x9CpaP.js";
  ...
  return {
    ...
    p(ctx2, dirty) {
      ...
      16384)
        ...
        ctx2[14];
      if (dirty[0] & /*_video, _subtitle, label, show_label, show_download_button, sources, active_source, mirror_webcam, include_audio, autoplay, root, loop, webcam_constraints, modelly, uploading, dragging, loading_status*/
  ...
  return {
    ...
    p(ctx2, dirty) {
      ...
      16384)
        block_changes.min_width = /*min_width*/
        ctx2[14];
      if (dirty[0] & /*_video, _subtitle, label, show_label, autoplay, loop, show_share_button, show_download_button, modelly, loading_status*/
...
function create_default_slot_2(ctx) {
  ...
  return {
    ...
    p(ctx2, dirty) {
      ...
      if (dirty[0] & /*modelly*/
      262144)
        uploadtext_changes.i18n = /*modelly*/
        ctx2[18].i18n;
...
function create_default_slot_1(ctx) {
  ...
  return {
    ...
    p(ctx2, dirty) {
      const statustracker_changes = dirty[0] & /*modelly, loading_status*/
      ...
      if (dirty[0] & /*modelly*/
      262144)
        video_changes.i18n = /*modelly*/
        ctx2[18].i18n;
      if (dirty[0] & /*modelly*/
      262144)
        video_changes.max_file_size = /*modelly*/
...
function create_default_slot(ctx) {
  ...
  return {
    ...
    p(ctx2, dirty) {
      ...
      if (dirty[0] & /*modelly*/
      262144)
        staticvideo_changes.i18n = /*modelly*/
        ctx2[18].i18n;
      if (dirty[0] & /*modelly*/
      262144)
...
function instance($$self, $$props, $$invalidate) {
  ...
  function handle_error({ detail }) {
    ...
    modelly.dispatch(level, detail);
  }
  const clear_status_handler = () => modelly.dispatch("clear_status", loading_status);
  const func = (...args) => modelly.client.upload(...args);
  const play_handler = () => modelly.dispatch("play");
  const pause_handler = () => modelly.dispatch("pause");
  const stop_handler = () => modelly.dispatch("stop");
  const end_handler = () => modelly.dispatch("end");
  const share_handler = ({ detail }) => modelly.dispatch("share", detail);
  const error_handler = ({ detail }) => modelly.dispatch("error", detail);
  const clear_status_handler_1 = () => modelly.dispatch("clear_status", loading_status);
  const func_1 = (...args) => modelly.client.upload(...args);
  const func_2 = (...args) => modelly.client.stream(...args);
  function video_uploading_binding(value2) {
    uploading = value2;
    $$invalidate(23, uploading);
  }
  const drag_handler = ({ detail }) => $$invalidate(27, dragging = detail);
  const clear_handler = () => modelly.dispatch("clear");
  const play_handler_1 = () => modelly.dispatch("play");
  const pause_handler_1 = () => modelly.dispatch("pause");
  const upload_handler = () => modelly.dispatch("upload");
  const stop_handler_1 = () => modelly.dispatch("stop");
  const end_handler_1 = () => modelly.dispatch("end");
  const start_recording_handler = () => modelly.dispatch("start_recording");
  const stop_recording_handler = () => modelly.dispatch("stop_recording");
  $$self.$$set = ($$props2) => {
    ...
    if ("modelly" in $$props2)
      $$invalidate(18, modelly = $$props2.modelly);
