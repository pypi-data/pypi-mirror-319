...
import Gallery from "./Gallery.BVRE0m_g.js";
import { B as BaseFileUpload } from "./FileUpload.CQyt8rZa.js";
/* empty css                                               */
...
function create_if_block(ctx) {
  ...
  return {
    ...
    p(ctx2, dirty) {
      ...
      if (dirty[0] & /*modelly*/
      4194304)
        basefileupload_changes.max_file_size = /*modelly*/
      ...
      if (dirty[0] & /*modelly*/
      4194304)
        basefileupload_changes.i18n = /*modelly*/
        ctx2[22].i18n;
      if (dirty[0] & /*modelly*/
      4194304)
...
function create_fragment(ctx) {
  ...
  return {
    ...
    p(ctx2, dirty) {
      ...
      if (dirty[0] & /*root, label, modelly, file_types, value, loading_status, interactive, no_value, show_label, columns, rows, height, preview, object_fit, allow_preview, show_share_button, show_download_button, show_fullscreen_button, selected_index*/
...
function instance($$self, $$props, $$invalidate) {
  ...
  const func_2 = (...args) => modelly.client.fetch(...args);
  ...
  const error_handler_1 = (e) => modelly.dispatch("error", e.detail);
  const preview_open_handler = () => modelly.dispatch("preview_open");
  const preview_close_handler = () => modelly.dispatch("preview_close");
  $$self.$$set = ($$props2) => {
    ...
    if ("modelly" in $$props2)
      $$invalidate(22, modelly = $$props2.modelly);
