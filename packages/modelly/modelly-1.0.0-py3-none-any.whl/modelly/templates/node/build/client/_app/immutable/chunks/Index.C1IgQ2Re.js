...
import ImagePreview from "./ImagePreview.DgQAgxrh.js";
import { I as ImageUploader } from "./ImageUploader.BgayIxmL.js";
import { W } from "./ImageUploader.BgayIxmL.js";
import { B as Block, S as Static } from "./2.CHjPp1_u.js";
import { E as Empty } from "./Empty.CJXSPa64.js";
import { I as Image } from "./FullscreenButton.C29drucn.js";
import { U as UploadText } from "./UploadText.U5x9CpaP.js";
import { I } from "./Image.Bf83hSbn.js";
import { default as default2 } from "./Example.Bo2qHUUg.js";
  ...
  return {
    ...
    p(ctx2, dirty) {
      ...
      65536)
        ...
        ctx2[16];
      if (dirty[0] & /*_selectable, root, sources, label, show_label, pending, streaming, mirror_webcam, stream_every, webcam_constraints, modelly, uploading, active_source, value, dragging, _modify_stream, set_time_limit, loading_status, placeholder*/
  ...
  return {
    ...
    p(ctx2, dirty) {
      ...
      65536)
        block_changes.min_width = /*min_width*/
        ctx2[16];
      if (dirty[0] & /*value, label, show_label, show_download_button, _selectable, show_share_button, modelly, show_fullscreen_button, loading_status*/
...
function create_default_slot_1(ctx) {
  ...
  return {
    ...
    p(ctx2, dirty) {
      ...
      if (dirty[0] & /*modelly*/
      67108864)
        imageuploader_changes.max_file_size = /*modelly*/
        ctx2[26].max_file_size;
      if (dirty[0] & /*modelly*/
      67108864)
        imageuploader_changes.i18n = /*modelly*/
        ctx2[26].i18n;
      if (dirty[0] & /*modelly*/
      67108864)
      ...
      if (dirty[0] & /*modelly*/
      67108864)
        imageuploader_changes.stream_handler = /*modelly*/
        (_a2 = ctx2[26].client) == null ? void 0 : _a2.stream;
      if (dirty[0] & /*modelly, placeholder, active_source*/
...
function create_default_slot(ctx) {
  ...
  return {
    ...
    p(ctx2, dirty) {
      ...
      if (dirty[0] & /*modelly*/
      67108864)
        staticimage_changes.i18n = /*modelly*/
        ctx2[26].i18n;
...
function instance($$self, $$props, $$invalidate) {
  ...
  const select_handler = ({ detail }) => modelly.dispatch("select", detail);
  ...
  const stream_handler = ({ detail }) => modelly.dispatch("stream", detail);
  const drag_handler = ({ detail }) => $$invalidate(29, dragging = detail);
  const upload_handler = () => modelly.dispatch("upload");
  const select_handler_1 = ({ detail }) => modelly.dispatch("select", detail);
  const share_handler_1 = ({ detail }) => modelly.dispatch("share", detail);
  ...
  const close_stream_handler = () => {
    modelly.dispatch("close_stream", "stream");
  };
  $$self.$$set = ($$props2) => {
    ...
    if ("modelly" in $$props2)
      $$invalidate(26, modelly = $$props2.modelly);
  };
  $$self.$$.update = () => {
