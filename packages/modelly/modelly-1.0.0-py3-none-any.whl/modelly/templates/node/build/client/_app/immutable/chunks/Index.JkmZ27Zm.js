...
function instance($$self, $$props, $$invalidate) {
  ...
  $$self.$$.update = () => {
    if ($$self.$$.dirty & /*old_value, value, active, old_active, interval, modelly*/
    63) {
  ...
  return [modelly, value, active, old_value, old_active, interval];
}
class Index extends SvelteComponent {
  constructor(options) {
    super();
    init(this, options, instance, null, safe_not_equal, { modelly: 0, value: 1, active: 2 });
  }
}
export {
  Index as default
