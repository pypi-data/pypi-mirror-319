const __vite__fileDeps=["./PlotlyPlot.B1kSSxII.js","./2.CHjPp1_u.js","./preload-helper.DpQnamwV.js","./stores.DBnlgyRo.js","./client.Dn1xcHrS.js","../assets/2.DCCryVoK.css","./_commonjs-dynamic-modules.TGKdzP3c.js","./BokehPlot.CLlwazaz.js","../assets/BokehPlot.BiRx4WhV.css","./AltairPlot.KUnBFfk5.js","./color.B0DpvCGe.js","./vega-embed.module.CWbUWcUM.js","./dsv.CKxpOsHB.js","../assets/AltairPlot.O7q90H0e.css","./MatplotlibPlot.m3Jijthl.js","../assets/MatplotlibPlot.BHPTlvkw.css"],__vite__mapDeps=i=>i.map(i=>__vite__fileDeps[i]);
  ...
  return {
    ...
    p(ctx2, dirty) {
      ...
      ctx2[10])) {
        ...
        if (dirty & /*modelly*/
        128)
          switch_instance_changes.modelly = /*modelly*/
          ctx2[7];
...
function instance($$self, $$props, $$invalidate) {
  ...
  const plotTypeMapping = {
    plotly: () => __vitePreload(() => import("./PlotlyPlot.B1kSSxII.js"), true ? __vite__mapDeps([0,1,2,3,4,5,6]) : void 0, import.meta.url),
    bokeh: () => __vitePreload(() => import("./BokehPlot.CLlwazaz.js"), true ? __vite__mapDeps([7,8]) : void 0, import.meta.url),
    altair: () => __vitePreload(() => import("./AltairPlot.KUnBFfk5.js"), true ? __vite__mapDeps([9,1,2,3,4,5,10,11,12,13]) : void 0, import.meta.url),
  ...
  $$self.$$set = ($$props2) => {
    ...
    if ("modelly" in $$props2)
      $$invalidate(7, modelly = $$props2.modelly);
    if ("x_lim" in $$props2)
