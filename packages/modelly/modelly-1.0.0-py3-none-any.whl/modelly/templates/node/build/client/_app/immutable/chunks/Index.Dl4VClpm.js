...
import { k as Index$1 } from "./2.CHjPp1_u.js";
...
function instance($$self, $$props, $$invalidate) {
  ...
  let { order } = $$props;
  const select_handler = ({ detail }) => modelly == null ? void 0 : modelly.dispatch("select", detail);
  $$self.$$set = ($$props2) => {
    if ("elem_id" in $$props2)
      $$invalidate(0, elem_id = $$props2.elem_id);
    if ("elem_classes" in $$props2)
    ...
    if ("modelly" in $$props2)
      $$invalidate(4, modelly = $$props2.modelly);
    if ("visible" in $$props2)
