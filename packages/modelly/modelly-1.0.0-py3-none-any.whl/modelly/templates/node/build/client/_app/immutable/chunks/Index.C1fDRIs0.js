...
import { B as Block, S as Static, n as Info } from "./2.CHjPp1_u.js";
  ...
  return {
    ...
    p(ctx2, [dirty]) {
      ...
      512)
        ...
        ctx2[9];
      if (dirty & /*$$scope, label, interactive, value, modelly, root, info, loading_status*/
      269425) {
...
function instance($$self, $$props, $$invalidate) {
  ...
  $$self.$$set = ($$props2) => {
    ...
    if ("modelly" in $$props2)
      $$invalidate(11, modelly = $$props2.modelly);
    if ("interactive" in $$props2)
