...
import { I as Image, F as FullscreenButton } from "./FullscreenButton.C29drucn.js";
import { I as IconButtonWrapper } from "./IconButtonWrapper.Bp9U9ea0.js";
import { r as resolve_wasm_src } from "./file-url.inDWsGLY.js";
/* empty css                                                    */
  ...
  return {
    ...
    p(ctx2, dirty) {
      ...
      4096)
        ...
        ctx2[12];
      if (dirty[0] & /*_value, color_map, show_legend, image_container, label, is_full_screen, active, height, show_fullscreen_button, show_label, modelly, loading_status*/
...
function instance($$self, $$props, $$invalidate) {
  ...
  function handle_click(i, value2) {
    modelly.dispatch("select", { value: label, index: i });
  }
  ...
  $$self.$$set = ($$props2) => {
    ...
    if ("modelly" in $$props2)
      $$invalidate(3, modelly = $$props2.modelly);
    if ("label" in $$props2)
  ...
  $$self.$$.update = () => {
    if ($$self.$$.dirty[0] & /*value, old_value, modelly, latest_promise*/
    29360136) {
      {
        if (value !== old_value) {
