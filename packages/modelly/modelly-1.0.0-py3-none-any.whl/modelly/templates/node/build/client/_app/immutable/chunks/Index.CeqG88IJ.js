...
function create_default_slot(ctx) {
  ...
  return {
    ...
    p(ctx2, dirty) {
      const statustracker_changes = dirty & /*loading_status, modelly*/
  ...
  return {
    ...
    p(ctx2, [dirty]) {
      ...
      128)
        ...
        ctx2[7];
      if (dirty & /*$$scope, rerender_key, file_count, interactive, server, value, show_label, label, loading_status, modelly*/
      17024561) {
