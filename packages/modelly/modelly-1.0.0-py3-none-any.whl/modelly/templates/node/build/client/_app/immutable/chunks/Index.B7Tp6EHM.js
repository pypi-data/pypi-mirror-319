const __vite__fileDeps=["./Canvas3D.0ob-dUGp.js","./2.CHjPp1_u.js","./preload-helper.DpQnamwV.js","./stores.DBnlgyRo.js","./client.Dn1xcHrS.js","../assets/2.DCCryVoK.css","./file-url.inDWsGLY.js","../assets/DownloadLink.wTm37iHI.css","./Canvas3DGS.BzZyzAos.js"],__vite__mapDeps=i=>i.map(i=>__vite__fileDeps[i]);
...
import { I as IconButton, B as Block, S as Static } from "./2.CHjPp1_u.js";
...
import { I as IconButtonWrapper } from "./IconButtonWrapper.Bp9U9ea0.js";
import { U as Upload } from "./Upload.C1X4PigL.js";
import { M as ModifyUpload } from "./ModifyUpload.CtWz7DC-.js";
...
async function loadCanvas3D$1() {
  const module = await __vitePreload(() => import("./Canvas3D.0ob-dUGp.js"), true ? __vite__mapDeps([0,1,2,3,4,5,6,7]) : void 0, import.meta.url);
  return module.default;
}
async function loadCanvas3DGS$1() {
  const module = await __vitePreload(() => import("./Canvas3DGS.BzZyzAos.js"), true ? __vite__mapDeps([8,6,7]) : void 0, import.meta.url);
  return module.default;
}
  ...
  return {
    ...
    p(ctx2, dirty) {
      ...
      32768)
        ...
        ctx2[15];
      if (dirty[0] & /*label, show_label, root, display_mode, clear_color, value, camera_position, zoom_speed, modelly, uploading, dragging, has_change_history, loading_status*/
  ...
  return {
    ...
    p(ctx2, dirty) {
      ...
      32768)
        block_changes.height = /*height*/
        ctx2[15];
      if (dirty[0] & /*value, modelly, display_mode, clear_color, label, show_label, camera_position, zoom_speed, has_change_history, loading_status*/
...
function create_default_slot_2(ctx) {
  ...
  return {
    ...
    p(ctx2, dirty) {
      ...
      if (dirty[0] & /*modelly*/
      16384)
        model3dupload_changes.i18n = /*modelly*/
        ctx2[14].i18n;
      if (dirty[0] & /*modelly*/
      16384)
        model3dupload_changes.max_file_size = /*modelly*/
...
function instance($$self, $$props, $$invalidate) {
  ...
  const change_handler_1 = ({ detail }) => {
    modelly.dispatch("change", detail);
  ...
  $$self.$$set = ($$props2) => {
    ...
    if ("modelly" in $$props2)
      $$invalidate(14, modelly = $$props2.modelly);
    if ("height" in $$props2)
