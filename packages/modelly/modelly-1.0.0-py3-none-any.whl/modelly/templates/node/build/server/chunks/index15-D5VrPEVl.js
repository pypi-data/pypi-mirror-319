...
import StaticAudio from './StaticAudio-C-tjjmXV.js';
import { I as InteractiveAudio$1 } from './InteractiveAudio-DSosEmhL.js';
import { B as Block, S as Static, U as UploadText } from './2-ZyZyiYjX.js';
export { A as BasePlayer } from './AudioPlayer-QsMpb0Ft.js';
export { default as BaseExample } from './Example3-D4rTevcB.js';
import './DownloadLink-DO-FUwy_.js';
import './ModifyUpload-C7AfhHei.js';
...
const Index = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    $$rendered = `  ${!interactive ? `${validate_component(Block, "Block").$$render(
      ...
      {
        default: () => {
          return `${validate_component(Static, "StatusTracker").$$render($$result, Object.assign({}, { autoscroll: modelly.autoscroll }, { i18n: modelly.i18n }, loading_status), {}, {})} ${validate_component(StaticAudio, "StaticAudio").$$render(
            $$result,
            {
              i18n: modelly.i18n,
              show_label,
      ...
      {
        default: () => {
          return `${validate_component(Static, "StatusTracker").$$render($$result, Object.assign({}, { autoscroll: modelly.autoscroll }, { i18n: modelly.i18n }, loading_status), {}, {})} ${validate_component(InteractiveAudio$1, "InteractiveAudio").$$render(
            $$result,
            {
              label,
              show_label,
            ...
            {
              default: () => {
                return `${validate_component(UploadText, "UploadText").$$render($$result, { i18n: modelly.i18n, type: "audio" }, {}, {})}`;
              }
            }
          )}`;
        }
...
//# sourceMappingURL=index15-D5VrPEVl.js.map
