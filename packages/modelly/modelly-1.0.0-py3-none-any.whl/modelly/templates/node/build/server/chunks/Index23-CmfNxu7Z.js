...
import ImagePreview from './ImagePreview-CLYtnYC2.js';
import { B as Block, S as Static, U as UploadText, h as Empty, g as Image, d as StreamingBar, f as BlockLabel, i as IconButtonWrapper, F as FullscreenButton, j as IconButton, z as Clear, a2 as SelectSource, ac as Webcam$2, a3 as Spinner, ad as Square, ae as Circle, af as Camera, ag as DropdownArrow, a4 as prepare_files } from './2-ZyZyiYjX.js';
import { U as Upload } from './ModifyUpload-C7AfhHei.js';
import { I as Image$1 } from './Image-CzxXKKDB.js';
export { default as BaseExample } from './Example14-DVJcH5YC.js';
...
const Index = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    $$rendered = `   ${!interactive ? `${validate_component(Block, "Block").$$render(
      ...
      {
        default: () => {
          return `${validate_component(Static, "StatusTracker").$$render($$result, Object.assign({}, { autoscroll: modelly.autoscroll }, { i18n: modelly.i18n }, loading_status), {}, {})} ${validate_component(ImagePreview, "StaticImage").$$render(
            $$result,
            {
              value,
              label,
      ...
      {
        default: () => {
          return `${validate_component(Static, "StatusTracker").$$render($$result, Object.assign({}, { autoscroll: modelly.autoscroll }, { i18n: modelly.i18n }, loading_status), {}, {})} ${validate_component(ImageUploader$1, "ImageUploader").$$render(
            $$result,
            {
              selectable: _selectable,
              root,
              ...
              stream_handler: modelly.client?.stream,
...
//# sourceMappingURL=Index23-CmfNxu7Z.js.map
