...
import { B as Block, S as Static, ab as css_units, i as IconButtonWrapper, j as IconButton, w as Copy, t as MarkdownCode } from './2-ZyZyiYjX.js';
export { default as BaseExample } from './Example16-BvIBYFy9.js';
...
const Index = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${validate_component(Block, "Block").$$render(
    ...
    {
      default: () => {
        return `${validate_component(Static, "StatusTracker").$$render($$result, Object.assign({}, { autoscroll: modelly.autoscroll }, { i18n: modelly.i18n }, loading_status, { variant: "center" }), {}, {})} <div class="${["svelte-1ed2p3z", loading_status?.status === "pending" ? "pending" : ""].join(" ").trim()}">${validate_component(Markdown$1, "Markdown").$$render(
          $$result,
          {
            value,
            elem_classes,
...
//# sourceMappingURL=Index46-DemDbEB3.js.map
