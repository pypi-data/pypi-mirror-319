...
import { B as Block, S as Static, I as Index$1 } from './2-ZyZyiYjX.js';
...
const Index = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    $$rendered = `${validate_component(Block, "Block").$$render($$result, { elem_id, elem_classes, visible }, {}, {
      default: () => {
        return `${validate_component(Static, "StatusTracker").$$render($$result, Object.assign({}, { autoscroll: modelly.autoscroll }, { i18n: modelly.i18n }, loading_status), {}, {})} ${validate_component(Accordion, "Accordion").$$render(
          $$result,
          { label, open },
          {
            open: ($$value) => {
...
//# sourceMappingURL=Index34-Bbg2g7D5.js.map
