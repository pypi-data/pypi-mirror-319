...
import { f as BlockLabel, au as Video$1, a2 as SelectSource, B as Block, S as Static, U as UploadText } from './2-ZyZyiYjX.js';
import { Webcam as Webcam$1 } from './Index23-CmfNxu7Z.js';
import { P as Player$1, V as VideoPreview } from './VideoPreview-BmWanYDd.js';
export { l as loaded, a as playable, p as prettyBytes } from './VideoPreview-BmWanYDd.js';
export { default as BaseExample } from './Example23-CqKVk44f.js';
...
import 'url';
import 'fs';
import './ImagePreview-CLYtnYC2.js';
import './Image-CzxXKKDB.js';
import './Example14-DVJcH5YC.js';
import './Video-D_fADZPe.js';
...
const Index = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    $$rendered = `  ${!interactive ? `${validate_component(Block, "Block").$$render(
      ...
      {
        default: () => {
          return `${validate_component(Static, "StatusTracker").$$render($$result, Object.assign({}, { autoscroll: modelly.autoscroll }, { i18n: modelly.i18n }, loading_status), {}, {})} ${validate_component(VideoPreview, "StaticVideo").$$render(
            $$result,
            {
              value: _video,
              subtitle: _subtitle,
      ...
      {
        default: () => {
          return `${validate_component(Static, "StatusTracker").$$render($$result, Object.assign({}, { autoscroll: modelly.autoscroll }, { i18n: modelly.i18n }, loading_status), {}, {})} ${validate_component(Video, "Video").$$render(
            $$result,
            {
              value: _video,
              subtitle: _subtitle,
            ...
            {
              default: () => {
                return `${validate_component(UploadText, "UploadText").$$render($$result, { i18n: modelly.i18n, type: "video" }, {}, {})}`;
              }
            }
          )}`;
        }
...
//# sourceMappingURL=index48-Cv-gLRle.js.map
