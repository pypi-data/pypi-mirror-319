...
import { B as Block, S as Static, f as BlockLabel, at as LineChart, h as Empty } from './2-ZyZyiYjX.js';
...
const Index = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${validate_component(Block, "Block").$$render(
    ...
    {
      default: () => {
        return `${validate_component(Static, "StatusTracker").$$render($$result, Object.assign({}, { autoscroll: modelly.autoscroll }, { i18n: modelly.i18n }, loading_status), {}, {})} ${show_label ? `${validate_component(BlockLabel, "BlockLabel").$$render(
          $$result,
          {
            Icon: LineChart,
            label,
...
//# sourceMappingURL=Index38-BtBcGCPf.js.map
