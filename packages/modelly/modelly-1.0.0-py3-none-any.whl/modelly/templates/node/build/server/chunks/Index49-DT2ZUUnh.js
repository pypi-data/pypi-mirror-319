...
import { B as Block, f as BlockLabel, as as JSON$1$1, S as Static, i as IconButtonWrapper, j as IconButton, w as Copy, h as Empty } from './2-ZyZyiYjX.js';
    ...
    {},
    {
      default: () => {
        return `<div>${label ? `${validate_component(BlockLabel, "BlockLabel").$$render(
          ...
          {},
          {}
        )}` : ``}</div> ${validate_component(Static, "StatusTracker").$$render($$result, Object.assign({}, { autoscroll: modelly.autoscroll }, { i18n: modelly.i18n }, loading_status), {}, {})} ${validate_component(JSON$1, "JSON").$$render(
          $$result,
          {
            value,
            open,
...
//# sourceMappingURL=Index49-DT2ZUUnh.js.map
