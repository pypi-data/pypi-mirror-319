...
import { B as Block, S as Static, f as BlockLabel, g as Image, h as Empty, i as IconButtonWrapper, F as FullscreenButton } from './2-ZyZyiYjX.js';
import { r as resolve_wasm_src } from './DownloadLink-DO-FUwy_.js';
...
const Index = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  let _value = null;
  let { modelly } = $$props;
  let { label = modelly.i18n("annotated_image.annotated_image") } = $$props;
  ...
  return `${validate_component(Block, "Block").$$render(
    ...
    {
      default: () => {
        return `${validate_component(Static, "StatusTracker").$$render($$result, Object.assign({}, { autoscroll: modelly.autoscroll }, { i18n: modelly.i18n }, loading_status), {}, {})} ${validate_component(BlockLabel, "BlockLabel").$$render(
          $$result,
          {
            show_label,
            Icon: Image,
...
//# sourceMappingURL=Index14-BQ3hceD-.js.map
