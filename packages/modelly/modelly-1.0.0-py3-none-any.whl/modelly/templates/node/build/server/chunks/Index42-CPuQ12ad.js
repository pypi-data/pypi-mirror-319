...
import { a5 as Button } from './2-ZyZyiYjX.js';
...
const Index = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${validate_component(UploadButton$1, "UploadButton").$$render(
    ...
    {
      default: () => {
        return `${escape(label ? modelly.i18n(label) : "")}`;
      }
    }
  )}`;
});
...
//# sourceMappingURL=Index42-CPuQ12ad.js.map
