import { B as Block, S as Static, K as BlockTitle, h as Empty, at as LineChart, a8 as globals } from './2-ZyZyiYjX.js';
...
const Index = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  async function load_chart() {
    ...
    if (!vegaEmbed) {
      vegaEmbed = (await import('./vega-embed.module-BV9yKgJg.js')).default;
    }
    vegaEmbed(chart_element, spec, { actions: false }).then(function(result) {
      view = result.view;
      resizeObserver.observe(chart_element);
  ...
  return `${validate_component(Block, "Block").$$render(
    ...
    {
      default: () => {
        return `${loading_status ? `${validate_component(Static, "StatusTracker").$$render($$result, Object_1.assign({}, { autoscroll: modelly.autoscroll }, { i18n: modelly.i18n }, loading_status), {}, {})}` : ``} ${validate_component(BlockTitle, "BlockTitle").$$render($$result, { root, show_label, info: void 0 }, {}, {
          default: () => {
            return `${escape(label)}`;
          }
...
//# sourceMappingURL=Index24-SrDgmqH1.js.map
