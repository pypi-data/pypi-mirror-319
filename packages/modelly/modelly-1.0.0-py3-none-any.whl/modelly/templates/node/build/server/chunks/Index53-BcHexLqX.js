import { B as Block, S as Static, f as BlockLabel, a7 as TextHighlight, h as Empty, a8 as globals, a9 as colors } from './2-ZyZyiYjX.js';
...
import { g as get_next_color } from './color-vxytxOFd.js';
...
const Index = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    $$rendered = `${!interactive ? `${validate_component(Block, "Block").$$render(
      ...
      {
        default: () => {
          return `${validate_component(Static, "StatusTracker").$$render($$result, Object_1.assign({}, { autoscroll: modelly.autoscroll }, { i18n: modelly.i18n }, loading_status), {}, {})} ${label && show_label ? `${validate_component(BlockLabel, "BlockLabel").$$render(
            $$result,
            {
              Icon: TextHighlight,
              label,
      ...
      {
        default: () => {
          return `${validate_component(Static, "StatusTracker").$$render($$result, Object_1.assign({}, { autoscroll: modelly.autoscroll }, loading_status, { i18n: modelly.i18n }), {}, {})} ${label && show_label ? `${validate_component(BlockLabel, "BlockLabel").$$render(
            $$result,
            {
              Icon: TextHighlight,
              label,
...
//# sourceMappingURL=Index53-BcHexLqX.js.map
