...
import Gallery from './Gallery-CmDWPxss.js';
import { BaseFileUpload } from './Index8-C3_Otlz-.js';
...
const Index = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    $$rendered = `${validate_component(Block, "Block").$$render(
      ...
      {
        default: () => {
          return `${validate_component(Static, "StatusTracker").$$render($$result, Object.assign({}, { autoscroll: modelly.autoscroll }, { i18n: modelly.i18n }, loading_status), {}, {})} ${interactive && no_value ? `${validate_component(BaseFileUpload, "BaseFileUpload").$$render(
            $$result,
            {
              value: null,
              root,
            ...
            {
              default: () => {
                return `${validate_component(UploadText, "UploadText").$$render($$result, { i18n: modelly.i18n, type: "gallery" }, {}, {})}`;
              }
            }
...
//# sourceMappingURL=Index7-OTYrr8_K.js.map
