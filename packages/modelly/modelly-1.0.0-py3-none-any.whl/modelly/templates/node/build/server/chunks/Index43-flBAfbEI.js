...
import { B as Block, S as Static } from './2-ZyZyiYjX.js';
...
const Index = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${validate_component(Block, "Block").$$render(
    ...
    {
      default: () => {
        return `${loading_status ? `${validate_component(Static, "StatusTracker").$$render($$result, Object.assign({}, { autoscroll: modelly.autoscroll }, { i18n: modelly.i18n }, loading_status), {}, {})}` : ``} ${validate_component(JsonView, "JsonView").$$render($$result, { json: value }, {}, {})}`;
      }
    }
  )}`;
});
...
//# sourceMappingURL=Index43-flBAfbEI.js.map
