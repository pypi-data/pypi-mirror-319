...
import { B as Block, S as Static, J as Info$1 } from './2-ZyZyiYjX.js';
...
const Index = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    $$rendered = `${validate_component(Block, "Block").$$render(
      ...
      {
        default: () => {
          return `${validate_component(Static, "StatusTracker").$$render($$result, Object.assign({}, { autoscroll: modelly.autoscroll }, { i18n: modelly.i18n }, loading_status), {}, {})} ${info ? `${validate_component(Info$1, "Info").$$render($$result, { root, info }, {}, {})}` : ``} ${validate_component(BaseCheckbox, "BaseCheckbox").$$render(
            $$result,
...
//# sourceMappingURL=Index35-D6OC0GYc.js.map
