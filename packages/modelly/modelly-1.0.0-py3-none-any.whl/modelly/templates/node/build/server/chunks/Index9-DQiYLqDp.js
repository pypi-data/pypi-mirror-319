...
import Plot$1 from './Plot-La59WfwM.js';
import { B as Block, f as BlockLabel, az as Plot, S as Static } from './2-ZyZyiYjX.js';
    ...
    {},
    {
      default: () => {
        return `${validate_component(BlockLabel, "BlockLabel").$$render(
          ...
          {},
          {}
        )} ${validate_component(Static, "StatusTracker").$$render($$result, Object.assign({}, { autoscroll: modelly.autoscroll }, { i18n: modelly.i18n }, loading_status), {}, {})} ${validate_component(Plot$1, "Plot").$$render(
          $$result,
          {
            value,
            theme_mode,
...
//# sourceMappingURL=Index9-DQiYLqDp.js.map
