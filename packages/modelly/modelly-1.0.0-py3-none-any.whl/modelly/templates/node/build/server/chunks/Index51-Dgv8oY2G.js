...
import { B as Block, S as Static, f as BlockLabel, v as File$1, h as Empty, U as UploadText, i as IconButtonWrapper, j as IconButton, A as Undo, D as Download } from './2-ZyZyiYjX.js';
import { U as Upload, M as ModifyUpload } from './ModifyUpload-C7AfhHei.js';
...
const Index = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    $$rendered = `${!interactive ? `${validate_component(Block, "Block").$$render(
      ...
      {
        default: () => {
          return `${validate_component(Static, "StatusTracker").$$render($$result, Object.assign({}, { autoscroll: modelly.autoscroll }, { i18n: modelly.i18n }, loading_status), {}, {})} ${value && is_browser ? `${validate_component(Model3D$1, "Model3D").$$render(
            $$result,
            {
              value,
              i18n: modelly.i18n,
      ...
      {
        default: () => {
          return `${validate_component(Static, "StatusTracker").$$render($$result, Object.assign({}, { autoscroll: modelly.autoscroll }, { i18n: modelly.i18n }, loading_status), {}, {})} ${validate_component(Model3DUpload$1, "Model3DUpload").$$render(
            $$result,
            {
              label,
              show_label,
            ...
            {
              default: () => {
                return `${validate_component(UploadText, "UploadText").$$render($$result, { i18n: modelly.i18n, type: "file" }, {}, {})}`;
              }
            }
          )}`;
        }
...
//# sourceMappingURL=Index51-Dgv8oY2G.js.map
