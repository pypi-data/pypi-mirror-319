...
import { B as Block, f as BlockLabel, N as Code, S as Static, ab as css_units } from './2-ZyZyiYjX.js';
    ...
    {},
    {
      default: () => {
        return `${show_label ? `${validate_component(BlockLabel, "BlockLabel").$$render(
          ...
          {},
          {}
        )}` : ``} ${validate_component(Static, "StatusTracker").$$render($$result, Object.assign({}, { autoscroll: modelly.autoscroll }, { i18n: modelly.i18n }, loading_status, { variant: "center" }), {}, {})} <div class="${[
...
//# sourceMappingURL=Index45-CQiXX9-R.js.map
