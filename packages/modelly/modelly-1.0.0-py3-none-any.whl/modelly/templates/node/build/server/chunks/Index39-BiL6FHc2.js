...
import { B as Block, S as Static, K as BlockTitle, z as Clear, M as Music, au as Video, v as File$1, av as Paperclip, aw as Microphone, ax as Send, ad as Square } from './2-ZyZyiYjX.js';
import { U as Upload } from './ModifyUpload-C7AfhHei.js';
import { I as Image$1 } from './Image-CzxXKKDB.js';
import { I as InteractiveAudio$1 } from './InteractiveAudio-DSosEmhL.js';
export { default as BaseExample } from './Example18-CHM8EEcS.js';
...
import './AudioPlayer-QsMpb0Ft.js';
...
const Index = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    $$rendered = `   ${validate_component(Block, "Block").$$render(
      ...
      {
        default: () => {
          return `${loading_status ? `${validate_component(Static, "StatusTracker").$$render($$result, Object.assign({}, { autoscroll: modelly.autoscroll }, { i18n: modelly.i18n }, loading_status), {}, {})}` : ``} ${validate_component(MultimodalTextbox$1, "MultimodalTextbox").$$render(
            $$result,
            {
              file_types,
              root,
...
//# sourceMappingURL=Index39-BiL6FHc2.js.map
