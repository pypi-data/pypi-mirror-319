...
const BokehPlot = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  plot = value?.plot;
  loaded && embed_bokeh(plot);
  return `<div${add_attribute("data-testid", "bokeh", 0)}${add_attribute("id", div_id, 0)} class="modelly-bokeh svelte-1mzhjrn"></div>`;
});

export { BokehPlot as default };
//# sourceMappingURL=BokehPlot-CKk_8lYE.js.map
