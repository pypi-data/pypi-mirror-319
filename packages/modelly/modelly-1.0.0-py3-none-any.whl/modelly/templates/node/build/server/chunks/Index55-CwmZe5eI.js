...
import { B as Block, S as Static, f as BlockLabel, v as File$1 } from './2-ZyZyiYjX.js';
...
const Index = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    $$rendered = `  ${validate_component(Block, "Block").$$render(
      ...
      {
        default: () => {
          return `${validate_component(Static, "StatusTracker").$$render($$result, Object.assign({}, loading_status, { autoscroll: modelly.autoscroll }, { i18n: modelly.i18n }), {}, {})} ${validate_component(BlockLabel, "BlockLabel").$$render(
            $$result,
            {
              show_label,
              Icon: File$1,
...
//# sourceMappingURL=Index55-CwmZe5eI.js.map
