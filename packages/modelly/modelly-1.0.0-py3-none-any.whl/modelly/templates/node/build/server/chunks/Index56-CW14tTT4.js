...
import { B as Block, S as Static, f as BlockLabel, C as Chat, i as IconButtonWrapper, j as IconButton, q as Community, r as Trash, t as MarkdownCode, M as Music, v as File$1, w as Copy, x as ScrollDownArrow, y as Check, z as Clear, R as Retry, A as Undo, G as Edit, H as DropdownCircularArrow } from './2-ZyZyiYjX.js';
import { I as Image$1 } from './Image-CzxXKKDB.js';
...
import './DownloadLink-DO-FUwy_.js';
...
const Thought = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="thought-group svelte-i6yrue"><div class="${["title svelte-i6yrue", "expanded"].join(" ").trim()}"${add_attribute("aria-busy", thought_node.content === "" || thought_node.content === null, 0)} role="button" tabindex="0"><span class="arrow svelte-i6yrue"${add_styles({
    ...
    {},
    {}
  )} ${thought_node.content === "" || thought_node.content === null ? `<span class="loading-spinner svelte-i6yrue"></span>` : ``} ${thought_node?.duration ? `<span class="duration svelte-i6yrue">${escape(thought_node.duration || 0.16)}s</span>` : ``}</div> ${`<div class="content svelte-i6yrue">${validate_component(MessageContent, "MessageContent").$$render(
    $$result,
    {
      message: thought_node,
      sanitize_html,
    ...
    {},
    {
      default: () => {
        return `${loading_status ? `${validate_component(Static, "StatusTracker").$$render(
          $$result,
          Object.assign({}, { autoscroll: modelly.autoscroll }, { i18n: modelly.i18n }, loading_status, {
...
//# sourceMappingURL=Index56-CW14tTT4.js.map
