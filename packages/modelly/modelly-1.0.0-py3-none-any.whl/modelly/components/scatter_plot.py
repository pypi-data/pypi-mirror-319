...
from modelly.components.plot import AltairPlot, AltairPlotData, Plot
    ...
    def __init__(
        ...
        *,
        ...
        Parameters:
            ...
            color: The column to determine the point color. If the column contains numeric data, modelly will interpolate the column data so that small values correspond to light colors and large values correspond to dark values.
            size: The column used to determine the point size. Should contain numeric data so that modelly can map the data to the point size.
            shape: The column used to determine the point shape. Should contain categorical data. Modelly will map each unique value to a different shape.
