"""Contains all of the components that can be used with Modelly Interface / Blocks.
...
from modelly.blocks import Block, BlockContext
...
from modelly.processing_utils import move_files_to_cache
...
class ComponentBase(ABC, metaclass=ComponentMeta):
    ...
    @abstractmethod
    def flag(self, payload: Any | ModellyDataModel, flag_dir: str | Path = "") -> str:
        """
    ...
    @abstractmethod
    def read_from_flag(self, payload: Any) -> ModellyDataModel | Any:
        """
...
class Component(ComponentBase, Block):
    ...
    def __init__(
        ...
        *,
        ...
        if not hasattr(self, "data_model"):
            self.data_model: type[ModellyDataModel] | None = None
    ...
    def example_payload(self) -> Any:
        ...
        This is used to generate the docs for the View API page for Modelly apps using this component.
        """
