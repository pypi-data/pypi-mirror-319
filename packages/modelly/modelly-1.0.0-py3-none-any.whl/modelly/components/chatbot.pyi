...
from modelly import utils
from modelly.component_meta import ComponentMeta
from modelly.components import (
    Component as ModellyComponent,
)
from modelly.components.base import Component
from modelly.data_classes import FileData, ModellyModel, ModellyRootModel
from modelly.events import Events
...
class FileDataDict(TypedDict):
    ...
    meta: dict[Literal["_type"], Literal["modelly.FileData"]]
...
class FileMessage(ModellyModel):
    file: FileData
    alt_text: Optional[str] = None


class ComponentMessage(ModellyModel):
    component: str
    value: Any
...
class ChatbotDataTuples(ModellyRootModel):
    root: list[
        tuple[
...
class Metadata(ModellyModel):
    title: Optional[str] = None
    id: Optional[int | str] = None
    parent_id: Optional[int | str] = None


class Message(ModellyModel):
    role: str
...
class ChatbotDataMessages(ModellyRootModel):
    root: list[Message]
...
if TYPE_CHECKING:
    from modelly.components import Timer


def import_component_and_data(
    component_name: str,
) -> ModellyComponent | ComponentMeta | Any | None:
    try:
...
from modelly.events import Dependency
...
class Chatbot(Component):
    ...
    def __init__(
        ...
        *,
        ...
        """
        Parameters:
            value: Default list of messages to show in chatbot, where each message is of the format {"role": "user", "content": "Help me."}. Role can be one of "user", "assistant", or "system". Content should be either text, or media passed as a Modelly component, e.g. {"content": gr.Image("lion.jpg")}. If callable, the function will be called whenever the app loads to set the initial value of the component.
            type: The format of the messages passed into the chat history parameter of `fn`. If "messages", passes the value as a list of dictionaries with openai-style "role" and "content" keys. The "content" key's value should be one of the following - (1) strings in valid Markdown (2) a dictionary with a "path" key and value corresponding to the file to display or (3) an instance of a Modelly component. At the moment Image, Plot, Video, Gallery, Audio, and HTML are supported. The "role" key should be one of 'user' or 'assistant'. Any other roles will not be displayed in the output. If this parameter is 'tuples', expects a `list[list[str | None | tuple]]`, i.e. a list of lists. The inner list should have 2 elements: the user message and the response message, but this format is deprecated.
            ...
            show_share_button: If True, will show a share icon in the corner of the component that allows user to share outputs to Hugging Face Spaces Discussions. If False, icon does not appear. If set to None (default behavior), then the icon appears if this Modelly app is launched on Spaces, but not otherwise.
            show_copy_button: If True, will show a copy button for each chatbot message.
            avatar_images: Tuple of two avatar image paths or URLs for user and bot (in that order). Pass None for either the user or bot image to skip. Must be within the working directory of the Modelly app or an external URL.
        ...
        if type is None:
            warnings.warn(
                "You have not specified a value for the `type` parameter. Defaulting to the 'tuples' format for chatbot messages, but this is deprecated and will be removed in a future version of Modelly. Please set type='messages' instead, which uses openai-style dictionaries with 'role' and 'content' keys.",
                UserWarning,
            )
            type = "tuples"
        elif type == "tuples":
            warnings.warn(
                "The 'tuples' format for chatbot messages is deprecated and will be removed in a future version of Modelly. Please set type='messages' instead, which uses openai-style 'role' and 'content' keys.",
                UserWarning,
            )
    ...
    def _preprocess_content(
    ...
    ) -> str | ModellyComponent | tuple[str | None] | tuple[str | None, str] | None:
        if chat_message is None:
            ...
            if component is not None:
                ...
                elif issubclass(instance.data_model, ModellyModel):
                    payload = instance.data_model(**chat_message.value)
                elif issubclass(instance.data_model, ModellyRootModel):
    ...
    @staticmethod
    def _get_alt_text(chat_message: dict | list | tuple | ModellyComponent):
        if isinstance(chat_message, dict):
            return chat_message.get("alt_text")
        elif not isinstance(chat_message, ModellyComponent) and len(chat_message) > 1:
    ...
    def _postprocess_content(
        ...
        elif isinstance(chat_message, ModellyComponent):
    ...
    def change(self,
        ...
        Parameters:
            ...
            inputs: list of modelly.components to use as inputs. If the function takes no inputs, this should be an empty list.
            outputs: list of modelly.components to use as outputs. If the function returns no outputs, this should be an empty list.
            api_name: defines how the endpoint appears in the API docs. Can be a string, None, or False. If False, the endpoint will not be exposed in the api docs. If set to None, the endpoint will be exposed in the api docs as an unnamed endpoint, although this behavior will be changed in Modelly 4.0. If set to a string, the endpoint will be exposed in the api docs with the given name.
