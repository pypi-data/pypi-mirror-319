...
from modelly import processing_utils, utils
...
class Annotation(ModellyModel):
    image: FileData
    label: str


class AnnotatedImageData(ModellyModel):
    image: FileData
    ...
    def postprocess(
        ...
        for mask, label in value[1]:
            ...
            mask_file = processing_utils.save_pil_to_cache(
                colored_mask_img, cache_dir=self.MODELLY_CACHE, format="png"
            )
