        ...
        *,
        ...
        for example in self.raw_samples:
            ...
            for component, ex in zip(self._components, example, strict=False):
                # If proxy_url is set, that means it is being loaded from an external Modelly app
                # which means that the example has already been processed.
                if self.proxy_url is None:
                    # We do not need to process examples if the Modelly app is being loaded from
