...
from modelly import processing_utils
from modelly.components.base import Component
from modelly.data_classes import FileData, ListFiles
from modelly.events import Events
from modelly.exceptions import Error
from modelly.utils import NamedString
...
class UploadButton(Component):
    ...
    def example_payload(self) -> Any:
        if self.file_count == "single":
            return handle_file(
                "https://github.com/khulnasoft/modelly/raw/main/test/test_files/sample_file.pdf"
            )
        else:
            return [
                handle_file(
    ...
    def example_value(self) -> Any:
        if self.file_count == "single":
            return "https://github.com/khulnasoft/modelly/raw/main/test/test_files/sample_file.pdf"
        else:
            return [
                "https://github.com/khulnasoft/modelly/raw/main/test/test_files/sample_file.pdf"
            ]
    ...
    def _process_single_file(self, f: FileData) -> bytes | NamedString:
        ...
        if self.type == "filepath":
            ...
            file = tempfile.NamedTemporaryFile(delete=False, dir=self.MODELLY_CACHE)
            file.name = file_name
