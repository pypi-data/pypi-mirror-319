...
from modelly import image_utils, utils
from modelly.components.base import Component, StreamingInput
from modelly.data_classes import Base64ImageData, ImageData
...
PIL.Image.init()  # fixes https://github.com/khulnasoft/modelly/issues/2843
...
class Image(StreamingInput, Component):
        ...
        if payload.url and payload.url.startswith("data:"):
            if self.type == "pil":
                ...
                return image_utils.decode_base64_to_file(
                    payload.url, self.MODELLY_CACHE, self.format
                )
    ...
    def postprocess(
        ...
        saved = image_utils.save_image(value, self.MODELLY_CACHE, self.format)
    ...
    def example_value(self) -> Any:
        return "https://raw.githubusercontent.com/khulnasoft/modelly/main/test/test_files/bus.png"
