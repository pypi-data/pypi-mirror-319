...
from modelly.components.base import Component, server
from modelly.data_classes import FileData, ModellyModel
...
class EditorDataBlobs(ModellyModel):
...
class AcceptBlobs(ModellyModel):
    data: BlobData
...
class ImageEditor(Component):
    ...
    def postprocess(self, value: EditorValue | ImageType | None) -> EditorData | None:
        ...
        return EditorData(
            background=(
                FileData(
                    path=image_utils.save_image(
                        value["background"], self.MODELLY_CACHE, format=self.format
                    )
                )
    ...
    def example_value(self) -> Any:
        return {
            "background": "https://raw.githubusercontent.com/khulnasoft/modelly/main/test/test_files/bus.png",
            "layers": [],
            "composite": None,
        }
