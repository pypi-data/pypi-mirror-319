...
from modelly.data_classes import ModellyModel
...
class NativePlot(Component):
    """
    Creates a native Modelly plot component to display data from a pandas DataFrame. Supports interactivity and updates.
