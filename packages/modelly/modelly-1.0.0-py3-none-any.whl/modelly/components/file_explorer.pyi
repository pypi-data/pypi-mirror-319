...
from modelly.data_classes import DeveloperPath, ModellyRootModel, UserProvidedPath
from modelly.utils import safe_join

if TYPE_CHECKING:
    from modelly.components import Timer


class FileExplorerData(ModellyRootModel):
...
class FileExplorer(Component):
    """
    Creates a file explorer component that allows users to browse files on the machine hosting the Modelly app. As an input component,
    ...
    def example_payload(self) -> Any:
        return [["modelly", "app.py"]]

    def example_value(self) -> Any:
        return os.sep.join(["modelly", "app.py"])
