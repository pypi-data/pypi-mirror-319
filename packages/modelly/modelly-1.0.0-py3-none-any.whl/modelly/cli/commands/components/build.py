...
from modelly.cli.commands.components._docs_utils import (
    get_deep,
)
from modelly.cli.commands.components.docs import run_command
from modelly.cli.commands.components.install_component import _get_executable_path
from modelly.cli.commands.display import LivePanelDisplay
    ...
    with LivePanelDisplay() as live:
        ...
        try:
            ...
            raise ValueError(
                ...
                "Please install it with the modelly cc install command before building it."
            ) from e
        if bump_version:
            pyproject_toml = parse((path / "pyproject.toml").read_text())
