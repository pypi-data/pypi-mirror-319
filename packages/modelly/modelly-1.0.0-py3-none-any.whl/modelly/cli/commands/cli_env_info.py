"""This file is the part of 'modelly/cli.py' for printing the environment info
for the cli command 'modelly environment'
"""
...
def print_environment_info():
    """Print Modelly environment information."""
    print("Modelly Environment Information:\n------------------------------")
    print("Operating System:", platform.system())

    for package_name in ["modelly", "modelly_client"]:
        try:
