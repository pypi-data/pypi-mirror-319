...
class FrontendSiteSettings:
    ...
    student_payment_main_option: Maybe[
        "t.Literal['coupon', 'stripe']"
    ] = Nothing
        ...
        lambda: rqa.FixedMapping(
            ...
            rqa.OptionalArgument(
                ...
                doc=(
                    ...
                    " `NEW_AUTO_TEST_ALLOWED_INITIAL_BUILD_IDS`, as otherwise"
                    " the user is not allowed to use the image. The last item"
                    " in this list will be the default image id."
                ),
            ),
            rqa.OptionalArgument(
            ...
            rqa.OptionalArgument(
                ...
                rqa.RichValue.TimeDelta,
                doc=(
                    "The amount of time before an access token expires when we"
                    " will show a toast message warning the user that their"
            ...
            rqa.OptionalArgument(
                ...
                doc=(
                    "The amount of time before an access token expires when we"
                    " will show a modal with a warning that the user's session"
                    " is about to expire."
                ),
            ),
            rqa.OptionalArgument(
            ...
            rqa.OptionalArgument(
                ...
                doc=(
                    "Define what will be shown as the main option for student"
                    " payment, the default will show stripe as the main"
                    " payment option."
                ),
            ),
            rqa.OptionalArgument(
            ...
            rqa.OptionalArgument(
                ...
                rqa.SimpleValue.bool,
                doc=(
                    "Whether the `is_admin` global permission should be"
            ...
            rqa.OptionalArgument(
                ...
                rqa.SimpleValue.int,
                doc=(
                    "How many steps in the failed state to expand"
                    " automatically. Set to a negative value to automatically"
                    " expand all steps."
                ),
            ),
            rqa.OptionalArgument(
            ...
            rqa.OptionalArgument(
                ...
                rqa.SimpleValue.bool,
                doc=(
                    'Should we hide the "No deadline" message if no deadline'
                    " or lock date is set."
                ),
            ),
            rqa.OptionalArgument(
                ...
                rqa.SimpleValue.bool,
                doc=(
                    "Should we retry passing back grades for group submissions"
                    " when the passback request failed for some but not all of"
                    " the group members."
                ),
            ),
            rqa.OptionalArgument(
                ...
                rqa.SimpleValue.bool,
                doc=(
                    "Should teachers have the option to enter student view to"
                    " restrict their course permissions and interact with"
                    " their course as a student."
                ),
            ),
            rqa.OptionalArgument(
                ...
                rqa.SimpleValue.bool,
                doc=(
                    "Whether to open the assignment description as the first"
                    " file in the Code Editor, if the assignment has one, or"
                    " the first file in the file tree."
                ),
            ),
            rqa.OptionalArgument(
                ...
                rqa.SimpleValue.bool,
                doc=(
                    "The main feature flag for all the AI assistant"
                    " capabilities in codegrade, whether we enable the ai"
                    " assistant to be inside the app."
                ),
            ),
            rqa.OptionalArgument(
                ...
                rqa.SimpleValue.bool,
                doc=(
                    "Whether to get the first day of the week in calendars"
                    " from the user's configured locale. If disabled the first"
                    " day of the week will default to Sunday."
                ),
            ),
            rqa.OptionalArgument(
                ...
                rqa.SimpleValue.bool,
                doc=(
                    "Whether to allow giving inline feedback on quiz"
                    " questions."
                ),
            ),
            rqa.OptionalArgument(
                ...
                rqa.SimpleValue.bool,
                doc=(
                    'Whether to enable the "Try out" functionality in Pearson'
                    " templates."
                ),
            ),
            rqa.OptionalArgument(
                ...
                rqa.SimpleValue.bool,
                doc=(
                    'Whether to hide the "▶️ Run" button in the editor sidebar'
                    ' when an assignment contains only quizzes with the "Run'
                    ' single questions" feature enabled.'
                ),
            ),
