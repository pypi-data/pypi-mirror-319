            ...
            rqa.FixedMapping(
                ...
                rqa.OptionalArgument(
                    ...
                    doc=(
                        ...
                        " `MAX_NORMAL_UPLOAD_SIZE`. Increasing this size might"
                ...
                rqa.OptionalArgument(
                    ...
                    doc=(
                        ...
                        " dynamodb. This is not the same as `MAX_FILE_SIZE`."
                ...
                rqa.OptionalArgument(
                    ...
                    doc=(
                        ...
                        " `MAX_DYNAMO_FILE_SIZE`, as it refers to a single"
                ...
                rqa.OptionalArgument(
                    ...
                    doc=(
                        ...
                        " `extra_roles_mapping` defined in their"
                        " `lms_capabilities`."
                    ),
                ),
                rqa.OptionalArgument(
                ...
                rqa.OptionalArgument(
                    ...
                    rqa.SimpleValue.bool,
                    doc=(
                        "Whether we are running Codegrade for Pearson"
                        " specifically, flag aligns all the smallest"
                        " adjustments needed that cannot be made into an"
                        " actual feature."
                    ),
                ),
            )
