...
parser.add_argument("scaleDbId", type=str, required=False,
                    help="The unique identifier for a scale")
...
class PhenotypingScales(Resource):
    ...
    def get(self):
        ...
        try:            
            ...
            brapiResponse,brapiStatus,brapiError = handler.brapiRepaginateRequestResponse(
                self.api.brapi, "scales", params=params)
            if brapiResponse:
