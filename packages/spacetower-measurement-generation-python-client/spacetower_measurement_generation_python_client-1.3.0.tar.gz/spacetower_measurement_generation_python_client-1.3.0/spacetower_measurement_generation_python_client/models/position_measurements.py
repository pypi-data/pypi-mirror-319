...
class PositionMeasurements(BaseModel):
    """
    Measurement sample consisting of position in a specified frame
    """ # noqa: E501
    dates: List[str]
    description: Optional[List[FieldDescription]] = None
    frame_id: EarthCenteredFrameId = Field(alias="frameId")
    data: List[List[Union[StrictFloat, StrictInt]]] = Field(description="[[pos-x[m], pos-y[m], pos-z[m]], ...]")
