<a id="types-boto3-storagegateway"></a>

# types-boto3-storagegateway

[![PyPI - types-boto3-storagegateway](https://img.shields.io/pypi/v/types-boto3-storagegateway.svg?color=blue)](https://pypi.org/project/types-boto3-storagegateway/)
[![PyPI - Python Version](https://img.shields.io/pypi/pyversions/types-boto3-storagegateway.svg?color=blue)](https://pypi.org/project/types-boto3-storagegateway/)
[![Docs](https://img.shields.io/readthedocs/boto3-stubs.svg?color=blue)](https://youtype.github.io/types_boto3_docs/)
[![PyPI - Downloads](https://static.pepy.tech/badge/types-boto3-storagegateway)](https://pypistats.org/packages/types-boto3-storagegateway)

![boto3.typed](https://github.com/youtype/mypy_boto3_builder/raw/main/logo.png)

Type annotations for
[boto3 StorageGateway 1.35.93](https://pypi.org/project/boto3/) compatible with
...
[types-boto3-storagegateway docs](https://youtype.github.io/types_boto3_docs/types_boto3_storagegateway/).

See how it helps you find and fix potential bugs:

![types-boto3 demo](https://github.com/youtype/mypy_boto3_builder/raw/main/demo.gif)

- [types-boto3-storagegateway](#types-boto3-storagegateway)
...
- Install `types-boto3[storagegateway]` in your environment:
...
- Install `types-boto3[storagegateway]` with services you use in your
  environment:
...
`types-boto3-storagegateway` dependency in production. However, there is an
...
from types_boto3_storagegateway import StorageGatewayClient
...
`types_boto3_storagegateway.paginator` module contains type annotations for all
paginators.
...
`types_boto3_storagegateway.literals` module contains literals extracted from
shapes that can be used in user code for type checking.

Full list of `StorageGateway` Literals can be found in
[docs](https://youtype.github.io/types_boto3_docs/types_boto3_storagegateway/literals/).
...
`types_boto3_storagegateway.type_defs` module contains structures and shapes
assembled to typed dictionaries and unions for additional type checking.

Full list of `StorageGateway` TypeDefs can be found in
[docs](https://youtype.github.io/types_boto3_docs/types_boto3_storagegateway/type_defs/).
...
`types-boto3-storagegateway` version is the same as related `boto3` version and
...
[boto3 docs](https://youtype.github.io/types_boto3_docs/types_boto3_storagegateway/)
