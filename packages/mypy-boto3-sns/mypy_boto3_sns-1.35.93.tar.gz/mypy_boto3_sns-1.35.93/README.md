...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-sns)](https://pypistats.org/packages/mypy-boto3-sns)
...
`mypy-boto3-sns` dependency in production. However, there is an issue in
