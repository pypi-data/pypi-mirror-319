...
class Lastmile(SyncAPIClient):
    ...
    label_dataset_jobs: resources.LabelDatasetJobsResource
    ...
    def __init__(
        ...
        *,
        ...
        self.label_dataset_jobs = resources.LabelDatasetJobsResource(self)
...
class AsyncLastmile(AsyncAPIClient):
    ...
    label_dataset_jobs: resources.AsyncLabelDatasetJobsResource
    ...
    def __init__(
        ...
        *,
        ...
        self.label_dataset_jobs = resources.AsyncLabelDatasetJobsResource(self)
...
class LastmileWithRawResponse:
    def __init__(self, client: Lastmile) -> None:
        ...
        self.label_dataset_jobs = resources.LabelDatasetJobsResourceWithRawResponse(client.label_dataset_jobs)
...
class AsyncLastmileWithRawResponse:
    def __init__(self, client: AsyncLastmile) -> None:
        ...
        self.label_dataset_jobs = resources.AsyncLabelDatasetJobsResourceWithRawResponse(client.label_dataset_jobs)
...
class LastmileWithStreamedResponse:
    def __init__(self, client: Lastmile) -> None:
        ...
        self.label_dataset_jobs = resources.LabelDatasetJobsResourceWithStreamingResponse(client.label_dataset_jobs)
...
class AsyncLastmileWithStreamedResponse:
    def __init__(self, client: AsyncLastmile) -> None:
        ...
        self.label_dataset_jobs = resources.AsyncLabelDatasetJobsResourceWithStreamingResponse(
