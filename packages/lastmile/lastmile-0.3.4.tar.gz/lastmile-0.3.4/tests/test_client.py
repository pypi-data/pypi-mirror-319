...
from lastmile import Lastmile, AsyncLastmile, APIResponseValidationError
from lastmile._types import Omit
from lastmile._models import BaseModel, FinalRequestOptions
from lastmile._constants import RAW_RESPONSE_HEADER
from lastmile._exceptions import LastmileError, APIStatusError, APITimeoutError, APIResponseValidationError
from lastmile._base_client import (
    DEFAULT_TIMEOUT,
...
def _get_open_connections(client: Lastmile | AsyncLastmile) -> int:
...
class TestLastmile:
    client = Lastmile(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=True)
            ...
            for frame in diff.traceback:
                if any(
                    ...
                    for fragment in [
                        ...
                        "lastmile/_legacy_response.py",
                        "lastmile/_response.py",
    ...
    def test_validate_headers(self) -> None:
        ...
        with pytest.raises(LastmileError):
            with update_env(**{"LASTMILE_API_TOKEN": Omit()}):
                client2 = Lastmile(base_url=base_url, bearer_token=None, _strict_response_validation=True)
            _ = client2
    ...
    def test_multipart_repeating_array(self, client: Lastmile) -> None:
        request = client._build_request(
    ...
    def test_base_url_env(self) -> None:
        with update_env(LASTMILE_BASE_URL="http://localhost:5000/from/env"):
            client = Lastmile(bearer_token=bearer_token, _strict_response_validation=True)
    ...
    def test_base_url_trailing_slash(self, client: Lastmile) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: Lastmile) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: Lastmile) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = Lastmile(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            strict_client.get("/foo", cast_to=Model)

        client = Lastmile(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=False)
    ...
    @mock.patch("lastmile._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
    def test_retrying_timeout_errors_doesnt_leak(self, respx_mock: MockRouter) -> None:
        respx_mock.post("/api/2/auto_eval/dataset/create").mock(
    ...
    def test_retrying_status_errors_doesnt_leak(self, respx_mock: MockRouter) -> None:
        respx_mock.post("/api/2/auto_eval/dataset/create").mock(return_value=httpx.Response(500))
    ...
    def test_retries_taken(
        ...
        respx_mock.post("/api/2/auto_eval/dataset/create").mock(side_effect=retry_handler)
    ...
    def test_omit_retry_count_header(
        self, client: Lastmile, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = client.with_options(max_retries=4)
        ...
        response = client.datasets.with_raw_response.create(extra_headers={"x-stainless-retry-count": Omit()})
    ...
    def test_overwrite_retry_count_header(
        ...
        response = client.datasets.with_raw_response.create(extra_headers={"x-stainless-retry-count": "42"})

        assert response.http_request.headers.get("x-stainless-retry-count") == "42"


class TestAsyncLastmile:
    client = AsyncLastmile(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=True)
    ...
    def test_validate_headers(self) -> None:
        ...
        with pytest.raises(LastmileError):
            with update_env(**{"LASTMILE_API_TOKEN": Omit()}):
                client2 = AsyncLastmile(base_url=base_url, bearer_token=None, _strict_response_validation=True)
            _ = client2
    ...
    def test_multipart_repeating_array(self, async_client: AsyncLastmile) -> None:
    ...
    def test_base_url_env(self) -> None:
        with update_env(LASTMILE_BASE_URL="http://localhost:5000/from/env"):
            client = AsyncLastmile(bearer_token=bearer_token, _strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"
    ...
    def test_base_url_trailing_slash(self, client: AsyncLastmile) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: AsyncLastmile) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: AsyncLastmile) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = AsyncLastmile(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            await strict_client.get("/foo", cast_to=Model)

        client = AsyncLastmile(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=False)
    ...
    async def test_retries_taken(
        ...
        response = await client.datasets.with_raw_response.create()
    ...
    async def test_omit_retry_count_header(
        self, async_client: AsyncLastmile, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = async_client.with_options(max_retries=4)
        ...
        response = await client.datasets.with_raw_response.create(extra_headers={"x-stainless-retry-count": Omit()})
    ...
    async def test_overwrite_retry_count_header(
        ...
        response = await client.datasets.with_raw_response.create(extra_headers={"x-stainless-retry-count": "42"})
    ...
    def test_get_platform(self) -> None:
        ...
        from lastmile._utils import asyncify
        from lastmile._base_client import get_platform 
