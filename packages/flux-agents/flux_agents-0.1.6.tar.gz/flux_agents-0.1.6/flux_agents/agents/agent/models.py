...
from ..config.models import AgentConfig, AgentStatus, Logging

from ..state.models import AgentState

try:
    from ...llm.inference.gemini.async_inference import gemini_llm_async_inference
    from ...llm import BaseEmbeddingFunction, LLM
except (ImportError, ValueError):
    from flux_agents.llm.inference.gemini.async_inference import gemini_llm_async_inference
    from flux_agents.llm import BaseEmbeddingFunction, LLM

from ..monitor.logger import AgentLogger, AgentLogHandler
from ..monitor.agent_logs import AgentLog

from ..monitor.wrappers.logging import logging_agent_wrapper
from ..monitor.wrappers.langfuse import langfuse_agent_wrapper
from ..monitor.wrappers.default import default_agent_wrapper
...
class Agent(BaseModel):
    ...
    type: AgentType = Field(default = AgentType.BASE)
    ...
    llm: Any = Field(default_factory = lambda: LLM(gemini_llm_async_inference))
