...
from ..vectorstore.models import BaseEmbeddingFunction
...
class Context(BaseModel):
    ...
    """
    id: int = Field(default_factory=lambda: IDFactory.next_id(Context))
    type: ContextType
    content: str
    ...
    def serialize(self) -> str:
        ...
        if hasattr(self, 'embedding_function') and self.embedding_function:
            data['embedding_function'] = self.embedding_function.serialize()
