...
try:
    ...
    from flux_agents.utils.shared.tokenizer import SliceType
...
class ContextConfig(BaseModel):
    ...
    """
    retrieval_strategy: RetrievalType = Field(default = RetrievalType.CHRONOLOGICAL)
...
class AgentConfig(BaseModel):
    ...
    search_context: bool = Field(default = False)