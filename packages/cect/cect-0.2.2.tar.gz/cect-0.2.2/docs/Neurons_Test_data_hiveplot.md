...
!!! abstract inline "Choose Graph type"
    ...
    <a href="../Neurons_Test_data_graph"> Graph</a> - <a href="../Neurons_Test_data"> Matrix</a> - <b><a href="../Neurons_Test_data_hiveplot"> Hive plot</a></b> 


!!! tip  "Choose View"

    <a href="../Test_data_hiveplot"> Raw Data</a> - <b><a href="../Neurons_Test_data_hiveplot"> Neurons</a></b> - <a href="../Pharynx_Test_data_hiveplot"> Pharynx</a> - <a href="../Nonpharyngeal_Test_data_hiveplot"> Nonpharyngeal Neurons</a> - <a href="../Social_Test_data_hiveplot"> Social Network</a> - <a href="../Escape_Test_data_hiveplot"> Escape Response Circuit</a> - <a href="../Full1_Test_data_hiveplot"> Cook 2019 Fig 3</a> - <a href="../PeptidergicHubs_Test_data_hiveplot"> Peptidergic Hubs</a> - 
...
=== "Chemical Exc"
    ...
    <br/>
    ```plotly
    { "file_path": "./assets/Test_Neurons_Chemical_Exc_hiveplot.json" }
    ```
...
=== "Chemical Inh"
    ...
    <br/>
    ```plotly
    { "file_path": "./assets/Test_Neurons_Chemical_Inh_hiveplot.json" }
    ```
...
=== "Electrical"
    ...
    <br/>
    ```plotly
    { "file_path": "./assets/Test_Neurons_Electrical_hiveplot.json" }
    ```
