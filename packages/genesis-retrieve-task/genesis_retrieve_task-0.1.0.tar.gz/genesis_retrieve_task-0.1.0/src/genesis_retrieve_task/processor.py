...
from genesis_models.models import TaskModel
...
class TaskRetriever:
    ...
    def get_task(self, task_id: int) -> Dict:
        ...
        try:
            sql = text("""
                SELECT t.*, m.material_path 
                FROM task_info t
                LEFT JOIN material_info m ON t.material_id = m.material_id
                WHERE t.task_id = :task_id AND t.deleted = 0
            """)
            ...
            task_dict = {
                ...
                "material_path": task_data.material_path,
