<a id="types-boto3-tnb"></a>

# types-boto3-tnb

[![PyPI - types-boto3-tnb](https://img.shields.io/pypi/v/types-boto3-tnb.svg?color=blue)](https://pypi.org/project/types-boto3-tnb/)
[![PyPI - Python Version](https://img.shields.io/pypi/pyversions/types-boto3-tnb.svg?color=blue)](https://pypi.org/project/types-boto3-tnb/)
[![Docs](https://img.shields.io/readthedocs/boto3-stubs.svg?color=blue)](https://youtype.github.io/types_boto3_docs/)
[![PyPI - Downloads](https://static.pepy.tech/badge/types-boto3-tnb)](https://pypistats.org/packages/types-boto3-tnb)

![boto3.typed](https://github.com/youtype/mypy_boto3_builder/raw/main/logo.png)

Type annotations for
[boto3 TelcoNetworkBuilder 1.35.93](https://pypi.org/project/boto3/) compatible
...
[types-boto3-tnb docs](https://youtype.github.io/types_boto3_docs/types_boto3_tnb/).

See how it helps you find and fix potential bugs:

![types-boto3 demo](https://github.com/youtype/mypy_boto3_builder/raw/main/demo.gif)

- [types-boto3-tnb](#types-boto3-tnb)
...
- Install `types-boto3[tnb]` in your environment:
...
- Install `types-boto3[tnb]` with services you use in your environment:
...
`types-boto3-tnb` dependency in production. However, there is an issue in
...
from types_boto3_tnb import TelcoNetworkBuilderClient
...
`types_boto3_tnb.paginator` module contains type annotations for all
paginators.
...
`types_boto3_tnb.literals` module contains literals extracted from shapes that
can be used in user code for type checking.

Full list of `TelcoNetworkBuilder` Literals can be found in
[docs](https://youtype.github.io/types_boto3_docs/types_boto3_tnb/literals/).
...
`types_boto3_tnb.type_defs` module contains structures and shapes assembled to
typed dictionaries and unions for additional type checking.

Full list of `TelcoNetworkBuilder` TypeDefs can be found in
[docs](https://youtype.github.io/types_boto3_docs/types_boto3_tnb/type_defs/).
...
`types-boto3-tnb` version is the same as related `boto3` version and follows
...
[boto3 docs](https://youtype.github.io/types_boto3_docs/types_boto3_tnb/)
