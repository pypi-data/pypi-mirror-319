...
class Model:
    ...
    def set_objective_expression(self, expr: Expression, target=Target.MINIMIZE):
        ...
        _, bias, weights = expr.split_into_component(len(self._variables))
    ...
    def set_objective_matrices(self, weights: Optional[np.ndarray], bias: np.ndarray, target=Target.MINIMIZE):
        ...
        self._objective = Objective(len(self._variables), weights, bias, target)
    ...
    def add_set_partitioning_constraints_matrix(self, constraint_mask: np.ndarray):
        ...
        self._constraints.add_constraint(
            variable_size=len(self._variables),
    ...
    def add_quadratic_inequality_constraint(
        ...
        if constraint_bounds[0] > constraint_bounds[1]:
            raise ValueError("Input constraint_bounds lowerbound is higher than his upperbound.")
    ...
    def optimize(
        ...
        *,
        ...
        result, metrics = self._solve(beta, coupling_mult, timeout_in_secs, num_chains, num_engines, penalty_scaling, precision, num_buckets)
        ...
        with zipfile.ZipFile(io.BytesIO(archive_file_content), 'r') as zip_file:
            try:
                ...
                try:
                    ...
                    raise OptimizeError(error_message)
