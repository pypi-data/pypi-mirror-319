	...
	def get_tax_details(self):
		...
		for order in executed_orders:
			...
			if exchange == 'NSE' and trade_type == 'DELIVERY':
				...
				transaction_charges = (0.03503 if exchange == 'NFO' else 0.0325) / 100 * order_value
				stamp_charges = 0.003 / 100 * order_value if order['action'] == 'Buy' else 0
...
if __name__ == '__main__':
	obj = OMS({'api_key': '3uggvz253hhhfjnp', 'api_secret': '2hbojy40dyu4itx8rbzpvkm353xu3dp3', 'access_token': 'w8UvwkGzxUERmnprkDgl6Cm6I2Y6qVNc'})
