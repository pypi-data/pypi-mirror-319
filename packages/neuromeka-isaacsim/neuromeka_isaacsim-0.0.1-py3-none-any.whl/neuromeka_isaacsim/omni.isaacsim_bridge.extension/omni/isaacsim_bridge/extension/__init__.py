...
class OmniIsaacsim_bridgeExtensionExtension(omni.ext.IExt):
    ...
    def on_startup(self, ext_id):
        print("[omni.isaacsim_bridge.extension] OmniIsaacsim_bridgeExtensionExtension startup", flush=True)

    def on_shutdown(self):
        print("[omni.isaacsim_bridge.extension] OmniIsaacsim_bridgeExtensionExtension shutdown", flush=True)
