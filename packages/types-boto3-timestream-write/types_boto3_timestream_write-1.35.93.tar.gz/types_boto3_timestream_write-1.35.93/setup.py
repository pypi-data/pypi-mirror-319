"""
Setup script for types-boto3-timestream-write.
...
setup(
    name="types-boto3-timestream-write",
    version="1.35.93",
    packages=["types_boto3_timestream_write"],
    ...
    package_data={"types_boto3_timestream_write": ["py.typed", "*.pyi"]},
    python_requires=">=3.8",
    project_urls={
