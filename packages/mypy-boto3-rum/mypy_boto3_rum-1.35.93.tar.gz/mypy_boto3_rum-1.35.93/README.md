...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-rum)](https://pypistats.org/packages/mypy-boto3-rum)
...
`mypy-boto3-rum` dependency in production. However, there is an issue in
