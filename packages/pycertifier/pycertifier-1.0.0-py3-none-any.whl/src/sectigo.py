from src.certifier import Certifier, CertifierError, certifier_set_property, certifier_get_property, certifier_setup_keys, sectigo_generate_certificate_signing_request, gen_application_error_msg, get_last_error, certifier_create_info, assign_last_error
from src.xpki_client import get_cert_param_t, search_cert_param_t, renew_cert_param_t, revoke_cert_param_t
from src.constants import SECTIGO_OPT, IMPULSE_URL, ALLOWABLE_CHARACTERS, get_cert_error, renew_cert_error, revoke_error, get_cert_status_error
...
def _sectigo_get_cert(certifier: Certifier, body):
    ...
    '''    
    certifier_get_url = IMPULSE_URL + "/api/createCertificate"
...
def _sectigo_search_cert(certifier: Certifier, request_params):
    ...
    Returns CertifierError() on failure
    '''    
    certifier_search_url = IMPULSE_URL + "/api/getCertificates"
...
def _sectigo_renew_cert(certifier: Certifier, body):
    ...
    Returns CertifierError() on failure
    '''    
    certifier_renew_url = IMPULSE_URL + "/api/renewCertificate"
...
def _sectigo_revoke_cert(certifier: Certifier, body):
    ...
    Returns CertifierError() on failure
    '''    
    certifier_revoke_url = IMPULSE_URL + "/api/revokeCertificate"
