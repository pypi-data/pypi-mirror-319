...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-sagemaker-a2i-runtime)](https://pypistats.org/packages/mypy-boto3-sagemaker-a2i-runtime)

![boto3.typed](https://github.com/youtype/mypy_boto3_builder/raw/main/logo.png)

Type annotations for
[boto3 AugmentedAIRuntime 1.35.93](https://pypi.org/project/boto3/) compatible
...
`mypy-boto3-sagemaker-a2i-runtime` dependency in production. However, there is
