...
class SavedOrbitalState(BaseModel):
    """
    SavedOrbitalState
    """ # noqa: E501
    id: StrictStr = Field(description="The unique identifier of the orbital state")
    creation_date: str = Field(description="The date and time of the creation of the orbital state", alias="creationDate")
    status: Status
    ...
    __properties: ClassVar[List[str]] = ["id", "creationDate", "status", "externalId", "date", "spaceObject", "orbitData", "attitudeLaw", "context"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SavedOrbitalState from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SavedOrbitalState from a dict"""
        if obj is None:
            return None
