...
class OrbitalStateContext(BaseModel):
    """
    The simulation context used to generate the orbital state
    """ # noqa: E501
    computation_id: StrictStr = Field(description="The unique identifier of the computation used to generate the orbital state", alias="computationId")
    ...
    __properties: ClassVar[List[str]] = ["computationId", "simulationConfiguration", "data"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OrbitalStateContext from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OrbitalStateContext from a dict"""
        if obj is None:
            return None
