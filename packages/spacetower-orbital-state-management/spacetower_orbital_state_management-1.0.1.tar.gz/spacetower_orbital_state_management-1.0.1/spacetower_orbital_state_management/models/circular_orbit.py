...
class CircularOrbit(Orbit):
    ...
    __properties: ClassVar[List[str]] = ["orbitType", "semiMajorAxis", "eccentricityVectorX", "eccentricityVectorY", "inclination", "raan", "argumentOfLatitude", "anomalyType", "meanOscType", "inertialFrameId"]
