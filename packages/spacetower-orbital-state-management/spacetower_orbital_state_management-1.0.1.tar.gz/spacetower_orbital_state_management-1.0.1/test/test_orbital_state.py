...
class TestOrbitalState(unittest.TestCase):
    """OrbitalState unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OrbitalState:
        """Test OrbitalState
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrbitalState`
        """
        model = OrbitalState()
        if include_optional:
            return OrbitalState(
