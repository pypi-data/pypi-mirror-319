...
class TestPowerSystem(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PowerSystem:
        """Test PowerSystem
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PowerSystem`
        """
        model = PowerSystem()
        if include_optional:
            return PowerSystem(
