...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-signer)](https://pypistats.org/packages/mypy-boto3-signer)
...
`mypy-boto3-signer` dependency in production. However, there is an issue in
