...
class ModelProperty(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            'id': (int,),  # noqa: E501
            'definition': (PropertyDefinition,),  # noqa: E501
            'property_set_id': (int,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'property_set_id': 'property_set_id',  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, definition, property_set_id, created_at, updated_at, *args, **kwargs):  # noqa: E501
        """ModelProperty - a model defined in OpenAPI

        Args:
            id (int):
            definition (PropertyDefinition):
            property_set_id (int): This field is useful when you update a property and the  API is rebuilding a new property set to avoid an update on many elements. It gives you the new pset id
            created_at (datetime):
            updated_at (datetime):
