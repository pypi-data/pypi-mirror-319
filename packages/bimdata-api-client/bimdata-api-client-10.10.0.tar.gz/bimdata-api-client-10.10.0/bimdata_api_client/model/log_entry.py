...
class LogEntry(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'description': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)},),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, user_id, user_email, app_name, project_name, date, action, description, *args, **kwargs):  # noqa: E501
