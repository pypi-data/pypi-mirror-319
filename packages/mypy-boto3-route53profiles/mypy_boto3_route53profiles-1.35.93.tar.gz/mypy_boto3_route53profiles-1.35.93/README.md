...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-route53profiles)](https://pypistats.org/packages/mypy-boto3-route53profiles)
...
`mypy-boto3-route53profiles` dependency in production. However, there is an
