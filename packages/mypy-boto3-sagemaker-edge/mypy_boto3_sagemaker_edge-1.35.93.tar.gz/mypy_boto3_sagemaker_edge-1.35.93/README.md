...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-sagemaker-edge)](https://pypistats.org/packages/mypy-boto3-sagemaker-edge)
...
`mypy-boto3-sagemaker-edge` dependency in production. However, there is an
