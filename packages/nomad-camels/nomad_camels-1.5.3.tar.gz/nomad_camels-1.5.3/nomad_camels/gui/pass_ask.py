...
class Ui_Pass_Ask(object):
    ...
    def retranslateUi(self, Pass_Ask):
        ...
        """
        Pass_Ask.setWindowTitle(QCoreApplication.translate("Pass_Ask", "Dialog", None))
        self.label_2.setText(QCoreApplication.translate("Pass_Ask", "Password:", None))
        self.label.setText(
            QCoreApplication.translate(
                "Pass_Ask", 'Enter sudo-password for the Ubuntu-user "epics":', None
            )
        )
