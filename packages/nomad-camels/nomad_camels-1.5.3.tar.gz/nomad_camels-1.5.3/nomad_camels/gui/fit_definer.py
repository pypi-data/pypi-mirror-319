...
class Ui_Fit_Definer(object):
    def setupUi(self, Fit_Definer):
        ...
        self.checkBox_display_values.setObjectName("checkBox_display_values")
    ...
    def retranslateUi(self, Fit_Definer):
        Fit_Definer.setWindowTitle(
            QCoreApplication.translate("Fit_Definer", "Form", None)
        )
        self.radioButton_custom_func.setText(
            QCoreApplication.translate("Fit_Definer", "Custom function", None)
        )
        self.radioButton_predef_func.setText(
            QCoreApplication.translate("Fit_Definer", "Predefined function", None)
        )
        self.label.setText(
            QCoreApplication.translate("Fit_Definer", "Fit to: all y-axes", None)
        )
        self.checkBox_fit.setText(
            QCoreApplication.translate("Fit_Definer", "fit?", None)
        )
        self.checkBox_guess.setText(
            QCoreApplication.translate("Fit_Definer", "guess initial parameters", None)
        )
        self.checkBox_display_values.setText(
            QCoreApplication.translate("Fit_Definer", "display fit values", None)
        )
