...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.label.setText(QCoreApplication.translate("Form", "x", None))
        self.pushButton_zDown.setText(QCoreApplication.translate("Form", "z", None))
        self.pushButton_zUp.setText(QCoreApplication.translate("Form", "z", None))
        self.pushButton_go_to.setText(QCoreApplication.translate("Form", "Go To", None))
        self.label_2.setText(QCoreApplication.translate("Form", "y", None))
        self.label_3.setText(QCoreApplication.translate("Form", "z", None))
        self.label_6.setText(QCoreApplication.translate("Form", "current pos.", None))
        self.label_4.setText(QCoreApplication.translate("Form", "Step Size", None))
        self.checkBox_manualActive.setText(
            QCoreApplication.translate("Form", "active", None)
        )
        self.label_5.setText(
            QCoreApplication.translate("Form", "Manual Movement Speeds", None)
        )
        self.checkBox_refY.setText(QCoreApplication.translate("Form", "y", None))
        self.checkBox_refZ.setText(QCoreApplication.translate("Form", "z", None))
        self.checkBox_refX.setText(QCoreApplication.translate("Form", "x", None))
        self.pushButton_ref.setText(
            QCoreApplication.translate("Form", "Find Reference", None)
        )
        self.pushButton_position.setText("")
        self.label_7.setText(
            QCoreApplication.translate("Form", "Time between readings (s)", None)
        )
