...
class Ui_for_loop_config(object):
    def setupUi(self, for_loop_config):
        ...
        self.radioButton_n_points = QRadioButton(self.sweep_widget)
        self.radioButton_n_points.setObjectName(u"radioButton_n_points")

        self.gridLayout_2.addWidget(self.radioButton_n_points, 7, 0, 1, 1)

        self.radioButton_point_distance = QRadioButton(self.sweep_widget)
        self.radioButton_point_distance.setObjectName(u"radioButton_point_distance")
        self.radioButton_point_distance.setChecked(True)

        self.gridLayout_2.addWidget(self.radioButton_point_distance, 7, 1, 1, 1)
    ...
    def retranslateUi(self, for_loop_config):
        ...
        self.radioButton_n_points.setText(QCoreApplication.translate("for_loop_config", u"# points", None))
        self.radioButton_point_distance.setText(QCoreApplication.translate("for_loop_config", u"point distance", None))
    # retranslateUi
