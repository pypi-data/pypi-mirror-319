...
class Ui_read_channels_config(object):
    def setupUi(self, read_channels_config):
        ...
        self.checkBox_read_variables.setObjectName("checkBox_read_variables")
    ...
    def retranslateUi(self, read_channels_config):
        read_channels_config.setWindowTitle(
            QCoreApplication.translate("read_channels_config", "Form", None)
        )
        self.checkBox_read_all.setText(
            QCoreApplication.translate("read_channels_config", "Read All", None)
        )
        self.checkBox_split_trigger.setText(
            QCoreApplication.translate(
                "read_channels_config", "Split trigger and read", None
            )
        )
        self.checkBox_read_variables.setText(
            QCoreApplication.translate(
                "read_channels_config", "read/save variables", None
            )
        )
