...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in secretflowapis/v1/sdc/authmanager/auth_manager_pb2_grpc.py depends on'
...
def add_AuthManagerServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('secretflowapis.v1.sdc.authmanager.AuthManager', rpc_method_handlers)
