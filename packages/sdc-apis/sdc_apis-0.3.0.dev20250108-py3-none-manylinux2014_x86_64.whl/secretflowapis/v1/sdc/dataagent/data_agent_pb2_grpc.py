...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in secretflowapis/v1/sdc/dataagent/data_agent_pb2_grpc.py depends on'
...
def add_DataAgentServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('secretflowapis.v1.sdc.dataagent.DataAgent', rpc_method_handlers)
