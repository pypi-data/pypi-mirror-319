...
class PSListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by PSParser#set_element.
    def enterSet_element(self, ctx:PSParser.Set_elementContext):
        pass

    # Exit a parse tree produced by PSParser#set_element.
    def exitSet_element(self, ctx:PSParser.Set_elementContext):
        pass
