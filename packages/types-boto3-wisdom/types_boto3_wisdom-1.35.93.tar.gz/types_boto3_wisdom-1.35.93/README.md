<a id="types-boto3-wisdom"></a>

# types-boto3-wisdom

[![PyPI - types-boto3-wisdom](https://img.shields.io/pypi/v/types-boto3-wisdom.svg?color=blue)](https://pypi.org/project/types-boto3-wisdom/)
[![PyPI - Python Version](https://img.shields.io/pypi/pyversions/types-boto3-wisdom.svg?color=blue)](https://pypi.org/project/types-boto3-wisdom/)
[![Docs](https://img.shields.io/readthedocs/boto3-stubs.svg?color=blue)](https://youtype.github.io/types_boto3_docs/)
[![PyPI - Downloads](https://static.pepy.tech/badge/types-boto3-wisdom)](https://pypistats.org/packages/types-boto3-wisdom)

![boto3.typed](https://github.com/youtype/mypy_boto3_builder/raw/main/logo.png)

Type annotations for
[boto3 ConnectWisdomService 1.35.93](https://pypi.org/project/boto3/)
...
[types-boto3-wisdom docs](https://youtype.github.io/types_boto3_docs/types_boto3_wisdom/).

See how it helps you find and fix potential bugs:

![types-boto3 demo](https://github.com/youtype/mypy_boto3_builder/raw/main/demo.gif)

- [types-boto3-wisdom](#types-boto3-wisdom)
...
- Install `types-boto3[wisdom]` in your environment:
...
- Install `types-boto3[wisdom]` with services you use in your environment:
...
`types-boto3-wisdom` dependency in production. However, there is an issue in
...
from types_boto3_wisdom import ConnectWisdomServiceClient
...
`types_boto3_wisdom.paginator` module contains type annotations for all
paginators.
...
`types_boto3_wisdom.literals` module contains literals extracted from shapes
that can be used in user code for type checking.

Full list of `ConnectWisdomService` Literals can be found in
[docs](https://youtype.github.io/types_boto3_docs/types_boto3_wisdom/literals/).
...
`types_boto3_wisdom.type_defs` module contains structures and shapes assembled
to typed dictionaries and unions for additional type checking.

Full list of `ConnectWisdomService` TypeDefs can be found in
[docs](https://youtype.github.io/types_boto3_docs/types_boto3_wisdom/type_defs/).
...
`types-boto3-wisdom` version is the same as related `boto3` version and follows
...
[boto3 docs](https://youtype.github.io/types_boto3_docs/types_boto3_wisdom/)
