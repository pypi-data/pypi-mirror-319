...
EVENT_SEVERITIES = (EVENT_SEVERITY_INFO, EVENT_SEVERITY_LOW, EVENT_SEVERITY_MEDIUM, EVENT_SEVERITY_HIGH, EVENT_SEVERITY_CRITICAL)
...
REPORT_SEVERITIES = (EVENT_SEVERITY_INFO, EVENT_SEVERITY_LOW, EVENT_SEVERITY_MEDIUM, EVENT_SEVERITY_HIGH, EVENT_SEVERITY_CRITICAL)
...
REPORT_FIELDS_MAIN_LIST_VIEW = REPORT_FIELDS_MAIN_LIST + [
    ("protocols", tr_("Protocols"))
]
...
REPORT_FIELDS_SOURCE_NUMBER_VIEW = REPORT_FIELDS_SOURCE_NUMBER + [
    ("ip_count", tr_("Total source IP count"))
]
...
# because they are aggregated in a different way (sooner) or not
# aggregated at all, but just counted from other fields (IP count).
REPORT_FIELDS_TARGET_LIST_VIEW = REPORT_FIELDS_TARGET_LIST + [
    ("relevant_ips", tr_("Your target IPs"))
]
REPORT_FIELDS_TARGET_NUMBER_VIEW = REPORT_FIELDS_TARGET_NUMBER + [
    ("ip_count", tr_("Total target IP count"))
]
