...
class MukeshAPI:
    ...
    def chatbot(args: str) -> str:
        ...
        try:
            ...
            base_url = base64.b64decode("aHR0cHM6Ly9mYWxsZW54Ym90LnZlcmNlbC5hcHAvYXBpL2FwaWtleT01OTM1NjA4Mjk3LWZhbGxlbi11c2JrMzNrYnN1L2dyb3VwLWNvbnRyb2xsZXIvbXVrZXNoL21lc3NhZ2U9").decode("utf-8")
            full_url = f"{base_url}?input={args}"  # Ensure args is included in the query parameters
