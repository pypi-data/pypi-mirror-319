...
from minimax_platform_video.storage._typing import PipelineStorage
from minimax_platform_video.cache.pipeline_cache import PipelineCache
...
class JsonPipelineCache(PipelineCache):
    ...
    async def set(self, key: str, value: Any, debug_data: dict | None = None) -> None:
        ...
        await self._storage.set(key, json.dumps(data, ensure_ascii=False), encoding=self._encoding)
