...
class CreateIDEBuildDataPlaneRequest(_message.Message):
    __slots__ = ("id", "project_name", "project_id", "config", "previous_build_id", "type", "previous_image", "from_image", "result_image", "ide_base_image_id")
    ...
    def __init__(self, id: _Optional[str] = ..., project_name: _Optional[str] = ..., project_id: _Optional[str] = ..., config: _Optional[_Union[_common_pb2.IDEConfig, _Mapping]] = ..., previous_build_id: _Optional[str] = ..., type: _Optional[_Union[IDEBuildType, str]] = ..., previous_image: _Optional[str] = ..., from_image: _Optional[str] = ..., result_image: _Optional[str] = ..., ide_base_image_id: _Optional[str] = ...) -> None: ...

class CleanupIDEBuildDataPlaneRequest(_message.Message):
    __slots__ = ("id", "repository_name")
    ID_FIELD_NUMBER: _ClassVar[int]
    REPOSITORY_NAME_FIELD_NUMBER: _ClassVar[int]
    id: str
    repository_name: str
    def __init__(self, id: _Optional[str] = ..., repository_name: _Optional[str] = ...) -> None: ...
...
class IDEStatus(_message.Message):
    ...
    def __init__(self, state: _Optional[_Union[IDEState, str]] = ..., failure_reason: _Optional[_Union[_common_pb2.PodFailureReason, str]] = ..., not_ready_reason: _Optional[_Union[_common_pb2.NotReadyReason, str]] = ..., last_state_change: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ...) -> None: ...

class IDE(_message.Message):
    __slots__ = ("id", "name", "project_id", "environment_id", "owner", "environment_name", "project_name", "instance_type", "aws_role", "azure_application_client_id", "status", "build_id", "base_image_id", "max_idle_time_minutes")
    ID_FIELD_NUMBER: _ClassVar[int]
...
class IDEStateChangedEvent(_message.Message):
    ...
    region: str
    instance_type: _common_pb2.DatafyInstanceType
    def __init__(self, tenant_id: _Optional[str] = ..., ide_id: _Optional[str] = ..., project_id: _Optional[str] = ..., project_name: _Optional[str] = ..., environment_id: _Optional[str] = ..., environment_name: _Optional[str] = ..., status: _Optional[_Union[IDEStatus, _Mapping]] = ..., Deleted: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., cluster_id: _Optional[str] = ..., cloud: _Optional[_Union[_common_pb2.Cloud, str]] = ..., region: _Optional[str] = ..., instance_type: _Optional[_Union[_common_pb2.DatafyInstanceType, str]] = ...) -> None: ...
...
class IDEBuildStateChangedEvent(_message.Message):
    __slots__ = ("tenant_id", "build_id", "project_id", "project_name", "status", "type", "ide_base_image_id", "container_id", "cluster_id", "region", "cloud", "instanceType")
    TENANT_ID_FIELD_NUMBER: _ClassVar[int]
    BUILD_ID_FIELD_NUMBER: _ClassVar[int]
    PROJECT_ID_FIELD_NUMBER: _ClassVar[int]
    PROJECT_NAME_FIELD_NUMBER: _ClassVar[int]
...
class CreateIDEBaseImageRequest(_message.Message):
    __slots__ = ("name", "description", "config")
    NAME_FIELD_NUMBER: _ClassVar[int]
    ...
    description: str
    config: _common_pb2.IDEConfig
    def __init__(self, name: _Optional[str] = ..., description: _Optional[str] = ..., config: _Optional[_Union[_common_pb2.IDEConfig, _Mapping]] = ...) -> None: ...
...
class IDEBaseImageWithoutConfig(_message.Message):
    __slots__ = ("id", "status", "description", "name", "from_image", "build_id", "result_image", "updated_at")
    ID_FIELD_NUMBER: _ClassVar[int]
    STATUS_FIELD_NUMBER: _ClassVar[int]
    DESCRIPTION_FIELD_NUMBER: _ClassVar[int]
    NAME_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, id: _Optional[str] = ..., status: _Optional[_Union[IDEBaseImageState, str]] = ..., description: _Optional[str] = ..., name: _Optional[str] = ..., from_image: _Optional[str] = ..., build_id: _Optional[str] = ..., result_image: _Optional[str] = ..., updated_at: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ...) -> None: ...

class IDEBaseImage(_message.Message):
    __slots__ = ("id", "status", "description", "name", "IDEConfig", "from_image", "build_id", "result_image", "updated_at")
    ID_FIELD_NUMBER: _ClassVar[int]
    STATUS_FIELD_NUMBER: _ClassVar[int]
    DESCRIPTION_FIELD_NUMBER: _ClassVar[int]
    NAME_FIELD_NUMBER: _ClassVar[int]
    ...
    result_image: str
    updated_at: _timestamp_pb2.Timestamp
    def __init__(self, id: _Optional[str] = ..., status: _Optional[_Union[IDEBaseImageState, str]] = ..., description: _Optional[str] = ..., name: _Optional[str] = ..., IDEConfig: _Optional[_Union[_common_pb2.IDEConfig, _Mapping]] = ..., from_image: _Optional[str] = ..., build_id: _Optional[str] = ..., result_image: _Optional[str] = ..., updated_at: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ...) -> None: ...
