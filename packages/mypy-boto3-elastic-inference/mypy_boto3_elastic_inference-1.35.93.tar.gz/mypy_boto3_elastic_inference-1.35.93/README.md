...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-elastic-inference)](https://pypistats.org/packages/mypy-boto3-elastic-inference)
...
`mypy-boto3-elastic-inference` dependency in production. However, there is an
