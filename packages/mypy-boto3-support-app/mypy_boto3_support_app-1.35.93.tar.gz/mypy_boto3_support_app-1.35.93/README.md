...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-support-app)](https://pypistats.org/packages/mypy-boto3-support-app)
...
`mypy-boto3-support-app` dependency in production. However, there is an issue
