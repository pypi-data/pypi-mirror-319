...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-sms-voice)](https://pypistats.org/packages/mypy-boto3-sms-voice)
...
`mypy-boto3-sms-voice` dependency in production. However, there is an issue in
