...
class DigitalFilterBox(Moku, StreamInstrument):
    """
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.id = 6
        self.operation_group = "digitalfilterbox"
    ...
    def set_frontend(self, channel, coupling, impedance, attenuation, strict=True):
        """
        set_frontend.
