...
class PIDController(Moku, StreamInstrument):
    """
    ...
    def set_frontend(
        self, channel, impedance, coupling, range=None, attenuation=None, strict=True
    ):
        """
        set_frontend.
        ...
        :type attenuation: `string` [0dB, 14dB, 20dB, 40dB] # noqa
