...
class TimeFrequencyAnalyzer(Moku):
    """
    ...
    def set_frontend(self, channel, impedance, coupling, range, strict=True):
        ...
        :type range: `string` ['400mVpp', '1Vpp', '4Vpp', '10Vpp', '40Vpp', '50Vpp'] # noqa
    ...
    def set_event_detector(self, id, source, threshold=0, edge="Rising", strict=True):
        """
        set_event_detector
        :type id: `integer`
