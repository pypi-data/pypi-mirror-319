...
def test_error_long(fake_accident_id, caplogs, httpbin):
    ...
    assert api_exc.detail == {"accident_id": "20241212:01:79200.00", "error_code": "ok", "error_message": "It's ok."}
...
csu.exceptions.APIServiceError: {{'accident_id': '20241212:01:79200.00', 'error_message': "It's ok.", 'error_code': 'ok'}}
------------------------------------------------------------ response exception ------------------------------------------------------------
  {{'accident_id': '20241212:01:79200.00', 'error_message': "It's ok.", 'error_code': 'ok'}}
============================================================================================================================================"""
    )
...
------------------------------------------------------------ response exception ------------------------------------------------------------
  {{'error_message': 'Internal server error', 'error_code': 'server', 'accident_id': '20241212:01:79200.00'}}
============================================================================================================================================"""
    )
