...
Traceback (most recent call last):
  File "{__file__}", line 72, in error_long_wrap_2
    return error_long_wrap_3()"""
        + (
            """
           ^^^^^^^^^^^^^^^^^^^"""
        ...
        + f"""
  File "{__file__}", line 70, in error_long_wrap_3
    return error_long_wrap_4()"""
        + (
            """
           ^^^^^^^^^^^^^^^^^^^"""
        ...
        + f"""
  File "{__file__}", line 68, in error_long_wrap_4
    return error_long_wrap_5()"""
        + (
            """
           ^^^^^^^^^^^^^^^^^^^"""
        ...
        + f"""
  File "{__file__}", line 66, in error_long_wrap_5
    return error_long_wrap_6()"""
        + (
            """
           ^^^^^^^^^^^^^^^^^^^"""
        ...
        + f"""
  File "{__file__}", line 64, in error_long_wrap_6
    raise OkError(details=[1], event_id=ctx.event_id)
...
---------------------------------------------------------------- traceback -----------------------------------------------------------------
Traceback (most recent call last):
  File "{__file__}", line 231, in test_decoding
    bingo.json()
  File "{__file__}", line 81, in json
    return ctx.request("GET", "status/418", accept_statuses=[418]).json"""
        + (
            """
           ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^"""
...
Traceback (most recent call last):
  File "{__file__}", line 283, in test_logging
    bingo.error()
  File "{__file__}", line 53, in error
    raise OkError(event_id=ctx.event_id) from exc
...
---------------------------------------------------------------- traceback -----------------------------------------------------------------
Traceback (most recent call last):
  File "{__file__}", line 408, in test_custom_context
    custom.run()
  File "{__file__}", line 391, in run
    resp = ctx.request("""
        + (
            """
           ^^^^^^^^^^^^"""
