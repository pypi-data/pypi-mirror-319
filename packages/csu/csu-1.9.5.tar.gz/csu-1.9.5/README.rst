...
.. |commits-since| image:: https://img.shields.io/github/commits-since/ionelmc/python-csu/v1.9.5.svg
    :alt: Commits since latest release
    :target: https://github.com/ionelmc/python-csu/compare/v1.9.5...main
