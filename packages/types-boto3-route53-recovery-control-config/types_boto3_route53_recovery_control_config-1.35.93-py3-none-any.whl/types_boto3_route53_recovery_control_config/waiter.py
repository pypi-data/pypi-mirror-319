...
class ClusterCreatedWaiter(Waiter):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_route53_recovery_control_config/waiters/#clustercreatedwaiter)
    """
...
class ClusterDeletedWaiter(Waiter):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_route53_recovery_control_config/waiters/#clusterdeletedwaiter)
    """
...
class ControlPanelCreatedWaiter(Waiter):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_route53_recovery_control_config/waiters/#controlpanelcreatedwaiter)
    """
...
class ControlPanelDeletedWaiter(Waiter):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_route53_recovery_control_config/waiters/#controlpaneldeletedwaiter)
    """
...
class RoutingControlCreatedWaiter(Waiter):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_route53_recovery_control_config/waiters/#routingcontrolcreatedwaiter)
    """
...
class RoutingControlDeletedWaiter(Waiter):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_route53_recovery_control_config/waiters/#routingcontroldeletedwaiter)
    """
