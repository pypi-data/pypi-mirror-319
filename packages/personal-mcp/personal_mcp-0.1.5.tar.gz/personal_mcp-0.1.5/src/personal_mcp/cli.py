...
def setup_logging(verbose: bool = False):
    ...
    logging.basicConfig(
        ...
        handlers=[
            RichHandler(
                console=stderr_console, rich_tracebacks=True, show_time=False, show_path=False
            )
        ],
    )
...
@click.option("--db-path", default="personal_tracking.db", help="Database path")
@click.pass_context
def run(ctx: click.Context, name: str, db_path: str):
    """Run the MCP server."""
...
@click.option("--db-path", default="personal_tracking.db", help="Database path")
@click.pass_context
def dev(ctx: click.Context, name: str, db_path: str):
...
@click.option("--db-path", default="personal_tracking.db", help="Database path")
@click.pass_context
def inspect(ctx: click.Context, name: str, db_path: str):
...
@click.option("--name", default="Personal Assistant", help="Server name")
@click.pass_context
def install(ctx: click.Context, claude_desktop: bool, name: str):
    setup_logging(ctx.obj.get("verbose", False))
