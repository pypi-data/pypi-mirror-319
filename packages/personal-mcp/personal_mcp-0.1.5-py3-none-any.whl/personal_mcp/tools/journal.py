...
from ..models import JournalEntry, ListPrompt
...
def register_journal_tools(mcp, db):
    ...
    def list_journal_entries(params: ListPrompt) -> str:
        ...
        with db.get_connection() as conn:
            ...
            df = pd.read_sql_query(query, conn, params=[params.limit, params.offset])
