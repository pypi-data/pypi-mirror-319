...
def get_documents(documents_folder):
    """
    Collect .txt documents from a folder containing documents for analysis.
    ...
    for txt_file in txt_files:
        filename = txt_file
        txt_path = os.path.join(documents_folder, txt_file)
...
def preprocess_documents(documents_folder, save_name, custom_items=[]):
    """
    ...
    param documents_folder: Path to the documents containing the documents for segmentation
    ...
    documents = get_documents(documents_folder)
