...
def analyze_all_sentences(sentences, analysis_type, save_name, context_length=0, filter=None, filter_key=0, filter_cutoff=0, terms_to_check=[], query_count=3, directory = '.'):
