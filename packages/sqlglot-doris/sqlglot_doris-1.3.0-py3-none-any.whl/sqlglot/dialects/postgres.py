...
def _build_timetostr_or_tochar(args: t.List) -> exp.TimeToStr | exp.ToChar | exp.Round:
    ...
    if this and not this.type:
        ...
        if this.is_type(*exp.DataType.TEMPORAL_TYPES):
            return build_formatted_time(exp.TimeToStr, "postgres", default=True)(args)
        ...
        if expr is not None:
            ...
            if expression is not None:
                try:
                    ...
                    return exp.Round(this=this, decimals=exp.Literal.number(strlen))
                except ValueError:
                    return exp.ToChar(
                        this=seq_get(args, 0),
                        format="'" + expression + "'",
    ...
    class Tokenizer(tokens.Tokenizer):
        ...
        KEYWORDS = {
            **tokens.Tokenizer.KEYWORDS,
            ...
            # [+doris]
            "FIXEDDECIMAL": TokenType.FIXEDDECIMAL,
        }
        KEYWORDS.pop("/*+")
        KEYWORDS.pop("DIV")
    ...
    class Parser(parser.Parser):
        ...
        FUNCTIONS = {
            **parser.Parser.FUNCTIONS,
            ...
            "JSON_AGG": exp.JSONArrayAgg.from_arg_list,
            ...
            "REGEXP_MATCHES": exp.RegexpExtractAll.from_arg_list,
        ...
        FUNCTION_PARSERS = {
            **parser.Parser.FUNCTION_PARSERS,
            ...
            "JSON_BUILD_ARRAY": lambda self: self._parse_json_array(
                exp.JSONArray,
