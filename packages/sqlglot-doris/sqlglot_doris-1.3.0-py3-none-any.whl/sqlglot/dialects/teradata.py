    ...
    class Tokenizer(tokens.Tokenizer):
        ...
        KEYWORDS = {
            **tokens.Tokenizer.KEYWORDS,
            ...
            "INTERVAL HOUR": TokenType.INTERVAL_DATETIME,
            "INTERVAL MINUTE": TokenType.INTERVAL_DATETIME,
            "INTERVAL SECOND": TokenType.INTERVAL_DATETIME,
            "INTERVAL DAY": TokenType.INTERVAL_DATETIME,
            "INTERVAL MONTH": TokenType.INTERVAL_DATETIME,
            "INTERVAL YEAR": TokenType.INTERVAL_DATETIME,
        }
        KEYWORDS.pop("/*+")
    ...
    class Parser(parser.Parser):
        ...
        FUNCTIONS = {
            **parser.Parser.FUNCTION_PARSERS,
            "TD_DAY_OF_WEEK": exp.DayOfWeek.from_arg_list,
            "ZEROIFNULL": lambda args: exp.Coalesce(
                this=seq_get(args, 0), expressions=exp.Literal.number(0)
            ),
            ...
            "LEFT": exp.Left.from_arg_list,
            "NVL2": exp.Nvl2.from_arg_list,
            "OREPLACE": exp.OrReplace.from_arg_list,
            "TD_DAY_OF_MONTH": exp.DayOfMonth.from_arg_list,
            "TD_DAY_OF_YEAR": exp.DayOfYear.from_arg_list,
            "TO_DATE": exp.TsOrDsToDate.from_arg_list,
            "TO_TIMESTAMP": exp.TsOrDsToDate.from_arg_list,
