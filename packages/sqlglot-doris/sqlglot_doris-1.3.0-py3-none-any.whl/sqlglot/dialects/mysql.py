...
def date_add_sql(
    ...
    def func(self: MySQL.Generator, expression: exp.Expression) -> str:
        ...
        if isinstance(expression.expression, exp.Interval):
            return f"DATE_{kind}({this}, {expression.expression})"
        return (
    ...
    class Tokenizer(tokens.Tokenizer):
        ...
        KEYWORDS = {
            **tokens.Tokenizer.KEYWORDS,
            ...
            "DOUBLE UNSIGNED": TokenType.DOUBLE,
            "FLOAT UNSIGNED": TokenType.FLOAT,
            "YEAR": TokenType.YEAR,
    ...
    class Parser(parser.Parser):
        ...
        CONSTRAINT_PARSERS = {
            **parser.Parser.CONSTRAINT_PARSERS,
            ...
            "ZEROFILL": lambda self: self.expression(exp.ZeroFillConstraint),
        }
