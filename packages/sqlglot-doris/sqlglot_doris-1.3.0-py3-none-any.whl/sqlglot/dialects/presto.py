...
def build_regexp_extract(args: t.List) -> exp.RegexpExtract:
    this = seq_get(args, 0)
    expression = seq_get(args, 1)
    group = seq_get(args, 2)
    dialects = "presto"
    return exp.RegexpExtract(this=this, expression=expression, group=group, dialects=dialects)
...
class Presto(Dialect):
    ...
    class Parser(parser.Parser):
        ...
        ID_VAR_TOKENS = {*parser.Parser.ID_VAR_TOKENS}
        ID_VAR_TOKENS.remove(TokenType.OFFSET)

        ALIAS_TOKENS = ID_VAR_TOKENS
        # [+doris]
        # parse ctas with properties
        PROPERTY_PARSERS = {
        ...
        FUNCTIONS = {
            **parser.Parser.FUNCTIONS,
            ...
            "CODEPOINT": exp.Codepoint.from_arg_list,
            ...
            # [+doris]
            "DAY_OF_WEEK": build_dayofweek,  # "DAY_OF_WEEK": exp.DayOfWeekIso.from_arg_list,
            "DOW": build_dayofweek,
            ...
            "REPLACE": exp.ReplaceEmpty.from_arg_list,
            ...
            "ZIP": exp.ArrayZip.from_arg_list,
