...
class ZeroFillConstraint(ColumnConstraintKind):
...
class SupplementalLogConstraint(ColumnConstraintKind):
    arg_types = {"this": False, "code": False, "expression": False, "scope": False}
...
class SegmentCreation(Expression):
    arg_types = {"this": True}


class Pctfree(Expression):
    arg_types = {"this": True}


class Pctused(Expression):
    arg_types = {"this": True}


class Initrans(Expression):
    arg_types = {"this": True}


class Maxtrans(Expression):
    arg_types = {"this": True}
...
class Minextents(Expression):
    arg_types = {"this": True}


class Maxextents(Expression):
    arg_types = {"this": True}


class Pctincrease(Expression):
    arg_types = {"this": True}


class Freelists(Expression):
    arg_types = {"this": True}


class FreelistGroups(Expression):
    arg_types = {"this": True}


class BufferPool(Expression):
    arg_types = {"this": True}


class FlashCache(Expression):
    arg_types = {"this": True}


class CellFlashCache(Expression):
    arg_types = {"this": True}


class Tablespace(Expression):
    arg_types = {"this": True}


class EnableRowMovement(Expression):
    arg_types = {"this": False}


class DisableRowMovement(Expression):
    arg_types = {"this": False}


class NoCompress(Expression):
    arg_types = {"this": False}
...
class NoLogging(Expression):
    arg_types = {"this": False}


class Logging(Expression):
    arg_types = {"this": False}
...
class IndexParameters(Expression):
    arg_types = {
        ...
        "tablespace": False,
        "where": False,
        # [fix](teradata) Fix parsing error of WITH LOAD IDENTITY (#60)
        "with_load_identity": False,
        "on": False,
    }
...
class Lag(AggFunc):
    arg_types = {"this": True, "offset": False, "default": False, "dialect": False}
...
class DayOfMonth(Func):
    _sql_names = ["DAY_OF_MONTH", "DAYOFMONTH", "DOM", "TD_DAY_OF_MONTH"]


class DayOfYear(Func):
    _sql_names = ["DAY_OF_YEAR", "DAYOFYEAR", "DOY", "TD_DAY_OF_YEAR"]
...
class Rand(Func):
    ...
    arg_types = {"this": False, "expression": False, "lower": False, "upper": False}
...
class YesterDay(Func):
    arg_types = {"this": False, "expression": False}


class CountEqual(Func):
    arg_types = {"this": True, "expression": False, "start": False, "length": False}
...
class DateCeil(Func):
    arg_types = {"this": True, "expression": True, "pos": False}
    ...
    **opts,
    ...
    if case_sensitive is not None:
        if isinstance(exp.this, Identifier):
            if case_sensitive:
                exp.args.get("this").set("this", exp.args.get("this").this.upper())
            else:
                exp.args.get("this").set("this", exp.args.get("this").this.lower())
