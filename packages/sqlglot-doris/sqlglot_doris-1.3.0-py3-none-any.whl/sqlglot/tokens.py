...
class TokenType(AutoName):
    ...
    FORCE = auto()
    FOREIGN_KEY = auto()
    SUPPLEMENTAL_LOG = auto()
    SEGMENT_CREATION = auto()
    FREELIST_GROUPS = auto()
    ENABLE_ROW_MOVEMENT = auto()
    DISABLE_ROW_MOVEMENT = auto()
    FORMAT = auto()
    FROM = auto()
    FULL = auto()
    FUNCTION = auto()
...
class Tokenizer(metaclass=_Tokenizer):
    ...
    KEYWORDS: t.Dict[str, TokenType] = {
        ...
        **{f"{prefix}}}}}": TokenType.BLOCK_END for prefix in ("+", "-")},
        ...
        "EXPLAIN VERBOSE": TokenType.EXPLAIN,
        "EXPLAIN MEMO PLAN": TokenType.EXPLAIN,
        "EXPLAIN PHYSICAL PLAN": TokenType.EXPLAIN,
        "EXPLAIN SHAPE PLAN": TokenType.EXPLAIN,
        ...
        "MULTI-DIMENSIONAL ARRAY": TokenType.MULTI_DIMENSIONAL_ARRAY,
    }
