...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-snowball)](https://pypistats.org/packages/mypy-boto3-snowball)
...
`mypy-boto3-snowball` dependency in production. However, there is an issue in
