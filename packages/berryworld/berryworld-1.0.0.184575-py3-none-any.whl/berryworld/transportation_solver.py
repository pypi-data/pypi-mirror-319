...
class TransportationAlgorithm:
    ...
    def solve_lp(self, rank_col='RankValue', col_name='Tonnage', max_iter=20000, tolerance=1e-12, display=True,
        ...
        :param minimize: The coefficients of the linear objective function to be minimized.
        ...
        if minimize:
            ...
            c = self.ranking[rank_col].reset_index(drop=True)
        ...
        b = pd.concat([sales, prod]).reset_index(drop=True)
        ...
        if res_success is False:
            ...
            b_eq = pd.concat([sales[1:m], prod[1:n]])
