...
class CreatePromptVersionModelType(str, Enum):
...
class CreatePromptVersionFormat(str, Enum):
...
class CreatePromptVersionQuality(str, Enum):
    r"""Only supported on `image` models."""
...
class CreatePromptVersionResponseFormatPromptsType(str, Enum):
    JSON_OBJECT = "json_object"
...
class CreatePromptVersionResponseFormatType(str, Enum):
...
CreatePromptVersionResponseFormatTypedDict = Union[
...
CreatePromptVersionResponseFormat = Union[
    CreatePromptVersionResponseFormat2, CreatePromptVersionResponseFormat1
]
r"""An object specifying the format that the model must output.
...
class CreatePromptVersionPhotoRealVersion(str, Enum):
...
class CreatePromptVersionEncodingFormat(str, Enum):
...
class CreatePromptVersionProvider(str, Enum):
    COHERE = "cohere"
    OPENAI = "openai"
    ANTHROPIC = "anthropic"
...
class CreatePromptVersionRole(str, Enum):
...
class CreatePromptVersion2PromptsType(str, Enum):
    IMAGE_URL = "image_url"
...
class CreatePromptVersion2Type(str, Enum):
    TEXT = "text"
...
CreatePromptVersionContent2TypedDict = Union[
    CreatePromptVersion21TypedDict, CreatePromptVersion22TypedDict
]
...
CreatePromptVersionContentTypedDict = Union[
    str, List[CreatePromptVersionContent2TypedDict]
]
...
class CreatePromptVersionType(str, Enum):
    FUNCTION = "function"
...
class CreatePromptVersionPromptsModelType(str, Enum):
    r"""The type of the model"""
...
class CreatePromptVersionPromptsFormat(str, Enum):
    r"""Only supported on `image` models."""
...
class CreatePromptVersionPromptsQuality(str, Enum):
    r"""Only supported on `image` models."""
...
class CreatePromptVersionResponseFormatPromptsResponse200Type(str, Enum):
    JSON_OBJECT = "json_object"
...
class CreatePromptVersionResponseFormatPromptsResponseType(str, Enum):
    JSON_SCHEMA = "json_schema"
...
CreatePromptVersionPromptsResponseFormatTypedDict = Union[
...
CreatePromptVersionPromptsResponseFormat = Union[
    CreatePromptVersionResponseFormatPrompts2, CreatePromptVersionResponseFormatPrompts1
]
r"""An object specifying the format that the model must output.
...
class CreatePromptVersionPromptsPhotoRealVersion(str, Enum):
    r"""The version of photoReal to use. Must be v1 or v2. Only available for `leonardoai` provider"""
...
class CreatePromptVersionPromptsEncodingFormat(str, Enum):
    r"""The format to return the embeddings"""
...
class CreatePromptVersionPromptsProvider(str, Enum):
    COHERE = "cohere"
    OPENAI = "openai"
    ANTHROPIC = "anthropic"
    HUGGINGFACE = "huggingface"
...
class CreatePromptVersionPromptsRole(str, Enum):
    r"""The role of the prompt message"""
...
class CreatePromptVersion2PromptsResponse200Type(str, Enum):
    IMAGE_URL = "image_url"
...
class CreatePromptVersion2PromptsResponseType(str, Enum):
    TEXT = "text"
...
CreatePromptVersionContentPrompts2TypedDict = Union[
    CreatePromptVersion2Prompts1TypedDict, CreatePromptVersion2Prompts2TypedDict
]


CreatePromptVersionContentPrompts2 = Union[
    CreatePromptVersion2Prompts1, CreatePromptVersion2Prompts2
]


CreatePromptVersionPromptsContentTypedDict = Union[
    str, List[CreatePromptVersionContentPrompts2TypedDict]
]
r"""The contents of the user message. Either the text content of the message or an array of content parts with a defined type, each can be of type `text` or `image_url` when passing in images. You can pass multiple images by adding multiple `image_url` content parts."""


CreatePromptVersionPromptsContent = Union[str, List[CreatePromptVersionContentPrompts2]]
r"""The contents of the user message. Either the text content of the message or an array of content parts with a defined type, each can be of type `text` or `image_url` when passing in images. You can pass multiple images by adding multiple `image_url` content parts."""


class CreatePromptVersionPromptsType(str, Enum):
    FUNCTION = "function"
