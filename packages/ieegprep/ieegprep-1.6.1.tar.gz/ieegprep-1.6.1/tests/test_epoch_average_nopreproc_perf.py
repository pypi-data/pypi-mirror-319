"""
Unit tests to measure the performances of different epoch & average routines for the BrainVision, EDF and MEF3 formats
...
class TestEpochAverageNoPreProcPerf(unittest.TestCase):
    ...
    def test_epoch_perf(self):
        ...
        tests['by_ch_cond_trial__bv_mult'] = dict()
        tests['by_ch_cond_trial__bv_mult']['test_name']= 'Epoch & average (no preprocessing), Brainvision (multiplexed), _load_data_epoch_averages__by_channel_condition_trial'
        tests['by_ch_cond_trial__bv_mult']['uncached_read_repetitions'] = uncached_read_repetitions
        tests['by_ch_cond_trial__bv_mult']['cached_read_repetitions'] = cached_read_repetitions
        tests['by_ch_cond_trial__bv_mult']['data_path'] = self.bv_data_path
        tests['by_ch_cond_trial__bv_mult']['by_routine'] = 'channel_condition_trial'
        tests['by_ch_cond_trial__bv_mult']['set_bv_orientation'] = 'MULTIPLEXED'
        tests['by_ch_cond_trial__bv_mult']['conditions'] = []
        tests['by_ch_cond_trial__bv_mult']['conditions'].append(False)            # not preloaded
        tests['by_ch_cond_trial__bv_mult']['conditions'].append(True)             # preloaded

        tests['by_ch_cond_trial__bv_vect'] = dict()
        tests['by_ch_cond_trial__bv_vect']['test_name']= 'Epoch & average  (no preprocessing), Brainvision (vectorized), _load_data_epoch_averages__by_channel_condition_trial'
        tests['by_ch_cond_trial__bv_vect']['uncached_read_repetitions'] = uncached_read_repetitions
        tests['by_ch_cond_trial__bv_vect']['cached_read_repetitions'] = cached_read_repetitions
        tests['by_ch_cond_trial__bv_vect']['data_path'] = self.bv_data_path
        tests['by_ch_cond_trial__bv_vect']['by_routine'] = 'channel_condition_trial'
        tests['by_ch_cond_trial__bv_vect']['set_bv_orientation'] = 'VECTORIZED'
        tests['by_ch_cond_trial__bv_vect']['conditions'] = []
        tests['by_ch_cond_trial__bv_vect']['conditions'].append(False)            # not preloaded
        tests['by_ch_cond_trial__bv_vect']['conditions'].append(True)             # preloaded

        tests['by_ch_cond_trial__edf'] = dict()
        tests['by_ch_cond_trial__edf']['test_name']= 'Epoch & average  (no preprocessing), EDF, _load_data_epoch_averages__by_channel_condition_trial'
        tests['by_ch_cond_trial__edf']['uncached_read_repetitions'] = uncached_read_repetitions
        tests['by_ch_cond_trial__edf']['cached_read_repetitions'] = cached_read_repetitions
        tests['by_ch_cond_trial__edf']['data_path'] = self.edf_data_path
        tests['by_ch_cond_trial__edf']['by_routine'] = 'channel_condition_trial'
        tests['by_ch_cond_trial__edf']['set_bv_orientation'] = ''
        tests['by_ch_cond_trial__edf']['conditions'] = []
        tests['by_ch_cond_trial__edf']['conditions'].append(False)            # not preloaded
        tests['by_ch_cond_trial__edf']['conditions'].append(True)             # preloaded

        tests['by_ch_cond_trial__mef'] = dict()
        tests['by_ch_cond_trial__mef']['test_name']= 'Epoch & average  (no preprocessing), MEF3, _load_data_epoch_averages__by_channel_condition_trial'
        tests['by_ch_cond_trial__mef']['uncached_read_repetitions'] = uncached_read_repetitions
        tests['by_ch_cond_trial__mef']['cached_read_repetitions'] = cached_read_repetitions
        tests['by_ch_cond_trial__mef']['data_path'] = self.mef_data_path
        tests['by_ch_cond_trial__mef']['by_routine'] = 'channel_condition_trial'
        tests['by_ch_cond_trial__mef']['set_bv_orientation'] = ''
        tests['by_ch_cond_trial__mef']['conditions'] = []
        tests['by_ch_cond_trial__mef']['conditions'].append(False)            # not preloaded
        tests['by_ch_cond_trial__mef']['conditions'].append(True)             # preloaded

        tests['by_cond_trials__bv_mult'] = dict()
        tests['by_cond_trials__bv_mult']['test_name']= 'Epoch & average  (no preprocessing), Brainvision (multiplexed), _load_data_epoch_averages__by_condition_trials'
        tests['by_cond_trials__bv_mult']['uncached_read_repetitions'] = uncached_read_repetitions
        tests['by_cond_trials__bv_mult']['cached_read_repetitions'] = cached_read_repetitions
        tests['by_cond_trials__bv_mult']['data_path'] = self.bv_data_path
        tests['by_cond_trials__bv_mult']['by_routine'] = 'condition_trials'
        tests['by_cond_trials__bv_mult']['set_bv_orientation'] = 'MULTIPLEXED'
        tests['by_cond_trials__bv_mult']['conditions'] = []
        tests['by_cond_trials__bv_mult']['conditions'].append(False)            # not preloaded
        tests['by_cond_trials__bv_mult']['conditions'].append(True)             # preloaded

        tests['by_cond_trials__bv_vect'] = dict()
        tests['by_cond_trials__bv_vect']['test_name']= 'Epoch & average  (no preprocessing), Brainvision (vectorized), _load_data_epoch_averages__by_condition_trials'
        tests['by_cond_trials__bv_vect']['uncached_read_repetitions'] = uncached_read_repetitions
        tests['by_cond_trials__bv_vect']['cached_read_repetitions'] = cached_read_repetitions
        tests['by_cond_trials__bv_vect']['data_path'] = self.bv_data_path
        tests['by_cond_trials__bv_vect']['by_routine'] = 'condition_trials'
        tests['by_cond_trials__bv_vect']['set_bv_orientation'] = 'VECTORIZED'
        tests['by_cond_trials__bv_vect']['conditions'] = []
        tests['by_cond_trials__bv_vect']['conditions'].append(False)            # not preloaded
        tests['by_cond_trials__bv_vect']['conditions'].append(True)             # preloaded

        tests['by_cond_trials__edf'] = dict()
        tests['by_cond_trials__edf']['test_name']= 'Epoch & average  (no preprocessing), EDF, _load_data_epoch_averages__by_condition_trials'
        tests['by_cond_trials__edf']['uncached_read_repetitions'] = uncached_read_repetitions
        tests['by_cond_trials__edf']['cached_read_repetitions'] = cached_read_repetitions
        tests['by_cond_trials__edf']['data_path'] = self.edf_data_path
        tests['by_cond_trials__edf']['by_routine'] = 'condition_trials'
        tests['by_cond_trials__edf']['set_bv_orientation'] = ''
        tests['by_cond_trials__edf']['conditions'] = []
        tests['by_cond_trials__edf']['conditions'].append(False)            # not preloaded
        tests['by_cond_trials__edf']['conditions'].append(True)             # preloaded

        tests['by_cond_trials__mef'] = dict()
        tests['by_cond_trials__mef']['test_name']= 'Epoch & average  (no preprocessing), MEF3, _load_data_epoch_averages__by_condition_trials'
        tests['by_cond_trials__mef']['uncached_read_repetitions'] = uncached_read_repetitions
        tests['by_cond_trials__mef']['cached_read_repetitions'] = cached_read_repetitions
        tests['by_cond_trials__mef']['data_path'] = self.mef_data_path
        tests['by_cond_trials__mef']['by_routine'] = 'condition_trials'
        tests['by_cond_trials__mef']['set_bv_orientation'] = ''
        tests['by_cond_trials__mef']['conditions'] = []
        tests['by_cond_trials__mef']['conditions'].append(False)            # not preloaded
        tests['by_cond_trials__mef']['conditions'].append(True)             # preloaded
        
        tests['by_prep_mem__bv_mult'] = dict()
        tests['by_prep_mem__bv_mult']['test_name']= 'Epoch & average  (no preprocessing), Brainvision (multiplexed), _load_data_epochs__by_channels__withPrep (mem)'
        ...
        tests['by_prep_mem__bv_vect']['test_name']= 'Epoch & average  (no preprocessing), Brainvision (vectorized), _load_data_epochs__by_channels__withPrep (mem)'
        ...
        tests['by_prep_mem__edf']['test_name']= 'Epoch & average  (no preprocessing), EDF, _load_data_epochs__by_channels__withPrep (mem)'
        ...
        tests['by_prep_mem__mef']['test_name']= 'Epoch & average  (no preprocessing), MEF3, _load_data_epochs__by_channels__withPrep (mem)'
        ...
        tests['by_prep_speed__bv_mult']['test_name']= 'Epoch & average  (no preprocessing), Brainvision (multiplexed), _load_data_epochs__by_channels__withPrep (speed)'
        ...
        tests['by_prep_speed__bv_vect']['test_name']= 'Epoch & average  (no preprocessing), Brainvision (vectorized), _load_data_epochs__by_channels__withPrep (speed)'
        ...
        tests['by_prep_speed__edf']['test_name']= 'Epoch & average  (no preprocessing), EDF, _load_data_epochs__by_channels__withPrep (speed)'
        ...
        tests['by_prep_speed__mef']['test_name']= 'Epoch & average  (no preprocessing), MEF3, _load_data_epochs__by_channels__withPrep (speed)'
        ...
        for test_name, test in tests.items():
            ...
            for preload_condition in test['conditions']:
                ...
                if test['uncached_read_repetitions'] > 0:
                    ...
                    mean, std, ret_range, times = time_func(self._time_prepare_input, clear_virtual_cache, test['uncached_read_repetitions'],
                    ...
                    tests[test_name]['cond_prep_results_uncached'].append(np.asarray([mean, std, ret_range, times], dtype=object))
                    ...
                    # Note: adding 'clear_virtual_cache' as pre_func will clear the virtual cache (page memory)
                    #       before reading (but will not be taken into account in the performance measurement)
                    print('          - load_data_epoch_averages (with cache-clearing)')
                    if tests[test_name]['by_routine'] == 'channel_condition_trial':
                        mean, std, ret_range, times = time_func(_load_data_epoch_averages__by_channel_condition_trial, clear_virtual_cache, test['uncached_read_repetitions'],
                                                            data_reader, data_reader.channel_names, conditions_onsets,
                    ...
                    elif tests[test_name]['by_routine'] == 'condition_trials':
                        mean, std, ret_range, times = time_func(_load_data_epoch_averages__by_condition_trials, clear_virtual_cache, test['uncached_read_repetitions'],
                                                            data_reader, data_reader.channel_names, conditions_onsets,
                                                            trial_epoch=self.test_trial_epoch,
                                                            baseline_method=baseline_method, baseline_epoch=self.test_baseline_epoch,
                                                            out_of_bound_method=out_of_bound_method, metric_callbacks=None)
                        ...
                        mean, std, ret_range, times = time_func(_load_data_epochs__by_channels__withPrep, clear_virtual_cache, test['uncached_read_repetitions'],
                                                               True, data_reader, data_reader.channel_names, conditions_onsets,
                                                               trial_epoch=self.test_trial_epoch,
                                                               baseline_method=baseline_method, baseline_epoch=self.test_baseline_epoch,
                                                               out_of_bound_method=out_of_bound_method, metric_callbacks=None,
                    ...
                    print('              Mean: ' + str(round(mean, 2)) + ' - std: ' + str(round(std, 2)) + ' - range: ' + str(round(ret_range[0], 2)) + '-' + str(round(ret_range[1], 2)))
                    tests[test_name]['cond_epoch_results_uncached'].append(np.asarray([mean, std, ret_range, times], dtype=object))
                ...
                if test['cached_read_repetitions'] > 0:
                    ...
                    mean, std, ret_range, times = time_func(self._time_prepare_input, None, test['cached_read_repetitions'],
                                                        tests[test_name]['data_path'], preload_condition)
                    print('              Mean: ' + str(round(mean, 2)) + ' - std: ' + str(round(std, 2)) + ' - range: ' + str(round(ret_range[0], 2)) + '-' + str(round(ret_range[1], 2)))
                    tests[test_name]['cond_prep_results_cached'].append(np.asarray([mean, std, ret_range, times], dtype=object))
                    ...
                    if tests[test_name]['by_routine'] == 'channel_condition_trial':
                        ...
                        _load_data_epoch_averages__by_channel_condition_trial(data_reader, data_reader.channel_names, conditions_onsets,
                                                       trial_epoch=self.test_trial_epoch,
                                                       baseline_method=baseline_method, baseline_epoch=self.test_baseline_epoch,
                                                       out_of_bound_method=out_of_bound_method, metric_callbacks=None)

                    elif tests[test_name]['by_routine'] == 'condition_trials':
                        _load_data_epoch_averages__by_condition_trials(data_reader, data_reader.channel_names, conditions_onsets,
                                                     trial_epoch=self.test_trial_epoch,
                                                     baseline_method=baseline_method, baseline_epoch=self.test_baseline_epoch,
                                                     out_of_bound_method=out_of_bound_method, metric_callbacks=None)

                    elif tests[test_name]['by_routine'] in ('prep_mem', 'prep_speed'):
                        _load_data_epochs__by_channels__withPrep(True, data_reader, data_reader.channel_names, conditions_onsets,
                                                                  trial_epoch=self.test_trial_epoch,
                                                                  baseline_method=baseline_method, baseline_epoch=self.test_baseline_epoch,
                                                                  out_of_bound_method=out_of_bound_method, metric_callbacks=None,
                                                                  high_pass=False, early_reref=None, line_noise_removal=None, late_reref=None,
                    ...
                    # test cached
                    print('          - load_data_epoch_averages (cached)')
                    if tests[test_name]['by_routine'] == 'channel_condition_trial':
                        mean, std, ret_range, times = time_func(_load_data_epoch_averages__by_channel_condition_trial, None, test['cached_read_repetitions'],
                                                                data_reader, data_reader.channel_names, conditions_onsets,
                                                                trial_epoch=self.test_trial_epoch,
                                                                baseline_method=baseline_method, baseline_epoch=self.test_baseline_epoch,
                                                                out_of_bound_method=out_of_bound_method, metric_callbacks=None)
                        ...
                        mean, std, ret_range, times = time_func(_load_data_epoch_averages__by_condition_trials, None, test['cached_read_repetitions'],
                                                                data_reader, data_reader.channel_names, conditions_onsets,
                                                                trial_epoch=self.test_trial_epoch,
                                                                baseline_method=baseline_method, baseline_epoch=self.test_baseline_epoch,
                                                                out_of_bound_method=out_of_bound_method, metric_callbacks=None)
                    ...
                    print('              Mean: ' + str(round(mean, 2)) + ' - std: ' + str(round(std, 2)) + ' - range: ' + str(round(ret_range[0], 2)) + '-' + str(round(ret_range[1], 2)))
                    tests[test_name]['cond_epoch_results_cached'].append(np.asarray([mean, std, ret_range, times], dtype=object))
