...
_DEFAULTS = {
    ...
    "DUCKDB_ENABLE_OPTIMIZED_FULL_AGG": (lambda: "false"),
...
# Enables RealtimeFeatureViews to be defined without a Transformation
# See Calculations Feature RFC for more info:
# https://www.notion.so/tecton/RFC-Calculation-Features-099a63daf5994482b9c1d252e49acfe3
ALLOW_REALTIME_FEATURE_VIEW_NO_TRANSFORMATION_FF = FeatureFlag(
    key="ALLOW_REALTIME_FEATURE_VIEW_NO_TRANSFORMATION", owner="Feature Eng", default_enabled=False
)
