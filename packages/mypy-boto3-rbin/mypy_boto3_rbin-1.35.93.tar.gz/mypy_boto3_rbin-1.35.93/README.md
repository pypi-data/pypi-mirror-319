...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-rbin)](https://pypistats.org/packages/mypy-boto3-rbin)

![boto3.typed](https://github.com/youtype/mypy_boto3_builder/raw/main/logo.png)

Type annotations for
[boto3 RecycleBin 1.35.93](https://pypi.org/project/boto3/) compatible with
...
`mypy-boto3-rbin` dependency in production. However, there is an issue in
