...
def export_docx_from_folder(input_directory:str, output_file:str, labels[List[str]] = None) -> None:
    ...
    """
    Process interview transcripts from .docx files into structured Excel format.
    
    Parameters
    ----------
    input_directory : str
        Directory containing .docx transcript files. Files should follow format:
        Interviewer: [question]
        Interviewee: [answer]
        
    output_file : str
        Path where output Excel file will be saved
    ...
    Examples
    --------
    >>> export_docx_from_folder("raw_transcripts/", "processed_data.xlsx")
