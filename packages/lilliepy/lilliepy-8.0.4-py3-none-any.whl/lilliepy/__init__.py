...
if 'DocumentTitle' in globals():
    del globals()['DocumentTitle']

__all__ = [name for name in globals() if name != 'DocumentTitle']
...
__all__.extend(['FileRouter', '_server', 'Meta', 'Title', 'Favicon', 'use_CSS', 'use_JS', 'use_PY', 'use_Image', 'use_Video', 'use_File', 'static', 'use_query', 'Fetcher', 'FSMContainer', 'StateContainer', 'use_store', 'Importer', '_import', 'init_server', 'on', 'emit', 'publish', 'subscribe', 'join_room', 'leave_room'])
