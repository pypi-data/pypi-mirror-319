"""
Setup script for types-boto3-securitylake.
...
setup(
    ...
    version="1.35.93",
    packages=["types_boto3_securitylake"],
    url="https://github.com/youtype/mypy_boto3_builder",
    license="MIT License",
    author="Vlad Emelianov",
    author_email="vlad.emelianov.nz@gmail.com",
    description="Type annotations for boto3 SecurityLake 1.35.93 service generated with mypy-boto3-builder 8.8.0",
    classifiers=[
    ...
    package_data={"types_boto3_securitylake": ["py.typed", "*.pyi"]},
    python_requires=">=3.8",
    project_urls={
