...
from modelly_client import media_data, utils
from modelly_client.data_classes import FileData
...
class ImgSerializable(Serializable):
    ...
    def example_inputs(self) -> dict[str, Any]:
        return {
            ...
            "serialized": "https://raw.githubusercontent.com/khulnasoft/modelly/main/test/test_files/bus.png",
        }
...
class FileSerializable(Serializable):
    ...
    def _single_file_example_inputs(self) -> dict[str, Any]:
        return {
            ...
            "serialized": "https://github.com/khulnasoft/modelly/raw/main/test/test_files/sample_file.pdf",
        }
...
class VideoSerializable(FileSerializable):
    ...
    def example_inputs(self) -> dict[str, Any]:
        return {
            ...
            "serialized": "https://github.com/khulnasoft/modelly/raw/main/test/test_files/video_sample.mp4",
        }
