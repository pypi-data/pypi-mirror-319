"""Contains methods that generate documentation for Modelly functions and classes."""
...
_module_prefixes = [
    ("modelly._simple_templates", "component"),
    ("modelly.block", "block"),
    ("modelly.chat", "chatinterface"),
    ("modelly.component", "component"),
    ("modelly.events", "helpers"),
    ("modelly.data_classes", "helpers"),
    ("modelly.exceptions", "helpers"),
    ("modelly.external", "helpers"),
    ("modelly.flag", "flagging"),
    ("modelly.helpers", "helpers"),
    ("modelly.interface", "interface"),
    ("modelly.layout", "layout"),
    ("modelly.route", "routes"),
    ("modelly.theme", "themes"),
    ("modelly_client.", "py-client"),
    ("modelly.utils", "helpers"),
    ("modelly.renderable", "renderable"),
]
...
def document(*fns, inherit=False, documentation_group=None):
    """
    Defines the @document decorator which adds classes or functions to the Modelly
    documentation at www.modelly.khulnasoft.com/docs.
    ...
    def inner_doc(cls):
        ...
        if _documentation_group is None:
            try:
                ...
                if modname.startswith("modelly.") or modname.startswith(
                    "modelly_client."
                ):
                    documentation_group = _get_module_documentation_group(modname)
                else:
                    # Then this is likely a custom Modelly component that we do not include in the documentation
                    pass
