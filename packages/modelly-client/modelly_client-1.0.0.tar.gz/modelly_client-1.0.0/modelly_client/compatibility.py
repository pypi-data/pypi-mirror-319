"""This module contains the EndpointV3Compatibility class, which is used to connect to Modelly apps running 3.x.x versions of Modelly."""
...
from modelly_client import serializing, utils
from modelly_client.exceptions import SerializationSetupError
...
class EndpointV3Compatibility:
    ...
    def _predict_resolve(self, *data) -> Any:
        """Needed for modelly.load(), which has a slightly different signature for serializing/deserializing"""
                    ...
                    if component.get("serializer"):
                        ...
                        if serializer_name not in serializing.SERIALIZER_MAPPING:
                            raise SerializationSetupError(
                                f"Unknown serializer: {serializer_name}, you may need to update your modelly_client version."
                            )
                        ...
                        raise SerializationSetupError(
                            f"Unknown component: {component_name}, you may need to update your modelly_client version."
                        )
