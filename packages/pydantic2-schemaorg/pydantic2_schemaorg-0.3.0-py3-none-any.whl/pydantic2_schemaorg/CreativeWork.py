...
class CreativeWork(Thing):
    ...
    archivedAt: Optional[
        Union[List[Union[AnyUrl, "URL", "WebPage", str]], AnyUrl, "URL", "WebPage", str]
    ] = Field(
        default=None,
        description="Indicates a page or other link involved in archival of a [[CreativeWork]]. In the case of [[MediaReview]], the items in a [[MediaReviewItem]] may often become inaccessible, but be archived by archival, journalistic, activist, or law enforcement organizations. In such cases, the referenced page may not directly publish the content.",
    )
    accessibilityFeature: Optional[Union[List[Union[str, "Text"]], str, "Text"]] = (
        Field(
            default=None,
    ...
    encodings: Optional[Union[List[Union["MediaObject", str]], "MediaObject", str]] = (
        Field(
            default=None,
    ...
    temporalCoverage: Optional[
        Union[
            List[Union[datetime, "DateTime", AnyUrl, "URL", str, "Text"]],
            datetime,
            "DateTime",
            AnyUrl,
            "URL",
    ...
    accessibilityControl: Optional[Union[List[Union[str, "Text"]], str, "Text"]] = (
        Field(
            default=None,
    ...
    video: Optional[
        Union[List[Union["VideoObject", "Clip", str]], "VideoObject", "Clip", str]
    ] = Field(
        default=None,
    ...
    publication: Optional[
        Union[List[Union["PublicationEvent", str]], "PublicationEvent", str]
    ] = Field(
        default=None,
    ...
    accessibilitySummary: Optional[Union[List[Union[str, "Text"]], str, "Text"]] = (
        Field(
            default=None,
    ...
    timeRequired: Optional[Union[List[Union["Duration", str]], "Duration", str]] = (
        Field(
            default=None,
    ...
    digitalSourceType: Optional[
        Union[
            List[Union["IPTCDigitalSourceEnumeration", str]],
    ...
    contentRating: Optional[
        Union[List[Union[str, "Text", "Rating"]], str, "Text", "Rating"]
    ] = Field(
        default=None,
    ...
    citation: Optional[
        Union[List[Union[str, "Text", "CreativeWork"]], str, "Text", "CreativeWork"]
    ] = Field(
        default=None,
    ...
    encoding: Optional[Union[List[Union["MediaObject", str]], "MediaObject", str]] = (
        Field(
            default=None,
    ...
    thumbnail: Optional[Union[List[Union["ImageObject", str]], "ImageObject", str]] = (
        Field(
            default=None,
    ...
    accessModeSufficient: Optional[
        Union[List[Union["ItemList", str]], "ItemList", str]
    ] = Field(
        default=None,
    ...
    audio: Optional[
        Union[
            List[Union["AudioObject", "Clip", "MusicRecording", str]],
            "AudioObject",
            "Clip",
            "MusicRecording",
            str,
    ...
    hasPart: Optional[Union[List[Union["CreativeWork", str]], "CreativeWork", str]] = (
        Field(
            default=None,
            description="Indicates an item or CreativeWork that is part of this item, or CreativeWork (in some sense).",
        )
    )
    accountablePerson: Optional[Union[List[Union["Person", str]], "Person", str]] = (
        Field(
            default=None,
    ...
    correction: Optional[
        Union[
            List[Union[AnyUrl, "URL", str, "Text", "CorrectionComment"]],
            AnyUrl,
            "URL",
            str,
            "Text",
    ...
    isBasedOn: Optional[
        Union[
            List[Union[AnyUrl, "URL", "Product", "CreativeWork", str]],
            AnyUrl,
            "URL",
            "Product",
            "CreativeWork",
