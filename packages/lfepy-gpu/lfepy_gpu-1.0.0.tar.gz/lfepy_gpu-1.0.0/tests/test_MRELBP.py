import unittest
import cupy as cp
from lfepy.Descriptor import MRELBP
...
class TestMRELBP(unittest.TestCase):
    ...
    def test_mrelbp_default_params(self):
        ...
        with self.assertRaises(ValueError):
            ...
            self.assertIsInstance(mrelbp_hist, cp.ndarray)  # Changed to cupy array
    ...
    def test_mrelbp_feature_extraction(self):
        ...
        with self.assertRaises(ValueError):
            ...
            for desc in imgDesc:
                ...
                self.assertIsInstance(desc['fea']['CImg'], cp.ndarray)  # Changed to cupy array
                self.assertIsInstance(desc['fea']['NILBPImage'], cp.ndarray)  # Changed to cupy array
                self.assertIsInstance(desc['fea']['RDLBPImage'], cp.ndarray)  # Changed to cupy array
