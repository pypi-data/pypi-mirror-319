...
class GetChat:
    async def get_chat(
        ...
        Returns:
            :obj:`~nerogram.types.Chat` | :obj:`~nerogram.types.ChatPreview`: On success, if you've already joined the chat, a chat object is returned,
        ...
        Example:
            .. code-block:: python
                ...
                chat = await app.get_chat("nerogram")
                print(chat)
        """
