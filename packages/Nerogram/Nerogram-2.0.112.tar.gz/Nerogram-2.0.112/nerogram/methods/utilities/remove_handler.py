...
import nerogram
from nerogram.handlers import DisconnectHandler
...
class RemoveHandler:
    def remove_handler(
        ...
        :meth:`~nerogram.Client.add_handler` method, a tuple of *(handler, group)*, and pass it directly.
        ...
        Example:
            .. code-block:: python
                ...
                from nerogram.handlers import MessageHandler
