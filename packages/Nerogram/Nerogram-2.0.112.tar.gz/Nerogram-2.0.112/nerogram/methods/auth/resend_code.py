...
class ResendCode:
    async def resend_code(
        ...
        :obj:`~nerogram.types.SentCode` object returned by :meth:`send_code`.
        ...
        Returns:
            :obj:`~nerogram.types.SentCode`: On success, an object containing information on the re-sent confirmation
            code is returned.
