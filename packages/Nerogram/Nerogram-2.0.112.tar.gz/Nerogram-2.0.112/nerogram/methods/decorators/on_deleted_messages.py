...
class OnDeletedMessages:
    def on_deleted_messages(
        ...
        :obj:`~nerogram.handlers.DeletedMessagesHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, nerogram.Client):
                self.add_handler(nerogram.handlers.DeletedMessagesHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        nerogram.handlers.DeletedMessagesHandler(func, self),
