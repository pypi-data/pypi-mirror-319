...
class OnCallbackQuery:
    def on_callback_query(
        ...
        :obj:`~nerogram.handlers.CallbackQueryHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, nerogram.Client):
                self.add_handler(nerogram.handlers.CallbackQueryHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        nerogram.handlers.CallbackQueryHandler(func, self),
