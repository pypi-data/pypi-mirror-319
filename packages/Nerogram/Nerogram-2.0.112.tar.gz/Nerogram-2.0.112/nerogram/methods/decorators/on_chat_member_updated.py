...
class OnChatMemberUpdated:
    def on_chat_member_updated(
        ...
        :obj:`~nerogram.handlers.ChatMemberUpdatedHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, nerogram.Client):
                self.add_handler(nerogram.handlers.ChatMemberUpdatedHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        nerogram.handlers.ChatMemberUpdatedHandler(func, self),
