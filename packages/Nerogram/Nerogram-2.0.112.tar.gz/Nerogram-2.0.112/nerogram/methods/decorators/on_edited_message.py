...
class OnEditedMessage:
    def on_edited_message(
        ...
        :obj:`~nerogram.handlers.EditedMessageHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, nerogram.Client):
                self.add_handler(nerogram.handlers.EditedMessageHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        nerogram.handlers.EditedMessageHandler(func, self),
