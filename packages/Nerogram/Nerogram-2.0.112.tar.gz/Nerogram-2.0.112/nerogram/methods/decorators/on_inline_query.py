...
class OnInlineQuery:
    def on_inline_query(
        ...
        :obj:`~nerogram.handlers.InlineQueryHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, nerogram.Client):
                self.add_handler(nerogram.handlers.InlineQueryHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        nerogram.handlers.InlineQueryHandler(func, self),
