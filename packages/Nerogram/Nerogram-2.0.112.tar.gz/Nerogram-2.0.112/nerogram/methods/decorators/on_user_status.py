...
class OnUserStatus:
    def on_user_status(
        ...
        :obj:`~nerogram.handlers.UserStatusHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, nerogram.Client):
                self.add_handler(nerogram.handlers.UserStatusHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        nerogram.handlers.UserStatusHandler(func, self),
