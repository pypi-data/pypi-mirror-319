...
class OnChosenInlineResult:
    def on_chosen_inline_result(
        ...
        :obj:`~nerogram.handlers.ChosenInlineResultHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, nerogram.Client):
                self.add_handler(nerogram.handlers.ChosenInlineResultHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        nerogram.handlers.ChosenInlineResultHandler(func, self),
