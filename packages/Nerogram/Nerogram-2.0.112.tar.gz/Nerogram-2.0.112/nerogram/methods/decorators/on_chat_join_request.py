...
class OnChatJoinRequest:
    def on_chat_join_request(
        ...
        :obj:`~nerogram.handlers.ChatJoinRequestHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, nerogram.Client):
                self.add_handler(nerogram.handlers.ChatJoinRequestHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        nerogram.handlers.ChatJoinRequestHandler(func, self),
