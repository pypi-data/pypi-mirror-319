...
import nerogram
from nerogram import StopTransmission, enums
...
class SendAudio:
    async def send_audio(
        ...
        For sending voice messages, use the :meth:`~nerogram.Client.send_voice` method instead.
        ...
        Returns:
            :obj:`~nerogram.types.Message` | ``None``: On success, the sent audio message is returned, otherwise, in
