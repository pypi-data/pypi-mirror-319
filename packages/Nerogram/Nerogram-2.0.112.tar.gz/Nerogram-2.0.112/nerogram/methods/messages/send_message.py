...
import nerogram
from nerogram import raw, utils, enums
...
class SendMessage:
    async def send_message(
        ...
        Returns:
            :obj:`~nerogram.types.Message`: On success, the sent text message is returned.

        Example:
            .. code-block:: python

                # Simple example
                await app.send_message("me", "Message sent with **Nerogram**!")

                # Disable web page previews
                await app.send_message("me", "https://docs.nerogram.org",
                ...
                await app.send_message(
                    ...
                    reply_markup=InlineKeyboardMarkup(
                        [
                            ...
                            [InlineKeyboardButton("Docs", url="https://docs.nerogram.org")]
                        ]))
        """
