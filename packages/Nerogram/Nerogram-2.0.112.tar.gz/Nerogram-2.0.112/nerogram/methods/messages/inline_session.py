...
from nerogram.errors import AuthBytesInvalid
from nerogram.session import Session
from nerogram.session.auth import Auth


async def get_session(client: "nerogram.Client", dc_id: int):
