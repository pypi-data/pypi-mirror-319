...
import nerogram
from nerogram import raw, enums, utils
...
class Poll(Object, Update):
    ...
    Parameters:
        ...
        options (List of :obj:`~nerogram.types.PollOption`):
        ...
        explanation_entities (List of :obj:`~nerogram.types.MessageEntity`, *optional*):
