...
import nerogram
from nerogram import raw, enums, types
from nerogram.errors import ChannelPrivate
...
class CallbackQuery(Object, Update):
    ...
    *inline_message_id* will be present. Exactly one of the fields *data* or *game_short_name* will be present.
    ...
    @staticmethod
    async def _parse(client: "nerogram.Client", callback_query, users, chats) -> "CallbackQuery":
        message = None
