...
from nerogram import types, utils, enums
...
class ChatEvent(Object):
    ...
    Parameters:
        ...
        action (:obj:`~nerogram.enums.ChatEventAction`):
            Event action.

        user (:obj:`~nerogram.types.User`):
            User that triggered the event.

        old_description, new_description (``str``, *optional*):
            Previous and new chat description.
            For :obj:`~nerogram.enums.ChatEventAction.DESCRIPTION_CHANGED` action only.

        old_history_ttl, new_history_ttl (``int``, *optional*):
            Previous and new chat history TTL.
            For :obj:`~nerogram.enums.ChatEventAction.HISTORY_TTL_CHANGED` action only.

        old_linked_chat, new_linked_chat (:obj:`~nerogram.types.Chat`, *optional*):
            Previous and new linked chat.
            For :obj:`~nerogram.enums.ChatEventAction.LINKED_CHAT_CHANGED` action only.

        old_photo, new_photo (:obj:`~nerogram.types.Photo`, *optional*):
            Previous and new chat photo.
            For :obj:`~nerogram.enums.ChatEventAction.PHOTO_CHANGED` action only.

        old_title, new_title (``str``, *optional*):
            Previous and new chat title.
            For :obj:`~nerogram.enums.ChatEventAction.TITLE_CHANGED` action only.

        old_username, new_username (``str``, *optional*):
            Previous and new chat username.
            For :obj:`~nerogram.enums.ChatEventAction.USERNAME_CHANGED` action only.

        old_chat_permissions, new_chat_permissions (:obj:`~nerogram.types.ChatPermissions`, *optional*):
            Previous and new default chat permissions.
            For :obj:`~nerogram.enums.ChatEventAction.CHAT_PERMISSIONS_CHANGED` action only.

        deleted_message (:obj:`~nerogram.types.Message`, *optional*):
            Deleted message.
            For :obj:`~nerogram.enums.ChatEventAction.MESSAGE_DELETED` action only.

        old_message, new_message (:obj:`~nerogram.types.Message`, *optional*):
            Previous and new message before it has been edited.
            For :obj:`~nerogram.enums.ChatEventAction.MESSAGE_EDITED` action only.

        invited_member (:obj:`~nerogram.types.ChatMember`, *optional*):
            New invited chat member.
            For :obj:`~nerogram.enums.ChatEventAction.MEMBER_INVITED` action only.

        old_administrator_privileges, new_administrator_privileges (:obj:`~nerogram.types.ChatMember`, *optional*):
            Previous and new administrator privileges.
            For :obj:`~nerogram.enums.ChatEventAction.ADMINISTRATOR_PRIVILEGES_CHANGED` action only.

        old_member_permissions, new_member_permissions (:obj:`~nerogram.types.ChatMember`, *optional*):
            Previous and new member permissions.
            For :obj:`~nerogram.enums.ChatEventAction.MEMBER_PERMISSIONS_CHANGED` action only.

        stopped_poll (:obj:`~nerogram.types.Message`, *optional*):
            Message containing the stopped poll.
            For :obj:`~nerogram.enums.ChatEventAction.POLL_STOPPED` action only.

        invites_enabled (``bool``, *optional*):
            If chat invites were enabled (True) or disabled (False).
            For :obj:`~nerogram.enums.ChatEventAction.INVITES_ENABLED` action only.

        history_hidden (``bool``, *optional*):
            If chat history has been hidden (True) or unhidden (False).
            For :obj:`~nerogram.enums.ChatEventAction.HISTORY_HIDDEN` action only.

        signatures_enabled (``bool``, *optional*):
            If message signatures were enabled (True) or disabled (False).
            For :obj:`~nerogram.enums.ChatEventAction.SIGNATURES_ENABLED` action only.

        old_slow_mode, new_slow_mode (``int``, *optional*):
            Previous and new slow mode value in seconds.
            For :obj:`~nerogram.enums.ChatEventAction.SLOW_MODE_CHANGED` action only.

        pinned_message (:obj:`~nerogram.types.Message`, *optional*):
            Pinned message.
            For :obj:`~nerogram.enums.ChatEventAction.MESSAGE_PINNED` action only.

        unpinned_message (:obj:`~nerogram.types.Message`, *optional*):
            Unpinned message.
            For :obj:`~nerogram.enums.ChatEventAction.MESSAGE_UNPINNED` action only.

        old_invite_link, new_invite_link (:obj:`~nerogram.types.ChatInviteLink`, *optional*):
            Previous and new edited invite link.
            For :obj:`~nerogram.enums.ChatEventAction.INVITE_LINK_EDITED` action only.

        revoked_invite_link (:obj:`~nerogram.types.ChatInviteLink`, *optional*):
            Revoked invite link.
            For :obj:`~nerogram.enums.ChatEventAction.INVITE_LINK_REVOKED` action only.

        deleted_invite_link (:obj:`~nerogram.types.ChatInviteLink`, *optional*):
            Deleted invite link.
            For :obj:`~nerogram.enums.ChatEventAction.INVITE_LINK_DELETED` action only.

        created_forum_topic (:obj:`~nerogram.types.ForumTopic`, *optional*):
            New forum topic.
            For :obj:`~nerogram.enums.ChatEvenAction.CREATED_FORUM_TOPIC` action only.

        old_forum_topic, new_forum_topic (:obj:`~nerogram.types.ForumTopic`, *optional*):
            Edited forum topic.
            For :obj:`~nerogram.enums.ChatEvenAction.EDITED_FORUM_TOPIC` action only.

        deleted_forum_topic (:obj:`~nerogram.types.ForumTopic`, *optional*):
            Deleted forum topic.
            For :obj:`~nerogram.enums.ChatEvenAction.DELETED_FORUM_TOPIC` action only.
    """
