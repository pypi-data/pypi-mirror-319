...
from nerogram.crypto import aes, rsa, prime
from nerogram.errors import SecurityCheckMismatch
from nerogram.raw.core import TLObject, Long, Int
...
class Auth:
    ...
    def __init__(self, client: "nerogram.Client", dc_id: int, test_mode: bool):
        self.dc_id = dc_id
