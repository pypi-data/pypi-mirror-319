...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-secretsmanager)](https://pypistats.org/packages/mypy-boto3-secretsmanager)
...
`mypy-boto3-secretsmanager` dependency in production. However, there is an
