...
class Pulla:
    ...
    def fetch_latest_calibration_set(self) -> tuple[CalibrationSet, uuid.UUID]:
        """
    ...
    def fetch_calibration_set_by_id(self, calibration_set_id: uuid.UUID) -> CalibrationSet:
        """
        ...
        Args:
            calibration_set_id: UUID of the calibration set to fetch.
        """
    ...
    def execute(
        ...
        try:
            ...
            while True:
                ...
                print(sweep_data.sweep_status)

                if sweep_data.sweep_status == SweepStatus.SUCCESS:
                ...
                if sweep_data.sweep_status == SweepStatus.FAILURE:
                ...
                # TODO: handle other non-pending non-successful cases
