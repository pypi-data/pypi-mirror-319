...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-workdocs)](https://pypistats.org/packages/mypy-boto3-workdocs)
...
`mypy-boto3-workdocs` dependency in production. However, there is an issue in
