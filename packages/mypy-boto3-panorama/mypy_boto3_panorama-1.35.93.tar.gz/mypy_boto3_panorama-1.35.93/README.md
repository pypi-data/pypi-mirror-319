...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-panorama)](https://pypistats.org/packages/mypy-boto3-panorama)

![boto3.typed](https://github.com/youtype/mypy_boto3_builder/raw/main/logo.png)

Type annotations for [boto3 Panorama 1.35.93](https://pypi.org/project/boto3/)
...
`mypy-boto3-panorama` dependency in production. However, there is an issue in
