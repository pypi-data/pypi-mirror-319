...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-sts)](https://pypistats.org/packages/mypy-boto3-sts)
...
`mypy-boto3-sts` dependency in production. However, there is an issue in
