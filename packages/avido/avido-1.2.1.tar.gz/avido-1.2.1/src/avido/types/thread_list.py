...
__all__ = [
    "ThreadList",
    "ThreadListItem",
    "ThreadListItemChildTrace",
    "ThreadListItemChildTraceLlmTrace",
    "ThreadListItemChildTraceToolTrace",
    "ThreadListItemChildTraceRetrieverTrace",
    "ThreadListItemChildTraceLogTrace",
]


class ThreadListItemChildTraceLlmTrace(BaseModel):
    application_id: str
    """Application ID (UUID)."""
...
class ThreadListItemChildTraceToolTrace(BaseModel):
    application_id: str
    """Application ID (UUID)."""
...
class ThreadListItemChildTraceRetrieverTrace(BaseModel):
    application_id: str
    """Application ID (UUID)."""
...
class ThreadListItemChildTraceLogTrace(BaseModel):
    application_id: str
    """Application ID (UUID)."""
...
ThreadListItemChildTrace: TypeAlias = Union[
    ThreadListItemChildTraceLlmTrace,
    ThreadListItemChildTraceToolTrace,
    ThreadListItemChildTraceRetrieverTrace,
    ThreadListItemChildTraceLogTrace,
...
class ThreadListItem(BaseModel):
    ...
    child_traces: List[ThreadListItemChildTrace]
    """Array of traces associated with the thread."""
