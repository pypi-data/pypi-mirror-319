...
The REST API documentation can be found on [docs.avido.io](https://docs.avido.io). The full API of this library can be found in [api.md](api.md).
...
client.with_options(max_retries=5).threads.create(
    application_id="456e4567-e89b-12d3-a456-426614174000",
)
```
...
client.with_options(timeout=5.0).threads.create(
    application_id="456e4567-e89b-12d3-a456-426614174000",
)
```
...
thread = response.parse()  # get the object that `threads.create()` would have returned
print(thread.data)
```
