...
from ..types import evaluation_topic_list_params, evaluation_topic_create_params
...
from ..types.evaluation_topic_list_response import EvaluationTopicListResponse
...
class EvaluationTopicsResource(SyncAPIResource):
    ...
    def list(
        ...
        *,
        ...
        extra_body: Body | None = None,
        timeout: float | httpx.Timeout | None | NotGiven = NOT_GIVEN,
    ) -> SyncOffsetPagination[EvaluationTopicListResponse]:
        """
        ...
        return self._get_api_list(
            "/v0/topics",
            page=SyncOffsetPagination[EvaluationTopicListResponse],
            options=make_request_options(
                ...
                query=maybe_transform(
                    ...
                    evaluation_topic_list_params.EvaluationTopicListParams,
                ),
            ),
            model=EvaluationTopicListResponse,
        )
...
class AsyncEvaluationTopicsResource(AsyncAPIResource):
    ...
    def list(
        ...
        *,
        ...
        extra_body: Body | None = None,
        timeout: float | httpx.Timeout | None | NotGiven = NOT_GIVEN,
    ) -> AsyncPaginator[EvaluationTopicListResponse, AsyncOffsetPagination[EvaluationTopicListResponse]]:
        """
        Retrieves a paginated list of evaluation topics with optional filtering.
        ...
        return self._get_api_list(
            "/v0/topics",
            page=AsyncOffsetPagination[EvaluationTopicListResponse],
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
                extra_body=extra_body,
