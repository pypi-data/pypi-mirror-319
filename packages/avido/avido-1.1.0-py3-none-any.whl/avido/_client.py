...
from .resources import tests, traces, threads, webhook, ingestion, evaluations, applications, evaluation_topics
...
class Avido(SyncAPIClient):
    ingestion: ingestion.IngestionResource
    ...
    def __init__(
        ...
        *,
        ...
        self.ingestion = ingestion.IngestionResource(self)
...
class AsyncAvido(AsyncAPIClient):
    ingestion: ingestion.AsyncIngestionResource
    ...
    def __init__(
        ...
        *,
        ...
        self.ingestion = ingestion.AsyncIngestionResource(self)
...
class AvidoWithRawResponse:
    def __init__(self, client: Avido) -> None:
        self.ingestion = ingestion.IngestionResourceWithRawResponse(client.ingestion)
...
class AsyncAvidoWithRawResponse:
    def __init__(self, client: AsyncAvido) -> None:
        self.ingestion = ingestion.AsyncIngestionResourceWithRawResponse(client.ingestion)
...
class AvidoWithStreamedResponse:
    def __init__(self, client: Avido) -> None:
        self.ingestion = ingestion.IngestionResourceWithStreamingResponse(client.ingestion)
...
class AsyncAvidoWithStreamedResponse:
    def __init__(self, client: AsyncAvido) -> None:
        self.ingestion = ingestion.AsyncIngestionResourceWithStreamingResponse(client.ingestion)
