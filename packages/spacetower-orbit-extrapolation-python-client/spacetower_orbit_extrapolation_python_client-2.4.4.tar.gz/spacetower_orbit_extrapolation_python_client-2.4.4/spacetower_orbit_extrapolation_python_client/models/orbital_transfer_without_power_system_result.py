...
class OrbitalTransferWithoutPowerSystemResult(BaseModel):
    """
    Result for a maneuver planning without power system based on orbit extrapolation
    """ # noqa: E501
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": obj.get("data"),
            "finalState": OrbitalTransferWithoutPowerSystemFinalState.from_dict(obj["finalState"]) if obj.get("finalState") is not None else None
        })
        return _obj
