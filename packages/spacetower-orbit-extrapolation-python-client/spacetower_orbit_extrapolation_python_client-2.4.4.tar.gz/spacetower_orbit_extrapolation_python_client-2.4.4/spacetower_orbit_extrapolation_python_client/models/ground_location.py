...
class GroundLocation(BaseModel):
    ...
    """ # noqa: E501
    name: StrictStr
    longitude: Union[StrictFloat, StrictInt] = Field(description="Geodetic longitude. Units [rad]")
    ...
    __properties: ClassVar[List[str]] = ["name", "longitude", "latitude", "altitude"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GroundLocation from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GroundLocation from a dict"""
        if obj is None:
            return None
