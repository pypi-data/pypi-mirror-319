...
class MassEphemeris(BaseModel):
    ...
    data: List[List[Union[StrictFloat, StrictInt]]] = Field(description="Ephemeris data. Each entry (DataEntry) corresponds to a date, and contains the list of the computed values as presented in the description field: <br> [[mass[kg]], ...]")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MassEphemeris from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MassEphemeris from a dict"""
        if obj is None:
            return None
