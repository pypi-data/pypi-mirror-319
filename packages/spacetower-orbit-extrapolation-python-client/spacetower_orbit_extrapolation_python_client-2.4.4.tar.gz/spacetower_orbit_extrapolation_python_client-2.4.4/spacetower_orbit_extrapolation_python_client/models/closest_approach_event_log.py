...
class ClosestApproachEventLog(BaseModel):
    """
    Closest approach event summary. The date is also the Time of Closest Approach (TCA) 
    """ # noqa: E501
    utc_date: str = Field(description="The event's UTC date. It is also the Time of Closest Approach (TCA)", alias="utcDate")
    ...
    relative_position_vector_in_qsw: Vector3D = Field(alias="relativePositionVectorInQsw")
    relative_velocity_vector_in_qsw: Vector3D = Field(alias="relativeVelocityVectorInQsw")
