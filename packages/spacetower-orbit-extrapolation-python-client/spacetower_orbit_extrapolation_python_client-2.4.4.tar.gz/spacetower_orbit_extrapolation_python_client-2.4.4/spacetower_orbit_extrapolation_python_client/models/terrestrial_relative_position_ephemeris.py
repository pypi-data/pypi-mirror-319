...
class TerrestrialRelativePositionEphemeris(BaseModel):
    """
    Ephemeris of the relative position vectors of ground-based targets w.r.t. the space object,  including azimuth, elevation and range of the space object from the terrestrial target point 
    """ # noqa: E501
    ...
    data: List[List[Union[StrictFloat, StrictInt]]] = Field(description="Terrestrial relative Cartesian ephemeris data. Each entry (DataEntry) corresponds to a date, and contains the list of the computed values as presented in the description field: <br> [[position-x[m], position-y[m], position-z[m], azimuth[rad], elevation[rad], range[m]], ...]")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TerrestrialRelativePositionEphemeris from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TerrestrialRelativePositionEphemeris from a dict"""
        if obj is None:
            return None
