...
class ExtrapolationRequestCommonFields(BaseModel):
    """
    Common fields for all extrapolation requests
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["targetDate", "outputConfiguration"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ExtrapolationRequestCommonFields from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ExtrapolationRequestCommonFields from a dict"""
        if obj is None:
            return None
