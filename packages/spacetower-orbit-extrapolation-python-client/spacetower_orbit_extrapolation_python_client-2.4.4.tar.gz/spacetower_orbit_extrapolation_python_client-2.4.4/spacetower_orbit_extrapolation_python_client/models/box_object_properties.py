...
class BoxObjectProperties(BaseModel):
    """
    Properties exclusive to box-shaped objects
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["xDimension", "yDimension", "zDimension", "radiationCoefficients", "solarArrayGeometry", "radiationCorrectionFactor"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BoxObjectProperties from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BoxObjectProperties from a dict"""
        if obj is None:
            return None
