...
class DatedLocalFrameFiniteThrustDirection(BaseModel):
    ...
    thrust_direction_right_ascension: Union[StrictFloat, StrictInt] = Field(description="Angle between the projection of the thrust vector on the xy-plane and the x-axis of the local frame. Units [rad]", alias="thrustDirectionRightAscension")
    thrust_direction_declination: Union[StrictFloat, StrictInt] = Field(description="Angle between the xy-plane of the local frame and the thrust vector. Units [rad]", alias="thrustDirectionDeclination")
