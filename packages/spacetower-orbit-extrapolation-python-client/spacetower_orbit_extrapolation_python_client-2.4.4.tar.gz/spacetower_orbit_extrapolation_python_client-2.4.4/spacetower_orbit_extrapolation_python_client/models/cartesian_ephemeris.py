...
class CartesianEphemeris(BaseModel):
    """
    Position and velocity ephemeris in an inertial or non-inertial frame
    """ # noqa: E501
    ...
    data: List[List[Union[StrictFloat, StrictInt]]] = Field(description="Ephemeris data. Each entry (DataEntry) corresponds to a date, and contains the list of the computed values as presented in the description field: <br> [[pos-x[m], pos-y[m], pos-z[m], vel-x[m/s], vel-y[m/s], vel-z[m/s]], ...]")
    orbit_ephemeris_message: Optional[StrictStr] = Field(default=None, description="CCSDS Orbit Ephemeris Message containing the position and velocity ephemeris and optionally the acceleration", alias="orbitEphemerisMessage")
    __properties: ClassVar[List[str]] = ["dates", "description", "frameId", "data", "orbitEphemerisMessage"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CartesianEphemeris from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CartesianEphemeris from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "data": obj.get("data"),
            "orbitEphemerisMessage": obj.get("orbitEphemerisMessage")
        })
        return _obj
