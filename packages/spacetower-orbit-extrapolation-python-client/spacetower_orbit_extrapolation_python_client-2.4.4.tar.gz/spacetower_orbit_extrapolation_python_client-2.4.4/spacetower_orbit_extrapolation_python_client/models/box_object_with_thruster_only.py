...
class BoxObjectWithThrusterOnly(BaseModel):
    """
    Box-shaped object with thruster and without power system 
    """ # noqa: E501
    ...
    space_object_type: Optional[StrictStr] = Field(default='BOX', alias="spaceObjectType")
    thruster: Optional[Thruster] = None
    __properties: ClassVar[List[str]] = ["xDimension", "yDimension", "zDimension", "radiationCoefficients", "solarArrayGeometry", "radiationCorrectionFactor", "mass", "dragCoefficient", "spaceObjectType", "thruster"]

    @field_validator('space_object_type')
    def space_object_type_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "spaceObjectType": obj.get("spaceObjectType") if obj.get("spaceObjectType") is not None else 'BOX',
