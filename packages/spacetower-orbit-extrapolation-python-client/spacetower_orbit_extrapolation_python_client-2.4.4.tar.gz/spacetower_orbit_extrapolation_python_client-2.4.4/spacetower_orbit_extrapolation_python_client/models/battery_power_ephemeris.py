...
class BatteryPowerEphemeris(BaseModel):
    """
    Ephemeris of power battery
    """ # noqa: E501
    ...
    data: List[List[Union[StrictFloat, StrictInt]]] = Field(description="Ephemeris data. Each entry (DataEntry) corresponds to a date, and contains the list of the computed values as presented in the description field: <br> [[power[W]], ...]")
    __properties: ClassVar[List[str]] = ["dates", "description", "data"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BatteryPowerEphemeris from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BatteryPowerEphemeris from a dict"""
        if obj is None:
            return None
