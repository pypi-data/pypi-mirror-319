...
class OrbitalTransferWithoutPowerSystemRequest(BaseModel):
    """
    Request for performing an orbital transfer with attitude based on orbit extrapolation
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["initialOrbit", "initialCovarianceMatrix", "simulationConfiguration", "data", "maneuverTarget", "outputConfiguration", "spaceObject", "ephemerisGenerationRequests", "eventGenerationRequests"]
