...
class QuaternionEphemeris(AttitudeEphemeris):
    """
    Ephemeris of attitude as quaternions w.r.t. the ECI frame defined in the Earth Frame Configuration
    """ # noqa: E501
    data: List[List[Union[StrictFloat, StrictInt]]] = Field(description="Ephemeris data. Each entry (DataEntry) corresponds to a date, and contains the list of the computed values as presented in the description field: <br> [[quaternion-scalar[-], quaternion-x[-], quaternion-y[-], quaternion-z[-]], ...]")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of QuaternionEphemeris from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of QuaternionEphemeris from a dict"""
        if obj is None:
            return None
