...
class SunPointingLaw(AttitudeLaw):
    """
    Attitude pointing the solar array normal towards the Sun (applies to BoxObject with solar array  geometry), with the last degree of freedom of the rotation set arbitrarily. 
    """ # noqa: E501
