...
class CartesianCovarianceMatrix(OrbitalCovarianceMatrix):
    ...
    cov_px_vx: Optional[Union[StrictFloat, StrictInt]] = Field(default=0.0, description="Position-x velocity-x covariance. Units [m^2/s]", alias="covPxVx")
    cov_px_vy: Optional[Union[StrictFloat, StrictInt]] = Field(default=0.0, description="Position-x velocity-y covariance. Units [m^2/s]", alias="covPxVy")
    cov_px_vz: Optional[Union[StrictFloat, StrictInt]] = Field(default=0.0, description="Position-x velocity-z covariance. Units [m^2/s]", alias="covPxVz")
    cov_py_vx: Optional[Union[StrictFloat, StrictInt]] = Field(default=0.0, description="Position-y velocity-x covariance. Units [m^2/s]", alias="covPyVx")
    cov_py_vy: Optional[Union[StrictFloat, StrictInt]] = Field(default=0.0, description="Position-y velocity-y covariance. Units [m^2/s]", alias="covPyVy")
    cov_py_vz: Optional[Union[StrictFloat, StrictInt]] = Field(default=0.0, description="Position-y velocity-z covariance. Units [m^2/s]", alias="covPyVz")
    cov_pz_vx: Optional[Union[StrictFloat, StrictInt]] = Field(default=0.0, description="Position-z velocity-x covariance. Units [m^2/s]", alias="covPzVx")
    cov_pz_vy: Optional[Union[StrictFloat, StrictInt]] = Field(default=0.0, description="Position-z velocity-y covariance. Units [m^2/s]", alias="covPzVy")
    cov_pz_vz: Optional[Union[StrictFloat, StrictInt]] = Field(default=0.0, description="Position-z velocity-z covariance. Units [m^2/s]", alias="covPzVz")
