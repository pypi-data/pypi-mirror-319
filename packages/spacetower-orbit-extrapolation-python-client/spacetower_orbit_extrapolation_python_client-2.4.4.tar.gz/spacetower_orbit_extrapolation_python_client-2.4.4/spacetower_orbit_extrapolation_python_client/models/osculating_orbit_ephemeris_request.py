...
class OsculatingOrbitEphemerisRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["timeGridConfiguration", "startDate", "endDate", "anomalyType", "orbitType"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OsculatingOrbitEphemerisRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OsculatingOrbitEphemerisRequest from a dict"""
        if obj is None:
            return None
