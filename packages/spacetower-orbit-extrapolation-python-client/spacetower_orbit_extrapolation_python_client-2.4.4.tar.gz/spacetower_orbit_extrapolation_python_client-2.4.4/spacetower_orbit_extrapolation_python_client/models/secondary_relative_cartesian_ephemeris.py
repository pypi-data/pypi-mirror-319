...
class SecondaryRelativeCartesianEphemeris(BaseModel):
    """
    Ephemeris of the relative position and velocity vectors of secondary orbiting objects w.r.t. the space object 
    """ # noqa: E501
    ...
    data: List[List[Union[StrictFloat, StrictInt]]] = Field(description="Secondary relative Cartesian ephemeris data. Each entry (DataEntry) corresponds to a date, and contains the list of the computed values as presented in the description field: <br> [[position-x[m], position-y[m], position-z[m], velocity-x[m/s], velocity-y[m/s], velocity-z[m/s]], ...]")
    __properties: ClassVar[List[str]] = ["dates", "description", "targetNames", "data"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SecondaryRelativeCartesianEphemeris from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SecondaryRelativeCartesianEphemeris from a dict"""
        if obj is None:
            return None
