...
class TestCartesianEphemeris(unittest.TestCase):
    """CartesianEphemeris unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CartesianEphemeris:
        """Test CartesianEphemeris
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CartesianEphemeris`
        """
        model = CartesianEphemeris()
        if include_optional:
    ...
    def testCartesianEphemeris(self):
        """Test CartesianEphemeris"""
