...
class TestNumericalExtrapolationWithoutAttitudeSimulationResult(unittest.TestCase):
    """NumericalExtrapolationWithoutAttitudeSimulationResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NumericalExtrapolationWithoutAttitudeSimulationResult:
        """Test NumericalExtrapolationWithoutAttitudeSimulationResult
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NumericalExtrapolationWithoutAttitudeSimulationResult`
        """
        model = NumericalExtrapolationWithoutAttitudeSimulationResult()
        if include_optional:
            return NumericalExtrapolationWithoutAttitudeSimulationResult(
                ...
                final_state = spacetower_orbit_extrapolation_python_client.models.numerical_extrapolation_without_attitude_simulation_final_state.NumericalExtrapolationWithoutAttitudeSimulationFinalState(),
                data = {
                    'key' : ''
                    }
            )
    ...
    def testNumericalExtrapolationWithoutAttitudeSimulationResult(self):
        """Test NumericalExtrapolationWithoutAttitudeSimulationResult"""
