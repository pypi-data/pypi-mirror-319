    ...
    def make_instance(self, include_optional) -> OrbitalTransferWithoutPowerSystemResult:
        ...
        if include_optional:
            return OrbitalTransferWithoutPowerSystemResult(
                ...
                final_state = spacetower_orbit_extrapolation_python_client.models.orbital_transfer_without_power_system_final_state.OrbitalTransferWithoutPowerSystemFinalState()
            )
        else:
            return OrbitalTransferWithoutPowerSystemResult(
        )
