...
class TestNumericalExtrapolationWithAttitudeSimulationRequest(unittest.TestCase):
    """NumericalExtrapolationWithAttitudeSimulationRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NumericalExtrapolationWithAttitudeSimulationRequest:
        """Test NumericalExtrapolationWithAttitudeSimulationRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NumericalExtrapolationWithAttitudeSimulationRequest`
        """
        model = NumericalExtrapolationWithAttitudeSimulationRequest()
        if include_optional:
            return NumericalExtrapolationWithAttitudeSimulationRequest(
                ...
                space_object = spacetower_orbit_extrapolation_python_client.models.box_object.BoxObject(),
    ...
    def testNumericalExtrapolationWithAttitudeSimulationRequest(self):
        """Test NumericalExtrapolationWithAttitudeSimulationRequest"""
