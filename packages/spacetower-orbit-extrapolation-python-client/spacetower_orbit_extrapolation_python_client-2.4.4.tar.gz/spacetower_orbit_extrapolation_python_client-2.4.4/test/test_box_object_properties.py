...
class TestBoxObjectProperties(unittest.TestCase):
    """BoxObjectProperties unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BoxObjectProperties:
        """Test BoxObjectProperties
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BoxObjectProperties`
        """
        model = BoxObjectProperties()
        if include_optional:
            return BoxObjectProperties(
                x_dimension = 0,
                y_dimension = 0,
                z_dimension = 0,
    ...
    def testBoxObjectProperties(self):
        """Test BoxObjectProperties"""
