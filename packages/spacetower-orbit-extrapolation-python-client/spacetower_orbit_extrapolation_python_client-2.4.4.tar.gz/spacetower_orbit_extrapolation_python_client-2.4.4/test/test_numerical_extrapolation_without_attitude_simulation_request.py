...
class TestNumericalExtrapolationWithoutAttitudeSimulationRequest(unittest.TestCase):
    """NumericalExtrapolationWithoutAttitudeSimulationRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NumericalExtrapolationWithoutAttitudeSimulationRequest:
        """Test NumericalExtrapolationWithoutAttitudeSimulationRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NumericalExtrapolationWithoutAttitudeSimulationRequest`
        """
        model = NumericalExtrapolationWithoutAttitudeSimulationRequest()
        if include_optional:
            return NumericalExtrapolationWithoutAttitudeSimulationRequest(
    ...
    def testNumericalExtrapolationWithoutAttitudeSimulationRequest(self):
        """Test NumericalExtrapolationWithoutAttitudeSimulationRequest"""
