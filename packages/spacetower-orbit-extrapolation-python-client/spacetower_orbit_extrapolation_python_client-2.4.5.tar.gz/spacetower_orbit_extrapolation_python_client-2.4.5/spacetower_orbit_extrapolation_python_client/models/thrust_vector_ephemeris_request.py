...
class ThrustVectorEphemerisRequest(BaseModel):
    """
    Options for exporting thrust vector in a given local frame
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["timeGridConfiguration", "startDate", "endDate", "localFrameId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ThrustVectorEphemerisRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ThrustVectorEphemerisRequest from a dict"""
        if obj is None:
            return None
