...
class NumericalExtrapolationWithAttitudeSimulationRequest(BaseModel):
    """
    Configuration for extrapolation based on special perturbations method with attitude simulation
    """ # noqa: E501
    ...
    space_object: Optional[BoxObject] = Field(default=None, alias="spaceObject")
    ...
    __properties: ClassVar[List[str]] = ["targetDate", "outputConfiguration", "initialOrbit", "initialCovarianceMatrix", "simulationConfiguration", "data", "attitudeSequence", "maneuverSchedule", "spaceObject", "ephemerisGenerationRequests", "eventGenerationRequests"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NumericalExtrapolationWithAttitudeSimulationRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NumericalExtrapolationWithAttitudeSimulationRequest from a dict"""
        if obj is None:
            return None
