...
class NumericalExtrapolationWithoutAttitudeSimulationResult(BaseModel):
    """
    Output containing the extrapolation result for an isotropic object
    """ # noqa: E501
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NumericalExtrapolationWithoutAttitudeSimulationResult from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NumericalExtrapolationWithoutAttitudeSimulationResult from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "finalState": NumericalExtrapolationWithoutAttitudeSimulationFinalState.from_dict(obj["finalState"]) if obj.get("finalState") is not None else None,
            "data": obj.get("data")
        })
        return _obj
