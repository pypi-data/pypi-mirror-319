...
class OrbitalCovarianceEphemerisRequest(BaseModel):
    """
    Options for exporting orbital covariance ephemeris in an inertial frame, which can be defined in the output configuration
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["timeGridConfiguration", "startDate", "endDate", "covarianceOrbitType", "anomalyType"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OrbitalCovarianceEphemerisRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OrbitalCovarianceEphemerisRequest from a dict"""
        if obj is None:
            return None
