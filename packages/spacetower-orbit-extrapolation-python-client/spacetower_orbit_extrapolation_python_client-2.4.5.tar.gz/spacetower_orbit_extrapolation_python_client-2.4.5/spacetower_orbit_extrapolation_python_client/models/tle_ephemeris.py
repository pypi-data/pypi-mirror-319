...
class TleEphemeris(BaseModel):
    ...
    data: List[TLE] = Field(description="Ephemeris data. Each entry (DataEntry) corresponds to a date, and contains the list of the computed values as presented in the description field ")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TleEphemeris from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TleEphemeris from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "data": [TLE.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
