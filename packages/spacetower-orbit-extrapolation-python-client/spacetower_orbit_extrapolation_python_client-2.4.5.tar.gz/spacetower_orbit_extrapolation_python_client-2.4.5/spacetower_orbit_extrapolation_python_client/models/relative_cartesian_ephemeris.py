...
class RelativeCartesianEphemeris(BaseModel):
    """
    Ephemeris of the relative position and velocity vectors of targets w.r.t. the space object 
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["dates", "description", "targetNames"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RelativeCartesianEphemeris from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RelativeCartesianEphemeris from a dict"""
        if obj is None:
            return None
