...
class BoxObject(BaseModel):
    """
    Box-shaped object with complete power systems
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["mass", "dragCoefficient", "boxGeometry", "xDimension", "yDimension", "zDimension", "radiationCoefficients", "solarArrayGeometry", "radiationCorrectionFactor", "propulsionSystem", "solarArraySystem", "batteryModel"]
