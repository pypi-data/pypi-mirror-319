...
class CelestialRelativePositionEphemerisRequest(BaseModel):
    """
    Options for exporting relative position vectors of celestial bodies w.r.t. space object
    """ # noqa: E501
    ...
    frame_type: EarthCenteredFrameType = Field(alias="frameType")
    celestial_body_names: Annotated[List[CelestialBodyName], Field(min_length=1)] = Field(alias="celestialBodyNames")
    __properties: ClassVar[List[str]] = ["timeGridConfiguration", "startDate", "endDate", "frameType", "celestialBodyNames"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CelestialRelativePositionEphemerisRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CelestialRelativePositionEphemerisRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "frameType": obj.get("frameType"),
            "celestialBodyNames": obj.get("celestialBodyNames")
        })
        return _obj
