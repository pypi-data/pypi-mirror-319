...
class SimulationContextCommonFields(BaseModel):
    """
    SimulationContextCommonFields
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["initialOrbit", "initialCovarianceMatrix", "simulationConfiguration", "data"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SimulationContextCommonFields from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SimulationContextCommonFields from a dict"""
        if obj is None:
            return None
