...
class GeodeticEphemerisRequest(BaseModel):
    """
    Options for exporting the geodetic coordinates (latitude, longitude and altitude) of the sub-satellite point as a function of time. An Earth-fixed frame and an ellipsoid model can be defined in the output configuration
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["timeGridConfiguration", "startDate", "endDate"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GeodeticEphemerisRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GeodeticEphemerisRequest from a dict"""
        if obj is None:
            return None
