...
class TerrestrialRelativePositionEphemerisRequest(BaseModel):
    """
    Options for exporting relative position vectors of ground-based targets w.r.t. space object
    """ # noqa: E501
    ...
    ground_locations: Annotated[List[GroundLocation], Field(min_length=1)] = Field(alias="groundLocations")
    __properties: ClassVar[List[str]] = ["timeGridConfiguration", "startDate", "endDate", "groundLocations"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TerrestrialRelativePositionEphemerisRequest from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in ground_locations (list)
        _items = []
        if self.ground_locations:
            for _item in self.ground_locations:
                if _item:
                    _items.append(_item.to_dict())
            _dict['groundLocations'] = _items
        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TerrestrialRelativePositionEphemerisRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "groundLocations": [GroundLocation.from_dict(_item) for _item in obj["groundLocations"]] if obj.get("groundLocations") is not None else None
        })
        return _obj
