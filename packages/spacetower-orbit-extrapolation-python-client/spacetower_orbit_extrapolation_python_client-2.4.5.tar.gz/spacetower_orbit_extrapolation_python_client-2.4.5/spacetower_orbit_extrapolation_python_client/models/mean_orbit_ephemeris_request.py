...
class MeanOrbitEphemerisRequest(BaseModel):
    """
    Options for exporting mean orbital elements in an inertial frame, which can be defined in the output configuration
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["timeGridConfiguration", "startDate", "endDate", "meanTheory"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MeanOrbitEphemerisRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MeanOrbitEphemerisRequest from a dict"""
        if obj is None:
            return None
