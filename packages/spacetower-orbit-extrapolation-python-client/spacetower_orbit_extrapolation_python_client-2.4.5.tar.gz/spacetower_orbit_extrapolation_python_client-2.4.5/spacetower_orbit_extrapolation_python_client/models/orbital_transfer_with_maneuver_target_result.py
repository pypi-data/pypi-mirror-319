...
class OrbitalTransferWithManeuverTargetResult(BaseModel):
    """
    Result for an orbital transfer maneuver planning without power system based on orbit extrapolation
    """ # noqa: E501
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OrbitalTransferWithManeuverTargetResult from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OrbitalTransferWithManeuverTargetResult from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "data": obj.get("data"),
            "finalState": OrbitalTransferWithManeuverTargetFinalState.from_dict(obj["finalState"]) if obj.get("finalState") is not None else None
        })
        return _obj
