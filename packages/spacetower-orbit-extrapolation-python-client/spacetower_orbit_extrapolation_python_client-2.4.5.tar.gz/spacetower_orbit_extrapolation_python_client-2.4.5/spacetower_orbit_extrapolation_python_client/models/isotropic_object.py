...
class IsotropicObject(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["mass", "dragCoefficient", "dragCrossSection", "radiationCrossSection", "radiationCoefficients", "propulsionSystem", "solarArraySystem", "batteryModel"]
