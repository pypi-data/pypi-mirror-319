...
class AttitudeEphemerisRequest(BaseModel):
    """
    Options for exporting attitude ephemeris. The orientation is given by a transformation to Satellite frame
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["timeGridConfiguration", "startDate", "endDate", "attitudeRepresentationType"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AttitudeEphemerisRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AttitudeEphemerisRequest from a dict"""
        if obj is None:
            return None
